...
$ls_reporte = $io_fun_ingreso->uf_select_config("SPI","REPORTE","ACUMULADO_POR_CUENTA","sigesp_spi_rpp_acum_x_cuenta_pdf.php","C")
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.gif" title="Imprimir" alt="Imprimir" width="20" height="20" border="0"></a><a href="javascript: ue_showouputexcel();"><img src="../shared/imagebank/tools20/excel.jpg" title="Imprimir" alt="Imprimir" width="20" height="20" border="0" <?php echo $ls_mostrar_estruc; ?>></a><a href="javascript:ue_graficos();"></a><a href="sigespwindow_blank.php"><img src="../shared/imagebank/tools20/salir.gif" title="Salir" alt="Salir" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/ayuda.gif" title="Ayuda" alt="Ayuda" width="20" height="20"></td>
  </tr>
</table>
  <?php
...
?>
  ...
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center"><div align="left"></div>        <div align="left"></div>        <div align="left" class="style14"></div>        <div align="left">
        <table width="542" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="2"><strong>Mes</strong></td>
            </tr>
          <tr>
            <td width="244" height="26"><div align="right">Hasta</div></td>
            <td width="296"><select name="cmbmeshas" id="cmbmeshas">
    ...
    <tr>
      <td colspan="3" align="center"><table width="542" border="0">
        <tr>
          <td class="titulo-celdanew">Graficos</td>
        </tr>
        <tr>
          <td><div align="center">
...
{
      nomreporte = document.getElementById('nomreporte').value;
      ...
      if(li_imprimir==1)
      {
		...
		cuentadesde = f.txtcuentades.value;
		cuentahasta = f.txtcuentahas.value;
		if(cuentadesde > cuentahasta)
		{
		 alert("Rango de cuentas inválida, verifique por favor");
		}
		else
		{    
	      if(estmodest==1)
	      {
			  ...
			  {                         
				...
				{
					nomreporte='sigesp_spi_rpp_acum_x_cuenta.php';	
				}						
			  ...
			  else
			  {
				if(estpreing==1)
				{
					  pagina = "reportes/"+nomreporte+"?cmbnivel="+cmbnivel
					  ...
					  +"&codestpro3h="+codestpro3h+"&estclades="+estclades+"&estclahas="+estclahas+"&tipo="+tipo+"&cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta;
					  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
				}
				else
				{
					  pagina = "reportes/sigesp_spi_rpp_acum_x_cuenta.php?cmbnivel="+cmbnivel
					  +"&cmbmeshas="+cmbmeshas+"&tiporeporte="+ls_tiporeporte+"&checksubniv="+checksubniv+"&cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta;
					  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
				}
			  }
	    }
		  ...
		  {      
			  ...
			  else
			  {
				...
				{ 
					  ...
					  +"&estclades="+estclades+"&estclahas="+estclahas+"&tipo="+tipo+"&cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta;			      
					  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
				}
				else
				{ 
	      ...
	      if(estmodest==1)
	      {
			  ...
			  else
			  {
				if(estpreing==1)
				{
				   ...
				   {
					  pagina = "reportes/sigesp_spi_rpp_acum_x_cuenta_gtorta.php?cmbnivel="+cmbnivel
					  +"&cmbmeshas="+cmbmeshas+"&tiporeporte="+ls_tiporeporte+"&checksubniv="+checksubniv+"&codestpro1="+codestpro1
					  +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h
					  +"&codestpro3h="+codestpro3h+"&estclades="+estclades+"&estclahas="+estclahas+"&tipo="+tipo+"&cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta;
					  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
				   ...
				   {
					  pagina = "reportes/sigesp_spi_rpp_acum_x_cuenta_gbarra.php?cmbnivel="+cmbnivel
					  +"&cmbmeshas="+cmbmeshas+"&tiporeporte="+ls_tiporeporte+"&checksubniv="+checksubniv+"&codestpro1="+codestpro1
					  +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h
					  +"&codestpro3h="+codestpro3h+"&estclades="+estclades+"&estclahas="+estclahas+"&tipo="+tipo+"&cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta;
					  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		  ...
		  {      
			  ...
			  else
			  {
				...
				{ 
				   ...
				   if(f.rdgrafico[0].checked)
				   {
					  pagina="reportes/sigesp_spi_rpp_acum_x_cuenta_torta.php?cmbnivel="+cmbnivel
					  +"&cmbmeshas="+cmbmeshas+"&tiporeporte="+ls_tiporeporte+"&checksubniv="+checksubniv
					  +"&codestpro1="+codestpro1+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro4="+codestpro4+"&codestpro5="+codestpro5
					  +"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&codestpro4h="+codestpro4h
					  +"&codestpro5h="+codestpro5h
...
function ue_showouputexcel()
{
	nomreporte = 'sigesp_spi_rpp_acum_x_cuenta_ipsfa_excel.php';
	f=document.form1;
	li_imprimir=f.imprimir.value;
	if(li_imprimir==1)
	{
			  ...
			  if(estpreing==1)
				{
					...
					if(document.getElementById('rdodetallado').checked==true)
					{
						nomreporte='sigesp_spi_rpp_acum_x_cuenta_excel.php';	
					}	
				}
				if(f.checksubniv.checked==true)
				{
				...
				else
				{
				  ...
				  {
					pagina="reportes/sigesp_spi_rpp_acum_x_cuenta_excel.php?cmbnivel="+cmbnivel
				   +"&cmbmeshas="+cmbmeshas+"&tiporeporte="+ls_tiporeporte+"&checksubniv="+checksubniv+"&cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta;
				   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
				...
				if(f.checksubniv.checked==true)
					...
					else
					{
					  ...
					  { 
						   ...
						   +"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&codestpro4h="+codestpro4h
						   +"&codestpro5h="+codestpro5h
						   +"&estclades="+estclades+"&estclahas="+estclahas+"&cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta;
...
function catalogo_estpro4()
{
	...
	if((codestpro2=='**')||(codestpro1=='**')||(codestpro3=='**'))
	{
		if((codestpro2!="")&&(codestpro1!="")&&(codestpro3!=""))
		{
			...
			+"&codestpro3="+codestpro3+"&estcla="+estcla+"&tipo=reporte";  //reporteacumdes
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
		}
		else
		{
	...
	else
	{
		if((codestpro2!="")&&(codestpro1!="")&&(codestpro3!=""))
		{
			...
			+"&tipo=reporte"+"&estcla="+estcla;                //reporteacumdes
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");	
		}
		else
		{
...
function catalogo_estpro5()
{
	...
	if((codestpro2=='**')||(codestpro1=='**')||(codestpro3=='**')||(codestpro4=='**'))
	{
		if((codestpro2!="")&&(codestpro1!="")&&(codestpro3!="")&&(codestpro4!=""))
		{
			...
			+"&codestpro3="+codestpro3+"&codestpro4="+codestpro4+"&estcla="+estcla+"&tipo=reporte";
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
		}
		else
		{
...
{
	   pagina="sigesp_spi_cat_public_estpro1.php?tipo=reporteacumhas";      //reporteacumhas
	   window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
}
