...
//////////////////////////////////////////////         SEGURIDAD               ///////////////////////////////////////////////////////////////////////
	...
	$io_fun_ingreso->uf_load_seguridad("SPI","sigesp_spi_r_modificaciones_presupuestarias_aprobadas.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////////////////////////////
?>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.gif" title="Imprimir" alt="Imprimir" width="20" height="20" border="0"></a></a><a href="javascript:ue_graficos();"></a><a href="../spi/sigespwindow_blank.php"><img src="../shared/imagebank/tools20/salir.gif" title="Salir" alt="Salir" width="20" height="20" border="0"></a>
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		{
			pagina="reportes/sigesp_spi_rpp_modificaciones_presupuestaria_aprobadas.php?ckbaum="+ckbaum+"&txtcomprobante="+txtcomprobante
...
function ue_graficos()
{
	...
	if(li_imprimir==1)
	{
		...
		{
			pagina="reportes/sigesp_spi_rpp_modificaciones_presupuestaria_torta.php?ckbaum="+ckbaum+"&txtcomprobante="+txtcomprobante
					+"&txtfecha="+txtfecha+"&txtprocede="+txtprocede+"&ckbdis="+ckbdis+"&txtfecdes="+txtfecdes+"&txtfechas="+txtfechas+"&tiporeporte="+ls_tiporeporte;
			window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
	}
