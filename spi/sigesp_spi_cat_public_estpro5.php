			   ...
			   while ($row=$io_sql->fetch_row($rs_data))
			         {
					   ...
					   if ($ls_tipo=="reporteacumdes_ma")		
						  { 
						    print "<td width=130 style=text-align:center><a href=\"javascript: aceptar_repma('$ls_codestpro5');\">".$ls_codestpro1."</a></td>";
							print "<td width=130 style=text-align:center><a href=\"javascript: aceptar_repma('$ls_codestpro5');\">".$ls_codestpro2."</a></td>";
							print "<td width=130 style=text-align:center><a href=\"javascript: aceptar_repma('$ls_codestpro5');\">".$ls_codestpro3."</a></td>";
							print "<td width=130 style=text-align:center><a href=\"javascript: aceptar_repma('$ls_codestpro5');\">".$ls_codestpro4."</a></td>";
							print "<td width=130 style=text-align:center><a href=\"javascript: aceptar_repma('$ls_codestpro5');\">".$ls_codestpro5."</a></td>";
					 	  }					 	  
					   if ($ls_tipo=="rephas")		
						  {
					   ...
					   if ($ls_tipo=="reporteacumhas")		
						  {
						    print "<td width=130 style=text-align:center><a href=\"javascript: aceptar_acumrephas('$ls_codestpro5','$ls_estcla');\">".$ls_codestpro1."</a></td>";
						    print "<td width=130 style=text-align:center><a href=\"javascript: aceptar_acumrephas('$ls_codestpro5','$ls_estcla');\">".$ls_codestpro2."</a></td>";
						    print "<td width=130 style=text-align:center><a href=\"javascript: aceptar_acumrephas('$ls_codestpro5','$ls_estcla');\">".$ls_codestpro3."</a></td>";
						    print "<td width=130 style=text-align:center><a href=\"javascript: aceptar_acumrephas('$ls_codestpro5','$ls_estcla');\">".$ls_codestpro4."</a></td>";
							print "<td width=130 style=text-align:center><a href=\"javascript: aceptar_acumrephas('$ls_codestpro5','$ls_estcla');\">".$ls_codestpro5."</a></td>";
						  }						  
...
<script language="JavaScript">
  ...
  function aceptar_repma(ls_codestpro5)
  {
	opener.document.form1.codestpro5.value=ls_codestpro5;
	opener.document.form1.codestpro5.readOnly=true;
	close();
  ...
  function aceptar_acumrephas(ls_codestpro5,ls_estclahas)
  {
	opener.document.form1.codestpro5h.value=ls_codestpro5;
	opener.document.form1.codestpro5h.readOnly=true;
	opener.document.form1.estclahas.value=ls_estclahas;
	close();
  }
