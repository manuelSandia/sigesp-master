...
<title>SIGESP - Reporte de Ejecuci&oacute;n Trimestral de Ingresos y Fuentes Financieras - Instructivo 08</title>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.gif" title="Imprimir" alt="Imprimir" width="20" height="20" border="0"></a><a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.jpg" alt="Excel" width="20" height="20" border="0" title="Excel"></a><a href="javascript:ue_graficos();"></a><a href="sigespwindow_blank.php"><img src="../shared/imagebank/tools20/salir.gif" title="Salir" alt="Salir" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/ayuda.gif" title="Ayuda" alt="Ayuda" width="20" height="20"></td>
  </tr>
</table>
  <?php
...
<table width="605" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="22" colspan="3" align="center">EJECUCION  TRIMESTRAL DE INGRESO Y <br>
	     ...
	     if (li_estpreing==1)
		    {
			  ...
			  pagina="reportes/sigesp_spi_rpp_ejecucion_trimestral_inst_08_2009.php?cmbmes="+cmbmes+"&codestpro1="+ls_codestpro1+
	     ...
	     if (li_estpreing==1)
		    {
			  ...
			  pagina="reportes/sigesp_spi_rpp_ejecucion_trimestral_inst_barra.php?cmbmes="+cmbmes+"&codestpro1="+ls_codestpro1+
			         "&codestpro2="+ls_codestpro2+"&codestpro3="+ls_codestpro3+"&codestpro1h="+ls_codestpro1h+
					 "&codestpro2h="+ls_codestpro2h+"&codestpro3h="+ls_codestpro3h+"&estclades="+estclades+"&estclahas="+estclahas+
					 "&codestpro4="+ls_codestpro4+"&codestpro5="+ls_codestpro5+"&codestpro4h="+ls_codestpro4h+"&codestpro5h="+ls_codestpro5h;
			}
		    ...
		    {
			  pagina="reportes/sigesp_spi_rpp_ejecucion_trimestral_inst_barra.php?cmbmes="+cmbmes;
			}
         window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
       }
}
	     ...
	     if (li_estpreing==1)
		    {
			  ...
			  pagina="reportes/sigesp_spi_rpp_ejecucion_trimestral_inst_08_2009_excel.php?cmbmes="+cmbmes+"&codestpro1="+ls_codestpro1+
			         "&codestpro2="+ls_codestpro2+"&codestpro3="+ls_codestpro3+"&codestpro1h="+ls_codestpro1h+
					 "&codestpro2h="+ls_codestpro2h+"&codestpro3h="+ls_codestpro3h+"&estclades="+estclades+"&estclahas="+estclahas+
					 "&codestpro4="+ls_codestpro4+"&codestpro5="+ls_codestpro5+"&codestpro4h="+ls_codestpro4h+"&codestpro5h="+ls_codestpro5h;
			}
		    ...
		    {
			  pagina="reportes/sigesp_spi_rpp_ejecucion_trimestral_inst_08_2009_excel.php?cmbmes="+cmbmes;
			}
         window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
       }
}
