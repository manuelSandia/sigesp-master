...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPI";
	$ls_ventanas="sigesp_spi_r_instructivo_presupuesto_caja.php";
...
<title>SIGESP - Reporte de Presupuesto de Caja - Instructivo 07</title>
...
function ue_showouput()
{
	...
	{
		pagina="reportes/sigesp_spi_rpp_instructivo_presupuesto_caja.php?trimestre="+trimestre;
...
function ue_openexcel()
{
	...
	{
		pagina="reportes/sigesp_spi_rpp_instructivo_presupuesto_caja_07_excel.php?trimestre="+trimestre;
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	}
}
