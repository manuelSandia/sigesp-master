  ...
  <div align="center">
    <table width="565" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td colspan="2"><div align="left">
          <input name="txtdocumento" type="text" id="txtdocumento" onBlur="javascript: rellenar_cad(document.form1.txtdocumento.value,15,'doc');">        
            ...
            <input name="txtfechadesde" type="text" id="txtfechadesde" style="text-align:center" onBlur="valFecha(document.form1.txtfecha)" size="12" maxlength="12" onKeyPress="javascript:currencyDate(this)" datepicker="true" value="<?php print $ls_fecdesde;?>">
      ...
      <tr>
        ...
        <td width="136" align="left"><input name="txtfechahasta" type="text" id="txtfechahasta" style="text-align:center" onBlur="valFecha(document.form1.txtfecha)" size="12" maxlength="12" onKeyPress="javascript:currencyDate(this)" datepicker="true" value="<?php print $ls_fechasta;?>"> </td>
      </tr>
      <tr>
