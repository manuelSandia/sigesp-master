...
$io_seguridad= new sigesp_c_seguridad();
	...
	$ls_sistema="SPI";
	$ls_ventana="sigesp_spi_p_aumento.php";
...
if($ls_operacion=="GUARDARPRE")
{
	...
	if($lb_valido)
	{
		...
		else	{	$in_classcmp->io_int_scg->io_sql->rollback(); }
	} 
	else
	{
		$ls_cuenta      = $_POST["txtcuenta"];
...
<table width="583" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
  ...
  <tr>
    ...
    <td height="22"><label>
      <input name="codestpro1" type="text" id="codestpro1" size="<?php echo $li_size1; ?>" value="<?php print $ls_estpro1; ?>"  maxlength="<?php echo $li_loncodestpro1 ?>" style="text-align:center">
  ...
  <tr>
    ...
    <td height="22"><label>
      <input name="codestpro2" type="text" id="codestpro2" size="<?php echo $li_size2; ?>"  value="<?php print $ls_estpro2; ?>" maxlength="<?php echo $li_loncodestpro2 ?>" style="text-align:center">
  ...
  <tr>
    ...
    <td height="22"><label>
      <input name="codestpro3" type="text" id="codestpro3" size="<?php echo $li_size3; ?>" value="<?php print $ls_estpro3; ?>"  maxlength="<?php echo $li_loncodestpro3 ?>" style="text-align:center">
  ...
  <tr>
    ...
    <td height="22"><label>
      <input name="codestpro4" type="text" id="codestpro4" size="<?php echo $li_size4; ?>" value="<?php print $ls_estpro4; ?>" maxlength="<?php echo $li_loncodestpro4 ?>" style="text-align:center">
  ...
  <tr>
    ...
    <td height="22"><label>
      <input name="codestpro5" type="text" id="codestpro5" size="<?php echo $li_size5; ?>" value="<?php print $ls_estpro5; ?>" maxlength="<?php echo $li_loncodestpro5 ?>" style="text-align:center">
  ...
  <tr>
    ...
    <td><div align="left">
      ...
      <select name="ddlb_operacion" id="ddlb_operacion">
        <option value="AU">Aumento</option>
      </select>
      </label>
    </div></td>
  </tr>
  <tr>
    ...
    <td><input name="txtmonto" type="text" id="txtmonto" style="text-align:right" size="22" onKeyPress="return(currencyFormat(this,'.',',',event))" onBlur="javascript:uf_format(this);" value="<? print $ld_monto ?>"> 
...
<script language="JavaScript">
  function aceptar_presupuestario()
  {
	...
	if((ls_cuenta!="")&&(ls_descripcion!="")&&(ls_procedencia!="")&&(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto!=""))
	{
		...
		f.action="sigesp_w_regdt_aumento.php";
		f.submit();
	}
	else
	{
...
function catalogo_estpro5()
{
	...
	{
		pagina="sigesp_spi_cat_public_estpro5.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2+"&codestpro3="+codestpro3+"&denestpro3="+denestpro3+"&codestpro4="+codestpro4+"&denestpro4="+denestpro4+"&hidestcla="+ls_estcla+"&estcla="+ls_estcla;
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
	else
	{
