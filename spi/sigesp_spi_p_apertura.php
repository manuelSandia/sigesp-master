...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPI";
	$ls_ventanas="sigesp_spi_p_apertura.php";
...
<table width="798" height="241" border="0" align="center">
  <tr>
    <td height="237"><table width="550" height="230" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
    ...
    <?php
	    ...
	    ?>
      <tr <? print $ls_mostrar_estruc ?>>
        <td height="20"><div align="right" <? print $ls_mostrar_estruc ?>><?php print $ls_NomEstPro4;?></div></td>
      ...
      <tr <? print $ls_mostrar_estruc ?>>
        <td height="20"><div align="right" <? print $ls_mostrar_estruc ?>><?php print $ls_NomEstPro5;?></div></td>
      ...
      <tr>
        <td height="22" colspan="5"><div align="center">
          <table width="323" height="53" border="0" align="center" class="formato-blanco">
            <tr>
              <td width="85"><div align="right">Fecha</div></td>
              <td width="116"><div align="left">
                <input name="txtFecha" type="text" class="formato-blanco" id="txtFecha" value="<?php print $ldt_fecha?>" size="10" readonly >
              </div></td>
              <td width="70">&nbsp;</td>
            ...
            <tr>
              ...
              <?php 	 
			  if(($ls_distribucion=="A")||($ls_distribucion==""))
			  {	
					$ls_auto="checked";
					$ls_manual="";
			  }
    ...
    Manual </td>
              <td width="32"><a href="javascript:ue_distribuir();"><img src="../shared/imagebank/tools15/aprobado.gif" alt="Aceptar" width="15" height="15" border="0"></a></td>
            </tr>
          </table>
        </div></td>
        </tr>
  ...
  /* if($li_estpreing=='1')
   ...
   { 
      ...
      if($lb_valido)
      {
		   ...
		   {
		   		$lb_valido=$class_aper->uf_spi_load_cuentas_apertura_con_estructuras($ls_codestpro1,$ls_codestpro2,
		   ...
		   if($lb_valido)
		   {
			  if($row=$SQL->fetch_row($rs_data))
			  {
			   ...
			   {    
					...
					$object[$i][3]="<input type=text name=txtPrevisto".$i." class=sin-borde onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)' onFocus= uf_fila(".$i.") value=$ld_previsto style=text-align:right><input name=enero".$i." type=hidden id=enero".$i." value='$ld_enero'onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)'>
									<input name=febrero".$i." type=hidden id=febrero".$i." value='$ld_febrero'onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)' >
									...
									<input name=abril".$i." type=hidden id=abril".$i." value='$ld_abril' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)'>
									<input name=mayo".$i." type=hidden id=mayo".$i." value='$ld_mayo'onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)' >
									...
									<input name=julio".$i." type=hidden id=julio".$i." value='$ld_julio' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)'>
									<input name=agosto".$i." type=hidden id=agosto".$i." value='$ld_agosto' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)'>
									...
									<input name=octubre".$i." type=hidden id=octubre".$i." value='$ld_octubre' onBlur='uf_formaot(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)'>
									<input name=noviembre".$i." type=hidden id=noviembre".$i." value='$ld_noviembre' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)'>
...
if ($ls_operacion=="GUARDAR")
{
   ...
   { 
		...
		$object[$i][1]="<input type=text name=txtCuenta".$i." value=$ls_cuenta class=sin-borde size=10 readonly><input name=cuenta".$i." type=hidden id=cuenta value='$ls_cuenta'><input name=distribuir".$i." type=hidden id=distribuir value='$ls_distribuir'>";
		$object[$i][2]="<input type=text name=txtDenominacion".$i." value='$ls_denominacion' size=105 class=sin-borde readonly >";
		$object[$i][3]="<input type=text name=txtPrevisto".$i." class=sin-borde onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)' onFocus= uf_fila(".$i.") value=$ld_previsto style=text-align:right>
		                <input name=enero".$i." type=hidden id=enero".$i." value='$ld_enero' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)'>
						<input name=febrero".$i." type=hidden id=febrero".$i." value='$ld_febrero' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)'>
						<input name=marzo".$i." type=hidden id=marzo".$i." value='$ld_marzo' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)'>
						<input name=abril".$i." type=hidden id=abril".$i." value='$ld_abril'onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)' >
						<input name=mayo".$i." type=hidden id=mayo".$i." value='$ld_mayo' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)'>
						...
						<input name=agosto".$i." type=hidden id=agosto".$i." value='$ld_agosto' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)'>
						<input name=septiembre".$i." type=hidden id=septiembre".$i." value='$ld_septiembre'onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)' >
						<input name=octubre".$i." type=hidden id=octubre".$i." value='$ld_octubre'onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)' >
						<input name=noviembre".$i." type=hidden id=noviembre".$i." value='$ld_noviembre' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)'>
						<input name=diciembre".$i." type=hidden id=diciembre".$i." value='$ld_diciembre' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)'>";
	 }//for
	 if($lb_valido)
   ...
   if(li!="")
   {
	   ...
	   else
	   {
			...
			if (document.opcion=="M" ) 
			{
				 ...
				 pagina="sigesp_spi_p_apertura_distribucion.php?fila="+li+"&txtPrevisto="+ld_previsto+"&enero="+ld_enero
...
function ue_guardar()
{
	...
	else
	{
		...
		f.action="sigesp_spi_p_apertura.php";
		f.submit();
	}	
}
