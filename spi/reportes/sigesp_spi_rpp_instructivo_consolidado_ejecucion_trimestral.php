    ...
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
	 ...
	 else // Imprimimos el reporte
	 {
		...
		for($z=1;$z<=$li_total;$z++)
	    {
			  ...
			  $ld_cobrado=$io_report->dts_reporte->data["devengado"][$z];
			  ...
			  $ld_cobrado_acumulado=$io_report->dts_reporte->data["devengado_acumulado"][$z];
			  ...
			  $la_data[$z]=array('cuenta'=>$ls_spi_cuenta,
								 ...
								 'liquidado_acumulado'=>$ld_cobrado_acumulado,
		...
		if(trim($ld_previsto_modificado_total)==trim($ld_previsto_total))
		{
	    ...
	    $la_data_totales[$z]=array('total'=>'<b>TOTALES Bs.</b>',
								   ...
								   'liquidado_acumulado'=>$ld_cobrado_acumulado_total,
