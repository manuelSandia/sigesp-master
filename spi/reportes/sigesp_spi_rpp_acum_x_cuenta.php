...
//--------------------------------------------------  Parámetros para Filtar el Reporte  ---------------------------------------
    ...
    if ($ls_estpreing==1)
	{
		...
		$la_data_tot2[]=array('total'=>'<b>TOTAL GENERAL</b>','previsto'=>$ld_totalgen_previsto,'aumento'=>$ld_totalgen_aumento,
										 'disminución'=>$ld_totalgen_disminucion,
										 'devengado'=>$ld_totalgen_devengado,'cobrado'=>$ld_totalgen_cobrado,
										 'cobrado_anticipado'=>$ld_totalgen_cobrado_anticipado,
										 'montoactualizado'=>$ld_totalgen_monto_actualizado,
										 'porcobrar'=>$ld_totalgen_por_cobrar);
