...
//----------------------------------------------------  Parámetros del encabezado  ---------------------------------------------
		$ls_titulo=" <b>EJECUCION TRIMESTRAL DE INGRESO Y FUENTES FINANCIERAS</b>";
//--------------------------------------------------------------------------------------------------------------------------------
	...
	else // Imprimimos el reporte
	{
		...
		uf_print_encabezado_pagina($ls_titulo,'(En Bolivares)',$ls_trimestre,$io_pdf); // Imprimimos el encabezado de la página
