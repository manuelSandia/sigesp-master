	...
	if ($ls_estpreing==1)
	{
	 ...
	 else // Imprimimos el reporte
	 {
		...
		{ 
			...
			{
				 $DataSet = new pData;
				 $DataSet->AddPoint(array($ld_total_devengado,$ld_total_cobrado,$ld_total_cobrado_anticipado,$ld_total_monto_actualizado,$ld_total_por_cobrar),"Serie1");
				 $DataSet->AddPoint(array("Devengado","Cobrado","Anticipado","Actualizado","Por Cobrar"),"titulos");
				 $DataSet->AddAllSeries();
				 $DataSet->SetAbsciseLabelSerie("titulos");
