<?php
	...
	$lo_archivo =  tempnam("/tmp", "spi_consolidado_ejecucion_trimestral_inst_07.xls");
	...
	else // Imprimimos el reporte
	{
		...
		for($z=1;$z<=$li_total;$z++)
		{
			...
			if($ld_previsto == $ld_previsto_modificado)
			  {
			   $ld_previsto_modificado = 0;
			  }
			...
			if($ld_previsto_modificado == '0,00')
			  {
			    $ld_previsto_modificado = '';
			  }
		...
		if($ld_previsto_modificado_total==$ld_previsto_total)
		{
		 $ld_previsto_modificado_total='';
		}
		...
		$la_data_totales[$z]=array('total'=>'TOTALES Bs.',
						...
						'liquidado_acumulado'=>$ld_devengado_acumulado_total,
		...
		{
			$lo_libro->close();
			header("Content-Type: application/x-msexcel; name=\"spi_consolidado_ejecucion_trimestral_inst_07.xls\"");
			header("Content-Disposition: inline; filename=\"spi_consolidado_ejecucion_trimestral_inst_07.xls\"");
