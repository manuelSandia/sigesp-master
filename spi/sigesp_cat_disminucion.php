      ...
      <tr>
        ...
        <td colspan="2"><div align="left">
          <input name="txtdocumento" type="text" id="txtdocumento" onBlur="javascript: rellenar_cad(document.form1.txtdocumento.value,15,'doc');">        
            ...
            <td align="left"> <input name="txtfechadesde" type="text" id="txtfechadesde" style="text-align:center" onBlur="valFecha(document.form1.txtfecha)" size="12" maxlength="12" onKeyPress="javascript:currencyDate(this)" datepicker="true" value="<?php print $ls_fecdesde;?>"></td>
      </tr>
      <tr>
        <td><div align="right">Procedencia</div></td>
        <td width="113" align="left"><input name="procede" type="text" id="procede" value="SPIDIS" readonly ></td>
        <td width="85" align="left">&nbsp;</td>
        <td><div align="right"></div></td>
        <td width="40"><div align="right">Hasta </div></td>
        <td width="136" align="left">
        
        <input name="txtfechahasta" type="text" id="txtfechahasta" style="text-align:center" onBlur="valFecha(document.form1.txtfecha)" size="12" maxlength="12" onKeyPress="javascript:currencyDate(this)" datepicker="true" value="<?php print $ls_fechasta;?>">
...
{
		$ls_sql="SELECT procede,comprobante,descripcion,fecha,cod_pro,ced_bene,estapro FROM sigesp_cmp_md 
...
<script language="JavaScript">
  ...
  function ue_search()
  {
	  ...
	  f.action="sigesp_cat_disminucion.php";
	  f.submit();
  }
