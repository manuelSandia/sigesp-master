	 ...
	 if ($li_estpreing==1)
	    {
	      ...
	      $ls_cadena =" SELECT spi_cuentas.*,(spi_cuentas_estructuras.previsto+spi_cuentas.aumento-spi_cuentas.disminucion) as disponible, spi_cuentas_estructuras.estcla as estcla  
		...
		{		  
			$ls_cadena =" SELECT *,((previsto+(aumento-disminucion))-devengado) as disponible 
				  FROM spi_cuentas 
			  ...
			  while($row=$io_sql->fetch_row($rs_data))
			       {
					 ...
					 if ($status=="S")
					 ...
					 else
					    {
						  ...
						  print "<td><a href=\"javascript: aceptar('$cuenta','$denominacion','$scgcuenta','$status','$estcla','$li_estpreing');\">".$cuenta."</a></td>";
						  print "<td  align=left>".$denominacion."</td>";
						  print "<td  align=center>".$scgcuenta."</td>";
...
<script language="JavaScript">
  function aceptar(cuenta,deno,scgcuenta,status,estcla,estpreing)
  {
