...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
	   	...
	   	if(estpreing==1)
		{
			...
			{
				codestpro1  = f.codestpro12.value;
				codestpro2  = f.codestpro22.value;
				codestpro3  = f.codestpro32.value;
				codestpro1h = f.codestpro1h2.value;
				codestpro2h = f.codestpro2h2.value;
				codestpro3h = f.codestpro3h2.value;
			}
			...
			else
			{
				...
				else
				{
					if(estpreing==1)
					  ...
					  {
					  	pagina="reportes/sigesp_spi_rpp_mayor_analitico_excel.php?txtfecdes="+txtfecdes+"&rborden="+orden
						        +"&txtfechas="+txtfechas+"&txtcuentades="+txtcuentades
								+"&txtcuentahas="+txtcuentahas;
						window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
					  }
				}	
...
function catalogo_estpro2()
{
	...
	else
	{
		...
		else
		{
			if(codestpro1!="")
			{
				pagina="sigesp_spi_cat_public_estpro2.php?codestpro1="+codestpro1+"&tipo=reporteacumdes_ma"+"&estcla="+estcla;
				window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
			}
			else
			{
...
function catalogo_estpro3()
{
	...
	{		
		...
		else
		{
			if((codestpro2!="")&&(codestpro1!=""))
			{
				pagina="sigesp_spi_cat_public_estpro3.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2+"&tipo=reporteacumdes_ma"
				+"&estcla="+estcla;
				window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");	
			}
			else
...
function catalogo_estpro4()
{
	...
	else
	{
		...
		{
			pagina="sigesp_spi_cat_public_estpro4.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3
			+"&tipo=reporteacumdes_ma"+"&estcla="+estcla;
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");	
		}
		else
		{
...
function catalogo_estprohas2()
{
	...
	{
		codestpro1=f.codestpro1h2.value;
		if(codestpro1=='**')
		{
...
function catalogo_estprohas3()
{
	...
	{
		codestpro1=f.codestpro1h2.value;
		codestpro2=f.codestpro2h2.value;
		codestpro3=f.codestpro3h2.value;
		if((codestpro2=='**')||(codestpro1=='**'))
		{
			if((codestpro2!="")&&(codestpro1!=""))
			{
