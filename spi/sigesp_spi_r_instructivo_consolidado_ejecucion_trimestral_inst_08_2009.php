...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPI";
	$ls_ventanas="sigesp_spi_r_instructivo_consolidado_ejecucion_trimestral.php";
...
<title>SIGESP - Reporte de Consolidado de Ejecuci&oacute;n Trimestral de Ingresos y Aplicaciones Financieras - Instructivo 08</title>
...
?>
  <table width="400" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">CONSOLIDADO DE EJECUCION TRIMESTRAL DE INGRESOS FINANCIEROS </td>
    </tr>
  </table>
...
function ue_showouput()
{
	...
	else
	{
		...
		pagina="reportes/sigesp_spi_rpp_instructivo_consolidado_ejecucion_trimestral_inst_08_2009.php?trimestre="+trimestre;
...
function ue_openexcel()
{
	...
	{
		li_mesdes=trimestre.substr(0,2);
		pagina="reportes/sigesp_spi_rpp_instructivo_consolidado_ejecucion_trimestral_08_2009_excel.php?trimestre="+trimestre;
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	}
}
