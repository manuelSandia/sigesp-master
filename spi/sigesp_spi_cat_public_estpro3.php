...
if ($ls_operacion=="BUSCAR")
{
	...
	if ($li_estpreing==1)
	{
		$ls_sql=" SELECT distinct(spg_ep3.codestpro3),spg_ep3.codestpro1, spg_ep3.codestpro2,spg_ep3.denestpro3, spg_ep3.estcla ".
			 "	  FROM spg_ep3 LEFT OUTER JOIN spi_cuentas_estructuras  ".
			 "		ON spi_cuentas_estructuras.codemp=spg_ep3.codemp ".
			   ...
			   while ($row=$io_sql->fetch_row($rs_data))
			         {
					   ...
					   {	  
						   print "<td width=160 style=text-align:center><a href=\"javascript: aceptar_reporteacumdes_ma('$ls_codestpro3','$ls_estcla');\">".$ls_codestpro1."</a></td>";
						   print "<td width=160 style=text-align:center><a href=\"javascript: aceptar_reporteacumdes_ma('$ls_codestpro3','$ls_estcla');\">".$ls_codestpro2."</a></td>";
						   print "<td width=160 style=text-align:center><a href=\"javascript: aceptar_reporteacumdes_ma('$ls_codestpro3','$ls_estcla');\">".$ls_codestpro3."</a></td>";
						   print "<td width=200 style=text-align:left>".$ls_denestpro3."</td>";
						   print "<td width=40 style=text-align:center>".$ls_denestcla."</td>";
						   print "</tr>";
					   }					   
...
<script language="JavaScript">
  ...
  function aceptar_reporteacumdes_ma(ls_codestpro3,estcla)
  {
	opener.document.form1.codestpro32.value=ls_codestpro3;
	opener.document.form1.codestpro32.readOnly=true;
	if(estcla=="PROYECTO")
	{
	  estcla="P";
	}
  ...
  function aceptar_reporteacumhas(ls_codestpro3,estcla)
  {
  	if("<?php print $li_estmodest;?>"==2) 
  	{
		if  (opener.document.getElementById('codestpro3h2') ) 
		{      			
			opener.document.form1.codestpro3h2.value=ls_codestpro3;
			opener.document.form1.codestpro3h2.readOnly=true;	
		}
		if  (opener.document.getElementById('codestpro3h') ) 
		{      			
