...
<table width="798" height="241" border="0" align="center">
  <tr>
    <td height="237"><table width="550" height="272" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      <?php
		...
		?>
         ...
         <td height="5" colspan="8" class="titulo-ventana">APERTURA DE CUENTAS POR ESTRUCTURA PRESUPUESTARIA</td>
         </tr>
		<?php  
		  }
		  else
      ...
      <tr >
        <td height="22" colspan="5"><div align="center">
          <table width="324" height="53" border="0" align="center" class="formato-blanco">
            <tr>
              <td width="84"><div align="right">Fecha</div></td>
            ...
            <tr>
              ...
              <?php 	 
			  if(($ls_distribucion=="A")||($ls_distribucion=="")||($ls_distribucion=="N"))
			  {	
					$ls_auto="checked";
					$ls_manual="";
			  }
    ...
    Manual </td>
              <td width="61"><a href="javascript:ue_distribuir();"><img src="../shared/imagebank/tools15/aprobado.gif" alt="Aceptar" width="15" height="15" border="0"></a></td>
            </tr>
          </table>
        </div></td>
        </tr>
