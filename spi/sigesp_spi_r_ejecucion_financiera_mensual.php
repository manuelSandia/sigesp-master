...
$io_fun_ingreso->uf_load_seguridad("SPI","sigesp_spi_r_ejecucion_financiera_mensual.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<title>Reporte de Ejecuci&oacute;n Presupuestaria Mensual de Ingreso</title>
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">EJECUCI&Oacute;N PRESUPUESTARIA MENSUAL DE INGRESO </td>
    </tr>
  </table>
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      ...
      <tr <? print $ls_mostrar_estruc ?>>
        ...
        <td align="center" <? print $ls_mostrar_estruc ?>><?php 
		 if($li_estmodest==2)
		  {
		?>
          <table width="275" height="117" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
    ...
    <tr>
      <td colspan="3" align="center">      <div align="left">
        <table width="548" height="40" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td width="246"><div align="right"><span class="style1 style14">Nivel</span></div></td>
            <td width="300" height="22"><select name="cmbnivel" id="cmbnivel">
    ...
    <tr>
      <td colspan="3" align="center"><div align="left"></div>        <div align="left"></div>        <div align="left" class="style14"></div>        <div align="left">
        <table width="548" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="2"><strong> Mes </strong></td>
            </tr>
          <tr>
            <td width="257" height="26"><div align="right">Mes</div></td>
            <td width="283"><select name="cmbmesdes" id="cmbmesdes">
		...
		if(estmodest==1)
		{
			  if(estpreing==1)
				...
				else
				{
				  if(estpreing==1)
				  {
				   pagina="reportes/sigesp_spi_rpp_ejecucion_financiera_mensual.php?cmbnivel="+cmbnivel+"&cmbmesdes="+cmbmesdes+"&codestpro1="+codestpro1
				  ...
				  {
					pagina="reportes/sigesp_spi_rpp_ejecucion_financiera_mensual.php?cmbnivel="+cmbnivel+"&cmbmesdes="+cmbmesdes;
				   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			  ...
			  if(estpreing==1)
				...
				else
				{
				  if(estpreing==1)
				  {
				   ...
				   {
					   pagina="reportes/sigesp_spi_rpp_ejecucion_financiera_mensual_torta.php?cmbnivel="+cmbnivel+"&cmbmesdes="+cmbmesdes+"&codestpro1="+codestpro1
					   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h
					   +"&codestpro3h="+codestpro3h+"&estclades="+estclades+"&estclahas="+estclahas+"&tipo="+tipo;
					   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
					}
					...
					{
					   pagina="reportes/sigesp_spi_rpp_ejecucion_financiera_mensual_barra.php?cmbnivel="+cmbnivel+"&cmbmesdes="+cmbmesdes+"&codestpro1="+codestpro1
					   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h
					   +"&codestpro3h="+codestpro3h+"&estclades="+estclades+"&estclahas="+estclahas+"&tipo="+tipo;
					   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
					}
				  ...
				  else
				  {
				   if(f.rdgrafico[0].checked)
				   {
						pagina="reportes/sigesp_spi_rpp_ejecucion_financiera_mensual_torta.php?cmbnivel="+cmbnivel+"&cmbmesdes="+cmbmesdes;
					   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
					}
					else
					{
						pagina="reportes/sigesp_spi_rpp_ejecucion_financiera_mensual_barra.php?cmbnivel="+cmbnivel+"&cmbmesdes="+cmbmesdes;
					   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
					}
				  }
				} 
