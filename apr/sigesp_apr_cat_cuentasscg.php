...
<table width="580" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="500" height="20" colspan="2" class="titulo-ventana">Cat&aacute;logo de Cuentas Contables </td>
    </tr>
  </table>
  <br>
...
function ue_aceptar(scg_cuenta,denominacion)
{
	...
	opener.document.formulario.txtscdenominacion.value=denominacion;
	close();
}
...
function ue_search()
{
	...
	ajax.send("catalogo=CUENTASSCG&scgcuenta="+scgcuenta+"&dencue="+dencue+"&orden="+orden+"&campoorden="+campoorden);
}
