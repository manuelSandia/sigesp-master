	...
	if($io_sql->num_rows($rs_data)==0)
	 ...
	 {	
		while($row=$io_sql->fetch_row($rs_data))
		{
				...
				{
					print "<td width=250 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro1)."</td>";
					print "<td width=150 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro2)."</td>";
					print "<td width=50 align=\"center\"><a href=\"javascript:  aceptar('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro3)."</td>";
					print "<td width=50 align=\"center\"><a href=\"javascript:  aceptar('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro4)."</a></td>";
					print "<td width=50 align=\"center\"><a href=\"javascript:  aceptar('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro5)."</a></td>";
					print "<td width=250 align=\"left\">".trim($ls_denestpro5)."</td>";
					print "</tr>";
				}
...
function aceptar(as_codestpro1,as_codestpro2,as_codestpro3,as_codestpro4,as_codestpro5,as_denestpro5,as_estcla)
{
  ls_opener     = fop.id;
