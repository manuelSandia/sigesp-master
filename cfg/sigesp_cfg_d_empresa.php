      ...
      <tr class="formato-blanco">
        <td height="13" colspan="6"><table width="593" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
		 ...
		 <tr class="formato-blanco">
          ...
          <tr class="formato-blanco">
            <td height="13">&nbsp;</td>
            <td height="13" colspan="2"><div align="right">Cuenta Contable para la Reposición de Caja Chica </div></td>
...
function ue_alertacorreo()
{
 ...
 if ((f.chkestenvcor.checked==true))
   { 
	 alert("Recuerde configurar los datos del correo para esta función");
   }
}
