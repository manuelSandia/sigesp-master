			  ...
			  while ($row=$io_sql->fetch_row($rs_data))
			        {
					  ...
					  echo "<td width=250 style=text-align:center><a href=\"javascript: aceptar('$ls_codestpro4','$ls_denestpro4');\">".trim($ls_codestpro1)."</td>";
					  echo "<td width=150 style=text-align:center><a href=\"javascript: aceptar('$ls_codestpro4','$ls_denestpro4');\">".trim($ls_codestpro2)."</td>";
					  echo "<td width=50  style=text-align:center><a href=\"javascript: aceptar('$ls_codestpro4','$ls_denestpro4');\">".trim($ls_codestpro3)."</td>";
					  echo "<td width=50  style=text-align:center><a href=\"javascript: aceptar('$ls_codestpro4','$ls_denestpro4');\">".trim($ls_codestpro4)."</a></td>";
...
function aceptar(as_codestpro4,as_denestpro4)
{
