  ...
  <p align="center">
	...
	if($ls_operacion=="BUSCAR")
	{
			$ls_sql=" SELECT a.codban as codban,b.nomban as nomban,a.ctaban as ctaban,c.dencta as dencta,a.numcol as numcol,     ".
					...
					"        a.estreicol as estreicol,a.codconmov,a.cod_pro,a.ced_bene,a.sc_cuentacob,   										 ".
					"        a.codestpro1,a.codestpro2,a.codestpro3,a.codestpro4,a.codestpro5,a.estcla, ".
					...
					"       (SELECT denominacion from scg_cuentas where a.codemp=scg_cuentas.codemp and ".
					"         a.sc_cuentacob=scg_cuentas.sc_cuenta)as denocob".
			...
			else
			{
				if($row=$SQL->fetch_row($rs_cta))
				{
					...
					for($z=1;$z<=$totrow;$z++)
					{
						...
						$ls_cuentacob=$data["sc_cuentacob"][$z];
						$ls_dencuentacob=$data["denocob"][$z];
						...
						print "<td align=center><a href=\"javascript: aceptar('$numcol','$dencol','$codban','$nomban','$ctaban','$dencta','$status','$codtipcol','$nomtipcol','$feccol',$monto,'$fecvencol',$monint,'$denscg','$ls_cuenta','$diacol','$tascol','$codconcepto','$codpro','$cedbene','$desconcepto','$nompro','$nomben','$denospi','$spi_cuenta','$ls_cuentacob','$ls_dencuentacob','$codestpro1','$codestpro2','$codestpro3','$codestpro4','$codestpro5','$estcla');\">".$numcol."</a></td>";
...
<script language="JavaScript">
  function aceptar(numcol,dencol,codban,nomban,ctaban,dencta,status,codtipcol,nomtipcol,feccol,monto,fecvencol,
				   ...
				   denospi,spi_cuenta,ls_cuentacob,ls_dencuentacob,codestpro1,codestpro2,codestpro3,codestpro4,codestpro5,estcla)
  {
		...
		opener.document.form1.txtcuentacobrar.value  = ls_cuentacob;
		opener.document.form1.txtdencuentacob.value = ls_dencuentacob;
		opener.document.form1.txthidcodestpro1.value = codestpro1;
		opener.document.form1.txthidcodestpro2.value = codestpro2;
		opener.document.form1.txthidcodestpro3.value = codestpro3;
		opener.document.form1.txthidcodestpro4.value = codestpro4;
		opener.document.form1.txthidcodestpro5.value = codestpro5;
		opener.document.form1.txthidestcla.value = estcla;
		opener.document.form1.hidestcol.value ="A";
		if(status==1)
		{
