          ...
          <table width="566" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
              ...
              <tr class="formato-blanco">
                ...
                <td height="22" colspan="2"><div align="left" >
                    <input name="txtcodigo" type="text" id="txtcodigo" value="<?php print $ls_codigo?>" size="35" maxlength="20" onBlur="javascript:rellenar_cad(this.value,20,'cod')" <?php print $readonly ?> style="text-align:center">
                </div></td>
              </tr>
              <tr class="formato-blanco">
              ...
              <tr class="formato-blanco">
                ...
                <td height="22" colspan="2" align="left"><div align="left">
                  <input name="txtctaext" type="text" id="txtctaext" value="<?php print $ls_ctaext;?>" size="28" maxlength="20">
                </div></td>
              </tr>
              <tr class="formato-blanco">
	...
	if (((lb_status=="C")&&(li_cambiar==1))||((lb_status=="N")&&(li_incluir==1)))
	   {
		 ...
		 ls_codigo = ls_codigo.replace(/(^\s*)|(\s*$)|[ ]/g, "");  
