...
{
	$ls_sql="SELECT codestpro1,denestpro1 FROM spg_ep1 WHERE codemp='".$ls_codemp."' AND codestpro1 like '".$ls_codigo."' AND denestpro1 like '".$ls_denominacion."' ";
...
<script language="JavaScript">
  ...
  f.action="sigesp_cat_public_colestpro1.php";
  f.submit();
  }
</script>
</html>
