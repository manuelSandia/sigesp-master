...
<div align="center">
    <table width="530" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
      ...
      <tr>
        <td width="80" height="22" align="right">Cuenta</td>
        <td width="265" height="22"><div align="left">
      ...
      <tr>
        ...
        <td height="22"><input name="tipo" type="hidden" id="tipo" value="<?php print $as_tipo;?>"></td>
		<td width="78" height="22"><div align="right"><a href="javascript: ue_search();"><img src="../../shared/imagebank/tools20/buscar.gif" alt="Buscar" width="20" height="20" border="0"> Buscar </a></div></td>
      </tr>
    </table>
	<p><br>
      <?php
				       ...
				       if ($ls_estcta=='S')
					   ...
					   else
					      {
						    switch ($as_tipo)
							{
								...
								case "COB":
								echo "<tr class=celdas-azules>";
								echo "<td style=text-align:center width=100><a href=\"javascript: aceptarcob('$ls_scgcta','$ls_dencta');\">".$ls_scgcta."</a></td>";
						  		break;
							}
						  }
...
<script language="JavaScript">
  ...
  {
    opener.document.form1.txtcuentacobrar.value=as_scgcta;
	opener.document.form1.txtdencuentacob.value=as_dencta;
	close();
  }

  function aceptarcob(as_scgcta,as_dencta)
  {
    opener.document.form1.txtcuentacobrar.value=as_scgcta;
	opener.document.form1.txtdencuentacob.value=as_dencta;
	close();
  ...
  function ue_search()
  {
	  ...
	  f.action="sigesp_cat_filt_scg_cob.php";
	  f.submit();
  }
</script>
</html>