...
if ($ls_operacion=="BUSCAR")
   {
	 $ls_estpreing=$la_empresa["estpreing"];/// manejo de estructura presupuestarias
	 if (!empty($ls_codestpro3))
	 {
		  $ls_codestpro3 = str_pad($ls_codestpro3,25,0,0);
	 }
		
	 if (($ls_estpreing=='1')&&($ls_tipo=="ingreso"))
	 {
	 ...
	 {
	 	$ls_sql = "SELECT spg_ep1.codestpro1 as codestpro1,spg_ep1.denestpro1 as denestpro1,
	                   spg_ep2.codestpro2 as codestpro2,spg_ep2.denestpro2 as denestpro2,
				  	   spg_ep3.codestpro3 as codestpro3,spg_ep3.denestpro3 as denestpro3, spg_ep3.estcla
			     ...
			     WHERE spg_ep1.codemp='".$la_empresa["codemp"]."'
				   ...
				   AND spg_ep2.estcla=spg_ep3.estcla
				   AND spg_ep3.estcla=spg_ep1.estcla
				 ORDER BY spg_ep3.codestpro1,spg_ep3.codestpro2,spg_ep3.codestpro3 ASC"; 
	 }	 
			   ...
			   while ($row=$io_sql->fetch_row($rs_data))
			         {
					   ...
					   if ($ls_tipo=="rephas")		
 				       ...
 				       print "<td width=200 style=text-align:left title = '".$ls_denestpro3."'>".$ls_denestpro3."</td>";
					   print "<td width=40  style=text-align:center title='".$ls_denestcla."'>".$ls_denestcla."</td>";
			           print "</tr>";
					 }
			 } 
	      else
...
<script language="JavaScript">
  ...
  function aceptar_apertura(ls_codestpro1,ls_denestpro1,ls_codestpro2,ls_denestpro2,ls_codestpro3,ls_denestpro3)
  {
    opener.document.form1.denestpro1.value=ls_denestpro1;
	opener.document.form1.codestpro1.value=ls_codestpro1;
    opener.document.form1.denestpro2.value=ls_denestpro2;
  ...
  function aceptar_progrep(ls_codestpro1,ls_denestpro1,ls_codestpro2,ls_denestpro2,ls_codestpro3,ls_denestpro3)
  {
    opener.document.form1.denestpro1.value=ls_denestpro1;
	opener.document.form1.codestpro1.value=ls_codestpro1;
    opener.document.form1.denestpro2.value=ls_denestpro2;
  ...
  function aceptar_rep(ls_codestpro1,ls_codestpro2,ls_codestpro3)
  {
	opener.document.form1.codestpro1.value=ls_codestpro1;
	opener.document.form1.codestpro2.value=ls_codestpro2;
	opener.document.form1.codestpro3.value=ls_codestpro3;
  ...
  function aceptar_rephas(ls_codestpro1,ls_codestpro2,ls_codestpro3)
  {
  ...
  f.action="sigesp_cat_public_colestpro.php?tipo=<?php print $ls_tipo; ?>";
  f.submit();
  }
</script>
</html>