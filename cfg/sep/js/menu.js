...
stm_ai("p0i0",[0,"   Solicitudes de Ejecución Presupuestaria     ","","",-1,-1,0,"sigesp_sep_w_sol_eje_pre.php","","","","","",0,0,0,"","",0,0,0,0,1,"#F7F7F7",0,"#f4f4f4",0,"","",3,3,0,0,"#fffff7","#000000","#909090","#909090","8pt 'Tahoma','Arial'","8pt 'Tahoma','Arial'",0,0]);
...
stm_aix("p1i0","p0i0",[0,"Reporte  1","","",-1,-1,0,"","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i2","p1i0",[0,"Reporte  2","","",-1,-1,0,"","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();

// Menú Principal - Ayuda
stm_aix("p0i4","p0i0",[0,"   Ayuda     ","","",-1,-1,0,"","","","","","",6,0,0,"","",0,0,0,0,1,"#f4f4f4"]);
stm_bpx("p5","p1",[1,4,0,0,2,3,6,7]);
stm_ep();
stm_em();