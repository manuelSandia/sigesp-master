...
if ($ls_operacion=="BUSCAR")
   {    
	 ...
	 if(($_SESSION["la_empresa"]["esttipcont"]==2)&&($ls_tipctares==1 || $ls_tipctares==2))
	 {
	     $ls_resultado = $_SESSION["la_empresa"]["resultado_h"];
	 }
	 
	 if(($_SESSION["la_empresa"]["esttipcont"]==2)&&($ls_tipctares==5))
	 {
	     $ls_resultado = "32309";
	 }
					  ...
					  if ($ls_estctascg=='S')
					     {
						   ...
						   echo "<td style=text-align:center width=100><a href=\"javascript: aceptar('$ls_scgcta','$ls_denctascg');\">".$ls_scgcta."</a></td>";
						 }
...
<script language="JavaScript">
  function aceptar(cuenta,denominacion)
  {
	...
	if (objeto=='1')
      ...
      {
	    fop.txtctaejeprecie.value=cuenta;
	    fop.txtctaejeprecie.readOnly=true;
      }
    else if (objeto=='6')
     {
	   fop.txtctaconrepcajchi.value=cuenta;
	   fop.txtdencuentascg.value=denominacion;
	   fop.txtctaconrepcajchi.readOnly=true;
     }
	else
	 {
