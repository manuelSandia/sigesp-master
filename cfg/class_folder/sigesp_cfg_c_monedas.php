...
class sigesp_cfg_c_monedas
 {
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 {
				$lb_existe=$this->uf_select_monedas($as_codigo);
				if(!$lb_existe)
				{
				...
				{
					$this->io_msg->message("El Código de moneda ya existe");
				}
				 return $lb_valido;	
		  }
	      $this->io_sql->close();
...
//--------------------------------------------------------------------------------------------------------------------------------------
 ...
 //-------------------------------------------------------------------------------------------------------------------------------------
   function uf_select_monedas($as_codigo)
   {
   		/////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	Function:  uf_select_monedas
		//	Access:  public
		//	Arguments:	
		//	  Returns:	
		//	Description: Este método Elimina una moenda
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////
   		$lb_valido=false;	   
		$ls_sql=" SELECT codmon   ".
                "   FROM sigesp_moneda ".
                "  WHERE codmon='".$as_codigo."'"; 
		$rs_data=$this->io_sql->select($ls_sql);
		if ($rs_data==false)
		{
			$this->io_msg->message("CLASE->SIGESP_CFG_C_MONEDAS; METODO->uf_select_monedas; ERROR->".
								   $this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false; 
		}
		else
