...
*/		$io_pdf->restoreState();
	...
	function uf_print_detalle($la_data,$ai_i,&$io_pdf)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetDy(-2);
		$la_datatit[1]=array('codcencos'=>'<b><i>Codigo del Centro de Costo</i></b>','denominacion'=>'<b><i>Denominación</i></b>');
		$la_columnas=array('codcencos'=>'',
						   'denominacion'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codcencos'=>array('justification'=>'center','width'=>170), // Justificación y ancho de la columna
	...
	$ls_titulo="<b>LISTADOS DE CENTROS DE COSTOS</b>";
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=uf_insert_seguridad($ls_titulo); // Seguridad de Reporte
	if($lb_valido)
	{

		$lb_valido=$io_report->uf_select_centro_costo(); // Cargar el DS con los datos del reporte
		...
		else  // Imprimimos el reporte
		{
			...
			$li_totrow=$io_report->DS->getRowCount("codcencos");
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				$ls_codcencos=trim($io_report->DS->data["codcencos"][$li_i]);
				$ls_denominacion=$io_report->DS->data["denominacion"][$li_i];
				$la_data[$li_i]=array('codcencos'=>$ls_codcencos,'denominacion'=>$ls_denominacion);
			}
