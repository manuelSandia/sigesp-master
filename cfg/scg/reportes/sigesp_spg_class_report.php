...
class sigesp_spg_class_report
{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_select_centro_costo()
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_select_casamientos
		//         Access: public (sigesp_sep_p_solicitud)  
		...
		if ($rs_data===false)
		{		
			$this->io_mensajes->message("CLASE->Report MÉTODO->uf_select_centro_costo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
