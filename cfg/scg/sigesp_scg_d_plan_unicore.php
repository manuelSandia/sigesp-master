    ...
    <table width="658" height="170" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
		...
		<table width="614" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td width="91" height="22"><span class="Estilo1"></span></td>
            <td width="521" height="22"><span class="Estilo1"></span></td>
          </tr>
          <tr>
            <td height="22"><div align="right" class="fd-blanco">C&oacute;digo</div></td>
            <td height="22"><div align="left">
                <input name="txtcuenta" type="text" id="txtcuenta" value="<?php print $ls_cuenta?>" maxlength="9" onKeyPress="return keyRestrict(event,'1234567890');" onBlur="rellenar_cad(this.value,<?php print $li_size_form;?>)"  style="text-align:center ">
          ...
          <tr>
            ...
            <td height="22"><div align="left">
              <input name="txtdenominacion" type="text" id="txtdenominacion" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz '+',.-');" size="95" maxlength="250" value="<?php print $ls_denominacion?>">
            </div></td>
          </tr>
          <tr class="fd-blanco">
            <td height="22">&nbsp;</td>
