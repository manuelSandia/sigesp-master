...
function uf_load_relacion($as_cuenta)
{
  ...
  $lb_valido = false;
  // la consulta siguiente apuntaba a la tabla de plan unico y siempre iba a dar cierto, se cambio a scg_cuentas
  // 23/02/2010
  
  $ls_sql    = "SELECT sc_cuenta FROM scg_cuentas WHERE trim(sc_cuenta) like '".$as_cuenta."%'";
