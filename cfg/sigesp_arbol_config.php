<?php
$li_i = 0;
$ls_nivapr=$_SESSION["la_empresa"]["nivapro"];
$li_i++;//1
$arbol["sistema"][$li_i] 	   = "Sistemas";
$arbol["nivel"][$li_i]		   = 0;
$arbol["nombre_logico"][$li_i] = "Sigesp";
...
$arbol["sistema"][$li_i]	   = "Sistemas";
$arbol["nivel"][$li_i]		   = 1;
$arbol["nombre_logico"][$li_i] = "Centro de Costos Contables";
$arbol["nombre_fisico"][$li_i] = "../cfg/scg/sigesp_scg_d_centro_costo_contable.php";
$arbol["id"][$li_i]			   = $li_i;
$arbol["padre"][$li_i]		   = "015";
$arbol["numero_hijos"][$li_i]  = 0;
...
$arbol["sistema"][$li_i]="Sistemas";
$arbol["nivel"][$li_i]=1;
$arbol["nombre_logico"][$li_i]="Traspasos de Cuentas entre Estructuras Presupuestarias";
$arbol["nombre_fisico"][$li_i]="../cfg/spg/sigesp_spg_d_copiarplandecuentas.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="023";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["sistema"][$li_i]	   = "Sistemas";
$arbol["nivel"][$li_i]		   = 1;
$arbol["nombre_logico"][$li_i] = "Sucursales";
$arbol["nombre_fisico"][$li_i] = "../cfg/sigesp_cfg_d_sucursales.php";
$arbol["id"][$li_i]			   = $li_i;
$arbol["padre"][$li_i]		   = "001";
$arbol["numero_hijos"][$li_i]  = 0;
...
if ($ls_nivapr==1)
{
	...
	$arbol["sistema"][$li_i]	   = "Sistemas";
	$arbol["nivel"][$li_i]		   = 1;
	$arbol["nombre_logico"][$li_i] = "Definición de Nivel de Aprobación";
	$arbol["nombre_fisico"][$li_i] = "../cfg/sigesp_cfg_d_nivel_apro.php";
	$arbol["id"][$li_i]			   = $li_i;
	$arbol["padre"][$li_i]		   = "001";
	$arbol["numero_hijos"][$li_i]  = 0;
	...
	$arbol["sistema"][$li_i]	   = "Sistemas";
	$arbol["nivel"][$li_i]		   = 1;
	$arbol["nombre_logico"][$li_i] = "Configuración del Nivel de Aprobación";
	$arbol["nombre_fisico"][$li_i] = "../cfg/sigesp_cfg_d_asignacion_nivel_apro.php";
	$arbol["id"][$li_i]			   = $li_i;
	$arbol["padre"][$li_i]		   = "001";
	$arbol["numero_hijos"][$li_i]  = 0;
}
