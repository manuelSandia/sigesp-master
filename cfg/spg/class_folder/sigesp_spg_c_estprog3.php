...
function uf_spg_insert_estprog3($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_denestpro3,$as_codfuefin,$ai_estmodest,
                               $as_estcla,$as_chkrecuadi,$as_codcencos,$aa_seguridad)
{
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
    ...
    {	 
	  $ls_sql = " INSERT INTO spg_ep3 (codemp,codestpro1,codestpro2,codestpro3,denestpro3,codfuefin,estcla,estreradi,codcencos) ".
	            " VALUES ('".$as_codemp."','".$as_codestpro1."','".$as_codestpro2."','".$as_codestpro3."','".$as_denestpro3."','".$as_codfuefin."','".$as_estcla."','".$as_chkrecuadi."','".$as_codcencos."')";
	}
	else
	{
	  $ls_sql = " INSERT INTO spg_ep3 (codemp,codestpro1,codestpro2,codestpro3,denestpro3,estcla,estreradi,codcencos) ".
	            " VALUES ('".$as_codemp."','".$as_codestpro1."','".$as_codestpro2."','".$as_codestpro3."','".$as_denestpro3."','".$as_estcla."','".$as_chkrecuadi."','".$as_codcencos."')";
	}
...
function uf_spg_update_estprog3($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_denestpro3,$as_codfuefin,$as_estcla,
								$as_chkrecuadi,$as_codcencos,$aa_seguridad)
{
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 if($as_codfuefin=='')
    ...
    {	 
		$ls_sql=" UPDATE spg_ep3".
		  		"    SET denestpro3='".$as_denestpro3."' , estreradi='".$as_chkrecuadi."', codcencos='".$as_codcencos."' ".
	...
	{
		$ls_sql=" UPDATE spg_ep3".
		  		"    SET denestpro3='".$as_denestpro3."' , codfuefin='".$as_codfuefin."', estreradi='".$as_chkrecuadi."', codcencos='".$as_codcencos."' ".
        	    "  WHERE codemp='".$as_codemp."' AND codestpro1='".$as_codestpro1."' AND codestpro2='".$as_codestpro2."' AND ".
		   		"        codestpro3='".$as_codestpro3."' AND estcla='".$as_estcla."'  ";
	}
  $this->io_sql->begin_transaction();
