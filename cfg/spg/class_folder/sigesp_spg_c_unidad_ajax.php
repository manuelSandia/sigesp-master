...
//----------------------------------------------------------------------------------------------------------------------------------
	...
	{			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		for($li_fila=1;$li_fila<=$ai_total;$li_fila++)
		{
			...
			$ls_central=$io_funciones_configuracion->uf_obtenervalor("txtcentral".$li_fila,"");
			...
			$j=1;
			$lo_object[$li_fila][$j]="<input type=text name=txtcodestpro1".$li_fila."    id=txtcodestpro1".$li_fila." class=".$ls_estilo." style=text-align:center size=20 value='".$ls_codestpro1."'    readonly>";
			$j++;
			$lo_object[$li_fila][$j]="<input type=text name=txtcodestpro2".$li_fila."    id=txtcodestpro2".$li_fila." class=".$ls_estilo." style=text-align:center size=20 value='".$ls_codestpro2."'    readonly>";
			$j++;
			$lo_object[$li_fila][$j]="<input type=text name=txtcodestpro3".$li_fila."    id=txtcodestpro3".$li_fila." class=".$ls_estilo." style=text-align:center size=20 value='".$ls_codestpro3."'    readonly>";
			$j++;
			if($li_estmodest=='2')
			{
			$lo_object[$li_fila][$j]="<input type=text name=txtcodestpro4".$li_fila."    id=txtcodestpro4".$li_fila." class=".$ls_estilo." style=text-align:center size=20 value='".$ls_codestpro4."'    readonly>";
			$j++;
			$lo_object[$li_fila][$j]="<input type=text name=txtcodestpro5".$li_fila."    id=txtcodestpro5".$li_fila." class=".$ls_estilo." style=text-align:center size=20 value='".$ls_codestpro5."'    readonly>";
			$j++;
			$lo_object[$li_fila][$j]="<input type=text name=txtdenominacion".$li_fila."    class=".$ls_estilo." style=text-align:left   size=20 value='".$ls_denominacion."'    readonly>";
			$j++;
			$lo_object[$li_fila][$j]="<input type=text name=txttipo".$li_fila."    class=".$ls_estilo." style=text-align:left   size=20 value='".$ls_tipo."'    readonly>" .
			" <input type=hidden name=txtcentral".$li_fila."  id=txtcentral".$li_fila." value='".$ls_central."'> ".
		...
		if($ls_estceniva==1)
		{
			...
			print " 	  <td height='22' align='left'><a href='javascript:catalogo_estpro2();'><img src='../../shared/imagebank/tools/nuevo.gif' title='Agregar Presupuestaria para Otros Créditos' width='20' height='20' border='0'>Agregar Estructura Presupuestaria para Otros Créditos</a></td>";
			print "    </tr>";
			print "  </table>";
		}
		else
...
//----------------------------------------------------------------------------------------------------------------------------------
	...
	{			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql=" SELECT codemp,coduniadm,central,
		...
		$li_fila=1;
			...
			$lo_object[$li_fila][$j]="<input type=text name=txttipo".$li_fila."    class=".$ls_estilo." style=text-align:left   size=20 value='".$ls_tipo."'    readonly>" .
			" <input type=hidden name=txtestcla".$li_fila."  value='".$ls_estcla."'> ".
			" <input type=hidden name=txtcentral".$li_fila."  value='".$ls_central."'> ";
			}else
			{
			$lo_object[$li_fila][$j]="<input type=text name=txtdenominacion".$li_fila."    class=".$ls_estilo." style=text-align:left   size=20 value='".$ls_denominacion."'    readonly>" ;
			$j++;
