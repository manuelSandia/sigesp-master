...
function uf_spg_insert_estprog5($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,
							    $as_denestpro5,$as_codfuefin,$ai_estmodest,$as_estcla,$as_codcencos,$aa_seguridad)
{
	//////////////////////////////////////////////////////////////////////////////
    ...
    {	 
		$ls_sql="INSERT INTO spg_ep5(codemp,codestpro1,codestpro2,codestpro3,codestpro4,codestpro5,denestpro5,estcla,codcencos)".
				" VALUES ('".$as_codemp."','".$as_codestpro1."','".$as_codestpro2."','".$as_codestpro3."','".$as_codestpro4."','".$as_codestpro5."','".$as_denestpro5."','".$as_estcla."','".$as_codcencos."') ";
	}
	else
	{
		$ls_sql="INSERT INTO spg_ep5(codemp,codestpro1,codestpro2,codestpro3,codestpro4,codestpro5,denestpro5,codfuefin,estcla,codcencos)".
				" VALUES ('".$as_codemp."','".$as_codestpro1."','".$as_codestpro2."','".$as_codestpro3."','".$as_codestpro4."','".$as_codestpro5."','".$as_denestpro5."','".$as_codfuefin."','".$as_estcla."','".$as_codcencos."') ";
	}
...
function uf_spg_update_estprog5($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,
								$as_denestpro5,$as_codfuefin,$as_codcencos,$aa_seguridad)
{
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {	 
		$ls_sql="UPDATE spg_ep5".
				"   SET denestpro5='".$as_denestpro5."',codcencos='".$as_codcencos."'".
	...
	{
		$ls_sql="UPDATE spg_ep5".
				"   SET denestpro5='".$as_denestpro5."',codfuefin='".$as_codfuefin."',codcencos='".$as_codcencos."'".
				" WHERE codemp='".$as_codemp."' AND codestpro1='".$as_codestpro1."' AND codestpro2='".$as_codestpro2."'".
				"   AND codestpro3='".$as_codestpro3."' AND codestpro4='".$as_codestpro4."' AND codestpro5='".$as_codestpro5."'";
	}
	$this->io_sql->begin_transaction();
