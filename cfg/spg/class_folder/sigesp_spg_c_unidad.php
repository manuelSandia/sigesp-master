...
//------------------------------------------------------------------------------------------------------------------------------------------
	 function uf_guardar_dt_unidad_adm($as_codemp,$ls_codunieje,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5,$ls_estcla,$ls_status,$ls_central)
	{
		$lb_valido=$this->uf_select_unidad($as_codemp,$ls_codunieje);
		if($lb_valido)
		{
			$ls_cadena= " INSERT INTO spg_dt_unidadadministrativa(codemp,coduniadm,codestpro1,codestpro2,codestpro3,codestpro4,codestpro5,estcla,central) VALUES('".$as_codemp."','".$ls_codunieje."','".$ls_codestpro1."','".$ls_codestpro2."','".$ls_codestpro3."','".$ls_codestpro4."','".$ls_codestpro5."','".$ls_estcla."','".$ls_central."') ";
			$ls_evento="INSERT";
