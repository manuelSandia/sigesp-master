		   ...
		   if ($ai_estmodest=='1')
		      {
				...
				if(!$lb_existe)
				{
			     $lb_valido = $this->io_estpro5->uf_spg_insert_estprog5($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,'NINGUNO','--',$ai_estmodest,$as_estcla,'00',$aa_seguridad);
			    if (!$lb_valido)
				   {
				     $lb_valido = false;
