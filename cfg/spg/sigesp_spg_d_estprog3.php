	 ...
	 if ($lb_encontrado)
	    {
		  ...
		  if (!$lb_existe)
			 { 
			   $lb_valido = $io_estpro3->uf_spg_insert_estprog3($ls_codemp,$ls_codestp1,$ls_codestp2,$ls_codestp3,$ls_denestpro3,$ls_codfuefin,$li_estmodest,$ls_clasificacion,$ls_chkrecuadi,$ls_codcencos,$la_seguridad);		
			   if ($lb_valido)
				  {
				    $io_sql->commit();
			 ...
			 { 
			   $lb_valido = $io_estpro3->uf_spg_update_estprog3($ls_codemp,$ls_codestp1,$ls_codestp2,$ls_codestp3,$ls_denestpro3,$ls_codfuefin,$ls_clasificacion,$ls_chkrecuadi,$ls_codcencos,$la_seguridad);		
			   if ($lb_valido)
				  {
				    $io_sql->commit();
          ...
          <table width="603" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
			...
			?>
                <tr>
                 ...
                 <td height="22" colspan="3"><input name="txtcodcencos" type="hidden" id="txtcodcencos" maxlength="2" size="4"onKeyPress="return keyRestrict(event,'1234567890');"  style="text-align:center " >
                   <input name="txtdencencos" type="hidden" class="sin-borde" id="txtdencencos" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz '+'.,-')" size="50" maxlength="250"  readonly></td>
               </tr>
              <tr>
	            <td height="22" colspan="3"><input name="txtcodigo" type="hidden" id="txtcodigo" value="<?php print $ls_codfuefin;?>"> 
			   <input name="txtdenominacion" type="hidden" id="txtdenominacion" value="<?php print $ls_denfuefin;?>">               </tr>
			   <?php
			   }
			   ?>
              <tr class="formato-blanco">
