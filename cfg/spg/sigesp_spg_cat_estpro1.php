...
<form name="formulario" method="post" action="" id="formulario">
  <p align="center">&nbsp;</p>
	 ...
	 <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        <td height="22" colspan="2" style="text-align:center"><div id="detcodestpro1"></div></td>
       </tr>
    </table>
	 <div align="center"><br>
         <?php
			  ...
			  while ($row=$io_sql->fetch_row($rs_data))
			        {
					  ...
					  switch ($ls_destino)
				             {  
							   ...
							   break;
							   case "inter":
								 print "<td  style=text-align:center width=150><a href=\"javascript: aceptar3('$ls_codestpro1','$ls_denestpro1','$li_estmodest','$ls_estint','$ls_scgcta','$ls_denscgcta','$ls_estcla','$ls_estcencos');\">".$ls_codestpro1."</a></td>";
							   break;
					         }		
...
function aceptar3(codigo,deno,li_estmodest,ls_estint,ls_sccuenta,ls_denoctacont,ls_estcla,ls_estcencos)
  {
	...
	if(ls_estcencos==1)
	{
		   fop.chkestcencos.checked=true;
	}
	else
	{
		   fop.chkestcencos.checked=false;
	}
    close();
  }
