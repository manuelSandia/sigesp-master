...
?>
          ...
          <table width="649" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
              ...
              <tr class="formato-blanco">
                ...
                <td height="22" colspan="2"><div align="left">
                  <input name="txtdenestpro2" type="text" id="txtdenestpro2" style="text-align:left" value="<?php print $ls_denestpro2?>" size="93" maxlength="254" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+',-.;*&?¿!¡+()[]{}%@/'+'´áéíóú');">
                </div></td>
              </tr>
              <tr class="formato-blanco">
