...
if (array_key_exists("central",$_GET))
   {
	 $ls_central=$_GET["central"];
   }
else
   {
	 $ls_central="0";
...
?>      
      <tr>
        ...
        <td width="380" height="22"><input name="txtcodestpro1" type="text" id="txtcodestpro1"  size="22" maxlength="<?php print $li_maxlength ?>" style="text-align:center"></td>
      </tr>
      <tr>
        <td width="118" height="22"><div align="right"><?php print $arr["nomestpro2"] ?></div></td>
        <td width="380" height="22"><input name="txtcodestpro2" type="text" id="txtcodestpro2"  size="22" maxlength="<?php print $li_maxlength ?>" style="text-align:center"></td>
      </tr>
      <tr>
        <td width="118" height="22"><div align="right"><?php print $arr["nomestpro3"] ?></div></td>
        <td width="380" height="22"><input name="txtcodestpro3" type="text" id="txtcodestpro3"  size="22" maxlength="<?php print $li_maxlength ?>" style="text-align:center"></td>
      </tr>
      <tr>
        <td width="118" height="22"><div align="right"><?php print $arr["nomestpro4"] ?></div></td>
        <td width="380" height="22"><input name="txtcodestpro4" type="text" id="txtcodestpro4"  size="22" maxlength="<?php print $li_maxlength ?>" style="text-align:center"></td>
      </tr>
      <tr>
        <td width="118" height="22"><div align="right"><?php print $arr["nomestpro5"] ?></div></td>
        <td width="380" height="22"><input name="txtcodestpro5" type="text" id="txtcodestpro5"  size="22" maxlength="<?php print $li_maxlength ?>" style="text-align:center"></td>
      </tr>
      <tr>
	...
	if ($li_estmodest==1)
	   {
		  if ($ls_tipo=="grid")		
		  {
		 	$ls_sql="SELECT SUBSTR(spg_ep3.codestpro1,".$li_longestpro1.",25) as codestpro1,
				      ...
				      WHERE spg_ep3.codestpro1 like '%$ls_codestpro1%' 
					    AND spg_ep3.codestpro2 like '%$ls_codestpro2%' 
	   ...
	   {	     
		 $ls_sql="SELECT SUBSTR(a.codestpro1,".$li_longestpro1.",25) AS codestpro1,
				   ...
				   WHERE e.codestpro1 like '%".$ls_codestpro1."%'
				     AND e.codestpro2 like '%".$ls_codestpro2."%'
				     AND e.codestpro3 like '%".$ls_codestpro3."%'
				     AND e.codestpro4 like '%".$ls_codestpro4."%'
  ...
  <script language="javascript">alert('No Existen Estructuras Presupuestaria');close();</script> 
	...
	else
	{
		while ($row=$io_sql->fetch_row($rs_data))
			...
			if ($ls_tipo=="reporte")		
			   {
				 print "<td width=200 align=\"center\"><a href=\"javascript: aceptar_rep('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro1)."</td>";
				 print "<td width=100 align=\"center\"><a href=\"javascript: aceptar_rep('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro2)."</td>";
				 print "<td width=100 align=\"center\"><a href=\"javascript: aceptar_rep('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro3)."</a></td>";
				 if ($li_estmodest=='2')
				    {
					  print "<td width=100 align=\"center\"><a href=\"javascript: aceptar_rep('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro4)."</td>";
					  print "<td width=100 align=\"center\"><a href=\"javascript: aceptar_rep('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro5)."</a></td>";
					}
				 print "<td width=180 align=\"left\">".trim($ls_denominacion)."</td>";
					     if ($ls_estcla=='P')
							{
			...
			if ($ls_tipo=="rephas")		
			   {
				 print "<td width=200 align=\"center\"><a href=\"javascript: aceptar_rephas('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro1)."</td>";
				 print "<td width=100 align=\"center\"><a href=\"javascript: aceptar_rephas('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro2)."</td>";
				 print "<td width=100 align=\"center\"><a href=\"javascript: aceptar_rephas('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro3)."</a></td>";
			     if ($li_estmodest=='2')
				    {
					  print "<td width=100 align=\"center\"><a href=\"javascript: aceptar_rephas('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro4)."</td>";
					  print "<td width=100 align=\"center\"><a href=\"javascript: aceptar_rephas('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".trim($ls_codestpro5)."</a></td>";
					}
				 print "<td width=180 align=\"left\">".trim($ls_denominacion)."</td>";
					     if ($ls_estcla=='P')
							{
			   ...
			   if ($ls_tipo=="grid")		
			   {
				 print "<td width=100 align=\"center\"><a href=\"javascript: ue_aceptar_grid('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_denestpro3','$li_estmodest','$ls_estcla','$ls_central');\">".trim($ls_codestpro1)."</td>";
				 print "<td width=100 align=\"center\"><a href=\"javascript: ue_aceptar_grid('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_denestpro3','$li_estmodest','$ls_estcla','$ls_central');\">".trim($ls_codestpro2)."</td>";
				 print "<td width=100 align=\"center\"><a href=\"javascript: ue_aceptar_grid('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_denestpro3','$li_estmodest','$ls_estcla','$ls_central');\">".trim($ls_codestpro3)."</a></td>";
			     if ($li_estmodest=='2')
				    {
					  print "<td width=100 align=\"center\"><a href=\"javascript: ue_aceptar_grid('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_denestpro5','$li_estmodest','$ls_estcla','$ls_central');\">".trim($ls_codestpro4)."</td>";
					  print "<td width=100 align=\"center\"><a href=\"javascript: ue_aceptar_grid('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_denestpro5','$li_estmodest','$ls_estcla','$ls_central');\">".trim($ls_codestpro5)."</a></td>";
					   print "<td width=180 align=\"left\">".trim($ls_denominacion)."</td>";
					}
					else
					{
...
function aceptar(ls_codestpro1,ls_denestpro1,ls_codestpro2,ls_denestpro2,ls_codestpro3,ls_denestpro3,ls_codestpro4,ls_denestpro4,ls_codestpro5,ls_denestpro5,ls_submit,ls_estcla,as_scgctaint)
{
  ...
  function aceptar_rep(ls_codestpro1,ls_codestpro2,ls_codestpro3,ls_codestpro4,$ls_denestpro4,ls_codestpro5,ls_denestpro5,ls_estcla)
  {
	fop.codestpro1.value    = ls_codestpro1;
	fop.codestpro2.value    = ls_codestpro2;
	fop.codestpro3.value    = ls_codestpro3;
	...
	li_estmodest            = "<?php print $li_estmodest ?>";
    //alert(' valor cambiado:'+ls_estcla);
	if (li_estmodest=='2')
	   {
	     fop.codestpro4.value = ls_codestpro4;	
	     fop.codestpro5.value = ls_codestpro5;
  ...
  function aceptar_rephas(ls_codestpro1,ls_codestpro2,ls_codestpro3,ls_codestpro4,$ls_denestpro4,ls_codestpro5,ls_denestpro5,ls_estcla)
  {
	fop.codestpro1h.value     = ls_codestpro1;
	fop.codestpro2h.value     = ls_codestpro2;
...
function ue_search()
{
	...
	f.action="sigesp_cat_public_estpro.php?tipo=<?php print $ls_tipo; ?>&central=<?php print $ls_central; ?>";
	f.submit();
}

function ue_aceptar_grid(ls_codestpro1,ls_codestpro2,ls_codestpro3,ls_codestpro4,ls_codestpro5,ls_denominacion,ls_estmodest,ls_estcla,ls_central)
{
	//---------------------------------------------------------------------------------
	...
	for(j=1;(j<rowestpro)&&(valido);j++)
	{
		...
		codestpro3grid=eval("opener.document.form1.txtcodestpro3"+j+".value");
		estclagrid    =eval("opener.document.form1.txtestcla"+j+".value");
		central    =eval("opener.document.form1.txtcentral"+j+".value");
		...
		if(ls_estmodest==2)
		{
			...
			parametros=parametros+"&txtcodestpro1"+j+"="+codestpro1grid+"&txtcodestpro2"+j+"="+codestpro2grid+""+
				   ...
				   "&txtestcla"+j+"="+estclagrid+"&txtcentral"+j+"="+central;	
		}
		else
		{
			dencodestprogrid=eval("opener.document.form1.txtdenominacion"+j+".value");
	...
	if(ls_estmodest==2)
	{
		parametros=parametros+"&txtcodestpro1"+rowestpro+"="+ls_codestpro1+ "&txtcodestpro2"+rowestpro+"="+ls_codestpro2+""+
						  ...
						  "&txtestcla"+rowestpro+"="+ls_estcla+""+"&totrowestpro="+totalestpro+"&txtcentral"+rowestpro+"="+ls_central;
	}else
	{
		parametros=parametros+"&txtcodestpro1"+rowestpro+"="+ls_codestpro1+ "&txtcodestpro2"+rowestpro+"="+ls_codestpro2+""+
