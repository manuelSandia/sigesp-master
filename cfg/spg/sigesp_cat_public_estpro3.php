...
<script language="JavaScript">
  ...
  {
    opener.document.formulario.denestpro3.value=deno;
	opener.document.formulario.codestpro3.value=codestprog;
	if(estcla=="PROYECTO")
	{
	  estcla="P";
	}
  ...
  function aceptar_apertura(codestprog,deno,li_estmodest,estcla)
  {
	...
	if(li_estmodest==1)
	{
		opener.document.formulario.operacion.value="CARGAR";
  ...
  {
	opener.document.formulario.codestpro3.value=codestprog;
	opener.document.formulario.codestpro3.readOnly=true;
	if(estcla=="PROYECTO")
	{
	  estcla="P";
	}
  ...
  {
	opener.document.formulario.codestpro3h.value=codestprog;
	opener.document.formulario.codestpro3h.readOnly=true;
	if(estcla=="PROYECTO")
	{
	  estcla="P";
	}
