...
elseif ($ls_operacion=="BUSCAR")
   {
     ...
     { 	 
		$ls_sql="  SELECT SUBSTR(codestpro1,".$li_longestpro1.",25) as codestpro1,".
				...
				"         ep5.denestpro5,ep5.estcla,'' as codfuefin, '' as denfuefin,ep5.codcencos,".
				"		 (SELECT denominacion FROM sigesp_cencosto WHERE spg_ep3.codemp=sigesp_cencosto.codemp ".
				"		     AND spg_ep3.codcencos=sigesp_cencosto.codcencos) as dencencos".
				" FROM spg_ep5 as ep5".
	...
	else
	{
		$ls_sql="  SELECT  SUBSTR(codestpro1,".$li_longestpro1.",25) as codestpro1,".
				...
				"         SUBSTR(codestpro4,".$li_longestpro4.",25) as codestpro4,".
				"         SUBSTR(codestpro5,".$li_longestpro5.",25) as codestpro5,".
				"         ep5.denestpro5,ep5.estcla,ff.codfuefin,ff.denfuefin,ep5.codcencos,".
				"		 (SELECT denominacion FROM sigesp_cencosto WHERE ep5.codemp=sigesp_cencosto.codemp ".
				"		     AND ep5.codcencos=sigesp_cencosto.codcencos) as dencencos".
	...
	if($io_sql->num_rows($rs_data)==0)
	 ...
	 {	
		while($row=$io_sql->fetch_row($rs_data))
		{
				...
				{
					print "<td width=250 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro5','$ls_denestpro5','$ls_codfuefin','$ls_denfuefin','$ls_estcla','$ls_codcencos','$ls_dencencos');\">".trim($ls_codestpro1)."</td>";
					print "<td width=150 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro5','$ls_denestpro5','$ls_codfuefin','$ls_denfuefin','$ls_estcla','$ls_codcencos','$ls_dencencos');\">".trim($ls_codestpro2)."</td>";
					print "<td width=50 align=\"center\"><a href=\"javascript:  aceptar('$ls_codestpro5','$ls_denestpro5','$ls_codfuefin','$ls_denfuefin','$ls_estcla','$ls_codcencos','$ls_dencencos');\">".trim($ls_codestpro3)."</td>";
					print "<td width=50 align=\"center\"><a href=\"javascript:  aceptar('$ls_codestpro5','$ls_denestpro5','$ls_codfuefin','$ls_denfuefin','$ls_estcla','$ls_codcencos','$ls_dencencos');\">".trim($ls_codestpro4)."</a></td>";
					print "<td width=50 align=\"center\"><a href=\"javascript:  aceptar('$ls_codestpro5','$ls_denestpro5','$ls_codfuefin','$ls_denfuefin','$ls_estcla','$ls_codcencos','$ls_dencencos');\">".trim($ls_codestpro5)."</a></td>";
					print "<td width=250 align=\"left\">".trim($ls_denestpro5)."</td>";
					print "</tr>";
				}
...
function aceptar(ls_codestpro5,ls_denestpro5,ls_codfuefin,ls_denfuefin,ls_estcla,ls_codcencos,ls_dencencos)
{
	...
	if (ls_opener!='sigesp_cfg_d_consolidacion.php')
	   {
		 ...
		 switch(ls_maestro)
		 {
			case 'Y':
				...
				fop.txtcodcencos.value    = ls_codcencos;
				fop.txtdencencos.value = ls_dencencos;
