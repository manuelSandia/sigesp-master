...
<script language="JavaScript">
  ...
  function aceptar_rep(codestpro4,estcla)
  {
	...
	opener.document.formulario.codestpro4.value=codestpro4;
	opener.document.formulario.codestpro4.readOnly=true;
	if(estcla=="PROYECTO")
	{
	  estcla="P";
	}
  ...
  {
	opener.document.formulario.codestpro4h.value=codestpro4;
	opener.document.formulario.codestpro4h.readOnly=true;
	if(estcla=="PROYECTO")
	{
	  estcla="P";
	}
