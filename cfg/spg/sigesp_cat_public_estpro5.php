...
<script language="JavaScript">
  ...
  {
	opener.document.formulario.codestpro5.value=codestprog;
	opener.document.formulario.codestpro5.readOnly=true;
	if(estcla=="PROYECTO")
	{
	  estcla="P";
	}
  ...
  {
	opener.document.formulario.codestpro5h.value=codestprog;
	opener.document.formulario.codestpro5h.readOnly=true;
	if(estcla=="PROYECTO")
	{
	  estcla="P";
	}
