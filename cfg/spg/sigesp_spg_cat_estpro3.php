...
<form name="formulario" method="post" action="">
  <p align="center">&nbsp;</p>
	 ...
	 <table width="600" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        <td height="22" colspan="2" style="text-align:center"><div id="detcodestpro3"></div></td>
      </tr>
	</table>
	 <p align="center">
<?php
...
elseif ($ls_operacion=="BUSCAR")
   {
    ...
    {	 
		 $ls_sql="SELECT substr(codestpro1,".$li_longcodestpro1.",25) as codestpro1,
						 ...
						 denestpro3,estcla,estreradi, '' as codfuefin, 
	...
	{	
		 $ls_sql="SELECT substr(codestpro1,".$li_longcodestpro1.",25) as codestpro1,
						 ...
						 sigesp_fuentefinanciamiento.denfuefin,codcencos,
						 (SELECT denominacion FROM sigesp_cencosto WHERE spg_ep3.codemp=sigesp_cencosto.codemp 
						     AND spg_ep3.codcencos=sigesp_cencosto.codcencos) as dencencos
			  ...
			  while ($row=$io_sql->fetch_row($rs_data))
			        {
					  ...
					  if (array_key_exists('session_activa',$_SESSION))
					     ...
					     {
						   echo "<td width=150 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro3','$ls_denestpro3','$ls_codfuefin','$ls_denfuefin','$ls_estcla','$ls_estreradi','$ls_codcencos','$ls_dencencos');\">".trim($ls_codestpro1)."</td>";
						   echo "<td width=100 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro3','$ls_denestpro3','$ls_codfuefin','$ls_denfuefin','$ls_estcla','$ls_estreradi','$ls_codcencos','$ls_dencencos');\">".trim($ls_codestpro2)."</td>";
						   echo "<td width=50  align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro3','$ls_denestpro3','$ls_codfuefin','$ls_denfuefin','$ls_estcla','$ls_estreradi','$ls_codcencos','$ls_dencencos');\">".trim($ls_codestpro3)."</a></td>";
...
function aceptar(ls_codestpro3,ls_denestpro3,ls_codfuefin,ls_denfuefin,ls_estcla,ls_estreradi,ls_codcencos,ls_dencencos)
{
