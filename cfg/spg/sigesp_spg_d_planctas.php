...
if  (array_key_exists("status",$_POST))
	...
	if (array_key_exists("operacion",$_POST))
	...
	else
	   {
		...
		$title[1]="Cuenta Presupuestaria";   
		$title[2]="Denominación";     
		$title[3]="Cuenta Contable";		
		$title[4]="Cta. Contable Articulos";
		$title[5]="Edición";
  		//Nombr del grid
		$grid1="grid";	
		 ...
		 for ($i=1;$i<=$total;$i++)
		     {
			   ...
			   $object[$i][4]="<input type=text name=txtcuentascgart".$i." value=''  class=sin-borde readonly style=text-align:center size=20 maxlength=25 onKeyPress=\"return keyRestrict(event,'1234567890');\"><a href=javascript:cat_plan2(".$i.");><img src=../../shared/imagebank/tools15/buscar.gif alt='Catalogo de Cuentas Contablese ' width=15 height=15 border=0></a>";
			   $object[$i][5] ="<a href=javascript:uf_delete_dt('".$i."');><img src=../../shared/imagebank/tools15/eliminar.gif alt=Cancelar Registro de Detalle Presupuestario width=15 height=15 border=0></a>";
		     }
		 $lastrow      = 0;
	   } 
		 ...
		 for ($i=1;$i<=$total;$i++)
	 	     {
			   ...
			   $ls_dencuentaspg = $_POST["txtdencuenta".$i];
		  	   ...
		  	   $ls_cuentascgart = trim($_POST["txtcuentascgart".$i]);
			   if (($ls_cuentaspg!="")&&($ls_dencuentaspg!="")&&($ls_cuentascg!=""))
			      {
				    ...
				    if ($lb_valido)//Si la cuenta es valida me permite insertar la cuenta
				       {
					     $lb_valido=$sig_spgcta->uf_procesar_cuentas($ls_cuentaspg,$ls_dencuentaspg,$la_estpro,$ls_cuentascg,$ls_cuentascgart,$la_security);
			   ...
			   $object[$i][4]="<input type=text name=txtcuentascgart".$i." value='".$ls_cuentascgart."' class=sin-borde readonly style=text-align:center size=20 maxlength=25 onKeyPress=\"return keyRestrict(event,'1234567890');\"><a href=javascript:cat_plan2(".$i.");><img src=../../shared/imagebank/tools15/buscar.gif alt='Catalogo de Cuentas Contablese ' width=15 height=15 border=0></a>";
			   $object[$i][5] ="<a href=javascript:uf_delete_dt('".$i."');><img src=../../shared/imagebank/tools15/eliminar.gif alt=Cancelar Registro de Detalle Presupuestario width=15 height=15 border=0></a>";
		     }
	...
	if ($ls_operacion=="DELETE")
	   {
			   ...
			   if ($i!=$li_fila_del)
			      {
					...
					$object[$li_temp][4]="<input type=text name=txtcuentascgart".$li_temp." value='".$ls_cuentascgart."' class=sin-borde readonly style=text-align:center size=20 maxlength=25 onKeyPress=\"return keyRestrict(event,'1234567890');\"><a href=javascript:cat_plan2(".$li_temp.");><img src=../../shared/imagebank/tools15/buscar.gif alt='Catalogo de Cuentas Contablese ' width=15 height=15 border=0></a>";
					$object[$li_temp][5] ="<a href=javascript:uf_delete_dt('".$li_temp."');><img src=../../shared/imagebank/tools15/eliminar.gif alt=Cancelar Registro de Detalle Presupuestario width=15 height=15 border=0></a>";
			      }
			   else
			      {
				    $li_fila_del=0;
		 ...
		 $object[$total][4]="<input type=text name=txtcuentascgart".$total." value='".$ls_cuentascgart."' class=sin-borde readonly style=text-align:center size=20 maxlength=25 onKeyPress=\"return keyRestrict(event,'1234567890');\"><a href=javascript:cat_plan2(".$total.");><img src=../../shared/imagebank/tools15/buscar.gif alt='Catalogo de Cuentas Contablese ' width=15 height=15 border=0></a>";
		 $object[$total][5] ="<a href=javascript:uf_delete_dt('".$total."');><img src=../../shared/imagebank/tools15/eliminar.gif alt=Cancelar Registro de Detalle Presupuestario width=15 height=15 border=0></a>";
	   ...
	   { 
		 ...
		 for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
		  { 
			 ...
			 $object[$li_s][4]="<input type=text name=txtcuentascgart".$li_s." value='".$ls_cuentascgart."'  class=sin-borde readonly style=text-align:center size=20 maxlength=25 onKeyPress=\"return keyRestrict(event,'1234567890');\"><a href=javascript:cat_plan2(".$li_s.");><img src=../../shared/imagebank/tools15/buscar.gif alt='Catalogo de Cuentas Contablese ' width=15 height=15 border=0></a>";
			 $object[$li_s][5] ="<a href=javascript:uf_delete_dt('".$li_s."');><img src=../../shared/imagebank/tools15/eliminar.gif alt=Cancelar Registro de Detalle Presupuestario width=15 height=15 border=0></a>";
		  }
...
function cat_plan(fila)
{
	...
	{
		window.open("sigesp_sel_scg_plancuentaspg.php?fila="+fila+"&campo=0","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes,dependent=yes");
	}
	else
	{
...
function cat_plan2(fila)
{
	ls_cuentaspg=eval("f.txtcuentaspg"+fila+".value;");
	ls_dencuenta=eval("f.txtdencuenta"+fila+".value;");
	if((ls_cuentaspg!="")&&(ls_dencuenta!=""))
	{
		window.open("sigesp_sel_scg_plancuentaspg.php?fila="+fila+"&campo=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes,dependent=yes");
	}
	else
	{
		alert("Seleccione la cuenta presupuestaria");
