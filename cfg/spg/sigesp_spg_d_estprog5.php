...
?>
 ...
 <?php print $ls_nomniv5 ?></td>
          ...
          <tr class="formato-blanco">
            ...
            <td height="22" colspan="2"><div align="left">
                <input name="txtdenestpro5" type="text" id="txtdenestpro5" style="text-align:left" value="<?php print $ls_denestpro5 ?>" size="91" maxlength="254" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+',-.;*&?¿!¡+()[]{}%@/'+'´áéíóú');">
            </div></td>
          </tr>
<?php
	if (!array_key_exists('session_activa',$_SESSION))
