...
<script language="JavaScript">
  ...
  {
    opener.document.formulario.denestpro2.value=deno;
	opener.document.formulario.codestpro2.value=codestprog2;
  ...
  {
	opener.document.formulario.codestpro2.value=codestprog2;
	opener.document.formulario.codestpro2.readOnly=true;
	opener.document.formulario.codestpro3.value="";
	if(estcla=="PROYECTO")
	{
	  estcla="P";
  ...
  {
	opener.document.formulario.codestpro2h.value=codestprog2;
	opener.document.formulario.codestpro2h.readOnly=true;
