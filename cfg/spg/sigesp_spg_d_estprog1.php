...
if (array_key_exists("chkestcencos",$_POST))
   {
     $ls_chkestcencos = $_POST["chkestcencos"];
   }
else
	{
	  $ls_chkestcencos = "0";
...
if ($ls_operacion == "GUARDAR")
   {
	 ...
	 echo $ls_clasificacion;
	 $lb_existe        = $io_estpro1->uf_spg_select_estprog1($ls_codemp,$ls_codestpro1,$ls_clasificacion); 
	 if (!$lb_existe)
	    {
          $lb_valido = $io_estpro1->uf_spg_insert_estprog1($ls_codemp,$ls_codestpro1,$ls_denestpro1,$ls_clasificacion,$ls_chkintercom,$ls_cuenta,$ls_chkestcencos,$la_seguridad);		
		  if ($lb_valido)
		     {
			   $io_sql->commit();
	    ...
	    { 
		  $lb_valido = $io_estpro1->uf_spg_update_estprog1($ls_codemp,$ls_codestpro1,$ls_denestpro1,$ls_clasificacion,$ls_chkintercom,$ls_cuenta,$ls_chkestcencos,$la_seguridad);		
		  if ($lb_valido)
		     {
			   $io_sql->commit();
          ...
          <table width="565" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
			...
			if ($li_estmodest=='2')
			 ...
			 $bloqueado='block';
				 ...
				 <tr class="formato-blanco">
				   <td height="22"><div align="right">
				     <input name="chkestcencos" type="checkbox" id="chkestcencos" <?php print $ls_chkestcencos; ?> value="1">
				   </div></td>
				   <td height="22" colspan="2" align="left">Centro de Costos </td>
		    </tr>
				 <tr class="formato-blanco">
