...
<script language="JavaScript">
  ...
  {
    opener.document.formulario.codestpro1.value=codigo;
    opener.document.formulario.denestpro1.value=deno;
	opener.document.formulario.codestpro2.value="";
    opener.document.formulario.denestpro2.value="";
	opener.document.formulario.codestpro3.value="";
    opener.document.formulario.denestpro3.value="";
	if(estcla=="PROYECTO")
	{
	  estcla="P";
	}
  ...
  {
    opener.document.formulario.codestpro1.value=codigo;
	opener.document.formulario.codestpro1.readOnly=true;
	opener.document.formulario.codestpro2.value="";
	opener.document.formulario.codestpro3.value="";
	if(estcla=="PROYECTO")
	{
	...
	opener.document.formulario.estclades.value=estcla;
	close();
  }
  ...
  {
    opener.document.formulario.codestpro1h.value=codigo;
	opener.document.formulario.codestpro1h.readOnly=true;
	opener.document.formulario.codestpro2h.value="";
	opener.document.formulario.codestpro3h.value="";
	if(estcla=="PROYECTO")
	{
	  estcla="P";
	}
	...
	opener.document.formulario.estclahas.value=estcla;
	close();
  }
