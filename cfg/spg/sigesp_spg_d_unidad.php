...
//		f.totrowestpro.value=1;
		existe=false;
		for (j=1;j<rowestpro;j++) 
		{
			central   = eval("document.form1.txtcentral"+j+".value");
			if(central==1)
			{
				existe=true;
			}
		...
		if(existe)
		{
			alert("Solo se debe agregar una estructura para centralizar el iva");
		}
		else
		{
			ls_codestpro1 = "";
			...
			ls_estcla ='P';	
			li_estmodest = "<?php print $li_estmodest ?>";
			pagina="sigesp_cat_public_estpro.php?tipo=grid&central=1";
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=630,height=450,resizable=yes,location=no");
		}
}
				  ...
				  if (ls_estmodest==2)
					 {
					   ...
					   parametros   = parametros+"&txtcodestpro1"+li_i+"="+codestpro1+"&txtcodestpro2"+li_i+"="+codestpro2+""+
							                     ...
							                     "&txtestcla"+li_i+"="+estcla+"&txtcentral"+li_i+"="+central;	
					 }
				  else
					 {
					   parametros   = parametros+"&txtcodestpro1"+li_i+"="+codestpro1+"&txtcodestpro2"+li_i+"="+codestpro2+""+
