    ...
    <tr>
      <td width="616" height="221"><table width="564"  border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td width="385" height="22"><input name="txtcodigo" type="text" id="txtcodigo" size="10" maxlength="3" onKeyPress="return keyRestrict(event,'0123456789');" value="<?php print $ls_codigo ?>"  style="text-align:center "  onBlur="javascript: ue_rellenarcampo(this,3);">
