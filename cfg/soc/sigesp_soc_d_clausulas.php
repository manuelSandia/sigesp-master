      ...
      <td width="517" height="170"><div align="center">
        <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
          ...
          <tr>
            ...
            <td height="22" colspan="3" rowspan="2"><textarea name="txtdenominacion" cols="90" rows="3" id="txtdenominacion" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+'.,-');" ><?php print $ls_dencla;?></textarea></td>
          </tr>
          <tr>
            <td height="22">&nbsp;</td>
            <td height="22">&nbsp;</td>
