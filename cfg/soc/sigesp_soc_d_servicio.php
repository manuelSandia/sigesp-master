...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_nuevo();"><img src="../../shared/imagebank/tools20/nuevo.gif" title="Nuevo" alt="Nuevo" width="20" height="20" border="0"></a><a href="javascript:ue_guardar();"><img src="../../shared/imagebank/tools20/grabar.gif" title="Guardar" alt="Grabar" width="20" height="20" border="0"></a><a href="javascript:ue_buscar();"><img src="../../shared/imagebank/tools20/buscar.gif" title="Buscar" alt="Buscar" width="20" height="20" border="0"></a><a> <img src="../../shared/imagebank/tools20/imprimir.gif" title="Imprimir" alt="Imprimir" width="20" height="20"></a><a href="javascript:ue_eliminar();"><img src="../../shared/imagebank/tools20/eliminar.gif" title="Eliminar" alt="Eliminar" width="20" height="20" border="0"></a><a href="sigespwindow_blank.php"><img src="../../shared/imagebank/tools20/salir.gif" title="Salir" alt="Salir" width="20" height="20" border="0"></a></td>
  </tr>
</table>
<?php 
...
if (array_key_exists("operacion",$_POST))
   {
	 ...
	 $li_tottipiva1   	  = $_POST["tottipiva1"];
	 $li_tottipiva2       = $_POST["tottipiva2"];
	 $li_tottipiva3       = $_POST["tottipiva3"];
   }
else
   {
     $ls_operacion    = "NUEVO";
	 ...
	 if(empty($ls_codigo))
	   {
        ...
        for ($i=1;$i<=5;$i++)
	        {//4 			   
	    	  $object[$i][1]="<input name=tipoiva".$i." id=tipoiva".$i." type=hidden value=$ld_tipoiva > <input type=text name=txtcodcar".$i."  id=txtcodcar".$i."  value=''  class=sin-borde  readonly  style=text-align:center  size=5>";
			  $object[$i][2]="<input type=text name=txtdencar".$i."  value=''  class=sin-borde  readonly  style=text-align:center  size=30>";
		   	  ...
		   	  $object[$i][4]="<input type=text name=txtdentipoiva".$i."  value=''  class=sin-borde  readonly  style=text-align:center  size=15>";
			  $object[$i][5]="<a href=javascript:uf_delete(".$i.");><img src=../../shared/imagebank/tools20/eliminar.gif alt=Aceptar width=15 height=15 border=0></a>";
	        }
	    $total=5;	
    }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if ($ls_operacion=="CARGAR")
	 {       
        ...
        $ls_sql=" SELECT c.codser as codigo,c.codcar as cargo,s.dencar as denominacion, s.porcar as porcentaje,s.tipo_iva, ".
				" CASE s.tipo_iva WHEN ".
         ...
         if ($row=$io_sql->fetch_row($rs_data))
            ...
            {							                  
               ...
               $ld_tipoiva = $data["tipo_iva"][$i];
			   $ls_dentipoiva=trim($data["dentipo_iva"][$i]); ;
               $li_row    = $li_row+1;
			   switch($ld_tipoiva)
			   {
			    case 1:
			   ...
			   $object[$i][1]="<input name=tipoiva".$li_row." id=tipoiva".$li_row." type=hidden value=$ld_tipoiva > <input name=txtcodcar".$li_row." type=text  id=txtcodcar".$li_row."  class=sin-borde  size=5 style=text-align:center   value='".$ls_codcar."' readonly>";
			   ...
			   $object[$i][4]="<input name=txtdentipoiva".$li_row." type=text  id=txtdentipoiva".$li_row."  class=sin-borde  size=15 style=text-align:center  value='".$ls_dentipoiva."' readonly>";
		   	   $object[$i][5]="<a href=javascript:uf_delete(".$li_row.");><img src=../../shared/imagebank/tools20/eliminar.gif alt=Aceptar width=15 height=15 border=0></a>";
             }           
         }
         else
         {
             ...
             for ($i=1;$i<=5;$i++)
	         {//4 			   
	    	    $object[$i][1]="<input name=tipoiva".$i." id=tipoiva".$i." type=hidden value=$ld_tipoiva > <input type=text name=txtcodcar".$i."  value=''  class=sin-borde  readonly  style=text-align:center  size=5>";
			    $object[$i][2]="<input type=text name=txtdencar".$i."  value=''  class=sin-borde  readonly  style=text-align:center  size=30>";
		   	    $object[$i][3]="<input type=text name=txtporcar".$i."  value=''  class=sin-borde  readonly  style=text-align:center   size=10>";
		   	    $object[$i][4]="<input type=text name=txtdentipoiva".$i."  value=''  class=sin-borde  readonly  style=text-align:center   size=15>";
				$object[$i][5]="<a href=javascript:uf_delete(".$i.");><img src=../../shared/imagebank/tools20/eliminar.gif alt=Aceptar width=15 height=15 border=0></a>";
    ...
    {             
	   ...
	   $li_tipoivaeli =$_POST["tipoiva".$li_rowdel]; // Tipo de Cargo a Eliminar
	   if(($li_tipoivaeli == 1)&&($li_tottipiva3 == 1))
	   {
	    $io_msg->message("No puede eliminar el cargo General, existe uno Adicional asociado, debe eliminarlo primero!!!");
		uf_cargar_det();
	   }
	   else
	   {
	     for($li_i=1;$li_i<=$li_total;$li_i++)
         {
	        ...
	        {		
			   ...
			   $ld_tipoiva	=$_POST["tipoiva".$li_i];
			   $ls_dentipoiva	=$_POST["txtdentipoiva".$li_i];    
               $object[$li_temp][1]="<input name=tipoiva".$li_temp." id=tipoiva".$li_temp." type=hidden value=$ld_tipoiva > <input name=txtcodcar".$li_temp."  type=text id=txtcodcar".$li_temp."  class=sin-borde  size=5  value='".$ls_codcar."' readonly>";
			   ...
			   $object[$li_temp][4]="<input name=txtdentipoiva".$li_temp."  type=text id=txtdentipoiva".$li_temp."  class=sin-borde  size=15 value='".$ls_dentipoiva."'>";
	           $object[$li_temp][5]="<a href=javascript:uf_delete(".$li_temp.");><img src=../../shared/imagebank/tools20/eliminar.gif alt=Aceptar width=15 height=15 border=0></a>";
            }
	        else
	        {	
		       $li_tipoivadel = $_POST["tipoiva".$li_rowdel]; 
			   switch($li_tipoivadel)
			   {
			    case 1:
						$li_tottipiva1--;
						break;
   ...
   {     
	 ...
	 if ($lb_existe)
        {           
	      if ($ls_estatus=="NUEVO")
		     {
			   $io_msg->message("Este Código de Servicio ya existe !!!");
			    uf_cargar_det(); 
			   $lb_valido=false;
			 }
  ...
  if ($lb_valido)
  {
   for ($i=1;$i<=5;$i++)
       { 			   
		  ...
		  $object[$i][2]="<input type=text name=txtdencar".$i."  value=''  class=sin-borde  readonly  style=text-align:center  size=30>";
		  $object[$i][3]="<input type=text name=txtporcar".$i."  value=''  class=sin-borde  readonly  style=text-align:center   size=10>";
		  $object[$i][4]="<input type=text name=txtdentipoiva".$i."  value=''  class=sin-borde  readonly  style=text-align:center   size=10>";
		  $object[$i][5]="<a href=javascript:uf_delete(".$i.");><img src=../../shared/imagebank/tools20/eliminar.gif alt=Aceptar width=15 height=15 border=0></a>";
	   }
	$total=5;
  }
	   ...
	   {//1            
		  ...
		  for ($li_i=1;$li_i<=$total;$li_i++)
			  {//2
				...
				$object[$li_i][1]="<input name=tipoiva".$li_i." id=tipoiva".$li_i." type=hidden value=$ld_tipoiva > <input name=txtcodcar".$li_i." type=text id=txtcodcar".$li_i." class=sin-borde  size=5  style=text-align:center  value='".$ls_codcar."'  readonly>";
				...
				$object[$li_i][4]="<input name=txtdentipoiva".$li_i." type=text id=txtdentipoiva".$li_i." class=sin-borde  size=15  style=text-align:center  value='".$ls_dentipoiva."'    readonly>";
				$object[$li_i][5]="<a href=javascript:uf_delete(".$li_i.");><img src=../../shared/imagebank/tools20/eliminar.gif alt=Aceptar width=15 height=15 border=0></a>";
			  }//2
	   }//1      
	   ...
	   {           
          ...
          for($i=1;$i<=$total;$i++)
          {
		      if (array_key_exists("txtcodcar".$i,$_POST))
		      {
				...
				$ld_tipoiva	   =$_POST["tipoiva".$i]; 
				$ls_dentipoiva =$_POST["txtdentipoiva".$i];    
				$object[$i][1]="<input name=tipoiva".$i." id=tipoiva".$i." type=hidden value=$ld_tipoiva > <input name=txtcodcar".$i." type=text id=txtcodcar".$i." class=sin-borde  size=5  style=text-align:center  value='".$ls_codcar."'  readonly>";
				...
				$object[$i][4]="<input name=txtdentipoiva".$i." type=text id=txtdentipoiva".$i." class=sin-borde  size=10  style=text-align:center  value='".$ls_dentipoiva."' readonly>";
				$object[$i][5]="<a href=javascript:uf_delete(".$i.");><img src=../../shared/imagebank/tools20/eliminar.gif alt=Aceptar width=15 height=15 border=0></a>";
			 }		  
	         else
	         {	  
				 $object[$i][1]="<input name=tipoiva".$i." id=tipoiva".$i." type=hidden value='' > <input type=text name=txtcodcar".$i."  id=txtcodcar".$i." value='' class=sin-borde readonly  style=text-align:center  size=5>";
				 $object[$i][2]="<input type=text name=txtdencar".$i." value='' class=sin-borde readonly  style=text-align:center  size=30>";
				 $object[$i][3]="<input type=text name=txtporcar".$i." value='' class=sin-borde readonly  style=text-align:center  size=10>"; 
				 $object[$i][4]="<input type=text name=txtdentipoiva".$i." value='' class=sin-borde readonly  style=text-align:center  size=15>"; 
				 $object[$i][5]="<a href=javascript:uf_delete(".$i.");><img src=../../shared/imagebank/tools20/eliminar.gif alt=Aceptar width=15 height=10 border=0></a>";
			 }
          }     
       }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			   ...
			   if ($lb_valido)
				  {
				    ...
				    for ($i=1;$i<=5;$i++)
					    {			   
						  $object[$i][1]="<input name=tipoiva".$i." id=tipoiva".$i." type=hidden value=0> <input type=text name=txtcodcar".$i."  value=''  class=sin-borde  readonly  style=text-align:center  size=5>";
						  $object[$i][2]="<input type=text name=txtdencar".$i."  value=''  class=sin-borde  readonly  style=text-align:center  size=30>";
						  $object[$i][3]="<input type=text name=txtporcar".$i."  value=''  class=sin-borde  readonly  style=text-align:center   size=10>";
						  $object[$i][4]="<input type=text name=txtdentipoiva".$i."  value=''  class=sin-borde  readonly  style=text-align:center   size=15>";
						  $object[$i][5]="<a href=javascript:uf_delete(".$i.");><img src=../../shared/imagebank/tools20/eliminar.gif alt=Aceptar width=15 height=15 border=0></a>";
			   ...
			   else
				  {
				    ...
				    for ($i=1;$i<=$li_lastrow;$i++)
					    {			   
						  ...
						  $ld_tipoiva    = $_POST["tipoiva".$i];
						  $ls_dentipoiva = $_POST["txtdentipoiva".$i];
						  $object[$i][1]="<input name=tipoiva".$i." id=tipoiva".$i." type=hidden value=".$ld_tipoiva."> <input type=text name=txtcodcar".$i."  id=txtcodcar".$i."  value='".$ls_codcar."'  class=sin-borde  readonly  style=text-align:center  size=5>";
						  ...
						  $object[$i][4]="<input type=text name=txtdentipoiva".$i."  id=txtdentipoiva".$i."  value='".$ls_dentipoiva."'  class=sin-borde  readonly  style=text-align:center  size=15>";
						  $object[$i][5]="<a href=javascript:uf_delete(".$i.");><img src=../../shared/imagebank/tools20/eliminar.gif alt=Aceptar width=15 height=15 border=0></a>";
					    }
				    $total=$li_lastrow;	 
				  }	
	 ...
	 else
	   {
	        ...
	        for ($i=1;$i<=5;$i++)
	            {			   
					...
					$object[$i][2]="<input type=text name=txtdencar".$i."  value=''  class=sin-borde  readonly  style=text-align:center  size=30>";
					$object[$i][3]="<input type=text name=txtporcar".$i."  value=''  class=sin-borde  readonly  style=text-align:center   size=10>";
					$object[$i][4]="<input type=text name=txtdentipoiva".$i."  id=txtdentipoiva".$i."  value=''  class=sin-borde  readonly  style=text-align:center  size=15>";
					$object[$i][5]="<a href=javascript:uf_delete(".$i.");><img src=../../shared/imagebank/tools20/eliminar.gif alt=Aceptar width=15 height=15 border=0></a>";
	            }
	        $total=5;	 
	   } 
...
<table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
      ...
      <tr> 
        ...
        <td height="22"><p>
          <input name="txtdenominacion" id="txtdenominacion" value="<?php print $ls_denominacion ?>" type="text" size="70" maxlength="254"  onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+'.,-');">
        </p>        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="22" colspan="2"><a href="javascript:catalogo_cargos();"><img src="../../shared/imagebank/tools20/nuevo.gif" width="20" height="20" border="0" alt="Registrar Detalles Contables">Agregar Cargos </a>
          ...
          <input name="freerows"  type="hidden"   id="freerows" >
          
          <input   name="filadel"  type="hidden"   id="filadel">
          <input   name="tottipiva1"  type="hidden"   id="tottipiva1" value="<?php print $li_tottipiva1;?>">
          <input   name="tottipiva2"  type="hidden"   id="tottipiva2" value="<?php print $li_tottipiva2;?>">
          <input   name="tottipiva3"  type="hidden"   id="tottipiva3" value="<?php print $li_tottipiva3;?>"></td>
      </tr>
      <tr>
...
function catalogo_cargos()
{
	...
	window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=712,height=400,resizable=yes,location=no");
} 		
							    ...
							    if (campo_requerido(txtcuenta,"La Cuenta debe estar llena !!")==false)
							    ...
							    else
								   {
									if (campo_requerido(txtcodunimed,"La Unidad de medida debe estar llena !!")==false)
									   ...
									   {
										 if((tottipiva3.value == 1)&&(tottipiva1.value == 0))
										 {
										  alert("Debe agregar tambien un cargo tipo General, no se permite sólo agregar uno Adicional, verifique por favor")
										 }
										 else
										 {
