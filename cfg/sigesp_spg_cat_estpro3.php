			  ...
			  while ($row=$io_sql->fetch_row($rs_data))
			        {
					  ...
					  if (array_key_exists('session_activa',$_SESSION))
					     ...
					     {
						   echo "<td width=150 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_denestpro3','$ls_estcla');\">".trim($ls_codestpro1)."</td>";
						   echo "<td width=100 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_denestpro3','$ls_estcla');\">".trim($ls_codestpro2)."</td>";
						   echo "<td width=50  align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_denestpro3','$ls_estcla');\">".trim($ls_codestpro3)."</a></td>";
...
function aceptar(as_codestpro1,as_codestpro2,as_codestpro3,as_denestpro3,as_estcla)
{
  ls_opener     = fop.id;
