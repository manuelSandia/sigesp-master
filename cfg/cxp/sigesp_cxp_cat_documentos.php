...
$ls_sql=" SELECT codtipdoc,dentipdoc,estpre,estcon,tipodocanti,tipdocdon ".
        " FROM cxp_documento ".
  ...
  {//1
    ...
    for($z=1;$z<=$totrow;$z++)
       {//2
		...
		print "<td style=text-align:center><a href=\"javascript: aceptar('$codigo','$denominacion','$presupuest','$contable','$anticipo','$ls_docdon');\">".$codigo."</a></td>";
...
<script language="JavaScript">
function aceptar(c,d,p,t,anticipo,docdon)
{
	...
	if(docdon==1)
	{ 
	  opener.document.form1.chktipdon.checked=true;
	}
