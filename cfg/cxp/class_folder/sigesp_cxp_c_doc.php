...
function uf_insert_documento($as_coddoc,$as_dendoc,$as_presu,$as_conta,$as_anticipo,$as_tipdon,$aa_seguridad) 
{
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
	...
	$ls_sql=" INSERT INTO cxp_documento (codtipdoc,dentipdoc,estcon,estpre,tipodocanti,tipdocdon)".
			" VALUES ('".$as_coddoc."','".$as_dendoc."','".$li_conta."','".$li_presu."','".$as_anticipo."','".$as_tipdon."')";
...
function uf_update_documento($as_coddoc,$as_dendoc,$as_presu,$as_conta,$as_anticipo,$as_tipdon,$aa_seguridad) 
{
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
	  ...
	  $ls_sql=" UPDATE cxp_documento ".
			  " SET dentipdoc='".$as_dendoc."',estcon='".$li_conta."', estpre='".$li_presu."',".
			  "     tipodocanti='".$as_anticipo."',tipdocdon='".$as_tipdon."' ".
