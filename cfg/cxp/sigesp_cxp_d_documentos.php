...
if (array_key_exists("chktipdon",$_POST))
   {
     $ls_tipdon          = $_POST["chktipdon"]; 
   }
else
   {
     $ls_tipdon          = 0;
	 ...
	 if ($lb_existe)
        { 
		  ...
		  elseif($ls_estatus=="GRABADO")
		     {
	           $lb_valido=$io_doc->uf_update_documento($ls_codigo,$ls_dendoc,$ls_presu,$ls_conta,$ls_anticipo,$ls_tipdon,$la_seguridad);
	           if ($lb_valido)
		          {
	    	        $io_sql->commit();
	         ...
	         {  
		       $lb_valido=$io_doc->uf_insert_documento($ls_codigo,$ls_dendoc,$ls_presu,$ls_conta,$ls_anticipo,$ls_tipdon,$la_seguridad);
	           if ($lb_valido)
		          {
		            $io_sql->commit();
    ...
    <td width="542" height="196"><div align="center">
      <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
        ...
        <tr>
          ...
          <td width="28" height="22"><input name="chktipodoc" type="checkbox" class="sin-borde" id="chktipodoc" value="1" <?php print $ls_anticipo ?>></td>
          <td width="130">Anticipo</td>
          <td width="242"><input name="chktipdon" type="checkbox" class="sin-borde" id="chktipdon" value="1">
            Donaci&oacute;n</td>
