        ...
        <tr>
          <td width="781" height="266"><div align="center">
            <table width="637"  border="0" align="center" class="formato-blanco" cellpadding="0" cellspacing="0">
              ...
              <tr>
              	<td height="22" align="right" >Tipo de Iva</td>
                 <td height="22" align="left" >
                 <select name="tipoiva" onClick="document.getElementById('val_tipoiva').value=this.options[this.selectedIndex].value;">
            ...
            <input name="val_tipoiva" type="hidden" id="val_tipoiva">
          </div></td>
        </tr>
  </table>
  <p>&nbsp;</p>
