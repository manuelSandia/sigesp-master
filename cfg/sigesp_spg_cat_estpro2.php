  ...
  <p align="center">
    <input name="operacion" type="hidden" id="operacion">
	 ...
	 <table width="550" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        <td height="22" colspan="2" style="text-align:center"><div id="detcodestpro2"></div></td>
  </tr>    </table>
  <div align="center"><br>
<?php
			  ...
			  while ($row=$io_sql->fetch_row($rs_data))
			        {
					  ...
					  echo "<td width=30 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro2','$ls_denestpro2');\">".trim($ls_codestpro1)."</td>";
					  echo "<td width=30 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro2','$ls_denestpro2');\">".trim($ls_codestpro2)."</a></td>";
...
function aceptar(as_codestpro2,as_denestpro2)
{
