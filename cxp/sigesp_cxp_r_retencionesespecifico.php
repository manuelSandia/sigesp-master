...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td height="19" align="center"><div align="right"><strong>Deduccion</strong></div></td>
      <td width="515" height="19" align="center"><div align="left"></div></td>
    </tr>
    <tr>
      <td height="19" align="center"><div align="right"></div></td>
    ...
    <tr>
      <td height="22" colspan="2" align="center"><input name="rdtipded" type="radio" class="sin-borde" value="T" checked onClick="javascript: ue_validar_filtro();">
TODAS<input name="rdtipded" type="radio" class="sin-borde" value="S"  onClick="javascript: ue_validar_filtro();">
I.S.L.R.
  <input name="rdtipded" type="radio" class="sin-borde" value="I"  onClick="javascript: ue_validar_filtro();">
Ret. IVA
<input name="rdtipded" type="radio" class="sin-borde" value="M"  onClick="javascript: ue_validar_filtro();">
Ret. Municipal
<input name="rdtipded" type="radio" class="sin-borde" value="A"  onClick="javascript: ue_validar_filtro();">
Ret. Aporte Social 
<input name="rdtipded" type="radio" class="sin-borde" value="1" onClick="javascript: ue_validar_filtro();">
1x1000
<input name="rdtipded" type="radio" class="sin-borde" value="O"  onClick="javascript: ue_validar_filtro();">
Otras </td>
    </tr>
    <tr>
      <td height="22" colspan="2" align="center">&nbsp;</td>
...
{
	f=document.formulario;
	if(f.rdtipded[0].checked==false)
	{
		alert("No se puede tener indicado un tipo de deduccion para utilizar este filtro");
	}
	else
	{
...
function ue_print()
{
	...
	if(li_imprimir==1)
	{
		...
		if((fecdes!="")&&(fechas!=""))
		{
			...
			pagina=pagina+"&codprobenhas="+codprobenhas+"&fecdes="+fecdes+"&fechas="+fechas+"&codded="+codded+"&dended="+dended+"&tiporeporte="+tiporeporte;
		...
		{
			alert("Debe indicar intervalo de fechas");
		}
	}
	else
	{
...
function ue_openexcel()
{
	...
	if(li_imprimir==1)
	{
		...
		if((fecdes!="")&&(fechas!=""))
		{
			...
			pagina=pagina+"&codprobenhas="+codprobenhas+"&fecdes="+fecdes+"&fechas="+fechas+"&codded="+codded+"&dended="+dended;
			window.open(pagina,"reporte","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no,left=0,top=0");
		}
		else
		{
...
function ue_validar_filtro()
{
	f=document.formulario;
	codded=f.txtcodded.value;
	if(codded!="")
	{
		alert("No se puede tener indicado una deduccion para utilizar este filtro");
		f.rdtipded[0].checked=true;
	}
}
</script>
</html>