...
function ue_aceptar(numrecdoc,codtipdoc,cedbene,codpro,codcla,fecemidoc,fecregdoc,fecvendoc,montotdoc,
					...
					codestpro2,codestpro3,codestpro4,codestpro5,estcla,estact,numordpagmin,codtipfon,repcajchi,codproalt,nomproalt,ls_conanurd,tipdocdon)
{
	...
	else
	{
		...
		opener.document.formulario.cmbcodtipdoc.value=codtipdoc+"-"+estcon+"-"+estpre+"-"+tipdocdon;
		opener.document.formulario.cmbcodtipdoc.disabled=true;
		opener.document.formulario.codtipdoc.value=codtipdoc+"-"+estcon+"-"+estpre+"-"+tipdocdon;
...
function ue_aceptar_solicitud(numrecdoc,dencondoc,codtipdoc,dentipdoc,montotdoc,cedbene,codpro,codproalt)
{
	//---------------------------------------------------------------------------------
...
*/		if(numrecdocgrid==numrecdoc)
	...
	for(j=1;(j<rowrecepciones)&&(valido);j++)
	{
		...
		parametros=parametros+"&txtnumrecdoc"+j+"="+numrecdocgrid+"&txtcodtipdoc"+j+"="+codtipdocgrid+""+
				   "&txtdentipdoc"+j+"="+dentipdocgrid+"&txtmontotdoc"+j+"="+montotdocgrid+"&txtauxpro"+j+"="+auxprogrid+"&txtauxben"+j+"="+auxbengrid+"&txtcodproalt"+j+"="+auxcodproalt+""; ;
	...
	parametros=parametros+"&txtnumrecdoc"+j+"="+numrecdoc+"&txtcodtipdoc"+j+"="+codtipdoc+""+
			   "&txtdentipdoc"+j+"="+dentipdoc+"&txtmontotdoc"+j+"="+montotdoc+"&txtauxpro"+j+"="+codpro+"&txtauxben"+j+"="+cedbene+"&txtcodproalt"+j+"="+codproalt+"&totrowrecepciones="+totalrecepciones+"&total="+montotal+"";
