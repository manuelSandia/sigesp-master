<?php
	...
	$ls_reporte=$io_fun_cxp->uf_select_config("CXP","REPORTE","FORMATO_RETENCION","sigesp_cxp_rpp_retenciongeneral.php","C");
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="22" colspan="3" align="center">Reporte de Retenciones General </td>
    </tr>
...
function ue_print()
{
	...
	if(li_imprimir==1)
	{
		...
		if((fecdes!="")&&(fechas!=""))
		{
			...
			pagina="reportes/"+formato+"?fecdes="+fecdes+"&fechas="+fechas+"&tiporeporte="+tiporeporte;
