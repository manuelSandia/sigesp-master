<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_solicitudesimputacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<td class="toolbar" width="25"><div align="center"><a href="javascript: ue_ayuda();"></a><a href="javascript: ue_openexcel();"></a><a href="javascript: ue_cerrar();"><img src="../shared/imagebank/tools20/salir.gif" alt="Salir" width="20" height="20" border="0" title="Salir"></a></div></td>
    <td class="toolbar" width="25"><div align="center"></a></div></td>
...
var patron2 = new Array(1,3,3,3,3)
	...
	function uf_imprimir()
	{
			...
			if(li_imprimir==1)
			{
				...
				formato="sigesp_cxp_rpp_solicitudesimputacion.php";
	...
	function ue_openexcel()
	{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/"+"sigesp_cxp_rpp_solicitudesf1_excel.php"+"?tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fecemides="+fecemides+"&fecemihas="+fecemihas+"&emitida="+emitida+"&contabilizada="+contabilizada+"&anulada="+anulada+"&propago="+propago+"&pagada="+pagada+"&tiporeporte="+tiporeporte+"";
				window.open(pantalla,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			}
			else
			{alert("No tiene permiso para realizar esta operación");}
