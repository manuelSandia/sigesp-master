...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_detalle($la_data,$as_titcuentas,$ai_i,&$io_pdf)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetDy(-2);
		$la_datatit[1]=array('codcar'=>'<b>Código</b>','dencar'=>'<b>Denominación</b>','codestpro'=>'<b>'.$as_titcuentas.'</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codcar'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
						 			   'dencar'=>array('justification'=>'center','width'=>165), // Justificación y ancho de la columna
						 			   'codestpro'=>array('justification'=>'center','width'=>160), // Justificación y ancho de la columna
						 			   'spg_cuenta'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'porcar'=>array('justification'=>'center','width'=>35), // Justificación y ancho de la columna
						 			   'formula'=>array('justification'=>'center','width'=>100))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('codcar'=>array('justification'=>'left','width'=>40), // Justificación y ancho de la columna
						 			   'dencar'=>array('justification'=>'left','width'=>165), // Justificación y ancho de la columna
						 			   'codestpro'=>array('justification'=>'center','width'=>160), // Justificación y ancho de la columna
						 			   'spg_cuenta'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'porcar'=>array('justification'=>'right','width'=>35), // Justificación y ancho de la columna
						 			   'formula'=>array('justification'=>'left','width'=>100))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>470), // Justificación y ancho de la columna
