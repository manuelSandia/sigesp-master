...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,&$io_pdf)
	{
		...
		$io_pdf->line(15,73,585,73);  //linea horizontal del firmante		
		$io_pdf->line(15,115,585,115);//linea horizontal del firmante		
		$io_pdf->line(190,60,190,130);//linea vertical del firmante		
		$io_pdf->line(390,60,390,130);//linea vertical del firmante		
		//$io_pdf->line(380,60,380,130);		
		$io_pdf->addText(55,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(50,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(210,122,7,"VERIFICADO POR CONTROL PRESUPUESTARIO"); // Agregar el título
		$io_pdf->addText(230,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		//$io_pdf->addText(275,122,7,"VERIFICADO POR"); // Agregar el título
		//$io_pdf->addText(257,63,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(410,122,7,"VERIFICADO POR DPTO. DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(425,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
