...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(153,60,153,130);		
		$io_pdf->line(380,60,380,130);		
		$io_pdf->addText(20,122,7,"Control Presupuestario"); // Agregar el título
		$io_pdf->addText(20,63,7,"Fecha:"); // Agregar el título
		$io_pdf->addText(237,122,7,"Contabilidad"); // Agregar el título
		$io_pdf->addText(155,63,7,"Fecha:"); // Agregar el título
		$io_pdf->addText(440,122,7,"Sub-Dirección Administrativa"); // Agregar el título
		$io_pdf->addText(385,63,7,"Fecha:"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
