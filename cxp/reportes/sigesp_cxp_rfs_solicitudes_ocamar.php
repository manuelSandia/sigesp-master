...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->addText(42,75,7,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]); // Agregar el título
		...
		$io_pdf->addText(295,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(285,75,7,"CN EMMY DA COSTA"); // Agregar el título
		$io_pdf->addText(247,63,7,"DIRECCIÓN DE ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->addText(460,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(460,75,7,"CN JUAN C. FLORES"); // Agregar el título
		$io_pdf->addText(460,63,7,"DIRECCIÓN GENERAL"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
