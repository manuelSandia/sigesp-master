...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,&$io_pdf)
	{
		...
		$io_pdf->addText(72,63,7,"Nombre"); // Agregar el título
		$io_pdf->addText(240,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(245,63,7,"Nombre del Gerente"); // Agregar el título
		...
		$io_pdf->addText(440,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(445,63,7,"Nombre del Gerente"); // Agregar el título
