...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],15,710,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$io_pdf->addText(110,740,5,"REPUBLICA BOLIVARIANA DE VENEZUELA"); // Agregar el título
		$io_pdf->addText(110,730,5,"GOBIERNO DEL DISTRITO CAPITAL"); // Agregar el título
		...
		$io_pdf->line(180,60,180,130);		
		$io_pdf->line(380,60,380,130);		
		//$io_pdf->line(380,60,380,130);		
		$io_pdf->addText(60,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(63,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(257,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(245,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(450,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(432,63,7,"ADMINISTRACIÓN Y SERVICIOS"); // Agregar el título
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera1($as_codasiona,$as_periodo,$as_nombemp,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data[1]=array('titulo'=>'<b> Año:</b>  '.$as_periodo.'<b>              Organismo o Ente:</b>  '.$as_codasiona.'                    '.$as_nombemp);
		...
		$la_data[1]=array('titulo'=>'<b> Unidad Administrativa:          </b> 00001                DESPACHO DEL JEFE O JEFA DE GOBIERNO DEL DISTRITO CAPITAL');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[1]=array('titulo'=>'<b>Ubicacion Geografica:                                   Region </b>                            CAPITAL');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[1]=array('titulo'=>'<b>Municipio: </b>                                        LIBERTADOR                          <b>Ciudad:</b>             CARACAS');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera2($as_codasiona,$as_periodo,$as_nombemp,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_cabecera
		//		   Access: private 
		...
		$la_data[2]=array('titulo'=>'<b> Codigo de la Accion Centralizada:         			                                         Tipo de Accion Centralizada</b>  ');
		...
		$la_data[1]=array('titulo'=>'<b> Codigo del Proyecto:          	   			                                                            Nombre del Proyecto</b>');
		$la_data[2]=array('titulo'=>"                            ");
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera4($as_compromisosoc,$as_compromisosos,$as_compromisossep,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_cabecera
		//		   Access: private 
		//	    Arguments: as_compromisosoc    // Numero de la Solicitud de Pago
		//	   			   as_compromisosos    // Codigo del Proveedor / Beneficiario
		//	   			   as_compromisossep    // Nombre del Proveedor / Beneficiario
		//	    		   io_pdf // Instancia de objeto pdf
		//    Description: función que imprime la cabecera 
		//	   Creado Por: Ing. Yesenia Moreno / Ing. Luis Lang
		// Fecha Creación: 17/05/2007
		...
		if($as_compromisosoc!="")
		{
			$la_data[$li_i]=array('titulo'=>'     Ordenes de Compra: '.$as_compromisosoc);
			$li_i++;
		}
		if($as_compromisosos!="")
		{
			$la_data[$li_i]=array('titulo'=>'     Ordenes de Servicio: '.$as_compromisosos);
			$li_i++;
		}
		if($as_compromisossep!="")
		{
			$la_data[$li_i]=array('titulo'=>'     Solicitudes de Ejecución Presupuestaria: '.$as_compromisossep);
			$li_i++;
		}
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'innerLineThickness' =>0.5,
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>570))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'<b>Compromisos Asociados</b>',$la_config);
		$io_pdf->ezSetDy(-2);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera3($as_dencla,$as_codfuefin,$as_denfuefin,$as_nomban,$as_ctaban,$as_rifpro,$as_numsol,$as_codigo,$as_nombre,$as_denfuefin,$ad_fecemisol,$as_consol,$as_obssol,
							   $ai_monsol,$as_monto,&$io_pdf)
	{
		...
		// Fecha Creación: 17/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data[1]=array('titulo'=>'<b>R.I.F.:</b> '.$as_rifpro.'                    <b> Beneficiario:</b> '.$as_nombre);
		$la_data[2]=array('titulo'=>' ');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
		...
		$la_data[1]=array('titulo'=>'<b>Abonese en el Banco:</b>                    '.$as_nomban.'                        <b>Cta. Nro.:</b>                    '.$as_ctaban);
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[1]=array('titulo'=>'<b>La cantidad de :   </b>'.$as_monto,);
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		if($ls_tiporeporte==1)
		{
			$as_titulo=" NETO A PAGAR Bs.F.: ";
		}
		else
		{
			$as_titulo=" NETO A PAGAR Bs.: ";
		}
		$la_data[1]=array('titulo'=>' ','contenido'=>'');
		$la_data[2]=array('titulo'=>'<b>'.$as_titulo.'</b>','contenido'=>'<b>'.$ai_monsol.'</b>',);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
		...
		$as_origen='SEGUN LEY';
		if($as_ctaban==''){
			$as_medipago='PAGO CON CHEQUE';
		}else{
			$as_medipago='ABONO EN CUENTA';
		}
		if($as_denfuefin=='---seleccione---'){
			$as_denfuefin='';
			$as_codfuefin='';
		}
		$la_data[1]=array('titulo'=>'<b>Fuente de Financiamiento:</b>          '.$as_codfuefin.'-'.$as_denfuefin.'        <b>Origen:</b>          '.$as_origen);
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		unset($la_columnas);
		unset($la_config);
		if($as_dencla=='---seleccione---'){
			$as_dencla='';
		}
		$la_data[1]=array('titulo'=>'<b>Tipo de Pago:</b>          '.$as_dencla.'          <b>Medio de Pago:</b>          '.$as_medipago);
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle_spg($la_codaccpro,$la_estcla,$aa_data,$ai_totpre,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		global $ls_tiporeporte;
		if($la_estcla=='A'){
			$io_pdf->addText(185,590,8,$la_codaccpro);
			//$io_pdf->addText(110,540,5,'AC-0101');
		}
		if($la_estcla=='P'){
			$io_pdf->addText(125,578,8,$la_codaccpro);
			//$io_pdf->addText(110,540,5,'AC-0101');
		}
		if($ls_estmodest==1)
		{
	...
	$ls_nombemp= $_SESSION["la_empresa"]["nombre"];
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				if($io_report->DS->data["tipproben"][$li_i]=='P')
				{
					$ls_nomban=$io_report->DS->data["nomban_prov"][$li_i];
					$ls_ctaban=$io_report->DS->data["ctaban_prov"][$li_i];				
				}
				else
				{
					$ls_nomban=$io_report->DS->data["nomban_bene"][$li_i];
					$ls_ctaban=$io_report->DS->data["ctaban_bene"][$li_i];
				}
				...
				$ls_compromisosos="";
				$ls_compromisossep="";
				$rs_compromisos=$io_report->uf_select_compromisos_relacionados($ls_numsol);
				...
				while(!$rs_compromisos->EOF)
				{
					...
					{
						case "SOCCOS":
							$ls_compromisosoc=$ls_numdoccom." ; ";
						break;
						case "SOCCOC":
							$ls_compromisosos=$ls_numdoccom." ; ";
						break;
						case "SEPSPC":
							$ls_compromisossep=$ls_numdoccom." ; ";
						break;
					}
				...
				uf_print_cabecera1($ls_codasiona,$ls_periodo,$ls_nombemp,&$io_pdf);
				uf_print_cabecera2($ls_codasiona,$ls_periodo,$ls_nombemp,&$io_pdf);
				uf_print_cabecera3($ls_dencla,$ls_codfuefin,$ls_denfuefin,$ls_nomban,$ls_ctaban,$ls_rifpro,$ls_numsol,$ls_codigo,$ls_nombre,$ls_denfuefin,$ld_fecemisol,$ls_consol,$ls_obssol,$li_monsol,$ls_monto,&$io_pdf);
				uf_print_cabecera4($ls_compromisosoc,$ls_compromisosos,$ls_compromisossep,&$io_pdf);
...
//////////////////////////   GRID DETALLE PRESUPUESTARIO		//////////////////////////////////////
						...
						if($lb_valido)
						{
							...
							for($li_s=1;$li_s<=$li_totrowspg;$li_s++)
							{
								...
								$ls_estcla=$io_report->ds_detalle_spg->data["estcla"][$li_s];
								...
								$ls_codaccpro=substr($ls_codestpro,21,4);
								if($ls_estmodest==1)
								{
									$la_data[$li_s]=array('codestpro'=>$ls_codestpro1." - ".$ls_codestpro2,
							...
							uf_print_detalle_spg($ls_codaccpro,$ls_estcla,$la_data,$li_totpre,&$io_pdf);
							unset($la_data);
						}
					}
//////////////////////////      GRID DETALLE PRESUPUESTARIO		//////////////////////////////////////
