<?php
	...
	function uf_print_encabezado($as_agente,$as_nombre,$as_rif,$as_nit,$as_telefono,$as_direccion,&$io_pdf)
	{
		...
		$la_data=array(array('name'=>'<b>DATOS DEL AGENTE DE RETENCION</b>'),
					   array('name'=>'<b>Nombre o Razón Social:</b>'."  ".$as_agente),
					   array('name'=>'<b>RIF:</b>'."  ".$_SESSION["la_empresa"]["rifemp"]."                                                        <b>NIT:</b> ".$_SESSION["la_empresa"]["nitemp"]),
					   array('name'=>'<b>Direccion:</b>'."  ".$_SESSION["la_empresa"]["direccion"]),
					   array('name'=>'<b>Telefono:</b>'."  ".$_SESSION["la_empresa"]["telemp"]));
		...
		$la_data=array(array('name'=>'<b>DATOS DEL AGENTE SUJETO A RETENCION</b>'),
					   ...
					   array('name'=>'<b>RIF:</b>'."  ".$as_rif."                                                       <b>NIT:</b>  ".$as_nit),
					   array('name'=>'<b>Direccion:</b>'."  ".$as_direccion),
					   array('name'=>'<b>Telefono:</b>'."  ".$as_telefono));
		$la_columna=array('name'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras						 
						 'showLines'=>1, // Mostrar Líneas
