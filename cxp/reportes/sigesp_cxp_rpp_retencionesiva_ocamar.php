<?PHP
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>322, // Orientación de la tabla
		...
		$io_pdf->addText(505,485,9,$ad_fecrep); // Agregar el titulo								 
	...
	function uf_print_detalle($la_data,$ai_totconiva,$ai_totsiniva,$ai_totbasimp,$ai_totmonimp,$ai_totivaret,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array(//'numche'=>array('justification'=>'center','width'=>110),
									   ...
									   'codope'=>array('justification'=>'center','width'=>100),
									   ...
									   'numnotdeb'=>array('justification'=>'center','width'=>60),
  						 			   'numnotcre'=>array('justification'=>'center','width'=>60),
									   ...
									   'baseimp'=>array('justification'=>'center','width'=>80),
						 			   'porimp'=>array('justification'=>'center','width'=>55),
   						 			   'totimp'=>array('justification'=>'center','width'=>80),
		...
		unset($la_columna);
		unset($la_config);
		$la_data[1]=array(/*'numche'=>'','fecche'=>'',*/'codope'=>'','fecfac'=>'','numfac'=>'','numref'=>'','numnotdeb'=>'TOTAL','numnotcre'=>'',
		                  'name1'=>$ai_totconiva,'name3'=>$ai_totbasimp,'name4'=>'','name5'=>$ai_totmonimp,'name6'=>$ai_totivaret);						                      
		$la_columna=array(/*'numche'=>'','fecche'=>'',*/'codope'=>'','fecfac'=>'','numfac'=>'','numref'=>'','numnotdeb'=>'',
		                  'numnotcre'=>'','name1'=>'','name3'=>'','name4'=>'','name5'=>'','name6'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' =>8,    // Tamaño de Letras
						 'showLines'=>1,    // Mostrar Lineas
						 'shaded'=>0,       // Sombra entre Lineas
						 ...
						 'cols'=>array(/*'numche'=>array('justification'=>'center','width'=>110), // Justificacion y ancho de la columna
									   ...
									   'name4'=>array('justification'=>'center','width'=>55),
									   'name5'=>array('justification'=>'center','width'=>80), // Justificacion y ancho de la columna
   						 			   'name6'=>array('justification'=>'center','width'=>80)));  
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		
		$la_dataf[1]=array('titulo'=>'');
		$la_dataf[2]=array('titulo'=>'');
		$la_dataf[3]=array('titulo'=>'');
		$la_dataf[4]=array('titulo'=>'');
		$la_dataf[5]=array('titulo'=>'');
		$la_dataf[6]=array('titulo'=>'');
		
		$la_dataf[7]=array('titulo'=>'                                                '.'_________________________________'.'                                                                                            '.'___________________________________');
		$la_dataf[8]=array('titulo'=>'                                   '.'FIRMA DEL AGENTE DE RETENCION'.'                                                                                                           '.'FIRMA DEL PROVEEDOR');
		$la_columna=array('titulo'=>'');		  
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>0, // Mostrar Letras
						 ...
						 'maxWidth'=>900,
						 'cols'=>array('titulo'=>array('justification'=>'center','width'=>900))); // Ancho Minimo de la tabla
		$io_pdf->ezTable($la_dataf,$la_columna,'',$la_config);
		unset($la_dataf);
		unset($la_columna);
		unset($la_config);
	...
	if($ls_tiporeporte==1)
	{
		$ls_titulo="COMPROBANTE DE RETENCION IVA";	
	}
	else
	{
		$ls_titulo="COMPROBANTE DE RETENCION IVA";	
			...
			for ($li_z=0;($li_z<$li_totrow)&&($lb_valido);$li_z++)
			{
				...
				if($lb_valido)
				{
					...
					if($lb_valido)
					{
						...
						//	$ls_numche=$io_report->ds_detalle->data["numche"][$li_i];
						//	$ls_fecche=$io_report->ds_detalle->data["fecche"][$li_i];
							...
							$la_data[$li_i]=array(/*'numche'=>$ls_numche,'fecche'=>$ls_fecche,*/'codope'=>$ls_numope,
							                      'fecfac'=>$ld_fecfac,'numfac'=>$ls_numfac,'numref'=>$ls_numref,
												  'numnotdeb'=>$ls_numnotdeb,'numnotcre'=>$ls_numnotcre,
												  'totalconiva'=>$li_coniva,
												  'baseimp'=>$li_baseimp,'porimp'=>$li_porimp,'totimp'=>$li_totimp,
												  'ivaret'=>$li_ivaret,'totalsiniva'=>$li_siniva);														
						  }																		 																						  
