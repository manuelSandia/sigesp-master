<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/conviasa.jpg',126,555,540,40); // Agregar Logo
	...
	function uf_print_detalle($la_data,$ai_totbasimp,$ai_totmonimp,$as_rifagenteret,&$io_pdf)
	{
		...
		$la_data1[1] = array('numero'=>'<b>Nº</b>',
						     ...
						     'fecnumsolpag'=>'<b>Fecha Orden Pago</b>',
		...
		$la_columna=array('numero'=>'','numsop'=>'','fecnumsolpag'=>'','numfac'=>'','numref'=>'','baseimp'=>'','porimp'=>'','iva_ret'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 ...
						 'cols'=>array('numero'=>array('justification'=>'center','width'=>50), // Justificacion y ancho de la columna
									   'numsop'=>array('justification'=>'center','width'=>110),
						 			   'fecnumsolpag'=>array('justification'=>'center','width'=>110), // Justificacion y ancho de la columna
		...
		unset($la_data1,$la_columna,$la_config);
						  ...
						  for ($li_i=1;$li_i<=$li_total;$li_i++)
						      {
								...
								$ld_fecsolpag = $io_funciones->uf_convertirfecmostrar($io_report->ds_detalle->data["fecemisol"][$li_i]);	
								...
								$la_data[$li_i]   = array('numero'=>$li_i,'numsop'=>$ls_numsop,'fecnumsolpag'=>$ld_fecsolpag,'numfac'=>$ls_numfac,
	...
	unset($io_report,$io_funciones,$io_fun_cxp);
?> 