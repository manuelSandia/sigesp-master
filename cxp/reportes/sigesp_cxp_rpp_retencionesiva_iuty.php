<?PHP
	...
	function uf_print_encabezadopagina($as_titulo,&$io_pdf)
	{
		...
		// Firmante
		$io_pdf->line(50,97,300,97);
		$io_pdf->addText(75,80,11,"Firma y Sello del Agente de Retencion"); // Agregar el título
		$io_pdf->addText(100,65,11,"RIF. Nro. ");  // Agregar el título
		$io_pdf->addText(103,50,11,"NIT. Nro. 0162952056");  // Agregar el título
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,&$io_pdf)
	{
		...
		$io_pdf->addText(145,64,11,$as_rifagenteret);  // Agregar el título RIF del firmante							 
        //---------------------------------------------------------------------------------------------------
		$la_data[1]=array('titulo'=>'');
		$la_columna=array('titulo'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
