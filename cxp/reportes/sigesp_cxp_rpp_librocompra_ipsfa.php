<?php
	...
	else
	{
			...
			{
				$la_cargos=$io_report->uf_select_rowdata($io_sql,"SELECT MAX(monobjret) as basimp,MAX(porcar) AS porcar,SUM(monret) as impiva".
																 "  FROM cxp_rd_cargos ".
																 " WHERE codemp='".$ls_codemp."'".
																 "   AND numrecdoc='".$ls_numrecdoc."'".
																 "   AND cod_pro='".$ls_codpro."'".
																 "   AND ced_bene='".$ls_cedben."'".
																 " GROUP BY codemp, numrecdoc, cod_pro, ced_bene, codtipdoc");
			}
			if(count($la_cargos)>0)
			{
				...
				//print "NUMRECDOC->".$ls_numrecdoc." BASE->".$ldec_baseimp."<br>";
			}
			else
			{
				$ldec_porcar="";
			...
			//print $ls_numrecdoc." MONTOTDOC->".$ldec_montodoc."  DED->".$ldec_mondeddoc." HAB->".$li_habman." DEB->".$li_debman."<br>";
