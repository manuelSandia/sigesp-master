...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(385,60,385,130);		
		$io_pdf->addText(80,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(84,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(265,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(258,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(453,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(433,63,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($as_numsol,$as_codigo,$as_nombre,$as_denfuefin,$ad_fecemisol,$as_consol,$as_obssol,
							   $ai_monsol,$as_monto,$as_nombenaltcre,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[1]=array('titulo'=>'<b> Beneficiario del Cheque: </b>'.$as_nombenaltcre);
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_detalle_spg($aa_data,$ai_totpre,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('codestpro'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
	...
	function uf_print_detalle_scg($aa_data,$ai_totdeb,$ai_tothab,&$io_pdf)
	{
		...
		unset($la_config);
		$io_pdf->ezSetDy(-2);
		$la_data[1]=array('sc_cuenta'=>'<b>Cuenta</b>',
						  'denominacion'=>'<b>Denominación</b>',
						  'mondeb'=>'<b>Debe</b>',
						  'monhab'=>'<b>Haber</b>');
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ls_nombenaltcre=$io_report->DS->data["nombenaltcre"][$li_i];
				if($ls_estretiva=="B")
				{
				...
				uf_print_cabecera($ls_numsol,$ls_codigo,$ls_nombre,$ls_denfuefin,$ld_fecemisol,$ls_consol,$ls_obssol,$li_monsol,
								  $ls_monto,$ls_nombenaltcre,&$io_pdf);
