<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo_emica.jpg',150,550,490,65); // Agregar Logo
		$li_tm=$io_pdf->getTextWidth(18,$as_titulo);
		$tm=520-($li_tm/2);
		$io_pdf->addText($tm,533,12,$as_titulo); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
		
		$io_pdf->addText(80,80,12,'____________________________'); // Agregar el título
		$io_pdf->addText(110,60,12,'LCDO. JUAN GONZÁLEZ'); // Agregar el título
		$io_pdf->addText(90,40,12,'<b>ENCARGADO DE TESORERIA</b>'); // Agregar el título
		
		
		$io_pdf->addText(510,80,12,'____________________________'); // Agregar el título
		$io_pdf->addText(520,60,12,'LCDA. MARIANELA GONZÁLEZ'); // Agregar el título
		$io_pdf->addText(470,40,12,'<b>GERENTA DE ADMINISTRACIÓN Y FINANZAS</b>'); // Agregar el título
	...
	function uf_print_detalle($la_data,$ai_totbasimp,$ai_totmonimp,$ai_totmoniva,$as_rifagenteret,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'colGap'=>1,
						 'cols'=>array('fecfac'=>array('justification'=>'center','width'=>60),
						 			   'fecliq'=>array('justification'=>'center','width'=>60), // Justificacion y ancho de la columna
									   ...
									   'baseimp'=>array('justification'=>'center','width'=>90), // Justificacion y ancho de la columna
						 			   'iva_ret'=>array('justification'=>'center','width'=>70),
						 			   'porimp'=>array('justification'=>'center','width'=>55),
   						 			   'totimp'=>array('justification'=>'center','width'=>85),
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('fecfac'=>array('justification'=>'center','width'=>60),
									   ...
									   'baseimp'=>array('justification'=>'right','width'=>90), // Justificacion y ancho de la columna
						 			   'iva_ret'=>array('justification'=>'right','width'=>70),
						 			   'porimp'=>array('justification'=>'center','width'=>55),
   						 			   'totimp'=>array('justification'=>'right','width'=>85),
									   'numsop'=>array('justification'=>'center','width'=>100))); 
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data1);
		unset($la_columna);
