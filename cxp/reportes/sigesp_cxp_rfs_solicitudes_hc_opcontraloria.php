...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_tipproben,$as_nombre,&$io_pdf)
	{
		...
		$io_pdf->addText(35,695,9,"RIF: ".$ls_rif); // Agregar el título
		// cuadro inferior
        $io_pdf->Rectangle(15,55,570,85);
		$io_pdf->line(15,114,585,114);		
		$io_pdf->line(15,127,585,127);		
		$io_pdf->line(157,55,157,140);		
		$io_pdf->line(300,55,300,140);		
		$io_pdf->line(442,55,442,140);		
		$io_pdf->addText(50,130,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(20,117,7,"FECHA:               /                /    "); 
		$io_pdf->addText(20,104,7,"FIRMA:");
		$io_pdf->addText(200,130,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(162,117,7,"FECHA:               /                /    ");
		$io_pdf->addText(162,104,7,"FIRMA:");
		$io_pdf->addText(345,130,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(305,117,7,"FECHA:               /                /    ");
		$io_pdf->addText(305,104,7,"FIRMA:");
		$io_pdf->addText(485,130,7,"CONTRALORIA"); // Agregar el título
		$io_pdf->addText(447,117,7,"FECHA:               /                /    ");
		$io_pdf->addText(447,104,7,"FIRMA:");
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_observaciones($as_obssol,$as_nomban,$as_ctaban,$as_tipcta,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetDy(-10);
		$la_datatot[1]=array('titulo'=>'<b>Banco abono: </b>'.$as_nomban.'   <b>Nro. Cuenta: </b>'.$as_ctaban.'   <b>Tipo Cuenta: </b>'.$as_tipcta);
		$la_columnas=array('titulo'=>'<b>Factura</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ls_tipcta=$io_report->DS->data["tipcta"][$li_i];
...
//////////////////////////         GRID DETALLE CONTABLE	    //////////////////////////////////////
				...
				uf_print_observaciones($ls_obssol,$ls_nomban,$ls_ctaban,$ls_tipcta,&$io_pdf);
			}
		}
