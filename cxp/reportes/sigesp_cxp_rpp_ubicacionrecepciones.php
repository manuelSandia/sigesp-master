...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_detalle_recepcion($la_data,&$io_pdf)
	{
		...
		$la_datatit[1]=array('numrecdoc'=>'<b>Nro de Recepción</b>',
							 'tipo'=>'<b>Tipo de Recepción</b>',
							 'nombre'=>'<b>Proveedor / Beneficiario</b>',
							 'estatus'=>'<b>Estatus de Recepción</b>',
							 'solicitud'=>'<b>Solicitud de Pago</b>',
							 'estatussol'=>'<b>Estatus Solicitud</b>');
		$la_columnas=array('numrecdoc'=>'<b>Nro de Recepción</b>',
						   'tipo'=>'<b>Tipo de Recepción</b>',
						   'nombre'=>'<b>Proveedor / Beneficiario</b>',
						   'estatus'=>'<b>Estatus de Recepción</b>',
						   'solicitud'=>'<b>Solicitud de Pago</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numrecdoc'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'tipo'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
						 			   'nombre'=>array('justification'=>'center','width'=>260), // Justificación y ancho de la columna
						 			   'estatus'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'solicitud'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'estatussol'=>array('justification'=>'center','width'=>100))); // Justificación y ancho de la columna
	...
	$ls_titulo="<b>UBICACIÓN DE RECEPCIONES DE DOCUMENTOS</b>";
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezSetCmMargins(4.1,3,3,3); // Configuración de los margenes en centímetros
			...
			while (!$io_report->rs_data->EOF)
			{
				...
				switch ($ls_estprosol)
				{
					...
					case "N":
						$ls_estprosol="Anulada Sin Afectación";
						break;
				}
