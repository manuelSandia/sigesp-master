<?php
	...
	function uf_print_sello(&$io_pdf)
	{
		...
		//		   Access: private 
		//	    Arguments: io_pdf // Instancia de objeto pdf
		//    Description: función que imprime las firmas y sello (agregadapara )
		//	   Creado Por: Ing. Jennifer Rivero
		//     Modificado Por: Ing. Danela Gutiérrez
		// Fecha Creación: 18/07/2012
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[6]=array('firma1'=>'____________________________','firma2'=>'____________________________');
		$la_data[7]=array('firma1'=>'AGENTE DE RETENCION','firma2'=>'BENEFICIARIO');
		...
		$io_pdf->rectangle(630,60,110,90); 
		$io_pdf->addText(665,66,10,'<b>SELLO</b>');
	}// end function uf_print_sello
