...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_tipproben,$as_nombre,&$io_pdf)
	{
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText(350,740,11,$as_titulo); // Agregar el título
		...
		$io_pdf->line(129,75,129,160);		
		$io_pdf->line(243,75,243,160);		
		$io_pdf->line(357,75,357,160);		
		$io_pdf->line(471,75,471,160);		
		$io_pdf->addText(55,152,7,"REVISADO"); // Agregar el título
		$io_pdf->addText(37,88,7,"SUPER.GEST.ADMON/ "); // Agregar el título
		$io_pdf->addText(170,152,7,"REVISADO"); // Agregar el título
		$io_pdf->addText(140,93,7,"SUPER.GESTION FINANZAS"); // Agregar el título
		$io_pdf->addText(146,83,7,"JEFE DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(250,152,7,"REVISADO Y CONFORMADO"); // Agregar el título
		$io_pdf->addText(250,93,7,"COORD. PRESUP. Y COSTOS"); // Agregar el título
		$io_pdf->addText(248,83,7,"ANALISTA PRESUP. Y COSTOS"); // Agregar el título
		$io_pdf->addText(385,152,7,"CONFORMADO"); // Agregar el título
		$io_pdf->addText(370,93,7,"GERENTE CORP. ADMON."); // Agregar el título
		$io_pdf->addText(390,83,7,"Y FINANZAS"); // Agregar el título
		$io_pdf->addText(505,152,7,"APROBADO"); // Agregar el título
		$io_pdf->addText(478,93,7,"GERENTE DE AREA GESTION"); // Agregar el título
		$io_pdf->addText(503,83,7,"DE PERSONAS"); // Agregar el título
	...
	function uf_print_cabecera($as_numsol,$as_codigo,$as_nombre,$as_denfuefin,$ad_fecemisol,$as_consol,$as_obssol,
							   $ai_monsol,$as_monto,$as_rifpro,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data[1]=array('titulo'=>'<b> Beneficiario</b>                                                                                                                                                      RIF: '.$as_rifpro);
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				uf_print_cabecera($ls_numsol,$ls_codigo,$ls_nombre,$ls_denfuefin,$ld_fecemisol,$ls_consol,$ls_obssol,$li_monsol,$ls_monto,$ls_rifpro,&$io_pdf);
