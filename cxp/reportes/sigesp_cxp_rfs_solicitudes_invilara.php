...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,&$io_pdf)
	{
		...
		$io_pdf->saveState();
//		$io_pdf->addText(485,750,9,"No. ".$as_numsol); // Agregar el título

		///////////////////////////////////////////////////////////////////////
		// Así estaba antes...
		// $io_pdf->addText(510,710,9,"".$ad_fecregsol); // Agregar el título
		///////////////////////////////////////////////////////////////////////
		// Cambio...
		$io_pdf->addText(540,740,10,"".$ad_fecregsol); // Agregar el título

		/* asì estaba antes...
		$io_pdf->addText(250,90,9,"LCDA. MARIA MENDOZA"); // Agregar el título
		$io_pdf->addText(450,90,9,"LCDA. LUZ MARIA TORRES"); // Agregar el título
		$io_pdf->addText(250,40,9,"LCDA. LUCY COLMENAREZ"); // Agregar el título
		$io_pdf->addText(450,40,9,"ING. CAROLINA FORTOUL"); // Agregar el título
		*/

		// Cambio...
		$io_pdf->addText(260,105,9,"LCDA. MARIA MENDOZA"); // Agregar el título
		$io_pdf->addText(460,105,9,"LCDA. LUZ MARIA TORRES"); // Agregar el título
		$io_pdf->addText(260,45,9,"LCDA. LUCY COLMENAREZ"); // Agregar el título
		$io_pdf->addText(460,45,9,"ING. CAROLINA FORTOUL"); // Agregar el título
							   ...
							   $ai_monsol,$as_monto,$as_rifpro,$as_dentipdoc,&$io_pdf)
	{
		...
		// Cambio...
		$io_pdf->ezSetY(720);
		$la_data[1]=array('titulo'=>"".$as_rifpro);
		...
		// $io_pdf->ezSetY(695);
		$io_pdf->ezSetY(700);
		$la_data[1]=array('titulo'=>"".$as_nombre);
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 10, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>540, // Ancho de la tabla
						 'maxWidth'=>540, // Ancho Máximo de la tabla
						 'xPos'=>341, // Orientación de la tabla
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
		...
		$la_data[1]=array('titulo'=>"",'contenido'=>$ai_monsol,);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 10, // Tamaño de Letras
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle_recepcion($la_data,$ai_totsubtot,$ai_tottot,$ai_totcar,$ai_totded,$as_numsol,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $ls_tiporeporte;
		$io_pdf->addText(507,760,10,"".$as_numsol); // Agregar el título
		if($ls_tiporeporte==1)
		{
			$ls_titulo=" Bs.F.";
		}
		...
		$io_pdf->ezSetDy(-30);
		//$io_pdf->ezSetY(555);
		$la_columnas=array('compromiso'=>'<b>Compromiso</b>',
						   'fecemisol'=>'<b>Fecha</b>',
						   'subtotdoc'=>'<b>Monto</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('compromiso'=>array('justification'=>'left','width'=>105), // Justificación y ancho de la columna                                                 
						 			   'fecemisol'=>array('justification'=>'left','width'=>70), // Justificación y ancho de la columna
						 			   'subtotdoc'=>array('justification'=>'right','width'=>123), // Justificación y ancho de la columna
						 			   'mondeddoc'=>array('justification'=>'right','width'=>85), // Justificación y ancho de la columna
									   'moncardoc'=>array('justification'=>'right','width'=>95), // Justificación y ancho de la columna
						 			   'montotdoc'=>array('justification'=>'right','width'=>115))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		*/
		///////////////////////////////////////////////////////////////////////
		// Cambio...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,						 
                                                 'cols'=>array('compromiso'=>array('justification'=>'left','width'=>70), // Justificación y ancho de la columna
						 			   'fecemisol'=>array('justification'=>'left','width'=>70), // Justificación y ancho de la columna
						 			   'subtotdoc'=>array('justification'=>'right','width'=>123), // Justificación y ancho de la columna
						 			   'mondeddoc'=>array('justification'=>'right','width'=>85), // Justificación y ancho de la columna
									   'moncardoc'=>array('justification'=>'right','width'=>95), // Justificación y ancho de la columna
		...
		$la_datatot[1]=array('numrecdoc'=>'<b></b>','subtotdoc'=>$ai_totsubtot,
		...
		*/
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>540, // Ancho de la tabla
						 'maxWidth'=>540, // Ancho Máximo de la tabla
						 'xPos'=>359, // Orientación de la tabla
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('numrecdoc'=>array('justification'=>'right','width'=>50), // Justificación y ancho de la columna
						 			   'subtotdoc'=>array('justification'=>'right','width'=>123), // Justificación y ancho de la columna
						 			   'moncardoc'=>array('justification'=>'right','width'=>85), // Justificación y ancho de la columna
						 			   'mondeddoc'=>array('justification'=>'right','width'=>95), // Justificación y ancho de la columna
						 			   'montotdoc'=>array('justification'=>'right','width'=>115))); // Justificación y ancho de la columna
	...
	function uf_print_detalle_spg($aa_data,$ai_totpre,&$io_pdf)
	{
		...
		// $la_datatit[1]=array('titulo'=>'<b>                                                                                                    CODIGOS PRESUPUESTARIOS </b>');

		$la_datatit[1]=array('titulo'=>'<b>                                                                         CODIGOS PRESUPUESTARIOS </b>');
		// $la_datatit[2]=array('titulo'=>'<b>                              PROGRAMATICA                                      CUENTA               DENOMINACION                                                                             MONTO</b>');
		$la_datatit[2]=array('titulo'=>'<b>              PROGRAMATICA                                      CUENTA               DENOMINACION                                          MONTO</b>');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
		...
		$la_columnas=array('codestpro'=>'<b></b>',
	...
	function uf_print_detalle_scg($aa_data,$ai_totdeb,$ai_tothab,&$io_pdf)
	{
		...
		$la_datatit[1]=array('titulo'=>'<b>                                                                        CODIGOS CONTABLES </b>');
		$la_datatit[2]=array('titulo'=>'<b>             CUENTA                       DENOMINACION                                                                               DEBE               HABER</b>');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 // 'fontSize' => 6, // Tamaño de Letras
						 'fontSize' => 10, // Tamaño de Letras
		...
		$la_datatot[1]=array('titulo'=>'<b>Totales</b>','totdeb'=>$ai_totdeb,'tothab'=>$ai_tothab);
		$la_columnas=array('titulo'=>'<b>Factura</b>',
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezSetCmMargins(10,7,3,3); // Configuración de los margenes en centímetros
...
//////////////////////////  GRID RECEPCIONES DE DOCUMENTOS		//////////////////////////////////////
				...
				if($lb_valido)
				{
					...
					{
						$ls_numsol=$io_report->ds_detalle_rec->data["numsol"][$li_s];
						...
						$la_data[$li_s]=array('compromiso'=>$ls_numrecdoc,'fecemisol'=>$ld_fecemidoc,'mondeddoc'=>$li_mondeddoc,
					...
					uf_print_detalle_recepcion($la_data,$li_totsubtot,$li_tottot,$li_totcar,$li_totded,$ls_numsol,&$io_pdf);
					unset($la_data);
//////////////////////////  GRID RECEPCIONES DE DOCUMENTOS		//////////////////////////////////////
