...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,&$io_pdf)
	{
		...
		$io_pdf->addText(37,122,7,"UNIDAD SOLICITANTE"); // Agregar el título
		$io_pdf->addText(148,122,7,"DIRECTOR GENERAL"); // Agregar el título
		$io_pdf->addText(167,63,7,"APROBADO"); // Agregar el título
		$io_pdf->addText(253,122,7,"PLANIF. Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(282,63,7,"APROBADO"); // Agregar el título
		$io_pdf->addText(380,122,7,"ADMIN. Y FINANZAS"); // Agregar el título
		$io_pdf->addText(395,63,7,"APROBADO"); // Agregar el título
		$io_pdf->addText(505,122,7,"PRESIDENTE"); // Agregar el título
		$io_pdf->addText(505,63,7,"AUTORIZADO"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
