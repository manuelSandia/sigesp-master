<?PHP
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,&$io_pdf)
	{
		...
		$io_pdf->addText(850,500,10,"<b>FECHA</b>"); // Agregar el titulo
		$io_pdf->addText(850,485,10,$ad_fecrep); // Agregar el titulo								 
		$io_pdf->Rectangle(845,4310,100,28);	
		$io_pdf->addText(850,456,10,"<b>PERIODO FISCAL</b>"); // Agregar el titulo	
		$io_pdf->addText(850,443,10,$as_perfiscal); // Agregar el titulo									 
		...
		$io_pdf->addText(405,458,10,"<b>REGISTRO DE INFORMACION FISCAL DEL AGENTE DE RETENCION</b>"); // Agregar el titulo
		$io_pdf->addText(405,443,10,$as_rifagenteret); // Agregar el t�ulo									 
        //---------------------------------------------------------------------------------------------------
		$la_data[1]=array('titulo'=>'');
		$la_columna=array('titulo'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
		...
		$io_pdf->addText(405,375,10,"<b>REGISTRO DE INFORMACION FISCAL DEL SUJETO RETENIDO (R.I.F)</b>"); // Agregar el titulo
		$io_pdf->addText(405,360,10,$as_rif); // Agregar el titulo									 
