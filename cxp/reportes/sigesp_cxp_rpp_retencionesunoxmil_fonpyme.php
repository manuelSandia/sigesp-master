<?php
	...
	function uf_print_detalle($la_data,$ai_totbasimp,$ai_totmonimp,$ai_totmoniva,$as_rifagenteret,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'colGap'=>1,
						 'cols'=>array('fecfac'=>array('justification'=>'center','width'=>85),
									   ...
									   'baseimp'=>array('justification'=>'center','width'=>100), // Justificacion y ancho de la columna
						 			   ...
						 			   'porimp'=>array('justification'=>'center','width'=>105),
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'colGap'=>1,
						 'maxWidth'=>690, // Ancho Mínimo de la tabla
						 'cols'=>array('total'=>array('justification'=>'center','width'=>285), // Justificacion y ancho de la columna
   						 			   'monto'=>array('justification'=>'right','width'=>100),
									   'iva'=>array('justification'=>'right','width'=>100),
									   'ret'=>array('justification'=>'right','width'=>105),
	...
	function uf_print_sello(&$io_pdf)
	{
		...
		$la_config= array('showHeadings'=>0, // Mostrar encabezados
						  ...
						  'colGap'=>1,
						  'width'=>690,
						  'cols'=>array('name1'=>array('justification'=>'center','width'=>690))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config); 		
