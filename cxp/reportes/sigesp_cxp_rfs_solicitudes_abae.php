...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(90,60,90,130);		
		$io_pdf->line(170,60,170,130);		
		...
		$io_pdf->addText(102,122,6,"VERIFICADO POR O.P"); // Agregar el título
		$io_pdf->addText(95,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(195,122,6,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(180,63,6,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->addText(300,122,6,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(300,63,6,"UNIDAD SOLICITANTE"); // Agregar el título
		$io_pdf->addText(395,122,6,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(385,63,6,"GERENTE DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(490,122,6,"CONTRALORIA INTERNA"); // Agregar el título
							   ...
							   $ai_monsol,$as_monto,&$io_pdf)
	{
		...
		$la_data[1]=array('titulo'=>'<b> Financiamiento:   </b>'.$as_denfuefin);
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
...
//////////////////////////   GRID DETALLE PRESUPUESTARIO		//////////////////////////////////////
						...
						if($lb_valido)
						{
							...
							for($li_s=1;$li_s<=$li_totrowspg;$li_s++)
							{
								...
								$ls_spgcuenta=rtrim($io_report->ds_detalle_spg->data["spg_cuenta"][$li_s]);
								$ls_denominacion=rtrim($io_report->ds_detalle_spg->data["denominacion"][$li_s]);
