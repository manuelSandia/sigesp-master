...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_dentipdoc,$as_estprosol,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$li_tm=$io_pdf->getTextWidth(9,$as_dentipdoc);
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,690,8,$as_dentipdoc); // Agregar el título
		// cuadro inferior
		$io_pdf->line(110,110,230,110);		
		$io_pdf->line(390,110,510,110);		
		$io_pdf->addText(140,102,7,"LIC. LUIS VARGAS"); // Agregar el título
		$io_pdf->addText(400,102,7,"LIC.CARMEN JULIA MACHADO"); // Agregar el título
		$io_pdf->addText(140,96,5,"DIRECTOR DE FINANZAS"); // Agregar el título
		$io_pdf->addText(402,96,5,"JEFE DE LA DIVISIÓN DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(20,50,7,"Emitido por: ".$_SESSION['la_apeusu'].' '.$_SESSION['la_nomusu'].""); // Agregar el título*/
		$io_pdf->addText(20,42,7,"Nota: Esta Orden de Pago es un compromiso en la división de Ordenación de pago, si por alguna razón no va a ser procesada, favor notificarlo a esta división."); // Agregar el título*/
		$io_pdf->restoreState();
		$io_pdf->closeObject();
...
*/				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecemisol,$ls_dencla,$ls_estprosol,&$io_pdf);
