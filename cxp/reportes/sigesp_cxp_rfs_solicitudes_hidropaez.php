...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(130,60,130,140);//vertical		
		$io_pdf->line(270,60,270,140);//vertical		
		$io_pdf->line(420,60,420,140);//vertical		
		$io_pdf->addText(30,132,7,"UNIDAD SOLICITANTE"); // Agregar el título
		$io_pdf->addText(15,122,7,"FECHA:            /             /            "); // Agregar el título
		$io_pdf->addText(42,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(177,132,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(135,122,7,"FECHA:              /             /            "); // Agregar el título
		$io_pdf->addText(168,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(315,132,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(275,122,7,"FECHA:                 /              /            "); // Agregar el título
		$io_pdf->addText(317,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(480,132,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(425,122,7,"FECHA:                 /                /            "); // Agregar el título
		$io_pdf->addText(470,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
