...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->addText(30,122,7,"Elaborado por:"); // Agregar el título
		$io_pdf->addText(30,63,7,"Firma:"); // Agregar el título
		$io_pdf->addText(190,122,7,"Revisado por:"); // Agregar el título
		$io_pdf->addText(190,63,7,"Firma:"); // Agregar el título
		$io_pdf->addText(390,122,7,"Aprobado por:"); // Agregar el título
		$io_pdf->addText(390,63,7,"Firma:"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
