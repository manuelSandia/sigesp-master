<?PHP
	...
	function uf_print_detalle($la_data,$ai_totconiva,$ai_totsiniva,$ai_totbasimp,$ai_totmonimp,$ai_totivaret,&$io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
		$io_pdf->addText(60,60,8,"AGENTE DE RETENCION"); // Agregar titutlo
		$io_pdf->addText(60,50,8,"DPTO. RECURSOS FINANCIEROS"); // Agregar titutlo
		$io_pdf->addText(50,73,8,"____________________________________"); // Agregar titutlo
		$io_pdf->addText(750,73,8,"___________________________________"); // Agregar titutlo
		$io_pdf->addText(800,60,8,"LIDIA RAMOS"); // Agregar titutlo
		$io_pdf->addText(800,50,8,"LIQUIDADOR"); // Agregar titutlo
		$io_pdf->addText(467,50,10,"FECHA DE LIQUIDACION"); // Agregar la Fecha
		$io_pdf->addText(487,60,10,date("d/m/Y")); // Agregar la Fecha
