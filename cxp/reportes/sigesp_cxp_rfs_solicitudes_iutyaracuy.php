...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->Rectangle(15,60,570,110);
		$io_pdf->line(15,105,585,105);//debajo de firma		
		$io_pdf->line(15,117,585,117);		
		$io_pdf->line(118,60,118,140);		
		$io_pdf->line(214,60,214,140);		
		$io_pdf->line(330,60,330,140);		
		$io_pdf->line(450,60,450,140);		
		$io_pdf->addText(15,160,7,"OBSERVACIONES"); // Agregar el título
		$io_pdf->addText(25,130,7,"UNID. CONTROL"); // Agregar el título
		$io_pdf->addText(25,122,7,"PRESUPUESTARIO"); 
		$io_pdf->addText(20,110,7,"FECHA:          /        /         "); // Agregar el título
		$io_pdf->addText(20,95,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(140,130,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(120,110,7,"FECHA:          /        /         "); // Agregar el título
		$io_pdf->addText(120,95,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(230,130,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(215,110,7,"FECHA:          /        /         "); // Agregar el título
		$io_pdf->addText(215,95,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(350,130,7,"SUB-DIRECCION"); // Agregar el título
		$io_pdf->addText(350,122,7,"ADMINISTRATIVA"); 
		$io_pdf->addText(335,110,7,"FECHA:          /        /         "); // Agregar el título
		$io_pdf->addText(335,95,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(480,130,7,"CONTRALORIA"); // Agregar el título
		$io_pdf->addText(453,110,7,"FECHA:          /        /         "); // Agregar el título
		$io_pdf->addText(453,95,7,"FIRMA:"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//////////////////////////         GRID DETALLE CONTABLE	    //////////////////////////////////////
						...
						if($lb_valido)
						{
							...
							for($li_s=1;$li_s<=$li_totrowscg;$li_s++)
							{
								...
								/*/for ($i=$li_s+1;$i<=130;$i++)
									{
									  $la_data[$i]=array('sc_cuenta'=>$ls_sccuenta,'denominacion'=>$ls_denominacion,
																  'mondeb'=>$li_montodebe,'monhab'=>$li_montohab);
									}/*/
