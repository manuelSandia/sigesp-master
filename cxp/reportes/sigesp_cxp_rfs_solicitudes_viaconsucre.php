...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$as_titulo1="<b>VIALIDAD Y CONSTRUCCIONES SUCRE S.A.</b>";
		$as_titulo2="<b>R.I.F.: G-20005595-2       N.I.T.: 0470199903</b>";
		$as_titulo3="<b>AV. FRANCISCO MIRANDA, TORRE PEQUIVEN PB, CHACAO.</b>";
		$as_titulo4="<b>TELF (0212) 201.57.06 FAX: 201.53.22.</b>";
		$io_pdf->addText(210,705,10,$as_titulo);
		$io_pdf->addText(100,750,8,$as_titulo1);
		$io_pdf->addText(100,740,8,$as_titulo2);
		$io_pdf->addText(100,730,8,$as_titulo3);
		$io_pdf->addText(100,720,8,$as_titulo4);
