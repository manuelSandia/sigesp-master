<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$tm=216-($li_tm/2);
		$io_pdf->addText($tm,510,12,$as_titulo); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(9,"ARTICULO 114 ORDENANZA SOBRE ACTIVIDADES ECONOMICAS");
		$tm=216-($li_tm/2);
		$io_pdf->addText($tm,500,9,"ARTICULO 114 ORDENANZA SOBRE ACTIVIDADES ECONOMICAS"); // Agregar el título
	...
	if($ls_tiporeporte==1)
	{
		$ls_titulo="<b>COMPROBANTE DE RETENCION DEL IMPUESTO MUNICIPAL </b>";
	}
	else
	{
		$ls_titulo="<b>COMPROBANTE DE RETENCION DEL IMPUESTO MUNICIPAL </b>";
