<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_inn.jpg',35,555,735,30); // Agregar Logo
		...
		$io_pdf->addText(710,595,8,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(716,585,7,date("h:i a")); // Agregar la Hora
		$io_pdf->restoreState();
		$io_pdf->closeObject();
