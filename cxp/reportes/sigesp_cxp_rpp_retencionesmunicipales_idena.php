<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_idena.jpg',47,530,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/comunas_idena.jpg',130,16,550,40); // Agregar Logo
		$io_pdf->restoreState();
		$io_pdf->closeObject();
