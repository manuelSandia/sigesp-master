...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
        ...
        $io_pdf->Rectangle(480,700,105,60);
		$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo_emica.jpg',67,715,390,55); // Agregar Logo
		if ($as_estprosol=="A")
		{
		...
		$tm=256-($li_tm/2);
		$io_pdf->addText($tm,702,11,$as_titulo); // Agregar el título
		...
		$io_pdf->line(400,60,400,117);		
		$io_pdf->addText(40,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(42,63,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(157,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(145,63,7,"COORD. CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(375,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(244,63,7,"GERENCIA DE ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->addText(460,63,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle_recepcion($la_data,$ai_totsubtot,$ai_tottot,$ai_totcar,$ai_totded,&$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-2);
		$la_datatit[1]=array('numrecdoc'=>'<b>Factura</b>','numref'=>'<b>N° Control</b>','fecemisol'=>'<b>Fecha</b>','subtotdoc'=>'<b>Monto</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numrecdoc'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
						 			   'numref'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
									   'fecemisol'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'subtotdoc'=>array('justification'=>'center','width'=>82), // Justificación y ancho de la columna
						 			   'moncardoc'=>array('justification'=>'center','width'=>82), // Justificación y ancho de la columna
						 			   'mondeddoc'=>array('justification'=>'center','width'=>72), // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numrecdoc'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
									   ...
									   'fecemisol'=>array('justification'=>'left','width'=>60), // Justificación y ancho de la columna
						 			   'subtotdoc'=>array('justification'=>'right','width'=>82), // Justificación y ancho de la columna
						 			   'moncardoc'=>array('justification'=>'right','width'=>82), // Justificación y ancho de la columna
						 			   'mondeddoc'=>array('justification'=>'right','width'=>72), // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('numrecdoc'=>array('justification'=>'right','width'=>250), // Justificación y ancho de la columna
						 			   'subtotdoc'=>array('justification'=>'right','width'=>82), // Justificación y ancho de la columna
						 			   'moncardoc'=>array('justification'=>'right','width'=>82), // Justificación y ancho de la columna
						 			   'mondeddoc'=>array('justification'=>'right','width'=>72), // Justificación y ancho de la columna
						 			   'montotdoc'=>array('justification'=>'right','width'=>82))); // Justificación y ancho de la columna
...
//////////////////////////  GRID RECEPCIONES DE DOCUMENTOS		//////////////////////////////////////
				...
				if($lb_valido)
				{
					...
					for($li_s=1;$li_s<=$li_totrowdet;$li_s++)
					{
						...
						$ls_referencia=$io_report->ds_detalle_rec->data["numref"][$li_s];
						...
						$la_data[$li_s]=array('numrecdoc'=>$ls_numrecdoc,'numref'=>$ls_referencia,'fecemisol'=>$ld_fecemidoc,'mondeddoc'=>$li_mondeddoc,
