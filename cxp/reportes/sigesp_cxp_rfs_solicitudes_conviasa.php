...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_numsol,$as_codigo,$as_nombre,$as_rifproben,$as_perfis,$as_denfuefin,$ad_fecemisol,$as_consol,$as_obssol,
							   $ai_monsol,$as_monto,&$io_pdf)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data[1]=array('titulo'=>'<b> Beneficiario</b>','rif'=>'<b>Rif</b>','perfis'=>'<b>Periodo Fiscal</b>');
		$la_data[2]=array('titulo'=>"                            ".$as_nombre,'rif'=>$as_rifproben,'perfis'=>$as_perfis);
		$la_columnas=array('titulo'=>'','rif'=>'','perfis'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>400),
						               'rif'=>array('justification'=>'left','width'=>100),
									   'perfis'=>array('justification'=>'left','width'=>70))); // Justificación y ancho de la columna
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ls_perfis=$io_report->DS->data["fecemisol"][$li_i];
				$ls_perfis=substr($ls_perfis,0,4).substr($ls_perfis,5,2);
				$ls_tiproben=$io_report->DS->data["tipproben"][$li_i];
				...
				uf_print_cabecera($ls_numsol,$ls_codigo,$ls_nombre,$ls_rifproben,$ls_perfis,$ls_denfuefin,$ld_fecemisol,$ls_consol,$ls_obssol,$li_monsol,$ls_monto,&$io_pdf);
