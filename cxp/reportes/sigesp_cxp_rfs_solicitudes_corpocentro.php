...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(110,80,585,80);
		$io_pdf->line(110,90,585,90);
		$io_pdf->line(15,117,585,117);		
		
		$io_pdf->line(110,60,110,130);		
		$io_pdf->line(220,60,220,130);
		$io_pdf->line(340,60,340,130);		
		$io_pdf->line(470,60,470,130);		
		
		$io_pdf->addText(25,72,6,"NOMBRE:"); // Agregar el título
		$io_pdf->addText(117,72,6,"NOMBRE:"); // Agregar el título
		$io_pdf->addText(230,72,6,"NOMBRE:"); // Agregar el título
		$io_pdf->addText(355,72,6,"NOMBRE:"); // Agregar el título
		$io_pdf->addText(480,72,6,"NOMBRE:"); // Agregar el título
		$io_pdf->addText(137,82,6,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(253,82,6,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(380,82,6,"UNIDAD EJECUTORA"); // Agregar el título
		$io_pdf->addText(500,82,6,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(25,122,6,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(25,63,6,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(137,122,6,"VERIFICADO POR:"); // Agregar el título
		$io_pdf->addText(140,63,6,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(250,122,6,"VERIFICADO POR:"); // Agregar el título
		$io_pdf->addText(253,63,6,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(375,122,6,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->addText(380,63,6,"FIRMA / SELLO "); // Agregar el título
		$io_pdf->addText(500,122,6,"APROBADO POR:"); // Agregar el título
		$io_pdf->addText(500,63,6,"FIRMA / SELLO "); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
