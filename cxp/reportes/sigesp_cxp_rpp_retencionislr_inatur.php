<?php
	...
	function uf_print_encabezado($as_agente,$as_nombre,$as_rif,$as_nit,$as_telefono,$as_direccion,&$io_pdf)
	{
		...
		$la_data[2]=array('name'=>'<b><i>Domicilio Fiscal:</i></b>'."  ".$ls_diragente);
		$la_data[3]=array('name'=>'<b><i>Rif Agente de Retención:</i></b>'."  ".$ls_rifagente);
	...
	function uf_print_detalle($as_numsol,$as_concepto,$as_fechapago,$ad_monto,$ad_monret,$ad_porcentaje,$as_numcon,&$io_pdf)
	{
		...
		// Fecha Creación: 05/07/2007 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      	$la_data[1]=array('solicitud'=>'<b><i>Concepto:</i></b>'."  ".$as_concepto);	
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('solicitud'=>array('justification'=>'left','width'=>500))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);		       
		unset($la_data);
		unset($la_columna);
		unset($la_config);
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$la_data[4]=array('firma1'=>'________________________________________');
		$la_data[5]=array('firma1'=>'FIRMA Y SELLO DEL AGENTE DE RETENCION');
