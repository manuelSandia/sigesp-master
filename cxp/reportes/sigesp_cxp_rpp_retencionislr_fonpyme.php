<?php
	...
	function uf_print_encabezado($as_agente,$as_nombre,$as_rif,$as_nit,$as_telefono,$as_direccion,$as_numsol,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data[1]=array('name'=>'<b><i>Agente de Retención:</i></b>'."  ".$as_agente."   <b><i>RIF:</i></b>  ".$_SESSION["la_empresa"]["rifemp"]);
	...
	function uf_print_detalle($as_numsol,$as_concepto,$as_fechapago,$ad_monto,$ad_monret,$ad_porcentaje,$as_numcon,$as_dended,&$io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
		$la_data[1]=array('fecha'=>'<b>Fecha de Pago</b>','dended'=>'<b>Retención</b>','monto'=>'<b>Monto Objeto de Retención</b>',
