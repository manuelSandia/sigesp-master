...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->Rectangle(120,710,440,40);
        $io_pdf->line(410,710,410,750); //vertical
		$io_pdf->line(410,730,560,730); //horizontal
		...
		$tm=260-($li_tm/2);
		$io_pdf->addText($tm,725,13,$as_titulo); // Agregar el título
		$io_pdf->addText(420,735,10,"<b> No.: </b> ".$as_numsol); // Agregar el título
		$io_pdf->addText(420,717,10,"<b>Fecha: </b> ".$ad_fecregsol); // Agregar el título
		$io_pdf->addText(550,760,7,date("d/m/Y")); // Agregar la Fecha
            $io_pdf->addText(110,780,6,"INSTITUTO UNIVERSITARIO DE TECNOLOGIA"); // Agregar el título	
            $io_pdf->addText(130,770,6,"JACINTO NAVARRO VALLENILLA"); // Agregar el título
            $io_pdf->addText(140,760,6,"CARUPANO EDO. SUCRE"); // Agregar el título

		//Cuadro de firmas
   		$io_pdf->Rectangle(15,60,570,140);
		$io_pdf->line(15,130,585,130);//Horizontal				
		$io_pdf->addText(20,187,7,"PROGRAMADO:"); // Agregar el título		
		$io_pdf->line(220,130,220,200);	//linea vertical
		$io_pdf->addText(230,187,7,"COMPROMETIDO:"); // Agregar el título		
		$io_pdf->line(430,130,430,200);	//linea vertical
		$io_pdf->addText(440,187,7,"DISPONIBLE:"); // Agregar el título		
		$io_pdf->line(15,112,585,112);//Horizontal		
		$io_pdf->line(15,72,585,72);//Horizontal
		$io_pdf->addText(50,115,7,"<b>PRESUPUESTO</b>"); // Agregar el título
		$io_pdf->addText(50,64,7,"<b>FIRMA Y FECHA</b>"); // Agregar el título
		$io_pdf->line(150,60,150,130);	//LINEA VERTICAL	
		$io_pdf->addText(200,115,7,"<b>ADMINISTRACION</b>"); // Agregar el título
		$io_pdf->addText(200,64,7,"<b>FIRMA Y FECHA</b>"); // Agregar el título	
		$io_pdf->line(300,60,300,130);	//LINEA VERTICAL			
		$io_pdf->addText(340,115,7,"<b>SUB-DIRECCION ADM.</b>"); // Agregar el título
		$io_pdf->addText(340,64,7,"<b>FIRMA Y FECHA</b>"); // Agregar el título	
		$io_pdf->line(440,60,440,130);	//LINEA VERTICAL			
		$io_pdf->addText(480,115,7,"<b>DIRECCION</b>"); // Agregar el título
		$io_pdf->addText(485,64,7,"<b>FIRMA Y FECHA</b>"); // Agregar el título
		$io_pdf->addText(130,35,7,"RECIBE CONFORME:"); // Agregar el título	
		$io_pdf->addText(250,35,7,"_________________________________________"); // Agregar el título
		$io_pdf->addText(250,10,7,"C.I:"); // Agregar el título	
		$io_pdf->addText(265,10,7,"<b>RIF:</b>"); // Agregar el título	
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_nompro,$as_dirpro,$as_estsolpag,$as_denfuefin,$as_consol,$as_obssol,$ad_monsol,$ls_rifpro,$ls_nomproben,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(270,25,7,'<b>'.$ls_nomproben.'</b>'); // Agregar el título
		$io_pdf->addText(300,10,7,'<b>'.$ls_rifpro.'</b>'); // Agregar el título
		$io_pdf->ezSetDy(+50);
	...
	function uf_print_detalle_recepcion($la_data,$ai_totsubtot,$ai_tottot,$ai_totcar,$ai_totded,&$io_pdf)
	{
		...
		$la_datatit[1]=array('numrecdoc'=>'<b>Nro del DOCUMENTO</b>',
							 ...
							 'subtotdoc'=>'<b>MONTO</b>',
							 'mondeddoc'=>'<b>IMPUESTO</b>',
							 'moncardoc'=>'<b>DEDUCCION</b>',
							 'montotdoc'=>'<b>MONTO</b>');
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
		    ...
		    $io_pdf->ezSetCmMargins(5,5,3,3); // Configuracion de los margenes en centimetros.		
			$io_pdf->ezStartPageNumbers(570,47,8,'','',1); // Insertar el número de página
			$li_totrow=$io_report->DS->getRowCount("numsol");
			for ($li_i=1;$li_i<=$li_totrow;$li_i++)
			    {
			 	  $ls_numsol	= trim($io_report->DS->data["numsol"][$li_i]);
			 	  $ls_rifpro	= trim($io_report->DS->data["rifpro"][$li_i]);
			  ...
			  uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecemisol,$ls_estprosol,&$io_pdf);
				  uf_print_cabecera($ls_rifpro.' - '.$ls_nomproben,$ls_dirproben,$ls_estsolpag,$ls_denfuefin,$ls_consol,$ls_obssol,$ld_monsol,$ls_rifpro,$ls_nomproben,&$io_pdf);				
