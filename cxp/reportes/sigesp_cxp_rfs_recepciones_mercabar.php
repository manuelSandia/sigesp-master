...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,&$io_pdf)
	{
        ...
        $io_pdf->Rectangle(155,700,430,60);
		...
		$io_pdf->addText(20,700,4,"MERCADO MAYORISTA DE ALIMENTOS DE BARQUISIMETO C.A."); // Agregar el título
		$io_pdf->addText(40,697,4,"MERCABAR, RIF: J-08512511-6"); // Agregar el título
		// cuadro inferior
		$io_pdf->setStrokeColor(0,0,0);
		...
		$io_pdf->line(390,60,390,130);		
		$io_pdf->addText(50,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(40,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(215,122,7,"COORDINACION DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(227,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(430,122,7,"PLANIFICACION Y PRESUPUESTO"); // Agregar el título
	...
	function uf_print_detalle_spg($aa_data,$ai_totpre,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('numrecdoc'=>array('justification'=>'center','width'=>140), // Justificación y ancho de la columna
									   'codestpro'=>array('justification'=>'center','width'=>170), // Justificación y ancho de la columna
						 			   'spg_cuenta'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
	...
	function uf_print_detalle_scg($aa_data,$ai_totdeb,$ai_tothab,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('numrecdoc'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
						 			   ...
						 			   'denominacion'=>array('justification'=>'center','width'=>190), // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>410), // Justificación y ancho de la columna
						 			   'totdeb'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'tothab'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_datatot,$la_columnas,'',$la_config);
	}// end function uf_print_detalle
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
...
//////////////////////////   GRID DETALLE PRESUPUESTARIO		//////////////////////////////////////
				...
				if($lb_valido)
				{
					...
					for($li_s=1;$li_s<=$li_totrowspg;$li_s++)
					{
						...
						$ls_denominacion=trim($io_report->ds_detalle_spg->data["denominacion"][$li_s]);
						...
						$la_data[$li_s]=array('numrecdoc'=>$ls_numdoccom,'codestpro'=>$as_programatica,
											  'spg_cuenta'=>$ls_spgcuenta,'monto'=>$li_monto,'denominacion'=>$ls_denominacion);
					}	
				...
				if($lb_valido)
				{
					...
					for($li_s=1;$li_s<=$li_totrowscg;$li_s++)
					{
						...
						$la_data[$li_s]=array('numrecdoc'=>$ls_numdoccom,'sc_cuenta'=>$ls_sccuenta,
											  'mondeb'=>$li_montodebe,'monhab'=>$li_montohab,'denominacion'=>$ls_denominacion);
					}	
