<?PHP
	...
	function uf_print_encabezadopagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo_emica.jpg',40,525,490,65); // Agregar Logo
		$io_pdf->addText(910,595,8,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(916,585,7,date("h:i a")); // Agregar la Hora
		$io_pdf->setStrokeColor(0,0,0);
        $io_pdf->Rectangle(650,100,310,100);	
		$io_pdf->addText(60,512,13,"<b>".$as_titulo."</b>"); // Agregar el t�ulo				
		$io_pdf->addText(660,140,13,'________________________________________'); // Agregar el t�ulo				
		$io_pdf->addText(660,122,13,'FIRMA Y SELLO DEL AGENTE DE RETENCION'); // Agregar el t�ulo				
		$io_pdf->addText(730,108,13,'RIF: G-20009017-0'); // Agregar el t�ulo				
