<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo_emica.jpg',50,685,490,65); // Agregar Logo
	...
	function uf_print_encabezado($as_agente,$as_nombre,$as_rif,$as_nit,$as_telefono,$as_direccion,$as_consol,&$io_pdf)
	{
		...
		$la_data[2]=array('name'=>'<b><i>Rif. Agente de Retención: G-20009017-0</i></b>');
