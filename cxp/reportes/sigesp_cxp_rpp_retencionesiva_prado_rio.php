<?PHP
	...
	function uf_print_encabezadopagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addText(260,570,13,"<b><i>".$as_titulo."</i></b>"); // Agregar el t�ulo				
		$io_pdf->restoreState();
		$io_pdf->closeObject();
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,&$io_pdf)
	{
		...
		$io_pdf->addText(850,500,9,"<b>1.FECHA</b>"); // Agregar el titulo
		$io_pdf->addText(850,485,9,$ad_fecrep); // Agregar el titulo								 
		$io_pdf->Rectangle(845,439,100,28);	
		$io_pdf->addText(850,456,9,"<b>4.PERIODO FISCAL</b>"); // Agregar el titulo	
		...
		$io_pdf->addText(405,458,9,"<b>3.REGISTRO DE INFORMACION FISCAL DEL AGENTE DE RETENCION</b>"); // Agregar el titulo
		...
		$io_pdf->addText(405,375,9,"<b>7.REGISTRO DE INFORMACION FISCAL DEL SUJETO RETENIDO (R.I.F)</b>"); // Agregar el titulo
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_ley_ret_iva(&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_ley_ret_iva
		//		   Access: private 
		//	    Arguments: io_pdf // Objeto PDF
		//    Description: funcion que imprime el articulo 11 de la ley de IVA
		//	   Creado Por: Ing. Néstor Falcón.	
		// Fecha Creacion: 21/11/2007
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////				
		$io_pdf->ezSetY(560);
		$la_data1=array(array('name'=>'Art. 11 Ley del IVA: Seran responsables del pago del impuesto en calidad de agentes de retencion, los compradores o adquirientesde determinados bienes muebles y los receptores de ciertos servicios, a quienes la Administracion Tributaria designe como tal.'));						                      
		$la_columna=array('name'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 ...
						 'cols'=>array('name'=>array('justification'=>'center','width'=>600)));  
		$io_pdf->ezTable($la_data1,$la_columna,'',$la_config);	
		unset($la_data1);
		unset($la_columna);
		unset($la_config);
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetDy(-25);
		$la_data[1]=array('name1'=>'Elaborado Por:','name2'=>'Aprobado Por:','name3'=>'Recibido Por:');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>900, // Ancho Mínimo de la tabla
						 'xPos'=>500, // Orientación de la tabla
						 'cols'=>array('name1'=>array('justification'=>'center','width'=>300), // Justificacion y ancho de la columna
  						 			   'name2'=>array('justification'=>'center','width'=>300),
									   'name3'=>array('justification'=>'center','width'=>300))); 
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
