<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_gel.jpg',30,600,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],485,600,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
	...
	function uf_print_encabezado($as_agente,$as_nombre,$as_rif,$as_nit,$as_telefono,$as_direccion,&$io_pdf)
	{
		...
		$la_data[4]=array('name'=>'<b><i>Dirección:</i></b>'."  ".$as_direccion);
		$la_data[5]=array('name'=>'<b><i>Teléfono:</i></b>'.$as_telefono);
	...
	function uf_print_firmas(&$io_pdf)
	{
	    ...
	    $io_pdf->addText(100,240,10,"Elaborado Por");  
	  
	    $io_pdf->line(50,250,230,250);
	    $io_pdf->addText(410,240,10,"Revisado Por");  

	    $io_pdf->line(350,150,540,150);
	    $io_pdf->addText(55,140,10,"GERENTE DE ADMON. Y FINANZAS");  
	  
	    $io_pdf->line(50,150,230,150);
	    $io_pdf->addText(400,140,10,"CONTRIBUYENTE");  
