<?PHP
	...
	function uf_print_encabezadopagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_gel.jpg',870,539,60,50); // Agregar Logo
		$io_pdf->setStrokeColor(0,0,0);
        $io_pdf->Rectangle(150,540,710,40);
		$io_pdf->addText(240,555,13,"<b>".$as_titulo."</b>");
		
		$as_ley="Ley IVA - Art 11 Seran responsables del pago del impuesto en calidad de agentes de retencion,";
		$as_ley2="los compradores o adquirientes de determinados bienes muebles y los receptores de";
		$as_ley3="ciertos servicios, a quienes la Administracion Tributaria designe como tal.";
		
        $io_pdf->Rectangle(45,475,420,40);	
		$io_pdf->addText(50,500,9,"<b>".$as_ley."</b>");
		$io_pdf->addText(50,490,9,"<b>".$as_ley2."</b>");
		$io_pdf->addText(50,480,9,"<b>".$as_ley3."</b>");
		
		$io_pdf->addText(60,108,10,"<b>              Elaborado por:                                               Revisado por:                                                                Aprobado por:                                                  Firma y Sello del Contribuyente</b>"); 
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,&$io_pdf)
	{
		...
		if($ai_estcmpret==2)
		{
		    $io_pdf->Rectangle(800,380,180,30);		
			$io_pdf->addText(850,390,15,"<b> ANULADO </b>"); 
		}	
