...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,&$io_pdf)
	{
       ...
       $io_pdf->Rectangle(15,60,570,70);
		...
		$io_pdf->addText(227,122,7,"VERIFICADO POR PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(245,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(430,122,7,"VERIFICADO POR CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(442,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
