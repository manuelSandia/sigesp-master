...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_mh.jpg',25,705,450,50); // Agregar Logo
		if ($as_estprodoc=="A")
		{
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,697,11,$as_titulo); // Agregar el título
		...
		$io_pdf->addText(257,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(440,122,7,"AUDITORIA INTERNA"); // Agregar el título
	...
	function uf_print_detalle_spg($aa_data,$ai_totpre,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('numrecdoc'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
									   'codestpro'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
	...
	function uf_print_detalle_scg($aa_data,$ai_totdeb,$ai_tothab,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('numrecdoc'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
						 			   'sc_cuenta'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'center','width'=>180), // Justificación y ancho de la columna
	...
	function uf_print_totales($ai_montotdoc,$ai_mondeddoc,$ai_moncardoc,$ai_monsubdoc,$ai_montotcar,&$io_pdf)
	{
		...
		$la_data[2]=array('titulo'=>'<b>Iva</b>','contenido'=>$ai_moncardoc);
...
//////////////////////////   GRID DETALLE PRESUPUESTARIO		//////////////////////////////////////
				...
				if($lb_valido)
				{
					...
					for($li_s=1;$li_s<=$li_totrowspg;$li_s++)
					{
						...
						$ls_denctaspg=trim($io_report->ds_detalle_spg->data["denominacion"][$li_s]);
						...
						$la_data[$li_s]=array('numrecdoc'=>$ls_numdoccom,'codestpro'=>$as_programatica,
											  'spg_cuenta'=>$ls_spgcuenta,'denominacion'=>$ls_denctaspg,'monto'=>$li_monto);
					}
...
//////////////////////////      GRID DETALLE CONTABLE	   	//////////////////////////////////////
				...
				if($lb_valido)
				{
					...
					for($li_s=1;$li_s<=$li_totrowscg;$li_s++)
					{
						...
						$ls_denctasc=trim($io_report->ds_detalle_scg->data["denominacion"][$li_s]);
						...
						$la_data[$li_s]=array('numrecdoc'=>$ls_numdoccom,'sc_cuenta'=>$ls_sccuenta,
											  'denominacion'=>$ls_denctasc,'mondeb'=>$li_montodebe,'monhab'=>$li_montohab);
					}
