...
//		$io_pdf->line(380,60,380,130);		
		$io_pdf->addText(75,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(80,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(75,75,7,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]); // Agregar el título
		$io_pdf->addText(265,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(255,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(460,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(455,75,7,"CN EMMY DA COSTA"); // Agregar el título
		$io_pdf->addText(410,63,7,"DIRECCIÓN DE ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
