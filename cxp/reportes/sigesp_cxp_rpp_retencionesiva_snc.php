<?PHP
	...
	function uf_print_encabezadopagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addText(240,555,13,"<b>".$as_titulo."</b>"); // Agregar el titulo				
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle($la_data,$ai_totconiva,$ai_totsiniva,$ai_totbasimp,$ai_totmonimp,$ai_totivaret,&$io_pdf)
	{
		...
		// Segmento de firmas
		$io_pdf->addText(250,80,9,"FIRMA Y SELLO DEL DIRECTOR"); // Agregar el titulo
		$io_pdf->addText(650,80,9,"CONTRIBUYENTE/PROVEEDOR"); // Agregar el titulo
