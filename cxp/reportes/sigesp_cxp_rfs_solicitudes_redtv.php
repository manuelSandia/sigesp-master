...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(129,60,129,130);		
		$io_pdf->line(243,60,243,130);		
		$io_pdf->line(357,60,357,130);		
		$io_pdf->line(471,60,471,130);		
		$io_pdf->addText(42,122,7,"ELABORADO POR"); // Agregar el título
		...
		$io_pdf->addText(267,122,7,"CONFORMADO POR"); // Agregar el título
		$io_pdf->addText(265,63,7,"ADMIN. Y FINANZAS"); // Agregar el título
		$io_pdf->addText(384,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(375,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(505,122,7,""); // Agregar el título
		$io_pdf->addText(505,122,7,"CONTABILIDAD"); // Agregar el título
...
/*		$io_pdf->addText(40,122,7,"ELABORADO POR"); // Agregar el título
		...
		$io_pdf->addText(145,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(275,122,7,"CONFORMADO POR"); // Agregar el título
		$io_pdf->addText(257,63,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->addText(455,122,7,"APROBADO POR"); // Agregar el título
...
*/		$io_pdf->restoreState();
							   ...
							   $ai_monsol,$as_monto,&$io_pdf)
	{
		...
		$la_data[1]=array('titulo'=>'<b>'.$ls_titulo.'</b>','contenido'=>'<b>'.$ai_monsol.'</b>');
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
