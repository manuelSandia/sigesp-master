...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(15,73,585,73); // linea horizontal inferior de los firmantes
		$io_pdf->line(15,130,585,130); // 1ra linea horizontal superior de los firmantes	
		$io_pdf->line(15,117,585,117);	// 2 da linea horizontal superior de los firmantes
		$io_pdf->addText(95,135,8,"CONTABILIDAD"); // Agregar el título	
		$io_pdf->line(90,60,90,130); // 1ra linea vertical de los firmantes
		$io_pdf->addText(25,122,6,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(25,63,6,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->line(165,60,165,130); // 2ra linea vertical de los firmantes
		$io_pdf->addText(93,122,6,"CONTABILIZADO POR"); // Agregar el título
		$io_pdf->addText(93,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título		
		$io_pdf->line(240,60,240,145);	// 3da linea vertical de los firmantes
		$io_pdf->addText(180,122,6,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(168,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título		
		$io_pdf->line(325,60,325,145);	// 4ra linea vertical de los firmantes
		$io_pdf->addText(255,135,8,"PRESUPUESTO"); // Agregar el título			
		$io_pdf->addText(255,122,6,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(250,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(410,60,410,145);	// 5ta linea vertical de los firmantes
		$io_pdf->addText(333,135,8,"ADMINISTRACION"); // Agregar el título			
		$io_pdf->addText(337,122,6,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(335,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(498,60,498,145);	// 6ta linea vertical de los firmantes
		$io_pdf->addText(423,135,8,"PRESIDENCIA"); // Agregar el título			
		$io_pdf->addText(427,122,6,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(420,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(502,135,8,"AUDITORIA INTERNA"); // Agregar el título		
		$io_pdf->addText(520,122,6,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(507,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
