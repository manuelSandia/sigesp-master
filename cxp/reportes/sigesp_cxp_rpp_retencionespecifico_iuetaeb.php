<?php
	...
	function uf_print_cabecera($as_codded,$as_dended,&$io_pdf)
	{
		...
		$io_pdf->addText(550,93,8,"___________________________________"); // Agregar titutlo
		$io_pdf->addText(600,80,8,"LIDIA RAMOS"); // Agregar titutlo
		$io_pdf->addText(600,70,8,"LIQUIDADOR"); // Agregar titutlo
		$io_pdf->addText(330,50,10,"Fecha de Liquidación"); // Agregar la Fecha
		$io_pdf->addText(347,60,10,date("d/m/Y")); // Agregar la Fecha
