...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->line(15,40,585,40);     // Horizontal 
		$io_pdf->line(480,700,480,780); // Vertical
		$io_pdf->line(480,740,585,740);
        $io_pdf->Rectangle(15,700,570,80);
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],20,705,170,$_SESSION["ls_height"]); // Agregar Logo
		if ($as_estprosol=="A")
		{
			$io_pdf->addText(485,765,10,"<b>ANULADO</b>"); // Agregar la Fecha
		}
		...
		$io_pdf->line(15,145,435,145);		         // Horizontal Firmante Superior
		...
		$io_pdf->addText(325,90,7,"GERENCIA GENERAL"); // Agregar el título
		$io_pdf->line(435,85,435,155);		        // Vertical
		$io_pdf->addText(440,125,7,"BANCO:"); // Agregar el título
		$io_pdf->line(435,122,585,122);		        // Horizontal Entre BANCO Y FECHA
		$io_pdf->addText(440,90,7,"FECHA DE PAGO:"); // Agregar el título
		$io_pdf->line(15,100,435,100);		        // Horizontal Firmante Inferior
