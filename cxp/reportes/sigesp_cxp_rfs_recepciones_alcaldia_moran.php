...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,&$io_pdf)
	{
		...
		$io_pdf->addText(130,122,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(120,63,7,"CONTABILIDAD FISCAL"); // Agregar el título
		$io_pdf->addText(420,122,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(400,63,7,"DIRECCION DE PRESUPUESTO"); // Agregar el título
