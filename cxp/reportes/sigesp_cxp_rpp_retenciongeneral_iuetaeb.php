<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_fecdes,$as_fechas,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],50,730,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,715,11,$ls_periodo); // Agregar el título
	...
	function uf_print_cabecera(&$io_pdf)
	{
	    ...
	    $io_pdf->closeObject();
	    $io_pdf->addObject($io_encabezado,'all');
		$io_pdf->addText(60,80,8,"AGENTE DE RETENCION"); // Agregar titutlo
		$io_pdf->addText(60,70,8,"DPTO. RECURSOS FINANCIEROS"); // Agregar titutlo
		$io_pdf->addText(50,93,8,"____________________________________"); // Agregar titutlo
		$io_pdf->addText(400,93,8,"___________________________________"); // Agregar titutlo
		$io_pdf->addText(450,80,8,"LIDIA RAMOS"); // Agregar titutlo
		$io_pdf->addText(450,70,8,"LIQUIDADOR"); // Agregar titutlo
		$io_pdf->addText(270,50,10,"Fecha de Liquidación"); // Agregar la Fecha
		$io_pdf->addText(287,60,10,date("d/m/Y")); // Agregar la Fecha
