...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(442,60,442,190);		
		$io_pdf->line(299,180,585,180);		
		$io_pdf->addText(130,192,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(415,192,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(310,182,7,"Direccion General de Administracion"); // Agregar el título
		$io_pdf->addText(453,182,7,"Direccion de Administracion y FInanzas"); // Agregar el título
		$io_pdf->addText(45,62,7,"NOMBRE(S) APELLIDO(S)"); // Agregar el título
		$io_pdf->addText(190,62,7,"CEDULA DE IDENTIDAD"); // Agregar el título
...
//		$io_pdf->addText(440,122,7,"CONTRALORIA INTERNA"); // Agregar el título
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezSetCmMargins(3.6,7.2,3,3); // Configuración de los margenes en centímetros
