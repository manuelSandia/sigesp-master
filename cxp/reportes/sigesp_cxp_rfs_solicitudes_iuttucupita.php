...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(15,105,585,105);
		$io_pdf->line(15,117,585,117);
		$io_pdf->line(130,60,130,130);
		$io_pdf->line(270,60,270,130);
		$io_pdf->line(420,60,420,130);
		$io_pdf->addText(40,122,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(17,108,7,"FECHA:         /        / "); // Agregar el título
		$io_pdf->addText(17,97,7,"FIRMA:"); // Agregar el título

		$io_pdf->addText(131,108,7,"FECHA:         /        / "); // Agregar el título
		$io_pdf->addText(131,97,7,"FIRMA:"); // Agregar el título

		$io_pdf->addText(272,108,7,"FECHA:         /        / "); // Agregar el título
		$io_pdf->addText(272,97,7,"FIRMA:"); // Agregar el título

		$io_pdf->addText(421,108,7,"FECHA:         /        / "); // Agregar el título
		$io_pdf->addText(421,97,7,"FIRMA:"); // Agregar el título

		$io_pdf->addText(150,122,7,"SUB-DIREC.ADMINISTRATIVA"); // Agregar el título
		//$io_pdf->addText(145,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(315,122,7,"PRESUPUESTO"); // Agregar el título
		//$io_pdf->addText(282,63,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->addText(465,122,7,"CONTABILIDAD"); // Agregar el título
