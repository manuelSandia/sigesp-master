...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(210,60,210,130);		
		$io_pdf->line(322,60,322,130);
		$io_pdf->line(415,60,415,130);
		$io_pdf->line(502,60,502,130);		
		$io_pdf->addText(28,122,6,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(20,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(105,122,6,"PLANIFICACION Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(115,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(216,122,6,"COORDINACION DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(227,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(325,122,6,"GERENCIA ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(335,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(425,122,6,"GERENCIA GENERAL"); // Agregar el título
		$io_pdf->addText(422,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(525,122,6,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(512,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
