<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$li_tm=$io_pdf->getTextWidth(9,"RETENCION LEY DE TIMBRE FISCAL");
		$tm=396-($li_tm/2);
		$io_pdf->addText($tm,530,9,"RETENCION LEY DE TIMBRE FISCAL"); // Agregar el título
							   ...
							   $as_nomsujret,$as_rif,$as_numlic,$ai_estcmpret,$as_conceptosp,&$io_pdf)
	{
		...
		unset($la_config);								 
		$io_pdf->ezSetY(490);
		$la_data[1]=array('name'=>'<b>RIF DEL AGENTE DE RETENCIÓN</b>');
	...
	{						 
		...
		$la_data1[1]=array('firma'=>'_________________________________________________');	
		$la_data1[2]=array('firma'=>'PROVEEDOR/CONTRIBUYENTE');	
		$la_data1[3]=array('firma'=>'');	
		$la_data1[4]=array('firma'=>'');
		$la_columna=array('firma'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 9,  // Tamaño de Letras de los títulos
