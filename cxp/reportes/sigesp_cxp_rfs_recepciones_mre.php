...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,&$io_pdf)
	{
		...
		$io_pdf->addText(78,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(270,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(260,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(460,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(470,63,7,"TESORERIA"); // Agregar el título
