...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_nomusu,$as_estprosol,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->saveState();
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_inn.jpg',20,730,570,40); // Agregar Logo
		if ($as_estprosol=="A")
		{
        ...
        $io_pdf->Rectangle(15,58,570,72);
		$io_pdf->line(15,73,585,73);
		$io_pdf->line(15,117,585,117);

		$io_pdf->line(200,59,200,130);
		$io_pdf->line(400,59,400,130);
		$io_pdf->addText(78,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(80,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(20,75,7,$as_nomusu); // Agregar el título
		$io_pdf->addText(265,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(250,66,7,"CONTROL DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(248,60,7,"Y EJECUCION PRESUPUESTARIA"); // Agregar el título
		$io_pdf->addText(455,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(455,63,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecemisol,$ls_nomusu,$ls_estprosol,&$io_pdf);
