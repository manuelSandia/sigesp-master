...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,&$io_pdf)
	{
		...
		$io_pdf->addText(45,135,8,"<b>GERENCIA SOLICITANTE</b>"); // Agregar el título			
		$io_pdf->addText(200,135,8,"<b>GERENCIA DE ADMINISTRACIÓN Y FINANZAS</b>"); // Agregar el título
		$io_pdf->addText(475,135,8,"<b>PRESIDENCIA</b>"); // Agregar el título		
		$io_pdf->addText(60,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(65,63,7,"FIRMA/SELLO"); // Agregar el título
		$io_pdf->addText(190,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(200,63,7,"FIRMA/SELLO"); // Agregar el título
		$io_pdf->addText(315,122,7,"PROCESADO POR"); // Agregar el título
		$io_pdf->addText(325,63,7,"FIRMA/SELLO"); // Agregar el título
		$io_pdf->addText(470,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(452,63,7," FIRMA/SELLO    PRESIDENTE(A)"); // Agregar el título
	...
	function uf_print_ded($la_dataded,&$io_pdf)
	{
		...
		unset($la_config);
		//-----------------------------------------------------------------------------------------------------------------																												
		$la_columnaded=array('dended'=>'<b>Denominación</b>',						  
						     'monded'=>'<b>Monto</b>');
		$la_configded=array('showHeadings'=>1,   // Mostrar encabezados
						    ...
						    'cols'=>array('dended'=>array('justification'=>'center','width'=>180), // Justificación y ancho de la columna
						 			      'monded'=>array('justification'=>'center','width'=>100)));      // Justificación y ancho de la columna
