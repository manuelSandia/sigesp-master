...
//		$io_pdf->line(50,40,960,40);
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,&$io_pdf)
	{
		...
		$io_pdf->addText(150,515,10,'(LEY IVA-ART.11 "Seran responsables del pago del impuesto en calidad de agentes de retencion,');
		$io_pdf->addText(150,505,10,'los compradores o adquirientes de determinados bienes muebles y los receptores de ciertos servicios,');
		$io_pdf->addText(150,495,10,'a quienes la Administracion Tributaria designe como tal")'); // Agregar el titulo
	...
	function uf_print_detalle($la_data,$ai_totconiva,$ai_totsiniva,$ai_totbasimp,$ai_totmonimp,$ai_totivaret,&$io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
		$la_data[1]=array('name0'=>'<b>TOTALES</b>','name1'=>$ai_totconiva,'name2'=>$ai_totsiniva,'name3'=>$ai_totbasimp,
		                  'name4'=>'','name5'=>$ai_totmonimp,'name6'=>$ai_totivaret);						                      
		$la_columna=array('name0'=>'','name1'=>'','name2'=>'','name3'=>'','name4'=>'','name5'=>'','name6'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' =>8,    // Tamaño de Letras
						 ...
						 'xPos'=>500, // Orientación de la tabla
						 'Width'=>900,
						 'cols'=>array('name0'=>array('justification'=>'center','width'=>480), // Justificacion y ancho de la columna
	...
	{
	    $la_data1[1]=array('name1'=>'','name2'=>'','name3'=>'');
	    $la_data1[3]=array('name1'=>'<b>ELABORADO POR:</b>','name2'=>'','name3'=>'RECIBIDO POR:');
		...
		$la_config= array('showHeadings'=>0, // Mostrar encabezados
						  ...
						  'cols'=>array('name1'=>array('justification'=>'left','width'=>200),						                
										'name2'=>array('justification'=>'center','width'=>240), // Ancho Máximo de la tabla
										'name3'=>array('justification'=>'left','width'=>455))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data1,$la_columna,'',$la_config); 		 
		
		$la_data2[1]=array('name1'=>'','name2'=>'','name3'=>'');
	    $la_data2[3]=array('name1'=>'<b>JEFE DE LA UNIDAD:</b>','name2'=>'','name3'=>'NOMBRE Y APELLIDO:');
	    ...
	    $la_data3[3]=array('name1'=>'<b>AGENTE DE RETENCION:</b>','name2'=>'','name3'=>'CEDULA DE IDENTIDAD:');	
				...
				if($lb_valido)
				{
					...
					if($lb_valido)
					{
						...
						for($li_i=1;$li_i<=$li_total;$li_i++)
						{
							...
							$li_totdersiniva= ($li_coniva - $li_monto);
							$ls_numfacafec="";
