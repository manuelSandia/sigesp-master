...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],20,702,56,56); // Agregar Logo
		if ($as_estprosol=="A")
		{
		...
		$io_pdf->line(260,60,260,140);		
		$io_pdf->line(420,60,420,140);		
		$io_pdf->addText(36,127.6,8,'<b>ELABORADO</b>');
		$io_pdf->addText(172,127.6,8,'<b>REVISADO</b>');
		$io_pdf->addText(276,131.6,8,'<b>COORDINACIÓN DE PLANIFICACIÓN</b>');
		$io_pdf->addText(276,122,8,'<b>PRESUPUESTO, ORGANIZACIÓN Y</b>');
		$io_pdf->addText(313,114,8,'<b> SISTEMAS</b>');
		$io_pdf->addText(449,130.6,8,'<b>DIRECCIÓN DE GESTIÓN</b>');
		$io_pdf->addText(464,120,8,'<b>ADMINISTRATIVA</b>');	
		$io_pdf->restoreState();
		$io_pdf->closeObject();
