<?PHP
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,&$io_pdf)
	{
		...
		$io_pdf->addText(850,500,9,"<b>FECHA</b>"); // Agregar el titulo
            $io_pdf->addText(70,105,9,"<b>____________________________</b>"); // Agregar el titulo
            $io_pdf->addText(80,90,9,"<b>CONTRALORA MUNICIPAL</b>"); // Agregar el titulo
            $io_pdf->addText(458,105,9,"<b>____________________________</b>"); // Agregar el titulo
            $io_pdf->addText(480,90,9,"<b>RECIBI CONFORME</b>"); // Agregar el titulo
            $io_pdf->addText(780,105,9,"<b>____________________________</b>"); // Agregar el titulo
            $io_pdf->addText(820,90,9,"<b>CONTABILIDAD</b>"); // Agregar el titulo
