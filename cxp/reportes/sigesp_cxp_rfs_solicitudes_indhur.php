...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(15,115,585,115);		
		$io_pdf->line(110,60,110,130);		
		$io_pdf->line(205,60,205,130);		
		$io_pdf->line(300,60,300,130);		
		$io_pdf->line(395,60,395,130);		
		$io_pdf->line(490,60,490,130);		


		$io_pdf->addText(20,123,6,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(20,117,6,"TSU. JAIRE MARTIN"); // Agregar el título
		$io_pdf->addText(20,63,6,"FIRMA / FECHA"); // Agregar el título
		$io_pdf->addText(115,123,6,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(115,117,6,"TSU. NESTOR ESCOBAR"); // Agregar el título
		$io_pdf->addText(115,63,6,"FIRMA / FECHA"); // Agregar el título
		$io_pdf->addText(210,123,6,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(210,117,6,"LCDA. MARINEL FAJARDO"); // Agregar el título
		$io_pdf->addText(210,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(305,123,6,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(305,117,6,"TSU. LEIDIS LOZADA"); // Agregar el título
		$io_pdf->addText(305,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(400,123,6,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(400,117,6,"LCDO. DANNY APARICIO"); // Agregar el título
		$io_pdf->addText(400,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(495,123,6,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(495,117,6,"ARQ. MARÍA E. VILLAQUIRAN"); // Agregar el título
		$io_pdf->addText(495,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
