<?PHP
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,&$io_pdf)
	{
		...
		$io_pdf->addText(700,176,9,"<b>RECIBI CONFORME</b>"); // Agregar el titulo
		$io_pdf->addText(700,136,9,"<b>Nombre: _______________________________________</b>"); // Agregar el titulo
		$io_pdf->addText(700,96,9,"<b>Fecha:_________________________________________</b>"); // Agregar el titulo
		$io_pdf->addText(700,56,9,"<b>Firma:_________________________________________</b>"); // Agregar el titulo
		$io_pdf->addText(150,176,9,"<b>AGENTE DE RETENCION</b>"); // Agregar el titulo
		$io_pdf->addText(100,116,9,"<b>___________________________________________</b>"); // Agregar el titulo
	...
	function uf_print_detalle($la_data,$ai_totconiva,$ai_totsiniva,$ai_totbasimp,$ai_totmonimp,$ai_totivaret,$as_ordenp,$ls_conceptosop,&$io_pdf)
	{
		...
		// Fecha Creación: 14/07/2007 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->Rectangle(845,399,100,28);	
		$io_pdf->addText(850,416,9,"<b>ORDEN DE PAGO</b>"); // Agregar el titulo	
		$io_pdf->addText(850,403,9,$as_ordenp); // Agregar el titulo
		...
		unset($la_columna);
		unset($la_config);
		$la_data[1]=array('concepto'=>"Detalle:  ".$ls_conceptosop);						                      
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>900, // Ancho Mínimo de la tabla
						 'xPos'=>500, // Orientación de la tabla
						 'cols'=>array('name'=>array('justification'=>'center','width'=>690)));  
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		unset($la_data);
		unset($la_columna);
		unset($la_config);
