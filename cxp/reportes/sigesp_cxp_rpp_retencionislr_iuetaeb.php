<?php
	...
	function uf_print_encabezado($as_agente,$as_nombre,$as_rif,$as_nit,$as_telefono,$as_direccion,$as_consol,&$io_pdf)
	{
		...
		$la_data[5]=array('name'=>'<b><i>Concepto:  </i></b>'.$as_consol);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500,
						 'cols'=>array('name'=>array('justification'=>'full','width'=>500))); // Ancho Máximo de la tabla
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$la_data[3]=array('firma1'=>'AGENTE DE RETENCION','firma2'=>'LIDIA RAMOS');
		$la_data[4]=array('firma1'=>'DPTO. RECURSOS FINANCIEROS','firma2'=>'LIQUIDADOR');
		...
		$io_pdf->addText(270,320,10,"Fecha de Liquidación"); // Agregar la Fecha
		$io_pdf->addText(287,330,10,date("d/m/Y")); // Agregar la Fecha
