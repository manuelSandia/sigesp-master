<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo.jpg',100,490,150,50); // Agregar Logo
	...
	function uf_print_encabezado($as_agente,$as_nombre,$as_rif,$as_nit,$as_telefono,$as_direccion,&$io_pdf)
	{
		...
		$io_pdf->addText(659,457,10,date("d/m/Y")); // Agregar la Fecha
        $io_pdf->addText(619,457,10,"FECHA:");
        $io_pdf->Rectangle(80,550,630,-350);
		
		$la_data[1]=array('name1'=>' <b>NOMBRE O RAZON SOCIAL:</b>  '.$as_agente,'name2'=>'<b>Razón:</b>   '.$as_nombre);
		$la_data[2]=array('name1'=>' <b>N° RIF:</b>  '.$ls_rifemp,'name2'=>'<b>RIF:</b>   '.$as_rif.'          <b>NIT:</b>   '.$as_nit);
		$la_data[3]=array('name1'=>' <b>DIRECCION Y TELEFONO:</b>  '.$ls_diremp,'name2'=>'<b>Dirección:</b>   '.$as_direccion);
		...
		$la_config= array('showHeadings'=>0, // Mostrar encabezados
						  ...
						  'colGap'=>1,
						  'width'=>530,
						  'cols'=>array('name1'=>array('justification'=>'left','width'=>630))); // Ancho Máximo de la tabla
		...
		$io_pdf->ezSetY(380);
		$la_data[1]=array('name2'=>' <b>NOMBRE O RAZON SOCIAL:</b>   '.$as_nombre);
		$la_data[2]=array('name2'=>' <b>RIF:</b>   '.$as_rif.''.$as_nit);
		$la_data[3]=array('name2'=>' <b>DIRECCION:</b>   '.$as_direccion);
	
        $la_columna=array('name2'=>'');
		$la_config= array('showHeadings'=>0, // Mostrar encabezados
						  'fontSize' => 10, // Tamaño de Letras
						  'showLines'=>1, // Mostrar Líneas
						  'shaded'=>0, // Sombra entre líneas
						  ...
						  'colGap'=>1,
						  'width'=>530,
						  'cols'=>array('name2'=>array('justification'=>'left','width'=>630))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
	...
	function uf_print_detalle($aa_data,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		  ...
		  //$io_pdf->ezSetDy(0);
          $la_datatit = array(array('fecact'=>'<b>Fecha Factura</b>','numrecdoc'=>'<b>Nº Factura</b>','control'=>'<b>Nº Control</b>',
		                            'monobjret'=>'<b>Base Imponible</b>','porcentaje'=>'<b>Porcentaje</b>','retenido'=>'<b>Total Retenido</b>'));	
	      $la_columna = array('fecact'=>'','numrecdoc'=>'','control'=>'','monobjret'=>'','porcentaje'=>'','retenido'=>'');
	      $la_config  = array('showHeadings'=>0,
					          ...
					          'colGap'=>1,
						      'width'=>530,
						      'cols'=>array('fecact'=>array('justification'=>'center','width'=>110),
											...
											'retenido'=>array('justification'=>'center','width'=>100)));
	...
	{
	  $io_pdf->addText(130,150,9,"Firma y Sello");
	  $io_pdf->addText(110,142,9,"<b>Viajes y Turismos Ifamil</b>");
	  $io_pdf->addText(366,487,12,"<b>I.S.L.R</b>");
	  $io_pdf->addText(570,150,9,"Recibi Conforme");
	  $io_pdf->addText(79,457,10," <b>DATOS DEL AGENTE DE RETENCIÓN:</b>");
	  $io_pdf->addText(79,387,10," <b>DATOS DEL BENEFICIARIO</b>");      
	...
	$ls_titulo="<b>COMPROBANTE DE RETENCIONES</b>";
					   ...
					   for ($li_i=1;($li_i<=$li_total);$li_i++)
				 	       {
							 ...
							 $la_data[$li_i] = array('fecact'=>$ld_fecemidoc,'numrecdoc'=>$ls_numref,'control'=>$ls_numdoc,'monobjret'=>$ld_monobjret,'porcentaje'=>$ld_porcentaje.'%','retenido'=>$ld_totmonret);
					       }
					 }	
