<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_hci.jpg',20,715,565,50); // Agregar Logo
		$li_tm=$io_pdf->getTextWidth(15,$as_titulo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,630,15,$as_titulo); // Agregar el título
		$io_pdf->addText(512,693,8,"Fecha: ".date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(518,685,8,"Hora: ".date("h:i a")); // Agregar la hora
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$la_data[5]=array('firma1'=>'AGENTE DE RETENCION','firma2'=>'BENEFICIARIOS');
		...
		$io_pdf->addText(487,66,10,'<b>SELLO</b>');
