...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->addText(70,122,6,"UNIDAD DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(75,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(200,60,200,130);	//VERTICAL NUMERO 1	
		$io_pdf->addText(250,122,6,"GERENCIA DE ADMON Y RRHH"); // Agregar el título
		$io_pdf->addText(260,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(400,60,400,130); //VERTICAL NUMERO 2
		$io_pdf->addText(480,122,6,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(470,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
