...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,&$io_pdf)
	{
		...
		$io_pdf->addText(152,122,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(155,63,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(275,122,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(278,63,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(455,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(438,63,7,"ADMINISTRACION Y FINANZAS"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle_scg($aa_data,$ai_totdeb,$ai_tothab,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'innerLineThickness' =>0.5,
						 'cols'=>array('numrecdoc'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
						 			   'sc_cuenta'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
...
//////////////////////////      GRID DETALLE CONTABLE	   	//////////////////////////////////////
				...
				if($lb_valido)
				{
					...
					for($li_s=1;$li_s<=$li_totrowscg;$li_s++)
					{
						...
						$ls_denominacion=$io_report->ds_detalle_scg->data["denominacion"][$li_s];
						if($ls_debhab=="D")
						{
