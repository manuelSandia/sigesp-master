...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->addText(550,760,7,date("d/m/Y")); // Agregar la Fecha
            $io_pdf->addText(10,702,6,"<b>Calle 18 entre Av. Fraternidad y Lisandro Alvarado</b>"); // Agregar el título
            $io_pdf->addText(10,710,6,"<b>Alcaldia de Morán Rif:G-20000673-0</b>"); // Agregar el título
		//Cuadro de firmas
      $io_pdf->Rectangle(15,60,570,95);
            $io_pdf->line(15,200,150,200);
	      $io_pdf->line(150,156,150,200);
            $io_pdf->line(15,156,15,200);
		$io_pdf->line(15,130,585,130);		
		$io_pdf->line(125,60,125,155);		
		$io_pdf->line(235,60,235,155);		
		$io_pdf->line(355,60,355,155);
            $io_pdf->line(470,60,470,155);	
            
	      $io_pdf->addText(18,190,7,"<b>REVISADO POR:</b>"); // Agregar el título
	      $io_pdf->addText(40,140,7,"<b>PRESUPUESTO</b>"); // Agregar el título
		$io_pdf->addText(160,140,7,"<b>ALCALDE</b>"); // Agregar el título
		$io_pdf->addText(270,140,7,"<b>TESORERO(A)</b>"); // Agregar el título
		$io_pdf->addText(380,140,7,"<b>ADMINISTRACION</b>"); // Agregar el título
            $io_pdf->addText(505,140,7,"<b>CONFORME</b>"); // Agregar el título
            $io_pdf->addText(485,120,7,"<b>FECHA  /  /</b>"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_nompro,$as_dirpro,$as_estsolpag,$as_denfuefin,$as_consol,$as_obssol,$ad_monsol,$ls_monto,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data=array(array('name'=>'<b>Proveedor: </b>'.$as_nompro),
					   ...
					   array('name'=>'<b>Monto en Letras: </b>'.$ls_monto),
					   array('name'=>'<b>                                                                                                                                                                                      '.$ls_titulo.'</b>'.$ad_monsol));			
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
		    ...
		    $io_pdf->ezSetCmMargins(5,8,3,3); // Configuracion de los margenes en centimetros.		
			...
			for ($li_i=1;$li_i<=$li_totrow;$li_i++)
			  ...
			  uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecemisol,$ls_estprosol,&$io_pdf);
				  uf_print_cabecera($ls_rifpro.' - '.$ls_nomproben,$ls_dirproben,$ls_estsolpag,$ls_denfuefin,$ls_consol,$ls_obssol,$ld_monsol,$ls_monto,&$io_pdf);				
