...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(168,60,168,130);		
		$io_pdf->line(400,60,400,130);		
		
		$io_pdf->addText(15,145,7,"OBSERVACIONES"); // Agregar el título
		$io_pdf->addText(40,122,7,"PREPARADO POR:"); // Agregar el título
		$io_pdf->addText(20,110,7,"FECHA:          /        /         "); // Agregar el título
		$io_pdf->addText(20,95,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(230,122,7,"REVISADO POR:"); // Agregar el título
		$io_pdf->addText(169,110,7,"FECHA:          /        /         "); // Agregar el título
		$io_pdf->addText(169,95,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(460,122,7,"CONFORMADO POR:"); // Agregar el título
		$io_pdf->addText(401,110,7,"FECHA:          /        /         "); // Agregar el título
		$io_pdf->addText(401,95,7,"FIRMA:"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
