...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/encabezado.jpg',16,700,464,59); // Agregar Logo
		if ($as_estprosol=="A")
		{
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,713,11,$as_titulo); // Agregar el título
		...
		$io_pdf->addText(42,63,7,"FIRMA / FECHA"); // Agregar el título
		$io_pdf->addText(157,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(155,63,7,"FIRMA / FECHA"); // Agregar el título
		$io_pdf->addText(275,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(285,63,7,"FIRMA / FECHA"); // Agregar el título
		$io_pdf->addText(425,122,7,"DIRECCIÓN DE ADMINISTRACIÓN"); // Agregar el título
		$io_pdf->addText(445,63,7,"FIRMA / FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_numsol,$as_codigo,$as_nombre,$as_denfuefin,$ad_fecemisol,$as_consol,$as_obssolpag,
							   $ai_monsol,$as_monto,&$io_pdf)
	{
		...
		$la_data[1]=array('titulo'=>'<b> Observación:          </b>'.$as_obssolpag);
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_detalle_recepcion($la_data,$ai_totsubtot,$ai_tottot,$ai_totcar,$ai_totded,&$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-2);
		$la_datatit[1]=array('numrecdoc'=>'<b>Documento</b>','fecemisol'=>'<b>Fecha</b>','subtotdoc'=>'<b>Monto</b>',
		...
		$la_datatot[1]=array('numrecdoc'=>'<b>Totales Bs.</b>','subtotdoc'=>$ai_totsubtot,
	...
	function uf_print_detalle_spg($aa_data,$ai_totpre,&$io_pdf)
	{
		...
		$io_pdf->ezTable($la_datatit,$la_columnas,'',$la_config);
		unset($la_datatit,$la_columnas,$la_config);
		...
		$la_datatot[1]=array('titulo'=>'<b>Totales Bs.</b>','totpre'=>$ai_totpre);
	...
	function uf_print_detalle_scg($aa_data,$ai_totdeb,$ai_tothab,&$io_pdf)
	{
		...
		$la_datatot[1]=array('titulo'=>'<b>Totales Bs.</b>','totdeb'=>$ai_totdeb,'tothab'=>$ai_tothab);
