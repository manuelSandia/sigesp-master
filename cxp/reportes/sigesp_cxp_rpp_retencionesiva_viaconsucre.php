<?PHP
	...
	function uf_print_encabezadopagina($as_titulo,&$io_pdf)
	{
		...
		$as_ley="Ley IVA - Art 11 Seran responsables del pago del impuesto en calidad de agentes de retencion, los compradores o adquirientes de determinados";
		$as_ley2="bienes muebles y los receptores de ciertos servicios, a quienes la Administracion Tributaria designe como tal.";
		
       
		$io_pdf->addText(220,530,9,"<b>".$as_ley."</b>");
		$io_pdf->addText(220,520,9,"<b>".$as_ley2."</b>");
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$la_data1[6]=array('firma1'=>'FIRMA Y SELLO DEL SUJETO RETENIDO',
						   'firma2'=>'FIRMA Y SELLO DEL AGENTE DE RETENCION');	
