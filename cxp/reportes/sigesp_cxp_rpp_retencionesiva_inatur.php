<?PHP
	...
	function uf_print_encabezadopagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/banner_inatur.jpg',50,40,920,40); // Agregar Logo
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,&$io_pdf)
	{
		...
		$io_pdf->addText(380,150,10,"<b>FIRMA Y SELLO DEL AGENTE DE RETENCION</b>");
		$io_pdf->addText(380,162,10,"<b>________________________________________</b>");									 
