<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->rectangle(20,65,558,635);
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/comunas_idena.jpg',45,16,500,40); // Agregar Logo
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$io_pdf->rectangle(450,80,110,90);
		$io_pdf->addText(485,86,10,'<b>SELLO</b>');
