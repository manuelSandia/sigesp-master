...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
      ...
      $io_pdf->Rectangle(15,60,570,90); 
		...
		$io_pdf->addText(40,134,7,"Lcda. Lesbia Sánchez"); // Agregar el título
		$io_pdf->addText(40,64,7,"Ordenamiento de Pago"); // Agregar el título
		$io_pdf->line(140,60,140,150);	//VERTICAL	
                $io_pdf->addText(185,142,7,"Verificado por:"); // Agregar el título
		$io_pdf->addText(175,134,7,"T.S.U Freddy Martinez"); // Agregar el título
		$io_pdf->addText(175,64,7,"Unidad de Presupuesto"); // Agregar el título
		$io_pdf->line(280,60,280,150);	//VERTICAL	
                $io_pdf->addText(325,142,7,"Autorizado por:"); // Agregar el título	
		$io_pdf->addText(315,134,7,"Lcdo. Luis E. Rodriguez "); // Agregar el título
		$io_pdf->addText(310,64,7,"Administración y Finanzas"); // Agregar el título
		$io_pdf->line(420,60,420,150);	//VERTICAL		
                $io_pdf->addText(480,142,7,"Autorizado por:"); // Agregar el título
		$io_pdf->addText(470,134,7,"Dra. Gloria A. Soler B."); // Agregar el título
		$io_pdf->addText(485,64,7,"Presidencia"); // Agregar el título
