...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,&$io_pdf)
	{
		...
		$io_pdf->line(400,90,400,170);		
		$io_pdf->addText(75,157,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(80,98,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(270,157,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(260,98,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(460,157,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(440,98,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
