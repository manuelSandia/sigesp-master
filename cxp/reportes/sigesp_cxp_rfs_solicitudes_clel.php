...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(100,60,100,155);		
		$io_pdf->line(190,60,190,155);		
		$io_pdf->line(280,60,280,155);
            $io_pdf->line(380,60,380,155);	
            $io_pdf->line(480,60,480,155);	
	      $io_pdf->addText(18,140,7,"<b>CUENTAS POR PAGAR</b>"); // Agregar el título
		$io_pdf->addText(120,140,7,"<b>PRESUPUESTO</b>"); // Agregar el título
		$io_pdf->addText(210,140,7,"<b>CONTABILIDAD</b>"); // Agregar el título
		$io_pdf->addText(300,140,7,"<b>ADMINISTRACIÓN</b>"); // Agregar el título
            $io_pdf->addText(383,140,7,"<b>DIRECCION DE SERV. ADM.</b>"); // Agregar el título
            $io_pdf->addText(505,140,7,"<b>PRESIDENCIA</b>"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_numsol,$as_codigo,$as_nombre,$as_rifpro,$as_denfuefin,$ad_fecemisol,$as_consol,$as_obssol,
							   $ai_monsol,$as_monto,&$io_pdf)
	{
		...
		$la_data[1]=array('titulo'=>'<b> Beneficiario                                                                       '.
		'                                                                                  RIF: '.$as_rifpro.' </b>');
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				uf_print_cabecera($ls_numsol,$ls_codigo,$ls_nombre,$ls_rifpro,$ls_denfuefin,$ld_fecemisol,$ls_consol,$ls_obssol,$li_monsol,$ls_monto,&$io_pdf);
