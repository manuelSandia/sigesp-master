...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->addText(20,137,7,"Banco Abono:"); // Agregar el título		
		$io_pdf->line(220,130,220,150);	//linea vertical
		$io_pdf->addText(230,137,7,"Nro Cuenta:"); // Agregar el título		
		$io_pdf->line(430,130,430,150);	//linea vertical
		$io_pdf->addText(440,137,7,"Tipo Cuenta:"); // Agregar el título		
		$io_pdf->line(15,112,585,112);//Horizontal		
		$io_pdf->line(15,72,585,72);//Horizontal
		$io_pdf->addText(50,115,7,"<b>ELABORADO POR</b>"); // Agregar el título
		$io_pdf->addText(50,64,7,"<b>FIRMA Y FECHA</b>"); // Agregar el título
		$io_pdf->line(150,60,150,130);	//LINEA VERTICAL	
		$io_pdf->addText(200,115,7,"<b>PRESUPUESTO</b>"); // Agregar el título
		$io_pdf->addText(200,64,7,"<b>FIRMA Y FECHA</b>"); // Agregar el título	
		$io_pdf->line(300,60,300,130);	//LINEA VERTICAL			
		$io_pdf->addText(340,115,7,"<b>CONTABILIDAD</b>"); // Agregar el título
		$io_pdf->addText(340,64,7,"<b>FIRMA Y FECHA</b>"); // Agregar el título	
		$io_pdf->line(440,60,440,130);	//LINEA VERTICAL			
		$io_pdf->addText(480,115,7,"<b>ADMINISTRACION</b>"); // Agregar el título
		...
		else  // Imprimimos el reporte
		{
			...
			for ($li_i=1;$li_i<=$li_totrow;$li_i++)
			  ...
			  uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecemisol,$ls_estprosol,&$io_pdf);
				  uf_print_cabecera($ls_rifpro.' - '.$ls_nomproben,$ls_dirproben,$ls_estsolpag,$ls_denfuefin,$ls_consol,$ls_obssol,$ld_monsol,&$io_pdf);				
