...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->Rectangle(15,60,570,94);
		$io_pdf->line(15,107,585,107);		
		$io_pdf->line(15,117,585,117);		
		$io_pdf->line(118,60,118,130);		
		$io_pdf->line(214,60,214,130);		
		$io_pdf->line(330,60,330,130);		
		$io_pdf->line(450,60,450,130);		
		$io_pdf->addText(15,145,7,"OBSERVACIONES"); // Agregar el título
		$io_pdf->addText(25,122,7,"CTRL. PRESUPUESTARIO"); // Agregar el título
		$io_pdf->addText(20,110,7,"FECHA:          /        /         "); // Agregar el título
		$io_pdf->addText(20,95,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(140,122,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(120,110,7,"FECHA:          /        /         "); // Agregar el título
		$io_pdf->addText(120,95,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(230,122,7,"SERV. ADMINISTRATIVO"); // Agregar el título
		$io_pdf->addText(215,110,7,"FECHA:          /        /         "); // Agregar el título
		$io_pdf->addText(215,95,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(350,122,7,"UNIDAD VERIFICADORA"); // Agregar el título
		$io_pdf->addText(335,110,7,"FECHA:          /        /         "); // Agregar el título
		$io_pdf->addText(335,95,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(480,122,7,"SUB-DIRECCION ADM."); // Agregar el título
