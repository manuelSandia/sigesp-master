...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$tm=240-($li_tm/2);
		$io_pdf->addText($tm,675,13,$as_titulo); // Agregar el título
		$io_pdf->addText(410,685,10,"<b> No.: </b> ".$as_numsol); // Agregar el título
		$io_pdf->addText(400,665,10,"<b>Fecha: </b> ".$ad_fecregsol); // Agregar el título
		...
		$io_pdf->line(240,60,240,112);		
		$io_pdf->line(360,60,360,130);
		$io_pdf->line(475,60,475,130);		
		
		$io_pdf->addText(36,122,7,"<b>Gerencia Control de</b>"); // Agregar el título
		$io_pdf->addText(31,115,7,"<b>Gestión y Presupuesto</b>"); // Agregar el título
		$io_pdf->addText(178,119,7,"<b>Gerencia Administración y Servicios</b>"); // Agregar el título
		$io_pdf->addText(160,64,7,"<b>Contabilidad</b>"); // Agregar el título
		$io_pdf->addText(383,122,7,"<b>Gerencia General de</b>"); // Agregar el título
		$io_pdf->addText(378,115,7,"<b>Gestión Administrativa</b>"); // Agregar el título
		$io_pdf->addText(275,64,7,"<b>Revisado Por</b>"); // Agregar el título
		$io_pdf->addText(510,119,7,"<b>Presidencia</b>"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
