...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->line(480,660,480,710);
		$io_pdf->line(480,685,585,685);
        $io_pdf->Rectangle(15,660,570,50);
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],30,715,490,50); // Agregar Logo
		if ($as_estprosol=="A")
		{
		...
		$io_pdf->addText(485,695,9,"No. ".$as_numsol); // Agregar el título
		...
		$io_pdf->addText(268,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(440,122,7,"AUDITORIA INTERNA"); // Agregar el título
		$io_pdf->addText(438,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
