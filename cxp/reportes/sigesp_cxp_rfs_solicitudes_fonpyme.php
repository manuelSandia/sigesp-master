...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$ab_solicitudcontable,$as_estprosol,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if(!$ab_solicitudcontable)
		{
			$as_titulo="<b>SOLICITUD DE PAGO CONTABLE</b>";
			// cuadro inferior
			$io_pdf->Rectangle(15,60,570,90);
			$io_pdf->line(15,80,585,80);		
			$io_pdf->line(15,95,585,95);		
			$io_pdf->line(15,137,585,137);		
			$io_pdf->line(150,60,150,150);		
			$io_pdf->line(300,60,300,150);		
			$io_pdf->line(440,60,440,150);		
			$io_pdf->addText(55,142,7,"Elaborado Por"); // Agregar el título
			$io_pdf->addText(45,85,7,"DAIVES MACHADO"); // Agregar el título
			$io_pdf->addText(50,68,7,"Administración"); // Agregar el título
			$io_pdf->addText(200,142,7,"Revisado por"); // Agregar el título
			$io_pdf->addText(190,85,7,"ELIEL RODRIGUEZ"); // Agregar el título
			$io_pdf->addText(200,68,7,"Contabilidad"); // Agregar el título
			$io_pdf->addText(345,142,7,"Verificado por"); // Agregar el título
			$io_pdf->addText(335,85,7,"MARYORIS LURUA"); // Agregar el título
			$io_pdf->addText(325,72,7,"Gerencia de Administracion"); // Agregar el título
			$io_pdf->addText(350,62,7,"y Finanzas"); // Agregar el título
			$io_pdf->addText(485,142,7,"Autorizado Por"); // Agregar el título
			$io_pdf->addText(480,85,7,"ANGEL SCARANO"); // Agregar el título
			$io_pdf->addText(483,63,7,"Gerente General"); // Agregar el título
		}
		else
		{
			// cuadro inferior
			...
			$io_pdf->line(300,60,300,150);		
			$io_pdf->line(440,60,440,150);		
			$io_pdf->addText(40,142,7,"Elaborado Por:"); // Agregar el título
			$io_pdf->addText(40,85,7,"DAIVES MACHADO"); // Agregar el título
			$io_pdf->addText(60,75,7,"Firma"); // Agregar el título
			$io_pdf->addText(42,63,7,"Administración"); // Agregar el título
			$io_pdf->addText(177,142,7,"Imputación Presupuestaria:"); // Agregar el título
			$io_pdf->addText(177,85,7,"MUSSOLINE CEVALLOS"); // Agregar el título
			$io_pdf->addText(207,75,7,"Firma"); // Agregar el título
			$io_pdf->addText(163,63,7,"Planificación y Control de Gestión"); // Agregar el título
			$io_pdf->addText(340,142,7,"Revisado por:"); // Agregar el título
			$io_pdf->addText(340,85,7,"ELIEL RODRIGUEZ"); // Agregar el título
			$io_pdf->addText(360,75,7,"Firma"); // Agregar el título
			$io_pdf->addText(350,63,7,"Contabilidad"); // Agregar el título
			$io_pdf->addText(480,142,7,"Autorizado Por:"); // Agregar el título
			$io_pdf->addText(480,85,7,"ANGEL SCARANO"); // Agregar el título
			$io_pdf->addText(500,75,7,"Firma"); // Agregar el título
			$io_pdf->addText(480,63,7,"Gerente General"); // Agregar el título
		}			
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$li_monretiva=0;
			$lb_solicitudcontable=$io_report->uf_select_verificar_detalle_spg($ls_numsol);
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecemisol,$lb_solicitudcontable,$ls_estprosol,&$io_pdf);
