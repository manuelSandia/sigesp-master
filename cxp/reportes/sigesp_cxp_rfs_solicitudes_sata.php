...
//		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],25,705,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_sata2.jpg',25,725,550,50); // Agregar Logo
		if ($as_estprosol=="A")
		{
			$io_pdf->addText(470,765,10,"<b>ANULADO</b>"); // Agregar la Fecha
		}
		$io_pdf->addText(375,700,11,$as_titulo); // Agregar el título
		$io_pdf->addText(30,715,9,$ls_nomemp); // Agregar el título
		$io_pdf->addText(485,700,9,"No. ".$as_numsol); // Agregar el título
		$io_pdf->addText(485,685,9,"Fecha ".$ad_fecregsol); // Agregar el título
		// cuadro inferior
		$io_pdf->setColor(0,0,0);
		$io_pdf->Rectangle(14,40,581,80);
		$io_pdf->line(14,107,594,107);		
		$io_pdf->line(14,94,594,94);		
		$io_pdf->addText(50,110,7,"ADMINISTRACION"); 
		$io_pdf->addText(20,96,7,"FECHA :        /           /");
		$io_pdf->addText(20,85,7,"FIRMA:");
		$io_pdf->line(160,40,160,120);		
		$io_pdf->addText(205,110,7,"CONTABILIDAD");
		$io_pdf->addText(165,96,7,"FECHA :        /           /");
        $io_pdf->addText(165,85,7,"FIRMA:");
		$io_pdf->line(310,40,310,120);		
		$io_pdf->addText(350,110,7,"PRESUPUESTO");
		$io_pdf->addText(315,96,7,"FECHA :        /           /");
	    $io_pdf->addText(315,85,7,"FIRMA:");
		$io_pdf->line(450,40,450,120);		
		$io_pdf->addText(495,110,7,"CONTRALORIA");
	...
	function uf_print_detalle_recepcion($la_data,$ai_totsubtot,$ai_tottot,$ai_totcar,$ai_totded,&$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-2);
		$la_datatit[1]=array('compromiso'=>'<b>COMPROMISO</b>','fecemisol'=>'<b>FECHA</b>','subtotdoc'=>'<b>MONTO</b>',
							 'moncardoc'=>'<b>IMPUESTO</b>','mondeddoc'=>'<b>DEDUCCIONES</b>','montotdoc'=>'<b>TOTAL</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('compromiso'=>array('justification'=>'center','width'=>140), // Justificación y ancho de la columna
						 			   'fecemisol'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'subtotdoc'=>array('justification'=>'center','width'=>93), // Justificación y ancho de la columna
						 			   'moncardoc'=>array('justification'=>'center','width'=>85), // Justificación y ancho de la columna
						 			   'mondeddoc'=>array('justification'=>'center','width'=>85), // Justificación y ancho de la columna
						 			   'montotdoc'=>array('justification'=>'center','width'=>95))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('compromiso'=>array('justification'=>'center','width'=>140), // Justificación y ancho de la columna
						 			   ...
						 			   'subtotdoc'=>array('justification'=>'right','width'=>93), // Justificación y ancho de la columna
						 			   ...
						 			   'montotdoc'=>array('justification'=>'right','width'=>95))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('numrecdoc'=>array('justification'=>'right','width'=>210), // Justificación y ancho de la columna
						 			   'subtotdoc'=>array('justification'=>'right','width'=>93), // Justificación y ancho de la columna
						 			   'moncardoc'=>array('justification'=>'right','width'=>85), // Justificación y ancho de la columna
						 			   'mondeddoc'=>array('justification'=>'right','width'=>85), // Justificación y ancho de la columna
						 			   'montotdoc'=>array('justification'=>'right','width'=>95))); // Justificación y ancho de la columna
...
//////////////////////////  GRID RECEPCIONES DE DOCUMENTOS		//////////////////////////////////////
				...
				if($lb_valido)
				{
					...
					for($li_s=1;$li_s<=$li_totrowdet;$li_s++)
					{
						...
						$la_data[$li_s]=array('compromiso'=>$ls_compromiso,'fecemisol'=>$ld_fecemidoc,'mondeddoc'=>$li_mondeddoc,
