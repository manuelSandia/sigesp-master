...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/banner_inatur.jpg',15,41,530,50); // Agregar Logo
		if ($as_estprosol=="A")
		{
		...
		// cuadro inferior
        $io_pdf->Rectangle(15,90,570,120);
		$io_pdf->line(15,155,585,155);	
		$io_pdf->line(15,185,585,185);	
		$io_pdf->line(15,170,585,170);		
		$io_pdf->line(150,90,150,185);		
		$io_pdf->line(290,90,290,185);		
		$io_pdf->line(430,90,430,185);	
		$io_pdf->addText(20,200,7,"OBSERVACIONES:"); // Agregar el título
		$io_pdf->addText(32,175,7,"SERVICIO ADMINISTRATIVO"); // Agregar el título
		$io_pdf->addText(28,160,7,"FECHA:"); // Agregar el título
		$io_pdf->addText(173,175,7,"UNIDAD VERIFICADORA"); // Agregar el título
		$io_pdf->addText(160,160,7,"FECHA:"); // Agregar el título
		$io_pdf->addText(330,175,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(300,160,7,"FECHA:"); // Agregar el título
		$io_pdf->addText(470,175,7,"SUB-DIRECCION ADM."); // Agregar el título
		$io_pdf->addText(443,160,7,"FECHA:"); // Agregar el título
		$io_pdf->addText(28,145,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(160,145,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(300,145,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(443,145,7,"FIRMA:"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
