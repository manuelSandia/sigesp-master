...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],30,708,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		if ($as_estprosol=="A")
		{
		...
		$io_pdf->addText(485,740,9.5,"No. ".$as_numsol); // Agregar el título
		$io_pdf->addText(485,710,9.5,"Fecha ".$ad_fecregsol); // Agregar el título
		$io_pdf->addText(540,770,9.5,date("d/m/Y")); // Agregar la Fecha
		...
		$io_pdf->line(465,60,465,130);
            $io_pdf->line(354,60,354,130);		
		$io_pdf->addText(42,63,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(157,63,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(265,63,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(357,63,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->addText(483,63,7,"CONTRALORA MUNICIPAL"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
