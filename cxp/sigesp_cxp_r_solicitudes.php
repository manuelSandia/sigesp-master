<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_solicitudes.php",$ls_permisos,$la_seguridad,$la_permisos);
	$ls_reporte=$io_fun_cxp->uf_select_config("CXP","REPORTE","CUENTAS_POR_PAGAR","sigesp_cxp_rpp_solicitudes.php","C");
	$ls_reporteexcel=$io_fun_cxp->uf_select_config("CXP","REPORTE","CUENTAS_POR_PAGAR_EXCEL","sigesp_cxp_rpp_solicitudes_excel.php","C");
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<html>
<head>
<title>Reporte de Solicitudes de Pago </title>
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td height="20" colspan="10" bgcolor="#E7E7E7" class="cd-menu">&nbsp;</td>
  </tr>
  <tr>

	    <td height="20" width="20" class="toolbar"><div align="center"><a href="javascript: uf_imprimir();"><img src="../shared/imagebank/tools20/imprimir.gif" alt="Imprimir" width="20" height="20" border="0" title="Imprimir"></a></div></td>
	    ...
	    <td class="toolbar" width="20"><div align="center"><a href="javascript: ue_ayuda();"><img src="../shared/imagebank/tools20/ayuda.gif" alt="Ayuda" width="20" height="20" border="0" title="Ayuda"></a></div></td>
	 	<td class="toolbar" width="70"><div align="center"></div></td>
	 	<td class="toolbar" width="70"><div align="center"></div></td>
	 	<td class="toolbar" width="70"><div align="center"></div></td>
	 	<td class="toolbar" width="70"><div align="center"></div></td>
	 	<td class="toolbar" width="70"><div align="center"></div></td>
...
<table width="575" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        <td height="22" colspan="3" align="center" class="titulo-ventana">Reporte de Cuentas por Pagar </td>
      </tr>
      ...
      <tr>
        <td height="22" colspan="3" align="center"><input name="chkintervalo" type="checkbox" class="sin-borde" id="chkintervalo" value="checkbox" checked>
        Imprimir solo Proveedores/Beneficiarios con movimientos en el intervalo. </td>
      </tr>
      <tr>
        <td height="22" colspan="3" align="center">&nbsp;</td>
      </tr>
...
var patron2 = new Array(1,3,3,3,3)
	...
	function uf_imprimir()
	{
			...
			if(li_imprimir==1)
			{
				...
				fecemides=f.txtfecregdes.value;
				fecemihas=f.txtfecreghas.value;
				...
				if((fecemides!="")&&(fecemihas!=""))
				{
					...
					pantalla="reportes/"+formato+"?tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fecemides="+fecemides+"&fecemihas="+fecemihas+"&tiporeporte="+tiporeporte+"&intervalo="+intervalo+"";
