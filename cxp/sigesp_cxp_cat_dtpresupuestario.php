	...
	for (li=1;li<=li_opener;li++)
	    {
		  ...
		  ls_procede       = eval("f.txtprocede"+li+".value");
		  ls_numdoccom       = eval("f.txtnumdoccom"+li+".value");
		  if (ls_cuentaspg!="" && ls_codestpro!="" && ldec_monto!="0,00" && ls_estcargo!='C')
		     {
			   ...
			   ls_campos=ls_campos+"&txtcuentaspgncnd"+li_registros+"="+ls_cuentaspg+
								   ...
								   "&txtprocede"+li_registros+"="+ls_procede+
								   "&txtnumdoccom"+li_registros+"="+ls_numdoccom+
					     ...
					     if (ldec_montoaux>0)
					        {
							  ...
							  ls_campos=ls_campos+"&txtcuentaspgncnd"+li_selected+"="+cuenta+"&txtcodestpro"+li_selected+"="+codestpro+"&txtestclancnd"+li_selected+"="+estcla+"&txtcodpro"+li_selected+"="+codpro+
									    "&txtdencuenta"+li_selected+"="+dencuenta+"&txtmonto"+li_selected+"="+monto+"&txtscgcuenta"+li_selected+"="+scg_cuenta+"&txtdenscgcuentadt"+li_selected+"="+den_scgcuenta+"&txtnumdoccom"+li_selected+"="+numdoccom+"&txtprocede"+li_selected+"="+procede+"&txtestcargo"+li_selected+"= ";					   
					        }						   
					     else
							{
