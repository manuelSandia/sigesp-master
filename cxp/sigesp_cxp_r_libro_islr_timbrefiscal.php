...
<table width="793" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    ...
    <td class="toolbar" width="26"><div align="center"><a href="javascript: ue_openexcel();"><img src="../shared/imagebank/tools20/excel.jpg" alt="Salir" width="20" height="20" border="0" title="Salir"></a></div></td>
...
function ue_openexcel()
{
	...
	if(li_imprimir==1)
	{
		...
		{			
			formato=f.formato1.value;
			pagina="reportes/sigesp_cxp_rpp_libro_islr_excel.php?mes="+ls_mes+"&anio="+ls_anio;
			window.open(pagina,"reporte","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no,left=0,top=0");
		}
		else if (ls_tiprep=='2')
		{
			pagina="reportes/sigesp_cxp_rpp_libro_timbrefiscal_excel.php?mes="+ls_mes+"&anio="+ls_anio;
			window.open(pagina,"reporte","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no,left=0,top=0");  
		}
		else
		{
