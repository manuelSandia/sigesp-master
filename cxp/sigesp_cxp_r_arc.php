...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  <tr>
    <td height="30" colspan="11" class="cd-logo"><img src="../shared/imagebank/header.jpg" width="806" height="40"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="10" width="29" class="toolbar"><div align="center"><a href="javascript: ue_print();"><img src="../shared/imagebank/tools20/imprimir.gif" alt="Imprimir" width="20" height="20" border="0" title="Imprimir"></a></div></td>
    <td height="10" width="30" class="toolbar"><div align="center"><a href="javascript: ue_openexcel();"><img src="../shared/imagebank/tools20/excel.jpg" alt="Imprimir" width="20" height="20" border="0" title="Imprimir"></a></div></td>
	<td class="toolbar" width="33"><div align="center"><a href="javascript: ue_cerrar();"><img src="../shared/imagebank/tools20/salir.gif" alt="Salir" width="20" height="20" border="0" title="Salir"></a></div></td>
    <td class="toolbar" width="34"><div align="center"><a href="javascript: ue_ayuda();"><img src="../shared/imagebank/tools20/ayuda.gif" alt="Ayuda" width="20" height="20" border="0" title="Ayuda"></a></div></td>
    <td class="toolbar" width="224"><div align="center"></div></td>
    <td class="toolbar" width="76">&nbsp;</td>
    <td class="toolbar" width="76"><div align="center"></div></td>
    <td class="toolbar" width="76"><div align="center"></div></td>
    <td class="toolbar" width="76"><div align="center"></div></td>
    <td class="toolbar" width="76"><div align="center"></div></td>
    <td class="toolbar" width="76"><div align="center"></div></td>
...
function ue_openexcel()
{
	...
	if(li_imprimir==1)
	{
		...
		tiporeporte=f.cmbbsf.value;
		formato=f.formato.value;
		pagina="reportes/sigesp_cxp_rpp_arc_excel.php?tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&tiporeporte="+tiporeporte;
		window.open(pagina,"reporte","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no,left=0,top=0");
	}
	else
	{
