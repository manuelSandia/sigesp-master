<?php
	//-----------------------------------------------------------------------------------------------------------------------------------
	// Clase donde se cargan todos los cat_logos del sistema SEP con la utilizaci_n del AJAX
	//-----------------------------------------------------------------------------------------------------------------------------------
    session_start();
	...
	function uf_print_proveedor()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de proveedores
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 17/03/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//Se agregÃ³ el require para operar con la fecha de vencimiento de rnc
		...
		$ls_sql="SELECT cod_pro, nompro, trim(rpc_proveedor.sc_cuenta) AS sc_cuenta, rifpro, fecvenince, tipconpro, dirpro,".
		...
		else
		{
			...
			//Se agregÃ³ la columna que indica si estÃ¡ o no vigente el proveedor con el RNC
			print "<td style='cursor:pointer' title='Ordenar por Vigencia' align='center' onClick=ue_orden('fecvenince')>Reg. Solvencia Laboral</td>";
			print "</tr>";
			...
			//Se agregÃ³ en el query el campo "fecvenrnc" y se operÃ³ con Ã©l para mostrar la vigencia de RNC de los proveedores
				$ls_fechavenRNC   = $io_funciones->uf_formatovalidofecha($row["fecvenince"]);
				...
				switch ($ls_tipo)
				{
					case "":
						...
						print "<td style=text-align:center>".$lb_registronacional."</td>";
						print "</tr>";
					break;
	...
	function uf_print_beneficiario()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de beneficiarios
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 17/03/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_funciones_cxp;
	...
	function uf_print_estructura1()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de la estructura presupuestaria 1
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 06/04/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_funciones_cxp;
		...
		else
		{
			print "<table width=500 border=0 cellpadding=1 cellspacing=1 class=fondo-tabla align=center>";
			print "<tr class=titulo-celda>";
			print "<td style='cursor:pointer' title='Ordenar por C_digo' align='center' onClick=ue_orden('codestpro1')>C_digo </td>";
			print "<td style='cursor:pointer' title='Ordenar por Denominaci_n' align='center' onClick=ue_orden('denestpro1')>Denominaci_n</td>";
	...
	function uf_print_estructura2()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de la estructura presupuestaria 2
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 06/04/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_funciones_cxp;
		...
		else
		{
			...
			print "<td width=150 style='cursor:pointer' title='Ordenar por C_digo' align='center' onClick=ue_orden('codestpro2')>C_digo</td>";
			print "<td width=200 style='cursor:pointer' title='Ordenar por Denominaci_n' align='center' onClick=ue_orden('denestpro2')>Denominaci_n</td>";
	...
	function uf_print_estructura3()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de la estructura presupuestaria 3
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 06/04/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_funciones_cxp;
		...
		else
		{
			...
			print "<td width=100 style='cursor:pointer' title='Ordenar por C_digo' align='center' onClick=ue_orden('spg_ep3.codestpro3')>C_digo</td>";
			print "<td width=150 style='cursor:pointer' title='Ordenar por Denominaci_n' align='center' onClick=ue_orden('spg_ep3.denestpro3')>Denominaci_n</td>";
			print "<td width=50 style='cursor:pointer' title='Ordenar por Estatus' align='center' onClick=ue_orden('estcla')>Estatus</td>";
			print "</tr>";
			while($row=$io_sql->fetch_row($rs_data))
			{
	...
	function uf_print_estructura4()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de la estructura presupuestaria 4
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 07/04/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_funciones_cxp;
		...
		else
		{
			...
			print "<td width=80 style='cursor:pointer' title='Ordenar por C_digo' align='center' onClick=ue_orden('codestpro4')>C_digo</td>";
			print "<td width=130 style='cursor:pointer' title='Ordenar por Denominaci_n' align='center' onClick=ue_orden('denestpro4')>Denominaci_n</td>";
			print "<td width=50 style='cursor:pointer' title='Ordenar por Estatus' align='center' onClick=ue_orden('estcla')>Estatus</td>";
			print "</tr>";
			while($row=$io_sql->fetch_row($rs_data))
			{
	...
	function uf_print_estructura5()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de la estructura presupuestaria 5
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 07/04/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_funciones_cxp;
		...
		else
		{
			...
			print "<td width=70 style='cursor:pointer' title='Ordenar por C_digo' align='center' onClick=ue_orden('spg_ep5.codestpro5')>C_digo</td>";
			print "<td width=100 style='cursor:pointer' title='Ordenar por Denominaci_n' align='center' onClick=ue_orden('spg_ep5.denestpro5')>Denominaci_n</td>";
			print "<td width=50 style='cursor:pointer' title='Ordenar por Estatus' align='center' onClick=ue_orden('estcla')>Estatus</td>";
			print "</tr>";
			while($row=$io_sql->fetch_row($rs_data))
			{
	...
	function uf_print_cuentasspg()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: M_todo que inprime el resultado de la busqueda de las cuentas presupuestarias
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 07/04/2007								Fecha _ltima Modificaci_n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_funciones_cxp;
	...
	function uf_print_cuentasscg()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: M_todo que inprime el resultado de la busqueda de las cuentas contables
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
	...
	function uf_print_otroscreditos()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: M_todo que inprime el resultado de la busqueda de los creditos a aplicar en un compromiso en particular
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 15/04/2007								Fecha _ltima Modificaci_n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$io_mensajes->uf_mensajes_ajax("Error al cargar Otros Cr_ditos ","ERROR->".$io_funciones->uf_convertirmsg($io_sql->message),false,"");
		}
		else
		{
			$lo_title[1]=" ";
			$lo_title[2]="C_digo";
			$lo_title[3]="Denominaci_n";
			$lo_object[1][1]="";
			$lo_object[1][2]="";
			$lo_object[1][3]="";
			$lo_object[1][4]="";
			...
			if($ls_parcial=="1")
			{
				...
				for($li_filaaux=1;$li_filaaux<=$li_totrowsession;$li_filaaux++)
				{
					...
					$lb_valido=$io_recepcion->uf_load_sccuenta_cargo($ls_codcar,&$ls_scgcuenta);
					if(($ls_scgcuenta==="")&&($ls_confiva<>'C'))
					{
						$io_mensajes->uf_mensajes_ajax("Error en Cuenta","ERROR->La Cuenta Presupuestaria Asociada al cargo no existe en la Estructura. Favor verifique en Configuracion->Cuentas Por Pagar->Otros Cr_ditos el cargo ".$ls_codcar,false,"");
					}
					...
					$io_funciones_cxp->uf_formatoprogramatica($ls_codestpro,&$ls_codpro);
	...
	function uf_print_deducciones()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: M_todo que inprime el resultado de la busqueda de las cdeducciones a aplicar en la recepci_n de documentos
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 22/04/2007								Fecha _ltima Modificaci_n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$ls_sql="SELECT sigesp_deducciones.codded,dended,formula,porded,monded,sc_cuenta,islr,iva,estretmun,retaposol,estretmil ".
		...
		else
		{
			...
			if ($ls_tipo=='CMPRETIVA' || $ls_tipo=='CMPRETMUN'|| $ls_tipo=='CMPRETAPO')
			   ...
			   {
				 $lo_title[4]="Monto Objeto Retenci_n";
				 $lo_title[5]="Monto Retenci_n";
			   }
	...
	function uf_print_recepcion()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de recepciones de documentos
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 02/05/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_funciones_cxp;
        ...
        $ls_sql="SELECT trim(numrecdoc) as numrecdoc, cxp_rd.codtipdoc, trim(ced_bene) as ced_bene, cod_pro, codcla, dencondoc,
				...
				"       coduniadm,codestpro1,codestpro2,codestpro3,codestpro4,codestpro5,estcla,estact,numordpagmin,codtipfon,repcajchi,codproalt,cxp_rd.conanurd,".
		...
		else
		{
			...
			print "<tr class=titulo-celda>";
			print "<td style='cursor:pointer' title='Ordenar por Recepci_n' align='center' onClick=ue_orden('numrecdoc')>Nro Recepci_n</td>";
			...
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($ls_tipo)
				{
					case "":
						...
						print "'".$ls_codestpro5."','".$ls_estcla."','".$ls_estact."','".$ls_numordpagmin."','".$ls_codtipfon."','".$ls_repcajchi."','".$ls_codproalt."','".$ls_nomproalt."','".$ls_conanurd."','".$ls_tipdocdon."');\">".$ls_numrecdoc."</a></td>";
					...
					case "SOLICITUDPAGO":
						...
						print "<tr class=celdas-blancas>";
						print "<td align='center'><a href=\"javascript: ue_aceptar_solicitud('".$ls_numrecdoc."','".$ls_dencondoc."','".$ls_codtipdoc."','".$ls_dentipdoc."','".$li_montotdoc."','".$ls_cedbene."','".$ls_codpro."','".$ls_codproalt."');\">".$ls_numrecdoc."</a></td>";
						print "<td with='200'>".$ls_nombre."</td>";
						print "<td with='100' align='center'>".$ld_fecregdoc."</td>";
						print "<td with='100' align='center'>".$ls_estatus."</td>";
	...
	function uf_print_compromisos()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de compromisos
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 09/05/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_funciones_cxp;
		require_once("../../shared/class_folder/class_mensajes.php");
		$io_mensajes=new class_mensajes();
...
//echo "<br>eeee2e".$li_totrowanu."  ".$la_numcomanu."fff  ";
...
//echo "<br>iii";
							...
							{
								$lb_valido=$io_recepcion->uf_load_cargos_compromisocontable($ls_comprobante,$ls_procede,
&$li_monimpcon);
//echo "<br>jjjj";
							}
							if(($lb_valido)&&($ls_estafenc==0))
							{
								$lb_valido=$io_recepcion->uf_load_monto_notascredito($ls_comprobante,$ls_procede,"",&$li_monnotas);
							}
							if($lb_valido)
							{
	//							$li_disponible=($li_total+$li_monto_ajuste)-$li_monto_causado+$li_monto_anulado-$li_monto_recepcion-$li_monto_cargo;
								$li_disponible=($li_total+$li_monimpcon+$li_monto_ajuste)-($li_monto_causado+$li_monto_totanulado)-$li_monto_recepcion+$li_monnotas;

//echo "<br>kkk".$ls_comprobante."    ".$li_disponible;
...
//echo "<br>llll";
				...
				{
        			$io_mensajes->message("ERROR->No hay comprobantes asociados a este Proveedor _ Beneficiario");
				}
			}
		}
		unset($io_mensajes);
	...
	function uf_print_solicitudespago()
	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de solicitudes de pago
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 29/04/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		require_once("../../shared/class_folder/sigesp_include.php");
		$io_include=new sigesp_include();
		$io_conexion=$io_include->uf_conectar();
		...
		else
		{
			...
			print "<tr class=titulo-celda>";
			print "<td width=60  style='cursor:pointer' title='Ordenar por Numero de Solicitud'       align='center' onClick=ue_orden('numsol')>N_mero de Solicitud</td>";
	...
	function uf_print_fuentefinanciamiento()
	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de fuente de financiamiento
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 19/04/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		require_once("../../shared/class_folder/sigesp_include.php");
		$io_include=new sigesp_include();
		$io_conexion=$io_include->uf_conectar();
	...
	function uf_print_retencionesislr()
	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de retenciones de ISLR
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 02/07/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_grid;
		...
		//Se agregó al sql el campo de numero de comprobante con sus filtros respectivos
		$ls_sql="SELECT DISTINCT scb_dt_cmp_ret.numcom as comprobante, cxp_solicitudes.numsol AS numero, cxp_solicitudes.consol AS concepto, cxp_rd.procede AS procede ".
				"  FROM cxp_solicitudes, cxp_dt_solicitudes, cxp_rd, cxp_rd_deducciones, sigesp_deducciones, scb_dt_cmp_ret ".
				...
				" UNION ".
				"SELECT scb_dt_cmp_ret.numcom as comprobante,scb_movbco.numdoc AS numero, MAX(scb_movbco.conmov) AS concepto, MAX(scb_movbco.procede) AS procede ".
			    "  FROM scb_movbco, sigesp_deducciones, scb_movbco_scg, scb_dt_cmp_ret ".
				...
				"    AND scb_dt_cmp_ret.numsop= scb_movbco.numdoc".
				"    AND scb_dt_cmp_ret.codret='0000000006'".
				"  GROUP BY scb_movbco.numdoc,scb_dt_cmp_ret.numcom ".
				" UNION ".
				"SELECT scb_dt_cmp_ret.numcom as comprobante,cxp_cmp_islr.numsol AS numero, cxp_cmp_islr.consol AS concepto, 'INT' AS procede".
				"  FROM cxp_cmp_islr, scb_dt_cmp_ret".
				" WHERE cxp_cmp_islr.codemp = '".$ls_codemp."' ".
				" AND scb_dt_cmp_ret.numsop=cxp_cmp_islr.numsol ".
				" AND scb_dt_cmp_ret.codret='0000000006' ".
		...
		{
			$lo_title[1]=" ";
			//Se agregó la impresión del numero de comprobante
			$lo_title[2]="Nro Comprobante";
			$lo_title[3]="Nro Documento";
			$lo_title[4]="Concepto";
			$lo_title[5]="Procede";
			$li_totrow=0;
			...
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				//Se agregó la impresión del numero de comprobante
				$lo_object[$li_totrow][2]="<input type=text      name=txtcomprobante".$li_totrow."   id=txtcomprobante".$li_totrow."   value='".$ls_comprobante."'   size=15  style=text-align:center  class=sin-borde readonly>";
				$lo_object[$li_totrow][3]="<input type=text      name=txtnumero".$li_totrow."   id=txtnumero".$li_totrow."   value='".$ls_numero."'   size=15  style=text-align:center  class=sin-borde readonly>";
				$lo_object[$li_totrow][4]="<input type=text      name=txtconcepto".$li_totrow." id=txtconcepto".$li_totrow." value='".$ls_concepto."' size=80 style=text-align:left    class=sin-borde readonly title='".$ls_concepto."' bgColor=#FF5500>";
				$lo_object[$li_totrow][5]="<input type=text      name=txtprocede".$li_totrow."  id=txtprocede".$li_totrow."  value='".$ls_procede."'  size=5   style=text-align:center  class=sin-borde readonly>";
			}
			$io_sql->free_result($rs_data);
			$io_grid->makegrid($li_totrow,$lo_title,$lo_object,550,'Comprobantes de Retenci&oacute;n de I.S.L.R.','grid');
		}	unset($io_include);
		unset($io_conexion);
		unset($io_sql);
		unset($io_mensajes);
	...
	function uf_print_catdeducciones()
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: M_todo que inprime el resultado de la busqueda de las deducciones
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 10/07/2007								Fecha _ltima Modificaci_n :
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_funciones_cxp;
		...
		else
		{
			print "<table width=500 border=0 cellpadding=1 cellspacing=1 class=fondo-tabla align=center>";
			print "<tr class=titulo-celda>";
			print "<td width=100 style='cursor:pointer' title='Ordenar por C_digo'       align='center' onClick=ue_orden('codded')>C_digo</td>";
	...
	function uf_print_retencionesiva()
	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de retenciones de iva
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 12/07/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_grid;
		...
		//Se comenta el if porque estas cadenas deben estar presentes siempre en el query
		...
		$ls_sql="SELECT DISTINCT scb_cmp_ret.numcom, scb_cmp_ret.fecrep, scb_cmp_ret.nomsujret ".
				...
				"   AND cxp_solicitudes.estprosol NOT IN ('A','N' )".
...
/*		$ls_codprobendes=$_POST['codprobendes'];
		...
		//Se agregó al query la consulta de la tabla cxp_solicitudes y el filtro para no traer los certificados de timbre correspondientes a solicitudes de pago con estatus "ANULADA" ni "ANULADA SIN AFECTACION"
		$ls_sql="SELECT DISTINCT scb_cmp_ret.numcom, scb_cmp_ret.fecrep, scb_cmp_ret.nomsujret ".
				"  FROM scb_cmp_ret, scb_dt_cmp_ret, cxp_solicitudes ".
				" WHERE scb_cmp_ret.codemp = '".$ls_codemp."' ".
	...
	function uf_print_retencionesaporte()
	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de retenciones de aporte social
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 12/07/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_grid;
		...
		else
		{
			...
			$io_sql->free_result($rs_data);
			$io_grid->makegrid($li_totrow,$lo_title,$lo_object,550,'Comprobantes de Retenci_n de IVA','grid');
		}	unset($io_include);
		unset($io_conexion);
		unset($io_sql);
		unset($io_mensajes);
	...
	function uf_print_retencionesmunicipales()
	{
		...
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de retenciones de iva
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci_n: 15/07/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_grid;
		...
		else
		{
			...
			$io_sql->free_result($rs_data);
			$io_grid->makegrid($li_totrow,$lo_title,$lo_object,750,'Comprobantes de Retenci_n Municipal','grid');
		}
		unset($io_include);
		unset($io_conexion);
	...
	function uf_print_dtpresupuestario()
	{
		...
		$ls_sql=" SELECT rd.codemp, rd.numrecdoc, rd.codtipdoc, rd.ced_bene, rd.cod_pro, rd.procede_doc, rd.numdoccom,
						 ...
						 trim(spg.sc_cuenta) as sc_cuenta,scg.denominacion as denscg, rd.procede_doc
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				if($ldec_disponible>0)
				{
					...
					$lo_object[$li][2]="<input type=text name=txtnumdoccom".$li."    class=sin-borde style=text-align:center size=37 value='".$ls_numdoccom."'    readonly><input name=txtprocede".$li." type=hidden id=txtprocede".$li." value='".$ls_procededoc."'>";
					$lo_object[$li][3]="<input type=text name=txtcodestpro".$li."    class=sin-borde style=text-align:center size=37 value='".$ls_programatica."'    readonly><input name=txtcodpro".$li." type=hidden id=txtcodpro".$li." value='".$ls_codestproaux."'>";
					$lo_object[$li][4]="<input type=text name=txtestclaaux".$li."    class=sin-borde style=text-align:center size=20 value='".$ls_estatus."'    readonly><input name=txtestcla".$li." type=hidden id=txtestcla".$li." value='".$ls_estcla."'>";
					$lo_object[$li][5]="<input type=text name=txtspgcuenta".$li."    class=sin-borde style=text-align:center size=16  value='".$ls_spgcuenta."'     readonly><input type=hidden name=txtscgcuenta".$li."  value='".$ls_scgcuenta."'><input type=hidden name=txtdenscgcuenta".$li."  value='".$ls_denscg."'>";
					$lo_object[$li][6]="<input type=text name=txtmonto".$li."        class=sin-borde style=text-align:right  size=20 value='".number_format($ldec_disponible,2,",",".")."' onBlur='javascript:uf_format(this);uf_valida_monto($li);'  onKeyPress=return(ue_formatonumero(this,'.',',',event));><input type=hidden name=txtmontooriginal".$li." value='".$ldec_disponible."'>";
				...
				else
				{
					if($ls_tiponota=='ND')
					{
						...
						$lo_object[$li][1]="<input type=checkbox name=chk".$li."      id=chk".$li." class=sin-borde >";
						$lo_object[$li][2]="<input type=text name=txtnumdoccom".$li."    class=sin-borde style=text-align:center size=37 value=''    readonly><input name=txtprocede".$li." type=hidden id=txtprocede".$li." value=''>";
						$lo_object[$li][3]="<input type=text name=txtcodestpro".$li."    class=sin-borde style=text-align:center size=37 value='".$ls_codestpro."'    readonly>";
						$lo_object[$li][4]="<input type=text name=txtestclaaux".$li."    class=sin-borde style=text-align:center size=20 value='".$ls_estatus."'    readonly><input name=txtestcla".$li." type=hidden id=txtestcla".$li." value='".$ls_estcla."'>";
						$lo_object[$li][5]="<input type=text name=txtspgcuenta".$li."    class=sin-borde style=text-align:center size=16  value='".$ls_spgcuenta."'     readonly><input type=hidden name=txtscgcuenta".$li."  value='".$ls_scgcuenta."'><input type=hidden name=txtdenscgcuenta".$li."  value='".$ls_denscg."'>";
						$lo_object[$li][6]="<input type=text name=txtmonto".$li."        class=sin-borde style=text-align:right  size=20 value='".number_format($ldec_monto,2,",",".")."' onBlur='javascript:uf_format(this);uf_valida_monto($li);'  onKeyPress=return(ue_formatonumero(this,'.',',',event));><input type=hidden name=txtmontooriginal".$li." value='".$ldec_monto."'>";
						$lo_object[$li][7]="<input type=text name=txtdencuenta".$li."    class=sin-borde style=text-align:left  size=50 value='".$ls_dencuenta."' readonly>";
					}
				}
	...
	function uf_print_cuentasspi()
   	{
		...
		{
			case "MYSQLT":
				$ls_aux_estpro=" AND rd.codestpro=CONCAT(spi.codestpro1,spi.codestpro2,spi.codestpro3,spi.codestpro4,spi.codestpro5) ";
				break;
			case "POSTGRES":
				$ls_aux_estpro=" AND rd.codestpro=spi.codestpro1||spi.codestpro2||spi.codestpro3||spi.codestpro4||spi.codestpro5 ";
				break;
			case "INFORMIX":
				$ls_aux_estpro=" AND rd.codestpro=spi.codestpro1||spi.codestpro2||spi.codestpro3||spi.codestpro4||spi.codestpro5 ";
				break;
...
//-----------------------------------------------------------------------------------------------------------------------------------
		...
		else
		{
			if($ls_estpreing==1)
			{
				$ls_sql="SELECT rd.codemp, rd.numrecdoc, rd.codtipdoc, rd.ced_bene, rd.cod_pro, rd.procede_doc, rd.numdoccom, rd.codestpro1,rd.codestpro2,
								...
								rd.monret,CAR.dencar, CAR.codcar,CAR.porcar
	...
	function uf_chequear_cancelado($as_numsol)
	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que verifica si una solicitud esta cancelada.
		//	   Creado Por: Ing. Nelson Barraez
		// Fecha Creaci_n: 28/08/2007 								Fecha _ltima Modificaci_n :
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_funciones_cxp;
	...
	function uf_print_amortizacion()
   	{
		...
		if($lb_valido==true)
		{
				...
				{
        			$io_mensajes->message("ERROR->No hay Anticipos asociados a este Proveedor _ Beneficiario");
				}
			}
		unset($io_mensajes);
		unset($io_funciones);
	...
	function uf_print_unidad_ejecutora()
	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: Funci_n que obtiene e imprime los resultados de la busqueda de la unidad ejecutora (Unidad administrativa)
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Modificado Por: Ing. Yozelin Barragan / Ing. Nestor Falcon
		// Fecha Creaci_n: 17/03/2007 								Fecha _ltima Modificaci_n : 05/05/2007
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		require_once("../../shared/class_folder/sigesp_include.php");
		$io_include=new sigesp_include();
		$io_conexion=$io_include->uf_conectar();
		...
		print "<table width=500 border=0 cellpadding=1 cellspacing=1 class=fondo-tabla align=center>";
		print "<tr class=titulo-celda>";
		print "<td width=60  style='cursor:pointer' title='Ordenar por C_digo'       align='center' onClick=ue_orden('coduniadm')>C&oacute;digo</td>";
		if (empty($ls_tipo))
		   {
		     print "<td width=400 style='cursor:pointer' title='Ordenar por Denominaci_n' align='center' onClick=ue_orden('denuniadm')>Denominaci&oacute;n</td>";
			 print "<td width=40  style='cursor:pointer' title='Seleccionar Estructura Presupuestaria'>Detalle</td>";
		   }
		else
		   {
		     print "<td width=440 style='cursor:pointer' title='Ordenar por Denominaci_n' align='center' onClick=ue_orden('denuniadm')>Denominaci&oacute;n</td>";
		   }
		print "</tr>";
	...
	function uf_print_ordenministerio()
   	{
		...
		else
		{
			 ...
			 while (!$rs_data->EOF)
			{
				...
				$ld_porrepfon    = $rs_data->fields["porrepfon"];//Porcentaje de Reposici_n.
				...
				$ld_monmaxmov = 0;
				$ld_monmaxmov = ($ld_monordpagmin-$ld_totmoncon);//Monto M_ximo de la Operaci_n.(Original - Consumido).
	...
	function uf_load_monto_consumido($as_numordpagmin,$as_codtipfon)
   	{
		...
		//		   Access: private
		//	    Arguments:
		//	  Description: M_todo que imprime el resultado de la busqueda de las Ordenes de Pago Ministerio.
		//	   Creado Por: Ing. N_stor Falc_n
		// Fecha Creaci_n: 11/02/2009.								Fecha _ltima Modificaci_n : 11/02/2009.
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		require_once("../../shared/class_folder/class_sql.php");
		require_once("../../shared/class_folder/sigesp_include.php");
		require_once("../../shared/class_folder/class_mensajes.php");
