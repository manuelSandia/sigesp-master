<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_retencionesunoxmil.php",$ls_permisos,$la_seguridad,$la_permisos);
	$ls_reporte=$io_fun_cxp->uf_select_config("CXP","REPORTE","FORMATO_RETMIL","sigesp_cxp_rpp_retencionesunoxmil.php","C");
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<html>
<head>
<title>Reporte de Retenciones 1 x 1000 </title>
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="22" colspan="4" align="center">Reporte de Retenciones 1 x 1000 </td>
    </tr>
...
function ue_search()
{
	...
	ajax.send("catalogo=RETENCIONES1x1000&mes="+mes+"&anio="+anio);
}
