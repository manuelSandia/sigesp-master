...
$io_fun_compra->uf_load_seguridad("SOC","sigesp_soc_r_solicitud_cotizacion.php",$ls_permisos,&$la_seguridad,$la_permisos);
...
<title>Reporte de Solicitudes de Cotizaciones</title>
...
if (array_key_exists("operacion",$_POST))
   {
     ...
     $ls_fecsoldes = $_POST["txtfecsoldes"];
	 $ls_fecsolhas = $_POST["txtfecsolhas"];
     $ls_codprodes = $_POST["txtcodprodes"];
	 $ls_codprohas = $_POST["txtcodprohas"];
	 $ls_numsepdes = $_POST["txtnumsepdes"];
	 $ls_numsephas = $_POST["txtnumsephas"];
   ...
   {
	 $ls_operacion = "";
     $ls_fecsoldes = '01/'.date("m/Y");
	 $ls_fecsolhas = date("d/m/Y");
     $ls_codprodes = "";
	 $ls_codprohas = "";
	 $ls_numsolcotdes = "";
	 $ls_numsolcothas = "";
...
<div align="center">
  ...
  ?>
    <table width="543" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
        <td height="22" colspan="6" class="titulo-ventana">Reporte de Solicitudes de Cotizaci&oacute;n 
      ...
      <tr>
        <td height="22" colspan="6" style="text-align:center"><table width="434" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="171" style="text-align:left"><input name="txtnumsolcotdes" type="text" id="txtnumsolcotdes" value="<?php print $ls_numsolcotdes ?>" size="20" maxlength="15"  style="text-align:center "  onblur="javascript:rellenar_cad(this.value,15,this)" onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript: ue_catalogo('sigesp_soc_cat_solicitud_cotizacion.php?origen=REPDES');"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar hasta..." name="buscar1" width="15" height="15" border="0"  id="buscar1" /></a></td>
            ...
            <td width="154" style="text-align:left"><input name="txtnumsolcothas" type="text" id="txtnumsolcothas" value="<?php print $ls_numsolcothas ?>" size="20" maxlength="15"  style="text-align:center"  onblur="javascript:rellenar_cad(this.value,15,this)"  onkeypress="return keyRestrict(event,'1234567890');" />
                <a href="javascript: ue_catalogo('sigesp_soc_cat_solicitud_cotizacion.php?origen=REPHAS');"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar desde..." name="buscar2" width="15" height="15" border="0" id="buscar2" /></a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="22" colspan="6" style="text-align:center"><table width="435" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td colspan="4" style="text-align:left"><strong>Fecha de la Solicitud </strong></td>
          </tr>
          <tr>
            <td width="63" style="text-align:right">Desde</td>
            <td width="134" style="text-align:left">
              <input name="txtfecsoldes" type="text" id="txtfecsoldes" value="<?php print $ls_fecsoldes ?>" size="12" maxlength="10"  style="text-align:left"  datepicker="true" onkeypress="currencyDate(this);" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);"/></td>
            <td width="49" style="text-align:right">&nbsp;</td>
            <td width="187" style="text-align:left">Hasta
              <input name="txtfecsolhas" type="text" id="txtfecsolhas" value="<?php print $ls_fecsolhas ?>" size="12" maxlength="10"  style="text-align:left"  datepicker="true" onkeypress="currencyDate(this);" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);"/></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="22" colspan="6" style="text-align:center"><table width="434" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td colspan="4" style="text-align:left"><strong>Solicitud de Ejecuci&oacute;n Presupuestaria </strong></td>
          </tr>
          <tr>
            <td width="64" style="text-align:right">Desde</td>
            <td width="170" style="text-align:left"><input name="txtnumsepdes" type="text" id="txtnumsepdes" value="<?php print $ls_numsolcotdes ?>" size="20" maxlength="15"  style="text-align:center "  onblur="javascript:rellenar_cad(this.value,15,this)" onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript: ue_catalogo('sigesp_soc_cat_sep.php?tipo=REPDES');"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar hasta..." name="buscar1" width="15" height="15" border="0"  id="buscar1" /></a></td>
            <td width="44" style="text-align:right">Hasta</td>
            <td width="154" style="text-align:left"><input name="txtnumsephas" type="text" id="txtnumsephas" value="<?php print $ls_numsolcothas ?>" size="20" maxlength="15"  style="text-align:center"  onblur="javascript:rellenar_cad(this.value,15,this)"  onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript: ue_catalogo('sigesp_soc_cat_sep.php?tipo=REPHAS');"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar desde..." name="buscar2" width="15" height="15" border="0" id="buscar2" /></a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        ...
        <td height="30" colspan="6" style="text-align:center"><table width="435" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="132" style="text-align:left"><label>
              <select name="cmbtipsolcot" id="cmbtipsolcot">
            ...
            <td width="201" style="text-align:left"><strong>Estatus</strong>
              <label>
              <select name="cmbestsolcot" id="cmbestsolcot">
                <option value="-">---seleccione---</option>
...
function ue_imprimir()
{
	...
	ls_numsepdes    = f.txtnumsepdes.value;
	ls_numsephas    = f.txtnumsephas.value;
	ls_fecsolcotdes = f.txtfecsoldes.value;
	ls_fecsolcothas = f.txtfecsolhas.value;
	ls_tipsolcot    = f.cmbtipsolcot.value;
	ls_estsolcot    = f.cmbestsolcot.value;
	
	pagina="reportes/sigesp_soc_rpp_solicitud_cotizacion.php?solcotdes="+ls_numsolcotdes+"&solcothas="+ls_numsolcothas+"&codprodes="+ls_codprodes+
	       "&codprohas="+ls_codprohas+"&numsepdes="+ls_numsepdes+"&numsephas="+ls_numsephas+"&fecsoldes="+ls_fecsolcotdes+"&fecsolhas="+ls_fecsolcothas+
		   "&tipsolcot="+ls_tipsolcot+"&estsolcot="+ls_estsolcot;
