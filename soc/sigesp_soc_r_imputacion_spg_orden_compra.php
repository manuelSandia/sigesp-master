...
$io_fun_compra->uf_load_seguridad("SOC","sigesp_soc_r_imputacion_spg_orden_compra.php",$ls_permisos,&$la_seguridad,$la_permisos);
...
<div align="center">
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
    ...
    <tr><td height="20" colspan="12" bgcolor="#E7E7E7">
          ...
          <tr>
            <td height="26" style="text-align:right"><label></label>
              <div align="left"><strong>Bienes</strong>
                <input name="rdtipo" type="radio" class="sin-borde" value="B" checked />
