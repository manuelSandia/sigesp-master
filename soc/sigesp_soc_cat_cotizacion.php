...
function ue_aceptar(ls_numcot,ls_codpro,ls_numsolcot,ls_fecregcot,ls_obscot,ld_monsubcot,ld_moncrecot,ld_montotcot,li_diaent,ls_estcot,ls_forpag,ld_poriva,li_estinciva,ls_nompro,ls_tipcot,ls_diavalofe,ls_estasitec,ls_estesp,ls_garanacot)
{
    ...
    fop.txtvalidezoferta.value = ls_diavalofe;
    fop.txtgarantias.value   = ls_garanacot;
  
    if (ls_estasitec==1)
    {
      fop.rdasitec[0].checked = true;           
    }
    else
    {
      fop.rdasitec[1].checked = true;           
    }
    if (ls_estesp==1)
    {
      fop.rdespecificaciones[0].checked = true;           
    }
    else
    {
      fop.rdespecificaciones[1].checked = true;           
    }  
