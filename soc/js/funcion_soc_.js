...
function redondear(number, decimals) 
{
	...
	return newString; // Output the result to the form field (change for your purposes)
		...
		//$li_monred=$cantidad;
/*		li_posdec=stripos(cantidad,".")+1;
		if(li_posdec>1)
		{
			li_valor1=cantidad.substr(0,li_posdec+$ai_decimales+1)
			li_valor2=cantidad.substr(0,li_posdec+$ai_decimales+1)
			li_factor=(li_valor1-li_valor2)*(Math.pow(10,decimales));
			li_factor=Math.round(li_factor,6);
			if($li_factor>=0.5)
			{
