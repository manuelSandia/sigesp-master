...
switch ($li_diasem){
  ...
  break;
   ...
   function uf_limpiarvariables()
   {
		...
		// Fecha Creaci_n: 11/04/2007			Fecha _ltima Modificaci_n : 
		//////////////////////////////////////////////////////////////////////////////
...
?>
    <table width="595" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td height="22">&nbsp;</td>
        <td height="22" colspan="2" style="text-align:center">
        	<strong>Fecha</strong> 
        	<input name="txtfecope" type="text" id="txtfecope" class="sin-borde" value="<?php print $ld_fecope ?>" size="12" maxlength="10" readonly />
        </td>
      </tr>
      ...
      <tr>
		...
		<td height="22" style="text-align:left"><input name="txtnumordcom" type="text" id="txtnumordcom" value="<?php print $ls_numordcom ?>" size="20" maxlength="15" style="text-align:center"<?php echo $ls_disabled; ?> /></td>
	   ...
	   if (li_incluir==1)
		  {
		    ...
		    for (li_i=1;li_i<=li_totrows;li_i++)
		     ...
		     if (li_totchk>0)
					    ...
					    if (eval("f.chk"+li_i+".checked")==true)
						   {
						     ...
						     if (!lb_valfec)
							    {
								  lb_valido = false;
								  alert("Existen Ordenes de Compra con Fecha de Registro mayor a la Fecha de Aprobaci_n !!!");
								  break;
							    }
						   }
					  }		 
			    ...
			    {
				  alert("Debe seleccionar Ordenes de Compra para su Aprobaci_n/Reverso de Aprobaci_n !!!");
				  lb_valido = false;
			    }	
		     if (lb_valido)
			    {
