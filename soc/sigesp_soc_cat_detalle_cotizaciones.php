<?php
	...
	$la_titulos=array(1=>"C�digo",2=>"Denominaci�n",3=>"Cantidad",4=>"Precio/Unid.", 5=>"Subtotal",6=>"Cargos",7=>"Total");
?>
...
<form name="formulario" method="post" action="">
  ...
  <table width="812" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
     ...
     <tr>
      <th scope="col">&nbsp;</th>
      <th scope="col"><div align="right">Asistencia T&eacute;cnica: </div></th>
      <th scope="col"><div align="left" class="celdas-blancas"><?php print $io_funciones->uf_convertirvalormostrar($la_cotizacion["estasitec"])?></div></th>
      <th width="174" scope="col"><div align="right">Cumple con Especificaciones:</div></th>
      <th scope="col"><div align="left" class="celdas-blancas"><?php print $io_funciones->uf_convertirvalormostrar($la_cotizacion["estesp"])?></div></th>
      <th scope="col">&nbsp;</th>
