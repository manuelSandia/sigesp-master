...
$io_fun_compra->uf_load_seguridad("SOC","sigesp_soc_r_orden_relacionmensual.php",$ls_permisos,&$la_seguridad,$la_permisos);
...
<title>Relaci&oacute;n Mensual de Ordenes de Compra</title>
    ...
    <table width="543" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
        <td height="22" colspan="6" class="titulo-ventana"><input name="operacion" type="hidden" id="operacion" value="<?php print $ls_operacion ?>" />
          Relaci&oacute;n Mensual de Ordenes de Compra </td>
      </tr>
      <tr>
        <td height="13">&nbsp;</td>
        <td height="13">&nbsp;</td>
...
function ue_imprimir()
{
	...
	ls_fecdes = f.txtfecordcomdes.value;
	ls_fechas = f.txtfecordcomhas.value;
		
	ls_reporte  = "sigesp_soc_rpp_relacionmensual.php";
	pagina="reportes/"+ls_reporte+"?txtnumordcomdes="+ls_numordcomdes+"&rdtipo="+ls_tipord
					 +"&txtnumordcomhas="+ls_numordcomhas+"&txtfecdes="+ls_fecdes+"&txtfechas="+ls_fechas;
...
function ue_openexcel()
{
	...
	ls_reporte  = "sigesp_soc_rpp_relacionmensual_excel.php";
	pagina="reportes/"+ls_reporte+"?txtnumordcomdes="+ls_numordcomdes+"&rdtipo="+ls_tipord
					 +"&txtnumordcomhas="+ls_numordcomhas+"&txtfecdes="+ls_fecdes+"&txtfechas="+ls_fechas;
	window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no,left=50,top=50");
}  
