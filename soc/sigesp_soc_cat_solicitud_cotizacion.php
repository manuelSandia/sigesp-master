...
function ue_aceptar_solicitud(ls_numsolcot,ls_tipsolcot,ls_fecsolcot,ls_obssolcot,ls_consolcot,ls_uniejeaso,ls_cedpersol,
							  ...
							  ls_codestpro3,ls_codestpro4,ls_codestpro5,ls_estcla,ls_estsolcot,as_tipbiesol,ls_codusu,ls_telusu,ls_nota)
{
  ...
  fop.txtfecha.value    	= ls_fecsolcot;
  fop.txtcorreosolcot.value = ls_nota;
  fop.txttlfcomprador.value = ls_telusu;
  switch(ls_estsolcot)
  {
  	case "R":
	...
	break;
  	case "A":
	   fop.txtestsolcot.value    = "ANULADA";
	   fop.cmbtipsolcot.disabled = true;
	   fop.botsep.disabled 		 = true;
	   fop.txttelpersol.disabled = true;
       fop.txtfaxpersol.disabled = true;
