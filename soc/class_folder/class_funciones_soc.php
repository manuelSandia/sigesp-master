<?php
class class_funciones_soc
{
	//-----------------------------------------------------------------------------------------------------------------------------------
 	function class_funciones_soc()
	{
		//////////////////////////////////////////////////////////////////////////////
		//	     Function: class_funciones_soc
		//		   Access: public
   ...
   //---------------------------------------------------------------------------------------------------------------------------------
    function uf_soc_select_administrador($as_codemp,$as_codusu,&$as_administrativo)
	{
	 ...
	 // Fecha Creación :   16/04/2007          Fecha última Modificacion : 30/01/2008   Hora = 04:35
	   ...
	   $this->io_sql      = new class_sql($this->io_conexion);
	   $lb_valido=false;
	   $as_ventana= $this->obtenerCodigoMenu('SOC','sigesp_soc_p_registro_orden_compra.php',&$campo);
...
//---------------------------------------------------------------------------------------------------------------------------------		
	function uf_get_estado_ordencompra($ls_estcom, $ls_estapro)
	{
		///////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function :   uf_get_estado_ordencompra
		//     Argumentos :   $ls_estcom ---> codigo que indica el estatus de la orden
		//                    $ls_estapro ---> codigo que indica si esta aprobada la orden             
		//	      Returns :	  Retorna un string con el estatus de la orden de compra
		//	  Description :	  Metodo que retorna en una variable el estatus de las ordenes de compra
		//     Creado por :   Ing. David Briceño.
		// Fecha Creación :   13/03/2013          Fecha última Modificacion :  13/03/2013    
		///////////////////////////////////////////////////////////////////////////////////////////////
		...
		switch ($ls_estcom)
		{
			...
			case "8":
				...
				break;
				//Se agregó un estatus nuevo a la SEP "Sin Disponibilidad Presupuestaria"
			case "9":
