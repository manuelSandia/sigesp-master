<?php
	...
	{	
		...
		for($li_fila=1;$li_fila<=$ai_total;$li_fila++)
		{
			...
			$lo_object[$li_fila][2]="<input type=text name=txtnompro".$li_fila."  id=txtnompro".$li_fila."  class=sin-borde style=text-align:left   size=50  value='".utf8_encode($ls_nompro)."'  readonly>";
			$lo_object[$li_fila][3]="<input type=text name=txtdirpro".$li_fila."  id=txtdirpro".$li_fila."  class=sin-borde style=text-align:left   size=55  value='".utf8_encode($ls_dirpro)."'  readonly>"; 
