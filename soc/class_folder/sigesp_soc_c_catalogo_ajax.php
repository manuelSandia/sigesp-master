<?php
	//-----------------------------------------------------------------------------------------------------------------------------------
	// Clase donde se cargan todos los catï¿½logos del sistema SEP con la utilizaciï¿½n del AJAX
	//-----------------------------------------------------------------------------------------------------------------------------------
    session_start();   
	...
	function uf_print_personal()
   	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Mï¿½todo que obtiene e imprime el resultado de la busqueda de los conceptos
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaciï¿½n: 17/03/2007								Fecha ï¿½ltima Modificaciï¿½n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_fun_soc;
		...
		print "<td style='cursor:pointer' title='Ordenar por Cï¿½dula'   align='center' onClick=ue_orden('cedper')>C&eacute;dula</td>";
		     ...
		     while(!$rs_data->EOF)
			      {
					...
					echo "<td align='center'><a href=\"javascript: ue_aceptar('".$ls_cedper."','".utf8_encode($ls_nomper)."','".utf8_encode($ls_apeper)."','".$ls_codcarper."');\">".$ls_cedper."</a></td>";
					echo "<td align='left'>".utf8_encode($ls_nomper)."</td>";
					echo "<td align='left'>".utf8_encode($ls_apeper)."</td>";
					echo "</tr>";
					$rs_data->MoveNext();
			      }
	...
	function uf_print_unidad_ejecutora()
	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Funciï¿½n que obtiene e imprime los resultados de la busqueda de la unidad ejecutora (Unidad administrativa)
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Modificado Por: Ing. Yozelin Barragan / Ing. Nestor Falcon 
		// Fecha Creaciï¿½n: 17/03/2007 								Fecha ï¿½ltima Modificaciï¿½n : 05/05/2007
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		require_once("../../shared/class_folder/sigesp_include.php");
		$io_include=new sigesp_include();
		$io_conexion=$io_include->uf_conectar();
		...
		print "<table width=500 border=0 cellpadding=1 cellspacing=1 class=fondo-tabla align=center>";
		print "<tr class=titulo-celda>";
		print "<td width=60  style='cursor:pointer' title='Ordenar por Cï¿½digo'       align='center' onClick=ue_orden('coduniadm')>C&oacute;digo</td>";
		if (empty($ls_tipo))
		   {
		     print "<td width=400 style='cursor:pointer' title='Ordenar por Denominaciï¿½n' align='center' onClick=ue_orden('denuniadm')>Denominaci&oacute;n</td>";
			 print "<td width=40  style='cursor:pointer' title='Seleccionar Estructura Presupuestaria'>Detalle</td>";   
		   }
		else
		   {
		     print "<td width=440 style='cursor:pointer' title='Ordenar por Denominaciï¿½n' align='center' onClick=ue_orden('denuniadm')>Denominaci&oacute;n</td>";
		   }
		print "</tr>";
		...
		if (strtoupper($ls_gestor) == "MYSQLT")
		{
		 $ls_sql_seguridad = " AND CONCAT('".$ls_codemp."','SOC','".$ls_logusr."',spg_unidadadministrativa.coduniadm) IN (SELECT CONCAT(codemp,codsis,codusu,codintper) 
		                       FROM sss_permisos_internos WHERE codusu = '".$ls_logusr."' AND codsis = 'SOC' AND enabled=1)";
		}
		else
		{
	...
	function uf_print_bienes()
   	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Mï¿½todo que obtiene e imprime el resultado de la busqueda de los bienes
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Modificado Por: Ing. Yozelin Barragan / Ing. Nestor Falcon 
		// Fecha Creaciï¿½n: 17/03/2007								Fecha ï¿½ltima Modificaciï¿½n : 23/07/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_fun_soc;
		require_once("../../shared/class_folder/class_sql.php");
		require_once("../../shared/class_folder/sigesp_include.php");
				  ...
				  if (!empty($la_spgctas))
				     {
					   ...
					   $ls_sql = "SELECT TRIM(siv_articulo.codart) as codart,siv_articulo.denart,siv_articulo.ultcosart,
									     ...
									     siv_unidadmedida.denunimed, siv_unidadmedida.unidad,siv_articulo.estartgen, $ls_straux
						    ...
						    while(!$rs_data->EOF)
						         {
							       ...
							       $ls_denart		= utf8_encode($rs_data->fields["denart"]);
	...
	function uf_print_servicios()
   	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Mï¿½todo que obtiene e imprime el resultado de la busqueda de los servicios
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Modificado Por: Ing. Yozelin Barragan / Ing. Nestor Falcon 
		// Fecha Creaciï¿½n: 17/03/2007								Fecha ï¿½ltima Modificaciï¿½n : 23/07/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ((!empty($ls_codunieje) && $ls_codunieje!='----------') || $ls_tipo=='OC')
		   {
			...
			else
			{
				while(!$rs_data->EOF)
				{
					...
					$ls_denser	   = utf8_encode($rs_data->fields["denser"]);
	...
	function uf_print_proveedor($ls_tipo)
   	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Funciï¿½n que obtiene e imprime los resultados de la busqueda de proveedores
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Modificado Por: Ing. Yozelin Barragan / Ing. Nestor Falcon 
		// Fecha Creaciï¿½n: 17/03/2007 								Fecha ï¿½ltima Modificaciï¿½n : 
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		print "<td>&nbsp;</td>";
		print "</tr>";
        $ls_sql="SELECT cod_pro,nompro,sc_cuenta,rifpro,dirpro,telpro,tipconpro,fecvenince".
				"  FROM rpc_proveedor  ".
                " WHERE codemp = '".$ls_codemp."' ".
				"   AND cod_pro <> '----------' ".
				"   AND estprov = 0 ".
		...
		else
		{
			while(!$rs_data->EOF)
			{
				...
				$ls_nompro    = utf8_encode($rs_data->fields["nompro"]);
				$ls_sccuenta  = $rs_data->fields["sc_cuenta"];
				$ls_rifpro    = trim($rs_data->fields["rifpro"]);
				$ls_dirpro    = utf8_encode($rs_data->fields["dirpro"]);
			 ...
			 //Se agregÃ³ en el query el campo "fecvenrnc" y se operÃ³ con Ã©l para mostrar la vigencia de RNC de los proveedores
				$ls_fechavenRNC   = $io_funciones->uf_formatovalidofecha($rs_data->fields["fecvenince"]);
				$ld_hoy=date('Y')."-".date('m')."-".date('d');
				$io_fecha     = new class_fecha();
				if($io_fecha->uf_comparar_fecha($ld_hoy,$ls_fechavenRNC))
				{
					$lb_registronacional="VIGENTE";
					//Ser construyen los links que poseen el icono para seleccionar al proveedor
					$lb_linkCaseSC="<a href=\"javascript: ue_aceptar_proveedor_solicitud_cotizacion('".$ls_codpro."','".$ls_nompro."','".$ls_dirpro."','".$ls_telpro."');\"><img src='../shared/imagebank/tools20/aprobado.gif' title='Agregar Proveedor' width='15' height='15' border='0'></a></td>";
					$lb_linkCaseRC="<a href=\"javascript: ue_aceptar_proveedor_registro_cotizacion('".$ls_codpro."','".$ls_nompro."','".$ls_tipconpro."');\"><img src='../shared/imagebank/tools20/aprobado.gif' title='Agregar Proveedor' width='15' height='15' border='0'></a></td>";
					$lb_linkCaseVacio="<a href=\"javascript: ue_aceptar('".$ls_codpro."','".$ls_nompro."','".$ls_tipconpro."','".$ls_rifpro."');\"><img src='../shared/imagebank/tools20/aprobado.gif' title='Agregar Proveedor' width='15' height='15' border='0'></a></td>";
					$lb_linkCaseREPDES="<a href=\"javascript: aceptar_reportedesde('".$ls_codpro."');\"><img src='../shared/imagebank/tools20/aprobado.gif' title='Agregar Proveedor' width='15' height='15' border='0'></a></td>";
					$lb_linkCaseREPHAS="<a href=\"javascript: aceptar_reportehasta('".$ls_codpro."');\"><img src='../shared/imagebank/tools20/aprobado.gif' title='Agregar Proveedor' width='15' height='15' border='0'></a></td>";
				}
				else
				{
					$lb_registronacional="VENCIDO";
					// No se generan los links ya que solo se imprimirÃ¡ un icono que no permitirÃ¡ seleccionar al proveedor
					$lb_linkCaseSC="<img src='../shared/imagebank/tools20/eliminar-off.gif' title='No se puede agregar el proveedor' width='15' height='15' border='0'></td>";
					$lb_linkCaseRC="<img src='../shared/imagebank/tools20/eliminar-off.gif' title='No se puede agregar el proveedor' width='15' height='15' border='0'></td>";
					$lb_linkCaseVacio="<img src='../shared/imagebank/tools20/eliminar-off.gif' title='No se puede agregar el proveedor' width='15' height='15' border='0'></td>";
					$lb_linkCaseREPDES="<img src='../shared/imagebank/tools20/eliminar-off.gif' title='No se puede agregar el proveedor' width='15' height='15' border='0'></td>";
					$lb_linkCaseREPHAS="<img src='../shared/imagebank/tools20/eliminar-off.gif' title='No se puede agregar el proveedor' width='15' height='15' border='0'></td>";
				}
				echo "<tr class=celdas-blancas>";
			...
			//Se agregÃ³ la impresiÃ³n de la vigencia del proveedor
				echo "<td style=text-align:center   width=80>".$lb_registronacional."</td>";
				echo "<td>";
				switch ($ls_tipo)
				{
					case "SC":
						//Se imprime la cadena construida de acuerdo a la vigencia del proveedor en el RNC
				        echo $lb_linkCaseSC;
					break;
					case "RC":
						//Se imprime la cadena construida de acuerdo a la vigencia del proveedor en el RNC
					...
					case "":
						//Se imprime la cadena construida de acuerdo a la vigencia del proveedor en el RNC
				        echo $lb_linkCaseVacio;
					break;
				  	case "REPDES":
				  		//Se imprime la cadena construida de acuerdo a la vigencia del proveedor en el RNC
				        echo $lb_linkCaseREPDES;
					break;
					case "REPHAS":
						//Se imprime la cadena construida de acuerdo a la vigencia del proveedor en el RNC
				        echo $lb_linkCaseREPHA;
					break;
				}
				echo "</td>";
			    echo "</tr>";
	...
	function uf_print_cotizacion_analisis()
   	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Mï¿½todo que obtiene e imprime el las cotizaciones registradas asociadas a su solicitud para el anï¿½lisis de cotizacion
		//	   Creado Por: Ing. Laura Cabrï¿½
		// Fecha Creaciï¿½n: 12/04/2007								Fecha ï¿½ltima Modificaciï¿½n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_fun_soc;		
		require_once("../../shared/class_folder/sigesp_include.php");
		$io_include=new sigesp_include();
		...
		else
		{
				...
				print "<tr class=titulo-celda>";
				print "<td style='cursor:pointer' title='Ordenar por Nï¿½ de Solicitud'       align='center' onClick=ue_orden('s.numsolcot')>No de Solicitud</td>";
				print "<td style='cursor:pointer' title='Ordenar por Nï¿½ Cotizaciï¿½n'         align='center' onClick=ue_orden('s.numcot')>No de Cotizacion</td>";
	...
	function uf_print_fuente_financiamiento($ls_codestpro1, $ls_codestpro2, $ls_codestpro3, $ls_codestpro4, $ls_codestpro5, $ls_estcla)
	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Funciï¿½n que obtiene e imprime los resultados de la busqueda de fuente de financiamiento
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaciï¿½n: 17/03/2007 								Fecha ï¿½ltima Modificaciï¿½n : 
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		require_once("../../shared/class_folder/sigesp_include.php");
	...
	function uf_print_solicitudes_cotizacion($as_origen,$as_codpro)
   	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Mï¿½todo que obtiene todas las Solicitudes de Cotizaciï¿½nes segun filtros.
		//	   Creado Por: Ing. Nï¿½stor Falcï¿½n.
		// Fecha Creaciï¿½n: 06/05/2007								Fecha ï¿½ltima Modificaciï¿½n :06/05/2007 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_fun_soc;
		require_once("../../shared/class_folder/sigesp_include.php");
		require_once("../../shared/class_folder/class_sql.php");
		...
		if ($as_origen=='RC')//Registro de Cotizaciï¿½n.
		   {
		     if ($ls_tipsolcot=='B')
			    {
		...
		print "<tr class=titulo-celda>";
		print "<td width=100 style='cursor:pointer' title='Ordenar por Nï¿½mero'   align='center' onClick=ue_orden('numsolcot')>Nro. Solicitud</td>";
		...
		print "</tr>"; 
 		$ls_sql = " SELECT soc_sol_cotizacion.numsolcot,
						   ...
						   max(sss_usuarios.telusu) as telusu,
						   max(sss_usuarios.nota) as nota,
					  ...
					  FROM soc_sol_cotizacion, sss_usuarios, spg_unidadadministrativa, spg_dt_unidadadministrativa, sno_personal 
					        $ls_tabla 
					 WHERE soc_sol_cotizacion.codemp='".$ls_codemp."' $ls_filtro $ls_cadaux
					   ...
					   AND soc_sol_cotizacion.codusu = sss_usuarios.codusu
		...
		else
		{
			while(!$rs_data->EOF)
			{
				...
				$ls_obssolcot  = utf8_encode(eregi_replace("[\n|\r|\n\r]",' ',$rs_data->fields["obssol"]));
				$ls_consolcot  = utf8_encode(eregi_replace("[\n|\r|\n\r]",' ',$rs_data->fields["consolcot"]));
				$ls_uniejeaso  = $rs_data->fields["uniejeaso"];
				$ls_codusu     = $rs_data->fields["codusu"];
				$ls_telusu     = $rs_data->fields["telusu"];
				$ls_nota       = $rs_data->fields["nota"];
				...
				$ls_estsolcot  = $rs_data->fields["estcot"];;
				echo "<tr class=celdas-blancas>";
				switch ($as_origen){
				  case 'SC':
					echo "<td align='center'><a href=\"javascript: ue_aceptar_solicitud('$ls_numsolcot','$ls_tipsolcot','$ls_fecsolcot','$ls_obssolcot','$ls_consolcot','$ls_uniejeaso',".
						  ...
						  "'$ls_codestpro4','$ls_codestpro5','$ls_estcla','$ls_estsolcot','$ls_tipbiesol','$ls_codusu','$ls_telusu','$ls_nota');\">".$ls_numsolcot."</a></td>";
				    break;
				  case 'RC': 
	...
	function uf_print_cotizaciones($as_origen,$as_tipcot)
   	{
		...
		//	  Description: Mï¿½todo que obtiene todas las Solicitudes de Cotizaciï¿½nes segun filtros.
		//	   Creado Por: Ing. Nï¿½stor Falcï¿½n.
		// Fecha Creaciï¿½n: 28/05/2007								Fecha ï¿½ltima Modificaciï¿½n :28/05/2007 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_fun_soc;
		require_once("../../shared/class_folder/sigesp_include.php");
		require_once("../../shared/class_folder/class_sql.php");
		...
		print "<tr class=titulo-celda>";
		print "<td width=120 style='cursor:pointer' title='Ordenar por Nï¿½mero'       align='center' onClick=ue_orden('numcot')>Nro. Cotizaci&oacute;n</td>";
		print "<td width=180 style='cursor:pointer' align='center'>Proveedor</td>";
		print "<td width=260 style='cursor:pointer' title='Ordenar por Observaciï¿½n'  align='center' onClick=ue_orden('obscot')>Observaci&oacute;n</td>";
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
                ...
                $ls_estasitec   =  $row["estasitec"];
                $ls_estesp      =  $row["estesp"];
                $ls_garanacot   =  $row["garanacot"];
                
				print "<tr class=celdas-blancas>";
				switch ($as_origen){
				  case 'RC':
				     print "<td align='center' width=120><a href=\"javascript: ue_aceptar('$ls_numcot','$ls_codpro','$ls_numsolcot','$ls_fecregcot','$ls_obscot','$ld_monsubcot','$ld_moncrecot','$ld_montotcot','$li_diaent','$ls_estcot','$ls_forpag','$ld_poriva','$li_estinciva','$ls_nompro','$ls_tipcot','$ls_diavalofe','$ls_estasitec','$ls_estesp','$ls_garanacot' );\">".$ls_numcot."</a></td>";
				  break;
				  case 'REPDES':
	...
	function uf_print_sep($as_tipo)
   	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Mï¿½todo que obtiene todas las Solicitudes de Ejecuciï¿½n Presupuestaria segun filtros.
		//	   Creado Por: Ing. Nï¿½stor Falcï¿½n.
		// Fecha Creaciï¿½n: 06/05/2007								Fecha ï¿½ltima Modificaciï¿½n :06/05/2007 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_fun_soc;
		...
		if (!empty($ls_tabla))
		   {
		     $ls_cadena = ", $ls_tabla ";
		     $ls_straux = " AND $ls_tabla.estincite = 'NI' and $ls_tabla.codemp=spg_unidadadministrativa.codemp and sep_solicitud.numsol=$ls_tabla.numsol and $ls_tabla.codemp=sep_solicitud.codemp AND  $ls_tabla.codemp=spg_dt_unidadadministrativa.codemp AND  $ls_tabla.codemp=rpc_proveedor.codemp AND $ls_tabla.codemp=spg_ep5.codemp AND   sep_solicitud.codemp=$ls_tabla.codemp AND sep_solicitud.numsol=$ls_tabla.numsol ";
		   } 
		...
		echo "<tr class=titulo-celda>";
		echo "<td width=100 style='cursor:pointer' title='Ordenar por Nï¿½mero'            align='center' onClick=ue_orden('numsol')>Nro. Solicitud</td>";
...
spg_ep5,
sep_tiposolicitud $ls_cadena


WHERE 

sep_solicitud.codemp=spg_unidadadministrativa.codemp AND 
sep_solicitud.codemp=spg_dt_unidadadministrativa.codemp AND 
sep_solicitud.codemp=rpc_proveedor.codemp AND 
sep_solicitud.codemp=spg_ep5.codemp AND 
 

 
spg_unidadadministrativa.codemp=spg_dt_unidadadministrativa.codemp AND  
spg_unidadadministrativa.codemp=rpc_proveedor.codemp AND 
spg_unidadadministrativa.codemp=spg_ep5.codemp AND 
 
spg_dt_unidadadministrativa.codemp=rpc_proveedor.codemp AND 
spg_dt_unidadadministrativa.codemp=spg_ep5.codemp AND 

rpc_proveedor.codemp=spg_ep5.codemp AND  
...
sep_solicitud.codemp=rpc_proveedor.codemp AND 
sep_solicitud.cod_pro=rpc_proveedor.cod_pro AND  
sep_solicitud.codtipsol=sep_tiposolicitud.codtipsol AND 

spg_unidadadministrativa.codemp=spg_dt_unidadadministrativa.codemp AND 

spg_unidadadministrativa.coduniadm=spg_dt_unidadadministrativa.coduniadm AND 
...
sep_solicitud.codestpro1=spg_ep5.codestpro1 AND 


sep_solicitud.codestpro2=spg_ep5.codestpro2 AND 


sep_solicitud.codestpro3=spg_ep5.codestpro3 AND 

sep_solicitud.codestpro4=spg_ep5.codestpro4 AND 

sep_solicitud.codestpro5=spg_ep5.codestpro5 AND 

sep_solicitud.estcla=spg_ep5.estcla AND  			 sep_solicitud.codemp='".$ls_codemp."'
					  AND sep_solicitud.numsol like '%".$ls_numsol."%'
                      AND (sep_solicitud.estsol='C' OR sep_solicitud.estsol='P') 
					  AND sep_solicitud.tipsepbie='".$ls_tipsolbie."' $ls_straux
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_consol = utf8_decode($row["consol"]);
				
				$ls_consol = str_replace("\n", " ", $ls_consol);
				$ls_consol = str_replace("\r", " ", $ls_consol);
				...
				switch ($as_tipo){
				  case 'SC':
			        print "<a href=\"javascript: ue_aceptar('".$ls_numsol."','".$ls_consol."','".$ld_monsol."','".$ls_unieje."','".$ls_denuni."','".$ls_codpro."','".$ls_nompro."','".$ls_dirpro."','".$ls_telpro."','".$ls_codestpro1."','".$ls_codestpro2."','".$ls_codestpro3."','".$ls_codestpro4."','".$ls_codestpro5."','".$ls_estcla."','".$ls_fecsol."');\"><img src='../shared/imagebank/tools20/aprobado.gif' title='Agregar' width='15' height='15' border='0'></a></td>";
				  break;
				  case 'REPDES':
	...
	function uf_print_analisis()
   	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Mï¿½todo que obtiene e imprime los analisis de cotizacion previamente registrados
		//	   Creado Por: Ing. Laura Cabrï¿½
		// Fecha Creaciï¿½n: 09/06/2007								Fecha ï¿½ltima Modificaciï¿½n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_fun_soc;		
		require_once("../../shared/class_folder/sigesp_include.php");
		$io_include=new sigesp_include();
		...
		$ls_sql="SELECT numanacot,
						...
						max(estasitec) as estasitec,
						max(estesp) as estesp,
						max(garanacot) as garanacot,
						max(recanacot) as recanacot
		...
		else
		{
				print "<table width=630 border=0 cellpadding=1 cellspacing=1 class=fondo-tabla align=center>";
				print "<tr class=titulo-celda>";
				print "<td style='cursor:pointer' title='Ordenar por Nï¿½ de Analisis'       align='center' onClick=ue_orden('numanacot')>No de Analisis</td>";
				print "<td style='cursor:pointer' title='Ordenar por Nï¿½ Solicitud'         align='center' onClick=ue_orden('numsolcot')>No de Solicitud</td>";
				...
				while($row=$io_sql->fetch_row($rs_data))
				{
					...
					$ls_numsolcot=$row["numsolcot"];
					$ls_obsana=utf8_encode($row["obsana"]);
					$ls_estasitec=$row["estasitec"];
					$ls_estesp=$row["estesp"];
					$ls_garanacot=$row["garanacot"];
					$ls_recanacot=utf8_encode($row["recanacot"]);
					$ls_feccot=$io_funciones->uf_formatovalidofecha($row["fecanacot"]);
					$ls_fecanacot=$io_funciones->uf_convertirfecmostrar($ls_feccot);
				if ($row["estana"]=='0')//R=REGISTRO.
				   {
				     $ls_estatus='REGISTRO';
				   }
				elseif($row["estana"]=='1')//P=PROCESADA.
				   {
				   ...
				   else
				   {
					...
					print "<tr class=celdas-blancas>";
					print "<td align='center'><a href=\"javascript:ue_aceptar('$ls_numanacot','$ls_fecanacot','$ls_obsana','$ls_numsolcot','".$row["tipsolcot"]."','$ls_estatus','$ls_estasitec','$ls_estesp','$ls_garanacot','$ls_recanacot');\">".$ls_numanacot."</a></td>";
	...
	function uf_print_orden_compra()
	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Funciï¿½n que obtiene e imprime los resultados de la busqueda de las Ordenes de Compra
		//     Creado Por: Ing. Yozelin Barragan.
		// Fecha Creaciï¿½n: 09/05/2007 								Fecha ï¿½ltima Modificaciï¿½n : 
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_campoorden=$_POST['campoorden'];
		$ls_tipo=$_POST['tipo'];
		print "<table width=850 border=0 cellpadding=1 cellspacing=1 class=fondo-tabla align=center>";
		print "<tr class=titulo-celda>";
		...
		print "<td width=250 style='cursor:pointer' title='Ordenar por Concepto' align='center' onClick=ue_orden('soc_ordencompra.obscom')>Concepto</td>";
		...
		if($ls_tipo=="COPIAR")
		{
			print "<td width=20 title='Copiar Items' align='center'></td>";
		}
		print "</tr>";
		if($ls_tipordcom=='-')
		{
		...
		$ls_sql=" SELECT soc_ordencompra.codemp, soc_ordencompra.numordcom, soc_ordencompra.estcondat, ".
				...
				"        soc_ordencompra.codpai,soc_ordencompra.codest,soc_ordencompra.codmun,soc_ordencompra.codpar,soc_ordencompra.conanusoc,".
		...
		else
		{
			...
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_concom=utf8_encode(caracteres_especiales($row["concom"]));
				$ls_obscom=utf8_encode(caracteres_especiales($row["obscom"]));
				...
				$ls_estatus = strtoupper($io_funciones_soc->uf_get_estado_ordencompra($ls_estcom, $ls_estapro));
			    ...
			    switch ($ls_tipo)
				{
					case "":
						print "<td align='center'><a href=\"javascript: ue_aceptar('$ls_numordcom','$ls_estcondat','$ld_fecordcom',".
											...
											'$ld_prentdesde','$ld_prenthasta','$ls_tipbieordcom','$ls_rifpro','$li_i','$ls_conanusoc');\">".$ls_numordcom."</a></td>";
					break;
					...
					break;
					case "COPIAR":
						print "<td align='center'>".$ls_numordcom."</td>";
					break;
			   }
			   ...
			   print "<td align='center'>".$ls_obscom."</td>";	
			   ...
			   if($ls_tipo=="COPIAR")
			   {
					echo "<a href=\"javascript: ue_copiar('$ls_numordcom','$ls_estcondat','$ld_monsubtot','$ld_monimp','$ld_montot'	);\"><img src='../shared/imagebank/tools20/aprobado.gif' title='Agregar Proveedor' width='15' height='15' border='0'></a></td>";
			   }
			   print "</tr>";			
			}
			$io_sql->free_result($rs_data);
	...
	function uf_print_solicitud_presupuestaria()
	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Funciï¿½n que obtiene e imprime los resultados de la busqueda de la Solicitud de ejecuciï¿½n presupuestaria
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Modificado Por: Ing. Yozelin Barragan.
		// Fecha Creaciï¿½n: 17/03/2007 								Fecha ï¿½ltima Modificaciï¿½n : 28/04/2007
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		require_once("../../shared/class_folder/sigesp_include.php");
		$io_include=new sigesp_include();
		$io_conexion=$io_include->uf_conectar();
		...
		{
		  $ls_tabla="sep_dt_articulos";
		  $ls_sql_con=" AND sep_dt_articulos.canart<>0 ";
		}
		elseif($ls_tipord=='S')
		{
		  $ls_tabla="sep_dt_servicio";
		  $ls_sql_con=" AND sep_dt_servicio.canser<>0 ";
		}
		...
		$ls_sql=" SELECT DISTINCT sep_solicitud.numsol, sep_solicitud.codtipsol, sep_solicitud.coduniadm, sep_solicitud.codfuefin,".
				...
				" WHERE   sep_solicitud.codemp='".$ls_codemp."' 
					  ...
					  AND ".$ls_tabla.".estincite='NI' ".$ls_sql_con.
	...
	function uf_print_cuentas_spg()
   	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Mï¿½todo que inprime el resultado de la busqueda de las cuentas presupuestarias
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Modificado Por: Ing. Yozelin Barragan
		// Fecha Creaciï¿½n: 17/03/2007								Fecha ï¿½ltima Modificaciï¿½n : 06/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_fun_soc;
		require_once("../../shared/class_folder/sigesp_include.php");
		$io_include=new sigesp_include();
		...
		switch($ls_modalidad)
		{
			...
			case "2": // Modalidad por Presupuesto
				$ls_titulo="Estructura Programï¿½tica ";
				break;
		}
		print "<table width=500 border=0 cellpadding=1 cellspacing=1 class=fondo-tabla align=center>";
		print "<tr class=titulo-celda>";
	...
	function uf_print_cuentas_cargos()
   	{
		...
		//		   Access: private
		//	    Arguments: 
		//	  Description: Mï¿½todo que inprime el resultado de la busqueda de las cuentas presupuestarias de los cargos
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Modificado Por: Ing. Yozelin Barragan
		// Fecha Creaciï¿½n: 20/03/2007								Fecha ï¿½ltima Modificaciï¿½n : 06/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_cargos()
	{
		...
		//	  Description: Funciï¿½n que obtiene e imprime los resultados de la busqueda de fuente de financiamiento
		//	   Creado Por: Ing. Yozelin Barragan
		// Fecha Creaciï¿½n: 12/05/2007 								Fecha ï¿½ltima Modificaciï¿½n : 
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		require_once("../../shared/class_folder/sigesp_include.php");
		$io_include=new sigesp_include();
		$io_conexion=$io_include->uf_conectar();
