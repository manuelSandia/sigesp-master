...
$io_fun_compra->uf_load_seguridad("SOC","sigesp_soc_p_anulacion_analisis_cotizacion.php",$ls_permisos,&$la_seguridad,$la_permisos);
...
<title>Anulaci&oacute;n de Analisis de Cotizacion</title>
...
<?php
require_once("class_folder/sigesp_soc_c_anulacion_analisis_cotizacion.php");
$io_soc=new sigesp_soc_c_anulacion_analisis_cotizacion("../");
uf_limpiarvariables();
switch($ls_operacion){
  case 'GUARDAR':
	 uf_load_variables();
	 $io_soc->uf_update_estatus_analisis_cotizacion($li_totrows,$la_seguridad);
  break;
}
?>
<div align="center">
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
    ...
    <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">			
      <tr><td width="430" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Ordenes de Compra</td>
      ...
      <tr>
        <td width="697" height="168"><div align="center">
          <table width="590" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
            <tr>
              <td height="22" colspan="8" class="titulo-celdanew">Anulaci&oacute;n de Analisis de Cotizacion
            ...
            <tr>
              <td height="22" colspan="8" style="text-align:right"><a href="javascript:ue_buscar();"><img src="../shared/imagebank/tools20/buscar.gif" alt="Buscar..." width="20" height="20" border="0" /></a><a href="javascript:ue_buscar();">Buscar Analisis </a></td>
            </tr>
            <tr>
...
function ue_buscar()
{
  if (uf_evaluate_cierre())
     {
	   ls_numanacot = f.txtnumordcom.value;
	   ...
	   if (li_leer==1)
		  {  
		    ...
		    ajax.open("POST","class_folder/sigesp_soc_c_anulacion_analisis_cotizacion_ajax.php",true);
			...
			ajax.send("numanacot="+ls_numanacot+"&codpro="+ls_codpro+"&fecdes="+ld_fecdes+"&fechas="+ld_fechas+"&proceso=BUSCAR");
		  }
	   else
		  {
  ...
  if (uf_evaluate_cierre())
     {
	   ...
	   if ((li_incluir==1) || (li_cambiar==1))
		  {    	 	 
		    ...
		    f.action="sigesp_soc_p_anulacion_analisis_cotizacion.php";
		    f.submit(); 
		  } 
	   else
		  {
