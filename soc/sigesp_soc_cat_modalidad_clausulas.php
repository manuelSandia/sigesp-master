...
function aceptar(codtipmod,denmodcla)
{
	opener.document.formulario.txtcodtipmod.value=codtipmod;
    opener.document.formulario.txtdenmodcla.value=denmodcla;
	close();
}
...
function ue_search()
{
	...
	ajax.send("catalogo=MODALIDAD-CLAUSULAS&tipo="+tipo+"&orden="+orden+"&campoorden="+campoorden);
}
</script>
</html>