...
$ls_reporte = $io_fun_compra->uf_select_config("SOC","REPORTE","ACEP_SERVICIOS","sigesp_soc_rpp_aceptacion_servicios.php","C");
  ...
  if (li_imprimir)
	 {
	   ...
	   if (ls_numordcom!="" && ls_fecordcom!="")
	      {
	        ls_pagina = "reportes/"+ls_reporte+"?numordcom="+ls_numordcom+"&fecordcom="+ls_fecordcom+"&cedper="+ls_cedper+"&nomper="+ls_nomper+"&nomreppro="+ls_nomreppro;  				
