...
$io_fun_compra->uf_load_seguridad("SOC","sigesp_soc_p_aprobacion_analisis_cotizacion.php",$ls_permisos,&$la_seguridad,$la_permisos);
...
switch ($li_diasem){
  ...
  break;
   ...
   function uf_limpiarvariables()
   {
		...
		// Fecha Creaci_n: 05/08/2007			Fecha _ltima Modificaci_n : 
		//////////////////////////////////////////////////////////////////////////////
	    global $ld_fecope,$li_totrows,$io_fun_compra,$ls_operacion,$ls_numanacot,$ls_solcot,$ld_fecdes,$ld_fechas,
   ...
   function uf_load_variables()
   {
		...
		//	   Creado Por: Ing. Laura Cabre
		// Fecha Creaci_n: 05/08/2007			Fecha _ltima Modificaci_n : 29/04/2007
		//////////////////////////////////////////////////////////////////////////////
	
	    global $ls_tipope,$li_totrows,$ls_operacion,$ls_numanacot,$ls_solcot,$ld_fecope,$ld_fecdes,$ld_fechas,$li_estciespg,
		       $li_estciespi;
...
<title>Aprobaci&oacute;n de An&aacute;lisis de Cotizaciones</title>
...
<?php
require_once("class_folder/sigesp_soc_c_aprobacion_analisis_cotizacion.php");
$io_soc = new sigesp_soc_c_aprobacion_analisis_cotizacion("../");
uf_limpiarvariables();
switch($ls_operacion){
  case 'GUARDAR':
			uf_load_variables();
...
<div align="center">
  ...
  <td height="20" colspan="12" bgcolor="#E7E7E7">
    ...
    <tr style="text-align:left">
      <td width="800" height="13" colspan="11" class="toolbar" style="text-align:left"><a href="javascript: ue_guardar();"><img src="../shared/imagebank/tools20/ejecutar.gif" alt="Procesar Operaci&oacute;n" width="20" height="20" border="0" title="Procesar Operaci&oacute;n" /></a><a href="../soc/sigespwindow_blank.php"><img src="../shared/imagebank/tools20/salir.gif" alt="Salir" width="20" height="20" border="0" title="Salir" /></a></td>
    </tr>
  </table>
  <p>&nbsp;</p>
...
?>
    <table width="595" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
        <td height="22" colspan="6" class="titulo-ventana">Aprobaci&oacute;n de An&aacute;lisis de Cotizaciones
      ...
      <tr>
        ...
        <td height="22" colspan="2" style="text-align:left"><label>
          <select name="cmbtipope" id="cmbtipope" <?php echo $ls_disabled; ?>>
            <option value="A" <?php if ($ls_tipope=='A'){print 'selected';}?>>Aprobaci&oacute;n</option>
            <option value="R" <?php if ($ls_tipope=='R'){print 'selected';}?>>Reverso de Aprobaci&oacute;n</option>
          </select>
        </label></td>
        <td height="22">&nbsp;</td>
        <td height="22" colspan="2" style="text-align:right"><strong>Fecha</strong> 
      ...
      <tr>
        <td height="22" colspan="6" class="titulo-celdanew">Datos An&aacute;lisis de Cotizacion </td>
      </tr>
      <tr>
        <td height="13">&nbsp;</td>
        <td height="13">&nbsp;</td>
      ...
      <tr>
        ...
        <td height="22" style="text-align:left"><label>
          <input name="txtnumanacot" type="text" id="txtnumanacot" value="<?php print $ls_numanacot ?>" size="20" maxlength="15" style="text-align:center" onKeyPress="return keyRestrict(event,'1234567890'); " onBlur="javascript:rellenar_cad(this.value,15)" <?php echo $ls_disabled; ?> />
        </label></td>
        <td height="22" style="text-align:right">Desde 
          <label>
          <input name="txtfecdes" type="text" id="txtfecdes" value="<?php print $ld_fecdes ?>" size="12" maxlength="10" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);" datepicker="true" <?php echo $ls_disabled; ?> />
        </label></td>
        <td height="22">&nbsp;</td>
        <td height="22" colspan="2" style="text-align:left">Hasta 
          <label>
          <input name="txtfechas" type="text" id="txtfechas" value="<?php print $ld_fechas ?>" size="12" maxlength="10" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);" datepicker="true" <?php echo $ls_disabled; ?> />
        </label></td>
      </tr>
      <tr>
        <td height="22" style="text-align:right">Tipo</td>
        <td height="22" style="text-align:left"><label>
          <select name="cmbtipanacot" id="cmbtipanacot" <?php echo $ls_disabled; ?>>
      ...
      <tr>
        <td height="22" colspan="6"><div align="right"><a href="javascript: ue_buscar();" title="Buscar An&aacute;lisis de Cotizaciones"><img src="../shared/imagebank/tools20/buscar.gif" alt="Buscar An&aacute;lisis de Cotizaciones" title="Buscar An&aacute;lisis de Cotizaciones" width="20" height="20" border="0" onclick="ue_buscar()">Buscar An&aacute;lisis de Cotizaciones</a>&nbsp;&nbsp;</div></td>
      </tr>
      <tr>
        <td height="13">&nbsp;</td>
        <td height="13">&nbsp;</td>
	...
	<input type="hidden" name="tipo" id="tipo" value="SC" />
  </form>
  <p>&nbsp;</p>
</div>
<p>&nbsp;</p>
...
function ue_catalogo_solicitudes()
{
	ls_tipo      = "SC";
	ls_codpro    = "";
	ls_tipsolcot = f.cmbtipanacot.value;
	window.open("sigesp_soc_cat_solicitud_cotizacion.php?tipo="+ls_tipo+"&cod_pro="+ls_codpro+"&tipsolcot="+ls_tipsolcot,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=650,height=400,left=50,top=50,location=no,resizable=no");   	
}
		    ...
		    if (ls_tipope!='-')
			   {
				 ...
				 ajax.open("POST","class_folder/sigesp_soc_c_aprobacion_analisis_cotizacion_ajax.php",true);
			     ...
			     ajax.send("tipanacot="+ls_tipanacot+"&numanacot="+ls_numanacot+"&fecdes="+ld_fecdes+"&fechas="+ld_fechas+"&tipope="+ls_tipope+"&proceso=BUSCAR");
		       }
	        else
		       {
		         alert("Debe seleccionar el Tipo de Operaci_n a realizar (Aprobaci_n/Reverso) !!!");
		       }
	      }
       else
          {
