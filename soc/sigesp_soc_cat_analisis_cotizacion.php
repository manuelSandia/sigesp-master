...
<script type="text/javascript"  src="js/funcion_soc.js" language="javascript"></script>
<script language="JavaScript">
function ue_aceptar(numanacot,fecanacot,obsana,numsolcot,tipsolcot,estana,estasitec,estesp,garanacot,recanacot)
{
	ls_opener=document.formulario.origen.value;
	if(ls_opener=="")
	{
		parametros="&numanacot="+numanacot+"&fecanacot="+fecanacot+"&obsana="+obsana+"&numsolcot="+numsolcot+"&txttipsolcot1="+tipsolcot+"&rdasitec="+estasitec+"&rdespecificaciones="+estesp+"&txtgarantias="+garanacot;
		...
		opener.document.formulario.txtrecanacot.value=recanacot;
