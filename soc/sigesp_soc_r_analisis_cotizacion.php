...
<title>Reporte de Análisis de Cotizaciones</title>
...
if (array_key_exists("operacion",$_POST))
   {
     ...
     $ls_fecanades = $_POST["txtfecanades"];
	 $ls_fecanahas = $_POST["txtfecanahas"];
     $ls_codprodes = $_POST["txtcodprodes"];
	 $ls_codprohas = $_POST["txtcodprohas"];
	 $ls_numanacotdes = $_POST["txtnumanacotdes"];
	 $ls_numanacothas = $_POST["txtnumanacothas"];
   }
else
   {
	 $ls_operacion = "";
     $ls_fecanades = '01/'.date("m/Y");
	 $ls_fecanahas = date("d/m/Y");
     $ls_codprodes = "";
	 $ls_codprohas = "";
	 $ls_numanacotdes = "";
	 $ls_numanacothas = "";
...
<div align="center">
  ...
  ?>
    <table width="543" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
        <td height="22" colspan="6" class="titulo-ventana">Reporte de An&aacute;lisis de Cotizaciones 
      ...
      <tr>
        <td height="22" colspan="6" style="text-align:center"><table width="434" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td colspan="4" style="text-align:left"><strong>An&aacute;lisis de Cotizaci&oacute;n </strong></td>
          </tr>
          <tr>
            <td width="63" style="text-align:right">Desde</td>
            <td width="171" style="text-align:left"><input name="txtnumanacotdes" type="text" id="txtnumanacotdes" value="<?php print $ls_numanacotdes ?>" size="20" maxlength="15"  style="text-align:center "  onblur="javascript:rellenar_cad(this.value,15,this)" onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript: ue_catalogo('sigesp_soc_cat_analisis_cotizacion.php?catalogo=txtnumanacotdes');"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar hasta..." name="buscar1" width="15" height="15" border="0"  id="buscar1" /></a></td>
            <td width="44" style="text-align:right">Hasta</td>
            <td width="154" style="text-align:left"><input name="txtnumanacothas" type="text" id="txtnumanacothas" value="<?php print $ls_numanacothas ?>" size="20" maxlength="15"  style="text-align:center"  onblur="javascript:rellenar_cad(this.value,15,this)"  onkeypress="return keyRestrict(event,'1234567890');" />
                <a href="javascript: ue_catalogo('sigesp_soc_cat_analisis_cotizacion.php?catalogo=txtnumanacothas');"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar desde..." name="buscar2" width="15" height="15" border="0" id="buscar2" /></a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="22" colspan="6" style="text-align:center"><table width="435" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td colspan="4" style="text-align:left"><strong> Proveedores Ganadores </strong></td>
          </tr>
          <tr>
      ...
      <tr>
        <td height="22" colspan="6" style="text-align:center"><table width="435" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td colspan="4" style="text-align:left"><strong>Fecha del An&aacute;lisis de Cotizaci&oacute;n </strong></td>
          </tr>
          <tr>
            <td width="63" style="text-align:right">Desde</td>
            <td width="134" style="text-align:left">
              <input name="txtfecanades" type="text" id="txtfecanades" value="<?php print $ls_fecanades ?>" size="12" maxlength="10"  style="text-align:left"  datepicker="true" onkeypress="currencyDate(this);" onkeypress="currencyDate(this);" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);"/></td>
            <td width="49" style="text-align:right">&nbsp;</td>
            <td width="187" style="text-align:left">Hasta
              <input name="txtfecanahas" type="text" id="txtfecanahas" value="<?php print $ls_fecanahas ?>" size="12" maxlength="10"  style="text-align:left"  datepicker="true" onkeypress="currencyDate(this);" onkeypress="currencyDate(this);" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);"/></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="30" colspan="6" style="text-align:center"><table width="435" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td width="148" height="24" style="text-align:right"><strong>Tipo</strong></td>
            <td width="219" style="text-align:left"><label>
              <select name="cmbtipanacot" id="cmbtipanacot">
            ...
            <!--td width="201" style="text-align:left"><strong>Estatus</strong>
              <label>
              <select name="cmbestanacot" id="cmbestanacot">
                <option value="-">---seleccione---</option>
...
{
	ls_numanacotdes = f.txtnumanacotdes.value;
	ls_numanacothas = f.txtnumanacothas.value;
	ls_codprodes    = f.txtcodprodes.value;
	ls_codprohas    = f.txtcodprohas.value;
	ls_fecanacotdes = f.txtfecanades.value;
	ls_fecanacothas = f.txtfecanahas.value;
	ls_tipanacot    = f.cmbtipanacot.value;
	
	pagina="reportes/sigesp_soc_rpp_analisis_cotizacion.php?anacotdes="+ls_numanacotdes+"&anacothas="+ls_numanacothas+"&codprodes="+ls_codprodes+
	       "&codprohas="+ls_codprohas+"&fecanades="+ls_fecanacotdes+"&fecanahas="+ls_fecanacothas+
		   "&tipanacot="+ls_tipanacot;
