...
<input name="estartgen" type="hidden" id="estartgen" value="0">
<input name="codartpri" type="hidden" id="codartpri" value="--------------------">
</form>      
</body>
...
function ue_search()
{
	...
	estartgen = f.estartgen.value;
	codartpri = f.codartpri.value;
	if(ls_tipo=="REPDES")
	{
		ls_codunieje = opener.document.formulario.txtcoduniejedes.value;
		ls_tipbie = "-";
	}
	else if (ls_tipo=="REPHAS")
	{
		ls_codunieje = opener.document.formulario.txtcoduniejehas.value;
		ls_tipbie = "-";
	}
	else
	{
	...
	ajax.send("catalogo=BIENES&codart="+codart+"&denart="+denart+"&codtipart="+codtipart+"&codestpro1="+codestpro1+
			  ...
			  "&estartgen="+estartgen+"&codartpri="+codartpri);
}
...
{   
	...
	li_loncodestpro1 = <?php print $_SESSION["la_empresa"]["loncodestpro1"]?>;
	li_loncodestpro2 = <?php print $_SESSION["la_empresa"]["loncodestpro2"]?>;
	li_loncodestpro3 = <?php print $_SESSION["la_empresa"]["loncodestpro3"]?>;
	li_loncodestpro4 = <?php print $_SESSION["la_empresa"]["loncodestpro4"]?>;
	li_loncodestpro5 = <?php print $_SESSION["la_empresa"]["loncodestpro5"]?>;
    ...
    if(li_estmodest==1){
        ls_codestpromen = ls_codestpro1.substr(25-li_loncodestpro1)+"-"+ls_codestpro2.substr(25-li_loncodestpro2)+"-"+ls_codestpro3.substr(25-li_loncodestpro3);
	}
    else{
    	ls_codestpromen = ls_codestpro1.substr(25-li_loncodestpro1)+"-"+ls_codestpro2.substr(25-li_loncodestpro2)+"-"+ls_codestpro3.substr(25-li_loncodestpro3)+"-"+ls_codestpro4.substr(25-li_loncodestpro4)+"-"+ls_codestpro5.substr(25-li_loncodestpro5);
	}

	if (li_valdispre==1 && ad_mondiscta<=0){
	     alert("No hay Disponibilidad en la Estructura "+ls_codestpromen+", Partida "+as_spg_cuenta+"  asociada al Item");
		 valido = false;
	}
