...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->line(480,760,480,700); // vertical
		$io_pdf->line(480,730,585,730); // horizontal
        $io_pdf->Rectangle(15,700,570,60);
		$io_pdf->addJpegFromFile('../../shared/imagebank/conviasa.jpg',16,720,460,37); // Agregar Logo
		if ($as_estcom=='3')
		{
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,710,14,$ls_titulo); // Agregar el título
		$io_pdf->addText(485,745,9," <b>No. </b>".$as_numordcom); // Agregar el título
		$io_pdf->addText(485,710,9,"<b>Fecha </b>".$ad_fecordcom); // Agregar el título
		$io_pdf->addText(540,770,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(546,764,6,date("h:i a")); // Agregar la Hora
		// cuadro inferior
        $io_pdf->Rectangle(15,60,570,80);  //Crea el Rectángulo
		$io_pdf->line(15,120,585,120);	//HORIZONTAL	
		$io_pdf->addText(25,130,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(35,63,7,"COMPRAS"); // Agregar el título
		$io_pdf->line(110,60,110,140);	//VERTICAL	
		$io_pdf->addText(143,132,7,"VERIFICADO Y"); // Agregar el título
		$io_pdf->addText(140,125,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(130,70,7,"DIR. PLANIFICACION"); // Agregar el título
		$io_pdf->addText(130,63,7,"Y PRESUPUESTO"); // Agregar el título
		$io_pdf->line(230,60,230,140);	//VERTICAL	
		$io_pdf->addText(260,128,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(255,63,7,"DIR. ADMINISTRACION"); // Agregar el título
		$io_pdf->line(350,60,350,140);	//VERTICAL		
		$io_pdf->addText(375,128,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(385,63,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->line(470,60,470,140);	//VERTICAL		
		$io_pdf->addText(500,128,7,"PROVEEDOR"); // Agregar el título
