...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
        ...
        $io_pdf->Rectangle(315,700,270,60);
		//$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],25,705,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo_emica.jpg',15,725,290,45); // Agregar Logo
		if ($as_estcom=='3')
		{
		...
		$tm=396-($li_tm/2);
		$io_pdf->addText($tm,725,14,$ls_titulo); // Agregar el título
		$io_pdf->addText(17,718,7,"<b>CARRERA 01 ENTRE CALLE 6 Y 7 URB. NUEVA SEGOVIA QTA. MORERE.</b>"); // Agregar el título
		$io_pdf->addText(17,711,7,"<b>TELF: (051) 540433</b>"); // Agregar el título
		$io_pdf->addText(17.5,704,7,"<b>FAX: (051) 552522</b>"); // Agregar el título
		$io_pdf->addText(17.5,697,7,"<b>RIF: G-20009017-0</b>"); // Agregar el título
		...
		$io_pdf->addText(35,122,7,"COORD. COMPRAS"); // Agregar el título
		$io_pdf->addText(56,63,7,"FIRMA"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(150,122,7,"COORD. PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(173,63,7,"FIRMA"); // Agregar el título
		$io_pdf->line(245,60,245,130);	//VERTICAL		
		$io_pdf->addText(247,122,7,"GERENCIA DE ADMINISTRACIÓN"); // Agregar el título
		$io_pdf->addText(286,63,7,"FIRMA"); // Agregar el título
		$io_pdf->line(360,60,360,130);	//VERTICAL		
		$io_pdf->addText(395,122,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(405,63,7,"FIRMA"); // Agregar el título
		$io_pdf->line(475,60,475,130);	//VERTICAL		
		$io_pdf->addText(505,122,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(520,63,7,"FIRMA"); // Agregar el título
