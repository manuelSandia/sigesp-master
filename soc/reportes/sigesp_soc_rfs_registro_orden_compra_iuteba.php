...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->line(429,60,429,130);
		$io_pdf->line(500,60,500,130);
				
    	$io_pdf->addText(16,122,7,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(16,62,7,"JEFE DE COMPRAS"); // Agregar el título
		$io_pdf->addText(91,62,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(171,62,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(241,62,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(331,68,7,"SUB-DIRECCION"); // Agregar el título
		$io_pdf->addText(331,62,7,"ADMINISTRATIVA"); // Agregar el título
		$io_pdf->addText(430,62,7,"DIRECCION"); // Agregar el título
		$io_pdf->addText(501,68,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(501,62,7,"SELLO Y FECHA"); // Agregar el título
