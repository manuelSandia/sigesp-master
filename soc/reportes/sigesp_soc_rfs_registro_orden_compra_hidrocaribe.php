...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->addText(35,122,7,"ELABORADO"); // Agregar el título
		$io_pdf->addText(35,71,7,"ANALISTA DE"); // Agregar el título
		$io_pdf->addText(41,63,7,"COMPRAS"); // Agregar el título
		$io_pdf->line(100,60,100,130);	//VERTICAL	
		$io_pdf->addText(130,122,7,"REVISADO"); // Agregar el título
		$io_pdf->addText(120,71,7,"GERENTE AREA"); // Agregar el título
		$io_pdf->addText(132,63,7,"PROCURA"); // Agregar el título
		$io_pdf->line(195,60,195,130);	//VERTICAL		
		$io_pdf->addText(232,122,7,"REVISADO Y CONFORMADO"); // Agregar el título
		$io_pdf->addText(225,71,7,"COORD. PRESUP. Y COSTOS /"); // Agregar el título
		$io_pdf->addText(225,63,7,"ANALISTA PRESUP. Y COSTOS"); // Agregar el título
		$io_pdf->line(360,60,360,130);	//VERTICAL
		$io_pdf->addText(402,122,7,"CONFORME"); // Agregar el título
		$io_pdf->addText(380,71,7,"GERENTE CORP. ADMON."); // Agregar el título
		$io_pdf->addText(390,63,7,"Y FINANZAS"); // Agregar el título
		$io_pdf->line(490,60,490,130);	//VERTICAL		
		$io_pdf->addText(515,122,7,"AUTORIZADO"); // Agregar el título
		$io_pdf->addText(513,63,7,"PRESIDENTE"); // Agregar el título
        ...
        $io_pdf->Rectangle(15,60,570,70); 
		$io_pdf->line(15,117,585,117);	//HORIZONTAL	
		$io_pdf->addText(45,122,7,"ELABORADO"); // Agregar el título
		$io_pdf->addText(49,71,7,"ANALISTA DE"); // Agregar el título
		$io_pdf->addText(55,63,7,"COMPRAS"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(170,122,7,"REVISADO"); // Agregar el título
		$io_pdf->addText(169,71,7,"GERENTE AREA"); // Agregar el título
		$io_pdf->addText(179,63,7,"PROCURA"); // Agregar el título
		$io_pdf->line(260,60,260,130);	//VERTICAL		
		$io_pdf->addText(302,122,7,"CONFORMADO"); // Agregar el título
		$io_pdf->addText(280,71,7,"COORD. PRESUP. Y COSTOS /"); // Agregar el título
		$io_pdf->addText(280,63,7,"ANALISTA PRESUP. Y COSTOS"); // Agregar el título
		$io_pdf->line(410,60,410,130);	//VERTICAL		
		$io_pdf->addText(470,122,7,"AUTORIZADO"); // Agregar el título
		$io_pdf->addText(455,71,7,"GERENTE CORP. ADMON."); // Agregar el título
		$io_pdf->addText(473,63,7,"Y FINANZAS"); // Agregar el título
		$io_pdf->line(15,79,585,79); //HORIZONTAL		
        }
		...
		$la_data[1]=array('columna1'=>'<b>Fuente Financiamiento</b>   '.$ls_fuefin,'columna2'=>'<b> Plazo de Entrega</b>    '.$as_diaplacom.'<b> días.</b>');
		$la_columnas=array('columna1'=>'','columna2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>115), // Justificación y ancho de la columna
						 			   ...
						 			   'denunimed'=>array('justification'=>'center','width'=>45), // Justificación y ancho de la columna
				 ...
				 if ($li_totrows>0)
				 {
				    ...
				    while($row=$io_sql->fetch_row($rs_datos))
					{
						...
						$la_data[$li_i]=array('codigo'=>$ls_codartser,'denominacion'=>$ls_denartser,'cantidad'=>$li_cantartser,
											  ...
											  'cargo'=>$ld_carartser,'montot'=>$ld_totartser,'denunimed'=>$ls_denunimed);
					}
