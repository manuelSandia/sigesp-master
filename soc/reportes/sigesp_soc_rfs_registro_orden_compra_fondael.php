...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$la_data[2]=array('columna1'=>'<b>Código</b>       '.$as_codigo,'columna2'=>'');
		$la_data[3]=array('columna1'=>'<b>Rif</b>              '.$as_rifpro,'columna2'=>'');
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-10);
		$la_datatitulo[1]=array('columna1'=>'<b> Detalles '.$ls_titulo_grid.'</b>');
		$la_columnas=array('columna1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$io_pdf->addText(30,63,7,"SECCION DE COMPRAS"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(220,122,7,"VERIFICADO"); // Agregar el título
		$io_pdf->addText(145,63,7,"UNIDAD PRESUPUESTO"); // Agregar el título
		$io_pdf->line(240,60,240,117);	//VERTICAL		
		$io_pdf->addText(265,63,7,"ADMINISTRACION"); // Agregar el título		
		$io_pdf->line(350,60,350,130);	//VERTICAL		
		$io_pdf->addText(375,122,7,"AUTORIZADO"); // Agregar el título
		$io_pdf->addText(375,63,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->line(450,60,450,130);	//VERTICAL		
		$io_pdf->addText(500,122,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(475,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
