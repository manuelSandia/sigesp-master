<?PHP
	...
	function uf_print_pie_pagina(&$io_pdf)
	{
		...
		$la_data[0]["1"]="<b>Elaborado por Coordinación de Adquisiciones</b>";
		$la_data[1]["1"]="";
		$la_data[0]["2"]="<b>Aprobado por Gerencia de Administración</b>";
		$la_data[1]["2"]="";
		$la_data[0]["3"]="<b>Aprobado por Gerencia General</b>";
		$la_data[1]["3"]="\n";
		$la_anchos_col = array(86.5,86.5,86.5);
