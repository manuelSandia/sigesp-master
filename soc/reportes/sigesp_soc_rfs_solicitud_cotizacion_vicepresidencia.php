<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsolcot,$as_fecsolcot,$as_dentipsolcot,$as_obssolcot,&$io_pdf)
	{
		...
		$io_pdf->addText(495,740,10,$as_numsolcot); // Agregar Numero de la solicitud
		$io_pdf->addText(460,710,10,"<b>  Fecha:</b>"); // Agregar texto
		$io_pdf->addText(505,710,10,$as_fecsolcot); // Agregar la Fecha
		...
		$io_pdf->addText(20,120,7,"OBSERVACIONES:"); // Agregar el título
		$io_pdf->addText(20,135,7,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]);
		$io_pdf->ezSetY(695);
