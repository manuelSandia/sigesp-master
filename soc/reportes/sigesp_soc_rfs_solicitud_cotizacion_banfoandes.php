<?php
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
        ...
        $la_config=array('showHeadings'=>0, // Mostrar encabezados
                         ...
                         'width'=>548, // Ancho de la tabla                         
                         'maxWidth'=>548); // Ancho Máximo de la tabla
        $io_pdf->ezTable($la_data1,$la_columna,'<b><i>Sírvase ofertar el (los) siguiente(s) artículo(s):</i></b>',$la_config);    
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>125),      // Justificación y ancho de la columna
                                       ...
                                       'denunimed'=>array('justification'=>'left','width'=>65),
        ...
        $ls_nota = "<b> Nota:<b>
- Presentar la inscripción vigente en el Registro Nacional de Contratistas (RNC), cuando la oferta supere las 4000 Unidades Tributarias (U.T.).
- Ajustarse a las características técnicas solicitadas.
- Especificar la vigencia de la Oferta, Garantía IVA y Tiempo de Entrega.
- Presentar la Oferta en sobre sellado con el número de requisición asignado.
- En caso que la Oferta supera las 1100 Unidades Tributarias (U.T.), debe presentar copia del Número de Identificación Laboral (NIL), caso contrario, presentar la Solvencia Laboral original.
- En caso que la Oferta a presentar supere las 700 U.T. el proveedor estará sujeto a una retención del 2% sobre el monto total adjudicado sin IVA, por concepto de Compromiso de Responsabilidad Social.";
