<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numcot,$as_feccot,$as_dentipcot,$as_obscot,$as_numsolcot,&$io_pdf)
	{
		...
		$io_pdf->addText(505,680,9,$as_numcot); // Agregar Numero de la solicitud
		$io_pdf->addText(460,665,9,"<b>  Fecha:</b>"); // Agregar texto
		$io_pdf->addText(505,665,9,$as_feccot); // Agregar la Fecha
		...
		$la_data=array(array('name'=>'                   <b>TIPO:  </b>'.$as_dentipcot),
	          ...
	          if ($row=$io_sql->fetch_row($rs_data))
		         {
				   ...
				   $io_pdf->ezStartPageNumbers(550,20,8,'','',1); // Insertar el número de página
				   $li_count = 0; 
