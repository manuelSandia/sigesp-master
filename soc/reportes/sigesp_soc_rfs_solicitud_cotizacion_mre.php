<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsolcot,$as_fecsolcot,$as_dentipsolcot,$as_obssolcot,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->rectangle(41,705,550,53);
		$io_pdf->line(450,705,450,758);
		$io_pdf->line(450,725,590,725);
		$io_pdf->addJpegFromFile('../../shared/imagebank/headmre.jpg',42,732,240,24); // Agregar Logo
		$li_tm=$io_pdf->getTextWidth(10,$as_titulo);		
		$io_pdf->addText(200,707,14,"<b>".$as_titulo."</b>"); // Agregar el título
