<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsolcot,$as_fecsolcot,$as_dentipsolcot,$as_obssolcot,&$io_pdf)
	{
		...
		// cuadro inferior
        $io_pdf->Rectangle(50,100,150,70);
		$io_pdf->line(50,113,200,113);		
		$io_pdf->line(50,123,200,123);		
		$io_pdf->line(50,157,200,157);		
		$io_pdf->addText(55,162,7,"Elaborado Por:"); // Agregar el título
		$io_pdf->addText(55,115,7,"Jose Manuel Balza"); // Agregar el título
		$io_pdf->addText(55,105,7,"Especialista En Compra"); // Agregar el título
		$io_pdf->addText(55,93,7,"Direccion: j.balza@fonpyme.gob.ve"); // Agregar el título
		$io_pdf->addText(65,85,7,"           compras@fonpyme.gob.ve"); // Agregar el título
