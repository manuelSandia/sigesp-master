<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numcot,$as_feccot,$as_dentipcot,$as_obscot,$as_numsolcot,$as_nomusu,$as_cedusu,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->saveState();
		$io_pdf->rectangle(160,705,430,60);
		$io_pdf->line(450,705,450,765);
		$io_pdf->line(450,725,590,725);
		$io_pdf->line(450,745,590,745);
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],30,705,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$li_tm=$io_pdf->getTextWidth(10,$as_titulo);		
		$io_pdf->addText(200,730,14,"<b>".$as_titulo."</b>"); // Agregar el título
		$io_pdf->addText(460,750,10,"<b>   No.:</b>");      // Agregar texto
		$io_pdf->addText(500,750,10,$as_numcot); // Agregar Numero de la solicitud
		$io_pdf->addText(450,730,10,"<b>  Fecha:</b>"); // Agregar texto
		$io_pdf->addText(500,730,10,$as_feccot); // Agregar la Fecha
		$io_pdf->addText(445,710,10,"<b>  Solicitud:</b>"); // Agregar texto
		$io_pdf->addText(500,710,10,$as_numsolcot); // Agregar la Fecha
...
//		$io_pdf->addText(560,760,7,date("h:i a")); // Agregar la hora
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_datos_proveedor($as_codpro,$as_nompro,$as_dirpro,$as_telpro,$as_email,$as_rifpro,$as_faxpro,$as_obscot,$as_tipo,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->saveState();
		$la_data1=array(array('name'=>' Tipo: '.$as_tipo));				
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('name'=>array('justification'=>'left','width'=>580))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
	
		$la_data[1]=array('name'=>'<b>Nombre o Razón Social:  </b>'.$as_nompro,'name1'=>'<b>R.I.F.:  <b>'.$as_rifpro);		
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>315, // Orientación de la tabla
						 'cols'=>array('name'=>array('justification'=>'left','width'=>470), // Justificación y ancho de la columna
						 			   'name1'=>array('justification'=>'left','width'=>110))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		...
		$la_data[1]=array('name'=>'<b>Teléfono:  </b>'.$as_telpro,'name1'=>'<b>Correo Electrónico:  <b>'.$as_email,'name2'=>'<b>Fax:  <b>'.$as_faxpro);		
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>315, // Orientación de la tabla
						 'cols'=>array('name'=>array('justification'=>'left','width'=>230), // Justificación y ancho de la columna
						 			   'name1'=>array('justification'=>'left','width'=>240), // Justificación y ancho de la columna
						 			   'name2'=>array('justification'=>'left','width'=>110))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
	
		$la_data[1]=array('name'=>'<b>Concepto:  </b>'.$as_obscot);		
		$la_columna=array('name'=>'');		
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_data1[1]=array('numero'=>'<b>No.</b>',
						  'tipo'=>'<b>Renglon</b>',
						  'codite'=>'<b>Código</b>',
						  'denite'=>'<b>Denominación</b>',
						  'denunimed'=>'<b>Unidad de Medida</b>',
  						  'canite'=>'<b>Cant.</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numero'=>array('justification'=>'center','width'=>30),      // Justificación y ancho de la columna
						 			   'tipo'=>array('justification'=>'center','width'=>90),      // Justificación y ancho de la columna
						 			   'codite'=>array('justification'=>'center','width'=>95),      // Justificación y ancho de la columna
						 			   'denite'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
						 			   'denunimed'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
						 			   'canite'=>array('justification'=>'center','width'=>30),
									   'preite'=>array('justification'=>'center','width'=>55),      // Justificación y ancho de la columna
						 			   'subite'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
						 			   'totite'=>array('justification'=>'center','width'=>55))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data1,$la_columna,'<b>DETALLE DE LOS MATERIALES, SUMINISTROS O SERVICIOS COTIZADOS</b>',$la_config);
		unset($la_data1);
		unset($la_columna);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>315, // Orientación de la tabla
						 'cols'=>array('numero'=>array('justification'=>'center','width'=>30),      // Justificación y ancho de la columna
						 			   'tipo'=>array('justification'=>'left','width'=>90),      // Justificación y ancho de la columna
						 			   'codite'=>array('justification'=>'center','width'=>95),      // Justificación y ancho de la columna
						 			   'denite'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la columna
						 			   'denunimed'=>array('justification'=>'left','width'=>50), // Justificación y ancho de la columna
						 			   'canite'=>array('justification'=>'right','width'=>30),
									   'preite'=>array('justification'=>'right','width'=>55),      // Justificación y ancho de la columna
						 			   'subite'=>array('justification'=>'right','width'=>55), // Justificación y ancho de la columna
						 			   'totite'=>array('justification'=>'right','width'=>55))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_totales($ad_monsubcot,$ad_totcrecot,$ad_montotcot,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla						 
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>456), // Justificación y ancho de la columna
	          ...
	          if ($row=$io_sql->fetch_row($rs_data))
		         {
				   ...
				   $io_pdf->ezSetCmMargins(5,4,3,3); // Configuración de los margenes en centímetros
						     ...
						     while ($row=$io_sql->fetch_row($rs_datos))
								   {
									 ...
									 $ld_totite = number_format($row["totite"],2,',','.');
								 	 ...
								 	 $la_datos[$li_i] = array('numero'=>$li_i,'tipo'=>$ls_tipoitem,'codite'=>$ls_codite,'denite'=>$ls_denite,'denunimed'=>$ls_denunimed,'canite'=>$ld_canite,'preite'=>$ld_preite,'subite'=>$ld_subite,'totite'=>$ld_totite);
								   }
							 uf_print_encabezado_pagina($ls_titulo,$ls_numcot,$ls_feccot,$ls_tipo,$ls_obscot,$ls_numsolcot,$ls_nomusu,$ls_cedusu,$io_pdf);
							 uf_print_datos_proveedor($ls_codpro,$ls_nompro,$ls_dirpro,$ls_telpro,$ls_mailpro,$ls_rifpro,$ls_faxpro,$ls_obscot,$ls_tipo,$io_pdf);
