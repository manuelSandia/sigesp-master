...
/*	if(!array_key_exists("la_logusr",$_SESSION))
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$rs_data_ue,$as_estcom,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//array('codigoue'=>$row["coduniadm"],'denominacionue'=>$row["denuniadm"])
	
		
		$la_columnas=array('codigoue'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 'showLines'=>1, // Mostrar Líneas
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('codigoue'=>array('justification'=>'left','width'=>570))); // Justificación y ancho de la columna
		$io_pdf->ezTable($rs_data_ue,$la_columnas,'',$la_config);
		unset($rs_data_ue);
		unset($la_columnas);
		unset($la_config);

		$ls_uniadm=$as_coduniadm."  -  ".$as_denuniadm;
		$la_data[1]=array('columna1'=>'<b>Forma de Pago</b>    '.$ls_forpagcom);
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ld_fecordcom=$io_funciones->uf_convertirfecmostrar($ld_fecordcom);
		 		if ($ls_coduniadm=="----------")
		 		{
		 			$rs_data_ue= $io_report->uf_select_ue($ls_numordcom,$ls_estcondat,&$lb_valido);	
		 		}
		 		else
		 		{		 			
		 			$rs_data_ue[1]=array('codigoue'=>'<b>Unidad Ejecutora</b>');
		 			$rs_data_ue[2]=array('codigoue'=>$ls_coduniadm.'    '.$ls_denuniadm);
		 		}
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$rs_data_ue,$ls_estcom,&$io_pdf);
