...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$as_telfpro,$as_lugcom,$as_fechent,$as_estlugcom,$as_obscom,$as_numcoti,$ls_analista,$as_estcom,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($as_estcom=='3')
		{
			$io_pdf->addText(483,772,9,"<b>ANULADO</b>"); // Agregar la Fecha
		}
	    ...
	    $io_pdf->addText(390,640,9,$ls_analista);
...
/*		unset($la_data);
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)
		{
			...
			$io_pdf->ezSetCmMargins(8.8,9,3,3); // Configuración de los margenes en centímetros
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_analista=strtoupper($row["nomusu"].' '.$row["apeusu"]);
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_estlugcom,$ls_obscom,$ls_numcoti,$ls_analista,$ls_estcom,&$io_pdf);
			   ...
			   if ($lb_valido)
			   {
				 ...
				 if ($li_totrows>0)
				 {
				    ...
				    while($row=$io_sql->fetch_row($rs_datos))
					{
						...
						$articulo= intval($ls_codartser).' '.$ls_denartser;
