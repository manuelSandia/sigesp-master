...
class sigesp_soc_class_reportbsf
{
	...
	function sigesp_soc_class_reportbsf()
	{
		...
		$this->ls_codusu    = $_SESSION["la_logusr"]["codemp"];
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     { 
	   $lb_valido = false;
	   $this->io_mensajes->message("CLASE->sigesp_soc_class_reportbsf.php->M_TODO->uf_load_cabecera_formato_solicitud_cotizacion.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	 }			  
  return $rs_data;
}//function uf_load_cabecera_formato_solicitud_cotizacion
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_mensajes->message("CLASE->sigesp_soc_class_reportbsf.php->M_TODO->uf_load_dt_solicitud_cotizacion.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	 }			  
  return $rs_data;
}//function uf_load_dt_solicitud_cotizacion.
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_mensajes->message("CLASE->sigesp_soc_class_reportbsf.php->M_TODO->uf_load_dt_registro_cotizacion.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	 }			  
  return $rs_data;
}//function uf_load_dt_registro_cotizacion.
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_mensajes->message("CLASE->sigesp_soc_class_reportbsf.php->M_TODO->uf_load_solicitudes_cotizacion.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	 }
  return $rs_data;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_mensajes->message("CLASE->sigesp_soc_class_reportbsf.php->M_TODO->uf_load_registro_cotizaciones.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	 }
  return $rs_data;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_mensajes->message("CLASE->sigesp_soc_class_reportbsf.php->M_TODO->uf_load_orden_servicio.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	 }
  return $rs_data;
}
//---------------------------------------------------------------------------------------------------------------------------------------
