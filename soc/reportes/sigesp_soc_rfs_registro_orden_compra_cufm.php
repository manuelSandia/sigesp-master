...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_lugentdir,$as_estcom,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $io_pdf->Rectangle(15,60,570,240); 
		$io_pdf->addText(20,290,7,"COORDINACION DE ADQUISICION Y SUMINISTROS"); // Agregar el título
		$io_pdf->addText(290,290,7,"EJECUCION Y CONTROL PRESUPUESTARIO"); // Agregar el título
		$io_pdf->line(15,270,280,270);	//HORIZONTAL	
		$io_pdf->addText(20,260,7,"DIVISION DE ADMINISTRACION"); // Agregar el título
		$io_pdf->line(15,240,280,240);	//HORIZONTAL
		$io_pdf->addText(20,230,7,"COORDINACION DE PRESUPUESTO"); // Agregar el título
		$io_pdf->line(15,210,585,210);	//HORIZONTAL
		$io_pdf->addText(20,200,7,"SUB-DIRECTOR ADMINISTRATIVO"); // Agregar el título
		$io_pdf->addText(290,200,7,"REFERENCIA"); // Agregar el título				
		$io_pdf->line(15,180,280,180);	//HORIZONTAL
		$io_pdf->addText(20,170,7,"DIRECTOR"); // Agregar el título		
		$io_pdf->line(15,150,585,150);	//HORIZONTAL
		$io_pdf->addText(20,140,7,"LUGAR DE ENTREGA"); // Agregar el título	
		$io_pdf->addText(20,130,7,$ls_lugentdir); // Agregar el título			
		$io_pdf->line(15,120,585,120);	//HORIZONTAL
		$io_pdf->line(280,300,280,150);	//VERTICAL
		$io_pdf->addText(20,110,7,"FAVOR ANEXAR ORIGINAL AL ENTREGAR LAS FACTURAS"); // Agregar el título
		$io_pdf->addText(20,95,4,"ORIGINAL: PROVEEDOR"); // Agregar el título
		$io_pdf->addText(20,90,4,"COPIA: ADQUISICIONES"); // Agregar el título						
		$io_pdf->addText(20,85,4,"COPIA: PRESUPUESTO"); // Agregar el título												
		$io_pdf->addText(20,80,4,"COPIA: EJECUCION Y CONTROL"); // Agregar el título												
		$io_pdf->addText(20,75,4,"COPIA: ALMACEN"); // Agregar el título												
		$io_pdf->addText(20,70,4,"COPIA: BIENES NACIONALES"); // Agregar el título												
		$io_pdf->line(280,120,280,60);	//VERTICAL
		$io_pdf->addText(290,110,7,"RECIBIDO POR"); // Agregar el título
		$io_pdf->addText(290,80,7,"FECHA"); // Agregar el título						
		//$io_pdf->addText(20,140,7,"LUGAR DE ENTREGA"); // Agregar el título			
		/*$io_pdf->addText(20,140,7,"UNIDAD DE COMPRAS"); // Agregar el título
		$io_pdf->addText(105,193,7,"REGISTRADO POR"); // Agregar el título
		$io_pdf->addText(102,140,7,"UNIDAD DE CONTROL"); // Agregar el título
		$io_pdf->addText(102,130,7,"PRESUPUESTARIO"); // Agregar el título
		$io_pdf->addText(190,193,7,"AUTORIZACION"); // Agregar el título
		$io_pdf->addText(190,140,7,"ADMINISTRACION"); // Agregar el título
		//$io_pdf->line(180,125,180,205);	//VERTICAL		
		$io_pdf->addText(270,193,7,"AUTORIZACION DE COMPRA"); // Agregar el título
		$io_pdf->addText(270,140,7,"SUBDIR. ADMINISTRATIVA"); // Agregar el título
		//$io_pdf->line(260,125,260,205);	//VERTICAL		
		$io_pdf->addText(390,193,7,"VISTO BUENO"); // Agregar el título
		$io_pdf->addText(390,140,7,"CONTRALORIA"); // Agregar el título
		//$io_pdf->line(370,125,370,205);	//VERTICAL
		//$io_pdf->line(470,125,470,205);	//VERTICAL		
		$io_pdf->addText(500,193,7,"VISTO BUENO"); // Agregar el título
		$io_pdf->addText(500,140,7,"DIRECCION"); // Agregar el título
		//$io_pdf->line(15,149,585,149); //HORIZONTAL	*/	
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			$io_pdf->ezSetCmMargins(8.5,12,3,3); // Configuración de los margenes en centímetros
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_lugentdir,$ls_estcom,&$io_pdf);
