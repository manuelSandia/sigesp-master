...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$io_pdf->addText(175,122,7,"VERIFICADO"); // Agregar el título
		$io_pdf->addText(155,63,7,"UNIDAD PRESUPUESTO"); // Agregar el título
		$io_pdf->line(260,60,260,130);	//VERTICAL		
		$io_pdf->addText(315,122,7,"AUTORIZADA"); // Agregar el título
		$io_pdf->addText(300,63,7,"GCIA. ADMON Y RRHH"); // Agregar el título
		$io_pdf->line(400,60,400,130);	//VERTICAL		
