...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->addText(45,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(50,79,7,"ING. RAFAEL CAMACHO"); // Agregar el título
		$io_pdf->addText(30,63,7,"COORDINACIÓN DE COMPRAS"); // Agregar el título
		$io_pdf->line(150,60,150,130);	//VERTICAL	
		$io_pdf->addText(190,79,7,"SOC. NESTOR GONZALES"); // Agregar el título
		$io_pdf->addText(155,63,7,"GERENCIA DE PROCURA E INSPECCIONES"); // Agregar el título
		$io_pdf->line(310,60,310,118);	//VERTICAL		
		$io_pdf->addText(280,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(312,83,7,"REQUIERE AUTORIZACIÓN POR MONTO"); // Agregar el título
		$io_pdf->addText(350,75,7,"A PARTIR DE 1001 UT"); // Agregar el título
		$io_pdf->addText(355,63,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->line(450,60,450,130);	//VERTICAL		
		$io_pdf->addText(495,122,7,"RECIBIDO POR"); // Agregar el título
		$io_pdf->addText(495,63,7,"PROVEEDOR"); // Agregar el título
