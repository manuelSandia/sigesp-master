<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numcot,$as_feccot,$as_dentipcot,$as_obscot,$as_numsolcot,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],55	,715,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$io_pdf->addText(20,770,8,"Consejo Legislativo del Estado Lara"); // Agregar el título
		$io_pdf->addText(50,705,8,"Unidad de Compras"); // Agregar el título
