...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_denmodcla,$as_estcom,$as_numsnc,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// cuadro inferior
        $io_pdf->Rectangle(16,60,570,70); 
		$io_pdf->line(15,105,585,105);	//HORIZONTAL	
		$io_pdf->addText(30,115,7,"ELABORADO"); // Agregar el título
//		$io_pdf->line(15,73,585,73); //HORIZONTAL		

		$io_pdf->line(95,60,95,130);	//VERTICAL
		$io_pdf->addText(122,115,7,"REVISADO"); // Agregar el título

		$io_pdf->line(190,60,190,130);	//VERTICAL
		$io_pdf->addText(193,122,7,"COORDINACION DE PLANIFICACION,"); // Agregar el título
		$io_pdf->addText(195,115,7,"PRESUPUESTO, ORGANIZACION Y"); // Agregar el título
		$io_pdf->addText(235,108,7,"SISTEMAS"); // Agregar el título

		$io_pdf->line(320,60,320,130);	//VERTICAL		
		$io_pdf->addText(326,120,7,"DIRECCION DE GESTION"); // Agregar el título
		$io_pdf->addText(336,112,7,"ADMINISTRATIVA"); // Agregar el título

		$io_pdf->line(415,60,415,130);	//VERTICAL	
		$io_pdf->addText(421,115,7,"DIRECCION GENERAL"); // Agregar el título

		$io_pdf->line(500,60,500,130);	//VERTICAL	
		$io_pdf->addText(520,115,7,"PROVEEDOR"); // Agregar el título


/*        $io_pdf->Rectangle(15,178,570,20); 
		$io_pdf->line(15,188,585,188);	//HORIZONTAL	
		$li_tm=$io_pdf->getTextWidth(7,"TODA NOTA DE ENTREGA DEBE INDICAR EL NUMERO DE ORDEN DE COMPRA ASOCIADA AL DESPACHO");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,190,7,"TODA NOTA DE ENTREGA DEBE INDICAR EL NUMERO DE ORDEN DE COMPRA ASOCIADA AL DESPACHO"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(7,"GARANTIAS");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,180,7,"GARANTIAS"); // Agregar el título


        $io_pdf->Rectangle(15,130,570,48); 
		$io_pdf->line(157,130,157,178);	//VERTICAL
		$io_pdf->line(300,130,300,178);	//VERTICAL	
		$io_pdf->line(442,130,442,178);	//VERTICAL	
		$io_pdf->line(15,168,585,168);	//HORIZONTAL	
		$io_pdf->addText(35,170,7,"FIANZA FIEL CUMPLIMIENTO"); // Agregar el título
		$io_pdf->addText(185,170,7,"FIANZA DE ANTICIPO"); // Agregar el título
		$io_pdf->addText(335,170,7,"CLAUSULA PENAL"); // Agregar el título
		$io_pdf->addText(473,170,7,"CLAUSULA ESPECIAL"); // Agregar el título


		//Clausulas
		$io_pdf->addText(18,157,5,"Al  aprobarse  esta  orden se  exigirá  al  Beneficiario  Fianza"); // Agregar el título
		$io_pdf->addText(18,151,5,"de  Fiel  Cumplimiento   o  cheque  de   gerencia  equivalente  "); // Agregar el título
		$io_pdf->addText(18,145,5,"al 15 % de la orden a nombre SAIME, otorgada por un Banco  "); // Agregar el título
		$io_pdf->addText(18,139,5,"o  Compañía  de Seguros,  notariada y vigente  hasta  la total"); // Agregar el título
		$io_pdf->addText(18,133,5,"recepción de la mercancía."); // Agregar el título
		
		$io_pdf->addText(160,157,5,"Al  aprobarse  esta  orden  se exigirá al  Beneficiario Anticipo"); // Agregar el título
		$io_pdf->addText(160,151,5,"equivalente  al 50%  del monto  de la  compra y/o  servicio  a "); // Agregar el título
		$io_pdf->addText(160,145,5,"nombre  SAIME,  otorgada   por  un  Banco o  Compañía  de  "); // Agregar el título
		$io_pdf->addText(160,139,5,"Seguros,  notariada  y  vigente   hasta  la  total  recepción de  "); // Agregar el título
		$io_pdf->addText(160,133,5,"la mercancía."); // Agregar el título
		
		$io_pdf->addText(307,157,5,"Queda  establecida  la clausula  penal, según  la cual el"); // Agregar el título
		$io_pdf->addText(307,151,5,"proveedor pagará al SAIME el 1 % sobre el monto de la "); // Agregar el título
		$io_pdf->addText(307,145,5,"mercancía  respectiva,  por  cada  día  hábil  de  retardo"); // Agregar el título
		$io_pdf->addText(307,139,5,"en la entrega.  "); // Agregar el título
		
		$io_pdf->addText(444,161,5,"El   SAIME  se   reserva  el   derecho  de   dar  por  terminado"); // Agregar el título
		$io_pdf->addText(444,155,5,"unilateralmente  la  presente  Orden, cuando  asi lo  considere"); // Agregar el título
		$io_pdf->addText(444,149,5,"conveniente  a  sus  intereses,  aun  sin  haber incumplido por "); // Agregar el título
		$io_pdf->addText(444,143,5,"parte   de  La  Empresa.   Sin  que  ello   de  lugar  al  pago de "); // Agregar el título
		$io_pdf->addText(444,137,5,"indemnización alguna. La desicion de la resolucion debera ser  "); // Agregar el título
		$io_pdf->addText(444,131,5,"notificada por escrito a la empresa."); // Agregar el título
*/
		//      
		//Clausulas
		$io_pdf->ezSetY(695);
		$la_data[1]=array('columna1'=>'<b>Proveedor</b>  '.$as_nombre,
		                 'columna2'=>'<b>Rif</b> '.$as_rifpro,
		                 'columna3'=>'<b>No. SNC</b> '.$as_numsnc);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>280), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>170), // Justificación y ancho de la columna
		...
		$la_data[1]=array('columna1'=>'<b>Direccion</b>  '.$as_dirpro,
		                 'columna2'=>'<b>Correo Electronico</b> '.$as_rifpro,
		                 'columna3'=>'<b>Fax</b> '.$as_rifpro);
		$la_columna=array('columna1'=>'','columna2'=>'','columna3'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>330), // Justificación y ancho de la columna
		...
		$la_data[1]=array('columna1'=>'<b>Plazo de Entrega</b>   '.$as_diaplacom,'columna2'=>'<b>Período de Entrega    Desde:</b> '.$ld_perentdesde.'    <b>Hasta:</b> '.$ld_perenthasta.'');
		$la_columnas=array('columna1'=>'','columna2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   ...
						 			   'cosuni'=>array('justification'=>'right','width'=>55), // Justificación y ancho de la columna
						 			   'baseimp'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'cargo'=>array('justification'=>'right','width'=>55), // Justificación y ancho de la columna
	...
	function uf_print_detalle_clausulas($la_data,&$io_pdf)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetDy(-30);
		$la_dataclausulas[1]=array('dencla'=>"TODA NOTA DE ENTREGA DEBE INDICAR EL NUMERO DE ORDEN DE COMPRA ASOCIADA AL DESPACHO");
		$la_dataclausulas[2]=array('dencla'=>"GARANTIAS");
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>540, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('dencla'=>array('justification'=>'center','width'=>570))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>540, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('dencla'=>array('justification'=>'left','width'=>570))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_datatit);
		unset($la_columnas);
		unset($la_config);
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			$io_pdf->ezSetCmMargins(8,4.8,3,3); // Configuración de los margenes en centímetros
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_denmodcla,$ls_estcom,
										   $ls_numsnc,&$io_pdf);
			   ...
			   if ($lb_valido)
			   {
				 ...
				 if ($li_totrows>0)
				 {
				    ...
				    while($row=$io_sql->fetch_row($rs_datos))
					{
						...
						$la_data[$li_i]=array('no'=>$li_i,'codigo'=>$ls_codartser,'denominacion'=>$ls_denartser,'cantidad'=>$li_cantartser,
	   ...
	   if($lb_valido)
	   {
			$li_totrowsm = $io_sql->num_rows($rs_clausulas);
			if ($li_totrowsm>0)
			{
				$li_j = 0;
				while($row=$io_sql->fetch_row($rs_clausulas))
				{
					$li_j=$li_j+1;
					$ls_dencla=rtrim($row["dencla"]);
					$la_dataclausulas[$li_j]=array('dencla'=>$ls_dencla);
				}
