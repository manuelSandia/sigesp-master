...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->addText(167,122,7,"REVISADO"); // Agregar el título
		...
		$io_pdf->addText(260,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(360,60,360,130);	//VERTICAL		
		$io_pdf->addText(383,122,7,"ADMINISTRACION"); // Agregar el título
