	...
	{	 
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
									   ...
									   'estcondat'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
						 			   'fecha'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
						 			   'estatus'=>array('justification'=>'center','width'=>70),
	...
	else // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			if($ls_tiporeporte=="SELECTIVO")
			{
				...
				for($li_j=0;$li_j<$li_row;$li_j++)
				{
					$ls_ordcom=$lr_datos[$li_j];
					...
					{     
					  ...
					  $ld_monto   = $rs_data->fields["montot"];
					  ...
					  $unidades = $io_report->uf_unidades_administrativas($ls_numord); 
					 ...
					 $la_data[$li_i]= array('codigo'=>$ls_numord,'nombre'=>$ls_nombre,'estcondat'=>$ls_estcondat,
										 'fecha'=>$ls_fecha,'estatus'=>$status,'unidad'=>$unidades,'monto'=>$ld_monto);
					  $li_i++;
					  $rs_data->MoveNext();
					}
				}
