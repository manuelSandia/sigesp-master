...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],50,710,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar 	
		$io_pdf->addText(20,760,7,'Consejo Legislativo del Estado Lara'); // Agregar titulo a Logo
		$io_pdf->addText(45,703,7,'Unidad de Compras'); // Agregar titulo a Logo
		if ($as_estcom=='3')
		{
			$io_pdf->addText(480,775,9,"<b>ANULADO</b>"); // Agregar la Fecha
		}
		if($as_estcondat=="B") 
        {
		...
		$io_pdf->addText(485,715,9,"<b>Fecha </b>".$ad_fecordcom); // Agregar el título
		//$io_pdf->addText(540,780,7,date("d/m/Y")); // Agregar la Fecha
		//$io_pdf->addText(546,774,6,date("h:i a")); // Agregar la Hora
		// cuadro inferior
        $io_pdf->Rectangle(8,60,595,90); 
		$io_pdf->addText(20,63,7,"JEFE COMPRAS"); // Agregar el título
		$io_pdf->line(90,60,90,150);	//VERTICAL	
		$io_pdf->addText(95,63,7,"JEFE ADMINISTRACION"); // Agregar el título
		$io_pdf->line(180,60,180,150);	//VERTICAL		
		$io_pdf->addText(200,63,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->line(278,60,278,150);	//VERTICAL		
		$io_pdf->addText(300,80,7,"DIRECCION DE "); // Agregar el título
            $io_pdf->addText(305,70,7,"SERVICIOS  "); // Agregar el título
            $io_pdf->addText(290,63,7,"ADMINISTRATIVOS "); // Agregar el título
            $io_pdf->line(368,60,368,150);	//VERTICAL	
            $io_pdf->addText(390,63,7,"PRESIDENCIA "); // Agregar el título
            $io_pdf->line(460,60,460,150);	//VERTICAL
            $io_pdf->addText(490,70,7,"UNIDAD"); // Agregar el título
            $io_pdf->addText(480,63,7,"SOLICITANTE"); // Agregar el título
            $io_pdf->line(540,60,540,150);	//VERTICAL
            $io_pdf->addText(550,63,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->line(8,87,602,87); //HORIZONTAL		
