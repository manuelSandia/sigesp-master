<?php
	...
	{	 
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>80), // Justificaci_n y ancho de la columna
						 			   'nombre'=>array('justification'=>'left','width'=>150), // Justificaci_n y ancho de la columna
									   'estcondat'=>array('justification'=>'center','width'=>45), // Justificaci_n y ancho de la columna
						 			   'status'=>array('justification'=>'center','width'=>70), // Justificaci_n y ancho de la columna
						 			   'documento'=>array('justification'=>'center','width'=>100),
   						 			   'origen'=>array('justification'=>'left','width'=>130))); // Justificaci_n y ancho de la columna
	...
	function uf_print_pie_cabecera($ad_numreg,$ad_totmon,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('name'=>array('justification'=>'left','width'=>520))); // Ancho M_ximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
	...
	{
		$ls_descripcion="Gener_ el Reporte de Ubicacion de Orden de Compra";
