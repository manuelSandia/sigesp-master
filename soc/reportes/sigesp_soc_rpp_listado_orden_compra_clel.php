<?php
	...
	{	 
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////				
		global $ls_bolivares;
		//CLEL Se agrega la columna concepto y se comenta sin concepto
		...
		//CLEL Se modifica la configuracion de la tabla para insertar la columna concepto y se comenta sin la columna
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
									   ...
									   'estcondat'=>array('justification'=>'center','width'=>45), // Justificación y ancho de la columna
						 			   ...
						 			   'estatus'=>array('justification'=>'center','width'=>60),
									   'obscom'=>array('justification'=>'center','width'=>180),
				...
				if($ls_tiporeporte=="SELECTIVO")
				{
					for($li_i=0;$li_i<$li_row;$li_i++)
					{
						...
						while($row=$io_sql->fetch_row($rs_data))
						{
							  ...
							  //CLEL Por peticion de compras agregar compo concepto &row["obscom"]
							 ...
							 $la_data[$li_i]= array('codigo'=>$ls_numord,'nombre'=>$ls_nombre,'estcondat'=>$ls_estcondat,
												 'fecha'=>$ls_fecha,'estatus'=>$status,'monto'=>$ld_monto,'obscom'=>$ls_obscom);
						}
						$li_i=$li_i-1;
					}
				}
