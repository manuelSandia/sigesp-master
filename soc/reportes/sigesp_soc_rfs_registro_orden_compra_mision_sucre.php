...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_nomreppro,$as_telpro,$as_estcom,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo_sucre.jpg',18,715,450,42); // Agregar Logo
		if ($as_estcom=='3')
		{
		...
		$la_data[2]=array('columna1'=>'<b>Persona Contacto</b>  '.$as_nomreppro.'<b>',
		                 'columna2'=>'<b>Telefono</b> '.$as_telpro.'');
		...
		$la_data[1]=array('columna1'=>'<b>Unidad Ejecutora/Solicitante</b>    '.$ls_uniadm,'columna2'=>'<b>Forma de Pago</b>    '.$ls_forpagcom);
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_nomreppro,$ls_telpro,$ls_estcom,&$io_pdf);
