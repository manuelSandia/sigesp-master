	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>115),      // Justificación y ancho de la columna
						 			   ...
						 			   'cantidad'=>array('justification'=>'right','width'=>80),
									   'unidad'=>array('justification'=>'left','width'=>120))); // Justificación y ancho de la columna
				...
				if ($lb_valido)
				{
					...
					{ 
						...
						while($row=$io_sql->fetch_row($rs_datos))
						{
							...
							$la_datos[$li_i] = array('codigo'=>$ls_codigo,'denominacion'=>$ls_denite,'cantidad'=>$ld_canite,'unidad'=>$ls_denunimed);
						}
					}
					else
					{
