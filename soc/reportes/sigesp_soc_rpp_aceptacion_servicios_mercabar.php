<?php
	...
	function uf_print_cuerpo($as_nomemp,$as_numordcom,$ad_fecordcom,$ai_montot,$as_totordser,$as_ciuemp,$ad_fecrecser,&$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-15);
		$la_data1[1]=array('empresa'=>"",'empresa1'=>"RECIBE CONFORME");
		$la_data1[2]=array('empresa'=>"",'empresa1'=>"Firma:___________________________");
		$la_data1[3]=array('empresa'=>"",'empresa1'=>"Nombre:_________________________");
		$la_data1[4]=array('empresa'=>"",'empresa1'=>"Cargo:__________________________");
		$la_data1[5]=array('empresa'=>"",'empresa1'=>"C.I.:_____________________________");
		$la_columna=array('empresa'=>'',
						  'empresa1'=>'<b>POR '.strtoupper($as_nomemp).' </b>');
					...
					while($row=$io_sql->fetch_row($rs_data))
					     {
				           ...
				           if ($ls_estcom!=7)
				              {
					            print("<script language=JavaScript>");
					            print(" alert('La Orden de Servicio no se le ha procesado el Acta');"); 
					            print(" close();");
					            print("</script>");
			  	              }
