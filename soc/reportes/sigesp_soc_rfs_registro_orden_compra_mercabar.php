...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->line(480,700,480,782);
		$io_pdf->line(480,740,585,740);
        $io_pdf->Rectangle(15,700,570,82);
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],50,711,50,70); // Agregar Logo
		if ($as_estcom=='3')
		{
			$io_pdf->addText(482,765,9,"<b>ANULADO</b>"); // Agregar la Fecha
		}
		if($as_estcondat=="B") 
        {
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,745,14,$ls_titulo); // Agregar el título
		$io_pdf->addText(485,750,9," <b>No. </b>".$as_numordcom); // Agregar el título
		$io_pdf->addText(485,720,9,"<b>Fecha </b>".$ad_fecordcom); // Agregar el título
		$io_pdf->addText(20,706,4,"MERCADO MAYORISTA DE ALIMENTOS DE BARQUISIMETO C.A."); // Agregar el título
		$io_pdf->addText(40,702,4,"MERCABAR, RIF: J-08512511-6"); // Agregar el título
		
		// cuadro inferior
        $io_pdf->Rectangle(15,60,570,70); 
		$io_pdf->line(15,119,585,119);	//HORIZONTAL	
		$io_pdf->addText(40,122,6,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(18,88,6,"FECHA:         /        /    "); // Agregar el título
		$io_pdf->addText(18,72,6,"FIRMA:"); // Agregar el título
		$io_pdf->addText(18,63,6,"COORDINACION DE ADQUISICIONES"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(167,122,6,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(140,63,6,"PLANIFICACION Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(133,88,6,"FECHA:         /        /    "); // Agregar el título
		$io_pdf->addText(133,72,6,"FIRMA:"); // Agregar el título
		$io_pdf->line(250,60,250,130);	//VERTICAL		
		$io_pdf->addText(370,122,6,"COMPRA AUTORIZADA"); // Agregar el título
		$io_pdf->addText(255,63,6,"GERENCIA DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(253,88,6,"FECHA:         /        /    "); // Agregar el título
		$io_pdf->addText(253,72,6,"FIRMA:"); // Agregar el título
		$io_pdf->line(355,60,355,119);	//VERTICAL		
		$io_pdf->addText(378,63,6,"GERENCIA GENERAL"); // Agregar el título
		$io_pdf->addText(358,88,6,"FECHA:         /        /    "); // Agregar el título
		$io_pdf->addText(358,72,6,"FIRMA:"); // Agregar el título
		$io_pdf->line(475,60,475,119);	//VERTICAL		
		$io_pdf->addText(498,63,6,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(478,88,6,"FECHA:         /        /    "); // Agregar el título
		$io_pdf->addText(478,72,6,"FIRMA:"); // Agregar el título
		$io_pdf->line(15,70,585,70); //HORIZONTAL		
		$io_pdf->addText(105,53,5,"MERCABAR, RIF: J-08512511-6, ZONA INDUSTRIAL III. AV. CARLOS GIFFONI. BARQUSIMETO - LARA - VENEZUELA, email mercompras25@gmail.com / Telefono (0251) 2691236)"); // Agregar el título
		//$io_pdf->addText(255,63,5,"email mercompras25@gmail.com / Telefono (0251) 2691236)"); // Agregar el título
