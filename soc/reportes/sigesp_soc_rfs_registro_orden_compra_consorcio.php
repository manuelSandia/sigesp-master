...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		//  1er cuadro inferior
		$io_pdf->Rectangle(15,110,570,80);
		$io_pdf->addText(20,180,9,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(20,125,7,"LICDA. ROSSANA DAVILA (E) "); // Agregar el título
		$io_pdf->addText(20,115,7,"UNIDAD DE COMPRAS Y SERVICIOS "); // Agregar el título
		$io_pdf->line(150,110,150,190);	//VERTICAL
		$io_pdf->line(275,110,275,190);	//VERTICAL	
		$io_pdf->addText(155,180,9,"APROBADO POR:"); // Agregar el título
		$io_pdf->addText(155,125,7,"NG. RODRIGO CANEDO"); // Agregar el título
		$io_pdf->addText(155,115,7,"GERENTE DE LOGISTICA"); // Agregar el título
		$io_pdf->line(437,110,437,190);	//VERTICAL	
		$io_pdf->addText(278,180,9,"CONFORME POR:"); // Agregar el título
		$io_pdf->addText(278,125,7,"ING. FRANCISCO OLIVEIRA"); // Agregar el título
		$io_pdf->addText(278,115,7,"OFICINA DE PLANIFICACIÓN Y PRESUPUESTO "); // Agregar el título
		$io_pdf->addText(440,180,9,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->addText(440,125,7,"ING. JOSE GREGORIO QUIJADA SINGER"); // Agregar el título
		$io_pdf->addText(440,115,7,"PRESIDENCIA"); // Agregar el título
		// 2do cudro inferior
        $io_pdf->Rectangle(15,60,570,50); 
		$io_pdf->line(15,90,585,90);	//HORIZONTAL	
		$io_pdf->addText(18,100,9,"RECEPCION DEL PROVEEDOR"); // Agregar el título
		$io_pdf->addText(18,80,9,"FIRMA Y C.I:"); // Agregar el título
		$io_pdf->addText(140,80,9,"FECHA:"); // Agregar el título
		$io_pdf->line(130,60,130,90);	//VERTICAL	
		$io_pdf->addText(280,100,9,"OFICIO"); // Agregar el título
		$io_pdf->addText(280,80,9,"Nº "); // Agregar el título
		$io_pdf->line(275,60,275,110);	//VERTICAL		
		$io_pdf->line(437,60,437,110);	//VERTICAL	
		$io_pdf->addText(440,100,9,"CONTABILIDAD"); // Agregar el título	
