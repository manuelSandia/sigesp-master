...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
        ...
        $io_pdf->Rectangle(15,125,570,80); 
		$io_pdf->line(15,190,585,190);	//HORIZONTAL	
		$io_pdf->addText(25,193,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(20,140,7,"UNIDAD DE COMPRAS"); // Agregar el título
		$io_pdf->line(100,125,100,205);	//VERTICAL	
		...
		// Agregar el título firma proveedor
		$io_pdf->addText(190,70,7,"PROVEEDOR:"); 
		$io_pdf->line(240,69,485,69); //HORIZONTAL		
		$io_pdf->addText(243,58,7,"FIRMA AUTOGRAFA, SELLO Y FECHA"); // Agregar el título
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			$io_pdf->ezSetCmMargins(8.5,10,3,3); // Configuración de los margenes en centímetros
