...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->line(480,678,480,722);
		$io_pdf->line(480,700,585,700);
        $io_pdf->Rectangle(15,678,570,45);
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_inn.jpg',25,726,560,40); // Agregar Logo
		if ($as_estcom=='3')
		{
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,695,14,$ls_titulo); // Agregar el título
		$io_pdf->addText(485,708,9," <b>No. </b>".$as_numordcom); // Agregar el título
		$io_pdf->addText(485,688,9,"<b>Fecha </b>".$ad_fecordcom); // Agregar el título
		...
		$io_pdf->addText(50,63,7,$ls_logusr); // Agregar el título
		...
		$io_pdf->addText(300,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(290,63,7,"DIR. DE ADMINISTRACION"); // Agregar el título
		...
		//$io_pdf->ezSetY(677);
		$la_data[1]=array('columna1'=>'<b>Rif</b>    '.$as_rifpro.'');
