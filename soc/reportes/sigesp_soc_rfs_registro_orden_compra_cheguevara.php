...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_denmodcla,$as_estcom,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->line(15,60,15,160);	//VERTICAL
		$io_pdf->line(15,160,585,160); //HORIZONTAL
		$io_pdf->line(200,130,200,160);	//VERTICAL
		$io_pdf->line(400,130,400,160);	//VERTICAL	
		$io_pdf->addText(148,122,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(140,63,7,"COORD./COMPRAS"); // Agregar el título

		$io_pdf->line(230,60,230,130);	//VERTICAL
		$io_pdf->addText(249,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(248,63,7,"ADMINISTRACION"); // Agregar el título

		$io_pdf->line(340,60,340,130);	//VERTICAL		
		$io_pdf->addText(360,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(368,63,7,"PRESIDENCIA"); // Agregar el título

		$io_pdf->line(470,60,470,130);	//VERTICAL	
		$io_pdf->line(585,60,585,160);	//VERTICAL		
		$io_pdf->addText(500,122,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(485,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(15,73,585,73); //HORIZONTAL		
		//Clausulas
		$io_pdf->addText(18,154,5,"FIANZA FIEL CUMPLIMIENTO: Al aprobarse esta orden se exigirá al Beneficiario "); // Agregar el título
		$io_pdf->addText(18,148,5,"Fianza de Fiel Cumplimiento equivalente al ____ % de la orden Otorgada por un "); // Agregar el título
		$io_pdf->addText(18,142,5,"Banco o Compañía de Seguros, notariada y vigente hasta la total recepción "); // Agregar el título
		$io_pdf->addText(18,136,5,"de la mercancía."); // Agregar el título
		
		$io_pdf->addText(203,154,5,"CLAUSULA PENAL: Queda establecida la clausula penal, según la cual el proveedor "); // Agregar el título
		$io_pdf->addText(203,148,5,"pagará al físico el ____% sobre el monto de la mercancía respectiva, por cada"); // Agregar el título
		$io_pdf->addText(203,142,5,"día hábil de retardo en la entrega.  "); // Agregar el título
		
		$io_pdf->addText(403,154,5,"CLAUSULA ESPECIAL: El Organismo se reserva el derecho de anular "); // Agregar el título
		$io_pdf->addText(403,148,5,"unilateralmente la presente Orden de Compra, sin indemnización de conformidad"); // Agregar el título
		$io_pdf->addText(403,142,5,"con lo dispuesto en el reglamento que rige la materia.  "); // Agregar el título
		...
		$la_data[1]=array('columna1'=>'<b>Modalidad de la Clausula</b>         '.$as_denmodcla);
		$la_columnas=array('columna1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
