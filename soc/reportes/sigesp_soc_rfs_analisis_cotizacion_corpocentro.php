<?PHP
	...
	//------------------------------------------------------------------------------------------------------------------------------------
	//------------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_pagina($as_observacion,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $io_pdf->addText(900,20,9,"COR-UAC-F-001");	
		...
		$la_anchos=array();
		$la_justificaciones=array();
		$la_data[0]["1"]="<b>OBSERVACIONES:</b>   ".$as_observacion;
		$la_anchos_col = array(310);
		...
		$io_pdf->add_tabla(15,$la_data,$la_opciones);	//primera fila del item, color gris	
	...
	if($lb_valido)
	{
		...
		$lb_valido=$io_class_report->uf_cargar_cotizaciones_esp($ls_numanacot,$la_cotizaciones,$ls_tipsolcot);
		if($lb_valido)
		{
			//print_r($la_cotizaciones);
