...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm,$as_lugentdir,$as_estlugcom
	                                    ,$as_codigo,$as_nombre,$as_conordcom,$as_rifpro,$as_diaplacom,$as_dirpro,$as_forpagcom,$as_estcom,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(75,135,7,"<b>GERENCIA DE ADMINISTRACIÓN Y FINANZAS</b>"); // Agregar el título	
		$io_pdf->addText(70,122,6,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(20,63,6,"RESP. COMPRAS Y CONTRATACION DE SERVICIOS"); // Agregar el título
		$io_pdf->line(170,60,170,130);	//VERTICAL	
		$io_pdf->addText(205,122,6,"CONFORMADO POR"); // Agregar el título
		$io_pdf->addText(180,63,6,"GTE. ADMINISTRACION Y FINANZAS"); // Agregar el título
		$io_pdf->line(300,60,300,145);	//VERTICAL
		$io_pdf->addText(340,135,7,"<b>PRESIDENCIA</b>"); // Agregar el título		
		$io_pdf->addText(335,122,6,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(340,63,6,"PRESIDENTE (A)"); // Agregar el título
		$io_pdf->line(430,60,430,145);	//VERTICAL		
		$io_pdf->addText(475,122,6,"RECIBI CONFORME"); // Agregar el título
		$io_pdf->addText(485,63,6,"PROVEEDOR"); // Agregar el título
		...
		unset($la_config);
         if ($as_estlugcom== '0')
		   {
		    $as_estlugcom = 'Nacional';
		   }
		   else
		   {
		   $as_estlugcom= 'Extranjero';
		   }
		
		$la_data[1]=array('columna1'=>'<b>Lugar de Compra</b>   '.$as_estlugcom,'columna2'=>'<b> Lugar de Entrega</b>    '.$as_lugentdir);
		$la_columnas=array('columna1'=>'','columna2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle($la_data,$as_estcondat,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			$la_config      = array('showHeadings'=>1, // Mostrar encabezados
									...
									'xPos'=>302, // Orientación de la tabla
						 			'cols'=>array('codigo'=>array('justification'=>'center','width'=>90),      // Justificación y ancho de la columna
												  ...
												  'cosuni'=>array('justification'=>'right','width'=>65),       // Justificación y ancho de la columna
						 			   			  'baseimp'=>array('justification'=>'right','width'=>65),     // Justificación y ancho de la columna
									  			  'porimp'=>array('justification'=>'center','width'=>25),     // Justificación y ancho de la columna
		...
		elseif($as_estcondat=='S')
		{
			...
			$la_columnas=array('codigo'=>'<b>Código</b>',
				               'denominacion'=>'<b>Denominación</b>',
				               'cantidad'=>'<b>Cant.</b>',
				               'cosuni'=>'<b>Precio ('.$ls_bolivares.')</b>',
				   			   'baseimp'=>'<b>Sub-Total ('.$ls_bolivares.')</b>',
							   'porimp'=>'<b>%</b>',
							   'cargo'=>'<b>IVA ('.$ls_bolivares.')</b>',
				   			   'montot'=>'<b>Total ('.$ls_bolivares.')</b>');
		    ...
		    $la_config      = array('showHeadings'=>1, // Mostrar encabezados
						 			...
						 			'cols'=>array('codigo'=>array('justification'=>'center','width'=>60),      // Justificación y ancho de la columna
						 			   			  ...
						 			   			  'cosuni'=>array('justification'=>'right','width'=>75),       // Justificación y ancho de la columna
												  'baseimp'=>array('justification'=>'right','width'=>75),     // Justificación y ancho de la columna
									  			  'porimp'=>array('justification'=>'center','width'=>25),     // Justificación y ancho de la columna
		...
		$io_pdf->ezTable($la_data,$la_columnas,'<b>Detalles de '.$ls_titulo_grid.'</b>',$la_config);
	    unset($la_data);
		unset($la_columnas);
		unset($la_config);
			   ...
			   if ($lb_valido)
			   {
				 ...
				 if ($li_totrows>0)
				 {
				    ...
				    while($row=$io_sql->fetch_row($rs_datos))
					{
					    ...
					    $ld_porimp = number_format($ld_porimp,2,',','.');
