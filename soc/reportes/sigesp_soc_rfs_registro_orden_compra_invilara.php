...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,&$io_pdf)
	{
		...
		if($as_estcondat=="B") 
        {
			 ...
			 $io_pdf->addText(525,740,10,date("d/m/Y")); // Agregar la Fecha
			 ...
			 ///////////////////////////////////////////////////
				...
				$la_data[1]=array('columna1'=>'                                    '.$as_numordcom);
				...
				$la_data[1]=array('columna1'=>'                                    '.$ad_fecordcom);
				$la_columna=array('columna1'=>'');
				$la_config=array('showHeadings'=>0, // Mostrar encabezados
								 'fontSize' => 9, // Tamaño de Letras
								 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
				...
				$la_data[1]=array('columna1'=>'                                    '.$as_nombre);
				$la_columna=array('columna1'=>'');
				$la_config=array('showHeadings'=>0, // Mostrar encabezados
								 'fontSize' => 9, // Tamaño de Letras
								 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
				...
				$la_config=array('showHeadings'=>0, // Mostrar encabezados
								 ...
								 'xOrientation'=>'center', // Orientación de la tabla
								 'rowGap' => 2.5,								 
								 'cols'=>array('columna1'=>array('justification'=>'left','width'=>390))); // Justificación y ancho de la columna
				$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
				unset($la_data);
				unset($la_columnas);
				unset($la_config);
				///////////////////////////////////////////////////////////////////////////////////////////				
				// Titulos adicionales
				$io_pdf->addText(50,490,9,"BARQUISIMETO"); // Agregar el título
				$io_pdf->addText(300,490,9,"TERRESTRE"); // Agregar el título
				$io_pdf->addText(515,490,9,date("d/m/Y")); // Agregar la Fecha
				///////////////////////////////////////////////////////////////////////////////////////////
        }
        else
        {
             //$ls_titulo="Orden de Servicio";
			 $io_pdf->addText(480,770,10,date("d/m/Y")); // Agregar la Fecha
			 $io_pdf->addText(470,720,10,"".$as_numordcom); // Agregar el título

			 // $io_pdf->addText(485,710,9,"".$ad_fecordcom); // Agregar el título			 
			 ...
			 // $io_pdf->ezSetDy(-30);
				...
				*/
			// $io_pdf->addText(525,770,10,date("d/m/Y")); // Agregar la Fecha
        }
		
		// Otro Cambio...
		$io_pdf->addText(22,30,8,"LCDO. JULIO ESCALONA"); // Agregar el título
		$io_pdf->addText(140,30,8,"LCDA. MARIA MENDOZA"); // Agregar el título
		$io_pdf->addText(252,30,8,"LCDA. LUCY COLMENAREZ"); // Agregar el título
		$io_pdf->addText(372,28,8,"ING. CAROLINA FORTOUL"); // Agregar el título
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle($la_data,&$io_pdf,$as_estcondat)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$ls_titulo_grid="Bienes";
			// $io_pdf->addText(40,80,6,"ENTRO por Orden de Compra...."); // Policia
			/////////////////////////////////
			// Así estaba antes...
			// $io_pdf->ezSetDy(-100);
			///////////////////////////////
			...
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 ...
							 'cols'=>array('codigo'=>array('justification'=>'left','width'=>115), // Justificación y ancho de la columna
										   'denominacion'=>array('justification'=>'left','width'=>155), // Justificación y ancho de la columna
										   ...
										   'baseimp'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
			$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		}
		else
		{
			$ls_titulo_grid="Servicios";
			// $io_pdf->addText(40,80,6,"ENTRO por Orden de Servicio...."); // Policia
			///////////////////////////////////////
			// Así estaba antes...
			// $io_pdf->ezSetDy(-117);
			///////////////////////////////////////
			...
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 ...
							 'cols'=>array('codigo'=>array('justification'=>'left','width'=>115), // Justificación y ancho de la columna
										   'denominacion'=>array('justification'=>'left','width'=>165), // Justificación y ancho de la columna
										   ...
										   'cosuni'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
										   'baseimp'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la columna
			$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		}
	...
	function uf_print_detalle_cuentas($la_data,&$io_pdf)
	{
		...
		$la_datatit[1]=array('titulo'=>'<b> COD. ESTADISTICO                      DENOMINACION                                        CUENTA                           MONTO </b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'center','width'=>495))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('codestpro'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'center','width'=>195), // Justificación y ancho de la columna
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
			   ...
			   if ($lb_valido)
			   {
				 ...
				 if ($li_totrows>0)
				 {
					...
					uf_print_detalle($la_data,&$io_pdf,$ls_estcondat);
