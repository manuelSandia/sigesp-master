...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		///$io_pdf->addText(50,63,7,"COMPRAS"); // Agregar el título
	        $io_pdf->line(210,60,210,130);	//VERTICAL	
		$io_pdf->addText(230,122,7,"REVISADO POR ADMINISTRACION:"); // Agregar el título
		/////$io_pdf->addText(160,63,7,"CONTABILIDAD"); // Agregar el título
		///$io_pdf->line(260,60,260,130);	//VERTICAL		
		$io_pdf->addText(470,122,7,"PRESUPUESTO"); // Agregar el título
		///$io_pdf->addText(300,63,7,"POR ADMINISTRACION"); // Agregar el título
		$io_pdf->line(410,60,410,130);	//VERTICAL		
		//$io_pdf->addText(470,122,7,"CONTRALORA MUNICIPAL:"); // Agregar el título
		//$io_pdf->addText(455,63,7,"POR LA EMPRESA:"); // Agregar el título
