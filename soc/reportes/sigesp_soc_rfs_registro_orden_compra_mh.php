...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_numsolcot,$ls_fecsolcot,$ls_numcot,$ls_feccot,$as_estcom,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->line(480,690,480,760);
		$io_pdf->line(480,730,585,730);
        $io_pdf->Rectangle(15,690,570,70);
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_mh.jpg',25,714,450,45); // Agregar Logo
		if ($as_estcom=='3')
		{
		...
		if($as_estcondat=="B")
        {
			 ...
			 $ls_uniadm = '  UNIDAD DE COMPRAS';
			 $ls_rifuni = '  RIF: G-20006677-6';
			 $ls_uniad_bot = 'Unidad de Compras';
        }
        else
        {
             $ls_titulo="Orden de Servicio";
			 $ls_titulo_grid="Servicios";
			 $ls_uniadm = 'SERVICIOS GENERALES';
			 $ls_rifuni = 'RIF: G-20006677-6';
			 $ls_uniad_bot = 'Unidad Servicios Generales';
        }

		$li_tm=$io_pdf->getTextWidth(14,$ls_titulo);
		$tm=296-($li_tm/2);
		$io_pdf->addText(228,720,7,$ls_uniadm); // Agregar el título
		$io_pdf->addText(242,714,6,$ls_rifuni); // Agregar el título
		$io_pdf->addText($tm,695,15,$ls_titulo); // Agregar el título
		...
		$io_pdf->addText(28,63,7,$ls_uniad_bot); // Agregar el título

		$io_pdf->line(120,60,120,130);	//VERTICAL
		$io_pdf->addText(160,122,7,"Revisado por"); // Agregar el título
		$io_pdf->addText(145,67,7,"Coordinación de Compras"); // Agregar el título
		$io_pdf->addText(150,61,7,"y Servicios Generales"); // Agregar el título

		$io_pdf->line(245,60,245,130);	//VERTICAL
		$io_pdf->addText(275,122,7,"Aprobado por"); // Agregar el título
		$io_pdf->addText(260,63,7,"Oficina Administración"); // Agregar el título

		$io_pdf->line(350,60,350,130);	//VERTICAL
		$io_pdf->addText(380,122,7,"Aprobado por"); // Agregar el título
		$io_pdf->addText(370,63,7,"Presidencia Ejecutiva"); // Agregar el título

		$io_pdf->line(480,60,480,130);	//VERTICAL
		$io_pdf->addText(510,122,7,"Aceptación"); // Agregar el título
		$io_pdf->addText(515,63,7,"Vendedor"); // Agregar el título
		...
		unset($la_columnas);
		unset($la_config);
		$la_data[1]=array('columna1'=>'<b>Solicitud de Cotización</b> ','columna2'=>'<b>Cotización</b> ');
		$la_columnas=array('columna1'=>'','columna2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'center','width'=>285),'columna2'=>array('justification'=>'center','width'=>285))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);

		$la_data[1]=array('columna1'=>'<b>Número</b> ','columna2'=>'<b>Fecha</b> ','columna3'=>'<b>Número</b> ','columna4'=>'<b>Fecha</b> ');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'center','width'=>142),'columna2'=>array('justification'=>'center','width'=>142),'columna3'=>array('justification'=>'center','width'=>142),'columna4'=>array('justification'=>'center','width'=>142))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);

		$la_data[1]=array('columna1'=>$ls_numsolcot,'columna2'=>$ls_fecsolcot,'columna3'=>$ls_numcot,'columna4'=>$ls_feccot);
		$la_columnas=array('columna1'=>'','columna2'=>'','columna3'=>'','columna4'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)
		{
			...
			$io_pdf->ezSetCmMargins(9.3,5,3,3); // Configuración de los margenes en centímetros
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_numsolcot,$ls_fecsolcot,$ls_numcot,$ls_feccot,$ls_estcom,&$io_pdf);
