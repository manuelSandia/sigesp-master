...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->addText(50,157,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(55,98,7,"COMPRAS"); // Agregar el título
		$io_pdf->line(150,90,150,170);	//VERTICAL	
		$io_pdf->addText(190,157,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(200,98,7,"COMPRAS"); // Agregar el título
		$io_pdf->line(290,90,290,170);	//VERTICAL		
		$io_pdf->addText(330,157,7,"IMPUTADO POR"); // Agregar el título
		$io_pdf->addText(330,98,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->line(430,90,430,170);	//VERTICAL		
		$io_pdf->addText(475,157,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(455,98,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
