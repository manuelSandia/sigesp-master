...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_valorunitrib,$ld_montot,$as_estcom,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/headmre.jpg',16,730,250,29); // Agregar Logo
		if ($as_estcom=='3')
		{
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,715,14,$ls_titulo); // Agregar el título
		...
		if ($ld_montot>$ls_valorunitrib)
		{
		  ...
		  $io_pdf->addText(270,152,7,"FIRMAS AUTORIZADAS"); // Agregar el título
		  $io_pdf->line(15,148,585,148);	//HORIZONTAL
		  $io_pdf->line(15,130,585,130);	//HORIZONTAL
		  $io_pdf->addText(35,138,8,"<b>Elaborado Por</b>"); // Agregar el título
	      $io_pdf->line(15,105,585,105);	//HORIZONTAL
		  $io_pdf->addText(20,122,7,"<b>Nombre y Apellido</b>"); // Agregar el título
		  $io_pdf->addText(20,96,7,"<b>Firma</b>"); // Agregar el título
		  $io_pdf->line(15,80,585,80);	//HORIZONTAL
		  $io_pdf->addText(20,72,7,"<b>Fecha</b>"); // Agregar el título
		  $io_pdf->line(120,60,120,148);	//VERTICAL
		  $io_pdf->addText(135,138,8,"<b>Coordinador del Area</b>"); // Agregar el título
		  $io_pdf->addText(122,122,7,"<b>Nombre y Apellido</b>"); // Agregar el título
		  $io_pdf->addText(122,96,7,"<b>Firma</b>"); // Agregar el título
		  $io_pdf->addText(122,72,7,"<b>Fecha</b>"); // Agregar el título
		  $io_pdf->line(235,60,235,148);	//VERTICAL
		  $io_pdf->addText(237,122,7,"<b>Nombre y Apellido</b>"); // Agregar el título
		  $io_pdf->addText(237,96,7,"<b>Firma</b>"); // Agregar el título
		  $io_pdf->addText(237,72,7,"<b>Fecha</b>"); // Agregar el título
		  $io_pdf->addText(240,138,8,"<b>Director de Administración</b>"); // Agregar el título
		  $io_pdf->line(350,60,350,148);	//VERTICAL
		  $io_pdf->addText(352,122,7,"<b>Nombre y Apellido</b>"); // Agregar el título
		  $io_pdf->addText(352,96,7,"<b>Firma</b>"); // Agregar el título
		  $io_pdf->addText(352,72,7,"<b>Fecha</b>"); // Agregar el título
		  $io_pdf->addText(355,140,8,"<b>Director General de la Oficina</b>"); // Agregar el título
		  $io_pdf->addText(355,132,8,"<b>de Servicios Administrativos</b>"); // Agregar el título
		  $io_pdf->line(480,60,480,148);	//VERTICAL
		  $io_pdf->addText(482,122,7,"<b>Nombre y Apellido</b>"); // Agregar el título
		  $io_pdf->addText(482,96,7,"<b>Firma</b>"); // Agregar el título
		  $io_pdf->addText(482,72,7,"<b>Fecha</b>"); // Agregar el título
		  $io_pdf->addText(515,138,8,"<b>Proveedor</b>"); // Agregar el título
		}
		else
		{ 
		  $io_pdf->Rectangle(15,60,570,100);
		  ...
		  $io_pdf->addText(155,138,8,"<b>Coordinador del Area</b>"); // Agregar el título
		  $io_pdf->addText(137,122,7,"<b>Nombre y Apellido</b>"); // Agregar el título
		  $io_pdf->addText(137,96,7,"<b>Firma</b>"); // Agregar el título
		  $io_pdf->addText(137,72,7,"<b>Fecha</b>"); // Agregar el título
		  $io_pdf->line(270,60,270,148);	//VERTICAL
		  $io_pdf->addText(272,122,7,"<b>Nombre y Apellido</b>"); // Agregar el título
		  $io_pdf->addText(272,96,7,"<b>Firma</b>"); // Agregar el título
		  $io_pdf->addText(272,72,7,"<b>Fecha</b>"); // Agregar el título
		  $io_pdf->addText(290,138,8,"<b>Director de Administración</b>"); // Agregar el título
		  $io_pdf->line(430,60,430,148);	//VERTICAL
		  $io_pdf->addText(432,122,7,"<b>Nombre y Apellido</b>"); // Agregar el título
		  $io_pdf->addText(432,96,7,"<b>Firma</b>"); // Agregar el título
		  $io_pdf->addText(432,72,7,"<b>Fecha</b>"); // Agregar el título
		  $io_pdf->addText(485,138,8,"<b>Proveedor</b>"); // Agregar el título	
		}
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			$io_pdf->ezSetCmMargins(7.5,7,3,3); // Configuración de los margenes en centímetros
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
			    ...
			    // $rs_datos_uni = $io_report->uf_select_unidadtributaria(&$ls_valorunitri);
			     $lb_valido= $io_report->uf_select_unidadtributaria(&$ls_valoruni); 
				 if($lb_valido)
				 { 
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_valorunitrib,$ld_montotalaux,$ls_estcom,&$io_pdf);
