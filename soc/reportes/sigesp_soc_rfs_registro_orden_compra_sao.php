...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->line(15,130,585,130);	//HORIZONTAL	
                $io_pdf->addText(50,142,7,"Elaborado por:"); // Agregar el título
		$io_pdf->addText(35,134,7,"T.S.U Shirley Gonzalez"); // Agregar el título
		$io_pdf->addText(38,64,7,"Unidad de Compras"); // Agregar el título
		$io_pdf->line(130,60,130,150);	//VERTICAL
                $io_pdf->addText(164,142,7,"Verificado por:"); // Agregar el título	
		$io_pdf->addText(150,134,7,"T.S.U Freddy Martinez"); // Agregar el título
		$io_pdf->addText(148,64,7,"Unidad de Presupuesto"); // Agregar el título
		$io_pdf->line(245,60,245,150);	//VERTICAL		
                $io_pdf->addText(280,142,7,"Autorizado por:"); // Agregar el título
		$io_pdf->addText(265,134,7,"Lcdo. Luis E. Rodriguez"); // Agregar el título
		$io_pdf->addText(260,64,7,"Administracion y Finanzas"); // Agregar el título
		$io_pdf->line(360,60,360,150);	//VERTICAL
                $io_pdf->addText(390,142,7,"Autorizado por:"); // Agregar el título		
		$io_pdf->addText(380,134,7,"Dra. Gloria A. Soler B."); // Agregar el título
		$io_pdf->addText(400,64,7,"Presidencia"); // Agregar el título
		$io_pdf->line(475,60,475,150);	//VERTICAL		
		$io_pdf->addText(512,138,7,"Proveedor"); // Agregar el título
		$io_pdf->addText(498,64,7,"Firma / Sello / Fecha"); // Agregar el título
