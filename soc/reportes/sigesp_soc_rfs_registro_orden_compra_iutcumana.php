...
//		$io_pdf->addText(25,122,7,"ELABORADO POR"); // Agregar el título
//		$io_pdf->addText(22,75,7,"Lcda. Francys Esteves"); // Agregar el título
//		$io_pdf->addText(22,63,7,"JEFE DE COMPRAS"); // Agregar el título
//		$io_pdf->line(100,60,100,130);	//VERTICAL	
//		$io_pdf->addText(142,122,7,"REVISION Y CONTROL"); // Agregar el título
//		$io_pdf->addText(118,110,7,"COMPROMISO"); // Agregar el título
//		$io_pdf->addText(197,110,7,"APROBADA"); // Agregar el título
//		$io_pdf->addText(105,75,7,"Lcda. Odalis Arcia"); // Agregar el título
//		$io_pdf->addText(105,63,7,"EJEC. PRESUPUEST"); // Agregar el título
//		$io_pdf->addText(190,75,7,"Lcda. Nelly Salazar"); // Agregar el título
//		$io_pdf->addText(280,75,7,"Lcda. Raiza Coronado"); // Agregar el título
//		$io_pdf->addText(190,63,7,"VERIF. Y CONTROL"); // Agregar el título
//		$io_pdf->line(180,60,180,117);	//VERTICAL		
//		$io_pdf->addText(275,122,7,"ADMINISTRACION"); // Agregar el título
//		$io_pdf->addText(340,63,7,"FIRMA AUTORIZADA, SELLO, FECHA"); // Agregar el título
//		$io_pdf->line(260,60,260,130);	//VERTICAL		
//		$io_pdf->addText(390,122,7,"DIRECCION"); // Agregar el título
//		$io_pdf->line(360,73,360,130);	//VERTICAL
//		$io_pdf->line(470,73,470,130);	//VERTICAL		
//		$io_pdf->addText(500,122,7,"SUB-DIRECCION"); // Agregar el título
