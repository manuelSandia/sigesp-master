...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$as_uniejeaso,$ls_telpro,$as_estcom,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($as_estcom=='3')
		{
			$io_pdf->addText(483,765,9,"<b>ANULADO</b>"); // Agregar la Fecha
		}
		if($as_estcondat=="B") 
        {
		...
		$io_pdf->addText(540,10,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(546,5,6,date("h:i a")); // Agregar la Hora
		// cuadro inferior
		...
		$io_pdf->addText(170,63,7,"JEFE DE COMPRAS"); // Agregar el título
		...
		//$io_pdf->line(15,73,585,73); //HORIZONTAL
                $io_pdf->addText(50,50,9,"Av. Bolivar Norte C/C Calle Las Flores Sector San José Zona Postal 2001 . Telf.Master: 0241-8581919-Fax 0241-8585325."); // Agregar el título		
		$io_pdf->addText(260,40,9,"Valencia Edo. Carabobo.");
		$io_pdf->addText(500,30,9,"COR-UAC-F-002");
		...
		$la_data[1]=array('columna1'=>'<b>Telefono</b>  '.$ls_telpro,
		                 'columna2'=>'<b>Condiciones de Pago </b> '.$ls_forpagcom.'');
		$la_columna=array('columna1'=>'','columna2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
							   ...
							   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_uniejeaso,$ls_telpro,$ls_estcom,&$io_pdf);
