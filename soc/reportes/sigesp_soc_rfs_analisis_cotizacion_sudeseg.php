<?PHP
	...
	function uf_print_encabezado_pagina($as_numanacot,$observacion,$ad_fecha,&$io_pdf)
	{
		...
		$io_pdf->addText(95,570,6,"REPÚBLICA BOLIVARIANA DE VENEZUELA"); // Agregar el título
 		$io_pdf->addText(95,560,6,"MINISTERIO DEL PODER POPULAR DE PLANIFICACIÓN Y FINANZAS"); // Agregar el título
  		$io_pdf->addText(95,550,6,"SUPERINTENDENCIA DE LA ACTIVIDAD ASEGURADORA"); // Agregar el título
  		$io_pdf->addText(95,540,6,"OFICINA DE ADMINISTRACIÓN"); // Agregar el título
	...
	function uf_print_pie_pagina(&$io_pdf)
	{
		...
		$io_pdf->line(30,50,780,50);	//VERTICAL
		$io_pdf->line(30,88,780,88);	//VERTICAL
		$io_pdf->addText(35,90,8,"<b>OBSERVACIONES:</b>");
		$io_pdf->addText(35,42,6,"<b>De acuerdo a lo establecido en el capitulo V Consulta de Precios, Art 73 Y 74 de la ley de Contrataciones Públicas, </b>");
		$io_pdf->addText(35,35,6,"<b>Gaceta Oficial Nº 39.165 de Fecha 24 de Abril de 2009 </b>");
		$io_pdf->line(404,30,405,100);	//VERTICAL
		$io_pdf->addText(455,90,8,"<b>ELABORADO POR:</b>");
		$io_pdf->addText(455,32,8,"<b>AREA DE COMPRAS</b>");
		$io_pdf->line(594,30,593,100);	//VERTICAL
		$io_pdf->addText(645,90,8,"<b>APROBADO POR:</b>");
		$io_pdf->addText(600,32,8,"<b>JEFE DE LA OFICINA DE ADMINISTRACION</b>");
