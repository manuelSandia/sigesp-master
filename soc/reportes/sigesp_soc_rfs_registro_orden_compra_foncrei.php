...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_nompro,$as_rifpro,$as_nitpro,$as_obscom,&$io_pdf)
	{
		...
		if (($as_estcondat=="B") || ($as_estcondat=="-") || ($as_estcondat=="")) 
        ...
        else
           {
			 ...
			 $la_data	   = array(array('name'=>'<b>Proveedor: </b>'.$as_nompro),
					   		       array('name'=>'<b>Observación: </b> '.$as_obscom));	
           }
		...
		$io_pdf->addText(165,715,14,"<b>".$ls_titulo."</b>"); // Agregar el título
		$io_pdf->addText(360,725,10," <b>No. </b>".$as_numordcom); // Agregar el título
		$io_pdf->addText(355,705,10,"<b>Fecha </b>".$ad_fecordcom); // Agregar el título
		// cuadro inferior
		...
		$io_pdf->addText(40,136,7,"OBSERVACIONES:"); // Agregar el título
		...
		$io_pdf->addText(300,63,7,"PRESIDENCIA"); // Agregar el título
		...
		$io_pdf->addText(435,63,7,"FIRMA AUTOGRAFA,SELLO,FECHA"); // Agregar el título
	...
	function uf_print_cabecera($as_condicion,$as_lugcom,$as_fecentordcom,$as_formapago,&$io_pdf)
	{
		...
		//		   Access: private 
		//	    Arguments: $as_condicion : Condición de la entrega.
		//                 $as_lugcom    : Lugar donde se realiza la Compra.
		//                 $ad_fecent    : Fecha de Entrega de la Compra.
		//                 $as_formapago : Forma de cancelación de la Compra.
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>570, // Ancho de la tabla						 									 
						 'maxWidth'=>570,
                         'cols'=>array('condicion'=>array('justification'=>'left','width'=>331), // Justificación y ancho de la columna
									   'forma'=>array('justification'=>'center','width'=>239))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);					
		...
		if ($as_tipordcom=='B')
		   {
			 ...
			 $la_config=array('showHeadings'=>1, // Mostrar encabezados
						 	  ...
						 	  'maxWidth'=>570, // Ancho Máximo de la tabla
						 	  'xOrientation'=>'center', // Orientación de la tabla
						      'cols'=>array('codigo'=>array('justification'=>'center','width'=>99), // Justificación y ancho de la columna
						 			   		'denominacion'=>array('justification'=>'left','width'=>138), // Justificación y ancho de la columna
						 			   		...
						 			   		'cargos'=>array('justification'=>'right','width'=>65), // Justificación y ancho de la columna
						 			   		'total'=>array('justification'=>'right','width'=>65))); // Justificación y ancho de la columna
		   }
		elseif($as_tipordcom=='S')
		   {
		     $la_columnas=array('codigo'=>'<b>Código</b>',
			 ...
			 $la_config=array('showHeadings'=>1, // Mostrar encabezados
						 	  ...
						 	  'xOrientation'=>'center', // Orientación de la tabla
						      'cols'=>array('codigo'=>array('justification'=>'center','width'=>99), // Justificación y ancho de la columna
						 			   		'denominacion'=>array('justification'=>'left','width'=>171), // Justificación y ancho de la columna
						 			   		'cantidad'=>array('justification'=>'right','width'=>40), // Justificación y ancho de la columna
						 			   		'precio'=>array('justification'=>'right','width'=>65), // Justificación y ancho de la columna
						 			   		'subtotal'=>array('justification'=>'right','width'=>65), // Justificación y ancho de la columna
						 			   		'cargos'=>array('justification'=>'right','width'=>65), // Justificación y ancho de la columna
