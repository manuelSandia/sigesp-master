...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->addText(140,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(145,63,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->line(225,60,225,130);	//VERTICAL	
		$io_pdf->addText(250,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(250,63,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->line(340,60,340,130);	//VERTICAL		
		$io_pdf->addText(370,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(370,63,7,"DIRECCIÓN GENERAL"); // Agregar el título
		$io_pdf->line(470,60,470,130);	//VERTICAL		
		$io_pdf->addText(505,122,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(490,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
