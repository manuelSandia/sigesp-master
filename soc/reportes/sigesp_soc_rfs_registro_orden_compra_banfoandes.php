...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_usureg,$ls_usuapr,$as_estcom,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(70,122,7,"ELABORADO POR"); // Agregar el título     $ls_usureg
		$io_pdf->addText(75,63,7,"$ls_usureg"); // Agregar el título
		$io_pdf->line(190,60,190,130);	//VERTICAL	
		$io_pdf->addText(247,122,7,"APROBADO POR"); // Agregar el título     
        $io_pdf->addText(250,72,7,$ls_usuapr); // Agregar el título
		$io_pdf->addText(240,63,7,"UNIDAD DE COMPRAS"); // Agregar el título
		$io_pdf->line(380,60,380,130);	//VERTICAL		
		$io_pdf->addText(445,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(405,63,7,"GERENCIA DE COMPRAS Y CONTRATACIONES"); // Agregar el título
	...
	function uf_print_piecabecera($li_subtot,$li_totcar,$li_montot,$ls_monlet,&$io_pdf)
	{
        ...
        $ls_nota = "<b> Nota:<b>
        · La entrega de material debe realizarse de lunes a viernes en horario comprendido entre las 8:30 a.m. y las 3:30 p.m.
        · El costo total que cancelará Banfoandes Banco Universal, Compañía Anónima, por razón de la presente Orden de Compra será el monto aquí señalado, pagadero en bolívares. De igual manera el precio citado abarca los conceptos de gastos por viáticos en los que incurra la empresa para cumplir con la obligación contraída.
        · En caso que el Proveedor no cumpla con la obligación contraída dentro del plazo especificado en la presente Orden de Compra, elaborada al efecto, Banfoandes Banco Universal, Compañía Anónima, sin perjuicio de los demás recursos que tenga con arreglo al mismo, podrá deducir del monto total contratado, por concepto de penalización, una suma equivalente al 0,50% del valor del servicio no realizado por cada día de retraso en la entrega, aplicando esta sanción sucesivamente hasta alcanzar un máximo del 15% del valor total de la presente Orden, momento en el cual Banfoandes Banco Universal, Compañía Anónima, podrá rescindir la Orden de Compra.";
        
        $io_pdf->ezSetDy(-5);
        $la_data[1]=array('titulo'=>$ls_nota);
        $la_columnas=array('titulo'=>'');
        $la_config=array('showHeadings'=>0, // Mostrar encabezados
                         'fontSize' => 9, // Tamaño de Letras
                         'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
                ...
                $ls_usureg=$row["codusureg"];
                $ls_usuapr=$row["codusuapr"];
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
                                           ...
                                           $ls_usureg,$ls_usuapr,$ls_estcom,&$io_pdf);
