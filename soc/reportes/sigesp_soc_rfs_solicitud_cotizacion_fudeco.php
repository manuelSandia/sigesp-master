<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsolcot,$as_fecsolcot,$as_dentipsolcot,&$io_pdf)
	{
		...
		$io_pdf->addText(40,40,7,"<b>DIRECCIÓN: ".strtoupper($_SESSION["la_empresa"]["direccion"])."</b>"); 		
		...
		$la_data    = array(array('name'=>'INDICAR EN COTIZACIÓN CONDICIONES DE COMPRA Y/O SERVICIOS: TIEMPO DE ENTREGA Y/O EJECUCIÓN, LUGAR DE ENTREGA, CONDICIONES DE PAGO Y GARANTÍAS'));
		$la_columna = array('name'=>'');		
		$la_config  = array('showHeadings'=>0, // Mostrar encabezados
						    'fontSize'=>10, // Tamaño de Letras
	...
	function uf_print_datos_proveedor($as_codpro,$as_nompro,$as_dirpro,$as_telpro,$as_email,$as_rifpro,$as_faxpro,&$io_pdf)
	{
		...
		$la_data=array(array('name'=>'<b>Nombre o Razón Social: </b>'.$as_codpro.'  -  '.$as_nompro),
					   ...
					   array('name'=>'<b>Teléfono: </b> '.$as_telpro.'  -      <b>FAX: </b>'.$as_faxpro      .'                    <b>E-Mail</b>: '.$as_email.'                                                                         <b>RIF: </b>'.$as_rifpro));				
		      ...
		      if ($li_numrows>0)
		         {
				   ...
				   $io_pdf->ezStartPageNumbers(575,30,10,'','',1); // Insertar el número de página
				   $li_count = 0; 
