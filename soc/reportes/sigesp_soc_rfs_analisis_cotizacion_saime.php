...
//		$io_pdf->add_texto(230,18,10,"$ad_fecha");		
		...
		$io_pdf->add_texto(100,14,14,"<b>"."<b>ANÁLISIS DE COTIZACIONES</b>"."</b>"); // Agregar el título
...
//		$io_pdf->addText(555,770,7,date("d/m/Y")); // Agregar la Fecha
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>394, // Orientación de la tabla
						 'cols'=>array('name'=>array('justification'=>'left','width'=>738))); // Justificación y ancho de la columna
...
/*		$la_data[0]["1"]="<b>Concepto:</b>";
	...
	function uf_print_proveedores($la_cotizaciones,&$io_pdf)
	{
		...
		$la_anchos=array();
		$la_justificaciones=array();
		$la_data[0]["1"]="<b>Nro. Cotización</b>";
	...
	function uf_print_pie_pagina($as_recomendacion,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>393, // Orientación de la tabla
						 'cols'=>array('name'=>array('justification'=>'left','width'=>736))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
