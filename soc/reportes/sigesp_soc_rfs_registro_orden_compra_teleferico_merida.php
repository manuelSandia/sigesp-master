		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ls_orgrif,$ls_telpro,$ls_obscom,$ls_nomdep,$ls_dirdep,$ls_concom,$ls_orgnom,$ls_orgtit,$ls_estcom,&$io_pdf);
