...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],25,690,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$io_pdf->addText(25,780,7,"REPÚBLICA BOLIVARIANA DE VENEZUELA"); // Agregar el título
		$io_pdf->addText(25,774,7,"MINISTERIO DEL PODER POPULAR DE PLANIFICACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->addText(25,768,7,"SUPERINTENDENCIA DE LA ACTIVIDAD ASEGURADORA"); // Agregar el título
		$io_pdf->addText(25,762,7,"OFICINA DE ADMINISTRACIÓN"); // Agregar el título
		if ($as_estcom=='3')
		{
		...
		$io_pdf->addText(160,70,7,"JEFE DE LA OFICINA"); // Agregar el título
		$io_pdf->addText(160,63,7,"DE ADMINISTRACION"); // Agregar el título
		$io_pdf->line(260,60,260,130);	//VERTICAL		
		$io_pdf->addText(295,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(295,70,7,"SUPERINTENDENTE"); // Agregar el título
		$io_pdf->addText(275,63,7,"DE LA ACTIVIDAD ASEGURADORA"); // Agregar el título
