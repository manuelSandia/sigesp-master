<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsolcot,$as_fecsolcot,$as_dentipsolcot,$as_obssolcot,&$io_pdf)
	{
		...
		$io_pdf->addText(42,738,6,"<b>REPÚBLICA BOLIVARIANA DE VENEZUELA</b>");      // Agregar texto
		$io_pdf->addText(42,731,6,"<b>MINISTERIO DEL PODER POPULAR DE PLANIFICACIÓN Y FINANZAS</b>");      // Agregar texto
		$io_pdf->addText(42,724,6,"<b>SUPERINTENDENCIA DE LA ACTIVIDAD ASEGURADORA</b>");      // Agregar texto
		$io_pdf->addText(42,717,6,"<b>OFICINA DE ADMINISTRACIÓN</b>");      // Agregar texto
		...
		$io_pdf->addText(200,680,14,"<b>".$as_titulo."</b>"); // Agregar el título
...
function uf_print_autorizacion(&$io_pdf)
{
		...
		$io_pdf->addText(230,232,6,"IMPORTANTE: REQUISITOS DEL PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(20,223,6,"1.- INDICAR PRECIO UNITARIO Y TOTAL"); // Agregar el título
		$io_pdf->addText(20,217,6,"2.- IMPUESTO AL VALOR AGREGADO (IVA ) 12%"); // Agregar el título
		$io_pdf->addText(20,210,6,"3.- SEÑALAR EL NÚMERO DEL REGISTRO DE INFORMACIÓN FISCAL (RIF)"); // Agregar el título
		$io_pdf->addText(20,203,6,"4.- DIRECCIÓN COMPLETA Y TELÉFONO"); // Agregar el título
		$io_pdf->addText(20,197,6,"5.- NÚMERO DE INSCRIPCIÓN EN EL REGISTRO NACIONAL DE CONTRATISTAS (RNC), PARA CANTIDADES MAYORES A 4.000 UNIDADES TRIBUTARIAS"); // Agregar el título
		$io_pdf->addText(20,190,6,"6.- INDICAR TIEMPO DE ENTREGA"); // Agregar el título
		$io_pdf->addText(20,183,6,"7.- INDICAR SI CUMPLE  CON EL COMPROMISO DE RESPONSABILIDAD SOCIAL  (ART. 6 DE LA LEY DE CONTRATACIONES PÚBLICAS)"); // Agregar el título
		$io_pdf->addText(20,177,6,"8.- ELABORAR A NOMBRE DE: SUPERINTENDENCIA DE LA ACTIVIDAD ASEGURADORA"); // Agregar el título
		
		$io_pdf->addText(20,169,6,"A partir de la recepción de la presente solicitud, la Empresa cuenta con tres (3) días hábiles para presentar su Oferta en bienes o servicios, y cuatro (4) días hábiles para Obras, según el Art. 45 de la Ley de"); // Agregar el título
		$io_pdf->addText(20,162,6,"Contrataciones Públicas vigente."); // Agregar el título

		$io_pdf->addText(240,150,6,"JEFE DE LA OFICINA DE ADMINISTRACIÓN"); // Agregar el título
		
		$io_pdf->addText(230,78,6,"Dirección: Final Av. Venezuela, Torre Del Desarrollo, El Rosal"); // Agregar el título
		$io_pdf->addText(265,71,6,"Nº de RIF: G-20008047-7"); // Agregar el título
		$io_pdf->addText(230,64,6,"Contactos: 0212/901688 – 9051524 Telefax: 0212/9051688"); // Agregar el título
		$io_pdf->closeObject();
		      ...
		      if ($li_numrows>0)
		         {
				   ...
				   $io_pdf->ezSetCmMargins(2,2,3,3); // Configuración de los margenes en centímetros
