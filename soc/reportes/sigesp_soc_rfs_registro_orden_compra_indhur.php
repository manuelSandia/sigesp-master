...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		// cuadro inferior
		$io_pdf->Rectangle(18,63,565,100);
		$io_pdf->line(18,145,582,145);	/////////	
		$io_pdf->line(18,92,582,92);///////////
		//$io_pdf->line(18,115,582,115);		
		
		$io_pdf->line(130,92,130,163);		
		$io_pdf->line(260,92,260,163);		
		$io_pdf->line(390,92,390,163);		
		$io_pdf->line(500,92,500,163);		
		
		$io_pdf->addText(45,150,6,"ELABORADO POR");
		$io_pdf->addText(170,150,6,"REVISADO POR");
		$io_pdf->addText(295,150,6,"ADMINISTRACION");
		$io_pdf->addText(420,150,6,"PRESUPUESTO");
		$io_pdf->addText(520,150,6,"PRESIDENCIA");

		$io_pdf->line(160,63,160,92);	////	
		$io_pdf->line(290,63,290,92);	////
		$io_pdf->line(450,63,450,92);	////
		$io_pdf->addText(23,85,6,"NOMBRE"); // Agregar el título	
		$io_pdf->addText(165,85,6,"CEDULA DE IDENTIDAD N°"); // Agregar el título
		$io_pdf->addText(295,85,6,"FECHA"); // Agregar el título
		$io_pdf->addText(455,85,6,"FIRMA"); // Agregar el título
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>114), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>114), // Justificación y ancho de la columna
						 			   'cantidad'=>array('justification'=>'left','width'=>39), // Justificación y ancho de la columna
						 			   'unidad'=>array('justification'=>'center','width'=>61), // Justificación y ancho de la columna
						 			   'cosuni'=>array('justification'=>'right','width'=>58), // Justificación y ancho de la columna
						 			   'baseimp'=>array('justification'=>'right','width'=>63), // Justificación y ancho de la columna
						 			   'cargo'=>array('justification'=>'right','width'=>56), // Justificación y ancho de la columna
