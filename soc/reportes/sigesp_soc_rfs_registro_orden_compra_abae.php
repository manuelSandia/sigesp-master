...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->addText(18,95,6,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]); // Agregar el título
		$io_pdf->addText(50,63,7,"COMPRAS"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(167,122,7,"VERIFICADO POR"); // Agregar el título
		...
		$io_pdf->addText(285,63,7,"GERENCIA DE ADMINISTRACION"); // Agregar el título
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			$io_pdf->ezSetCmMargins(7.5,5,3,3); // Configuración de los margenes en centímetros
