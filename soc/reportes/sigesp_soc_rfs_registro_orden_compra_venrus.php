...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		if($as_estcondat=="B") 
        {
             $ls_titulo="Orden de Compra / Purchase Order";	
			 $ls_titulo_grid="Bienes";
        }
        else
        {
             $ls_titulo="Orden de Servicio / Service Order";
		...
		$io_pdf->addText(485,710,9,"<b>Fecha / Date </b>".$ad_fecordcom); // Agregar el título
		$io_pdf->addText(540,770,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(546,764,6,date("h:i a")); // Agregar la Hora
		// cuadro inferior
        $io_pdf->Rectangle(15,60,570,70); 
		//$io_pdf->line(15,117,585,117);	//HORIZONTAL	
		$io_pdf->addText(20,122,7,"COMENTARIO / COMMENT:"); // Agregar el título
		$io_pdf->addText(19,121,7,"_______________________"); // Agregar el título
		$io_pdf->addText(17,76,7,"Requisición Asignada / Assigned requisition"); // Agregar el título
		$io_pdf->addText(17,63,7,"Contacto email / Email contact   msalas@venrusca.com.ve"); // Agregar el título
		$io_pdf->addText(17,63,7,"_______________"); // Agregar el título
		$io_pdf->line(202,60,202,130);	//VERTICAL	
		$io_pdf->addText(207,122,7,"SOLICITADO / REQUESTED"); // Agregar el título
		$io_pdf->addText(207,122,7,"________________________"); // Agregar el título
		$io_pdf->addText(220,63,7,"MAIRANOR SALAS"); // Agregar el título
		$io_pdf->line(330,60,330,130);	//VERTICAL		
		$io_pdf->addText(335,122,7,"REVISADO / REVISED"); // Agregar el título
		$io_pdf->addText(335,122,7,"____________________"); // Agregar el título
		$io_pdf->addText(370,63,7,"MANUEL BORREGO"); // Agregar el título
		$io_pdf->line(470,60,470,130);	//VERTICAL		
		$io_pdf->addText(475,122,7,"APROBADO / APPROVED"); // Agregar el título
		$io_pdf->addText(475,122,7,"_____________________"); // Agregar el título
		$io_pdf->addText(495,63,7,"MANUEL BORREGO"); // Agregar el título
		$io_pdf->line(15,83,202,83); //HORIZONTAL		
		
		$io_pdf->ezSetY(695);
		$la_data[1]=array('columna1'=>'<b>Proveedor / Vendor Name</b>  '.$as_nombre.'<b>             Rif / Vendor ID.</b> '.$as_rifpro,
		                 'columna2'=>'<b>Direccion / Address</b> '.$as_dirpro.'');
		...
		$la_data[1]=array('columna1'=>'<b>Unidad Ejecutora / Executive Unit</b>    '.$ls_uniadm,'columna2'=>'<b>Forma de Pago / Method of payment</b>    '.$ls_forpagcom);
		...
		$la_data[1]=array('columna1'=>'<b>Fuente Financiamiento / Finance source</b>   '.$ls_fuefin,'columna2'=>'<b> Plazo de Entrega / Delivery Time</b>    '.$as_diaplacom);
		$la_columnas=array('columna1'=>'','columna2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[1]=array('columna1'=>'<b>Período de Entrega    Desde / Delivery Period From:</b> '.$ld_perentdesde.'    <b>Hasta / To:</b> '.$ld_perenthasta.'');
		...
		$la_data[1]=array('columna1'=>'<b>Concepto / Concept</b>         '.$as_conordcom);
		$la_columnas=array('columna1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		{
			$ls_titulo_grid="Bienes";
			$ls_titulo_grid2="Property";
		}
		else
		{
			$ls_titulo_grid="Servicios";
			$ls_titulo_grid2="Services";
		}
		$io_pdf->ezSetDy(-10);
		$la_datatitulo[1]=array('columna1'=>'<b> Detalle de '.$ls_titulo_grid.' / '.$ls_titulo_grid2.'  Details '.'</b>');
		$la_columnas=array('columna1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		unset($la_config);
		$io_pdf->ezSetDy(-2);
		$la_columnas=array('codigo'=>'<b>Código / Code</b>',
						   'denominacion'=>'<b>Denominacion / Description</b>',
						   'cantidad'=>'<b>Cant. / Quantity</b>',
						   'unidad'=>'<b>Unidad / Unit</b>',
						   'cosuni'=>'<b>Costo / Cost'.$ls_bolivares.'</b>',
						   'baseimp'=>'<b>Sub-Total '.$ls_bolivares.'</b>',
						   'cargo'=>'<b>Cargo / Charge '.$ls_bolivares.'</b>',
	...
	function uf_print_detalle_cuentas($la_data,&$io_pdf)
	{
		...
		if($ls_estmodest==1)
		{
			$ls_titulo="Estructura Presupuestaria / Budget structure";
		}
		else
		{
			$ls_titulo="Estructura Programatica / Program Structure";
		}
		$la_datatit[1]=array('titulo'=>'<b> Detalle de Presupuesto / Budget Detail </b>');
	...
	function uf_print_piecabecera($li_subtot,$li_totcar,$li_montot,$ls_monlet,&$io_pdf)
	{
		...
		unset($la_columnas);
		unset($la_config);
		$la_data[1]=array('titulo'=>'<b>Cargos / Charge '.$ls_bolivares.'</b>','contenido'=>$li_totcar,);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
