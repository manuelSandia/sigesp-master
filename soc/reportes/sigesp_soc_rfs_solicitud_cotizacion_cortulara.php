<?php
	...
	function uf_print_encabezado_pagina($io_encabezado,$as_titulo,$as_numsolcot,$as_fecsolcot,$as_dentipsolcot,$as_obssolcot,$as_consolcot,$as_codpro,$as_nompro,$as_dirpro,$as_telpro,$as_email,$as_rifpro,&$io_pdf)
	{
		...
		// Pie de Pagina
		$io_pdf->addText(100,65,7,"Las aclaratorias serán solicitadas hasta un maximo de 24 horas porterior a la fecha de emisión de esta solicitud en la sede de CORTULARA."); // Agregar el título	
		$io_pdf->addText(190,55,7,"Dirección: Carrera 19 con esquina calle 25, Palacio de Gobierno. Telefax: 0251-233.40.59");	
		$io_pdf->ezSetY(695);
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>125),      // Justificación y ancho de la columna
								...
								'denunimed'=>array('justification'=>'left','width'=>70), // Justificación y ancho de la columna
	...
	//Agrega el detalle de la matriz de evaluación
	//Agregado por TSU Juan Castellanos
	
			// cuadro inferior
        $io_pdf->Rectangle(15,130,570,65); 
		$io_pdf->line(15,180,585,180);	//HORIZONTAL	
		$io_pdf->addText(250,185,9,"MATRIZ DE EVALUACION"); // Agregar el título
		$io_pdf->line(300,80,300,180);	//VERTICAL		
		$io_pdf->line(15,165,585,165);	//HORIZONTAL			
		//Bloque Izquierdo
		$io_pdf->addText(100,170,7,"Precio de la Oferta 80%"); // Agregar el título
		$io_pdf->addText(30,155,7,"- La menor oferta tendrá 80 puntos."); // Agregar el título
		$io_pdf->addText(30,145,7,"- La mayor oferta tendrá 10 puntos."); // Agregar el título
		$io_pdf->addText(30,135,7,"- El resto de las ofertas serán proporcional entre la menor y la mayor tendrá 30 puntos."); // Agregar el título
		//Bloque Derecho
		$io_pdf->addText(400,170,7,"Tiempo de Entrega 20%"); // Agregar el título
		$io_pdf->addText(310,155,7,"- De acuerdo a la solicitud 20 puntos"); // Agregar el título
		$io_pdf->addText(310,145,7,"- Tiempo diferente será causal de descalificación del Proveedor"); // Agregar el título
