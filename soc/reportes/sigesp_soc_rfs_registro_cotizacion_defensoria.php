<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numcot,$as_feccot,$as_dentipcot,$as_obscot,$as_numsolcot,&$io_pdf)
	{
        ...
        $io_pdf->Rectangle(40,60,538,50);
		$io_pdf->line(40,97,577,97);// Horizontal
		$io_pdf->addText(90,100,8,"Elaborado Por: "); // Agregar el título
		$io_pdf->line(230,60,230,110); // Vertical
		$io_pdf->addText(300,100,8,"Revisado Por: "); // Agregar el título
		$io_pdf->line(430,60,430,110); // Vertical	
		$io_pdf->addText(500,100,8,"Sello"); // Agregar el título	
