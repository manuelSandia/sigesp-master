...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,&$io_pdf)
	{
		...
		$io_pdf->line(15,209,380,209);	//HORIZONTAL
		$io_pdf->line(15,170,585,170);	//HORIZONTAL
		$io_pdf->line(15,161,585,161);	//HORIZONTAL
		$io_pdf->line(15,143,585,143);	//HORIZONTAL
		$io_pdf->line(15,110,585,110);	//HORIZONTAL
		$io_pdf->line(15,101,585,101);	//HORIZONTAL	
		$io_pdf->addText(40,212,7,"FIANZA DE FIEL CUMPLIMIENTO:"); // Agregar el título
		$io_pdf->addText(240,212,7,"CLAUSULA PENAL:"); // Agregar el título
		$io_pdf->line(200,170,200,208);	//VERTICAL
		$io_pdf->line(380,170,380,220);	//VERTICAL
		$io_pdf->addText(390,212,7,"CLAUSULA ESPECIAL:"); // Agregar el título
		$io_pdf->addText(190,163,7,"FIRMAS Y SELLOS PARA LA APROBACION DE LA ORDEN DE COMPRA"); // Agregar el título
		$io_pdf->addText(20,155,7,"GERENCIA DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(55,95,7,"APELLIDO(S) Y NOMBRE(S)"); // Agregar el título
		$io_pdf->line(145,110,145,160);	//VERTICAL	
		$io_pdf->addText(173,155,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->line(260,110,260,160);	//VERTICAL		
		$io_pdf->addText(290,155,7,"GERENCIA DE PLANIFICACION"); // Agregar el título
		$io_pdf->addText(305,146,7,"Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(265,95,7,"CEDULA DE IDENTIDAD"); // Agregar el título
		$io_pdf->line(420,110,420,160);	//VERTICAL		
		$io_pdf->addText(460,155,7,"COORDINADOR DE COMPRAS"); // Agregar el título
		$io_pdf->addText(175,103,7,"RECEPCION CONFORME DE LA ORDEN DE COMPRA POR EL PROVEEDOR"); // Agregar el título
		$io_pdf->addText(455,95,7,"FIRMA Y FECHA DE RECIBO"); // Agregar el título
		$io_pdf->line(420,60,420,100);	//VERTICAL
		$io_pdf->line(200,60,200,100);	//VERTICAL
		$io_pdf->addText(15,203,6,"AL APROBARSE ESTA ORDEN SE EXIGIRA AL BENEFICIARIO"); // Agregar el título
		$io_pdf->addText(15,196,6,"FIANZA DE FIEL CUMPLIMIENTO EQUIVALENTE AL ______%"); // Agregar el título
		$io_pdf->addText(15,189,6,"DEL MONTO DE ESTA ORDEN OTORGADA POR BANCO O"); // Agregar el título
		$io_pdf->addText(15,182,6,"COMPAÑIA DE SEGUROS VIGENTE HASTA LA TOTAL ENTREGA"); // Agregar el título
		$io_pdf->addText(15,175,6,"DE LA MERCANCIA."); // Agregar el título
		
		$io_pdf->addText(205,203,6,"QUEDA ESTABLECIDA LA CLAUSULA PENAL SEGUN LA"); // Agregar el título
		$io_pdf->addText(205,196,6,"CUAL EL PROVEEDOR PAGARA AL FISCO ______% SOBRE"); // Agregar el título
		$io_pdf->addText(205,189,6,"EL MONTO DE LA MERCANCIA RESPECTIVA POR CADA DIA"); // Agregar el título
		$io_pdf->addText(205,182,6,"HABIL DE RETARDO EN LA ENTREGA."); // Agregar el título

		$io_pdf->addText(385,203,6,"EL ORGANISMO SE RESERVA EL DERECHO DE ANULAR"); // Agregar el título
		$io_pdf->addText(385,196,6,"UNILATERALMENTE LA PRESENTE ORDEN DE COMPRA SIN"); // Agregar el título
		$io_pdf->addText(385,189,6,"INDEMNIZACION DE CONFORMIDAD CON LAS PREVISIONES."); // Agregar el título
		$io_pdf->addText(385,182,6,"LEGALES QUE RIGEN LA MATERIA."); // Agregar el título
		$io_pdf->ezSetY(695);
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			$io_pdf->ezSetCmMargins(6.7,7.5,3,3); // Configuración de los margenes en centímetros
