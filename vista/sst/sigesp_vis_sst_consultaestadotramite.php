...
<html>
	<head>
	    ...
	    <title id="page-title">SIGESP - Consultar Estado Tramites</title> 
    	...
    	<script language="javascript">
			var sistema='SST';
			var vista='sigesp_vis_sst_consultaestadotramite.php';
			var tbnuevo = false;
		...
		<script type="text/javascript" src="js/sigesp_vis_sst_consultaestadotramite.js"></script>
	...
	<body>
		...
		<table width="925" height="33" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno" id="norte">
			<tr> 
				...
				<div id="formulario_consultratramite"></div>
			</tr>
 		</table>
	</body> 
</html>