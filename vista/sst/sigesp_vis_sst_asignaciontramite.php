...
<html>
	<head>
	    ...
	    <title id="page-title">SIGESP - Asignar Tramite</title> 
    	...
    	<script language="javascript">
			var sistema='SST';
			var vista='sigesp_vis_sst_asignaciontramite.php';
			var tbnuevo = false;
		...
		<script type="text/javascript" src="js/sigesp_vis_sst_asignaciontramite.js"></script>
	...
	<body>
		...
		<table width="925" height="33" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno" id="norte">
			<tr> 
				...
				<div id="formulario_asignaciontramite"></div>
			</tr>
 		</table>
	</body>
</html>