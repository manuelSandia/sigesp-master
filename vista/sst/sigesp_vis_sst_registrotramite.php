...
<html>
	<head>
	    ...
	    <title id="page-title">SIGESP - Registro de Tramites</title> 
    	...
    	<script language="javascript">
			var sistema='SST';
			var vista='sigesp_vis_sst_registrotramite.php';
			var tbnuevo = false;
		...
		<script type="text/javascript" src="js/sigesp_vis_sst_registrotramite.js"></script>
		<script type="text/javascript" src="catalogo/sigesp_vis_sst_catalogo_documento.js"></script>
		<script type="text/javascript" src="catalogo/sigesp_vis_sst_catalogo_tramite.js"></script>
	</head>
	<body>
		<script type="text/javascript" src="../../base/librerias/js/general/sigesp_vis_encabezado.js"></script>
		<table width="925" height="33" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno" id="norte" background="#F9F9EE">
			<tr> 
				<div id="menu_principal"></div>
				<div id="barra_herramientas"></div>
				<div id="formulario_registrotramite"></div>
			</tr>
 		</table>
	</body>
</html>