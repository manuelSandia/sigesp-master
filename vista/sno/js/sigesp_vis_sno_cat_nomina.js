/**************************************************************************
*@archivo javascript para el catálogo de nomina
*@version: 1.0
...
/******************************************************************************
* @Función genérica para el uso del catálogo de nomina
* @parametros: 
* @retorno: 
...
**************************************************************************/
	function actualizarDataNomina(criterio,cadena)
	{
		...
		objdata=Ext.util.JSON.encode(myJSONObject);
...
/***********************************************************************************
* @Función que carga los usuarios de la nómina
* @parámetros: 
* @retorno: 
			...
			if (datos!='')
			{
				...
				if (myObject.raiz[0].valido==true)
				{
					...
					{name: 'desnom'}
			      	...
			      	gridNomina = new Ext.grid.GridPanel({
			            ...
			            new Ext.grid.CheckboxSelectionModel(),
							{header: 'Código', width: 30, sortable: true,   dataIndex: 'codnom'},
					...
					var panelNomina = new Ext.FormPanel({
						...
						{
							title: 'Cat&aacute;logo de Nóminas',
					    	autoScroll:true,
			                width:500,
			                height:400,
			                modal: true,
