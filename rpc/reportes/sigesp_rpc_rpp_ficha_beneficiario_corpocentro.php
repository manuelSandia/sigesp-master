...
function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
{
	...
	//	reado Por: Ing. Yesenia Moreno
	// Fecha Creación: 21/04/2006 
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	$io_encabezado=$io_pdf->openObject();
	$io_pdf->saveState();
	$io_pdf->line(20,48,578,48);
	$io_pdf->addText(35,40,7,"CORPORACION DE DESARROLLO DE LA REGION CENTRAL. AVENIDA BOLIVAR NORTE CALLE FLORES SECTOR SAN JOSE EDIFICIO CORPOCENTRO.");
	$io_pdf->addText(170,30,7,"VALENCIA, Edo. CARABOBO. RIF: G-20008343-3. Telefono: 02418581919.");	
