...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$io_pdf->saveState();
	$io_pdf->line(20,48,578,48);
	$io_pdf->addText(35,40,7," AVENIDA BOLIVAR NORTE CALLE FLORES SECTOR SAN JOSE EDIFICIO CORPOCENTRO VALENCIA, Edo. CARABOBO. Telefono: 0241-8581919.Fax: 0241-8585325.");
	$io_pdf->addText(35,690,8,'<b>'." LA CORPORACION DE DESARROLLO DE LA REGION CENTRAL (CORPOCENTRO) ADSCRITO AL MINISTERIO DEL PODER POPULAR PARA".'</b>');
	$io_pdf->addText(35,680,8,'<b>'." LA PLANIFICACION Y DESARROLLO (MPPPD) HACE CONSTAR QUE LA SIGUIENTE EMPRESA ESTA INSCRITA EN ESTE ORGANISMO:".'</b>');
        $io_pdf->line(140,175,500,175);
	$io_pdf->addText(230,160,10,'<b>'."PRESIDENTE DE LA CORPORACION".'</b>'); // Agregar el título
        $io_pdf->addText(40,450,10,'<b>'."PRESENTACION, REVISION Y ADMISION CONFORME DE LOS DOCUMENTOS Y RECAUDOS EXIGIDOS".'</b>'); // Agregar el título
	...
	if ($lb_valido)
	   {
		 ...
		 for ($z=1;$z<=$li_total;$z++)
			 ...
			 ///$io_pdf->addText(43,625,10,'<b>PROVEEDOR :</b>');
			   $io_pdf->addText(43,625,16,'<b>'.$ls_nompro.'</b>'); 
		      /// $io_pdf->line(120,618,120,652);
			   $io_pdf->rectangle(35,475,520,140);
			   $io_pdf->addText(43,600,10,'<b>Domiciliada en:</b>');
			   $ls_dirpro = $io_pdf->addTextWrap(230,600,400,10,$ls_dirpro);
			   $io_pdf->addText(230,585,10,$ls_dirpro);
			   $io_pdf->addText(43,585,10,'<b>Con un Capital de:</b>');
			   $io_pdf->addText(230,585,10, $ld_capital);
			   $io_pdf->addText(43,570,10,'<b>Representada legalmente por:</b>');
			   $io_pdf->addText(230,570,10,$ls_nomrep);
			   $io_pdf->addText(43,555,10,'<b>Telefono:</b>');
			   $io_pdf->addText(230,555,10,$ls_telpro);
			   //$io_pdf->addText(43,510,10,'<b>Representada legalmente por:</b>');
			 //  $io_pdf->addText(130,510,10,$ls_nomrep); 
			   $io_pdf->addText(43,540,10,'<b>RIF :</b>');
			   $io_pdf->addText(230,540,10,$ls_rifpro);
			   $io_pdf->addText(43,525,10,'<b>Ha sido inscrita en Fecha:</b>');
			   $io_pdf->addText(230,525,10, $ls_fecreg);
			   $io_pdf->addText(43,510,10,'<b>Bajo el Codigo de Registro Nùmero:</b>');
			   $io_pdf->addText(230,510,10,$ls_codpro);
