  ...
  <tr>
	...
	<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema de Proveedores y Beneficiarios</td>
			<td width="349" bgcolor="#E7E7E7"><div align="right"><span class="letras-peque�as"><b><?php print $ls_diasem." ".date("d/m/Y")." - ".date("h:i a ");?></b></span></div></td>
	  	  <tr>
...
if  (array_key_exists("chkageviapro",$_POST))
	{
	  $ls_ageviapro=$_POST["chkageviapro"];
	  $lr_datos["ageviapro"]=$ls_ageviapro;
    }
else
	{
	  $ls_ageviapro="0";
...
if  (array_key_exists("chkaerolipro",$_POST))
	{
	  $ls_aerolipro=$_POST["chkaerolipro"];
	  $lr_datos["aerolipro"]=$ls_aerolipro;
    }
else
	{
	  $ls_aerolipro="0";
...
if  (array_key_exists("comprobante",$_POST))
	{
	  $li_comprobante=$_POST["comprobante"];
    }
else
	{
	  $li_comprobante="0";
...
if ($ls_operacion=="NUEVO")
   {
	 $lb_empresa = true;
	 $ls_type    = uf_load_tipo($ls_codemp); // Variable que indica si el C�digo es 
	                                         // N�merico o Alfanumerico para la 
...
if ($ls_operacion=="GUARDAR")
   { 
	 ...
	 if ($lb_existe && $ls_estatus=="GRABADO")
        { 
	      /*if ($ls_estatus=="NUEVO")
		     {
			   $io_msg->message("Este C�digo de Proveedor ya existe !!!");  
			   $lb_valido=false;
			 }
		  else*///if($ls_estatus=="GRABADO")
		     //{
	   ...
	   {
          $lb_valido=$io_proveedor->uf_insert_proveedor($ls_codemp,$lr_datos,$ls_cod,$la_seguridad);
	      if($lb_valido)
		    {
		      $io_sql->commit();
			  $io_msg->message("Registro incluido con el codigo ".$ls_cod);
		      $lb_empresa=false;
	          $ls_codigo=$io_funciondb->uf_generar_codigo($lb_empresa,$ls_codemp,'rpc_proveedor','cod_pro');
		      $ls_estatus="NUEVO";
              uf_limpiar_variables();
...
?>  
 <p>&nbsp;  </p>
   ...
   <table width="770"  border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
    ...
    <tr>
      <td width="212" height="22" align="right"> <span class="sin-borde"><strong>(*)</strong></span> C&oacute;digo&nbsp;</td>
    ...
    <tr>
      ...
      <td height="22" colspan="4"><input name="txtnombre" type="text" id="txtnombre" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz '+',-.;*&?�!�+()[]{}%@/'+'������');" value="<?php print $ls_nombre ?>" size="100" maxlength="100" tabindex="1"></td>
    </tr>
    <tr>
      <td height="22" align="right"><span class="sin-borde" body="bold"><strong>(*)</strong></span> Direcci&oacute;n&nbsp;</td>
      <td height="22" colspan="4"><input name="txtdireccion" type="text" id="txtdireccion" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz '+',-.;*&?�!�+()[]{}%@#/'+'������');" value="<?php print $ls_direccion ?>" size="100" maxlength="254" tabindex="2"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td height="22" colspan="4"><input name="txtnit" type="text" id="txtnit" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz '+'.-');" value="<?php print $ls_nit ?>" size="15" maxlength="15" style="text-align:right" tabindex="10"></td>
    </tr>
    <tr>
    ...
    <tr>
	  ...
	  <td height="22" colspan="4"><select name="cmbcontribuyente" class="contorno" id="cmbcontribuyente" style="width:120px" tabindex="18">
        <option value="-">---seleccione---</option>
        <option value="F" <?php print $ls_formal    ?>>Exento de IVA</option>
    ...
    <tr>
      ...
      <td colspan="4"><input name="txtpagweb" type="text" id="txtpagweb" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz '+'._-');" value="<?php print $ls_pagweb ?>" size="70" maxlength="200"></td>
    </tr>
    <tr>
      <td height="22" align="right">Email&nbsp;</td>
      <td colspan="4"><input name="txtemail" type="text" id="txtemail" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz '+'._-@'); " value="<?php print $ls_email ?>" size="70" maxlength="200"></td>
    </tr>
    <tr>
	...
	?>
     ...
     <tr>
      ...
      <td colspan="4"><input name="txtobservacion" type="text" id="txtobservacion" value="<?php print $ls_observacion ?>" size="70" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz '+'.,-');"></td>
    </tr>
    <tr>
      ...
      Activo</td>
      <td width="92"><input name="estprov" type="radio" class="sin-borde" value="I" <?php print $ls_estprovinactivo ?>>
      Inactivo</td>
      <td width="103"><input name="estprov" type="radio" class="sin-borde" value="B" <?php print $ls_estprovbloqueado ?>>
      Bloqueado</td>
      <td><input name="estprov" type="radio" class="sin-borde" value="S" <?php print $ls_estprovsuspendido ?>>
      Suspendido</td>
    </tr>
    <tr>
      <td height="22" colspan="5" align="right" class="sin-bordeAzul"><div align="center" class="titulo-celdanew">Informaci&oacute;n Especial para Comprobante de Retenci&oacute;n</div></td>
     </tr>
    <tr>
      <td height="22" colspan="5" align="right"><label>
      <div align="center">
        <input name="chkageviapro" type="checkbox" class="sin-borde" id="chkageviapro" value="1" onChange="javascript: ue_agencia('1');" <?php if($ls_ageviapro=='1'){ print 'checked';} ?>>      
        Agencia de Viajes     
          <input name="chkaerolipro" type="checkbox" class="sin-borde" id="chkaerolipro" value="1" onChange="javascript: ue_agencia('2');" <?php if($ls_aerolipro=='1'){ print 'checked';} ?>>      
        Aerolinea</div>
      </label></td>
     </tr>
    <tr>
...
<br>
  ...
  <tr class="titulo-celdanew">
    ...
    <tr>
      ...
      <td height="22"><input name="txtnomrep" type="text" id="txtnomrep" onKeyPress="return keyRestrict(event,'abcdefghijklmn�opqrstuvwxyz ');" value="<?php print $ls_nomrep ?>" size="50" maxlength="50"></td>
    </tr>
    <tr>
      <td height="22" align="right">Cargo&nbsp;</td>
      <td height="22"><input name="txtcargo" type="text" id="txtcargo" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz '+'.,-');" value="<?php print $ls_cargo ?>" size="35" maxlength="35"></td>
    </tr>
    <tr>
      <td height="22"><div align="right">Email&nbsp;</div></td>
      <td height="22"><input name="txtemailrep" type="text" id="txtemailrep" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmno�pqrstuvwxyz '+'._-@');" value="<?php print $ls_emailrep ?>" size="60" maxlength="60"></td>
    </tr>
    <tr>
...
<br>
  <table width="770" border="0" cellpadding="0" cellspacing="0" align="center" class="contorno">
	...
	<tr>
      ...
      <td width="411" height="22"><input name="txtnumregRNC" type="text" id="txtnumregRNC" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz ')"; value="<?php print $ls_numregRNC ?>" size="40" maxlength="35">      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td height="22"><input name="txtregSSO" type="text" id="txtregSSO" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz ')"; value="<?php print $ls_regSSO ?>" size="15" maxlength="15"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="22" align="right">N&ordm; Registro Solvencia Laboral&nbsp;</td>
      <td height="22"><input name="txtregINCE" type="text" id="txtregINCE" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz ')"; value="<?php print $ls_regINCE ?>" size="15" maxlength="15"></td>
    </tr>
    <tr>
      <td height="22" align="right">Fecha Vencimiento Solvencia Laboral&nbsp;</td>
    ...
    <tr>
      ...
      <td height="22"><input name="txtregistro" type="text" id="txtregistro" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz ')"; value="<?php print $ls_registro ?>"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td height="22"><input name="txtnumero" type="text" id="txtnumero" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz ')"; value="<?php print $ls_numero?>" size="15" maxlength="15"></td>
    </tr>
    <tr>
      <td height="22" align="right">Tomo del Registro&nbsp;</td>
      <td height="22"><input name="txttomo" type="text" id="txttomo" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz ')"; value="<?php print $ls_tomo ?>" size="5" maxlength="5"></td>
    </tr>
    <tr>
      <td height="22" align="right">Registro Modificado&nbsp;</td>
      <td height="22"><input name="txtregmod" type="text" id="txtregmod" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz ')"; value="<?php print $ls_regmod ?>" size="40" maxlength="35"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td height="22"><input name="txttommod" type="text" id="txttommod" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz ')"; value="<?php print $ls_tommod ?>" size="5" maxlength="5"></td>
    </tr>
    <tr>
      <td height="22" align="right">N&ordm; Modificado&nbsp;</td>
      <td height="22"><input name="txtnummod" type="text" id="txtnummod" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz ')"; value="<?php print $ls_nummod ?>" size="15" maxlength="15"></td>
    </tr>
    <tr>
      <td height="22" align="right" >N&ordm; Folio&nbsp;</td>
    <td height="22"><input name="txtnumfol" type="text" id="txtnumfol" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz ')"; value="<?php print $ls_numfol ?>" size="5" maxlength="5"></tr>
    <tr>
      <td height="22" align="right">N&ordm; Folio Modificado&nbsp;</td>
    <td height="22"><input name="txtnumfolmod" type="text" id="txtnumfolmod" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz ')"; value="<?php print $ls_numfolmod ?>" size="5" maxlength="5"></tr>
    <tr>
      <td height="22" align="right">N&ordm; Licencia&nbsp;</td>
    <td height="22"><input name="txtnumlic" type="text" id="txtnumlic" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz ')"; value="<?php print $ls_numlic ?>" size="27" maxlength="25"></tr>
    <tr>
    ...
    <tr>
      <td height="22" colspan="2"><div align="center">
        ...
        <input name="comprobante" id="comprobante" type="hidden" value=<?php print $li_comprobante; ?>>      
        <input name="ageviapro" id="ageviapro" type="hidden" value=<?php print $ls_ageviapro; ?>>      
        <input name="aerolipro" id="aerolipro" type="hidden" value=<?php print $ls_aerolipro; ?>>      
      </div></td>
    <td height="22">    </tr>
    <tr>
      <td height="22"></td>
...
function uf_socio(prov)
{
  ...
  if (prov=="")
      {
	    alert("Debe seleccionar previamente un Proveedor V�lido !!!");
      }
   else
      {
...
{//1
  ...
  if (((evento=="NUEVO")&&(li_incluir==1))||(evento=="GRABADO")&&(li_cambiar==1))
     {//2  	
	   with (document.form1)
		    {//3
		      if (valida_null(txtcodigo,"El C�digo del Proveedor esta vacio!!")==false)
		         {//4
			       txtcodigo.focus();
		         }//4
		      else
		         {//5
				   if (valida_null(txtnombre,"El Nombre del Proveedor esta vacio!!")==false)
			          ...
			          {//7
			            if (valida_null(txtdireccion,"La Direcci�n del Proveedor esta vacia!!")==false)
			               {//8
				             txtdireccion.focus();
			               }//8
			            else
				                  ...
				                  if (valida_null(txtnumpririf,"Complete RIF del Proveedor !!!")==false) 
				                     ...
				                     {//13
				                       if (valida_null(txtnumterrif,"Complete RIF del Proveedor !!!")==false) 
				                          ...
				                          {//15
				                            if (valida_null(txtcapital,"El Capital Social Suscrito est� vac�o !!!")==false) 
				                               {//16
					                             txtcapital.focus();
				                               }//16
				                            else
				                               {//17
					                             if (valida_null(txtmonmax,"El monto esta est� vac�o !!!")==false) 
					                                {//18
					                                  txtcapital.focus();
					                                }//18
					                             else
					                                {//19
													       if (valida_null(txtcontable,"El C�digo Contable Asociado al Proveedor est� vac�o !!!")==false) 
					                                          {//22
						                                        txtcontable.focus();
					                                          }//22
					                                       else
...
/*Function:  ue_eliminar()
	 *
	 *Descripci�n: Funci�n que se llama al presionar la opcion de "Eliminar" en el toolbar o en el menu. En caso de que el usuario 
	               presione la opcion de eliminar sin tener marcado ningun registro se enviara un mensaje Javascript indicandole 
				   que no ha seleccionado ningun registro para su eliminaci�n. Una vez seleccionado el registro a eliminar y 
				   presionada la opci�n de eliminar se envia al usuario un mensaje Javascript de verificaci�n que presenta al 
				   usuario las opciones de aceptar o cancelar. Si el usuario presiona la opci�n aceptar se procede a eliminar dicho 
				   registro,en caso contrario se detiene el proceso de eliminaci�n y se limpia los campos de la pagina.*/
function ue_eliminar()
{
    var borrar="";
    f=document.form1;
...
*
 *Descripci�n: Funci�n que se encarga de llamar al respectivo codigo PHP una vez el usuario haya seleccionado un pais y cargar todos
...
/*Fin de la funci�n uf_cambiopais()*/


/*Function:  uf_cambioestado()
*
 *Descripci�n: Funci�n que se encarga de llamar al respectivo codigo PHP una vez el usuario haya seleccionado un estado y cargar todos
...
/*Fin de la funci�n uf_cambioestado()*/
		

/*Function:  uf_cambiomunicipio()
*
 *Descripci�n: Funci�n que se encarga de llamar al respectivo codigo PHP una vez el usuario haya seleccionado un municipio y cargar 
...
/*Fin de la funci�n uf_cambiomunicipio()*/
//FIN DE UBICACI�N GEOGR�FICA
...
/*Function:  ue_nuevo()
	 *
	 *Descripci�n: Funci�n que se encarga de colocar la p�gina en su estado original y poner la p�gina a disposici�n para incluir
	               un nuevo registro*/   
function ue_nuevo()
		{
		  f=document.form1;
...
function ue_agencia(tipo)
{
	f=document.form1;
	if(f.comprobante.value>0)
	{
		if(f.ageviapro.value>0)
		{
			f.chkageviapro.checked=true;
			f.chkaerolipro.checked=false;
		}
		if(f.aerolipro.value>0)
		{
			f.chkageviapro.checked=false;
			f.chkaerolipro.checked=true;
		}
	}
	else
	{
