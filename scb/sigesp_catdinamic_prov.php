...
print "<td width=100 style=text-align:center>C�digo</td>";
print "<td width=300 style=text-align:center>Nombre del Proveedor</td>";
print "<td width=100 style=text-align:center>RIF</td>";
//Se agregó la columna que indica si está o no vigente el proveedor con el RNC
...
if ($ls_operacion=="BUSCAR")
   {
	 $ls_sql     = "SELECT cod_pro,nompro,rifpro,fecvenrnc
	                  FROM rpc_proveedor 
	      ...
	      while ($row=$io_sql->fetch_row($rs_data))
	            {
	             ...
	             //Se agregó en el query el campo "fecvenrnc" y se operó con él para mostrar la vigencia de RNC de los proveedores
				  $ls_fechavenRNC   = $io_funciones->uf_formatovalidofecha($row["fecvenrnc"]);
				  ...
				  //Se agregó la impresión de la etiqueta de vigencia RNC
