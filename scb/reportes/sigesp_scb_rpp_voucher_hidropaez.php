<?php
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		...
		$io_pdf->addText(60,462,10,'<b>'.$ls_nomban.'</b>');
		$io_pdf->addText(273,462,10,'<b>'.$ls_numdoc.'</b>');
		$io_pdf->addText(505,462,10,'<b>'.$ls_ctaban.'</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'left','width'=>110),
									   ...
									   'monto_spg'=>array('justification'=>'right','width'=>80),
						 			   'scg_cuenta'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
...
if ($ls_tipimp=='lote')
   {
	 ...
	 if ($li_total>0)
		{	
		  ...
		  if(trim($ls_codban)=="002")//Banco de Venezuela
		 {
	 	...
	 	elseif(trim($ls_codban)=="003")//Banco Banesco.
		 {
	 	...
	 	elseif(trim($ls_codban)=="004")//Banco Federal.
		 {
		   $ls_archivo   = "cheque_configurable/medidas_federal.txt";
		   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
		   $li_medidas   = 22;
		 }
	 	elseif(trim($ls_codban)=="006")//Banco Provincial.
		 {
		   $ls_archivo   = "cheque_configurable/medidas_provincial.txt";
		   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
		   $li_medidas   = 22;
		 }
	 	elseif(trim($ls_codban)=="007")//Banco Mercantil.
		 {
		   $ls_archivo   = "cheque_configurable/medidas_provincial.txt";
	 	...
	 	elseif(trim($ls_codban)=="009")//Banco CorpBanca
		 {
		   $ls_archivo   = "cheque_configurable/medidas_corbanca.txt";
		   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
		   $li_medidas   = 22;
		 }
	 	elseif(trim($ls_codban)=="010")//Banco BOD
		 {
		   $ls_archivo   = "cheque_configurable/medidas_bod.txt";
		   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
		   $li_medidas   = 22;
		 }
	 	elseif(trim($ls_codban)=="013")//Banco Banfoandes.
		 {
