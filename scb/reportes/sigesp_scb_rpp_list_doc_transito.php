<?php
	...
	function uf_print_totales($ad_debitos,$ad_creditos,$ad_total,&$io_pdf)
	{
		...
		// Fecha Creación: 21/04/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$as_debaux=$ad_debitos;
		$as_credaux=$ad_creditos;
		$as_debaux=str_replace(".","",$as_debaux);
		$as_debaux=str_replace(",","",$as_debaux);
		$as_credaux=str_replace(".","",$as_credaux);
		$as_credaux=str_replace(",","",$as_credaux);
		if ($as_debaux > $as_credaux)
		{
			$ad_total=str_replace("-","",$ad_total);
		}
		if ($as_credaux > $as_debaux)
		{
			$ad_total="- ".$ad_total;
		}
