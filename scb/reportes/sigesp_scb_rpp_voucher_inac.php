<?php
	...
	function uf_print_clausula($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_monto,$ls_nomproben,$ls_fecmov,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$li_pos=265;
		$fecha=date("d/m/Y"); // Agregar la Fecha
		$hora=date("h:i a"); // Agregar la Hora
		$ls_conmovcorto=wordwrap($ls_conmov,100,"?");
		$la_concorto=array();
		$la_concorto=explode("?",$ls_conmovcorto);
		$io_pdf->convertir_valor_mm_px($li_pos);
		$io_pdf->ezSetY($li_pos);
		$la_data=array(array('ordenes'=>$ls_fecmov),
					   array('ordenes'=>$ls_nomproben),
					   array('ordenes'=>$la_concorto[0]),
					   array('ordenes'=>$ls_monto),
					   array('ordenes'=>$ls_numdoc));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>45, // Orientación de la tabla
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('ordenes'=>array('justification'=>'left','width'=>60))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	}// end function uf_print_cabecera.
	
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_monto,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_cabecera
		//		   Access: private 
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$io_pdf->addText(132,137.6,9,'<b>CONTABILIZADO POR:</b>');
		$io_pdf->addText(340,137.6,9,'<b>GERENTE DE FINANZAS</b>');		
		$io_pdf->addText(384,137.6,9,'<b></b>');		
		$io_pdf->addText(508,137.6,9,'<b></b>');
		$io_pdf->addText(258,78.85,10,'<b>Recibí Conforme</b>');
		
		$io_pdf->addText(16,63.27,10,'<b>Nombre y Apellido :</b>');		
	   ...
	   //Descompongo la cadena de operaciones en un arreglo tomando como separación el '-'
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				if (trim($ls_codban)=="001")//Banco de Venezuela.
					 {
				  ...
				  elseif(trim($ls_codban)=="002" || trim($ls_codban)=="005" || trim($ls_codban)=="006" || trim($ls_codban)=="007" || trim($ls_codban)=="008" || trim($ls_codban)=="009" || trim($ls_codban)=="012" || trim($ls_codban)=="013" || trim($ls_codban)=="014" || trim($ls_codban)=="015" || trim($ls_codban)=="099" || trim($ls_codban)=="098" || trim($ls_codban)=="999")//Banco Del Caribe;Central;Casa Propia;Banesco;Mercantil;Banfoandes.
					 {
				  ...
				  elseif(trim($ls_codban)=="003" || trim($ls_codban)=="010")//Banco Industrial de Venezuela.
					 {
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					uf_print_clausula($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_monto,$ls_nomproben,$ld_fecmov,$io_pdf);
					uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_monto,$io_pdf); // Imprimimos la cabecera del registro
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		if(trim($ls_codban)=="001")//Banco de Venezuela.
		 ...
		 elseif(trim($ls_codban)=="019")//Banco Banplus.
		 {
		   $ls_archivo   = "cheque_configurable/medidas_banplus.txt";
		   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
		   $li_medidas   = 16;
		 }
		else
