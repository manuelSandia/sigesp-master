<?php
	...
	//Busqueda de la data 
	$lb_valido        = true;
	$data             = $io_report->uf_generar_estado_cuenta($ls_codemp,$ls_codban,$ls_ctaban,$ls_orden,$ld_fecdesde,$ld_fechasta,&$ldec_saldoant,&$ldec_total_debe,&$ldec_total_haber,true,'C','---');
   // $li_numrows       = $io_sql->num_rows($data);
	...
	else // Imprimimos el reporte
	{
		...
		$lo_hoja->write(4, 4, "Descripción",$lo_titulo);
		$lo_hoja->write(4, 5, "Débitos",$lo_titulo);
		$lo_hoja->write(4, 6, "Créditos",$lo_titulo);
