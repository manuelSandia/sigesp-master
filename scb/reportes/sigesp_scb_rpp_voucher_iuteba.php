<?php
	...
	header("Cache-Control: must-revalidate, post-check=0, pre-check=0");//IUTEBA
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$io_pdf->line(147,90,147,148);
		$io_pdf->line(283,90,283,148);
		$io_pdf->line(440,90,440,148);
		...
		$io_pdf->addText(46,137.6,9,'<b>ADM / ECON IRIS</b>');
		$io_pdf->addText(182,137.6,9,'<b>SUB / ADMON</b>');
		$io_pdf->addText(330,137.6,9,'<b>DIRECTOR</b>');		
		$io_pdf->addText(490,137.6,9,'<b>CONTABILIDAD</b>');
	   ...
	   //Descompongo la cadena de operaciones en un arreglo tomando como separación el '-'
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				elseif(trim($ls_codban)=="002")//Banco Occidental de Descuento.
				   {
