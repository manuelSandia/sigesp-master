<?php
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,&$io_pdf)
	{
		...
		$io_pdf->add_texto($valores[2],$valores[3],10,"<b>$ls_nomproben</b>");
		...
		//Fecha del Cheque
		$io_pdf->add_texto($valores[8],$valores[9],10,"<b>$ls_fecha_corta</b>");
		$io_pdf->add_texto($valores[10],$valores[11],10,"<b>$ls_anio</b>");	
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ldec_monto,&$io_pdf)
	...
	$io_pdf->setStrokeColor(0,0,0);
		...
		$la_data=array(//array('banco'=>'<b>Banco</b>  ','cheque'=>'<b>Cheque N�</b>  ','cuenta'=>'<b>Cuenta N�:</b>  ','voucher'=>'<b>Voucher N�:</b>  '),
						array('cuenta'=>$ls_ctaban,'ordenes'=>$ls_conmov,'monto_spg'=>$ldec_monto)); 
		$la_columna=array('cuenta'=>'','ordenes'=>'','monto_spg'=>''); //Imprime N° de Cuenta del banco,Concepto de Pago y el Monto
//				$la_config=array('xOrientation'=>'justified', // Orientaci�n de la tabla
...
//		                 'maxWidth'=>580);
        $la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('cuenta'=>array('justification'=>'left','width'=>120),'ordenes'=>array('justification'=>'left','width'=>260),
                         'monto_spg'=>array('justification'=>'left','width'=>200))); // Ancho M�ximo de la tabla
...
////////////////////////////////////////IMPRIME MONTO TOTAL////////////////////////////////////////////		                 
	   ...
	   //$io_pdf->set_margenes(107,55,0,0);   
		$la_data=array(//array('banco'=>'<b>Banco</b>  ','cheque'=>'<b>Cheque N�</b>  ','cuenta'=>'<b>Cuenta N�:</b>  ','voucher'=>'<b>Voucher N�:</b>  '),
						array('monto_spg'=>$ldec_monto)); 
		$la_columna=array('monto_spg'=>'');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>270, // Ancho M�ximo de la tabla
						 'xOrientation'=>'center', // Orientaci�n de la tabla
						 'cols'=>array('monto_spg'=>array('justification'=>'right','width'=>270)));
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		
////////////////////////////////////// IMPRIME NRO. CHEQUE Y NOMBRE DEL BANCO //////////////////////////////////////		
		$io_pdf->ezSetDy(-5);
	    $io_pdf->setStrokeColor(0,0,0);
	    $li_pos=125;
	    $io_pdf->convertir_valor_mm_px($li_pos);
		...
		$la_columna=array('cheque'=>'','banco'=>''); //Imprime N° de Cuenta del banco,Concepto de Pago y el Monto
//				$la_config=array('xOrientation'=>'justified', // Orientaci�n de la tabla
//		                 'width'=>580, // Ancho de la tabla
//		                 'maxWidth'=>580);
        $la_config=array('showHeadings'=>0,
                         'fontSize' => 8, // Tama�o de Letras // Mostrar encabezados
						 'showLines'=>0, // Mostrar L�neas
						 'shaded'=>0, // Sombra entre l�neas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xOrientation'=>'center', // Orientaci�n de la tabla
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('cheque'=>array('justification'=>'left','width'=>100),'banco'=>array('justification'=>'left','width'=>480)));
                         //'monto_spg'=>array('justification'=>'left','width'=>200))); // Ancho M�ximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	//	$io_pdf->ezTable($la_data_title,$la_columna,'',$la_config);	
		...
		//$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 //'xOrientation'=>'center', // Orientaci�n de la tabla
						 //'cols'=>array('monto_spg'=>array('justification'=>'right','width'=>250)));
	...
	//	$io_pdf->setStrokeColor(0,0,0);
	//	$la_data_title=array($la_title);
	//	$io_pdf->set_margenes(130,55,0,0);         
	//	$la_columna=array('title'=>'','title2'=>'');
	//	$la_config=array('showHeadings'=>0, // Mostrar encabezados
	//					 'showLines'=>1, // Mostrar L�neas
	//					 'shaded'=>0, // Sombra entre l�neas
	...
	//					 'xOrientation'=>'center', // Orientaci�n de la tabla
	//					 'cols'=>array('monto_spg'=>array('justification'=>'right','width'=>75)));
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ldec_monto,$io_pdf); // Imprimimos la cabecera del registro
