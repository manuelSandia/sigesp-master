<?PHP
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ld_fecha,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// Fecha Creación: 06/06/2007. 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->add_texto(150,96,9,$ls_chevau);//Numero de voucher
		$io_pdf->add_texto(10,96,9,$_SESSION["la_empresa"]["nombre"]."  ".$ls_ctaban);//Nombre de la empresa y numero de cuenta bancaria
		$io_pdf->add_texto(24,106,9,$ls_numdoc);//Numero de documento
		$io_pdf->add_texto(74,106,9,$ls_nomban);//Nombre del banco
		$io_pdf->add_texto(154,106,9,$ld_fecha);//fecha de emision
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle($la_title,$la_data,$la_data_spg,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_columnas=array('cuenta'=>'',
						   ...
						   'debe'=>'',
						   'haber'=>'');
		$io_pdf->ezTable($la_dataaux,$la_columnas,'',$la_config);			
			...
			for ($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
				  ...
				  uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,'  ',$ls_conmov,$ld_fecmov,$io_pdf); // Imprimimos la cabecera del registro
				  ...
				  uf_print_detalle(array('title'=>'','title2'=>''),$la_data,$la_data_spg,$io_pdf); // Imprimimos el detalle		
