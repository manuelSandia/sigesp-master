<?php
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('voucher'=>array('justification'=>'left','width'=>116),
									   ...
									   'orden'=>array('justification'=>'left','width'=>100))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('scg_cuenta'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'descripcion'=>array('justification'=>'center','width'=>225),
									   'debe'=>array('justification'=>'right','width'=>120), // Justificación y ancho de la columna
						 			   'haber'=>array('justification'=>'right','width'=>120))); // Justificación y ancho de la columna
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$la_data[3]=array('elaborado'=>'Cristian Fernández','revisado'=>'Anabel Torres','presupuesto'=>'Milagros Negrón','administracion'=>'','presidencia'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 ...
						 'cols'=>array('elaborado'=>array('justification'=>'left','width'=>100),
									   ...
									   'presupuesto'=>array('justification'=>'center','width'=>100),
						 			   ...
						 			   'presidencia'=>array('justification'=>'center','width'=>164))); // Justificación y ancho de la columna
