<?PHP
    session_start();//Oficina de Apoyo Marítimo de la Armada.(OCAMAR)    
	...
	function uf_print_detalle($la_datapre,$la_datacon,&$io_pdf,$x_pos)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>238, // Orientación de la tabla
						 'cols'=>array('codestpro1'=>array('justification'=>'left','width'=>55),
									   ...
									   'monto_spg'=>array('justification'=>'right','width'=>175))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>580, // Ancho Máximo de la tabla
						 'colGap'=>1, //Separacion de los caracteres entre las barras de las tablas.
						 'xPos'=>332, // Orientación de la tabla
	...
	//	   			   io_pdf // Objeto PDF
	//    Description: Función que imprime las firmas en el formato del voucher preimpreso del instituto.
	...
	for($li_i=1;$li_i<=$li_totrow;$li_i++)
	{
		...
		uf_print_cabecera($ls_numdoc,$ls_chevau,$ls_nomban,$ls_ctaban,$ls_nomproben,$ls_solicitudes,$ld_fecmov,$ls_conmov,$ls_monto,$ldec_total,$io_pdf); // Imprimimos la cabecera del registro
		uf_print_firmas($io_sql,$class_report,&$io_pdf);
		...
		uf_print_detalle($la_datapre,$la_datacon,$io_pdf,$x_pos); // Imprimimos el detalle 
	}
