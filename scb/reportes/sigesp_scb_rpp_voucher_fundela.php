...
$numalet->setSufijo("***");
    ...
    if($ls_codban=='005')//Banco Industrial.
	   {
	...
	elseif($ls_codban=='001')//Banco Provincial.
	   {
	...
	elseif($ls_codban=='002')// Banco Bicentenario
	   {
	...
	elseif($ls_codban=='007')// Banco Caroní
	   {
	...
	elseif($ls_codban=='008')// Banco Casa Propia
	   {
	...
	else if($ls_codban=='003')// Banco Federal
	     {
		 ...
		 else if($ls_codban=='004') // Banco Mercantil
	     {
