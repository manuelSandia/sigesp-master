<?php
    session_start();//VIALIDAD Y CONTRUCCIONES SUCRE.   
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
	    ...
	    $io_pdf->ezSetY(578);
		$la_data=array(array('cheque'=>'','voucher'=>''),  
						array('cheque'=>'No cheque:','voucher'=>'                                                            '.$ls_chevau));
		$la_columna=array('cheque'=>'','voucher'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,
						 'cols'=>array('cheque'=>array('justification'=>'left','width'=>260),
						               'voucher'=>array('justification'=>'center','width'=>320)));
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
			
   	    $la_data=array(array('banco'=>'<b>Banco</b>  ','cuenta'=>'<b>Cuenta Nº:</b>  '),
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('banco'=>array('justification'=>'left','width'=>260),
						               'cuenta'=>array('justification'=>'left','width'=>320)));
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_fun_nomina;
		$la_data[0]=array('elaborado'=>'<b>HECHO POR:</b>','revisado'=>'<b>REVISADO POR:</b>','presupuesto'=>'<b>CONTABILIZADO POR</b>','administracion'=>'<b>FIRMA A</b>','presidencia'=>'<b>FIRMA B</b>');
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					if (empty($la_data))
					   {
						 $la_data[1]=array('spg_cuenta'=>'','estpro'=>'','monto_spg'=>'','scg_cuenta'=>'','debe'=>'','haber'=>'');
						 $la_data[2]=array('spg_cuenta'=>'','estpro'=>'','monto_spg'=>'','scg_cuenta'=>'','debe'=>'','haber'=>'');
						 $la_data[3]=array('spg_cuenta'=>'','estpro'=>'','monto_spg'=>'','scg_cuenta'=>'','debe'=>'','haber'=>'');
					   }
