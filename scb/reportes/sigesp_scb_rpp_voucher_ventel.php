<?php
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ldec_total,$ls_dencta,$ls_nomban,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//$io_pdf->addText(50,580,10,$ls_conmov);
		...
		$io_pdf->ezSetY(426);
		$la_data=array(array('banco'=>'CHEQUE','cheque'=>$ls_numdoc,'cuenta'=>'','voucher'=>$ldec_total,'estatus'=>''));
		$la_columna=array('banco'=>'','cheque'=>'','cuenta'=>'','voucher'=>'','estatus'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('banco'=>array('justification'=>'center','width'=>70),'cheque'=>array('justification'=>'center','width'=>130),
						 'cuenta'=>array('justification'=>'center','width'=>150),'voucher'=>array('justification'=>'center','width'=>150),'estatus'=>array('justification'=>'left','width'=>30))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		
		$ls_dencta_cortado=wordwrap($ls_dencta,35,"?");
		$la_arreglo=array();
		$la_arreglo_den=explode("?",$ls_dencta_cortado);
		$io_pdf->ezSetY(380);
		$la_data2=array(array('banco'=>$ls_ctaban,'cheque'=>$la_arreglo_den[0],'cuenta'=>$ls_nomban,'voucher'=>$ldec_total));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('banco'=>array('justification'=>'center','width'=>100),'cheque'=>array('justification'=>'center','width'=>200),
						 'cuenta'=>array('justification'=>'center','width'=>150),'voucher'=>array('justification'=>'right','width'=>80))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data2,$la_columna,'',$la_config);
		
		$io_pdf->ezSetY(90);
		$la_data3=array(array('banco'=>$ls_nomban,'cheque'=>$ls_chevau));
		$la_columna=array('banco'=>'','cheque'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>0, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('banco'=>array('justification'=>'center','width'=>180),'cheque'=>array('justification'=>'right','width'=>150))); // Ancho Máximo de la tabla
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		// Fecha Creación: 02/04/2008 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$li_montooriginal=$la_data["1"]["monto_spg"];
		$li_montodesc=$la_data["1"]["debe"];
		if (($li_montooriginal!=0)||($li_montooriginal!=0.00))
		{
			$io_pdf->addText(280,415.5,8,$li_montooriginal);	//320
		}
		else
		{
			$io_pdf->addText(280,415.5,8,$li_montodesc);
		}
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('title'=>array('justification'=>'center','width'=>310),'title2'=>array('justification'=>'center','width'=>270))); // Ancho Máximo de la tabla
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>150),
									   ...
									   'monto_spg'=>array('justification'=>'right','width'=>80),
						 			   'scg_cuenta'=>array('justification'=>'center','width'=>110), // Justificación y ancho de la columna
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$io_pdf->addText(16,95.6,9,'<b>Lcda. Auristela Aparicio</b>');
		$io_pdf->addText(132,137.6,9,'<b>Revisado por:</b>');
		$io_pdf->addText(132,95.6,9,'<b>Lcdo. Luis E. Rodriguez</b>');
		$io_pdf->addText(250,137.6,9,'<b>Aprobado por:</b>');	
		$io_pdf->addText(250,95.6,9,'<b>Dra. Gloria A. Soler B.</b>');		
		$io_pdf->addText(365,137.6,9,'<b>Pagado por:</b>');		
				...
				for ($li_i=1;$li_i<=$li_totrow;$li_i++)
				    {
					  ...
					  uf_print_encabezado_pagina($ls_codban,number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$io_pdf); // Imprimimos el encabezado de la página
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
else 
   {
	 ...
	 elseif(trim($ls_codban)=="002")//Corp. Banca.
		 {
		   $ls_archivo   = "cheque_configurable/medidas_corbanca.txt";
		   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
		   $li_medidas   = 22;
		 }
	 elseif(trim($ls_codban)=="003")//Banco Bicentenario.
	   {
	 ...
	 for ($li_i=1;$li_i<=$li_totrow;$li_i++)
		 {
		   ...
		   $ls_nomban		= $class_report->uf_select_data($io_sql,"SELECT nomban FROM scb_banco WHERE codban ='".$ls_codban."' AND codemp='".$ls_codemp."'","nomban");
		   $ls_ctaban		= $ds_voucher->data["ctaban"][$li_i];
		   $ls_dencta		= $ds_voucher->data["dencta"][$li_i];
		   $ls_chevau		= $ds_voucher->data["chevau"][$li_i];
		   $ld_fecmov	  	= $io_funciones->uf_convertirfecmostrar($ds_voucher->data["fecmov"][$li_i]);
		   $ls_nomproben 	= $ds_voucher->data["nomproben"][$li_i];
		   $ls_solicitudes  = $class_report->uf_select_solicitudes($ls_numdoc,$ls_codban,$ls_ctaban);
		   ...
		   $ls_monto= $numalet->letra();
		   uf_print_encabezado_pagina($ls_codban,number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$io_pdf); // Imprimimos el encabezado de la página
		   uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,number_format($ldec_total,2,",","."),$ls_dencta,$ls_nomban,$io_pdf); // Imprimimos la cabecera del registro
