<?php
	...
	function uf_print_encabezado_pagina($as_numdoc,$as_fecha,&$io_pdf)
	{
		...
		$io_pdf->addText(150,725,13,"<b>ORDEN DE TRANSFERENCIA</b>"); // Agregar el titulo
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		...
		if ($as_tipproben=='B')
		   {
			 $la_config=array('showHeadings'=>1, // Mostrar encabezados
							  ...
							  'cols'=>array('nombene'=>array('justification'=>'left','width'=>250))); // Justificación y ancho de la columna
			 $la_columnas=array('nombene'=>'<b>Beneficiario</b>');
		   }
		elseif($as_tipproben=='P')
		   {
			 $la_config=array('showHeadings'=>1, // Mostrar encabezados
							  ...
							  'cols'=>array('nompro'=>array('justification'=>'left','width'=>250))); // Justificación y ancho de la columna
			 $la_columnas=array('nompro'=>'<b>Proveedor</b>');
		   }
