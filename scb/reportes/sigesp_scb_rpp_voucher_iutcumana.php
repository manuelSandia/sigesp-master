<?php
	...
	header("Cache-Control: must-revalidate, post-check=0, pre-check=0");//IUTCUMANA.
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$io_pdf->line(11,63,590,63);				
		$io_pdf->line(310.5,90,310.5,148);
		$io_pdf->line(191,43,191,75);
		$io_pdf->line(310.5,43,310.5,75);
		$io_pdf->line(411,43,411,75);	
		
		$io_pdf->addText(96,137.6,9,'<b>Elaborado por</b>');
		$io_pdf->addText(408,137.6,9,'<b>Revisado y Autorizado por</b>');

		$io_pdf->addText(258,78.85,10,'<b>Recibí Conforme</b>');
		
		$io_pdf->addText(16,66,8,'<b>Nombres y Apellidos</b>');		
		$io_pdf->addText(196,66,8,'<b>Cédula de Identidad</b>');		
		$io_pdf->addText(316,66,8,'<b>Fecha</b>');
		$io_pdf->addText(416,66,8,'<b>Firma</b>');
		//$io_pdf->restoreState();
		//$io_pdf->closeObject();
