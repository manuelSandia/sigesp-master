<?php
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>3, // Mostrar encabezados
						...
						'xOrientation'=>'center', // Orientación de la tabla
						 ...
						 'monto'=>array('justification'=>'right','width'=>180))); // Ancho Máximo de la tabla
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('space'=>array('justification'=>'left','width'=>160),
						               'data'=>array('justification'=>'left','width'=>520))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/* en la próxima instrucción se mueve el nombre del banco */
		$io_pdf->ezSetY(370);
		...
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
                /* EN LA PRÓXIMA INSTRUCCIÓN SE MUEVE EL CONCEPTO */
		$io_pdf->ezSetY(340);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('ordenes'=>array('justification'=>'left','width'=>560))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		// Fecha Creación: 24/04/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// En la instrucción a continuación se mueven el debe y el haber jcm //
	   $io_pdf->ezSetY(285);
         $la_config=array('showHeadings'=>1, // Mostrar encabezados
					   ...
					   'debe'=>array('justification'=>'right','width'=>80), 			  'haber'=>array('justification'=>'right','width'=>90))); // Justificación y ancho de la columna
...
/*		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro1'=>array('justification'=>'center','width'=>20),
									   ...
									   'monto_spg'=>array('justification'=>'right','width'=>110),
						 			   'scg_cuenta'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
						 			   'debe'=>array('justification'=>'right','width'=>110), // Justificación y ancho de la columna
						 			   'haber'=>array('justification'=>'right','width'=>110))); // Justificación y ancho de la columna
...
// $io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
	...
	{
		print("<script language=JavaScript>");
		print(" alert('El cheque no puede ser generado, este se encuentra anulado!.');"); 
		print(" close();");
		print("</script>");
		/*
		print "El cheque no puede ser generado, esta anulado.";
		$class_report->is_msg_error;	
		$class_report->SQL->rollback();*/
	}
