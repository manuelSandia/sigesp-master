<?php
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('fecha'=>array('justification'=>'center','width'=>56),
									   ...
									   'estmov'=>array('justification'=>'center','width'=>60))); // Justificación y ancho de la columna
	...
	$ls_titulo		= "<b>Relación de Documentos $ls_tipbol</b>";
	...
	if(!empty($la_data))
	{
		...
		$io_pdf->ezStartPageNumbers(500,50,10,'','',1); // Insertar el número de página
