<?php
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'monto'=>array('justification'=>'left','width'=>150),'4'=>array('justification'=>'left','width'=>50))); // Ancho Máximo de la tabla
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('space'=>array('justification'=>'left','width'=>60),'data'=>array('justification'=>'left','width'=>450))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>155),
									   ...
									   'monto_spg'=>array('justification'=>'right','width'=>95),
						 			   ...
						 			   'debe'=>array('justification'=>'right','width'=>95), // Justificación y ancho de la columna
						 			   'haber'=>array('justification'=>'right','width'=>95))); // Justificación y ancho de la columna
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_fun_nomina;
		$la_data[0]=array('tesoreria'=>'<b>Tesoreria</b>','presupuesto'=>'<b>Presupuesto</b>','contabilidad'=>'<b>Contabilidad</b>','gerencia'=>'<b>Gerencia de Administración y Finanzas</b>','presidencia'=>'<b>Presidencia</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('tesoreria'=>array('justification'=>'center','width'=>116),
									   ...
									   'contabilidad'=>array('justification'=>'center','width'=>116),
						 			   'gerencia'=>array('justification'=>'center','width'=>116), // Justificación y ancho de la columna
	   ...
	   //Descompongo la cadena de operaciones en un arreglo tomando como separación el '-'
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				$io_pdf->selectFont('../../shared/ezpdf/fonts/Helvetica.afm'); // Seleccionamos el tipo de letra
				$io_pdf->ezSetCmMargins(0.5,3.5,1,1); // Configuración de los margenes en centímetros
				$io_pdf->ezStartPageNumbers(580,30,10,'','',1); // Insertar el número de página
