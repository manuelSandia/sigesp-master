<?php
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,&$io_pdf)
	{
		...
		$ls_nomprobencorto=wordwrap($ls_nomproben,70,"?");
		$io_pdf->add_texto($valores[2],$valores[3],11,"<b>$ls_nomprobencorto</b>");
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,
						 'cols'=>array('banco'=>array('justification'=>'left','width'=>160),
						 				'cheque'=>array('justification'=>'left','width'=>90),
						 'cuenta'=>array('justification'=>'left','width'=>150),
						 'voucher'=>array('justification'=>'left','width'=>150))); // Ancho Máximo de la tabla
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('ordenes'=>array('justification'=>'left','width'=>550))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('title'=>array('justification'=>'center','width'=>330),
						 'title2'=>array('justification'=>'center','width'=>220))); // Ancho Máximo de la tabla
	   ...
	   //Descompongo la cadena de operaciones en un arreglo tomando como separación el '-'
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				if (trim($ls_codban)=="004")//Banco Mercantil.
				   {
				...
				elseif(trim($ls_codban)=="003")//Banco Provincial.
				   {
				...
				elseif(trim($ls_codban)=="001")//Banco Industrial.
				   {
					 $ls_archivo="cheque_configurable/medidas_industrial.txt";
					 $ls_contenido="144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
					 $li_medidas=22;
				   }
				elseif(trim($ls_codban)=="005")//BOD.
				   {
				...
				elseif(trim($ls_codban)=="006")//Banesco
				   {
					 $ls_archivo="cheque_configurable/medidas_banesco.txt";
					 $ls_contenido="144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
					 $li_medidas=16;
				   }
				elseif(trim($ls_codban)=="007")//Banco del Tesoro
				   {
