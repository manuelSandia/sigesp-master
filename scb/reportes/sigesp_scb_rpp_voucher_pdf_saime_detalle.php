<?php
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,$ls_nomban,$ls_ctaban,$ls_numdoc,&$io_pdf)
	{
		...
		$io_pdf->addText(20,680,9,"<b>CTA.CTE Nro.: ".$ls_ctaban."</b>");
		$io_pdf->addText(250,680,9,"<b>Nro.: ".$ls_numdoc."</b>");
		$io_pdf->addText(390,680,9,"<b>Bs.***".$ldec_monto."***</b>");
		//Beneficiario del Cheque
		$io_pdf->addText(6,630,9,"<b>PAGUESE A LA ORDEN DE : </b>");
		$io_pdf->addText(134,630,9,"<b>".$ls_nomproben."</b>");
		...
		$ls_monto1=substr($ls_monto,0,70);
		$ls_monto2=substr($ls_monto,70,140);
		$io_pdf->addText(6,620,9,"<b>LA CANTIDAD DE :</b>");
		//if(array_key_exists(0,$la_arreglo))
		$io_pdf->addText(93,620,9,"<b>".$ls_monto1."</b>");
		//if(array_key_exists(1,$la_arreglo))
		$io_pdf->addText(93,610,9,"<b>".$ls_monto2."</b>");
		$ls_anio=substr($ls_fecha,-4);
		$ls_fecha_corta=substr($ls_fecha,0,(strlen($ls_fecha)-5));	
		//Fecha del Cheque
		$io_pdf->addText(140,576,9,"<b>".$ls_fecha_corta."</b>");
		$io_pdf->addText(220,576,9,"<b>$ls_anio</b>");
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_tipodestino,$ls_cedula,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data=array(array('ordenes'=>'<b>Orden(es) de Pago(s):</b> '.$ls_solicitudes),
					   ...
					   array('ordenes'=>'<b>'.$ls_tipo.'</b> '.$ls_cedula),
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('title'=>array('justification'=>'center','width'=>345),'title2'=>array('justification'=>'center','width'=>235))); // Ancho Máximo de la tabla
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$ls_monto= $numalet->letra();
			uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$ls_nomban,$ls_ctaban,$ls_numdoc,$io_pdf); // Imprimimos el encabezado de la página
			uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_tipodestino,$ls_cedula,$io_pdf); // Imprimimos la cabecera del registro
