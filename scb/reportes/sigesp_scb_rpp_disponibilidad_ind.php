<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->rectangle(120,705,450,40);
		$io_pdf->line(450,705,450,745);
		$io_pdf->line(450,725,570,725);
		...
		$io_pdf->addText(465,730,10,"<b>Fecha:</b> ".date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(470,710,10,"<b>Hora:</b> ".date("h:i a")); // Agregar la hora
	...
	{
	  $io_pdf->setStrokeColor(0,0,0);
	  $io_pdf->line(80,125,210,125);
	  $io_pdf->addText(80,110,9,'<b>Lcda. GENGIS J. OROPEZA M.</b>');
	  $io_pdf->addText(122,98,9,'<b>TESORERA</b>');
	  $io_pdf->line(380,125,490,125);
	  $io_pdf->addText(394,110,9,'<b>Lcdo. LUIS VARGAS.</b>');
	  $io_pdf->addText(380,98,9,'<b>DIRECCIÓN DE FINANZAS</b>');	
	  $io_pdf->addText(20,55,8,'<b>ELABORADO POR:</b> '.$_SESSION["la_nomusu"].', '.$_SESSION["la_apeusu"]);
	  $io_pdf->addText(20,45,8,'<b>FECHA DE ELABORACIÓN:</b> '.date("d/m/Y"));
	  $io_pdf->addText(430,45,8,'<b>REVISADO POR :</b> Lcda. Mireya Torcat');
	}
	...
	$io_pdf->ezStartPageNumbers(560,25,10,'','',1); // Insertar el número de página
	...
	$la_config=array('showHeadings'=>1, // Mostrar encabezados
			 ...
			 'fontSize'=>9,
			 'titleFontSize'=>9,
			 'cols'=>array('nomban'=>array('justification'=>'left','width'=>90),
			               'ctaban'=>array('justification'=>'center','width'=>140),
						   'tipcta'=>array('justification'=>'center','width'=>70),
						   'debitos'=>array('justification'=>'right','width'=>80),
						   'creditos'=>array('justification'=>'right','width'=>80),
