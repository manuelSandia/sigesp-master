<?PHP
	...
	function uf_print_cabecera($la_title,$ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		...
		$io_pdf->addText(53,121,7,"ELABORADO"); // Agregar el título
		$io_pdf->addText(55,64,7,"TESORERIA"); // Agregar el título
		$io_pdf->addText(185,121,7,"VERIFICADO"); // Agregar el título
		$io_pdf->addText(180,64,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(325,121,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(315,64,7,"COORD. DE FINANZAS"); // Agregar el título
		$io_pdf->addText(480,121,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(445,64,7,"GTE. ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
