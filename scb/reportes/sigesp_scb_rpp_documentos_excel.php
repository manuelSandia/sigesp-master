<?php
	...
	// para crear el libro excel
		...
		$lo_archivo = tempnam("/tmp", "listado_documentos.xls");
	...
	if ($ls_conchk==1)
	{
		...
		{
			$ls_documento=$lr_datos[$li_p];
			$rs_data   = $io_report->uf_cargar_documentos($ls_codope,$ld_fecdesde,$ld_fechasta,$ls_codban,$ls_ctaban,$ls_codconcep,$ls_estmov,$ls_orden,$ls_documento,$ls_conchk,&$lb_valido);
			//---------------------------------------------------------------------------------------------------------------------------
