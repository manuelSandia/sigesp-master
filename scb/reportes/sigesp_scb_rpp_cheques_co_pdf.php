...
//		$io_pdf->add_texto(10,25,9,"<b><i>".$_SESSION["la_empresa"]["nombre"]."</i></b>");
		...
		//Listado de 
		$io_pdf->add_texto(10,50,10,"<b>LISTADO DE: CHEQUES / CARTA ORDEN          </b>");		
		//Rango de Fechas
...
//			$io_pdf->add_texto(10,60,9,"<b>TODAS LAS FECHAS</b>");		
	...
	$ls_titulo    		= "<b>LISTADO DE CHEQUES / CARTA ORDEN </b>";
	$ldec_totaldebitos  = 0;
	...
	if ($ls_conchk==1)
	{
		...
		for($li_p=0;$li_p<$li_total;$li_p++)
		{
			...
			$rs_data            = $io_report->uf_cargar_documentos_ch_co($ls_codope,$ld_fecdesde,$ld_fechasta,$ls_codban,$ls_ctaban,$ls_codconcep,$ls_estatus,$ls_orden,$ls_numdocmov,$ls_conchk,&$lb_valido);
			if($lb_valido)
			{
