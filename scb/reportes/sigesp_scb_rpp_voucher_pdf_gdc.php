<?php
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_ctabanext,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data=array(array('banco'=>'<b>Banco</b>  ','cheque'=>'<b>Cheque Nº</b>  ','cuenta'=>'<b>Cuenta Nº:</b>  ','voucher'=>'<b>Voucher Nº:</b>  '),
						array('banco'=>$ls_nomban,'cheque'=>$ls_numdoc,'cuenta'=>$ls_ctabanext,'voucher'=>$ls_chevau));
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$io_pdf->line(147,90,147,148); // Vertical
		$io_pdf->line(283,90,283,148);// Vertical
		$io_pdf->line(395,90,395,148);// Vertical
		...
		$io_pdf->addText(150,137.6,9,'<b>Revisado por:</b>');
		$io_pdf->addText(293,137.6,9,'<b>Tesoreria/Finanzas:</b>');
		$io_pdf->addText(405,137.6,9,'<b>Cordinado de Administración y Servicio:</b>');	
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					$ls_ctabanext		= $ds_voucher->data["ctabanext"][$li_i];
					...
					uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_ctabanext,$io_pdf); // Imprimimos la cabecera del registro
