<?php
	...
	function uf_print_encabezado_pagina_prov($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,$ls_conmov,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_encabezado_pagina
		//		    Acess: private 
		...
		//Monto en letras del Cheque
		//Cortando el monto en caso de que sea muy largo		
		$ls_conc_cortado=wordwrap($ls_conmov,65,"?");
		$la_arreglo=array();
		$la_arreglo=explode("?",$ls_conc_cortado);
		/*if(array_key_exists(0,$la_arreglo))
			$io_pdf->add_texto($valores[4],$valores[5],9,"<b>$la_arreglo[0]</b>");
		if(array_key_exists(1,$la_arreglo))
			$io_pdf->add_texto($valores[6],$valores[7],9,"<b>$la_arreglo[1]</b>");*/
		$ls_anio=substr($ls_fecha,-4);
		$ls_fecha_corta=substr($ls_fecha,0,(strlen($ls_fecha)-8));
		$ls_fecha_corta2=substr($ls_fecha,12,2);	
		if ($ls_fecha_corta2=="01"){$ls_fecha_corta2='Enero';}
		elseif ($ls_fecha_corta2=="02"){$ls_fecha_corta2='Febrero';}
		elseif ($ls_fecha_corta2=="03"){$ls_fecha_corta2='Marzo';}
		elseif ($ls_fecha_corta2=="04"){$ls_fecha_corta2='Abril';}
		elseif ($ls_fecha_corta2=="05"){$ls_fecha_corta2='Mayo';}
		elseif ($ls_fecha_corta2=="06"){$ls_fecha_corta2='Junio';}
		elseif ($ls_fecha_corta2=="07"){$ls_fecha_corta2='Julio';}
		elseif ($ls_fecha_corta2=="08"){$ls_fecha_corta2='Agosto';}
		elseif ($ls_fecha_corta2=="09"){$ls_fecha_corta2='Septiembre';}
		elseif ($ls_fecha_corta2=="10"){$ls_fecha_corta2='Octubre';}
		elseif ($ls_fecha_corta2=="11"){$ls_fecha_corta2='Noviembre';}
		else {$ls_fecha_corta2='Diciembre';}
		//Fecha del Cheque
		$io_pdf->addText(100,730,11,"<b>$ls_nomproben</b>");// Nombre prov
		$io_pdf->addText(410,780,10,"<b>$ldec_monto</b>");// Monto
		$io_pdf->addText(70,700,11,'<b>                                         C.U.F.M Bs. ******   </b>'."<b>$ldec_monto</b>");// Monto Letras
		$io_pdf->addText(85,675,9,"<b>$ls_fecha_corta  </b>"."<b>$ls_fecha_corta2</b>");// Fecha1
		$io_pdf->addText(250,675,9,"<b>$ls_anio</b>");// Fecha2
		//$io_pdf->addText(425,760,9,"<b>NO ENDOSABLE</b>");// No endosable
		$io_pdf->addText(370,600,9,"<b>CADUCA A LOS ".$_SESSION["la_empresa"]["diacadche"]." DIAS</b>");// Caduca
		$io_pdf->addText(60,536,7,"<b>$la_arreglo[0]</b>");// Concepto
		if(array_key_exists(1,$la_arreglo))
		{
			$io_pdf->addText(60,528,7,"<b>$la_arreglo[1]</b>");// Concepto
		}
		// Segundo Cheque
		$io_pdf->addText(100,325,11,"<b>$ls_nomproben</b>");// Nombre prov
		$io_pdf->addText(410,375,10,"<b>$ldec_monto</b>");// Monto
		$io_pdf->addText(70,295,11,'<b>                                         C.U.F.M Bs. ******   </b>'."<b>$ldec_monto</b>");// Monto Letras
		$io_pdf->addText(85,270,9,"<b>$ls_fecha_corta  </b>"."<b>$ls_fecha_corta2</b>");// Fecha1
		$io_pdf->addText(250,270,9,"<b>$ls_anio</b>");// Fecha2
		//$io_pdf->addText(425,355,9,"<b>NO ENDOSABLE</b>");// No endosable
		$io_pdf->addText(370,195,9,"<b>CADUCA A LOS ".$_SESSION["la_empresa"]["diacadche"]." DIAS</b>");// Caduca
		$io_pdf->addText(60,136,7,"<b>$la_arreglo[0]</b>");// Concepto
		if(array_key_exists(1,$la_arreglo))
		{
			$io_pdf->addText(60,128,7,"<b>$la_arreglo[1]</b>");// Concepto
		}
		
	}// end function uf_print_encabezado_pagina_prov.
	
	function uf_print_encabezado_pagina_ben($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,$ls_conmov,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_encabezado_pagina
		//		    Acess: private 
		...
		//Fecha del Cheque
		$io_pdf->addText(100,715,11,"<b>$ls_nomproben</b>");// Nombre prov
		$io_pdf->addText(410,765,10,"<b>$ldec_monto</b>");// Monto
		$io_pdf->addText(70,685,11,'<b>                                         C.U.F.M Bs. ******   </b>'."<b>$ldec_monto</b>");// Monto Letras
		$io_pdf->addText(85,650,9,"<b>$ls_fecha_corta  </b>"."<b>$ls_fecha_corta2</b>");// Fecha1
		$io_pdf->addText(250,650,9,"<b>$ls_anio</b>");// Fecha2
		//$io_pdf->addText(425,760,9,"<b>NO ENDOSABLE</b>");// No endosable
		$io_pdf->addText(370,585,9,"<b>CADUCA A LOS ".$_SESSION["la_empresa"]["diacadche"]." DIAS</b>");// Caduca
		// Segundo Cheque
		$io_pdf->addText(100,430,11,"<b>$ls_nomproben</b>");// Nombre prov
		$io_pdf->addText(410,490,10,"<b>$ldec_monto</b>");// Monto
		$io_pdf->addText(70,410,11,'<b>                                         C.U.F.M Bs. ******   </b>'."<b>$ldec_monto</b>");// Monto Letras
		$io_pdf->addText(85,385,9,"<b>$ls_fecha_corta  </b>"."<b>$ls_fecha_corta2</b>");// Fecha1
		$io_pdf->addText(250,385,9,"<b>$ls_anio</b>");// Fecha2
		//$io_pdf->addText(425,485,9,"<b>NO ENDOSABLE</b>");// No endosable
		$io_pdf->addText(370,310,9,"<b>CADUCA A LOS ".$_SESSION["la_empresa"]["diacadche"]." DIAS</b>");// Caduca
		// Tercer Cheque
		$io_pdf->addText(100,170,11,"<b>$ls_nomproben</b>");// Nombre prov
		$io_pdf->addText(410,220,10,"<b>$ldec_monto</b>");// Monto
		$io_pdf->addText(70,140,11,'<b>                                         C.U.F.M Bs. ******   </b>'."<b>$ldec_monto</b>");// Monto Letras
		$io_pdf->addText(85,115,9,"<b>$ls_fecha_corta  </b>"."<b>$ls_fecha_corta2</b>");// Fecha1
		$io_pdf->addText(250,115,9,"<b>$ls_anio</b>");// Fecha2
		//$io_pdf->addText(425,215,9,"<b>NO ENDOSABLE</b>");// No endosable
		$io_pdf->addText(370,40,9,"<b>CADUCA A LOS ".$_SESSION["la_empresa"]["diacadche"]." DIAS</b>");// Caduca
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		...
		$la_data=array(array('ordenes'=>'<b>Orden(es) de Pago(s):</b> '.$ls_solicitudes),
					   ...
					   array('ordenes'=>'<b>Conceptod:</b> '.$ls_conmov));
	...
	function uf_print_detalle_prov($la_title,$la_data,$ls_chevau,$ld_fecmov,$li_monto_tot,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_detalle_prov
		//		    Acess: private 
		//	    Arguments: la_data // arreglo de información
		//	   			   io_pdf // Objeto PDF
		//    Description: función que imprime el detalle
		...
		// Fecha Creación: 02/04/2008 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$ls_anio=substr($ld_fecmov,-4);
		$ls_chevau=substr($ls_chevau,16);
		$io_pdf->addText(60,445,9,"<b>AÑO  </b>"."<b>$ls_anio</b>");// Fecha2
		$io_pdf->addText(280,445,9,"<b>$ls_chevau</b>");// Chevau
		$io_pdf->addText(255,470,7,"--------------");// Chevau
		$io_pdf->addText(255,465,7,"<b>$li_monto_tot</b>");// Chevau
		$io_pdf->setStrokeColor(0,0,0);
		$la_data_title=array($la_title);
		$io_pdf->ezSetDy(-240);
		//Imprimo los detalles tanto `de presupuesto como contablwe del movimiento
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomspg'=>array('justification'=>'left','width'=>150),// Justificación y ancho de la columna
									   'monto_spg'=>array('justification'=>'right','width'=>55))); // Justificación y ancho de la columna
		$la_columnas=array('denomspg'=>'',
						   'monto_spg'=>'');
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		$io_pdf->ezText('                     ',10);//Inserto una linea en blanco
		//Segundo Cheque
		$io_pdf->addText(60,45,9,"<b>AÑO  </b>"."<b>$ls_anio</b>");// Fecha2
		$io_pdf->addText(280,45,9,"<b>$ls_chevau</b>");// Chevau
		$io_pdf->addText(255,70,7,"--------------");// Chevau
		$io_pdf->addText(255,65,7,"<b>$li_monto_tot</b>");// Chevau
		$io_pdf->setStrokeColor(0,0,0);
		$la_data_title=array($la_title);
		$io_pdf->ezSetY(120);
		//Imprimo los detalles tanto `de presupuesto como contablwe del movimiento
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		if ((trim($ls_codban)=="001")||(trim($ls_codban)=="002"))//Banco Industrial de Venezuela.
		   {
		...
		elseif(trim($ls_codban)=="003")//Banco Caroni.
		   {
		...
		elseif(trim($ls_codban)=="004")//Banco Provincial.
		   {
			 $ls_archivo="cheque_configurable/medidas_provincial.txt";
			 $ls_contenido="144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
			 $li_medidas=22;
		   }
		elseif(trim($ls_codban)=="006")//Banco del Bicentenario - Banfoandes.
		   {
		...
		$thisPageNum=$io_pdf->ezPageCount;
		//$io_pdf->ezStartPageNumbers(570,30,10,'','',1); // Insertar el número de página
		if (($ls_codban!='001')&&($ls_codban!='002'))
		{
			uf_print_autorizacion($io_pdf);	
		}
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$ld_fecmov	  	= $io_funciones->uf_convertirfecmostrar($ds_voucher->data["fecmov"][$li_i]);
			$ls_nomproben 	= $ds_voucher->data["nomproben"][$li_i];
			$ls_tipo_destino= $ds_voucher->data["tipo_destino"][$li_i];
			$ls_solicitudes = $class_report->uf_select_solicitudes($ls_numdoc,$ls_codban,$ls_ctaban);
			$ls_conmov		= $ds_voucher->getValue("conmov",$li_i);
			$ldec_monret	= $ds_voucher->getValue("monret",$li_i);
			$ldec_monto		= $ds_voucher->getValue("monto",$li_i);
			...
			//Obtengo el texto del monto enviado.
			$ls_monto= $numalet->letra();
			if ((($ls_codban=='001')||($ls_codban=='002'))&&($ls_tipo_destino=="P"))
			{
				uf_print_encabezado_pagina_prov(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$ls_conmov,$io_pdf); // Imprimimos el encabezado de la página
				//uf_print_cabecera_prov($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$io_pdf); // Imprimimos la cabecera del registro
			}
			elseif((($ls_codban=='001')||($ls_codban=='002'))&&($ls_tipo_destino=="B"))
			{
				uf_print_encabezado_pagina_ben(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$ls_conmov,$io_pdf); // Imprimimos el encabezado de la página
			}
			else
			{
				uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$io_pdf); // Imprimimos el encabezado de la página
				 ...
				 for ($li_s=1;$li_s<=$li_totrow_det;$li_s++)
					 {
							...
							if (array_key_exists($li_s,$ds_dt_spg->data["spg_cuenta"]))
							   {
								 ...
								 $ls_estpro      = $ds_dt_spg->getValue("estpro",$li_s);	  
								 $ldec_monto_spg = number_format($ds_dt_spg->getValue("monto",$li_s),2,",",".");
								 $ls_denomspg    = $ds_dt_spg->getValue("denominacion",$li_s);
								 $li_acum_spg	 = $li_acum_spg+($ds_dt_spg->getValue("monto",$li_s));
							   }
							else
							   {
								 $ls_cuentaspg   = "";	
					   ...
					   $la_data[$li_s]=array('spg_cuenta'=>$ls_cuentaspg,'estpro'=>$ls_estpro,'monto_spg'=>$ldec_monto_spg,'scg_cuenta'=>$ls_scg_cuenta,'debe'=>$ldec_mondeb,'haber'=>$ldec_monhab,'denomspg'=>$ls_denomspg);
					 }
			   }
			if ($li_totrow_spg>$li_totrow_det)
			   {
			...
			if (empty($la_data))
			   {
				 ...
				 $ldec_monhab	 = '';
				 $ls_denomspg    = '';
				 $la_data[1]=array('spg_cuenta'=>$ls_cuentaspg,'estpro'=>$ls_estpro,'monto_spg'=>$ldec_monto_spg,'scg_cuenta'=>$ls_scg_cuenta,'debe'=>$ldec_mondeb,'haber'=>$ldec_monhab,'denomspg'=>$ls_denomspg);
				 $la_data[2]=array('spg_cuenta'=>$ls_cuentaspg,'estpro'=>$ls_estpro,'monto_spg'=>$ldec_monto_spg,'scg_cuenta'=>$ls_scg_cuenta,'debe'=>$ldec_mondeb,'haber'=>$ldec_monhab,'denomspg'=>$ls_denomspg);
				 $la_data[3]=array('spg_cuenta'=>$ls_cuentaspg,'estpro'=>$ls_estpro,'monto_spg'=>$ldec_monto_spg,'scg_cuenta'=>$ls_scg_cuenta,'debe'=>$ldec_mondeb,'haber'=>$ldec_monhab,'denomspg'=>$ls_denomspg);
			   }
			if ((($ls_codban=='001')||($ls_codban=='002'))&&($ls_tipo_destino=="P"))
			{
				uf_print_detalle_prov(array('title'=>'','title2'=>''),$la_data,$ls_chevau,$ld_fecmov,number_format($li_acum_spg,2,",","."),$io_pdf);
			}
			elseif ((($ls_codban=='001')||($ls_codban=='002'))&&($ls_tipo_destino=="B"))
			{}
			else
