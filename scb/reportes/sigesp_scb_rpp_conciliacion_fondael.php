<?PHP
	...
	function uf_print_encabezado_pagina($ls_banco,$ls_mes,$ls_anio,$ls_ctaban,&$io_pdf)
	{
		...
		$io_pdf->addText(40,680,9,"Banco:   ".$ls_banco); // Agregar la Fecha
		$io_pdf->addText(40,665,9,"Cuenta:   ".$ls_ctaban); // Agregar la Fecha
	...
	function uf_print_saldo_libro($ls_fecha,$ls_saldo){
		...
		$la_data[1]=array('titulo1'=>'<b>Saldo Segun LIBRO al '.$ls_fecha.'</b>','titulo2'=>'','titulo3'=>$ls_saldo);
	...
	$la_data_errbco_retiro_mas,$la_data_errbco_retiro_menos,$la_data_errbco_deposito_mas,$la_data_errbco_deposito_menos,&$io_pdf)
	{
		...
		$la_data[1]=array('titulo1'=>'Saldo Segun Banco al   '.$ld_fechas,'titulo2'=>'','titulo3'=>$ls_salban);
		$ls_chkpass=0;
		///////////////////////////////////////////CHEQUES MENOS////////////////////////////////////////////////////////////////
		if (!empty($la_data_cheque_menos))
		{
			...
			$la_data[]=array('titulo1'=>'','titulo2'=>'','titulo3'=>'('.$li_acum_mon_cheq_menos.')');	
		}
		///////////////////////////////////////////CHEQUES MENOS////////////////////////////////////////////////////////////////
		...
		if($ls_chkpass==0)
		{
			if (!empty($la_data_nota_deb_menos))
			{
				...
				$la_data[]=array('titulo1'=>'','titulo2'=>'','titulo3'=>'('.$li_acum_mon_nd_menos.')');	
			}
		}
		else
		{
		...
		if (!empty($la_data_errbco_nota_deb_mas))
		{
			...
			$la_data[]=array('titulo1'=>'','titulo2'=>'','titulo3'=>'('.$li_acum_mon_errbco_nd_mas.')');
		}
		...
		if (!empty($la_data_errbco_nota_deb_menos))
		{
			...
			$la_data[]=array('titulo1'=>'','titulo2'=>'','titulo3'=>'('.$li_acum_mon_errbco_nd_menos.')');
		}
		...
		if($ls_chkpasserrobco==0)
		{
			if (!empty($la_data_errbco_cheque_mas))
			{
				...
				$la_data[]=array('titulo1'=>'','titulo2'=>'','titulo3'=>'('.$li_acum_mon_errbco_ch_mas.')');	
				$li_c=$li_a+1;
			}
		}
		else
		...
		if($ls_chkpasserrobco==0)
		{
			...
			{
				$la_data[]=array('titulo1'=>'<b>ERRORES DE BANCO</b>','titulo2'=>'','titulo3'=>'');
				$la_data[]=array('titulo1'=>'   Menos: Cheques','titulo2'=>'','titulo3'=>'');
				$la_data[]=array('titulo1'=>'     Nro.                               Fecha                  Beneficiario                                                                                           ','titulo2'=>'','titulo3'=>'');
			}
		}
		else
		...
		if (!empty($la_data_errbco_cheque_menos))
		{
			...
			$la_data[]=array('titulo1'=>'','titulo2'=>'','titulo3'=>'('.$li_acum_mon_errbco_ch_menos.')');
		}
		...
		if($ls_chkpasserrobco==0)
		{
			...
			{
				$la_data[]=array('titulo1'=>'<b>ERRORES DE BANCO</b>','titulo2'=>'','titulo3'=>'');
				$la_data[]=array('titulo1'=>'   Mas: Nota Credito','titulo2'=>'','titulo3'=>'');
				$la_data[]=array('titulo1'=>'     Nro.                               Fecha                  Beneficiario                                                                                           ','titulo2'=>'','titulo3'=>'');
			}
		}
		else
		...
		if (!empty($la_data_errbco_nota_cred_mas))
		{
			...
			$la_data[]=array('titulo1'=>'','titulo2'=>'','titulo3'=>'('.$li_acum_mon_errbco_nc_mas.')');
		}
		...
		if($ls_chkpasserrobco==0)
		{
			...
			{
				$la_data[]=array('titulo1'=>'<b>ERRORES DE BANCO</b>','titulo2'=>'','titulo3'=>'');
				$la_data[]=array('titulo1'=>'   Menos: Nota de Credito','titulo2'=>'','titulo3'=>'');
				$la_data[]=array('titulo1'=>'     Nro.                               Fecha                  Beneficiario                                                                                           ','titulo2'=>'','titulo3'=>'');
			}
		}
		else
		...
		if (!empty($la_data_errbco_nota_cred_menos))
		{
			...
			$la_data[]=array('titulo1'=>'','titulo2'=>'','titulo3'=>'('.$li_acum_mon_errbco_nc_menos.')');
		}
		...
		if($ls_chkpasserrobco==0)
		{
			...
			{
				$la_data[]=array('titulo1'=>'<b>ERRORES DE BANCO</b>','titulo2'=>'','titulo3'=>'');
				$la_data[]=array('titulo1'=>'   Mas: Retiros','titulo2'=>'','titulo3'=>'');
				$la_data[]=array('titulo1'=>'     Nro.                               Fecha                  Beneficiario                                                                                           ','titulo2'=>'','titulo3'=>'');
			}
		}
		else
		...
		if (!empty($la_data_errbco_retiro_mas))
		{
			...
			$la_data[]=array('titulo1'=>'','titulo2'=>'','titulo3'=>'('.$li_acum_mon_errbco_re_mas.')');
		}		
		...
		if($ls_chkpasserrobco==0)
		{
			...
			{
				$la_data[]=array('titulo1'=>'<b>ERRORES DE BANCO</b>','titulo2'=>'','titulo3'=>'');
				$la_data[]=array('titulo1'=>'   Menos: Retiros','titulo2'=>'','titulo3'=>'');
				$la_data[]=array('titulo1'=>'     Nro.                               Fecha                  Beneficiario                                                                                           ','titulo2'=>'','titulo3'=>'');
				$ls_chkpass=2;
		...
		if (!empty($la_data_errbco_deposito_mas))
		{
			...
			$la_data[]=array('titulo1'=>'','titulo2'=>'','titulo3'=>'('.$li_acum_mon_errbco_dp_mas.')');
		}		
		...
		if (!empty($la_data_errbco_deposito_menos))
		{
			...
			$la_data[]=array('titulo1'=>'','titulo2'=>'','titulo3'=>'('.$li_acum_mon_errbco_dp_menos.')');	
		}
		//$ls_sallib=$ls_sallib+$li_acum_mon_trans_no_regist;
		$la_data[]=array('titulo1'=>'<b>Saldo Segun LIBRO al  '.$ld_fechas.'</b>','titulo2'=>'','titulo3'=>'<b>'.number_format($ls_sallib,2,",",".").'</b>');
		$la_columnas=array('titulo1'=>'<b>Descripcion</b>','titulo2'=>'<b>Cifras Parciales</b>','titulo3'=>'<b>Cifras Totales</b>');
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$io_pdf->addText(435,80,9,"APROBADO POR:"); // Agregar el título
		$io_pdf->closeObject();
