<?php
	...
	$io_pdf->addText(100,448,9,$ls_chevau);			//numero de cheque voucher
	$io_pdf->addText(30,415,9,$ls_nomban);	     	//nombre del banco
	$io_pdf->addText(250,415,9,$ls_numdoc);        	//numero de documento
	$io_pdf->addText(400,415,9,$ls_ctaban);			//cuenta de banco
	$io_pdf->addText(30,383,9,$ls_solicitudes);		//numero de solicitudes canceladas con el cheque	
	$io_pdf->addText(30,355,9,$ls_nomproben);		//nombre del proveedor o beneficiario	
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		$thisPageNum=$io_pdf->ezPageCount;
		$io_pdf->ezStartPageNumbers(570,30,10,'','',1); // Insertar el número de página
			if (trim($ls_codban)=="001")//Banco Central.
			   {
				 $ls_archivo="cheque_configurable/medidas_central.txt";
				 $ls_contenido="144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
				 $li_medidas=22;
			...
			elseif(trim($ls_codban)=="005")//Banco BOD.
			   {
