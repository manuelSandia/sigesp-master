<?php
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		...
		$io_pdf->addText(30,478,11,'<b>'.$ls_nomban.'</b>');
		$io_pdf->addText(250,478,11,'<b>'.$ls_numdoc.'</b>');
		$io_pdf->addText(450,478,11,'<b>'.$ls_ctaban.'</b>');
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'left','width'=>150),
