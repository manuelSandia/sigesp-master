<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$ad_fecdesde,$ad_fechasta,$ls_nomban,$ls_tipcta,$ls_ctaban,$ls_tipolistado,&$io_pdf)
	{
		...
		//Fecha y hora
		$io_pdf->add_texto(206,25,9,"<b>Pág. </b>");
		$io_pdf->add_texto(206,30,9,"<b>Fecha de Impresión:</b> ".date("d/m/Y"));
		$io_pdf->add_texto(206,35,9,"<b>Hora de Impresión  :</b>  ".date("G:i:s"));		
		//Banco
	...
	if($lb_valido)
	{
		...
		$io_pdf->set_margenes(20,3,3,3);	 // Configuración de los margenes en centímetros
		...
		$io_pdf->ezStartPageNumbers(655,475,9,'','',1); // Insertar el número de página
        $i=0;
		$ld_totanu = 0;
		$ld_totdeb = 0;
		$ld_totcre = 0;
