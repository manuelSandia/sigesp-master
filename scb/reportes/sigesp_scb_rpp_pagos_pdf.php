<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf,$ls_tipproben,$ls_tiprep,$ls_probendesde,$ls_probenhasta,$ld_fecdesde,$ld_fechasta,$ls_nomban,$ls_ctaban,$as_tipbol)
	{
		...
		$tm=356-($li_tm/2);
		$io_pdf->addText(430,555,9,$ls_fechas); // Agregar el título
		if($ls_tipproben=='P')
		{
			$ls_den="<b>Proveedor:</b> ".$ls_probendesde." <b>al</b> ".$ls_probenhasta;
			$io_pdf->addText(430,540,9,$ls_den); // Agregar el título
		}
		if($ls_tipproben=='B')
		{
		...
		if(($ls_nomban!="")&&($ls_ctaban!=""))		
		{
			...
			$io_pdf->addText(430,525,9,$ls_den); // Agregar el título	
		}
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		...
		if ($as_tiprep=='E') 
		   {
		     $la_columna=array('beneficiario'=>'<b>Proveedor \ Benef.</b>','solicitud'=>'<b>Solicitud</b>', 'conmov'=>'<b>Concepto</b>',
						       'documento'=>'<b>Documento</b>','operacion'=>'<b>Operación</b>','nomban'=>'<b>Banco</b>','cuenta'=>'<b>Cuenta</b>', 'fecha'=>'<b>Fecha</b>','monto'=>'<b>Monto</b>','monret'=>'<b>Retenido</b>');
				$la_config=array('showHeadings'=>1, // Mostrar encabezados
								 ...
								 'cols'=>array('beneficiario'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
											   ...
											   'nomban'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
	...
	function uf_print_totales($ad_total,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Justificación y ancho de la columna
						 'cols'=>array('name'=>array('justification'=>'right','width'=>620), // Justificación y ancho de la columna
	...
	if($li_total>0)
	{
		...
		$io_pdf->ezStartPageNumbers(885,50,10,'','',1); // Insertar el número de página
		$i=0;
		$ldec_total = 0;
		while ($row=$io_sql->fetch_row($rs_data)){
			    ...
			    $la_data[$i]=array('beneficiario'=>$ls_nombrellen,'solicitud'=>$ls_numsol,'cuenta'=>$ls_ctaban,'documento'=>$ls_numdoc,'operacion'=>$ls_tipoope,
							       'fecha'=>$ld_fecmov,'monto'=>number_format($ldec_monsol,2,",","."),'monret'=>number_format($ld_monret,2,",","."),'conmov'=>$ls_conmov,'nomban'=>$ls_nomban);
		}
