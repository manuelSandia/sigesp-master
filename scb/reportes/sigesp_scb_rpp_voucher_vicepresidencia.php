<?php
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_conmov,$ls_nomproben,$ls_cedrif,$ldec_monto,$ls_fecha,$ls_montospg,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cuenta'=>array('justification'=>'right','width'=>200))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		//$io_pdf->addText(16,500,9,$ls_conmov);
		$ls_anio=substr($ls_fecha,-4);
		$ls_fecha_corta=substr($ls_fecha,0,(strlen($ls_fecha)-5));
		$ls_fechadef=$ls_fecha_corta."/".$ls_anio;
		$io_pdf->addText(90,320,8,"TOTAL A PAGAR..................     ".number_format($ldec_monto,2,",","."));
		$io_pdf->addText(90,270,8,$_SESSION["la_nomusu"]);
		$io_pdf->addText(163,239,10,$ls_nomproben);
		$io_pdf->addText(162,215,10,$ls_cedrif);		
		$io_pdf->addText(140,185,10,$ls_fechadef); // Agregar la Fecha
		$io_pdf->addText(520,42,10,number_format($ldec_monto,2,",","."));
		$io_pdf->ezSetDy(-61);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('ordenes'=>array('justification'=>'left','width'=>530))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'fontSize' => 8, // Tamaño de Letras
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xPos'=>357, // Orientación de la tabla
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('montospg'=>array('justification'=>'left','width'=>530))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);		
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		$io_pdf->addText(225,750,11,"<b>VICEPRESIDENCIA DE LA REPUBLICA</b>"); // Agregar el título
		$io_pdf->addText(20,135,8,"Por Vicepresidencia:"); // Agregar el título
		$io_pdf->addText(20,115,8,"Nombre:"); // Agregar el título
		$io_pdf->line(53,113,150,113); //HORIZONTAL		
		$io_pdf->addText(20,95,8,"C.I:"); // Agregar el título
		$io_pdf->line(40,92,150,92); //HORIZONTAL		
		$io_pdf->addText(20,75,8,"Firma:"); // Agregar el título
		$io_pdf->line(45,72,150,72); //HORIZONTAL		
		$io_pdf->addText(20,55,8,"Fecha:"); // Agregar el título
		$io_pdf->line(45,52,150,52); //HORIZONTAL
		
		$io_pdf->addText(420,135,8,"Recibido Por:"); // Agregar el título
		$io_pdf->addText(420,115,8,"Nombre:"); // Agregar el título
		$io_pdf->line(453,113,556,113); //HORIZONTAL		
		$io_pdf->addText(420,95,8,"C.I:"); // Agregar el título
		$io_pdf->line(440,92,556,92); //HORIZONTAL		
		$io_pdf->addText(420,75,8,"Firma:"); // Agregar el título
		$io_pdf->line(445,72,556,72); //HORIZONTAL		
		$io_pdf->addText(420,55,8,"Fecha:"); // Agregar el título
		$io_pdf->line(445,52,556,52); //HORIZONTAL		
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('title'=>array('justification'=>'center','width'=>340),'title2'=>array('justification'=>'center','width'=>220))); // Ancho Máximo de la tabla
    ...
    function uf_print_detalle_ret($la_title,$la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('nomret'=>array('justification'=>'center','width'=>190),
			 						   'montobjret'=>array('justification'=>'right','width'=>75),
									   'nomret2'=>array('justification'=>'right','width'=>190),
						 			   'montotot'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
