<?php
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'voucher'=>array('justification'=>'center','width'=>150))); // Ancho Máximo de la tabla
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>546, // Ancho de la tabla
						 'maxWidth'=>546,
						 'cols'=>array('ordenes'=>array('justification'=>'left','width'=>546))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>546, // Ancho de la tabla
						 'maxWidth'=>546,
						 'cols'=>array('title'=>array('justification'=>'center','width'=>365),'title2'=>array('justification'=>'center','width'=>181))); // Ancho Máximo de la tabla
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'shaded'=>0, // Sombra entre líneas
						 'width'=>546, // Ancho de la tabla
						 'maxWidth'=>546, // Ancho Máximo de la tabla
						 'colGap'=>1,
						 'xPos'=>315, // Orientación de la tabla
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>65),
									   ...
									   'monto_spg'=>array('justification'=>'right','width'=>64),
						 			   ...
						 			   'debe'=>array('justification'=>'right','width'=>71), // Justificación y ancho de la columna
						 			   'haber'=>array('justification'=>'right','width'=>71))); // Justificación y ancho de la columna
