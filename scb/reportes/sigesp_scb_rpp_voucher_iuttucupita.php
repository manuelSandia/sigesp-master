<?php
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$io_pdf->line(11,80,590,80);//aaa
		$io_pdf->line(11,74.6,590,74.6);
		$io_pdf->line(140,80,140,148);
		$io_pdf->line(290,80,290,148);
		$io_pdf->line(440,80,440,148);
...
//		$io_pdf->line(411,43,411,75);
		...
		$io_pdf->addText(12,140,9,'<b>Preparado:</b>');
		$io_pdf->addText(141,140,9,'<b>Revisado:</b>');
		$io_pdf->addText(291,140,9,'<b>Sirvase:</b>');
		$io_pdf->addText(441,140,9,'<b>Pagado:</b>');

		$io_pdf->addText(40,81,9,'<b>Administración</b>');
		$io_pdf->addText(155,81,9,'<b>Sub Director Administrativo</b>');
		$io_pdf->addText(350,81,9,'<b>Director</b>');
		$io_pdf->addText(488,81,9,'<b>Habilitado</b>');

		$io_pdf->line(195,43,195,75);
		$io_pdf->line(359,43,359,75);
		$io_pdf->line(479,43,479,75);

		$io_pdf->addText(12,45,9,'<b>Recibí Conforme:</b>');
		$io_pdf->addText(196,45,9,'<b>Cédula de Identidad:</b>');
		$io_pdf->addText(360,45,9,'<b>Fecha:</b>');
		$io_pdf->addText(480,45,9,'<b>Firma:</b>');
		//$io_pdf->restoreState();
		//$io_pdf->closeObject();
