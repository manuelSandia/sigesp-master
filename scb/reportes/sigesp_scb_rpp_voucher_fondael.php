<?php
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		...
		$la_data=array(array('banco'=>'<b>Banco</b>  ','cheque'=>'<b>Documento Nº</b>  ','cuenta'=>'<b>Cuenta Nº:</b>  ','voucher'=>'<b>Voucher Nº:</b>  '),
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		$la_columnas=array('estpro'=>'<b>Estructura Programatica</b>',
...
if ($ls_tipimp=='lote')
   {
	 ...
	 if ($li_total>0)
		{	
		  ...
		  elseif(trim($ls_codban)=="002")//Banco Canarias.
			 {
		  ...
		  elseif(trim($ls_codban)=="004")//Banco Industrial.
			 {
			   $ls_archivo   = "cheque_configurable/medidas_industrial.txt";
			   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
			   $li_medidas   = 22;
			 }
		  elseif(trim($ls_codban)=="005")//Banco Fondocomun.
			 {
			   $ls_archivo   = "cheque_configurable/medidas_fondocomun.txt";
			   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
			   $li_medidas   = 22;
			 }
		  elseif(trim($ls_codban)=="008")//Banco Banesco.
			 {
			   $ls_archivo   = "cheque_configurable/medidas_banesco.txt";
			   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
			   $li_medidas   = 16;
			 }
		  elseif(trim($ls_codban)=="009")//Banco Central.
			 {
			   $ls_archivo   = "cheque_configurable/medidas_central.txt";
			   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
			   $li_medidas   = 16;
			 }
		  elseif(trim($ls_codban)=="010")//Banco Banco del Tesoro.
			 {
