<?php
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);		
		$io_pdf->Rectangle(11,113,580,105);
		$io_pdf->line(11,160,590,160);
		$io_pdf->line(11,144.6,590,144.6);		
		$io_pdf->line(127,160,127,218);
		$io_pdf->line(243,160,243,218);
		$io_pdf->line(359,160,359,218);
		$io_pdf->line(475,160,475,218);		
		$io_pdf->line(191,113,191,145);
		$io_pdf->line(310.5,113,310.5,145);
		$io_pdf->line(411,113,411,145);	
		
		$io_pdf->addText(16,207.6,9,'<b>Elaborado por:</b>');
		$io_pdf->addText(132,207.6,9,'<b>Revisado por:</b>');
		$io_pdf->addText(273,207.6,9,'<b>Presupuesto</b>');		
		$io_pdf->addText(384,207.6,9,'<b>Administración</b>');		
		$io_pdf->addText(508,207.6,9,'<b>Presidencia</b>');
		$io_pdf->addText(258,148.85,10,'<b>Recibí Conforme</b>');
		
		$io_pdf->addText(16,133.27,10,'<b>Nombre:</b>');		
		$io_pdf->addText(196,133.27,10,'<b>Cédula de Identidad:</b>');		
		$io_pdf->addText(316,133.27,10,'<b>Fecha:</b>');
		$io_pdf->addText(416,133.27,10,'<b>Firma:</b>');
