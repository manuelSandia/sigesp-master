...
if ($ls_tipimp=='lote')
   {
	 ...
	 if ($li_total>0)
		{	
		  ...
		  elseif(trim($ls_codban)=="002" || trim($ls_codban)=="003" || trim($ls_codban)=="004" || trim($ls_codban)=="006" || trim($ls_codban)=="008" || trim($ls_codban)=="009")//Banco Del Caribe;Central;Casa Propia;Banesco;Mercantil;Banfoandes.
			 {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
else 
   {
	 ...
	 elseif(trim($ls_codban)=="003" || trim($ls_codban)=="005")//Banesco;Mercantil;Banfoandes.
		{
		  $ls_archivo	= "cheque_configurable/medidas_banesco.txt";
		  $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
		  $li_medidas   = 16;
		}
	elseif(trim($ls_codban)=="004")//Banfoandes.
		{
