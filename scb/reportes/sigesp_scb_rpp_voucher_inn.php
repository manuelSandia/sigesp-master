<?php
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_cedrif,$ls_monto,$ls_fecha,&$io_pdf)
	{
		...
		$io_pdf->add_texto($valores[2],$valores[3],11,"<b>$ls_nomproben</b>"."      "."<b>$ls_cedrif</b>");
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_conmov,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data=array(array('cuenta'=>$ls_ctaban,'cheque'=>$ls_numdoc,'banco'=>$ls_nomban));
		$la_columna=array('cuenta'=>'','cheque'=>'','banco'=>'');
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'shaded'=>0, // Sombra entre líneas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xPos'=>240, // Orientación de la tabla
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
	   ...
	   //Descompongo la cadena de operaciones en un arreglo tomando como separación el '-'
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				elseif(trim($ls_codban)=="002")//Banco Venezuela.
				   {
				...
				elseif(trim($ls_codban)=="003")//Banco Banfoandes.
				   {
					 $ls_archivo="cheque_configurable/medidas_banfoandes.txt";
					 $ls_contenido="144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
					 $li_medidas=22;
				   }
				elseif(trim($ls_codban)=="004")//Banco Guayana.
				   {
					 $ls_archivo="cheque_configurable/medidas_guayana.txt";
					 $ls_contenido="144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
					 $li_medidas=16;
				   }
				elseif(trim($ls_codban)=="005")//Banco Bancoro.
				   {
					 $ls_archivo="cheque_configurable/medidas_bancoro.txt";
					 $ls_contenido="144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
					 $li_medidas=16;
				   }
				elseif(trim($ls_codban)=="006")//Banco Banesco.
				   {
					 $ls_archivo="cheque_configurable/medidas_banesco.txt";
					 $ls_contenido="144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
					 $li_medidas=16;
				   }
				elseif(trim($ls_codban)=="007")//Banco Industrial de Venezuela.
				   {
					 $ls_archivo="cheque_configurable/medidas_industrial.txt";
					 $ls_contenido="144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
					 $li_medidas=16;
				   }          
				elseif(trim($ls_codban)=="008")//Banco Fondocomun.
				   {
					 $ls_archivo="cheque_configurable/medidas_fondocomun.txt";
					 $ls_contenido="144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
					 $li_medidas=16;
				   }
				elseif(trim($ls_codban)=="009")//Banco BOD.
				   {
					 $ls_archivo="cheque_configurable/medidas_bod.txt";
					 $ls_contenido="144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
					 $li_medidas=16;
				   }
				elseif(trim($ls_codban)=="010")//Banco Canarias.
				   {
					 $ls_archivo="cheque_configurable/medidas_canarias.txt";
					 $ls_contenido="144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
					 $li_medidas=16;
				   }          
				else
