<?php
	...
	header("Cache-Control: must-revalidate, post-check=0, pre-check=0");//IUTEP
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$io_pdf->addText(36,137.6,9,'<b>Preparado por:</b>');
		$io_pdf->addText(152,137.6,9,'<b>Revisado por:</b>');
		$io_pdf->addText(283,137.6,9,'<b>Autorizado por:</b>');		
		$io_pdf->addText(460,137.6,9,'<b>Registrado por:</b>');		
