<?php
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		...
		$io_pdf->addText(40,505,9,'<b>'.$ls_nomban.'</b>');
		$io_pdf->addText(260,505,9,'<b>'.$ls_numdoc.'</b>');
		$io_pdf->addText(450,505,9,'<b>'.$ls_ctaban.'</b>');
		$io_pdf->addText(450,490,8,'<b>Fecha:   </b>'.date("d/m/Y")); // Agregar la Fecha
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,
						 'rowGap'=>2,
						 'cols'=>array('ordenes'=>array('justification'=>'left','width'=>460))); // Ancho Máximo de la tabla
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,
						 'rowGap'=>5,
						 'cols'=>array('ordenes'=>array('justification'=>'left','width'=>520))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'right','width'=>150),
			 						   'spg_cuenta'=>array('justification'=>'right','width'=>80),
									   'monto_spg'=>array('justification'=>'right','width'=>80),
						 			   'scg_cuenta'=>array('justification'=>'right','width'=>110), // Justificación y ancho de la columna
...
if ($ls_tipimp=='lote')
   {
	 ...
	 if ($li_total>0)
		{	
		  ...
		  elseif(trim($ls_codban)=="002" || trim($ls_codban)=="006" || trim($ls_codban)=="009")//Banco Del Caribe;Central;Casa Propia;Banesco;Mercantil;Banfoandes.
			 {
		  ...
		  elseif(trim($ls_codban)=="003")//Banco Central.
			 {
			   $ls_archivo   = "cheque_configurable/medidas_central.txt";
			   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
			   $li_medidas   = 22;
			 }
		  elseif(trim($ls_codban)=="005")//Banco de Venezuela.
			 {
			   $ls_archivo   = "cheque_configurable/medidas_venezuela.txt";
			   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
			   $li_medidas   = 22;
			 }
		  elseif(trim($ls_codban)=="007")//Banco Sofitasa.
			 {
			   $ls_archivo   = "cheque_configurable/medidas_sofitasa.txt";
			   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
			   $li_medidas   = 16;
			 }
		  ...
		  elseif(trim($ls_codban)=="008")//Banco Occidental de Descuento.
			 {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
else 
   {
	 ...
	 $io_pdf->set_margenes(0,55,0,0);
	 if((trim($ls_codban)=="001")||(trim($ls_codban)=="007"))//Banco Central.
		{
		   $ls_archivo   = "cheque_configurable/medidas_bicentenario.txt";
		   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
		   $li_medidas   = 16;
		}
	 elseif ((trim($ls_codban)=="002")||(trim($ls_codban)=="009"))//Banco de Venezuela.
		{
		  $ls_archivo   = "cheque_configurable/medidas_venezuela.txt";
		  $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
		  $li_medidas   = 22;
		}
	 elseif((trim($ls_codban)=="006")||(trim($ls_codban)=="010"))//Banco Banesco.
			 {
			   $ls_archivo	= "cheque_configurable/medidas_banesco.txt";
			   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
			   $li_medidas   = 16;
			 }
	 elseif (trim($ls_codban)=="008")//Banco Provincial.
		{
		  $ls_archivo   = "cheque_configurable/medidas_provincial.txt";
		  $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
		  $li_medidas   = 22;
		}
	 elseif(trim($ls_codban)=="011")//Banco Casa Propia.
		{
