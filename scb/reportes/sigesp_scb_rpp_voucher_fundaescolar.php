<?PHP
	...
	header("Cache-Control: must-revalidate, post-check=0, pre-check=0");//Fundaescolar - Primer Formato Old.
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($ls_numdoc,$ls_chevau,$ls_nomban,$ls_ctaban,$ls_nomproben,$ls_fecmov,$ls_conmov,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(511,547,9,$ls_numdoc);//522
		$li_pos=197;//200
		$io_pdf->convertir_valor_mm_px($li_pos);//print "Voucher".$ls_chevau;		
		$io_pdf->ezSetY($li_pos);
		$ls_ctaban = substr($ls_ctaban,-20);
		$la_data=array(array('chevau'=>'','banco'=>'','cuenta'=>'','cheque'=>''),
						array('chevau'=>$ls_chevau,'banco'=>$ls_nomban,'cuenta'=>$ls_ctaban,'cheque'=>""));
		$la_columna=array('chevau'=>'','banco'=>'','cuenta'=>'','cheque'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,
						 'cols'=>array('chevau'=>array('justification'=>'left','width'=>150),
						 'banco'=>array('justification'=>'center','width'=>185),
						 'cuenta'=>array('justification'=>'center','width'=>115),
						 'cheque'=>array('justification'=>'center','width'=>87))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	
		$ls_conmov = wordwrap($ls_conmov,100);
		$io_pdf->add_texto(5,108,10,$ls_conmov);//96
		
		$li_pos=134;//125
		$io_pdf->convertir_valor_mm_px($li_pos);		
		$io_pdf->ezSetY($li_pos);
		$la_data=array(array('nomproben'=>'','firma'=>'','fecha'=>''),
						array('nomproben'=>$ls_nomproben,'firma'=>'','fecha'=>''));
		$la_columna=array('nomproben'=>'','firma'=>'','fecha'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'showLines'=>0, // Mostrar Líneas
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('nomproben'=>array('justification'=>'left','width'=>250),
						 'firma'=>array('justification'=>'left','width'=>220),
				         'fecha'=>array('justification'=>'center','width'=>150))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_detalle($la_data,&$io_pdf,$x_pos)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>165),
			 						   'spg_cuenta'=>array('justification'=>'center','width'=>78),
			 						   'denctaspg'=>array('justification'=>'left','width'=>250),									   
									   'monto_spg'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>580, // Ancho Máximo de la tabla
						 'colGap'=> 1, //Separacion de los caracteres entre las barras de las tablas.
						 'xPos'=>113, // Orientación de la tabla
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					uf_print_cabecera($ls_numdoc,$ls_chevau,$ls_nomban,$ls_ctaban,$ls_nomproben,$ld_fecmov,$ls_conmov,$io_pdf); // Imprimimos la cabecera del registro
					$io_pdf->closeObject();
					...
					if($li_totrow_det>=$li_totrow_spg)
					{
						for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
						{
							...
							$la_data[$li_s]=array('estpro'=>$ls_estpro,'spg_cuenta'=>$ls_cuentaspg,'denctaspg'=>$ls_denctaspg,'monto_spg'=>$ldec_monto_spg,'scg_cuenta'=>$ls_scg_cuenta,'debe'=>$ldec_mondeb,'haber'=>$ldec_monhab);
						}
					}
					...
					if(empty($la_data))
					{
						...
						$ldec_mondeb='';
						$ldec_monhab='';
						$la_data[1]=array('estpro'=>$ls_estpro,'spg_cuenta'=>$ls_cuentaspg,'denctaspg'=>$ls_denctaspg,'monto_spg'=>$ldec_monto_spg,'scg_cuenta'=>$ls_scg_cuenta,'debe'=>$ldec_mondeb,'haber'=>$ldec_monhab);
						$la_data[2]=array('estpro'=>$ls_estpro,'spg_cuenta'=>$ls_cuentaspg,'denctaspg'=>$ls_denctaspg,'monto_spg'=>$ldec_monto_spg,'scg_cuenta'=>$ls_scg_cuenta,'debe'=>$ldec_mondeb,'haber'=>$ldec_monhab);
						$la_data[3]=array('estpro'=>$ls_estpro,'spg_cuenta'=>$ls_cuentaspg,'denctaspg'=>$ls_denctaspg,'monto_spg'=>$ldec_monto_spg,'scg_cuenta'=>$ls_scg_cuenta,'debe'=>$ldec_mondeb,'haber'=>$ldec_monhab);
					}
