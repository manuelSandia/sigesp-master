<?PHP
	...
	header("Cache-Control: must-revalidate, post-check=0, pre-check=0");//Concejo Municipal del Municipio Morán.
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,&$io_pdf,$x)
	{
		...
		$io_pdf->add_texto($valores[14],$valores[15],9,"<b>Caduca a los 90 días</b>");	
   ...
   //--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle($la_data,&$io_pdf,$x_pos)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codestpro'=>array('justification'=>'center','width'=>60),
									   ...
									   'monto_spg'=>array('justification'=>'right','width'=>70))); // Justificación y ancho de la columna
	...
	function uf_print_pie_pagina($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_nomproben,$ls_fecmov,$ls_conmov,$ls_chevau,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'colGap' =>1, // Tamaño de Letras
						 'shaded'=>0, // Sombra entre líneas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xPos'=>135, // Orientación de la tabla
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('cheque'=>array('justification'=>'center','width'=>150),
						 'banco'=>array('justification'=>'left','width'=>115))); // Ancho Máximo de la tabla
