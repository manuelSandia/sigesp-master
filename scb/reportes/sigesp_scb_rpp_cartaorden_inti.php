<?php
	...
	function uf_print_encabezado_pagina($as_numdoc,$as_fecha,&$io_pdf)
	{
		...
		$io_pdf->addText(384,137.6,9,'<b>Administracion</b>');		
		$io_pdf->addText(508,137.6,9,'<b>Presidencia</b>');
		$io_pdf->addText(258,78.85,10,'<b>Recibi Conforme</b>');
		...
		if ($as_tipproben=='B')
		   {
			 $la_config=array('showHeadings'=>1, // Mostrar encabezados
							  ...
							  'cols'=>array('cedbene'=>array('justification'=>'center','width'=>60),// Justificación y ancho de la columna
										    ...
										    'ctaban2'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
