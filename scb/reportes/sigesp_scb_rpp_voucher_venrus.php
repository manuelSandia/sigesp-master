<?php
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		...
		$la_data=array(array('vacio'=>'<b>Cuenta Nº:</b>  '.$ls_ctaban,'voucher'=>$ls_chevau),
						array('vacio'=>'','voucher'=>''));
		$la_columna=array('vacio'=>'','voucher'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>465, // Ancho de la tabla
						 'maxWidth'=>465,
						 'cols'=>array('vacio'=>array('justification'=>'left','width'=>340),'voucher'=>array('justification'=>'left','width'=>125))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->ezText('                     ',10);//Inserto una linea en blanco		
		$la_data=array(array('cheque'=>$ls_numdoc,'banco'=>$ls_nomban,'fecha'=>'<b></b>  '),
						array('cheque'=>'','banco'=>'','fecha'=>''));
		$la_columna=array('cheque'=>'','banco'=>'','fecha'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>0, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 ...
						 'width'=>465, // Ancho de la tabla
						 'maxWidth'=>465,
						 'cols'=>array('cheque'=>array('justification'=>'right','width'=>150),'banco'=>array('justification'=>'center','width'=>200),
						 'fecha'=>array('justification'=>'right','width'=>110))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);

		$la_data=array(array('ordenes'=>'<b>                          </b> '.$ls_nomproben),
					   array('ordenes'=>'<b>                                    </b> '.$ls_conmov),
					   array('ordenes'=>'<b>Orden(es) de Pago(s):</b> '.$ls_solicitudes));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>465, // Ancho de la tabla
						 'maxWidth'=>465,
						 'cols'=>array('ordenes'=>array('justification'=>'left','width'=>465))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->ezText('                     ',10);//Inserto una linea en blanco
		$io_pdf->ezText('                     ',10);//Inserto una linea en blanco
		$io_pdf->ezText('                     ',10);//Inserto una linea en blanco
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>465, // Ancho de la tabla
						 'maxWidth'=>465,
						 'cols'=>array('title'=>array('justification'=>'center','width'=>275),'title2'=>array('justification'=>'center','width'=>190))); // Ancho Máximo de la tabla
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'shaded'=>0, // Sombra entre líneas
						 'width'=>465, // Ancho de la tabla
						 'maxWidth'=>465, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>140),
			 						   'spg_cuenta'=>array('justification'=>'center','width'=>80),
									   'monto_spg'=>array('justification'=>'right','width'=>55),
						 			   'scg_cuenta'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'debe'=>array('justification'=>'right','width'=>55), // Justificación y ancho de la columna
						 			   'haber'=>array('justification'=>'right','width'=>55))); // Justificación y ancho de la columna
