<?PHP
	...
	function uf_print_encabezado_pagina($ls_banco,$ls_mes,$ls_anio,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 $li_ancho=$_SESSION["ls_width"];
		 $io_pdf->convertir_valor_px_mm($li_ancho);         
		 $io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],405,$li_alto_usado+85,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		 //------------Fecha--------------------------------//
		 $la_data=array();
		 $la_anchos_col=array();
		 $la_justificaciones=array();
