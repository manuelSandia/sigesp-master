<?PHP
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,&$io_pdf,$x)
	{
		...
		$io_pdf->add_texto($valores[14],$valores[15],9,"CADUCA A LOS 45 DIAS");	
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('title'=>array('justification'=>'center','width'=>330),'title2'=>array('justification'=>'center','width'=>250))); // Ancho Máximo de la tabla
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$la_data[0]=array('elaborado'=>'<b>Elaborado por:</b>','revisado'=>'<b>Revisado por:</b>','aprobado'=>'<b>Aprobado por:</b>','contabilizado'=>'<b>Contabilizado</b>');
		$la_data[1]=array('elaborado'=>'','revisado'=>'','aprobado'=>'','contabilizado'=>'');
		$la_data[2]=array('elaborado'=>'','revisado'=>'','aprobado'=>'','contabilizado'=>'');
		$la_data[3]=array('elaborado'=>'','revisado'=>'','aprobado'=>'','contabilizado'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 'showLines'=>1, // Mostrar Líneas
						 ...
						 'cols'=>array('elaborado'=>array('justification'=>'left','width'=>145),
									   ...
									   'aprobado'=>array('justification'=>'center','width'=>145),
						 			   'contabilizado'=>array('justification'=>'center','width'=>145))); // Justificación y ancho de la columna
		$la_columnas=array('elaborado'=>'','revisado'=>'','aprobado'=>'','contabilizado'=>'');
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
