<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina_central($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_encabezado_pagina
		//		    Acess: private 
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		...
		$io_pdf->ezSetY(525);
		$la_data=array(array('banco'=>$ls_nomban,'cheque'=>'','cuenta'=>$ls_ctaban,'voucher'=>$ls_numdoc));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cuenta'=>array('justification'=>'left','width'=>160),'voucher'=>array('justification'=>'right','width'=>160))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera_central($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_numdoc,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_cabecera
		//		   Access: private 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('banco'=>array('justification'=>'center','width'=>160),'cheque'=>array('justification'=>'left','width'=>150),
						 'cuenta'=>array('justification'=>'right','width'=>193),'voucher'=>array('justification'=>'right','width'=>90))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	for($li_i=1;$li_i<=$li_totrow;$li_i++)
	{
		...
		$ls_nomproben=$ds_voucher->data["nombre"][$li_i];
		...
		if($ls_codban=='004')
		{
			uf_print_encabezado_pagina_central(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$io_pdf); // Imprimimos el encabezado de la página
			uf_print_cabecera_central($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_numdoc,$io_pdf); // Imprimimos la cabecera del registro
		}
		else
		{
