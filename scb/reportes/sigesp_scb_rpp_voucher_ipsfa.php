<?php
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,&$io_pdf)
	{
		...
		$io_pdf->add_texto($valores[13],$valores[15],9,"<b>Caduca a los 90 dias a partir de la fecha _____/_____/_____</b>");		
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>140),
									   ...
									   'monto_spg'=>array('justification'=>'right','width'=>80),
						 			   'scg_cuenta'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$la_data[0]=array('elaborado'=>'<b>Elaborado por:</b>','revisado'=>'<b></b>','presupuesto'=>'<b>Revisado por:</b>','administracion'=>'<b></b>','presidencia'=>'');
		...
		{	
		    ...
		    for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					$ls_nomproben   = $class_report->uf_load_beneficiario_alterno($ls_codban,$ls_ctaban,$ls_numdoc,$ls_codope);
					if (empty($ls_nomproben))
					   {
					...
					if (empty($la_data))
					   ...
					   //codigo para unir las cuentas iguales
						...
						$io_pdf->y=190;
						$io_pdf->y=440;	
						$io_pdf->set_margenes(120,70,$x_pos,0);
						uf_print_detalle($la_dataaux,$io_pdf,$x_pos); // Imprimimos el detalle presupuestario y contable
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$la_suma  = array('0'=>'monto');
			$ds_dt_scg->group_by($la_items,$la_suma,'scg_cuenta');
			$li_totrow_det=$ds_dt_scg->getRowCount("scg_cuenta"); //print "deta contable ".$li_totrow_det."<br>";
			
			$ds_dt_spg->data=$class_report->uf_cargar_dt_spg($ls_numdoc,$ls_codban,$ls_ctaban,$ls_codope);
			$la_items = array('0'=>'estpro','1'=>'spg_cuenta');
			$la_suma  = array('0'=>'monto');
			$ds_dt_spg->group_by($la_items,$la_suma,'spg_cuenta');
			$li_totrow_spg=$ds_dt_spg->getRowCount("spg_cuenta"); //print "deta presu ".$li_totrow_spg."<br>";
			///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// Ciclo para unir en una sola matriz los detalles de presupuesto y los contables para proceder luego a imprimirlos.
			///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			if ($li_totrow_det>=$li_totrow_spg)
