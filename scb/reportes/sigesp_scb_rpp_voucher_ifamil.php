...
$numalet->setSufijo("***");
	...
	if ($ls_codban=='001')//Banco Banesco.
	   {
	...
	elseif($ls_codban=='002' || $ls_codban=='003')//Banco Industrial Venezuela/Miami.
	   {
	...
	elseif($ls_codban=='005')
	   {
         $ls_archivo="cheque_configurable/medidas_mercantil.txt";	   
	   	 $ls_contenido="144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00-50.00-50.00";
	 	 $li_medidas=24;
	  	 $lb_concepto=true;
	   }
