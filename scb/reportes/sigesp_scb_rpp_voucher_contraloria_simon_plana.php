<?php
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$io_pdf->line(270,90,270,148);
		$io_pdf->line(430,90,430,148);
		///$io_pdf->line(475,90,475,148);		
		$io_pdf->line(191,43,191,75);
		$io_pdf->line(310.5,43,310.5,75);
		$io_pdf->line(411,43,411,75);	
		
		$io_pdf->addText(24,137.6,9,'<b>ELABORADO POR</b>');
		$io_pdf->addText(150,137.6,9,'<b>ADMINISTRACION</b>');
		$io_pdf->addText(305,137.6,9,'<b>CONTABILIDAD</b>');		
		///$io_pdf->addText(330,137.6,9,'<b>AUDITORIA INETERNA</b>');		
		$io_pdf->addText(473,137.6,9,'<b>CONTRALORA</b>');
