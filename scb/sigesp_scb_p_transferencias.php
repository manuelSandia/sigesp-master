  ...
  <table width="722" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="189"><div align="left">
          <input name="txtdocorigen" type="text" id="txtdocorigen" style="text-align:center" onBlur="rellenar( this,15)" value="<?php print $ls_docorigen;?>" size="24" maxlength="15" <?php echo $ls_disabled; ?>>
      </div></td>
      <td width="228">&nbsp;</td>
      <td width="180">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td><div align="left">
        <input name="txtdocdestino" type="text" id="txtdocdestino" style="text-align:center" onBlur="rellenar(this,15)" value="<?php print $ls_docdestino;?>" size="24" maxlength="15" <?php echo $ls_disabled; ?>>
      </div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
...
function rellenar(obj,longitud)
{
		if(obj.value!="")
		{
			...
			if (lencad > 15)
			{
				alert ("El numero de documento no debe exceder de 15 digitos!");
				obj.value="";
			}
			else
			{
