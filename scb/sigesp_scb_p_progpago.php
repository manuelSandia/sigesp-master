		  ...
		  while(!$rs_solpag->EOF)
			   {
				 ...
				 if (($li_estciespg==1 || $li_estciespi==1) && ($ls_valor==0 && $li_estciescg==0) || 
				    ($li_estciespg==0 && $li_estciespi==0 && $li_estciescg==0))
					{
					  ...
					  $object[$li_i][7] = "<input type=text     name=txtfecprog".$li_i."   id=txtfecprog".$li_i."   value=''  class=sin-borde readonly style=text-align:center size=10 maxlength=10 onClick=javascript:uf_registrar($li_i,'$ls_numsol','$ld_montotsal','$ls_fecemisol','$ls_codproben',this);><input type=hidden name=hidprocede".$li_i." value='' class=sin-borde readonly style=text-align:left size=10 maxlength=6;>"; // ".$ls_procede." Va en el value del hidprocede OJO!!
