				...
				if ($lb_valido)
				   {
					 ...
					 $ls_estdoc='C';
						  print "<script language=javascript>";
							print "f=opener.document.form1;";
							print "f.operacion.value='CARGAR_DT';";
							if((($ls_codope=="NC")||($ls_codope=="ND")||($ls_codope=="DP"))&&($ls_contintmovban!=0))
								print "f.txtnumconint.value='$ls_numconint';";
							print "f.status_doc.value='C';";//Cambio estatus a actualizable
							print "f.action='$ls_opener';";
							print "f.submit();";
						  print "</script>";
				   }
				else
...
<table width="583" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
  ...
  <tr>
    <td height="22" colspan="2"><input name="txtcuentascg" type="hidden" id="txtcuentascg">
	  ...
	  <input name="numconint" type="hidden" id="numconint" value="<?php print $ls_numconint;?>">
	  <input name="reglibro" type="hidden" id="reglibro" value="<?php print  $ls_reglibro;?>"></td>
    </tr>
</table>
</form>
</body>
...
function aceptar_presupuestario()
{
  ...
  ls_operacion    = fop.cmboperacion.value;
  if (ls_operacion!='RE')
     {
