...
<?php
	...
	if( array_key_exists("operacion",$_POST))
	{
		...
		$li_hidtotalrows = $_POST["hidtotalrows"];
		...
		$li_hidsalsegban   = $_POST["hidsalsegban"];
		$li_hidsalsegban   = str_replace(".","",$li_hidsalsegban);
		$li_hidsalsegban   = str_replace(",",".",$li_hidsalsegban);
		
		$li_hidsalseglib   = $_POST["hidsalseglib"];
		$li_hidsalseglib   = str_replace(".","",$li_hidsalseglib);
		$li_hidsalseglib   = str_replace(",",".",$li_hidsalseglib);
		
		$li_hidconciliacion   = $_POST["hidconciliacion"];
		$li_hidconciliacion   = str_replace(".","",$li_hidconciliacion);
		$li_hidconciliacion   = str_replace(",",".",$li_hidconciliacion);
		...
		$ls_hidarray1	= $_POST["hidarraydoc"];
		$la_hidarray1	= split('<<<',$ls_hidarray1);
		
		$ls_hidarray2	= $_POST["hidarraycod"];
		$la_hidarray2	= split('<<<',$ls_hidarray2);
		
		$ls_hidarray3	= $_POST["hidarraychk"];
		$la_hidarray3	= split('<<<',$ls_hidarray3);
...
else
   {
	...
	if ($ls_operacion=="GUARDAR")
	   {		
		 ...
		 //$li_total=$li_hidtotalrows;
		 $li_total=count($la_hidarray1);
		 $aa_conciliacion["mesano"]		  = str_replace("/","",$ld_fecha);
		 $aa_conciliacion["salseglib"]	  = $li_hidsalseglib;
		 $aa_conciliacion["salsegban"]	  = $li_hidsalsegban;	
		 $aa_conciliacion["conciliacion"] = $li_hidconciliacion;
		 ...
		 { 
			 ...
			 //if ($li_change==1)
				 $li_numrowmod++;
				 //$ls_numdoc = $_POST["txtnumdoc".$li_filatil];
			     //$ls_codope = $_POST["txtcodope".$li_filatil];
				 $ls_numdoc = $la_hidarray1[$li_i];
				 $ls_codope = $la_hidarray2[$li_i];
				 if ($la_hidarray3[$li_i]==1)
				 {
					$li_estcon_mov = 1;
	...
	function uf_cargar_montos_conciliacion($as_codban,$as_ctaban,$ld_fecha)
	{
		...
		if($ld_fecha!="")
		{
			...
			$ldec_diferencia  = $ldec_diferencia + $ldec_tranoreglib;
		}
...
?>
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr class="titulo-ventana" >
	  ...
	  <input name="hidsalsegban" type="hidden" id="hidsalsegban" value="<?php print $li_hidsalsegban;?>">
	  <input name="hidsalseglib" type="hidden" id="hidsalseglib" value="<?php print $li_hidsalseglib;?>">
	  <input name="hidconciliacion" type="hidden" id="hidconciliacion" value="<?php print $li_hidconciliacion;?>">
	  <input name="hidtotalrows" type="hidden" id="hidtotalrows" value="<?php print $li_hidtotalrows;?>">
	  <input name="hidarraydoc" type="hidden" id="hidarraydoc" value="">
	  <input name="hidarraycod" type="hidden" id="hidarraycod" value="">
	  <input name="hidarraychk" type="hidden" id="hidarraychk" value="">
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td height="38" colspan="4">
        <div align="center">
          <table width="534" border="0" cellpadding="0" cellspacing="0" class="formato-blancotabla">
            <tr>
              <td width="496">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript: uf_cargar_dt();">Cargar Movimientos </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#01">Detalles Conciliaci&oacute;n</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:uf_reg_error('B');">Errores en Banco</a><!--<a href="javascript:uf_reg_error('L');">Transacciones no registradas en libro</a>--></td>
            </tr>
          </table>
        </div></td>
    </tr>
...
-->            <td><div align="left">
              <input name="txterrorlib" type="hidden" id="txterrorlib" style="text-align:right" value="<?php print number_format($ldec_errorlib,2,",",".");?>" readonly>
            </div></td>
          </tr>
          <tr>
...
function ue_guardar()
{
	...
	f.hidsalsegban.value=f.txtsalsegban.value;
	f.hidsalseglib.value=f.txtsalseglib.value;
	f.hidconciliacion.value=f.txtsaldoconcil.value;
	f.hidtotalrows.value=f.totalrows.value;
    totalfilas=f.totalrows.value;
	for(i=1;i<=totalfilas;i++)
	{
		if(eval("f.hidchange"+i+".value==1"))
		{
			f.hidarraydoc.value=f.hidarraydoc.value+eval("f.txtnumdoc"+i+".value")+"<<<";
			f.hidarraycod.value=f.hidarraycod.value+eval("f.txtcodope"+i+".value")+"<<<";
			lb_chk  = eval("f.chk"+i+".checked;");
			if (lb_chk)
			{
				f.hidarraychk.value=f.hidarraychk.value+1+"<<<";
			}
			else
			{
				f.hidarraychk.value=f.hidarraychk.value+0+"<<<";
			}	
		}
	}
