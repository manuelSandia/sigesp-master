...
<html>
<head>
<title>Cat&aacute;logo de Comprobantes de Retenci&oacute;n 1x1000</title>
  ...
  <div align="center">
    <table width="531" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr class="titulo-celda">
        ...
        Cat&aacute;logo de Comprobantes de Retenci&oacute;n 1x1000</td>
      </tr>
      <tr>
...
if ($ls_operacion=="BUSCAR")
   {
     $ls_sql="SELECT numcom, codret, fecrep, perfiscal, codsujret, nomsujret, rif, dirsujret, estcmpret 
		        FROM scb_cmp_ret 
			   WHERE codemp='".$ls_codemp."' AND codret='0000000005'";
...
<script language="JavaScript">
  ...
  function ue_search()
  {
	  ...
	  f.action="sigesp_cat_cmp_ret_1x1000.php";
	  f.submit();
  }
