...
<html>
<head>
<title>Eliminaci&oacute;n de Transferencia Bancaria no Contabilizada</title>
...
<?php
	...
	$titleProg[3]="Transferencia Bancaria";
	...
	if($ls_operacion == "PROCESAR")
	{
		...
		for($i=0;($i<=$li_total)&&($lb_valido);$i++)
		{
			if(array_key_exists("chksel".$i,$_POST))
			{
					...
					{
						$msg->message("La Transferencia Bancaria $ls_numdoc no puede ser eliminada, ya fue Conciliada");
						$lb_conciliado=true;
					}
			}			
		}
...
?>
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco" id="tabla">
    <tr class="titulo-ventana">
      <td height="22" colspan="6">Eliminaci&oacute;n de Transferencia Bancaria no Contabilizada</td>
    </tr>
    <tr>
      <td colspan="6">&nbsp;</td>
    </tr>
...
Beneficiario</label></td>
    ...
    <tr>
      <td height="13">&nbsp;</td>
      <td height="13">&nbsp;</td>
      <td height="13"><a href="javascript:uf_cambiar();" >Cargar Transferencias Bancarias </a></td>
      <td height="13">&nbsp;</td>
      <td height="13">&nbsp;</td>
      <td height="13">&nbsp;</td>
    </tr>
    <tr>
      <td height="22" colspan="6"><div align="center"><?php $io_grid->makegrid($li_total,$titleProg,$object,800,'Transferencias Bancarias no Contabilizadas ',$gridProg);?>
          <p>
