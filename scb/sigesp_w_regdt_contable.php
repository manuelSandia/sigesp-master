...
<table width="567" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
  ...
  <tr>
    ...
    <td height="22"><input name="operacion" type="hidden" id="operacion">
	  ...
	  <input name="reglibro" type="hidden" id="reglibro" value="<?php print  $ls_reglibro;?>">
	  <input name="nocontabiliza" type="hidden" id="nocontabiliza" value="<?php print  $ls_controlnocontabil;?>">
  </tr>
</table>
</form>
</body>
<script language="JavaScript">
  function aceptar_presupuestario()
  {
	...
	fop.hidconnocontabi.value=f.nocontabiliza.value;
