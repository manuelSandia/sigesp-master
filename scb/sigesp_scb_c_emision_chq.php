...
//--------------------------------------------------------------------------------------------------------------------------------------
	...
	////////////////////////////////////////////////AGREGADO POR OFIMATICA DE VENEZUELA EL 01-06-2011/////////////////////////////////////////////////////////////
    function uf_verificar_sol_repchequenomina($as_codemp,$as_numsol)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	          Metodo:  uf_verificar_sol_repcajachica
		//	          Access:  public
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////
		$ls_sql="SELECT true AS repcajchi
				   FROM cxp_solicitudes
				  WHERE codemp='".$as_codemp."'
					AND numsol='".$as_numsol."' AND consol like '%NOMINA%' and CONSOL not like '%CONTRATADO%'"; 
		$rs_dt_scg=$this->io_sql->select($ls_sql);
		if(($rs_dt_scg===false))
		{
			$this->is_msg_error="Error en uf_verificar_sol_repcajachica ".$this->fun->uf_convertirmsg($this->io_sql->message);
	...
	////////////////////////////////////////////////AGREGADO POR OFIMATICA DE VENEZUELA EL 01-06-2011/////////////////////////////////////////////////////////////
    function uf_cuenta_repchequenomina($as_codemp)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	          Metodo:  uf_verificar_sol_repcajachica
		//	          Access:  public
		...
		$ls_sql="SELECT value
				   FROM sigesp_config
				  WHERE codemp='".$as_codemp."'
					AND  entry='CTA.CONTA.CHEQUE' and codsis='SNO' and seccion='CONFIG'"; 
		$rs_dt_scg=$this->io_sql->select($ls_sql);
		if(($rs_dt_scg===false))
		{
			$this->is_msg_error="Error en uf_verificar_sol_repcajachica ".$this->fun->uf_convertirmsg($this->io_sql->message);
