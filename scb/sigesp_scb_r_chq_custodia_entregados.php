  ...
  if (li_imprimir=='1')
     {
       if (ld_fecdesde!="" && ld_fechasta!="")
          {
 	        pagina="reportes/sigesp_scb_rpp_chq_custodia_entregados_excel.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&tiprep="+ls_tiprep+"&codban="+ls_codban+"&denban="+ls_nomban+"&ctaban="+ls_ctaban+"&dencta="+ls_dencta
			       +"&probendesde="+ls_probendesde+"&probenhasta="+ls_probenhasta+"&tipo_destino="+ls_tipproben+"&tiporeporte="+ls_tiporeporte;
 	               window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
          }
       else
