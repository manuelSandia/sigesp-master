<?php
    ...
    $io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_r_retenciones_pub1x1000.php",$ls_permisos,$la_seguridad,$la_permisos);
	$ls_reporte=$io_fun_banco->uf_select_config("SCB","REPORTE","FORMATO_1x1000","sigesp_scb_rpp_retencionesunoxmil.php","C");
	$li_diasem = date('w');
	switch ($li_diasem){
...
<script type="text/javascript" language="JavaScript1.2" src="../cxp/js/funcion_sep.js"></script>
...
<script language="javascript" src="../cxp/js/funcion_cxp.js"></script>
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="22" colspan="4" align="center">Reporte de Retenciones 1x1000 Entes Publicos</td>
    </tr>
...
function ue_print()
{
	...
	if(li_imprimir==1)
	{
		...
		if(ls_comprobantes!="")
		{
			...
			pagina="../scb/reportes/"+formato+"?tiporeporte="+tiporeporte+"&mes="+ls_mes+"&anio="+ls_anio;
...
function ue_search()
{
	...
	ajax.send("catalogo=RETENCIONESIVA&tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+
