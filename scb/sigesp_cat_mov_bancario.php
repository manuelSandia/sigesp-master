...
if(array_key_exists("operacion",$_POST))
{
	...
	$ls_cartaorden="%".trim($_POST["txtcartaorden"])."%";
...
<form name="form1" method="post" action="">
  ...
  <div align="center">
    <table width="900" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        <td height="22" align="right">Carta Orden</td>
        <td height="22" colspan="2"><div align="left">
          <input name="txtcartaorden" type="text" id="txtcartaorden">        
        </div></td>
	...
	if ($ls_operacion=="BUSCAR")
       {
		 $ls_sql = "SELECT scb_movbco.codemp,scb_movbco.codban,scb_movbco.ctaban,scb_movbco.numdoc,scb_movbco.numordpagmin, ".
				   ...
				   "	   scb_ctabanco.dencta,scb_ctabanco.sc_cuenta,scb_cheques.numchequera,scb_movbco.codtipfon,scb_movbco.estmovcob,scb_movbco.numconint,scb_movbco.tranoreglib,scb_movbco.conanu, ".
		  ...
		  if((($ls_fecdesde!="")&&($ls_fecdesde!="01/01/1900"))&&(($ls_fechasta!="")&&($ls_fechasta!="01/01/1900")))
			...
			if ($ls_cartaorden!="%%") {
				$ls_sql=$ls_sql." AND scb_movbco.numcarord like '".$ls_cartaorden."'";;
			}
...
?>
		...
		<input name="txtdesproben" type="hidden" id="txtdesproben" >
		<input name="hidconint" type="hidden" id="hidconint" value="<?php print $ls_contintmovban;?>"></td>
      </tr>
    </table>
  </div>
</form>
...
<script language="JavaScript">
  ...
  function uf_aceptar(ls_documento,ls_codope,ls_fecha,ls_descripcion,ldec_monto,ldec_monobjret,ldec_monret,ls_tipo_destino,ls_prov,ls_bene,ls_provbene,ls_codban,
					  ...
					  ls_codfuefin,ls_numchequera,ls_numordpagmin,ls_codtipfon,ls_dentipfon,ls_numconint,ls_estreglib,ls_conanu,ls_voucher)
  {
   	f=opener.document.form1;
	ls_conint=document.form1.hidconint.value;
	...
	f.txtconceptoanu.value=ls_conanu;
