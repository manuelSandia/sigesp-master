...
<html>
<head>
<title>Modificaci&oacute;n de Comprobante de Retenci&oacute;n 1x1000</title>
    ...
    <tr>
      <td><table width="693" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco" id="tabla">
          <tr class="titulo-ventana">
            <td height="22" colspan="4">Modificaci&oacute;n de Comprobante de Retenci&oacute;n 1x1000</td>
          </tr>
          <tr>
            <td height="19">&nbsp;</td>
            <td>			</td>
...
function ue_nuevo()
{
	...
	f.action="sigesp_scb_p_modcmpret_1x1000.php";
	f.submit();
}
...
function ue_buscar()
{
	window.open("sigesp_cat_cmp_ret_1x1000.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=700,height=400,left=50,top=50,location=no,resizable=yes,dependent=yes");
}
