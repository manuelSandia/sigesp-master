...
<html>
<head>
<title>Selecci&oacute;n de Formato de Impresi&oacute;n de Transferencia Bancaria</title>
...
?>
		...
		<table width="647" height="335" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
              <tr class="titulo-ventana">
                <td colspan="3">Configuraci&oacute;n de Formato de Impresi&oacute;n de Transferencia Bancaria</td>
              </tr>
                  ...
                  <tr class="formato-blanco">
                    <td width="142" height="153" rowspan="4"><label>
                      <select name="lista" size="11" >
                        ...
                        <option value="@cartaorden@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">N&ordm; de Transferencia Bancaria</option>
                        <option value="@documento@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">N&ordm; de Documento</option>
                        <option value="@cuentabancaria@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">N&ordm; de Cuenta Emisor</option>						
                        <option value="@cuentabancariaextendida@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">N&ordm; de Cuenta Extendida Movimiento</option>						
                        ...
                        <option value="@bancoemisor@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">Banco Emisor</option>
                        <option value="@cuentabancariaemisor@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">N&ordm; de Cuenta Destinatario</option>						
                      	<option value="@conceptocarta@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">Justificaci&oacute;n de la Transferencia Bancaria</option>
						<option value="@nombre@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">Nombre Provedor/Beneficiario</option>
					  	<option value="@factura@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">Factura(s)</option>
						<option value="@rif@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">Rif.</option>
						<option value="@cibene@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">C.I Beneficiario</option>
					  </select>
                    </label></td>
                  ...
                  <tr class="formato-blanco">
                    ...
                    <td height="100" colspan="4" align="center" valign="top"><label>
                      ...
                      <div align="center">
                            ...
                            <p>Detalle de la Transferencia Bancaria </p>
                      </div>
                    </label></td></tr>
                  <tr class="formato-blanco">
                    <td width="39"><label>
