...
if (($li_estciespg==1 || $li_estciespi==1) && $ls_operacion=="NUEVO")
   {
	 $io_msg->message("Ya fu� procesado el Cierre Presupuestario, s�lo ser� posible la consulta de Movimientos Bancarios !!!");	   
   }
	...
	$titleSpi=array('1'=>'Cuenta','2'=>'Descripci�n','3'=>'Procede','4'=>'Documento','5'=>'Operaci�n','6'=>'Monto','7'=>'Edici�n');
	$title2=array('1'=>'Cuenta','2'=>'Documento','3'=>'Descripci�n','4'=>'Procede','5'=>'Debe/Haber','6'=>'Monto','7'=>'Deducci�n','8'=>'Edici�n');
	$title=array('1'=>'Cuenta', '2'=>'Programatico','3'=>'Documento','4'=>'Descripci�n','5'=>'Procede','6'=>'Operaci�n','7'=>'Monto','8'=>'Edici�n');
...
?>
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td colspan="6" style="text-align:left"><input name="cmboperacion" type="text" id="cmboperacion" value="CH" readonly style="text-align:center"><div style="display:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No. Orden Pago Ministerio
      ...
      &nbsp;<a href="javascript:uf_catalogo_ordenes();"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar Ordenes de Pago Ministerio..." width="15" height="15" border="0" title="Buscar Ordenes de Pago Ministerio..."></a></div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="4"><div align="left">
          <input name="txtdocumento" type="text" id="txtdocumento" style="text-align:center" onBlur="rellenar_cad(this.value,15,'doc')" value="<?php print $ls_docmov;?>" size="24" maxlength="15" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz '+'-()[]{}#/');">
    ...
    <tr>
      ...
      <td colspan="6" style="text-align:left"><input name="txtconcepto" type="text" id="txtconcepto" value="<?php print $ls_desmov;?>" size="120"  onKeyPress="return keyRestrict(event,'0123456789'+'abcdefghijklmnopqrstuvwxyz� .,*/-()$%&!�������[]{}<>')"></td>
    </tr>
    <tr>
      <td height="22" colspan="2" style="text-align:right">Concepto Anulaci&oacute;n</td>
	  <td colspan="6" style="text-align:left"><input name="txtconceptoanu" type="text" id="txtconceptoanu" value="<?php print $ls_desmovanu;?>" size="120" maxlength="254" readonly></td>
    </tr>
	<tr>
			...
			if((ls_status!="C")&&(ls_status!='O')&&(ls_status!='A'))
			{
				...
				if((lb_valido)&&(ls_provbene!="")&&(ls_descripcion!="")&&(ls_codban!="")&(ls_ctaban!="")&&(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto>0))
				{
				  ...
				  if (lb_valido)
					 {
					   ls_numconint 	  = " ";
					   ls_pagina = "sigesp_w_regdt_contable_pd.php?txtprocedencia=SCBMOV&mov_document="+ls_documento+"&fecha="+ld_fecha+"&procede="+ls_procede+
								   ...
								   "&codconmov="+ls_codconmov+"&tip_mov= &opener=sigesp_scb_p_pago_directo.php&estdoc="+ls_estdoc+"&codfuefin="+ls_codfuefin+"&numconint="+ls_numconint;
					  ...
					  if (lb_valido)
						 {
						   ...
						   ls_numconint	   = " ";
						   ls_pagina = "sigesp_w_regdt_presupuesto_pd.php?txtprocedencia=SCBMOV&mov_document="+ls_documento+"&fecha="+ld_fecha+"&procede="+ls_procede+
									   "&tipo="+ls_tipo+"&provbene="+ls_provbene+"&descripcion="+ls_descripcion+"&codban="+ls_codban+"&ctaban="+ls_ctaban+
									   "&cuenta_scg="+ls_cuenta_scg+"&mov_operacion="+ls_operacion+"&monto="+ldec_monto+"&objret="+ldec_objret+"&retenido="+ldec_monret+
									   ...
									   "&tip_mov= &opener=sigesp_scb_p_pago_directo.php&estdoc="+ls_estdoc+"&codfuefin="+ls_codfuefin+"&numordpagmin="+ls_numordpagmin+"&codtipfon="+ls_codtipfon+"&numconint="+ls_numconint;
...
{
	alert("Monto Objeto a Retenci�n no puede ser mayor al del Movimiento");	
  ...
  for (li_i=1;li_i<=li_totrowspg;li_i++)
      {
	    ...
	    ld_sumdetmov = ld_sumdetmov+ld_mondetmov;
		alert (ld_sumdetmov);
      }
