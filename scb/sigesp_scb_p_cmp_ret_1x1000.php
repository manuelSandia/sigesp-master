...
$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_cmp_ret_1x1000.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
<html>
<head>
<title>Comprobante de Retenciones 1x1000</title>
...
$in_class_cmp_ret = new sigesp_scb_c_cmp_ret('0000000005');
...
else
{
	...
	$ls_fuente=$in_classconfig->uf_select_fuente_1x1000();
	if($ls_fuente!=false)
	{
		if($ls_fuente=="C")
		{
...
?> 
  <table width="474" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td width="472" height="22" colspan="4" align="center">Comprobante de Retenciones 1x1000 </td>
    </tr>
    <tr>
...
<script language="JavaScript">
	function ue_procesar()
	{
	  ...
	  f.action="sigesp_scb_p_cmp_ret_1x1000.php";
	  f.submit();	  
	}
