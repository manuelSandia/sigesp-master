...
if($ls_operacion=="BUSCAR")
{
	...
	{
		$ls_sql_seguridad = " AND '".$ls_codemp."'||'SPG'||'".$ls_logusr."'||c.codestpro1||c.codestpro2||c.codestpro3||c.estcla IN (SELECT distinct codemp||codsis||codusu||substr(codintper,1,75)||substr(codintper,126,1)
		                       FROM sss_permisos_internos WHERE codusu = '".$ls_logusr."' AND codsis = 'SPG' AND enabled=1)";
	}
	...
	$ls_sql=" SELECT a.codestpro1 as codestpro1,a.denestpro1 as denestpro1,b.codestpro2 as codestpro2, ".
			...
			" ORDER BY a.codestpro1,b.codestpro2,c.codestpro3,c.estcla ";
...
<script language="JavaScript">
  ...
  function aceptar_rep(codestprog1,codestprog2,codestprog3,estcla)
  {
	...
	if(opener.document.form1.estcla != null)
	{
     opener.document.form1.estcla.value=estcla;
	}
	close();
