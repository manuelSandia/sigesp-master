...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_instructivo_06_ejec_fin_pry_acc.php";
...
<title>EJECUCION FINANCIERA DE LOS PROYECTOS / ACCIONES CENTRALIZADAS DEL &Oacute;RGANO</title>
...
?>
  <table width="400" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">EJECUCI&Oacute;N FINANCIERA DE LOS PROYECTOS / ACCIONES CENTRALIZADAS DEL &Oacute;RGANO </td>
    </tr>
  </table>
    ...
    <tr>
      <td height="22" colspan="3" align="left"><table width="362" height="34" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr class="titulo-celdanew">
          <td height="13"><strong class="titulo-celdanew"> MES </strong></td>
        </tr>
        <tr>
          <td height="21">
            <div align="center">
...
function ue_showouput()
{
	...
	{
		pagina="reportes/sigesp_spg_rpp_instructivo_06_ejec_fin_pry_acc.php?mes="+mes;
...
function ue_showouput_excel()
{
	...
	{
		pagina="reportes/sigesp_spg_rpp_instructivo_06_ejec_fin_pry_acc_excel.php?mes="+mes;
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	}
}
