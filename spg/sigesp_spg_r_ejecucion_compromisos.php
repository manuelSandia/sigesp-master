...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_reporte = $io_fungas->uf_select_config("SPG","REPORTE","COMPROMISOS","sigesp_spg_rpp_ejecucion_compromisos.php","C");
	
	$dat=$_SESSION["la_empresa"];
	$ls_empresa=$dat["codemp"];
	$ls_logusr=$_SESSION["la_logusr"];
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_ejecucion_compromisos.php";
...
<title>EJECUCION DE COMPROMISOS </title>
...
?>
  <table width="530" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">EJECUCION DE COMPROMISOS </td>
    </tr>
  </table>
  <table width="530" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr style="display:none">
      ...
      <td width="65" align="center"><div align="left">
    ...
    <tr>
      <td height="63" colspan="3" align="center"><div align="left">
        <table width="480" height="52" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
          <!--DWLayoutTable-->
			<tr class="titulo-celdanew">
			<td height="13" colspan="4" valign="top">Comprobante</td>
            </tr>
		    <tr class="formato-blanco">
		      <td width="147" height="37">
		        <div align="center">
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		if((txtcomprobante!="")&&(txtprocede!="")&&(txtfecha!=""))
		{
			pagina="reportes/"+reporte+"?txtcomprobante="+txtcomprobante+"&txtprocede="+txtprocede
														+"&txtfecha="+txtfecha+"&txtfecdes="+txtfecdes+"&txtfechas="+txtfechas
...
{
	   pagina="sigesp_cat_comprobantesspg_reporte.php?tipocat=rep_ejecucion";
