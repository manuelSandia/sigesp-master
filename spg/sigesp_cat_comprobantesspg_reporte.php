  ...
  <div align="center">
    <table width="565" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td width="136" align="left"><input name="txtfechahasta" type="text" id="txtfechahasta" style="text-align:center" onBlur="valFecha(document.form1.txtfecha)" onKeyPress="javascript:currencyDate(this)" value="<?php print $ls_fechasta;?>" size="18" maxlength="10" datepicker="true" > </td>
      </tr>
      <tr>
...
if($ls_operacion=="BUSCAR")
{
		...
		$ls_sql=" SELECT distinct a.procede,a.codemp,a.comprobante,a.fecha,a.ced_bene,a.cod_pro,a.descripcion,a.tipo_destino,a.total
		 		  FROM sigesp_cmp a,spg_dt_cmp b, spg_operaciones c
		  		  WHERE a.procede=b.procede AND a.tipo_comp=1 AND a.comprobante=b.comprobante AND a.fecha=b.fecha AND 
					    ...
					    a.procede like '%".$ls_procedencia."%' AND c.operacion=b.operacion AND (c.operacion='CS' OR 
						c.operacion='CG' OR c.operacion='CCP') ";		
...
<script language="JavaScript">
  ...
  function ue_search()
  {
	  ...
	  f.action="sigesp_cat_comprobantesspg_reporte.php?tipocat=<?php print $ls_tipocat; ?>";
	  f.submit();
  }
