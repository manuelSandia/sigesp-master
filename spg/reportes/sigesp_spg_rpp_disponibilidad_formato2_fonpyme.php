<?php
	...
	function uf_print_cabecera_detalle($io_encabezado,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->ezSetY(643);
		$la_data=array(array('cuenta'=>'<b>Cuenta</b>','denominacion'=>'<b>Denominación</b>','ejecutado'=>'<b>Ejecutado</b>'));
		$la_columnas=array('cuenta'=>'','denominacion'=>'','ejecutado'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la 
						 			   'denominacion'=>array('justification'=>'center','width'=>250), // Justificación y ancho de la
						 			   'ejecutado'=>array('justification'=>'center','width'=>100))); // Justificación y ancho 
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>299, // Orientación de la tabla
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la 
						 			   'denominacion'=>array('justification'=>'left','width'=>250), // Justificación y ancho de la
						 			   'ejecutado'=>array('justification'=>'right','width'=>100))); // Justificación y ancho 
	...
	function uf_print_pie_cabecera($ad_totalasignado,$ad_totaldisponible,$ad_totalejecutado,$ad_totalacumulado,$as_denominacion,&$io_pdf)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data=array(array('total'=>'<b> Total '.$as_denominacion.' </b>','ejecutado'=>$ad_totalejecutado));
		$la_columna=array('total'=>'','ejecutado'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 ...
						 'xPos'=>299, // Orientación de la tabla
						 'colGap'=>1,
				 		 'cols'=>array('total'=>array('justification'=>'right','width'=>320), // Justificación y ancho de la columna
						 	           'ejecutado'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la
	 ...
	 else // Imprimimos el reporte
	 {
		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			if (!empty($ls_programatica))
		    {
				...
				$la_data[$z]=array('cuenta'=>$ls_spg_cuenta,'denominacion'=>$ls_denominacion,'ejecutado'=>$ld_monto_ejecutado);
