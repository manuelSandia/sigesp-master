<?php
	...
	function uf_print_cabecera_detalle($io_encabezado,&$io_pdf)
	{
        ...
        //$io_pdf->ezSetDy(1);
		$io_pdf->ezSetY(644);
		$la_data=array(array('cuenta'=>'<b>Cuenta</b>','denominacion'=>'<b>Denominacion</b>',
		                     'disponibilidad'=>'<b>Disponibilidad</b>'));
		$la_columnas=array('cuenta'=>'','denominacion'=>'','disponibilidad'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tama�o de Letras
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>100), // Justificaci�n y ancho de la
						 			   'denominacion'=>array('justification'=>'center','width'=>200), // Justificaci�n y ancho de la						 			  
									   'disponibilidad'=>array('justification'=>'center','width'=>125))); // Justificaci�n y ancho
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'left','width'=>100), // Justificaci�n y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>200), // Justificaci�n y ancho de la    // Justificaci�n y ancho de la
									   'disponibilidad'=>array('justification'=>'right','width'=>125))); // Justificaci�n y ancho de
	...
	function uf_print_pie_cabecera($ad_totalasignado,$ad_totaldisponible,$as_denominacion,&$io_pdf)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data=array(array('total'=>'<b> Total '.$as_denominacion.' </b>','disminucion'=>$ad_totaldisponible));
		$la_columna=array('total'=>'','disminucion'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tama�o de Letras
						 'showLines'=>1, // Mostrar L�neas
						 'shaded'=>0, // Sombra entre l�neas
