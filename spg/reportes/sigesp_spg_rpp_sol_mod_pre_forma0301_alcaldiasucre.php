...
function uf_print_encabezado_pagina($as_titulo,$as_procede,$ad_fecha,$as_fuentefin="",$as_tipotra,&$io_pdf){
	...
	$io_pdf->addText(260,110,7,"<b>FIRMAS AUTORIZADAS</b>"); // Agregar el título
	$io_pdf->addText(90,60,7,"<b>ALCALDE MUNICIPAL</b>"); // Agregar el título
    $io_pdf->addText(80,50,7,"<b>Carlos Eduardo Ocariz Guerra</b>"); // Agregar el título 
	$io_pdf->addText(390,60,7,"<b>DIRECTOR DE PRESUPUESTO</b>"); // Agregar el título
    $io_pdf->addText(420,50,7,"<b>Federico Ortega</b>"); // Agregar el título
...
if($ls_tipotra == 1){
	$ls_titulo = "<b>SOLICITUD DE MODIFICACIÓN PRESUPUESTARIA Nº. ".$ls_numtrares."</b>";
}
else{
...
uf_print_encabezado_pagina($ls_titulo,$ls_procede,$ld_fecha,$ls_fuentefin,$ls_tipotra,$io_pdf); // Imprimimos el encabezado de la página
