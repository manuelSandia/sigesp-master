...
//----------------------------------------------------  Parámetros del encabezado  ---------------------------------------------
		$ls_titulo=" EJECUCIÓN FINANCIERA DE LOS PROYECTOS / ACCIONES CENTRALIZADAS DEL ORGANO";       
//--------------------------------------------------------------------------------------------------------------------------------
	 ...
	 else // Imprimimos el reporte
	 {
		...
		$lo_hoja->write(0, 0,"CÓDIGO DEL ÓRGANO",$lo_titulo);
		...
		$lo_hoja->write(6,0,"Código",$lo_titulo);
		$lo_hoja->write(6,1,"Denominación",$lo_titulo);
		$lo_hoja->write(6,2,"Programado",$lo_dataright2);
		$lo_hoja->write(6,3," ",$lo_titulo);
		$lo_hoja->write(6,4," ",$lo_titulo);
		$lo_hoja->write(6,5,"Ejecutado",$lo_dataright2);
		$lo_hoja->write(6,6," .",$lo_titulo);
		$lo_hoja->write(6,7," .",$lo_titulo);	
		$lo_hoja->write(6,8,"Variación Mes",$lo_titulo);
		$lo_hoja->write(6,9," .",$lo_titulo);
		$lo_hoja->write(6,10,"Responsable de la Ejecución",$lo_titulo);
		$lo_hoja->write(6,11,"Previsión Actualizada Próximo Mes",$lo_titulo);
		
		
		$lo_hoja->write(7,0," .",$lo_titulo);
		$lo_hoja->write(7,1," .",$lo_titulo);
		$lo_hoja->write(7,2,"Mensual",$lo_titulo);
		$lo_hoja->write(7,3,"Acumulado",$lo_titulo);
		$lo_hoja->write(7,4,"Mensual",$lo_dataright2);
		$lo_hoja->write(7,5,".",$lo_titulo);
		$lo_hoja->write(7,6,"Acumulado",$lo_dataright2);
		$lo_hoja->write(7,7,".",$lo_titulo);	
		$lo_hoja->write(7,8," .",$lo_titulo);
		$lo_hoja->write(7,9," ",$lo_titulo);
		$lo_hoja->write(7,10," .",$lo_titulo);
		$lo_hoja->write(7,11," .",$lo_titulo);
		
		
		$lo_hoja->write(8,0," .",$lo_titulo);
		$lo_hoja->write(8,1," .",$lo_titulo);
		$lo_hoja->write(8,2," ",$lo_titulo);
		$lo_hoja->write(8,3," ",$lo_titulo);
		$lo_hoja->write(8,4,"Compromiso",$lo_titulo);
		$lo_hoja->write(8,5,"Causado",$lo_titulo);
		$lo_hoja->write(8,6,"Compromiso",$lo_titulo);
		$lo_hoja->write(8,7,"Causado",$lo_titulo);	
		$lo_hoja->write(8,8," .",$lo_titulo);
		$lo_hoja->write(8,9," ",$lo_titulo);
		$lo_hoja->write(8,10," .",$lo_titulo);
		$lo_hoja->write(8,11," .",$lo_titulo);
