		...
		while(!$rs_data->EOF)
		{
			...
			{  
				...
				{			
		           ...
		           $io_tcpdf->uf_print_cabecera($ls_programatica,$ls_denestpro); // Imprimimos la cabecera del registro
				   $la_auxdata[0]=array('','','','SALDOS ANTERIORES',number_format(0,2,",","."),
								                     number_format(0,2,",","."),
													 number_format(0,2,",","."),
													 number_format(0,2,",","."),
													 number_format(0,2,",","."),
													 number_format(0,2,",","."),
							 					     number_format(0,2,",","."),
													 number_format(0,2,",","."),number_format(0,2,",","."));
					 $io_tcpdf->uf_print_detalle_campoext2($la_auxdata,$y,0,$ls_mostrar); // Imprimimos los saldos anteriores	

					 $la_data_tot[$li_tmp]=array('SALDO POR COMPROMETER Bs.  '.number_format(0,2,",",".").'  ',number_format(0,2,",","."),
					                             number_format(0,2,",","."),number_format(0,2,",","."),number_format(0,2,",","."),
												 number_format(0,2,",","."),number_format(0,2,",","."),number_format(0,2,",","."),
												 number_format(0,2,",","."),number_format(0,2,",","."),$ld_total_saldo_comprometer);
					
					 $io_tcpdf->uf_print_total2($la_data_tot,'3',0,$ls_mostrar);								
				}
				...
				// var_dump($ld_totspg_por_pagar);
			      ...
			      if(($ls_spg_cuenta!=$ls_spg_cuenta_next)&& ($li_tmp!=($li_totrow_det-1)))
			      {
					  ...
					  $la_data[$li_tmp]=array($ls_fecha,$ls_comprobante,$ls_documento,
										      $ls_descripcion,number_format($ld_asignado,2,",","."),
											  ...
											  number_format($ld_por_paga,2,",","."),number_format($ld_por_comprometer,2,",","."));
											  
					 $ld_monto_actualizado=0;
					 $entro=false;

					 $io_tcpdf->uf_print_cabecera_detalle($ls_spg_cuenta,$ls_denominacion);
					 $io_tcpdf->uf_print_titulos_campoext2 ($ls_mostrar);
					 $io_tcpdf->uf_print_detalle_campoext2($la_auxdata,$y,0,$ls_mostrar); // Imprimimos los saldos anteriores							 
					 $io_tcpdf->uf_print_detalle_campoext2($la_data,$y,1,$ls_mostrar); // Imprimimos el detalle
					 ...
					 $ld_por_comprometer=$ls_submonto_actual-$ls_subprecompromiso-$ls_subcompromiso;					 
					 ...
					 $la_data_subtot2[1]=array('SUB TOTAL CUENTA '.$ls_spg_cuenta,number_format($ls_sub_asignado,2,",","."),
												...
												number_format($ls_subpagar,2,",","."),number_format($ld_por_comprometer,2,",","."));
					 
					 $io_tcpdf->uf_print_total2($la_data_subtot2,'0',$y,$ls_mostrar);
					 $ls_sub_asignado          =0;
					 $ls_subaumento            =0;
					 $ls_subdisminucion        =0;
					 ...
					 $la_data_subtot[1]=array("TOTAL CUENTA ".$ls_spg_cuenta,number_format($ld_totspg_asignado,2,",","."),
											  ...
											  number_format($ld_totspg_por_pagar,2,",","."),number_format($ld_por_comprometer,2,",",".")); 
					 

					 $io_tcpdf->uf_print_total2($la_data_subtot,'1',0,$ls_mostrar);
				...
				if($li_tmp==($li_totrow_det-1))
				{
					  ...
					  $la_data[$li_tmp]=array($ls_fecha,$ls_comprobante,$ls_documento,
											  ...
											  number_format($ld_precompromiso,2,",","."),number_format($ld_compromiso,2,",","."),
											  number_format($ld_causado,2,",","."),number_format($ld_pagado,2,",","."),
											  number_format($ld_por_paga,2,",","."),$ld_total_saldo_comprometer);
					...
					$la_data_subtot2[1]=array('SUB TOTAL CUENTA '.$ls_spg_cuenta,
											  ...
											  number_format($ls_subcausado,2,",","."),
											  number_format($ls_subpagado,2,",","."),
											  number_format($ls_subpagar,2,",","."),$ld_total_saldo_comprometer);
					 ...
					 $io_tcpdf->uf_print_titulos_campoext2 ($ls_mostrar);
					 $io_tcpdf->uf_print_detalle_campoext2($la_auxdata,$y,0,$ls_mostrar); // Imprimimos los saldos anteriores	
					 $io_tcpdf->uf_print_detalle_campoext2($la_data,$y,1,$ls_mostrar); // Impr,imimos el detalle 
					 $io_tcpdf->uf_print_total2($la_data_subtot2,'0',$y,$ls_mostrar);
					 $la_data_subtot[1]=array("TOTAL CUENTA ".$ls_spg_cuenta,number_format($ld_totspg_asignado,2,",","."),
					  						  number_format($ld_totspg_aumento ,2,",","."),
											  number_format($ld_totspg_disminucion,2,",","."),
										      ...
										      number_format($ld_totspg_causado,2,",","."),
											  number_format($ld_totspg_pagado,2,",","."),
											  number_format(abs($ld_totspg_por_pagar),2,",","."),000); 
					...
					$io_tcpdf->uf_print_total2($la_data_subtot,'1',0,$ls_mostrar);
					 ...
					 $la_data_tot[$li_tmp]=array('SALDO POR COMPROMETER Bs.  '.$ld_total_saldo_comprometer.'   ',
												 ...
												 $ld_total_causado,$ld_total_pagado,$ld_total_por_paga,00);
