<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_procede,$ad_fecha,&$io_pdf,$fuente)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(25,695,7,"FUENTE DE FINANCIAMIENTO: {$fuente['denfuefin']}");
		$io_pdf->addText(295,695,7,"CONCEPTO: {$fuente['descripcion']}");
		...
		$io_pdf->addText(30,630,7,"OTRA");$io_pdf->rectangle(95,630,10,10);
		...
		//$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],80,700,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
	 ...
	 // echo $ls_estmodprog;
	  ...
	  if ($lb_valido==false)
	   ...
	   else
		 {
			...
			$fuente = $io_report->uf_select_fuente_fin($ls_comprobante);
			
			
			
			uf_print_encabezado_pagina($ls_titulo,$ls_procede,$ld_fecha,$io_pdf,$fuente); // Imprimimos el encabezado de la página
