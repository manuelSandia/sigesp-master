<?php
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $io_pdf->Rectangle(19,20,570,60);
		$io_pdf->line(300,20,300,110);	
		//$io_pdf->line(480,40,480,100);
		
		$io_pdf->addText(140,92,8,"<b>PRESUPUESTO</b>"); // Agregar el título
		$io_pdf->addText(390,92,8,"<b>CONTRALORA MUNICIPAL</b>"); // Agregar el título
