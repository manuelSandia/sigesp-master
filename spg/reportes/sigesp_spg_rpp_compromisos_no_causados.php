<?php
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la 
						               'comprobante'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la 
						 			   ...
						 			   'comprometido'=>array('justification'=>'right','width'=>120), // Justificación 
						 			   'causado'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la 
									   'pagado'=>array('justification'=>'right','width'=>60))); // Justificación y ancho de la 
	...
	//--------------------------------------------------  Parámetros para Filtar el Reporte  --------------------------------------
	 ...
	 $io_function_report->uf_load_seguridad_reporte("SPG","sigesp_spg_r_compromisos_no_causados.php",$ls_desc_event);
	////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////////////
    ...
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
     $lb_valido=$io_report->uf_spg_reportes_compromiso_no_causados($ldt_fecdes,$ldt_fechas);
		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			if (!empty($ls_cod_pro_ben_next))
			{
				 ...
				 {// Hacemos un rollback de los registros, agregamos una nueva página y volvemos a imprimir
					...
					uf_print_pie_cabecera($ld_subtotal_comprometer,$ld_subtotal_causado,$ld_subtotal_pagado,$io_pdf,"Total Bs.");	
