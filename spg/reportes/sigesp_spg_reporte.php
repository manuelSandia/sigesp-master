     ...
     if($rs_mov_spg->RecordCount()==0)
	  {
	  	$sql = "select MV.* ,
				...
				0 as precompromiso,
				0 as pago
	  			from spg_cuentas as MV
	  			where {$ls_str_sql_2}='{$ls_estructura_desde}'
	  			AND MV.spg_cuenta between '".$as_cuenta_from."' AND '".$as_cuenta_to."'
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha de Modificaciòn: 24/10/2008
	  ...
	  $ls_sql=" SELECT DT.fecha, DT.monto, OP.aumento, OP.disminucion, OP.precomprometer,OP.comprometer, OP.causar, OP.pagar ".
			  ...
			  "        EP.codfuefin BETWEEN '".$as_codfuefindes."' AND '".$as_codfuefinhas."'   ".
...
function uf_spg_reporte_detalle_acumulado_cuentas($as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,
												  ...
												  $as_spg_cuenta,$adt_fecfin,&$rs_data2)

{
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //	   Description :	Reporte que genera el reporte del acumulado por cuentas(asignacion,aumneto,disminucion ...)
	 //     Creado por :    Ing. María Beatriz Unda
	 // Fecha Creación :    13/08/08          Fecha última Modificacion : 20/08/2009
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

		$lb_valido = true;
		if ($_SESSION["ls_gestor"]=="MYSQLT")		//,MV.estcla      $as_estclades		$as_estclahas   	||MV.estcla 		$as_estclades		$as_estclahas
		{
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    16/03/09          Fecha última Modificacion :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data2===false)
		{   //error interno sql
		   $this->io_msg->message("Error en Reporte Ejecución Financiera Mensual ".$this->fun->uf_convertirmsg($this->SQL->message));
           $lb_valido = false;
		}
  	 ...
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $ls_sql=	" SELECT MV.spg_cuenta,  ".
					...
					" END as pagado ".
                  	" FROM spg_dt_cmp as MV ".
					" WHERE MV.spg_cuenta LIKE '$as_spg_cuenta'".
					" AND MV.fecha<'$adt_fecini' ".$criterio.
					" GROUP BY MV.spg_cuenta, MV.operacion".
                  	" ORDER BY MV.spg_cuenta ";
        //echo $ls_sql;
		$rs_data2=$this->SQL->select($ls_sql); 
 ...
 *************************************************************************************************************************************************/
 ...
 //     Creado por :    Ing. Arnaldo Suárez
 // Fecha Creación :    11/04/2010          Fecha última Modificacion :
 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
											  ...
											  $as_codestpro4_des,$as_codestpro5_des,$as_estclades,$as_estclahas,&$rs_estructuras)
 {
  ...
  $this->io_spg_report_funciones->uf_filtro_seguridad_programatica('spg_ep5',$ls_seguridad);
  if ($_SESSION["ls_gestor"]=="MYSQLT")
  {
...
{///////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 //     Creado por :    Ing. Arnaldo Suárez
 // Fecha Creación :    11/04/2010          Fecha última Modificacion :      Hora :
 ////////////////////////////////////////////////////////////////////////////////////////////////////////
 $lb_valido = true;	 
 $ad_precomprometer=0;
 $ad_comprometer=0;  
 ...
 { // error interno sql
	$this->io_mensajes->message("CLASE->sigesp_spg_reporte ". 
								"MÉTODO->uf_spg_ejecutado_cuenta ".
											   ...
											   $as_sc_cuenta,$as_sc_cuentah,&$rs_estructuras=NULL)
 {
	 ...
	 //     Creado por :    Ing. Arnaldo Suárez
	 // Fecha Creación :    25/06/2010          Fecha última Modificacion :
	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 $ls_sql = "";
	 $lb_valido = true;
	 $ls_seguridad="";
	 ...
	 { // error interno sql
		$this->io_msg->message("CLASE->sigesp_spg_reporte ". 
									"MÉTODO->uf_reporte_listado_cuenta_estructura ".
									...
									&$rs_cuentas=NULL,$ab_cueart=false)
 {
	 ...
	 //     Creado por :    Ing. Arnaldo Suárez
	 // Fecha Creación :    28/06/2010          Fecha última Modificacion :
	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 $lb_valido = true;
	 $ls_filtro_spg="";
	 $ls_filtro_scg="";
   ...
   {  // error interno sql
	 $this->io_msg->message("CLASE->sigesp_spg_reporte ". 
								"MÉTODO->uf_reporte_listado_cuenta ".
								"ERROR->".$this->fun->uf_convertirmsg($this->io_sql->message)); 
	$lb_valido = false;
   }
   else
