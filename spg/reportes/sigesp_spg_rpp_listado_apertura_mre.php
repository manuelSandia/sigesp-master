<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$ai_ano,&$io_pdf)
	{
		...
		//$tm1=306-($li_tm/2);
		$tm1=200-($li_tm/2);
		$io_pdf->addText($tm1,740,14,"<b>PRESUPUESTO DE LEY ".$ai_ano." <b>"); // Agregar el título
		$io_pdf->addText($tm,720,14,$as_titulo); // Agregar el título
		...
		if ($li_estmodest==1)
		{
			...
			//$ls_nomestpro3    = $_SESSION["la_empresa"]["nomestpro3"];
	 		...
	 		$la_config=array('showHeadings'=>0, // Mostrar encabezados
					 		 ...
					 		 'width'=>530, // Ancho de la tabla
					    	 'maxWidth'=>530,// Ancho Máximo de la tabla
					  		 'cols'=>array('nomestpro'=>array('justification'=>'left','width'=>150),'name'=>array('justification'=>'right','width'=>50), // Justificación y ancho de la columna
						 		   'name2'=>array('justification'=>'left','width'=>330))); // Justificación y ancho de la columna
	...
	//function uf_print_cabecera_detalle(&$io_pdf)
	{
		...
		if($as_saldol == "TRUE")
		{
		$la_data=array(array('cuenta'=>'<b>Cuenta</b>','denominacion'=>'<b>Denominación</b>','monto'=>'<b>Asignado Bs.</b>','montodol'=>'<b>Asignado $</b>'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>70), // Justificación y ancho  
						 			   'denominacion'=>array('justification'=>'center','width'=>260), // Justificación y ancho 
									   'monto'=>array('justification'=>'center','width'=>100),
									   'montodol'=>array('justification'=>'center','width'=>100))); // Justificación y ancho 
		}
		else
		{
		 $la_data=array(array('cuenta'=>'<b>Cuenta</b>','denominacion'=>'<b>Denominación</b>','monto'=>'<b>Asignado Bs.</b>'));
		 ...
		 $la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>70), // Justificación y ancho  
						 			   'denominacion'=>array('justification'=>'center','width'=>260), // Justificación y ancho 
									   'monto'=>array('justification'=>'center','width'=>200))); // Justificación y ancho 
		}							    
	...
	function uf_print_detalle($la_data,$as_saldol,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la 
						 			   'denominacion'=>array('justification'=>'left','width'=>260), // Justificación y ancho de la  
									   'monto'=>array('justification'=>'right','width'=>100),
									   'montodol'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la 
		...
		else
		{
		 $la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la 
						 			   'denominacion'=>array('justification'=>'left','width'=>260), // Justificación y ancho de la 
									   'monto'=>array('justification'=>'right','width'=>200))); // Justificación y ancho de la 
		$la_columnas=array('cuenta'=>'<b>Cuenta</b>',
						   'denominacion'=>'<b>Denominación</b>',
						   'monto'=>'<b>Monto</b>');
		}				   
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
				 		 'cols'=>array('total'=>array('justification'=>'right','width'=>330), // Justificación y ancho de la columna
						 			   ...
						 			   'montodol'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la columna
		}
		else
		{
...
//--------------------------------------------------------------------------------------------------------------------------------
    ...
    $lb_valido=$io_report->uf_spg_reporte_select_apertura($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,
	 ...
	 else // Imprimimos el reporte
	 {
		...
		uf_print_encabezado_pagina($ls_titulo,$li_ano,$io_pdf); // Imprimimos el encabezado de la página
