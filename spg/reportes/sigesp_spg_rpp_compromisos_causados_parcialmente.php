<?php
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la 
									   ...
									   'pagado'=>array('justification'=>'right','width'=>40))); // Justificación y ancho de la 
	...
	function uf_print_pie_cabecera($ad_totalcomprometer,$ad_totalcausado,$ad_totalpagado,&$io_pdf,$as_titulo)
	{
		...
		$la_data[]=array('cuenta'=>' ','comprobante'=>'','fecha'=>'<b>'.$as_titulo.'</b> ',
		                 'comprometido'=>$ad_totalcomprometer,
	...
	//--------------------------------------------------  Parámetros para Filtar el Reporte  --------------------------------------
	 ...
	 $io_function_report->uf_load_seguridad_reporte("SPG","sigesp_spg_r_compromisos_causados_parcialmente.php",$ls_desc_event);
	...
	// Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
     $lb_valido=$io_report->uf_spg_reportes_compromiso_causados_parcialmente($ldt_fecdes,$ldt_fechas);
	 ...
	 else // Imprimimos el reporte
	 {
		...
		//print_r($io_report->dts_reporte_final);
