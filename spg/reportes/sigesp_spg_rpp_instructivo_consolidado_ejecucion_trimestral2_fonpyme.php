<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_titulo_reporte($io_encabezado,$ai_periodo,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_encabezadopagina
		//		    Acess: private 
		...
		switch($ai_periodo)
		{
		 case 'I' : $ls_periodo = 'ENERO - MARZO';
		 break;
		 
		 case 'II' : $ls_periodo = 'ABRIL - JUNIO';
		 break;
		 
		 case 'III' : $ls_periodo = 'JULIO - SEPTIEMBRE';
		 break;
		 
		 case 'IV' : $ls_periodo = 'OCTUBRE - DICIEMBRE';
		 break;
		
		}
		$la_data=array(array('name'=>'<b>CODIGO PRESUPUESTARIO DEL ENTE:     </b>'.$ls_codasiona),
		               array('name'=>'<b>DENOMINACION:    </b>'.$ls_nombre),
					   array('name'=>'<b>ORGANO DE ADSCRIPCION:    </b>'.$ls_nomorgads),
		               array('name'=>'<b>PERIODO PRESUPUESTARIO:    </b>'.$ls_periodo." ".substr($_SESSION["la_empresa"]["periodo"],0,4)));
	...
	//--------------------------------------------------  Parámetros para Filtar el Reporte  -----------------------------------------
		...
		switch($ls_trimestre)
		{
		 case '0103': $trimestre = "I";
		 break;
		 
		 case '0406': $trimestre = "II";
		 break;
		 
		 case '0709': $trimestre = "III";
		 break;
		 
		 case '1012': $trimestre = "IV";
		 break;
    ...
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
	 ...
	 else // Imprimimos el reporte
	 {
		...
		uf_print_encabezado_pagina($ls_titulo,'(En Bolivares)',$io_pdf); // Imprimimos el encabezado de la página
		...
		if($ld_asignado_modificado_total == '0,00')
		{
		...
		$io_encabezado=$io_pdf->openObject();
		uf_print_titulo_reporte($io_encabezado,$trimestre,$io_pdf);
