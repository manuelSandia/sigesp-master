<?php
	...
	//$io_pdf->ezStartPageNumbers(980,40,10,'','',1); // Insertar el número de página
		...
		$li_row=4;
		$lo_hoja->write($li_row, 4, "TRIMESTRE Nº ",$lo_titulo);
		$lo_hoja->write($li_row, 5, "",$lo_titulo);
		$lo_hoja->write($li_row, 6, "VARIACION EJECUTADO PROGRAMADO EN EL TRIMESTRE Nº ",$lo_titulo);
		$lo_hoja->write($li_row, 7, "",$lo_titulo);
		$lo_hoja->write($li_row, 8, "TOTAL ACUMULADO AL TRIMESTRE Nº:",$lo_titulo);
