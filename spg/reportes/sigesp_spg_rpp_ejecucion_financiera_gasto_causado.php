...
//--------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_cabecera_estructura($io_encabezado,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5,
		                                  $ls_denestpro1,$ls_denestpro2,$ls_denestpro3,$ls_denestpro4,$ls_denestpro5,$ls_codestpro1h,
										  $ls_codestpro2h,$ls_codestpro3h,$ls_codestpro4h,$ls_codestpro5h,$ls_denestpro1h,$ls_denestpro2h,
										  $ls_denestpro3h,$ls_denestpro4h,$ls_denestpro5h,$ls_desper,$ls_lapso_meses,$ls_text_periodo,&$io_pdf)
	{
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//       Function: uf_print_cabecera_estructura
	//		   Access: private 
	//	    		   io_pdf // Objeto PDF
	//    Description: función que imprime la cabecera de cada página
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($ls_estmodest==1)
		{
			$ls_datat1[1]=array('nombre'=>'<b>'.strtoupper($li_nomestpro1).":</b> ",'desde'=>"<b>DESDE:</b>",'codestpro'=>$ls_codestpro1,'denom'=>$ls_denestpro1,'hasta'=>"<b>HASTA:</b>",'codestproh'=>$ls_codestpro1h,'denomh'=>$ls_denestpro1h);
			$ls_datat1[2]=array('nombre'=>'<b>'.strtoupper($li_nomestpro2).":</b> ",'desde'=>"<b>DESDE:</b>",'codestpro'=>$ls_codestpro2,'denom'=>$ls_denestpro2,'hasta'=>"<b>HASTA:</b>",'codestproh'=>$ls_codestpro2h,'denomh'=>$ls_denestpro2h);
			$ls_datat1[3]=array('nombre'=>'<b>'.strtoupper($li_nomestpro3).":</b> ",'desde'=>"<b>DESDE:</b>",'codestpro'=>$ls_codestpro3,'denom'=>$ls_denestpro3,'hasta'=>"<b>HASTA:</b>",'codestproh'=>$ls_codestpro3h,'denomh'=>$ls_denestpro3h);			
			...
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 ...
							 'cols'=>array('nombre'=>array('justification'=>'left','width'=>150),
							 			   'desde'=>array('justification'=>'center','width'=>30),									  
										   'codestpro'=>array('justification'=>'center','width'=>60),
										   'denom'=>array('justification'=>'left','width'=>300),
										   'hasta'=>array('justification'=>'center','width'=>30),									  
										   'codestproh'=>array('justification'=>'center','width'=>60),
										   'denomh'=>array('justification'=>'left','width'=>300)));
			$la_columna=array('nombre'=>'','desde'=>'','codestpro'=>'','denom'=>'','hasta'=>'','codestproh'=>'','denomh'=>'');			
		...
		else
		{
			...
			$ls_datat1[2]=array('nombre'=>'<b>'.strtoupper($li_nomestpro2).":</b> ",'desde'=>"<b>DESDE:</b>",'codestpro'=>$ls_codestpro2,'denom'=>$ls_denestpro2,'hasta'=>"<b>HASTA:</b>",'codestproh'=>$ls_codestpro2h,'denomh'=>$ls_denestpro2h);
			$ls_datat1[3]=array('nombre'=>'<b>'.strtoupper($li_nomestpro3).":</b> ",'desde'=>"<b>DESDE:</b>",'codestpro'=>$ls_codestpro3,'denom'=>$ls_denestpro3,'hasta'=>"<b>HASTA:</b>",'codestproh'=>$ls_codestpro3h,'denomh'=>$ls_denestpro3h);			
			$ls_datat1[4]=array('nombre'=>'<b>'.strtoupper($li_nomestpro4).":</b> ",'desde'=>"<b>DESDE:</b>",'codestpro'=>$ls_codestpro5,'denom'=>$ls_denestpro4,'hasta'=>"<b>HASTA:</b>",'codestproh'=>$ls_codestpro4h,'denomh'=>$ls_denestpro4h);
			$ls_datat1[5]=array('nombre'=>'<b>'.strtoupper($li_nomestpro5).":</b> ",'desde'=>"<b>DESDE:</b>",'codestpro'=>$ls_codestpro5,'denom'=>$ls_denestpro5,'hasta'=>"<b>HASTA:</b>",'codestproh'=>$ls_codestpro5h,'denomh'=>$ls_denestpro5h);
			...
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 ...
							 'cols'=>array('nombre'=>array('justification'=>'left','width'=>75),
							 			   'desde'=>array('justification'=>'center','width'=>30),									  
										   'codestpro'=>array('justification'=>'center','width'=>60),
										   'denom'=>array('justification'=>'left','width'=>300),
										   'hasta'=>array('justification'=>'center','width'=>30),									  
		...
		switch($ai_estilo)
		{
		 case 1:
				...
				$la_columnas=array('cuenta'=>'<b>CODIGO</b>',
								   ...
								   'periodo01'=>'<b>'.$as_nomper01.'</b>',
								   'totcom'=>'<b>TOTAL CAUSADO</b>',
								   'ajucom'=>'<b>AJUSTE/COMP</b>',
								   'modpres'=>'<b>MOD. PRES</b>',
								   'precom'=>'<b>COMPROMETIDO</b>',
								   'libprecom'=>'<b>LIBER./COMPROMISO</b>',
...
//--------------------------------------------------  Parámetros para Filtar el Reporte  ------------------------------------
	 ...
	 $io_function_report->uf_load_seguridad_reporte("SPG","sigesp_spg_r_ejecucion_financiera_causado.php",$ls_desc_event);
	////////////////////////////////         SEGURIDAD               ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------  Parámetros del encabezado  ----------------------------------------------
		$ls_titulo="<b> EJECUCION FINANCIERA DEL PRESUPUESTO DE GASTO - CAUSADO ".$ls_desper." AL ".$ld_fecfinrep."</b> ";
//--------------------------------------------------------------------------------------------------------------------------------
    ...
    $lb_valido=$io_report->uf_spg_reportes_ejecucion_financiera_presupuesto_causado($ls_codestpro1,$ls_codestpro2,
	 ...
	 else // Se Transfiere la data a otro arreglo para incluir subtotales por partida
	 {
		...
		$suma = 0;
	 	...
	 	$i=1;
	 		...
	 		for($z=1;$z<=$li_tot;$z++)
	 		{
				...
				$ld_libprecomprometido  	= $io_report->dts_reporte->data["libcomprometido"][$z];
				...
				if($ls_status=="C")
				{
					//$ls_partida_aux=$ls_partida;
					 ...
					 //echo $ls_programatica." - ".$ls_spg_cuenta." - ".$ld_totalp_precompromiso."<br>";
					 //echo $ls_spg_cuenta." - ".$ld_totalp_precompromiso."<br><br>";
				}
					...
					switch($ld_tipper)
			 		{
			  			case 1:
					         $la_data_temp[$i]=array('programatica'=>$ls_programatica,
													 ...
													 'status'=>$ls_status,
													 'estcla'=>$ls_estcla,
													 'cuenta'=>'<b>Total Partida '.$ls_partida.'</b>',
													 'denominacion'=>'',
		...
		for($z=1;$z<=($i-2);$z++)
		{
			...
			{
				$ls_denestpro1="";
			    $io_function_report->uf_spg_reporte_select_denestpro1($ls_codestpro1,$ls_denestpro1,$ls_estclades);
			}
			if($ls_codestpro1h!="")
			{
				$ls_denestpro1h="";
				$io_function_report->uf_spg_reporte_select_denestpro1($ls_codestpro1h,$ls_denestpro1h,$ls_estclahas);
			}
			if($ls_codestpro2!="")
			{
				$ls_denestpro2="";
				$io_function_report->uf_spg_reporte_select_denestpro2($ls_codestpro1,$ls_codestpro2,$ls_denestpro2,$ls_estclades);
			}
			if($ls_codestpro2h!="")
			{
				$ls_denestpro2h="";
				$io_function_report->uf_spg_reporte_select_denestpro2($ls_codestpro1h,$ls_codestpro2h,$ls_denestpro2h,$ls_estclahas);
			}
			if($ls_codestpro3!="")
			{
				$ls_denestpro3="";
				$io_function_report->uf_spg_reporte_select_denestpro3($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_denestpro3,$ls_estclades);
			}
			if($ls_codestpro3h!="")
			{
				$ls_denestpro3h="";
				$io_function_report->uf_spg_reporte_select_denestpro3($ls_codestpro1h,$ls_codestpro2h,$ls_codestpro3h,$ls_denestpro3h,$ls_estclahas);
			}
			if($li_estmodest==2)
			{
				if($ls_codestpro4!="")
				{
					$ls_denestpro4="";
					$io_function_report->uf_spg_reporte_select_denestpro4($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_denestpro4,$ls_estclades);
				}
				if($ls_codestpro4h!="")
				{
					$ls_denestpro4h="";
					$io_function_report->uf_spg_reporte_select_denestpro4($ls_codestpro1h,$ls_codestpro2h,$ls_codestpro3h,$ls_codestpro4h,$ls_denestpro4h,$ls_estclahas);
				}
				if($ls_codestpro5!="")
				{
					$ls_denestpro5="";
					$io_function_report->uf_spg_reporte_select_denestpro5($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5,$ls_denestpro5,$ls_estclades);
				}
				if($ls_codestpro5h!="")
				{
					$ls_denestpro5h="";
					$io_function_report->uf_spg_reporte_select_denestpro5($ls_codestpro1h,$ls_codestpro2h,$ls_codestpro3h,$ls_codestpro4h,$ls_codestpro5h,$ls_denestpro5h,$ls_estclahas);
				}
			 }
			...
			if($lb_lprintsub)
			{
			 $ld_comprometido     	    =$la_data_temp[$z]["precom"];
			 $ld_disponact              =$la_data_temp[$z]["disponact"];
			 $ld_disponible          	 =$ld_disponact + $ld_modpres - $ld_comprometido;	//- $ld_comprometido
			}
			else 
			{
			 $ld_comprometido     	    =$la_data_temp[$z]["precomprometido"];
			 $ld_disponact     			=$la_data_temp[$z]["disponible"];
			 $ld_disponible          	=$ld_disant + $ld_modpres - $ld_comprometido;	//- $ld_comprometido
			}
			...
			//print "$ld_disant menos $ld_causado mas $ld_modpres menos $ld_comprometido <br> <br>";
			...
			if(($ls_status == "C")&&(!$lb_lprintsub))
			{
				...
				$ld_total_comprometido 		= $ld_total_comprometido + $ld_causado;
				$ld_total_ajuste 			= $ld_total_ajuste + $ld_libcomprometido;
				$ld_total_modificaciones 	= $ld_total_modificaciones + $ld_modpres;
				$ld_total_precompromiso		= $ld_total_precompromiso + $ld_comprometido;
			...
			if (!empty($ls_programatica_next))
			{
				...
				elseif($li_consolidado == 1)
				{
				 uf_print_cabecera_estructura($io_cabecera,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5,
		                                      $ls_denestpro1,$ls_denestpro2,$ls_denestpro3,$ls_denestpro4,$ls_denestpro5,$ls_codestpro1h,
										      $ls_codestpro2h,$ls_codestpro3h,$ls_codestpro4h,$ls_codestpro5h,$ls_denestpro1h,$ls_denestpro2h,
										      $ls_denestpro3h,$ls_denestpro4h,$ls_denestpro5h,$ls_desper,$ls_lapso_meses,$ls_text_periodo,$io_pdf);
				}				  
				...
				if($_SESSION["la_empresa"]["estmodest"] == 1)
		        {
				 $io_pdf->ezSetCmMargins(5.75,3,3,3);
				}
				elseif($_SESSION["la_empresa"]["estmodest"] == 2)
				{
				 $io_pdf->ezSetCmMargins(6.35,3,3,3);
				}
