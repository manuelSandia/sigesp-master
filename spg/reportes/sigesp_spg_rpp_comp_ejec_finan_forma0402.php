<?php
	...
	function uf_print_titulo_reporte($io_encabezado,$as_programatica,$ai_ano,$as_mes,$as_denestpro,&$io_pdf)
	{
		...
		$la_data=array(array('name'=>'<b>Programatica    </b>'.'<b>'.$as_programatica.'</b>'),
		               ...
		               array('name'=>'<b>Mes  </b>'.'<b>'.$as_mes.'</b>'.'<b>           Presupuesto   </b> '.'<b>'.$ai_ano.'</b>'));
	...
	function uf_print_titulo($io_titulo,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->saveState();
		//$io_pdf->ezSetDy(-20); // para  el rectangulo 
...
//----------------------------------------------------  Parámetros del encabezado  ---------------------------------------------
		$ls_titulo=" <b>EJECUCION FINANCIERA MENSUAL DEL PRESUPUESTO DE GASTOS (FORMA 0402)</b>";       
//--------------------------------------------------------------------------------------------------------------------------------
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
	 ...
	 else // Imprimimos el reporte
	 {
		...
		//$io_pdf->ezSetCmMargins(5.7,3,3,3); // Configuración de los margenes en centímetros(para el rectangulo)
		...
		{		
			...
			if($li_estmodest==2)
			{
				...
				{
				  $ls_denestpro4="";
				  $lb_valido=$io_function_report->uf_spg_reporte_select_denestpro4($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_denestpro4);
