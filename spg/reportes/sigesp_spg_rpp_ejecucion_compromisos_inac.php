<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addText(500,730,10,$_SESSION["ls_database"]);// Agrerar el nombre de la base de datos actual
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_procede,$as_comprobante,$as_nomprobene,$as_tipo_destino,$as_descripcion,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data=array(array('name'=>'<b>Concepto: </b>  '.$as_descripcion));
		$la_columna=array('name'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'showLines'=>0, // Mostrar Líneas
						 'fontSize' => 9, // Tamaño de Letras
    ...
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
	 ...
	 else // Imprimimos el reporte
	 {
		...
		for($li_i=1;$li_i<=$li_tot;$li_i++)
		{
			...
			{
			    uf_print_cabecera($ls_procede,$ls_comprobante,$ls_nomprobene,$ls_tipo_destino,$ls_descripcion,$io_pdf); // Imprimimos la cabecera 
			}	
