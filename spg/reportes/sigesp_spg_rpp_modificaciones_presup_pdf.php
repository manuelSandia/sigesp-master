<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_comprobante,$as_descripcion,$adt_fecha,$as_proc,&$io_pdf)
	{
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xPos'=>305, // Orientación de la tabla
						 'cols'=>array('programatica'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
						 			   'cuenta'=>array('justification'=>'left','width'=>60), // Justificación y ancho de la columna
						 			   'documento'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
						 			   'descripcion'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
	...
	//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
		$ls_titulo=" <b>MODIFICACIONES PRESUPUESTARIAS</b> ";       
	//--------------------------------------------------------------------------------------------------------------------------------
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
     $lb_valido=$io_report->uf_spg_reporte_modificaciones_presupuestarias($ls_ckbrect,$ls_ckbtras,$ls_ckbinsu,$ls_ckbcre,$ldt_fecdes,$ldt_fechas);
	 ...
	 else // Imprimimos el reporte
	 {
		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			if (!empty($ls_comprobante))
		    {
				...
				$la_data[$z]=array('programatica'=>$ls_programatica,'cuenta'=>$ls_spg_cuenta,'documento'=>$ls_documento,
			...
			if (!empty($ls_comprobante_next))
			{
				...
				$la_data[$z]=array('programatica'=>$ls_programatica,'cuenta'=>$ls_spg_cuenta,'documento'=>$ls_documento,
								   'descripcion'=>$ls_descripcion,'aumento'=>$ld_aumento,'disminucion'=>$ld_disminucion);
                uf_print_cabecera($ls_comprobante_ant,$ls_descripcion,$ldt_fecha,$ls_proc,$io_pdf);
