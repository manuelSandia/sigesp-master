<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addText(900,560,10,$_SESSION["ls_database"]);// Agrerar el nombre de la base de datos actua
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_titulo_acciones(&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_titulo_acciones
		//		   Access: private 
		...
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$la_data   =array(array('name1'=>'<b>ACCIONES</b>','name2'=>'',
		                        'name3'=>'','name4'=>'',
								'name5'=>'','name6'=>''));
		$la_columna=array('name1'=>'','name2'=>'','name3'=>'','name4'=>'','name5'=>'','name6'=>'');
		$la_config =array('showHeadings'=>0,     // Mostrar encabezados
	...
	}// end function uf_print_titulo_acciones
	//--------------------------------------------------------------------------------------------------------------------------------	//--------------------------------------------------------------------------------------------------------------------------------
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle_acciones($la_data,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_detalle_acciones
		//		    Acess: private 
	...
	}// end function uf_print_detalle_acciones
	//--------------------------------------------------------------------------------------------------------------------------------

	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_cabecera_acciones($la_data_totales,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
		$ls_titulo="<b>EJECUCIÓN FINANCIERA DE LAS ACCIONES CENTRALIZADAS DEL ENTE (FORMA 0517)</b>";  
	//--------------------------------------------------------------------------------------------------------------------------------
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
     $lb_valido_proyectos=$io_report->uf_spg_reportes_comparados_forma0517_acciones($ls_codestpro1,$ls_codestpro2,
	 ...
	 else // Imprimimos el reporte
	 {
        ...
        uf_print_titulo_acciones($io_pdf);
		uf_print_detalle_acciones($la_data,$io_pdf); // Imprimimos el detalle 
		//uf_print_pie_cabecera_acciones($la_data_tot,$io_pdf);
			 ...
			 if($ls_tipoformato==1)
		 	 {
				 ...
				 $la_data_totales[$z]=array('total'=>'<b>TOTALES BsF.</b>','pres_anual'=>$ld_total_c1,'prog_acum'=>$ld_total_c2,
			...
			else
			{
				 ...
				 $la_data_totales[$z]=array('total'=>'<b>TOTALES Bs.</b>','pres_anual'=>$ld_total_c1,'prog_acum'=>$ld_total_c2,
											'monto_eject'=>$ld_total_c3,'acum_eject'=>$ld_total_c4,
											'varia_abs'=>$ld_total_c5,'varia_porc'=>$ld_total_c6,
											'varia_abs_acum'=>$ld_total_c7,'varia_porc_acum'=>$ld_total_c8,
											'reprog_prox_mes'=>$ld_total_c9);
				 ...
				 $la_data_totales_bsf[$z]=array('total'=>'<b>TOTALES Bs.</b>','pres_anual'=>$ld_total_c1_bsf,'prog_acum'=>$ld_total_c2_bsf,
											'monto_eject'=>$ld_total_c3_bsf,'acum_eject'=>$ld_total_c4_bsf,
