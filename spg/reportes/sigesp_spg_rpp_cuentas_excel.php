   ...
   /////////////////////////////////         SEGURIDAD               ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if($lb_valido)
	{
		...
		else
		{
			...
			$ls_encabezado="Listado de Cuentas Presupuestarias"; // Imprimimos el encabezado de la página
			...
			while(!$rs_estructuras->EOF)
			{
				...
				$lo_hoja->write($contlineas, 2, "Cuenta Contable",$lo_titulo);
				$lo_hoja->write($contlineas, 3,"Denominación Cta Contable", $lo_titulo);
				$contlineas++;
