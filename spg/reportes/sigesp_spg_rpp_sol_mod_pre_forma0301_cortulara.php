<?php
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(117,91,7,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->addText(114,83,7,"GTE. ADMON Y RRHH"); // Agregar el título
		$io_pdf->addText(220,90,7,"APROBADO POR: PRESIDENTE"); // Agregar el título
		$io_pdf->addText(370,90,7,"UNIDAD CEDENTE:"); // Agregar el título
		$io_pdf->addText(485,90,7,"UNIDAD RECEPTORA:"); // Agregar el título
	 ...
	 // echo $ls_estmodprog;
	  ...
	  if ($lb_valido==false)
	   ...
	   else
		 {
			...
			$ls_titulo = "<b>MODIFICACIÓN PRESUPUESTARIA Nº. ".$ls_comprobante."</b>";
