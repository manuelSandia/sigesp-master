...
function uf_print_encabezado_pagina($as_titulo,$as_procede,$ad_fecha,$as_fuentefin="",&$io_pdf){
	...
	$io_pdf->line(19,100,590,100);
	$io_pdf->line(300,120,300,40);
	$io_pdf->addText(100,110,8,"<b>Presupuesto</b>"); // Agregar el título
	$io_pdf->addText(350,110,8,"<b>Gerencia de Administración y Recursos Humanos</b>"); // Agregar el título
