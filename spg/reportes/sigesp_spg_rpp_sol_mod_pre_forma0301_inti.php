...
$io_pdf->addText(540,725,8,"A  09  35");$io_pdf->rectangle(538,723,10,10);$io_pdf->rectangle(548,723,12,10);$io_pdf->rectangle(560,723,12,10);
	...
	$io_pdf->addText(25,90,5,"GERENTE DE GESTION"); // Agregar el título
	$io_pdf->addText(30,83,5,"ADMINISTRATIVA"); // Agregar el título
	$io_pdf->addText(92,90,5,"RESPONSABLE DEL PROYECTO"); // Agregar el título
	$io_pdf->addText(98,83,5,"/ACCION CENTRALIZADA"); // Agregar el título
	$io_pdf->addText(180,90,5,"GERENTE DE PLANIFICACION."); // Agregar el título
	$io_pdf->addText(190,83,5,"ESTRATEGICA"); // Agregar el título
	$io_pdf->addText(265,90,5,"COORD. DE PLANIFICACION"); // Agregar el título
	$io_pdf->addText(270,83,5,"Y FORMUL. PRUSUPUEST."); // Agregar el título
	$io_pdf->addText(350,90,5,"MAXIMA AUTORIDAD");
	$io_pdf->addText(450,90,5,"DIRECTOR"); // Agregar el título
	$io_pdf->addText(520,90,5,"DIRECTOR G. SECTORIAL"); // Agregar el título
...
$ls_fuentefin = $io_report->uf_obtener_fuente_financiamiento_comprobante($ls_comprobante,$ls_procede,$ld_fecha,$ls_desmod);
...
if ($la_result_dis->EOF && $la_result_aum->EOF){
	...
	$io_pdf->ezNewPage();
	$io_pdf->addText(220,570,7,"<b>EXPOSICIÓN DE MOTIVOS</b>");
	$io_pdf->ezSetDy(-45);
