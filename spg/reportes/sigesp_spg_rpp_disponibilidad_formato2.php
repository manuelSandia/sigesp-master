	...
	function uf_print_cabecera_detalle($io_encabezado,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la 
						 			   'denominacion'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la
						 			   'asignado'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la 
						 			   'acumulado'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la 
						 			   'ejecutado'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la 
									   'disponibilidad'=>array('justification'=>'center','width'=>100))); // Justificación y ancho 
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la 
						 			   ...
						 			   'acumulado'=>array('justification'=>'right','width'=>100), // Justificación y ancho de la 
						 			   'ejecutado'=>array('justification'=>'right','width'=>100), // Justificación y ancho de la 
									   'disponibilidad'=>array('justification'=>'right','width'=>100))); // Justificación y ancho 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'colGap'=>1,
				 		 'cols'=>array('total'=>array('justification'=>'right','width'=>150), // Justificación y ancho de la columna
						 	           ...
						 	           'acumulado'=>array('justification'=>'right','width'=>100), // Justificación y ancho de la 
						 	           'ejecutado'=>array('justification'=>'right','width'=>100), // Justificación y ancho de la 
							           'disminucion'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la
