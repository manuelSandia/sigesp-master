<?php
    ...
    //--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera_detalle($io_encabezado,$as_descripcion,$as_numdoc,$as_fecmov,$as_fecaprmod,$as_tipmodpre,&$io_pdf)
	{
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// cuadro inferior
        $io_pdf->Rectangle(90,60,430,70); 
		$io_pdf->line(90,117,520,117);	//HORIZONTAL	
		$io_pdf->addText(120,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(120,63,7,"FIRMA Y FECHA"); // Agregar el título
		$io_pdf->line(230,60,230,130);	//VERTICAL	
		$io_pdf->addText(270,122,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(270,63,7,"FIRMA Y SELLO"); // Agregar el título
		$io_pdf->line(380,60,380,130);	//VERTICAL		
		$io_pdf->addText(410,122,7,"DIRECCIÓN GENERAL"); // Agregar el título
		$io_pdf->addText(420,63,7,"FIRMA Y SELLO"); // Agregar el título
		$io_pdf->line(90,73,520,73); //HORIZONTAL		
		...
		$io_pdf->addText(415,630,10,'Fecha Aprobación: '.$as_fecaprmod);
			 ...
			 for ($z=1;$z<=$li_tot;$z++)
				 {
				   ...
				   $ldt_fecaprmod  = $io_report->dts_reporte->data["fecaprmod"][$z];
		 	       ...
		 	       if (!empty($ls_procomp_next))
			          {
						 ...
						 else
						 {
							...
							//uf_print_pie_cabecera($ld_totalaumento_bsf,$ld_totaldismi_bsf,'BsF.',$io_pdf);
						 }
