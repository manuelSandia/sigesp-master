...
<table width="798" height="203" border="0" align="center">
  <tr>
	...
	<table width="800" height="171" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
   ...
   if($li_totnum>0)
   {
	   ...
	   {    
		    ...
		    $object[$i][3]="<input type=text name=txtAsignacion".$i." class=sin-borde onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)' value=$ld_asignado  onFocus= uf_fila(".$i.") style=text-align:right>
			                <input type=hidden name=txtMarzo".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)' value=$ld_marzo class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
			                <input type=hidden name=txtJunio".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)' value=$ld_junio class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
                            <input type=hidden name=txtSeptiembre".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)' value=$ld_septiembre class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
                            <input type=hidden name=txtDiciembre".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)' value=$ld_diciembre class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>";
...
{  
   ...
   { 
		...
		$object[$i][3]="<input type=text name=txtAsignacion".$i." class=sin-borde onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)' value=".number_format($ld_asignado,2,",",".")."  onFocus= uf_fila(".$i.") style=text-align:right>
			            <input type=hidden name=txtMarzo".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)' value=".number_format($ld_marzo,2,",",".")." class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
			            <input type=hidden name=txtJunio".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)' value=".number_format($ld_junio,2,",",".")." class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
                        <input type=hidden name=txtSeptiembre".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)' value=".number_format($ld_septiembre,2,",",".")." class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
                        <input type=hidden name=txtDiciembre".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)' value=".number_format($ld_diciembre,2,",",".")." class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>";
		$object[$i][4]="<div align='center'><a href=javascript:ue_distribuir(".$i.");><img src=../shared/imagebank/tools/nuevo.gif alt=Detalle width=12 height=15 border=0></a></div>";
		$object[$i][5]="<div align='center'><a href=javascript:uf_asignardisfuefin('$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_estcla','".trim($ls_cuenta)."',$i);><img src=../shared/imagebank/mas.gif alt=Detalle width=12 height=24 border=0></a></div>";
...
function ue_distribuir(i)
{
   ...
   if(li!="")
   {
	   ...
	   else
	   {
			...
			pagina="sigesp_spg_p_apertura_trim_distribucion.php?fila="+li+"&txtAsignacion="+ld_asignacion+"&marzo="+ld_marzo+"&junio="+ld_junio
			        +"&septiembre="+ld_septiembre+"&diciembre="+ld_diciembre+"&txtCuenta="+ls_cuenta+"&txtDenominacion="+ls_denominacion
...
function catalogo_estpro3()
{
	...
	{
    	pagina="sigesp_cat_public_estpro3.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2+"&estcla="+estcla+"&tipo=apertura";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
	else
	{
