...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_cuentas.php";
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			pagina="reportes/sigesp_spg_rpp_cuentas.php?codestpro1="+codestpro1
		...
		else
		{
			...
			pagina="reportes/sigesp_spg_rpp_cuentas.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
...
function ue_showouput_excel()
{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			pagina="reportes/sigesp_spg_rpp_cuentas_excel.php?codestpro1="+codestpro1
					+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
					+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&txtcuentades="+txtcuentades
					+"&txtcuentahas="+txtcuentahas+"&cuentascg_desde="+txtcuentascg_des+"&cuentascg_hasta="+txtcuentascg_has
					+"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas
		...
		else
		{
			...
			pagina="reportes/sigesp_spg_rpp_cuentas_excel.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
			+"&codestpro3="+codestpro3+"&codestpro4="+codestpro4+"&codestpro5="+codestpro5
			+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h
			+"&codestpro4h="+codestpro4h+"&codestpro5h="+codestpro5h+"&txtcuentades="+txtcuentades
			+"&txtcuentahas="+txtcuentahas+"&cuentascg_desde="+txtcuentascg_des+"&cuentascg_hasta="+txtcuentascg_has
