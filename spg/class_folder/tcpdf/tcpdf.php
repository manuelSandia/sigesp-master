	...
	*/
	class TCPDF {
		...
		*/
		...
		protected $ifacumulado = false;
		
		protected $headerx1 = 0;
		protected $headerx2 = 0;
		...
		*/
		...
		public function  setHeaderx($bandera,$x1,$x2) {
			$this->ifacumulado = $bandera;
			$this->headerx1 = $x1;
			$this->headerx2 = $x2;
		}
