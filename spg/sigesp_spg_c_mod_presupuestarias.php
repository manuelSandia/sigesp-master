...
function uf_generar_num_cmp($as_codemp,$as_procede)
{
	 ...
	 $ls_sql="SELECT max(comprobante) as comprobante ".
					...
					"					 AND (comprobante not like '%Ñ%' AND comprobante not like '%ñ%')".
					...
					" 					 AND (comprobante not like '%-%' OR comprobante not like '%_%') ".
					"  					 AND (comprobante not like '%|%' OR comprobante not like '%º%') ". 
					"   				 AND (comprobante not like '%.%' OR comprobante not like '%?%') ". 
					"  					 AND (comprobante not like '%¿%' OR comprobante not like '%!%') ". 
					"  					 AND (comprobante not like '%¡%' OR comprobante not like '%&%') ". 
					"  					 AND (comprobante not like '%%%' OR comprobante not like '%$%') ". 
					"  					 AND (comprobante not like '%$%' OR comprobante not like '%#%') ". 
...
/**********************************************************************************************************************************/
	function uf_sigesp_insert_comprobante($as_codemp,$as_procede,$as_comprobante,$as_fecha,$ai_tipo_comp,$as_descripcion,
	                                      $as_tipo,$as_cod_prov,$as_ced_ben,$as_codfuefin,$as_coduniadm,$as_esttraresol="",$as_numtrasresolucion="")
	{
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($as_esttraresol=="" && $as_numtrasresolucion==""){
			...
			$ls_sql = " INSERT INTO sigesp_cmp_md (codemp,procede,comprobante,fecha,descripcion,tipo_comp,tipo_destino,".
		          "                            cod_pro,ced_bene,total,estapro,codfuefin,coduac,codtipmodpre,esttrares,numtrares)".
				  " VALUES('".$as_codemp."', '".$as_procede."', '".$as_comprobante."','".$ls_fec."', ".
				  "        '".$as_descripcion."',".$ai_tipo_comp.",'".$as_tipo."','".$as_cod_prov."', ".
				  "        '".$as_ced_ben."', ". intval(0). ",0,'".$as_codfuefin."','".$as_coduniadm."','".$this->is_tipmodpre."',".$as_esttraresol.",'".$as_numtrasresolucion."')";
		}
...
/**********************************************************************************************************************************/
	function uf_sigesp_update_comprobante($as_codemp,$as_procede,$as_comprobante,$as_fecha,$ai_tipo_comp,$as_descripcion,$as_tipo,$as_cod_prov,$as_ced_ben,$li_estapro,$as_codfuefin,$as_coduniadm,$as_esttraresol="",$as_numtrasresolucion="")
    {		
		//////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$cadupdate = "";
		if ($as_esttraresol == "" && $as_numtrasresolucion == "") {
			$cadupdate = ", esttrares = 0, numtrares='' ";
		}
		else{
			$cadupdate = ", esttrares = ".$as_esttraresol.", numtrares='".$as_numtrasresolucion."' ";
		}
		
		
		$ls_sql = " UPDATE sigesp_cmp_md SET descripcion='".$as_descripcion."' ,estapro=".$li_estapro.", codfuefin='".$as_codfuefin."',coduac='".$as_coduniadm."' ".$cadupdate."  
...
/**********************************************************************************************************************************/
	function uf_sigesp_comprobante($as_codemp,$as_procedencia,$as_comprobante,$as_fecha,$ai_tipo_comp,$as_descripcion,
	                               $as_tipo,$as_cod_pro,$as_ced_bene,$adec_monto,$li_estapro,$as_codfuefin,$as_coduniadm,$as_esttraresol="",$as_numtrasresolucion="")
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	{
		...
		{	
           ...
           $lb_valido=$this->uf_sigesp_update_comprobante($as_codemp,$as_procedencia,$as_comprobante,$as_fecha,$ai_tipo_comp,$as_descripcion,$as_tipo,$this->is_cod_prov,$this->is_ced_ben,$li_estapro,$as_codfuefin,$as_coduniadm,$as_esttraresol,$as_numtrasresolucion);
		}
		else
		{
		   $this->ib_new_comprobante=true;		
		   $lb_valido=$this->uf_sigesp_insert_comprobante($as_codemp,$as_procedencia,$as_comprobante,$as_fecha,$ai_tipo_comp,$as_descripcion,$as_tipo,$this->is_cod_prov,$this->is_ced_ben,$as_codfuefin,$as_coduniadm,$as_esttraresol,$as_numtrasresolucion);
		}
		return $lb_valido;
	} // end function uf_procesar_comprobante_en_linea()
/**********************************************************************************************************************************/
function uf_guardar_automatico($as_comprobante,$ad_fecha,$as_proccomp,$as_desccomp,$as_prov,$as_bene,$as_tipo,$ai_tipo_comp,$li_estapro,$as_codfuefin,$as_coduniadm,$as_esttraresol="",$as_numtrasresolucion="")
{
	$lb_valido=false;
	...
	{	
	   $lb_valido=$this->uf_sigesp_comprobante($dat["codemp"],$as_proccomp,$as_comprobante,$ad_fecha,$ai_tipo_comp,$as_desccomp,$as_tipo,$as_prov,$as_bene,0,$li_estapro,$as_codfuefin,$as_coduniadm,$as_esttraresol,$as_numtrasresolucion);
	   if (!$lb_valido)
	   {
...
//echo "<script>alert({$ls_sql})</script>";
//	die();			
