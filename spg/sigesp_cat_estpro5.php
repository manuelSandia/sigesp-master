	...
	if($ls_operacion=="BUSCAR")
	{
		...
		if($row=$io_sql->fetch_row($rs_data))
		{
			...
			for($z=1;$z<=$li_totrow;$z++)
			{
				...
				$codestprog1=substr($codestprog1,-$ls_loncodestpro1);
				$codestprog2=substr($codestprog2,-$ls_loncodestpro2);
				$codestprog3=substr($codestprog3,-$ls_loncodestpro3);
				$codestprog4=substr($codestprog4,-$ls_loncodestpro4);
				$codigo=substr($codigo,-$ls_loncodestpro5);
