...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_distribucion_trimestral_presupuesto.php";
...
<title>DISTRIBUCION TRIMESTRAL DEL PRESUPUESTO</title>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.gif" width="20" height="20" border="0" title="Imprimir"><a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.jpg" alt="Excel" width="20" height="20" border="0" title="Excel"></a></a><a href="sigespwindow_blank.php"><img src="../shared/imagebank/tools20/salir.gif" alt="Salir" width="20" height="20" border="0" title="Salir"></a><img src="../shared/imagebank/tools20/ayuda.gif" alt="Ayuda" width="20" height="20" title="Ayuda"></td>
  </tr>
</table>
<?php
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">DISTRIBUCION TRIMESTRAL DEL PRESUPUESTO </td>
    </tr>
  </table>
      ...
      <td height="13" colspan="4" align="center"><table width="567" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td width="167"><div align="left">
              <input name="txtcodfuefindes" type="text" id="txtcodfuefindes"  style="text-align:center" value="<?php print $ls_codfuefindes; ?>" readonly>
          ...
          <td width="120"><input name="txtcodfuefinhas" type="text" id="txtcodfuefinhas" style="text-align:center" value="<?php print $ls_codfuefinhas; ?>" readonly>
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			if (((codestpro1!="")&&(codestpro2!="")&&(codestpro3!=""))||((codestpro1h!="")&&(codestpro2h!="")&&(codestpro3h!="")))
			{
				...
				pagina="reportes/sigesp_spg_rpp_distribucion_trimestral_presupuesto.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
			...
			{
				alert("Debe seleccionar un rango de estructuras programatica")
			}
		}
		else
		{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			if (((codestpro1!="")&&(codestpro2!="")&&(codestpro3!=""))||((codestpro1h!="")&&(codestpro2h!="")&&(codestpro3h!="")))
			{
				...
				pagina="reportes/sigesp_spg_rpp_distribucion_trimestral_presupuesto_excel.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
						+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h
						+"&tipoformato="+tipoformato+"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas
						+"&estclades="+estclades+"&estclahas="+estclahas+"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas;
				window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
