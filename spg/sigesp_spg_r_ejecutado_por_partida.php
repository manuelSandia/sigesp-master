  ...
  <table width="580" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center"><table width="542" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          <td width="53" colspan="2"><div align="right">Reporte Resumido</div></td>
          <td colspan="2"><div align="left">
              <input type="checkbox" name="chkresumido" id="chkresumido" value="0"   />
          </div></td>
          <td width="51">&nbsp;</td>
          <td width="47"><div align="right"></div></td>
          <td width="192"><div align="left"></td>
        </tr>
	...
	if(li_imprimir==1)
	{
		...
		else
		{
			...
			else                                                          
			{
				...
				+"&tipoformato="+tipoformato+"&resumen="+li_resumen;
