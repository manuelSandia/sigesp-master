...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_ejecucion_financiera_causado.php";
...
<title>Reporte de Ejecucion Financiera de Presupuesto de Gasto - Causado</title>
...
?>
    ...
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Ejecucion Financiera de Presupuesto de Gasto - Causado </td>
    </tr>
  </table>
      ...
      <tr>
        <td height="22" colspan="3" align="left"><table width="568" height="84" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
            ...
            <tr>
              ...
              <td width="91">
                <div align="center">
                  <input name="botbimensual" type="button" class="boton" id="botbimensual" value="Bimestral" onClick="uf_cargar_combo('BIMENSUAL')">
                  </div></td><td width="257" colspan="2"><div align="left">
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		if((ls_periodo != "")&&(ls_periodo != "s1"))
		{
			...
			if(estmodest==1)
			{
					   pagina="reportes/sigesp_spg_rpp_ejecucion_financiera_gasto_causado.php?codestpro1="+codestpro1
...
function ue_openexcel()
{
	...
	if(li_imprimir==1)
	{
		...
		if((ls_periodo != "")&&(ls_periodo != "s1"))
		{
			...
			if(estmodest==1)
			{
					   pagina="reportes/sigesp_spg_rpp_ejecucion_financiera_gasto_causado_excel.php?codestpro1="+codestpro1
					   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
					   +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h
					   +"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas
					   +"&tipper="+li_tipper+"&periodo="+ls_periodo+"&tperiodo="+ls_text_periodo
