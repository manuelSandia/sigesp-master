...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_cuentas_conart.php";
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-celdanew">Listado de Cuentas Presupuestarias(Vinculación Cuenta Articulos) </td>
    </tr>
  </table>
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="306" align="center"><div align="left">
        <?php 
		  }
		 if($li_estmodest==1)
		 {
    ...
    <tr>
      <td height="19" colspan="3" align="left"></div></td>
    </tr>
    <tr>
      <td colspan="3" align="center"><div align="left" class="style14"></div>        
        <table width="559" border="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			pagina="reportes/sigesp_spg_rpp_cuentas_conart.php?codestpro1="+codestpro1
		...
		else
		{
			...
			pagina="reportes/sigesp_spg_rpp_cuentas_conart.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
			+"&codestpro3="+codestpro3+"&codestpro4="+codestpro4+"&codestpro5="+codestpro5
...
function ue_showouput_excel()
{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			pagina="reportes/sigesp_spg_rpp_cuentas_conart_excel.php?codestpro1="+codestpro1
					+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
					+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&txtcuentades="+txtcuentades
					+"&txtcuentahas="+txtcuentahas+"&cuentascg_desde="+txtcuentascg_des+"&cuentascg_hasta="+txtcuentascg_has
					+"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas
		...
		else
		{
			...
			pagina="reportes/sigesp_spg_rpp_cuentas_conart_excel.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
			+"&codestpro3="+codestpro3+"&codestpro4="+codestpro4+"&codestpro5="+codestpro5
			+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h
			+"&codestpro4h="+codestpro4h+"&codestpro5h="+codestpro5h+"&txtcuentades="+txtcuentades
			+"&txtcuentahas="+txtcuentahas+"&cuentascg_desde="+txtcuentascg_des+"&cuentascg_hasta="+txtcuentascg_has
