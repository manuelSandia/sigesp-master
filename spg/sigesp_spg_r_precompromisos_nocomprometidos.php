...
if (!array_key_exists("la_logusr",$_SESSION))
   ...
   //////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_precompromisos_nocomprometidos.php";
...
<?php 
	...
	//////////////////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////
?>
  <table width="530" height="19" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" height="17" colspan="2" class="titulo-ventana">PRE-COMPROMISOS</td>
    </tr>
  </table>
  <table width="530" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center"><div align="left"></div>        <div align="left" class="style14"></div>        <div align="left">
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		pagina="reportes/sigesp_spg_rpp_precompromisos_nocomprometidos.php?txtfecdes="+txtfecdes+"&txtfechas="+txtfechas;
