...
stm_ep();
stm_aix("p1i5","p1i0",[0,"Consolidaci&oacute;n Presupuestaria","","",-1,-1,0,"sigesp_spg_p_consolidacion_empresas.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
stm_ep();
stm_ep();
...
//stm_aix("p4i0","p1i0",[0," Listado de Cuentas Presupuestarias (Cuenta Articulos) ","","",-1,-1,0,"sigesp_spg_r_cuentas_conart.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
...
stm_aix("p4i0","p1i0",[0," Ejecucion Presupuestaria Mensual de Gasto  ","","",-1,-1,0,"sigesp_spg_r_ejecucion_financiera_mensual.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
...
stm_aix("p4i0","p1i0",[0," Ejecucion Financiera de Presupuesto de Gasto - Causado ","","",-1,-1,0,"sigesp_spg_r_ejecucion_financiera_causado.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
...
stm_aix("p4i0","p1i0",[0," Pre-Compromisos","","",-1,-1,0,"sigesp_spg_r_precompromisos_nocomprometidos.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
...
stm_aix("p1i5","p1i0",[0," ONAPRE ","","",-1,-1,0,"","","","","","",6,0,0,"../shared/imagebank/arrow.gif","../shared/imagebank/arrow.gif",0,0,0,0,1,"#ffffff"]);
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
stm_aix("p1i0","p1i0",[0," Instructivo 06 ","","",-1,-1,0,"","","","","","",6,0,0,"../shared/imagebank/arrow.gif","../shared/imagebank/arrow.gif",0,0,0,0,1,"#ffffff"]);
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
...
stm_ep();
stm_aix("p1i0","p1i0",[0," Instructivo 07 ","","",-1,-1,0,"","","","","","",6,0,0,"../shared/imagebank/arrow.gif","../shared/imagebank/arrow.gif",0,0,0,0,1,"#ffffff"]);
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
...
stm_aix("p1i0","p1i0",[0," Instructivo 08 ","","",-1,-1,0,"","","","","","",6,0,0,"../shared/imagebank/arrow.gif","../shared/imagebank/arrow.gif",0,0,0,0,1,"#ffffff"]);
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
stm_aix("p1i5","p1i0",[0," Ejecuci&oacute;n Trimestral de Gastos y Aplicaciones Financiera (Resumen Institucional)","","",-1,-1,0,"sigesp_spg_r_ejecucion_trimestral2.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i5","p1i0",[0," Consolidado de Ejecuci&oacute;n Trimestral de Gastos y Aplicaciones Financieras ","","",-1,-1,0,"sigesp_spg_r_instructivo_consolidado_ejecucion_trimestral2.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
<!-- stm_aix("p1i5","p1i0",[0," Ejecuci&oacute;n Trimestral de Gastos y Aplicaciones Financieras por Programatica ","","",-1,-1,0,"sigesp_spg_r_instructivo_ejecucion_trimestral_x_programatica2.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]); -->
stm_aix("p1i5","p1i0",[0," Estado de Resultados ","","",-1,-1,0,"sigesp_spg_r_instructivo_estado_resultado2.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);stm_ep();
