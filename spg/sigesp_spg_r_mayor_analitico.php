...
$ls_reporte = $io_fungas->uf_select_config("SPG","REPORTE","MAYOR ANALITICO","sigesp_spg_rpp_mayor_analitico_pdf.php","C");
unset($io_fungas);
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_mayor_analitico.php";
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.gif" width="20" height="20" border="0" title="Imprimir"></a>
	                                                  </a><a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.jpg" alt="Excel" width="20" height="20" border="0" title="Excel"></a>
													  <a href="sigespwindow_blank.php"><img src="../shared/imagebank/tools20/salir.gif" alt="Salir" width="20" height="20" border="0" title="Salir"></a>
...
?>
  ...
  <table width="580" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="281" align="center"><div align="left">
        <?php 
		  }
		 if($li_estmodest==1)
		 {
    ...
    <tr>
      <td colspan="3" align="center"><div align="left"></div>        <div align="left"></div>        <div align="left" class="style14"></div>        <div align="left">
        <table width="567" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td width="97" height="39"><div align="right">Desde</div></td>
    ...
    <tr>
      <td colspan="3" align="center"><div align="left">
          <table width="567" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
            <tr class="titulo-celdanew">
              <td height="13" colspan="3"><strong>Configurar Reporte </strong></td>
            </tr>
            <tr>
              <td width="110" height="22"><div align="right"></div></td>
               <td width="28"><div align="right">
                 <label>
                 <input type="checkbox" name="checkmostrar" value="">
                 </label>
               </div>              
              
                <div align="left"></div></td>
            <td width="421"><div align="left">Ocultar campo Detalle de los Comprobantes  Presupuestarios</div></td>             
            </tr>
          </table>
      </div></td>
    </tr>
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			else
			{
				...
				{
				  pagina="reportes/"+ls_reporte+"?codestpro1="+codestpro1
							...
							+"&estclades="+estclades+"&estclahas="+estclahas+"&mostrar="+mostrar;
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			else
			{
				...
				{
				  pagina="reportes/sigesp_spg_rpp_mayor_analitico_excel.php?codestpro1="+codestpro1
							+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3
							+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h
							+"&txtcuentades="+txtcuentades
							+"&txtcuentahas="+txtcuentahas+"&txtfecdes="+txtfecdes+"&rborden="+orden+"&txtfechas="+txtfechas
		...
		else
		{
			...
			else
			{
				...
				{
				  pagina="reportes/sigesp_spg_rpp_mayor_analitico_excel.php?reportes/sigesp_spg_rpp_mayor_analitico_excel.php?codestpro1="+codestpro1
							+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro4="+codestpro4+"&codestpro5="+codestpro5
							+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h
							+"&codestpro4h="+codestpro4h+"&codestpro5h="+codestpro5h+"&txtcuentades="+txtcuentades
							+"&txtcuentahas="+txtcuentahas+"&txtfecdes="+txtfecdes+"&rborden="+orden+"&txtfechas="+txtfechas
