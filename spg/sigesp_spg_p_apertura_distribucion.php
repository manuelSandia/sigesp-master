...
<form name="form1" method="post" action="">
  ...
  ?>
    ...
    <tr>
      ...
      <td><input name="radiobutton" type="radio" value="A" <?php print $ls_auto;?> onClick='ue_distribucion("A","<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>")'>
        Autom&aacute;tica</td>
      <td><input name="radiobutton" type="radio" value="M" <?php print $ls_manual;?> onClick='ue_distribucion("M","<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>")'>
        Manual </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="146">
        <div align="left">
          <input name="txtEnero" type="text" class="fd-blanco" id="txtEnero" onBlur="uf_actualizar(this)" onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>')' value="<?php print $ld_enero ?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly; ?>>
</div></td><td class="fd-blanco"><div align="right">Julio</div></td>
      <td><input name="txtJulio" type="text" class="fd-blanco" id="txtJulio" onBlur="uf_actualizar(this)"  onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this'<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>')' value="<?php print $ld_julio?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly; ?>>        <div align="right">
        </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="txtFebrero" type="text" class="fd-blanco" id="txtFebrero" onBlur="uf_actualizar(this)"  onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this'<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>')' value="<?php  print $ld_febrero?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly; ?>></td>
      <td class="fd-blanco"><div align="right">Agosto</div></td>
      <td><input name="txtAgosto" type="text" class="fd-blanco" id="txtAgosto" onBlur="uf_actualizar(this)"  onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this'<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>')' value="<?php  print $ld_agosto?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly; ?>></td>
    </tr>
    <tr>
      <td class="fd-blanco Estilo1">&nbsp;</td>
      <td><span class="Estilo1"></span></td>
    ...
    <tr>
      ...
      <td><input name="txtMarzo" type="text" class="fd-blanco" id="txtMarzo" onBlur="uf_actualizar(this)"  onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>')' value="<?php print $ld_marzo?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly; ?>></td>
      <td class="fd-blanco"><div align="right">Septiembre</div></td>
      <td><input name="txtSeptiembre" type="text" class="fd-blanco" id="txtSeptiembre" onBlur="uf_actualizar(this)" onKeyPress='return keyRestrictgrid(event)'onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>')' value="<?php print $ld_septiembre?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly; ?>></td>
    </tr>
    <tr>
      <td class="fd-blanco Estilo1">&nbsp;</td>
      <td><span class="Estilo1"></span></td>
    ...
    <tr>
      ...
      <td><input name="txtAbril" type="text" class="fd-blanco" id="txtAbril" onBlur="uf_actualizar(this)"  onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>')' value="<?php print $ld_abril?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly; ?>></td>
      <td class="fd-blanco"><div align="right">Octubre</div></td>
      <td><input name="txtOctubre" type="text" class="fd-blanco" id="txtOctubre" onBlur="uf_actualizar(this)"  onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>')' value="<?php print $ld_octubre?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly; ?>></td>
    </tr>
    <tr>
      <td class="fd-blanco Estilo1">&nbsp;</td>
      <td><span class="Estilo1"></span></td>
    ...
    <tr>
      ...
      <td><input name="txtMayo" type="text" class="fd-blanco" id="txtMayo" onBlur="uf_actualizar(this)" onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>')' value="<?php print $ld_mayo?>" size="25" style="text-align:right" <?php print $ls_readonly; ?>></td>
      <td class="fd-blanco"><div align="right">Noviembre</div></td>
      <td><input name="txtNoviembre" type="text" class="fd-blanco" id="txtNoviembre" onBlur="uf_actualizar(this)" onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>')' value="<?php print $ld_noviembre?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly; ?>></td>
    </tr>
    <tr>
      <td class="fd-blanco Estilo1">&nbsp;</td>
      <td><span class="Estilo1"></span></td>
    ...
    <tr>
      ...
      <td><input name="txtJunio" type="text" class="fd-blanco" id="txtJunio" onBlur="uf_actualizar(this)" onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>')' value="<?php print $ld_junio?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly; ?>></td>
      <td class="fd-blanco"><div align="right">Diciembre</div></td>
      <td><input name="txtDiciembre" type="text" class="fd-blanco" id="txtDiciembre" onBlur="uf_actualizar(this)" onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>')'value="<?php print $ld_diciembre?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly; ?>></td>
    </tr>
    <tr>
      <td class="fd-blanco Estilo1">&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td class="fd-blanco">&nbsp;</td>
      <td>&nbsp;</td>
      <td colspan="2" rowspan="4"><input name="botAceptar" type="button" class="boton" id="botAceptar" onClick="ue_aceptar('<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>')" value="Aceptar">
...
<script language="javascript">
function ue_aceptar(estspgdecimal)
{
	f=document.form1;
    li=f.fila.value;
	opcion=f.tipo.value;
	...
	if(estspgdecimal==1){
		ld_total=uf_convertir(ld_total);
		ld_total=uf_convertir_monto(ld_total); 
	}

	
	if (ld_total!=ld_asignado)
	{
	  alert(" La Distribución no cuadra con lo asignado. Por favor revise los montos "+ld_total);
	}
	else
	{	
        txtm1 = "txtEnero"+li;
...
function ue_distribucion(opcion,estspgdecimal)
{
   f=document.form1;
   ...
   if(opcion=="A")
   {
	   f.txtEnero.readOnly = true;
	   f.txtFebrero.readOnly = true;
	   f.txtMarzo.readOnly = true;
	   f.txtAbril.readOnly = true;
	   f.txtMayo.readOnly = true;
	   f.txtJunio.readOnly = true;
	   f.txtJulio.readOnly = true;
	   f.txtAgosto.readOnly = true;
	   f.txtSeptiembre.readOnly = true;
	   f.txtOctubre.readOnly = true;
	   f.txtNoviembre.readOnly = true;
	   ...
	   if(estspgdecimal==0){
		   ...
		   ld_diciembre=uf_convertir(ld_diciembre);
	   		...
	   		ld_division=uf_convertir(ld_division);	
	   		ld_mes=parseFloat(uf_convertir_monto(ld_division));
	   		ld_diciembre=uf_convertir(ld_mes+(ld_asignacion-(ld_mes*12)))
	   }
	   m1="txtEnero";
   ...
   else if (opcion == "M")
   {
	...
	f.txtEnero.readOnly = false;
    f.txtFebrero.readOnly = false;
    f.txtMarzo.readOnly = false;
    f.txtAbril.readOnly = false;
    f.txtMayo.readOnly = false;
    f.txtJunio.readOnly = false;
    f.txtJulio.readOnly = false;
    f.txtAgosto.readOnly = false;
    f.txtSeptiembre.readOnly = false;
    f.txtOctubre.readOnly = false;
    f.txtNoviembre.readOnly = false;
    f.txtDiciembre.readOnly = false;
    m1="txtEnero";
    ld_enero=eval("f."+m1+".value='"+ld_monto+"'") ;
    m2="txtFebrero";
    ld_febrero=eval("f."+m2+".value='"+ld_monto+"'") ;
    m3="txtMarzo";
    ld_marzo=eval("f."+m3+".value='"+ld_monto+"'") ;
    m4="txtAbril";
    ld_abril=eval("f."+m4+".value='"+ld_monto+"'") ;
    m5="txtMayo";
    ld_mayo=eval("f."+m5+".value='"+ld_monto+"'") ;
    m6="txtJunio";
    ld_junio=eval("f."+m6+".value='"+ld_monto+"'") ;
    m7="txtJulio";
    ld_julio=eval("f."+m7+".value='"+ld_monto+"'") ;
    m8="txtAgosto";
    ld_agosto=eval("f."+m8+".value='"+ld_monto+"'") ;
    m9="txtSeptiembre";
    ld_septiembre=eval("f."+m9+".value='"+ld_monto+"'") ;
    m10="txtOctubre";
    ld_octubre=eval("f."+m10+".value='"+ld_monto+"'") ;
    m11="txtNoviembre";
    ld_noviembre=eval("f."+m11+".value='"+ld_monto+"'") ;
    m12="txtDiciembre";
...
<?php
   ...
   if(($ld_enero == "0,00")&&($ld_febrero == "0,00")&&($ld_marzo == "0,00")&&
	  ($ld_abril == "0,00")&&($ld_mayo == "0,00")&&($ld_junio == "0,00")&&
	  ($ld_julio == "0,00")&&($ld_agosto == "0,00")&&($ld_septiembre == "0,00")&&
	  ($ld_octubre == "0,00")&&($ld_noviembre == "0,00")&&($ld_diciembre == "0,00"))
   {
?>
<script language="javascript">
document.form1.radiobutton[0].checked = true;
ue_distribucion("A",'<?php echo $_SESSION["la_empresa"]["estspgdecimal"]?>');
</script>
<?php    
   }
?>
