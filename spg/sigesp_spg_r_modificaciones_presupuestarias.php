...
<title>Reporte de Modificaciones Presupuestarias No Aprobadas</title>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.gif" width="20" height="20" border="0" title="Imprimir"></a><a href="javascript:ue_graficos();"></a><a href="sigespwindow_blank.php"><img src="../shared/imagebank/tools20/salir.gif" alt="Salir" width="20" height="20" border="0" title="Salir"></a>
...
?>
  ...
  <table width="540" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td height="19" colspan="3" align="left"><strong><span class="style14">
        ...
        <table width="480" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="121" colspan="2"><div align="left">
              <input name="txtfecdes" type="text" id="txtfecdes" onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" style="text-align:center"value="<?php print $ldt_fecdes ; ?>" size="15" maxlength="15" datepicker="true">
            </div></td>
            <td width="20">&nbsp;</td>
	...
	if(li_imprimir==1)
	{
		...
		else                                                          
		{
			pagina="reportes/"+ls_reporte+"?ckbrect="+ckbrect+"&txtcomprobante="+txtcomprobante
					+"&txtfecha="+txtfecha+"&txtprocede="+txtprocede+"&ckbtras="+ckbtras+"&ckbinsu="+ckbinsu+"&ckbcre="+ckbcre
					+"&txtfecdes="+txtfecdes+"&txtfechas="+txtfechas+"&tipoformato="+tipoformato;
...
function ue_graficos()
{
	...
	if(li_imprimir==1)
	{
		...
		{
			pagina="reportes/sigesp_spg_rpp_modificaciones_presupuestarias_torta?ckbrect="+ckbrect+"&txtcomprobante="+txtcomprobante
					+"&txtfecha="+txtfecha+"&txtprocede="+txtprocede+"&ckbtras="+ckbtras+"&ckbinsu="+ckbinsu+"&ckbcre="+ckbcre
					+"&txtfecdes="+txtfecdes+"&txtfechas="+txtfechas+"&tipoformato="+tipoformato;
			window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
...
{
	   pagina="sigesp_cat_comprobantes_modificaciones.php?tipocat=rep_ejecucion";
