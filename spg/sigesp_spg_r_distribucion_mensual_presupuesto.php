...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_distribucion_mensual_presupuesto.php";
...
<title>DISTRIBUCION MENSUAL DEL PRESUPUESTO </title>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.gif" width="20" height="20" border="0" title="Imprimir"></a><a href="javascript: ue_showouput_excel();"><img src="../shared/imagebank/tools20/excel.jpg" width="20" height="20" border="0" title="Imprimir"></a><a href="sigespwindow_blank.php"><img src="../shared/imagebank/tools20/salir.gif" alt="Salir" width="20" height="20" border="0" title="Salir"></a><img src="../shared/imagebank/tools20/ayuda.gif" alt="Ayuda" width="20" height="20" title="Ayuda"></td>
  </tr>
</table>
<?php
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">DISTRIBUCION MENSUAL DEL PRESUPUESTO </td>
    </tr>
  </table>
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td height="13" colspan="4" align="center"><table width="567" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td width="167"><div align="left">
              <input name="txtcodfuefindes" type="text"  style="text-align:center" id="txtcodfuefindes" value="<?php print $ls_codfuefindes; ?>">
          ...
          <td width="120"><input name="txtcodfuefinhas" type="text" style="text-align:center" id="txtcodfuefinhas" value="<?php print $ls_codfuefinhas; ?>">
            <a href="javascript:catalogo_fuefinhas();"></a></td>
          <td width="80"><a href="javascript:catalogo_fuefinhas();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a></td>
        </tr>
      </table>	</td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5" align="center"><table width="567" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr class="titulo-celdanew">
          <td height="13" colspan="5"><strong>Intervalo de Cuentas Presupuestarias </strong></td>
        </tr>
        <tr>
          <td width="96" height="22"><div align="right"><span class="style1 style14">Desde</span></div></td>
          <td width="167"><div align="left">
              <input name="txtcuentades" readonly="true" type="text" id="txtcuentades"  style="text-align:center" value="<?php print $ls_cuentades; ?>">
          ...
          <td width="94"><div align="right">Hasta</div></td>
          <td width="120"><input name="txtcuentahas" readonly="true" type="text" id="txtcuentahas" style="text-align:center" value="<?php print $ls_cuentahas; ?>">
            <a href="javascript:catalogo_cuentahas();"></a></td>
  ...
  <p align="center"><input name="total" type="hidden" id="total" value="<?php print $totrow;?>">
</p>
</form>      
<p>&nbsp;</p>
<p>&nbsp;</p>
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			pagina="reportes/sigesp_spg_rpp_distribucion_mensual_presupuesto.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
					...
					+"&estclades="+estclades+"&estclahas="+estclahas+"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas;
		...
		else
		{
			...
			pagina="reportes/sigesp_spg_rpp_distribucion_mensual_presupuesto.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
					+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h
					+"&codestpro4="+codestpro4+"&codestpro5="+codestpro5+"&codestpro4h="+codestpro4h+"&codestpro5h="+codestpro5h
					+"&tipoformato="+tipoformato+"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas
					+"&estclades="+estclades+"&estclahas="+estclahas+"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas;
			window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
...
function ue_showouput_excel()
{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			pagina="reportes/sigesp_spg_rpp_distribucion_mensual_presupuesto_excel.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
					+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h
					+"&tipoformato="+tipoformato+"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas
					+"&estclades="+estclades+"&estclahas="+estclahas+"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas;
			window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
