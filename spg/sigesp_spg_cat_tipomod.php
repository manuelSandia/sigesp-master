...
if ($row=$io_sql->fetch_row($rs_fuente))
   {
	 ...
	 for ($z=1;$z<=$totrow;$z++)
	{
			...
			$ls_pretipmodpre2= str_pad(rtrim($ls_pretipmodpre), 3,0);
			print "<td><a href=\"javascript: aceptar('$ls_codtipmodpre','$ls_dentipmodpre','$ls_contipmodpre','$ls_pretipmodpre2');\">".$ls_codtipmodpre."</a></td>";
