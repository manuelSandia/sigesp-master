...
<html>
<head>
<title>Catalogo de Comprobante Insusbsitencia</title>
...
<form name="form1" method="post" action="">
  ...
  <table width="565" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Comprobante Insubsistencia </td>
    </tr>
  </table>
  <br>
  <div align="center">
    <table width="565" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td width="113" align="left"><input name="procede" type="text" id="procede" value="SPGINS" readonly ></td>
...
if($ls_operacion=="BUSCAR")
{
		...
		$ls_sql=" SELECT distinct sigesp_cmp_md.codemp||sigesp_cmp_md.procede||sigesp_cmp_md.comprobante||sigesp_cmp_md.fecha,sigesp_cmp_md.*, ".
		        ...
		        " WHERE sigesp_cmp_md.codemp='".$ls_codemp."' AND sigesp_cmp_md.comprobante like '".$ls_comprobante."' AND sigesp_cmp_md.procede='SPGINS'".
	...
	else
	{
		...
		alert("No se han creado Comprobantes de Insubsistencia.....");
		//close();
        </script>
		<?php
	}
...
function ue_search()
{
	 ...
	 f.action="sigesp_cat_insubsistencia.php";
	 f.submit();
}
