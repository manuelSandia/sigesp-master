...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_acum_x_cuentas.php";
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.gif" width="20" height="20" border="0" title="Imprimir"></a>
													  ...
													  <a href="javascript:ue_graficos();"></a>
...
<?php 
	...
	$ls_reporte           = $io_fun_gasto->uf_select_config("SPG","REPORTE","ACUMULADO_POR_CUENTA","sigesp_spg_rpp_acum_x_cuenta_pdf.php","C");
	$ls_reporte_detallado = $io_fun_gasto->uf_select_config("SPG","REPORTE","ACUMULADO_POR_CUENTA_DET","sigesp_spg_rpp_acum_x_cuenta_pdf_detallado.php","C");	
?>
    </p>
    ...
    <table width="600" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
      ...
      <tr>
        <td height="13" colspan="3" align="left"><table width="567" height="40" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="5"><strong class="titulo-celdanew">Nivel de Cuentas </strong></td>
          </tr>
          <tr>
            <td width="59"><div align="right"><span class="style1 style14">Nivel</span></div></td>
            <td width="161" height="22"><select name="cmbnivel" id="cmbnivel">
            ...
            <td width="77" style="display:none"><div align="right">
              <input name="checkformato" type="checkbox" id="checkformato" value="1"  <?php print $checkformato;?> >
            </div></td>
            <td width="165" style="display:none">Formato # 2 </td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td height="48" colspan="3" align="center"><table width="567" height="34" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco" <?php echo $ls_mostrar_estruc; ?>>
          <tr class="titulo-celdanew">
          ...
          <tr>
            <td height="21"><div align="center">
                <label>
                <input name="rdotipo" type="radio" id="rdotipo" checked>
                  Consolidado</label>
                <input type="radio" name="rdotipo" id="rdotipo">
              Detallado
              </label>
            </div></td>
          </tr>
      ...
      <tr>
        <td height="68" colspan="3" align="center"><div align="left">
              <table width="567" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
                <tr class="titulo-celdanew">
                  <td height="13" colspan="3"><strong>Acumulado Hasta</strong></td>
                </tr>
                <tr>
                <td width="231"><div align="right"></div></td>
                  <td width="334" align="left">
				  <input type="hidden" name="cmbmesdes" id="cmbmesdes" value="01">
...
{
	f=document.form1;
	nombreformato    = document.getElementById('nombrereporte').value;
	nombreformatodet = document.getElementById('nombrerepdet').value;
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			{
			   if(f.checkformato.checked==true)
			   {
				   pagina="reportes/sigesp_spg_rpp_acum_x_cuenta_formato2.php?codestpro1="+codestpro1
			   ...
			   else
			   {
				   ...
				   {
				    pagina="reportes/"+nombreformato+"?codestpro1="+codestpro1
				    +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
				    +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel
				    +"&cmbmesdes="+cmbmesdes+"&cmbmeshas="+cmbmeshas+"&checksubniv="+checksubniv
				    +"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas+"&tipoformato="+tipoformato
				   ...
				   else if(f.rdotipo[1].checked)
				   {
				    pagina="reportes/"+nombreformatodet+"?codestpro1="+codestpro1
				    +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
				    +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel
				    +"&cmbmesdes="+cmbmesdes+"&cmbmeshas="+cmbmeshas+"&checksubniv="+checksubniv
				    +"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas+"&tipoformato="+tipoformato
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			else
			{
				   ...
				   {
				    pagina="reportes/sigesp_spg_rpp_acum_x_cuenta_torta.php?codestpro1="+codestpro1
				    +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
				    +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel
				    +"&cmbmesdes="+cmbmesdes+"&cmbmeshas="+cmbmeshas+"&checksubniv="+checksubniv
				    +"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas+"&tipoformato="+tipoformato
				   ...
				   {
				    pagina="reportes/sigesp_spg_rpp_acum_x_cuenta_barra.php?codestpro1="+codestpro1
				    +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
				    +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel
				    +"&cmbmesdes="+cmbmesdes+"&cmbmeshas="+cmbmeshas+"&checksubniv="+checksubniv
				    +"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas+"&tipoformato="+tipoformato
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			else
			{
			   ...
			   {
			       pagina="reportes/sigesp_spg_rpp_acum_x_cuenta_excel_detallado.php?codestpro1="+codestpro1
				   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
				   +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel
				   +"&cmbmesdes="+cmbmesdes+"&cmbmeshas="+cmbmeshas+"&checksubniv="+checksubniv
				   +"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas+"&tipoformato="+tipoformato
