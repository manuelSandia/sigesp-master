...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_reportepdf = $io_fungas->uf_select_config("SPG","REPORTE","EJECUCION MENSUAL","sigesp_spg_rpp_ejecucion_financiera_mensual.php","C");
	$ls_reportexls = $io_fungas->uf_select_config("SPG","REPORTE","EJECUCION MENSUAL XLS","sigesp_spg_rpp_ejecucion_financiera_mensual_excel.php","C");
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_ejecucion_financiera_mensual.php";
...
<title>Reporte de Ejecuci&oacute;n Presupuestaria Mensual de Gasto</title>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.gif" width="20" height="20" border="0" title="Imprimir"></a><a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.jpg" alt="Excel" width="20" height="20" border="0" title="Excel"></a>
													  <a href="javascript:ue_graficos();"></a><a href="sigespwindow_blank.php"><img src="../shared/imagebank/tools20/salir.gif" alt="Salir" width="20" height="20" border="0" title="Salir"></a><img src="../shared/imagebank/tools20/ayuda.gif" alt="Ayuda" width="20" height="20" title="Ayuda"></td>
  </tr>
</table>
  <p>
<?php
...
?>
    ...
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">EJECUCI&Oacute;N PRESUPUESTARIA MENSUAL DE GASTO </td>
    </tr>
  </table>
    <table width="600" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
      ...
      <tr>
        <td height="13" colspan="3" align="center"><table width="567" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        <td height="13" colspan="3" align="left"><table width="567" height="40" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="2"><strong class="titulo-celdanew">Nivel de Cuentas </strong></td>
          </tr>
          <tr>
            <td width="226"><div align="right"><span class="style1 style14">Nivel</span></div></td>
            <td width="339" height="22">
              <div align="left">
...
-->
      ...
      <tr>
        <td colspan="3" align="center" class="titulo-celdanew">Graficos</td>
      </tr>
      <tr>
        <td colspan="3" align="center"><input name="rdgrafico" type="radio" class="sin-borde" value="radiobutton" checked>
Torta
...
Barras</td>
      ...
      <tr>
        <td colspan="3" align="center"><div align="right"><span class="Estilo1"> </span><span class="Estilo1">
            ...
            <input name="hidreportepdf" type="hidden" id="hidreportepdf" value="<?php print $ls_reportepdf;?>">
            <input name="hidreportexls" type="hidden" id="hidreportexls" value="<?php print $ls_reportexls;?>">
        </span></div></td>
      </tr>
    </table>
    <p align="center">
...
function ue_showouput()
{
	...
	ls_reportepdf  = f.hidreportepdf.value;
	if(li_imprimir==1)
	{
		...
		if((ls_periodo != "")&&(ls_periodo != "s1"))
		{
			if(estmodest==1)
			{
				...
				//else
				//{
				   pagina="reportes/"+ls_reportepdf+"?codestpro1="+codestpro1
			...
			else
			{
				...
				//{
					   ...
					   +"&codestpro5h="+codestpro5h+"&cmbnivel="+cmbnivel
					   +"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas
					   +"&tipper="+li_tipper+"&periodo="+ls_periodo+"&tperiodo="+ls_text_periodo
					   +"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas+"&estclades="+estclades
					   +"&estclahas="+estclahas;
	...
	if(li_imprimir==1)
	{
		...
		if((ls_periodo != "")&&(ls_periodo != "s1"))
		{
			if(estmodest==1)
			{
				...
				{
					   pagina="reportes/sigesp_spg_rpp_ejecucion_financiera_mensual_torta.php?codestpro1="+codestpro1
					   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel
					   +"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas
					   +"&tipper="+li_tipper+"&periodo="+ls_periodo+"&tperiodo="+ls_text_periodo
					   +"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas+"&estclades="+estclades
					   +"&estclahas="+estclahas;
				...
				{
					   pagina="reportes/sigesp_spg_rpp_ejecucion_financiera_mensual_barra.php?codestpro1="+codestpro1
					   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel
					   +"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas
					   +"&tipper="+li_tipper+"&periodo="+ls_periodo+"&tperiodo="+ls_text_periodo
					   +"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas+"&estclades="+estclades
...
function ue_openexcel()
{
	...
	ls_periodo = f.combo.value;
	ls_text_periodo= f.combo.options[f.combo.selectedIndex].text;
	ls_reportexls  = f.hidreportexls.value;
	if(li_imprimir==1)
	{
		codestpro1  = f.codestpro1.value;
		codestpro2  = f.codestpro2.value;
		...
		if((ls_periodo != "")&&(ls_periodo != "s1"))
		{
			if(estmodest==1)
			{
				...
				cmbnivel = f.cmbnivel.value;
				   pagina="reportes/"+ls_reportexls+"?codestpro1="+codestpro1
				   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
				   +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel
				   +"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas
				   +"&tipper="+li_tipper+"&periodo="+ls_periodo+"&tperiodo="+ls_text_periodo
