...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_reportepdf = $io_fungas->uf_select_config("SPG","REPORTE","DISPONIBILIDAD FORMATO 2","sigesp_spg_rpp_disponibilidad_formato2.php","C");
    
	$dat=$_SESSION["la_empresa"];
	$ls_empresa=$dat["codemp"];
	$ls_logusr=$_SESSION["la_logusr"];
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_disponibilidad_formato2.php";
...
?>
  ...
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="312" align="center"><div align="left">
          <?php 
		  }
		 if($li_estmodest==1)
		 {
    ...
    <tr>
      <td height="16" colspan="3" align="left"></div></td>
    </tr>
    <tr>
      <td colspan="3" align="center"><div align="left"></div>        <div align="left"></div>        <div align="left" class="style14"></div>        <div align="left">
        <table width="559" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="6"><strong>Fecha de Corte</strong></td>
          </tr>
          <tr height="25">
            <td width="230" colspan="3"><div align="right">Hasta</div></td>
            <td width="250" colspan="3"><div align="left">
