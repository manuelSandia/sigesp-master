			   ...
			   while($row=$io_sql->fetch_row($rs_data))
			        {
				      ...
				      $ls_esttrares = $row["esttrares"];
				      $ls_numtrares = $row["numtrares"];
					  ...
					  print "<td style=text-align:center width=100><a href=\"javascript: uf_aceptar('$ls_numcom','$ls_descom','$ls_procom','$ls_feccom','$ls_tipproben','$ls_codpro','$ls_cedben','$li_estapro','$ls_codfuefin','$ls_coduniadm','$ls_denuniadm','$ls_esttrares','$ls_numtrares');\">".$ls_numcom."</a></td>";
...
<script language="JavaScript">
  ...
  function uf_aceptar(comprobante,descripcion,procede,fecha,tipo,prov,bene,estapro,ls_codfuefin,ls_coduniadm,denuniadm,estrares,numtrares)
  {
