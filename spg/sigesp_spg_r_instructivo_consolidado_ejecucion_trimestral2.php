...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_reportepdf = $io_fungas->uf_select_config("SPG","REPORTE","CONSOLIDADO EJECUCION INST08 PDF","sigesp_spg_rpp_instructivo_consolidado_ejecucion_trimestral2.php","C");
	$ls_reportexls = $io_fungas->uf_select_config("SPG","REPORTE","CONSOLIDADO EJECUCION INST08 XLS","sigesp_spg_rpp_instructivo_consolidado_ejecucion_trimestral2_excel.php","C");
	$io_seguridad= new sigesp_c_seguridad();
    
	$ls_empresa=$_SESSION["la_empresa"]["codemp"];
	$ls_logusr=$_SESSION["la_logusr"];
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_instructivo_consolidado_ejecucion_trimestral.php";
...
<title>CONSOLIDADO DE EJECUCION TRIMESTRAL</title>
...
?>
  <table width="400" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">CONSOLIDADO DE EJECUCION TRIMESTRAL </td>
    </tr>
  </table>
...
function ue_showouput()
{
	...
	else
	{
		...
		pagina="reportes/"+ls_reportepdf+"?trimestre="+trimestre;
...
function ue_showouput_excel()
{
	...
	{
		li_mesdes=trimestre.substr(0,2);
		pagina="reportes/"+ls_reportexls+"?trimestre="+trimestre;
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	}
}
