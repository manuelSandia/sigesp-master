...
class sigesp_sss_c_usuarios
{
	...
	function uf_sss_delete_usuario($as_codemp,$as_codusu,$aa_seguridad)
	{
		...
		else
		{
			...
			if(!$lb_existe)
			{
				$lb_valido=$this->uf_sss_delete_permisos_internos($as_codemp,$as_codusu);
				if(!$lb_valido)
				{
					return false;
				}
	...
	function  uf_sss_delete_permisos_internos($as_codemp,$as_codusu)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_sss_delete_permisos_internos
		//         Access: private
		//      Argumento: $as_codemp    // codigo de empresa
		//  			   $as_codusu    // codigo de usuario
		//	      Returns: Retorna un Booleano
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->usuarios MÉTODO->uf_sss_delete_permisos_internos ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$this->io_sql->rollback();
		}
		else
		{
