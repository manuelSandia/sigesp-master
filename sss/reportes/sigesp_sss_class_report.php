...
//		require_once("../../shared/class_folder/class_datastore.php");
	...
	function uf_sss_select_permisos_usuario($as_codemp,$as_codusu,$as_codsis,$ai_orden)	
	{
		...
		$ls_sql="SELECT sss_derechos_usuarios.codsis, sss_derechos_usuarios.codusu, MAX(sss_sistemas.nomsis) AS nomsis, ".
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=false;
		$ls_sql="SELECT codemp, codusu, codsis, nomven, MAX(visible) AS visible, MAX(enabled) AS enabled, MAX(leer) AS leer, MAX(incluir) AS incluir,".
				...
				" GROUP BY codemp,codsis,codusu, nomven ".
				" ORDER BY titven";
