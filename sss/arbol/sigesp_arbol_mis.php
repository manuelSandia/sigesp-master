...
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=2;
$arbol["nombre_logico"][$li_i]="Variación";
$arbol["nombre_fisico"][$li_i]="";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="012";
$arbol["numero_hijos"][$li_i]=4;
...
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=1;
$arbol["nombre_logico"][$li_i]="Prestaciones Sociales";
$arbol["nombre_fisico"][$li_i]="";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="001";
$arbol["numero_hijos"][$li_i]=2;
...
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=1;
$arbol["nombre_logico"][$li_i]="Rentas Muicipales";
$arbol["nombre_fisico"][$li_i]="";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="001";
$arbol["numero_hijos"][$li_i]=2;
...
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=1;
$arbol["nombre_logico"][$li_i]="Documentos Contabilizados";
$arbol["nombre_fisico"][$li_i]="sigesp_mis_r_documentoscontabilizados.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="028";
...
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=3;
$arbol["nombre_logico"][$li_i]="Contabilizar Variación Obras";
$arbol["nombre_fisico"][$li_i]="sigesp_mis_p_contabiliza_variacion_sob.php";
$arbol["id"][$li_i]=$li_i;
...
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=3;
$arbol["nombre_logico"][$li_i]="Reversar Variación Obras";
$arbol["nombre_fisico"][$li_i]="sigesp_mis_p_reverso_variacion_sob.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="016";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=3;
$arbol["nombre_logico"][$li_i]="Contabilizar Valuacion";
$arbol["nombre_fisico"][$li_i]="sigesp_mis_p_contabiliza_valuacion_sob.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="029";
$arbol["numero_hijos"][$li_i]=0;

$li_i++;
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=3;
$arbol["nombre_logico"][$li_i]="Reversar Valuacion";
...
$arbol["sistema"][$li_i]="SAF";
$arbol["nivel"][$li_i]=3;
$arbol["nombre_logico"][$li_i]="Contabilizar Desincorporación Activos Fijos";
$arbol["nombre_fisico"][$li_i]="sigesp_mis_p_contabiliza_saf.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="030";
$arbol["numero_hijos"][$li_i]=0;

$li_i++;
$arbol["sistema"][$li_i]="SAF";
$arbol["nivel"][$li_i]=3;
$arbol["nombre_logico"][$li_i]="Reversar Desincorporación Activos Fijos";
$arbol["nombre_fisico"][$li_i]="sigesp_mis_p_reverso_saf.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="030";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=2;
$arbol["nombre_logico"][$li_i]="Contabilizar Transferencias";
$arbol["nombre_fisico"][$li_i]="sigesp_mis_p_contabiliza_siv_transferencias.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="024";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=2;
$arbol["nombre_logico"][$li_i]="Reversar Transferencias";
$arbol["nombre_fisico"][$li_i]="sigesp_mis_p_reverso_siv_transferencias.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="024";
$arbol["numero_hijos"][$li_i]=0;
//--------------------------------------------- SFC -----------------------------------------------------------
...
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=2;
$arbol["nombre_logico"][$li_i]="Contabilización de Prestaciones sociales";
$arbol["nombre_fisico"][$li_i]="sigesp_mis_p_contabiliza_sps.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="011";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=2;
$arbol["nombre_logico"][$li_i]="Reverso de Prestaciones Sociales";
$arbol["nombre_fisico"][$li_i]="sigesp_mis_p_reverso_sps.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="011";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=2;
$arbol["nombre_logico"][$li_i]="Contabilización de Resumen de Cobranzas";
$arbol["nombre_fisico"][$li_i]="sigesp_mis_p_contabiliza_srm.php";
$arbol["id"][$li_i]=$li_i;
...
$arbol["sistema"][$li_i]="MIS";
$arbol["nivel"][$li_i]=2;
$arbol["nombre_logico"][$li_i]="Reverso de Resumen de Cobranzas";
$arbol["nombre_fisico"][$li_i]="sigesp_mis_p_reverso_srm.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="027";
$arbol["numero_hijos"][$li_i]=0;
