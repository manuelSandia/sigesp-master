...
$arbol["sistema"][$li_i]       = "SCB";
$arbol["nivel"][$li_i]         = 1;
$arbol["nombre_logico"][$li_i] = "Modificación de Movimiento de Banco";
$arbol["nombre_fisico"][$li_i] = "sigesp_scb_p_modifmovbco.php";
$arbol["id"][$li_i]            = $li_i;
$arbol["padre"][$li_i]         = "001";
$arbol["numero_hijos"][$li_i]  = 0; //Modificación hecha para colocar el proceso de modif. de documento original
*/
