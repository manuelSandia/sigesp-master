...
<?php
	...
	$ls_auxcodsis=strtolower($ls_codsis);
	if(file_exists("arbol/sigesp_arbol_".$ls_auxcodsis.".php"))
	{
		include("arbol/sigesp_arbol_".$ls_auxcodsis.".php");
		$ls_existe=$io_sss->uf_sss_load_sistema($ls_codsis,$ls_nomsis);
		$li_total=$gi_total;
		$ls_ventana="";
		print("<table border=0 cellpadding='1' cellspacing=1>");
		print("<tr>");
		print("<td width='16'><input type=hidden name=hidsis$i id=hidsis$i value='$ls_nomsis' ><a id='x".$i."' href=javascript:cambiar('".$i."','$ls_ventana','$ls_codsis',parent.leftFrame.document.form1.hidsis$i);><img src='imagenes/folder.gif' width='18' height='18' hspace='0' vspace='0' border='0'></a></td>");
		print("<td><b>".$ls_codsis." </b>");
		print("</table>");
		...
		for($j=1; $j <= $li_total; $j++)
		{
			...
			{	
				...
				if($li_hijos > 0)
				{
					print("<td width=16><input type=hidden name=hidsis$ls_id id=hidsis$ls_id value='$ls_nomsis' ><a  href=javascript:cambiar('".$i."-".$ls_id."','$ls_ventana','$ls_codsis',parent.leftFrame.document.form1.hidsis$j);  id='x".$i."-".$ls_id."'><img src=imagenes/folder.gif width=18 height=18 hspace=0 vspace=0 border=0></a></td>");
				}
				else
				{
					print("<td width=16><input type=hidden name=oculto$ls_id id=oculto$ls_id value='$ls_nomlog' ><input type=hidden name=oculto1$ls_id id=oculto1$ls_id value='$ls_nomsis' ><a  href=javascript:uf_cambiar('".$i."-".$ls_id."',document.form1.oculto$j,'$ls_codsis','$ls_nomsis',document.form1.oculto1$j);  id='x".$i."-".$ls_id."'><img src=imagenes/empty.png width=18 height=18 hspace=0 vspace=0 border=0></a></td>");
				}
			...
			if($li_hijos > 0)
			{
				for($k=1; $k <= $li_total; $k++)
				{
					...
					if (($ls_padre1==$ls_id)&&($li_nivel1==1))
					{
						...
						{
							$ls_ventana="";
							print("<td width=16><input type=hidden name=hidsis$ls_id1 id=hidsis$ls_id1 value='$ls_nomsis' ><a  href=javascript:cambiar('".$i."-".$j."-".$ls_id1."','$ls_ventana','$ls_codsis',parent.leftFrame.document.form1.hidsis$ls_id1);  id='x".$i."-".$j."-".$ls_id1."'><img src=imagenes/folder.gif width=18 height=18 hspace=0 vspace=0 border=0></a></td>");
						}
						else
						{
							print("<td width=16><input type=hidden name=oculto$ls_id1 id=oculto$ls_id1 value='$ls_nomhijo' ><input type=hidden name=oculto1$ls_id1 id=oculto1$ls_id1 value='$ls_nomhijo' ><a  href=javascript:uf_cambiar('".$i."-".$j."-".$ls_id1."',document.form1.oculto$ls_id1,'$ls_codsis',document.form1.oculto1$ls_id1,'$ls_nomfis1');  id='x".$i."-".$j."-".$ls_id1."'><img src=imagenes/empty.png width=18 height=18 hspace=0 vspace=0 border=0></a></td>");
//							print("<td width=16><input type=hidden name=oculto$ls_id1 id=oculto$ls_id1 value='$ls_nomhijo' ><input type=hidden name=oculto1$ls_id1 id=oculto1$ls_id1 value='$ls_nomhijo' ><a  href=javascript:uf_cambiar('".$i.$j.$ls_id1."',document.form1.oculto1$ls_id1,'$ls_codsis',document.form1.oculto1$ls_id1,'$ls_nomfis1');  id='x".$i.$j.$ls_id1."'><img src=imagenes/empty.png width=18 height=18 hspace=0 vspace=0 border=0></a></td>");
						}
						...
						if($li_hijos1 > 0)
						{
							for($z=1; $z <= $li_total; $z++)
							{
								...
								if (($ls_padre2==$ls_id1)&&($li_nivel2==2))
								{
									...
									if($li_hijos2 > 0)
									{
										print("<td width=16><input type=hidden name=hidsis$ls_id2 id=hidsis$ls_id2 value='$ls_nomsis' ><a  href=javascript:cambiar('".$i."-".$j."-".$k."-".$ls_id2."','$ls_ventana','$ls_codsis',parent.leftFrame.document.form1.hidsis$ls_id2);  id='x".$i."-".$j."-".$k."-".$ls_id2."'><img src=imagenes/folder.gif width=18 height=18 hspace=0 vspace=0 border=0></a></td>");
									}
									else
									{
										
										print("<td width=16><input type=hidden name=oculto$ls_id2 id=oculto$ls_id2 value='$ls_nomhijo1' ><input type=hidden name=oculto1$ls_id2 id=oculto1$ls_id2 value='$ls_nomsis' ><a  href=javascript:uf_cambiar('".$i."-".$j."-".$k."-".$ls_id2."',document.form1.oculto$ls_id2,'$ls_codsis',document.form1.oculto1$ls_id2,'$ls_nomfis2');  id='x".$i."-".$j."-".$k."-".$ls_id2."'><img src=imagenes/empty.png width=18 height=18 hspace=0 vspace=0 border=0></a></td>");
									}
						...
						if($li_hijos2 > 0)
						{
							for($x=1; $x <= $li_total; $x++)
							{
								...
								if (($ls_padre3==$ls_id2)&&($li_nivel3==3))
								{
									...
									if($li_hijos3 > 0)
									{
										print("<td width=16><input type=hidden name=hidsis$ls_id3 id=hidsis$ls_id3 value='$ls_nomsis' ><a  href=javascript:cambiar('".$i."-".$j."-".$k."-".$z."-".$ls_id3."','$ls_ventana','$ls_codsis',parent.leftFrame.document.form1.hidsis$ls_id3);  id='x".$i."-".$j."-".$k."-".$z."-".$ls_id3."'><img src=imagenes/folder.gif width=18 height=18 hspace=0 vspace=0 border=0></a></td>");
									}
									else
									{
										
										print("<td width=16><input type=hidden name=oculto$ls_id3 id=oculto$ls_id3 value='$ls_nomhijo3' ><input type=hidden name=oculto1$ls_id3 id=oculto1$ls_id3 value='$ls_nomsis' ><a  href=javascript:uf_cambiar('".$i."-".$j."-".$k."-".$z."-".$ls_id3."',document.form1.oculto$ls_id3,'$ls_codsis',document.form1.oculto1$ls_id3,'$ls_nomfis3');  id='x".$i."-".$j."-".$k."-".$z."-".$ls_id3."'><img src=imagenes/empty.png width=18 height=18 hspace=0 vspace=0 border=0></a></td>");
									}
	...
	else
	{
		...
		print(" parent.location.href='sigespwindow_blank.php'");
		print("</script>");
	}
?>
</form>
