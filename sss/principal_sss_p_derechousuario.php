		...
		else
		{
			...
			if($lb_existe)
			{
				if(array_key_exists("radioenable",$_POST))
				{
					...
					if(($ls_codsis=="SNO")||($ls_codsis=="SPG")||($ls_codsis=="SEP")||($ls_codsis=="SOC")||($ls_codsis=="CXP"))
					{
						$lb_existe=$io_sss->uf_select_permisos_internos($ls_codemp,$ls_codsis,$ls_codusu,$la_codintper);
						if($lb_existe)
						{
					...
					else
					{
						...
						if($lb_valido)
						{
							...
							else
							{
								...
								{
									$ls_descripcion="";
									$lb_valido=$io_sss->uf_sss_insert_ventana($ls_codsis,$ls_nomven,$ls_pantalla,$ls_descripcion);//Realiza el Insert del evento
								}//end->else si existe ventana
								$lb_valido=$io_sss->uf_sss_insert_derecho_usuario($ls_codemp,$ls_codusu,$ls_codsis,$ls_nomven,$li_visible,
																				  $li_habilitada,$li_leer,$li_incluir,$li_cambiar,$li_eliminar,
																				  $li_imprimir,$li_administrador,$li_anular,$li_ejecutar,
																				  $ls_codintper,$la_seguridad);
...
?>		  
  <table width="561" height="195" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr>
      <td width="559" height="13" class="titulo-ventana">Opciones del Men&uacute; </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td height="154"><table width="509" height="210" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td height="13" colspan="10"align="center" class="titulo-celdanew"><strong>Propiedades del Usuario <?php print $ls_nomusu ." ". $ls_apeusu ?></strong></td>
        </tr>
        <tr>
          <td height="18"></td>
          <td width="89"><input name="txtusuario" type="hidden" class="sin-borde" id="txtusuario3" value="<?php print $ls_codusu ?>" size="15"></td>
        ...
        <tr>
          <td height="13" colspan="10" align="center" class="titulo-celdanew"><strong>Derechos</strong></td>
        </tr>
        <tr>
          <td height="13">&nbsp;</td>
          <td colspan="5"></td>
        ...
        <tr>
          <td height="13" colspan="10" align="center" class="titulo-celdanew">Permisos</td>
          </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="172">
		  <?php
		  if(($ls_codsis=="SOC")||($ls_codsis=="SEP")||($ls_codsis=="CXP")||($ls_codsis=="SCG"))
		  {
		  ?>
          ...
          <td colspan="6"><div align="right"><a href="javascript: ue_guardar();"><img src="../shared/imagebank/tools20/grabar.gif" alt="Grabar" width="20" height="20" border="0">Guardar</a></div></td>
          </tr>
      </table></td>
    </tr>
    <tr>
