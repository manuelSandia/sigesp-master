...
class class_sigesp_int_int extends class_sigesp_int
{
	...
	function uf_sql_transaction($ab_valido)
	{
		...
		//		   Access: public
		//       Argument: lb_valido // si el proceso fue valido � n
	...
	$ab_spg_enlace_contable,$as_codban,$as_ctaban,$ai_tipo_comp)
	{
		...
		//       		   as_fuente // C�digo de Proveedor � Benficiario dependiendo del tip
		//       		   ab_spg_enlace_contable // Si tiene enlace contable
		//       		   as_codban // C�digo de Banco
		//       		   as_ctaban // Cuenta de Banco
		//       		   ai_tipo_comp // Tipo de comprobante 1-> si es un comprobante Normal 2-> Si es una modificaci�n Presupuestaria
		//	  Description: Este m�todo inicia la transacci�n de un nuevo comprobante SPI,SPG,SCG. Creara los datastore par
		//                 guardar los movimientos contables del nucleo y las validaciones necesaria de la transacci�n
		...
		$as_tipo,$as_fuente)))
		{
			$this->is_msg_error="Error parametros contables";
			return false;
		}
		...
		$this->is_log_transacciones="CREACION DE COMPROBANTE " .$this->is_salto. "  Comprobante: ".$this->is_procedencia."/"+$this->is_comprobante." / ".$this->id_fecha." ".$this->is_salto." Descripci�n: ".$this->is_descripcion." " .$this->is_salto;
		if ($this->is_tipo=="P")
		{
	...
	$as_tipo,$as_fuente)
	{
		...
		//       		   as_tipo // Tipo de Destino si es proveedor �  Beneficiario
		//       		   as_fuente // C�digo de Proveedor � Benficiario dependiendo del tip
		//	  Description: Este m�todo valida la informaci�n de cabecera del comprobante en cuanto a los campos que las contiene 
		//	      Returns: booleano lb_valido
		//	   Creado Por: Ing. Wilmer Brice�o
		// Modificado Por: Ing. Yesenia Moreno								Fecha �ltima Modificaci�n : 31/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$this->io_msg->message("El N� de Comprobante no puede tener valor nulo o vac�o.");			
			return false;
		}
		...
		{
			$this->io_msg->message("La descripci�n no puede tener valor nulo o vac�o.");
			return false;
		}
		if((is_null($as_tipo)) or (empty($as_tipo)))
		{
			$this->io_msg->message("El Tipo (Beneficiario o Proveedor) no puede tener valor nulo o vac�o.");
			return false;
		}
		if((is_null($as_fuente)) or ($as_fuente==""))
		{
			$this->io_msg->message("El Beneficiario o Proveedor no puede tener valor nulo o vac�o.");
			return false;
		}
		$as_cedben="----------";
		$as_codpro="----------";
	...
	function uf_init_destroy_datastore()
	{
		...
		//		   Access: public
		//       Argument:
		//	  Description: M�todo que Elimina todos los datastored utilizados por las rutinas para evitar problemas de data
	...
	function uf_init_create_datastore()
	{
		...
		//		   Access: public
		//       Argument:
		//	  Description: M�todo que Crea todos los datastored utilizados por las rutinas para almacenar la informaci�n de los
	...
	$as_descripcion)
	{
		...
		//       		   as_operacion // representa la operaci�n D=Debe o H=Haber
		...
		//	  Description: Este m�todo inserta el movimiento contable en el datastore $this->ds_scg
		//	      Returns: booleano lb_valido
		//	   Creado Por: Ing. Wilmer Brice�o
		// Modificado Por: Ing. Yesenia Moreno								Fecha �ltima Modificaci�n : 31/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// sumo el monto en el registro del datastore si no es as� entonces inserto un nuevo registro.
		// en el datastore
		if ($as_operacion=="D")
		{
			//$this->idec_monto_debe=number_format(($this->idec_monto_debe + $adec_monto),2,'.','') ;
			$this->idec_monto_debe=($this->idec_monto_debe + $adec_monto);
		}
		else
		{
			//$this->idec_monto_haber=number_format(($this->idec_monto_haber + $adec_monto),2,'.','') ;
	...
	$adec_monto,$as_documento,$as_procede_doc,$as_descripcion)
	{
		...
		//		   Access: public
		//       Argument: as_codemp // C�digo de empresa
		//       		   as_codestpro1 // C�digo de estructura Programatica 1
		...
		//       		   as_procede_doc // N� del documento asociado a la procedencia del sistema
		//       		   as_descripcion // descripcion del movimiento
		//	  Description: Este m�todo inserta el movimiento resupuestario de gasto en el datastore $this->ds_spg
		//	      Returns: booleano lb_valido
		//	   Creado Por: Ing. Wilmer Brice�o
		// Modificado Por: Ing. Yesenia Moreno								Fecha �ltima Modificaci�n : 31/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		&$ls_sc_cuenta))
		{
			...
			{
				$ls_estructura=$aa_estructura[0]."-".$aa_estructura[1]."-".$aa_estructura[2]."-".$aa_estructura[3]."-".$aa_estructura[4]."-".$aa_estructura[5];
	...
	$ls_estcla="-")
	{
		...
		//       		   as_procede_doc // N� del documento asociado a la procedencia del sistema
		//       		   as_descripcion // descripcion del movimiento
		//	  Description: Este m�todo inserta el movimiento resupuestario de ingresoen el datastore $this->ds_spi
		//	      Returns: booleano lb_valido
		//	   Creado Por: Ing. Wilmer Brice�o
		// Modificado Por: Ing. Yesenia Moreno								Fecha �ltima Modificaci�n : 31/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$ab_check_close,$as_codban,$as_ctaban,$as_tipcomp="1")
	{
		...
		//       		   ab_check_close // Si se validan los par�metros del comprobante
		//       		   as_codban // C�digo del Banco
		//       		   as_ctaban // Cuenta del Banco
		//	  Description: Este m�todo inicia la transacci�n de un cursor para eliminar los movimientos contable del comprobante. 
		//	      Returns: booleano lb_valido
		//	   Creado Por: Ing. Wilmer Brice�o
		// Modificado Por: Ing. Yesenia Moreno								Fecha �ltima Modificaci�n : 31/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if(!($lb_valido))
		{
			$this->io_msg->message("ERROR-> En m�todo uf_init_load_datastore_integracion ");
			return false;
		}
	...
	function uf_init_load_datastore_integracion()
	{
		...
		//		   Access: public
		//       Argument:
		//	  Description: Metodo que accede a las tablas detalles spg,spi y scg para vaciar la informaci�n en los datastores
		//                 respectivos
		//	      Returns: booleano lb_valido
		//	   Creado Por: Ing. Wilmer Brice�o
		// Modificado Por: Ing. Yesenia Moreno								Fecha �ltima Modificaci�n : 31/05/2007
		...
		if($rs_data===false)
		{
			$this->is_msg_error="CLASE->sigesp_int_int M�TODO->uf_init_load_datastore_integracion ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			return false;
		}
		else
		{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_valida_comprobante_cuadre_scg($validamovspi=true)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_valida_comprobante_cuadre_scg
		//		   Access: public
		//       Argument:
		//	  Description: Este m�todo recorre cada registro del datastore instanciado dse scg, y suma los valores o monto del
			...
			if($ll_tot_row > 0)
			{
				for($ll_row=1;$ll_row<=$ll_tot_row;$ll_row++)
				{
					...
					if ($ls_debhab=="D")
					{
						...
						//	$ldec_monto_debe=number_format($ldec_monto_debe,2,'.','');
					}
					else
					{
						$ldec_monto_haber = $ldec_monto_haber + $this->ds_scg->getValue("monto",$ll_row);
						//	$ldec_monto_haber=number_format($ldec_monto_haber,2,'.','');
					}
				}
				$ldec_monto_debe=number_format($ldec_monto_debe,2,'.','');
				$ldec_monto_haber=number_format($ldec_monto_haber,2,'.','');
	...
	function uf_init_end_transaccion_integracion($aa_seguridad)
	{
		...
		//	  Description: Este m�todo culmina la transacci�n de un nuevo comprobante SPI,SPG,SCG.
		...
		$lb_valido=$this->uf_valida_comprobante_cuadre_scg(false);
		if(!$lb_valido)
		{
			return false;
		}
			...
			if($aa_seguridad["sistema"]!="")
			{
				if($this->ib_new_comprobante)
				{
					...
					$ls_descripcion="Inserto el Comprobante <b>".$this->is_comprobante."</b>, Procedencia <b>".$this->is_procedencia."</b>,".
									...
									" Banco <b>".$this->as_codban."</b>, Cuenta <b>".$this->as_ctaban."</b>, Descripci�n <b>".$this->is_descripcion."</b>";
					...
					if($aa_seguridad["sistema"]!="")
					{
						if(!$this->ib_new_comprobante)
						{
							...
							$ls_descripcion="Elimino el Comprobante <b>".$this->is_comprobante."</b>, Procedencia <b>".$this->is_procedencia."</b>,".
											" Fecha <b>".$this->id_fecha."</b>, Proveedor <b>".$this->is_cod_prov."</b>, Beneficiario <b>".$this->is_ced_ben."</b>,".
											" Descripci�n <b>".$this->is_descripcion."</b>";
							$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
							$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
							$aa_seguridad["ventanas"],$ls_descripcion);
							/////////////////////////////////         SEGURIDAD               /////////////////////////////
	...
	function uf_int_valida_informacion_datastore()
	{
		...
		//		   Access: public
		//       Argument:
		//	  Description: Este m�todo realiza las siguientes validaciones:
		...
		$this->idec_monto_debe=number_format($this->idec_monto_debe,2,'.','');
		$this->idec_monto_haber=number_format($this->idec_monto_haber,2,'.','');
		if(doubleval(trim($this->idec_monto_debe))!=doubleval(trim($this->idec_monto_haber)))
		{
	...
	function uf_int_make_scg($aa_seguridad)
	{
		...
		//	  Description: Este m�todo recorre todos los registros del datastore de contabilidad y lo inserta uno a uno en l
				...
				if($lb_valido)
				{
					if($aa_seguridad["sistema"]!="")
					{
						...
						$ls_descripcion=$ls_descripcion." el Detalle Contable <b>".$this->is_comprobante."</b>, Procedencia <b>".$this->is_procedencia."</b>,".
										" Fecha <b>".$this->id_fecha."</b>, Cuenta <b>".$ls_sc_cuenta."</b>, Operaci�n <b>".$ls_debhab."</b>, Monto <b>".$ldec_monto."</b>";
						$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
						$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
						$aa_seguridad["ventanas"],$ls_descripcion);
						/////////////////////////////////         SEGURIDAD               /////////////////////////////
	...
	function uf_int_make_spg($aa_seguridad)
	{
		...
		//		   Access: public
		//       Argument: aa_seguridad // Arreglo de la variable de seguridad
		//	  Description: Este m�todo recorre todos los registros del datastore de presupuesto de gasto y lo inserta uno a
		...
		if(!empty($this->ds_spg->data))
		{
			...
			for($ll_row=1;($ll_row<=$ll_tot_row)&&($lb_valido);$ll_row++)
			{
				...
				if(($this->is_modo=="C")||($this->is_modo=="A")||($this->is_modo=="G"))
				{
					...
					else // Si es una modificaci�n presupuestaria
					{
	...
	function uf_int_make_spi($aa_seguridad)
	{
		...
		//		   Access: public
		//       Argument: aa_seguridad // Arreglo de la variable de seguridad
		//	  Description: Este m�todo recorre todos los registros del datastore de presupuesto de ingreso y lo inserta uno a
		...
		if(!empty($this->ds_spi->data))
		{
			...
			for($ll_row=1;($ll_row<=$ll_tot_row)&&($lb_valido);$ll_row++)
			{
				...
				//-----------informaci�n de las estructuras de gastos relacionadas con las cuentas de ingresos---------------
	...
	$as_descripcion,$as_codban,$as_ctaban,$ai_tipo_comp,&$estatusorden)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//       		   as_comprobante // N�mero del Comprobante Original
		...
		//       		   as_ctaban // Cuenta del Banco
		//       		   ai_tipo_comp // Tipo de comprobante 1-> si es un comprobante Normal 2-> Si es una modificaci�n Presupuestaria
		//	  Description: Este m�todo prepara los par�metros en lote para la anulaci�n de un comprobante.
		//	      Returns: booleano lb_valido
		//	   Creado Por: Ing. Wilmer Brice�o
		// Modificado Por: Ing. Yesenia Moreno								Fecha �ltima Modificaci�n : 31/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$this->io_msg->message("ERROR-> La fecha de anulaci�n ".$adt_fecha_anula." no puede ses menor que la fecha ".$adt_fecha." del comprobante previo ");
			return false;
		}
		...
		if(!$this->uf_init_load_anular_datastore_integracion($as_codemp,$as_procedencia,$as_comprobante,$adt_fecha,$as_codban,$as_ctaban,&$estatusorden))
		{
			$this->io_msg->message("ERROR-> en carga datos para la anulaci�n del comprobante ".$as_comprobante);
			return false;
		}
		return $lb_valido;
	...
	function uf_init_valida_parametros_anulacion($as_codemp,$as_procedencia,$as_comprobante,$as_fecha,$as_procede_anulacion,$as_descripcion)
	{
		...
		//       		   as_procede_anulacion // Procede del Documento a Anular
		//       		   as_descripcion // Descripci�n del Documento
		//	  Description: Este m�todo valida los par�metros de anulaci�n.
		//	      Returns: booleano lb_valido
		//	   Creado Por: Ing. Wilmer Brice�o
		// Modificado Por: Ing. Yesenia Moreno								Fecha �ltima Modificaci�n : 31/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$this->io_msg->message("La procedencia de anulaci�n no puede tener valor nulo.");
			return false;
		}
		$as_comprobante = $this->uf_fill_comprobante($as_comprobante);
		if(!($this->uf_valida_procedencia($as_procedencia,$ls_desproc)))
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_init_load_anular_datastore_integracion($as_codemp,$as_procedencia,$as_comprobante,$adt_fecha,$as_codban,$as_ctaban,&$estatusorden)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//       		   as_codban // C�digo de Banco
		//       		   as_ctaban // Cuenta de Banco
		//	  Description: M�todo que llena los datastore con la informaci�n del comprobante que desea anular
		//	      Returns: booleano lb_valido
		//	   Creado Por: Ing. Wilmer Brice�o
		// Modificado Por: Ing. Yesenia Moreno								Fecha �ltima Modificaci�n : 31/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->is_msg_error="CLASE->sigesp_int_int M�TODO->uf_init_load_anular_datastore_integracion ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			return false;
		}
		else
		{
		...
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				//if($as_tipo=='A'||$as_tipo=='F'){
				$ls_sql2="SELECT sum(monto)as monto  FROM cxp_rd_spg ".
	            " WHERE codemp='".$as_codemp."' ".
				"   AND numdoccom='".$as_comprobante."' and spg_cuenta='".$row["spg_cuenta"]."' and procede_doc='".$as_procedencia."'";
				...
				while($row2=$this->io_sql->fetch_row($rs_data2))
				{
					$ldec_monto2=($row2["monto"]);
				...
				$mm2=$row["monto"]+$ldec_monto2;

				if($mm2<0&&$ldec_monto2!=0){
					$estatusorden=8;
					//echo "<br>".$mm2."  ll     ".$row["monto"]." ll   ".$ldec_monto2;

					$this->ds_spg->insertRow("monto",$mm2);

				}else{

					$estatusorden=3;
					//echo "<br>".$mm2."  aa     ".$row["monto"]." aa   ".$ldec_monto2;
	...
	function uf_locate_movimiento_scg($as_cuenta,$as_debhab)
	{
		...
		//       		   as_debhab // Operaci�n Debe � haber
		//	  Description: M�todo que verifica si una cuenta contable existe en el datastored de contabilidad
		//	      Returns: booleano lb_valido
		//	   Creado Por: Ing. Wilmer Brice�o
		// Modificado Por: Ing. Yesenia Moreno								Fecha �ltima Modificaci�n : 31/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_verificar_cierre_spg(&$as_estciespg)
	{
		...
		{
			$lb_valido=false;
			$this->is_msg_error="CLASE->sigesp_int_int M�TODO->uf_verificar_cierre_spg ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
		}
		else
		{
	...
	function uf_verificar_cierre_scg(&$as_estciescg)
	{
		...
		//	    Arguments:
		//	      Returns: lb_valido True si se ejecuto el guardar � False si hubo error en el guardar
		//	  Description: Funci�n que se encarga de verificar si esta procesado contabilidad
		//	   Creado Por: Ing. Luis Anibal Lang
		// Fecha Creaci�n: 29/08/2008 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$this->ls_codemp=$_SESSION["la_empresa"]["codemp"];
		...
		{
			$lb_valido=false;
			$this->is_msg_error="CLASE->sigesp_int_int M�TODO->uf_verificar_cierre_scg ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
		}
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
