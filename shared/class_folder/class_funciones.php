<?php
 ...
 class class_funciones
 {
  ...
  function uf_formatovalidofecha($as_fecha)
  {
	  ...
	  {
      	//$as_fecha=adodb_date("Y-m-d",strtotime($as_fecha));
	   }
      return $as_fecha;
  } // end function  
  ...
  function uf_convertirdatetobdletras($as_fecha)
  {
	  ////////////////////////////////////////////////////////////////////////////////////////////////////////	   
	  //    Function:   uf_convertirdatetobd
	  // Descripci�n:   m�todo que convierte el formato de una fecha tipo caracter a formato (yyyy/mm/dd)
  ...
  $ls_fecha="";
	  ...
	  $dia=substr($ls_fecha,0,2);
	  $ano=substr($ls_fecha,6,4);
	  $mes=substr($ls_fecha,3,2);
  ...
  function uf_convertirfecmostrar($as_fecha)
  {
      ...
      function uf_convertirvalormostrar($as_valor)
  {
	  ////////////////////////////////////////////////////////////////////////////////////////////////////////	   
	  //    Function:   uf_convertirvalormostrar
	  // Descripci�n:   m�todo que convierte en Sí el valor 1 y en No el valor 0 (para mostrar en el detalle de 
	  //                la cotización los campos Asistencia Técnica y Cumple con Especificaciones)
	  //   Arguments:   $as_valor: int
	  ////////////////////////////////////////////////////////////////////////////////////////////////////////	   	   
      $ls_valor="";
...
function uf_calcular_tiempofechas($ad_desde,$ad_hasta,&$dias,&$meses,&$anios)
 {
  ...
  $diaActual  = substr($ad_desde, 0,2);  
  $mesActual = substr($ad_desde,3,2);  
  $anioActual = substr($ad_desde,6,4); 
  
  $diaInicio = substr($ad_hasta,0,2);  
  $mesInicio = substr($ad_hasta,3,2);  
  $anioInicio = substr($ad_hasta,6,4);  
