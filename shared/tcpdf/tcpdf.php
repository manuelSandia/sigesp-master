	...
	*/
	class TCPDF {
		...
		*/
		...
		public function setTextoFooter($val='') {
			$this->texto_footer = $val;
		}
		...
		*/
		...
		public function Footer() {				
			...
			if ($this->getRTL()) {
				$this->SetX($ormargins['right']);
				$this->Cell(0, 0, $this->texto_footer.'     '.$pagenumtxt, 'T', 0, 'L');
			} else {
				$this->SetX($ormargins['left']);
				if($this->texto_footer){					
					$this->MultiCell(0, 5, $this->texto_footer, 'T', 'C', 0, 1, '', '', true);					
