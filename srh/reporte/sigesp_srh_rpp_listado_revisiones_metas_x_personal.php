  ...
  //-----------------------------------------------------------------------------------------------------------------------------------
	...
	if($lb_valido)
	{
		...
		else // Imprimimos el reporte
		{
			...
			$li_totrow=$io_report->DS_metas->getRowCount("fecha");
			$li_aux=0;
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				$li_aux++;
				$ls_nroreg=$io_report->DS_metas->data["nroreg"][$li_i];
				$ls_codigo=$io_report->DS_metas->data["codper"][$li_i];
				$ls_fechaini=$io_report->DS_metas->data["fecini"][$li_i];
				$ls_fechafin=$io_report->DS_metas->data["fecfin"][$li_i];
				$ls_nombreper=$io_report->DS_metas->data["nomper"][$li_i];
				$ls_apellidoper=$io_report->DS_metas->data["apeper"][$li_i];
