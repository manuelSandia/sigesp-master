<?php
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
		function print_cabecera_seccion_C($as_deneval,&$io_pdf)
	      {
		$io_pdf->ezSetDy(-1);
		...
		$la_data_2[3]=array('seccion_2'=>$as_deneval);
		$la_columnas=array('seccion_2'=>'');
	...
	//------------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle($adt_fecini,$adt_fecfin,$as_deneval,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(290,405,10,$as_deneval); // Agregar el t�tulo
		$io_pdf->ezSetDy(-50);
	...
	function uf_print_detalle2($adt_fecini,$adt_fecfin,$as_nombre,$as_cedper,$as_deasicar,$as_codasicar,$as_desuniadm,$ls_titulo,$as_codnom,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>400, // Orientación de la tabla
						 'xOrientation'=>'center', // Orientación de la tablA
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>720))); // Justificaci�n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>400, // Orientación de la tabla
						 'xOrientation'=>'center', // Orientación de la tablA
						 'cols'=>array('cedula'=>array('justification'=>'left','width'=>360),
						 			   'codnom'=>array('justification'=>'left','width'=>360))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>400, // Orientación de la tabla
						 'xOrientation'=>'center', // Orientación de la tablA
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>360), // Justificaci�n y ancho de la columna
						               'nomina'=>array('justification'=>'left','width'=>360))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>400, // Orientación de la tabla
						 'xOrientation'=>'center', // Orientación de la tablA
						 'cols'=>array('unidad'=>array('justification'=>'left','width'=>720))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
   ...
   //------------------------------------------------------------------------------------------------------------------------
   	function print_detalle_seccion_D($tot_B,$tot_C,$total_final,$actuacion,$ls_data_s,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>400, // Orientación de la tabla
						 'xOrientation'=>'center', // Orientación de la tablA
						 'cols'=>array('seccion_6'=>array('justification'=>'center','width'=>700))); // Justificaci�n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>400, // Orientación de la tabla
						 'xOrientation'=>'center', // Orientación de la tablA
						 'cols'=>array('obs_sup'=>array('justification'=>'left','width'=>700))); // Justificaci�n y ancho de la columna
   ...
   function uf_print_firmas(&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tablA
						 'cols'=>array('pregunta'=>array('justification'=>'left','width'=>130),
						               'respuesta1'=>array('justification'=>'left','width'=>95),
						               'respuesta2'=>array('justification'=>'left','width'=>95))); // Justificaci�n y ancho de la columna
	...
	if($lb_valido==false) // Existe alg�n error � no hay registros
	 ...
	 else
	 {
		    ...
		    uf_print_detalle($ldt_fecini,$ldt_fecfin,$ls_deneval,$io_pdf);	   	
		   ...
		   $lb_valido1=$io_report->uf_select_dt_evaluacion_odi($ls_nroeval,$ldt_fecini,$ldt_fecfin);
		   ...
		   $total_peso_rango=0;
			...
			$io_pdf->ezNewPage(); // Insertar una nueva p�gina
			print_cabecera_seccion_C($ls_deneval,&$io_pdf);			
			$lb_valido=$io_report->uf_select_competencias_odi($ls_nroeval);
			$li_total4=$io_report->ds_detalle4->getRowCount("denite");
			$total_peso_c=0;
