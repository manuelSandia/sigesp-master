...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$io_pdf)
	{
		...
		$la_data[1]=array('codigo'=>'<b>Código del Personal</b>',
							 ...
							 'numero'=>'<b>Código de Registro</b>',
							 'fecha'=>'<b>Fecha</b>',
							 'enfermedad'=>'<b>Descripción de Enfermedad</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
									   ...
									   'numero'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'fecha'=>array('justification'=>'center','width'=>80),
									   'enfermedad'=>array('justification'=>'center','width'=>110),
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ls_enfermedad=$io_report->ds_detalle->data["denenf"][$li_i];
				$la_data[$li_i]=array('codigo'=>$ls_codigoper,'nombre'=>$ls_cadena,'numero'=>$ls_nroreg,'fecha'=>$ls_fecha,'codigoenf'=>$ls_codenf,
				                      'descripcion'=>$ls_observacion,'diasrep'=>$ls_reposo,'enfermedad'=>$ls_enfermedad);
			}
