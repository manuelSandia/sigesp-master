<?php
	...
	function uf_print_cabecera($as_nombre,$as_cedula,$as_cargo,$as_desuniadm,$as_objetivo,
	                           $adt_revini1,$adt_revfin1,$adt_revini2,$adt_revfin2,$ls_rev,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->ezSetDy(115);
		$ls_fech=date("j/n/Y");
		$ls_fech2=substr($ls_fech,-4);
		if ($ls_rev=='SEGUNDA REVISION')
		{
			$ls_semes='<b>SEGUNDO</b>';
		}
		else
		{
			$ls_semes='<b>PRIMER</b>';
		}
		$la_data[1]=array('titulo'=>'<b> ESTABLECIMIENTO Y SEGUIMIENTO DE LOS OBJETIVOS DE DESEMPEÑO INDIVIDUAL CORRESPONDIENTE AL </b>'.$ls_semes.' <b>SEMESTRE AÑO </b>'.'<b>'.$ls_fech2.'</b>');
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle_trabajo($adt_revfin1,$adt_revfin2,$ai_peso_total,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_detalle
		//		   Access: private 
		...
		// Fecha Creación: 27/04/2006		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			$la_data[1]=array('pesoacum'=>'                                                                                                                                                                TOTAL: '.$ai_peso_total);
			$la_columnas=array('pesoacum'=>'');
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 'fontSize' =>8, // TamaÃ±o de Letras
							 'titleFontSize' => 12,  // TamaÃ±o de Letras de los tÃ­tulos
							 'showLines'=>1, // Mostrar LÃ­neas
							 ...
							 'xPos'=>400, // OrientaciÃ³n de la tabla
							 'xOrientation'=>'center', // OrientaciÃ³n de la tablA
							 'cols'=>array('pesoacum'=>array('justification'=>'left','width'=>660))); // Justificación y ancho de la columna
			$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
			unset($la_data);
			unset($la_columnas);
			unset($la_config);
			
			$la_data[1]=array('trabajos'=>'Trabajos Especiales');
			$la_data[2]=array('trabajos'=>'');
			$la_data[3]=array('trabajos'=>'');
			$la_data[4]=array('trabajos'=>'');
			$la_columnas=array('trabajos'=>'');
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 'fontSize' =>8, // TamaÃ±o de Letras
							 'titleFontSize' => 12,  // TamaÃ±o de Letras de los tÃ­tulos
							 'showLines'=>1, // Mostrar LÃ­neas
							 ...
							 'xPos'=>400, // OrientaciÃ³n de la tabla
							 'xOrientation'=>'center', // OrientaciÃ³n de la tablA
							 'cols'=>array('trabajos'=>array('justification'=>'left','width'=>660))); // Justificación y ancho de la columna
			$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
			unset($la_data);
			unset($la_columnas);
			unset($la_config);
			
			$la_data[1]=array('nomleg'=>'NOMBRE LEGIBLE Y FIRMAS (EN CASO DE QUE EL EVALUADOR SEA MILITAR COLOCAR EL RANGO): ');
			$la_columnas=array('nomleg'=>'');
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 'fontSize' =>8, // TamaÃ±o de Letras
							 'titleFontSize' => 12,  // TamaÃ±o de Letras de los tÃ­tulos
							 ...
							 'xPos'=>400, // OrientaciÃ³n de la tabla
							 'xOrientation'=>'center', // OrientaciÃ³n de la tablA
							 'cols'=>array('nomleg'=>array('justification'=>'left','width'=>660))); // Justificación y ancho de la columna
			$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
			unset($la_data);
			unset($la_columnas);
			unset($la_config);
			
			$la_data[1]=array('evaluador'=>'Evaluador','evaluado'=>'Evaluado','fechrev'=>'Fecha de Revisión');
			$la_columnas=array('evaluador'=>'','evaluado'=>'','fechrev'=>'');
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 'fontSize' =>8, // TamaÃ±o de Letras
							 'titleFontSize' => 12,  // TamaÃ±o de Letras de los tÃ­tulos
							 'showLines'=>0, // Mostrar LÃ­neas
							 ...
							 'xPos'=>400, // OrientaciÃ³n de la tabla
							 'xOrientation'=>'center', // OrientaciÃ³n de la tablA
							 'cols'=>array('evaluador'=>array('justification'=>'left','width'=>220),
										   'evaluado'=>array('justification'=>'left','width'=>220),
										   'fechrev'=>array('justification'=>'left','width'=>220))); // Justificación y ancho de la columna
			$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
			unset($la_data);
			unset($la_columnas);
			unset($la_config);
			
			$la_data[1]=array('evaluador'=>'','evaluado'=>'','fechrev'=>$adt_revfin1);
			$la_columnas=array('evaluador'=>'','evaluado'=>'','fechrev'=>'');
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 'fontSize' =>8, // TamaÃ±o de Letras
							 'titleFontSize' => 12,  // TamaÃ±o de Letras de los tÃ­tulos
							 ...
							 'xPos'=>400, // OrientaciÃ³n de la tabla
							 'xOrientation'=>'center', // OrientaciÃ³n de la tablA
							 'rowGap' => 4, //Ancho entre celdas
							 'cols'=>array('evaluador'=>array('justification'=>'left','width'=>220),
										   'evaluado'=>array('justification'=>'left','width'=>220),
										   'fechrev'=>array('justification'=>'right','width'=>220))); // Justificación y ancho de la columna
			$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
			unset($la_data);
			unset($la_columnas);
			unset($la_config);
			
			$la_data[1]=array('evaluador'=>'','evaluado'=>'','fechrev'=>$adt_revfin2);
			$la_columnas=array('evaluador'=>'','evaluado'=>'','fechrev'=>'');
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 'fontSize' =>8, // TamaÃ±o de Letras
							 'titleFontSize' => 12,  // TamaÃ±o de Letras de los tÃ­tulos
			...
			$la_data[1]=array('rev'=>'Revisión','reposos'=>'Reposos','permisos'=>'Permisos','accdic'=>'Acciones Diciplinarias');
			$la_columnas=array('rev'=>'','reposos'=>'','permisos'=>'','accdic'=>'');
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 'fontSize' =>8, // TamaÃ±o de Letras
							 'titleFontSize' => 12,  // TamaÃ±o de Letras de los tÃ­tulos
							 'showLines'=>0, // Mostrar LÃ­neas
							 ...
							 'xPos'=>400, // OrientaciÃ³n de la tabla
							 'xOrientation'=>'center', // OrientaciÃ³n de la tablA
							 'cols'=>array('rev'=>array('justification'=>'center','width'=>75),
										   'reposos'=>array('justification'=>'center','width'=>195),
										   'permisos'=>array('justification'=>'center','width'=>195),
										   'accdic'=>array('justification'=>'center','width'=>195))); // Justificación y ancho de la columna
			$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
			unset($la_data);
			unset($la_columnas);
			unset($la_config);
			
			$la_data[1]=array('rev'=>'1ra','reposos'=>'','permisos'=>'','accdic'=>'');
			$la_columnas=array('rev'=>'','reposos'=>'','permisos'=>'','accdic'=>'');
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 'fontSize' =>8, // TamaÃ±o de Letras
							 'titleFontSize' => 12,  // TamaÃ±o de Letras de los tÃ­tulos
			...
			$la_data[1]=array('rev'=>'2da','reposos'=>'','permisos'=>'','accdic'=>'');
			$la_columnas=array('rev'=>'','reposos'=>'','permisos'=>'','accdic'=>'');
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 'fontSize' =>8, // TamaÃ±o de Letras
							 'titleFontSize' => 12,  // TamaÃ±o de Letras de los tÃ­tulos
			...
			$la_data[1]=array('nomleg'=>'NOTA: UNA VEZ EFECTUADA CADA REVISIÓN SE DEBERÁ ENVIAR UNA COPIA A LA GERENTE DE RRHH EN LOS 5 PRIMEROS DÍAS HÁBILES DEL MES SIGUIENTE A LA FECHA DE REVISIÓN');
			$la_columnas=array('nomleg'=>'');
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
	...
	function uf_print_detalle2($as_evaluador,$as_evaluado,&$io_pdf)
	{
		...
		$tm=250-(200/2);
		$io_pdf->addText(77,60,10,"EVALUADOR:    ".$as_evaluador); // Agregar el título
	    $tm=310-(300/2);
		$io_pdf->addText(430,60,10," EVALUADO:    ".$as_evaluado); // Agregar el título
		 $tm=250-(350/2);
	 ...
	 else
	 {
			...
			while($row=$io_report->io_sql->fetch_row($rs_data))  
			{
				...
				uf_print_cabecera($ls_nomper,$ls_cedper,$ls_descar,$ls_desuniadm,
				                  $ls_objetivo,$ldt_revini1,$ldt_revfin1,$ldt_revini2,$ldt_revfin2,$ls_rev,&$io_pdf);
				...
				uf_print_detalle_trabajo($ldt_revfin1,$ldt_revfin2,$li_peso_total,&$io_pdf);
