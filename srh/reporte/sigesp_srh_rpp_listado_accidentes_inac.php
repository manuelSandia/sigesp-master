...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$io_pdf)
	{
		...
		$la_data[1]=array('codigo'=>'<b>Código del Personal</b>',
							 ...
							 'accidente'=>'<b>Descripción de Accidente</b>',
							 'fecha'=>'<b>Fecha</b>',
							 'descripcion'=>'<b>Descripción</b>',
							 'testigos'=>'<b>Testigos</b>',
							 'reposo'=>'<b>Días Reposo</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   ...
						 			   'accidente'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
									   ...
									   'reposo'=>array('justification'=>'center','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
	...
	function uf_print_detalle($la_data,&$io_pdf)
 	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
									   ...
									   'testigos'=>array('justification'=>'center','width'=>150),
									   'diasrep'=>array('justification'=>'center','width'=>80)));// Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ls_accidente=$io_report->ds_detalle->data["denacc"][$li_i];
				...
				$la_data[$li_i]=array('codigo'=>$ls_codigoper,'nombre'=>$ls_cadena,'numregistro'=>$ls_nroreg,'fecha'=>$ls_fecha,
				                      'descripcion'=>$ls_descripcion,'testigos'=>$ls_testigos,'diasrep'=>$ls_reposo,'accidente'=>$ls_accidente);
			}
