...
function uf_srh_getProximoCodigo()
  {
		...
		//      Argumento: 
		//	      Returns: Retorna el nuevo c�digo de un competencia de adiestramiento
		//    Description: Funcion que genera un c�digo de un competencia de adiestramiento
    ...
    $ls_codcompadi = str_pad ($ls_codcompadi,15,"0",STR_PAD_LEFT);
	...
	function uf_srh_select_competencia_adiestramiento($as_codcompadi)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Competencia Adiestramiento M�TODO->uf_srh_select_competencia_adiestramiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function  uf_srh_insert_competencia_adiestramiento($as_codcompadi,$as_dencompadi,$aa_seguridad)
	{
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->Competencia Adiestramiento M�TODO->uf_srh_insert_competencia_adiestramiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
	...
	function uf_srh_update_competencia_adiestramiento($as_codcompadi,$as_dencompadi,$aa_seguridad) 
	{
		...
		//         areaess: public 
		//      Argumento: $as_codcompadi        // c�digo de competencia de adiestramiento
	    //                 $as_dencompadi       // denominaci�n de competencia de adiestramiento
	    //                 $aa_seguridad   // arreglo de registro de seguridad
		//	      Returns: Retorna un Booleano
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->Competencia Adiestramiento M�TODO->uf_srh_update_competencia_adiestramiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
			$this->io_sql->rollback();
		}
		else
	...
	function uf_select_competencia_adiestramiento_necesidad ($as_codcompadi)
	{
		...
		//		   Access: private
 		//	    Arguments: as_codcompadi // c�digo de la competencia de adiestramiento
		...
		if($rs_data===false)
		{
        	$this->io_msg->message("CLASE->Competencia Adiestramiento  M�TODO->uf_select_competencia_adiestramiento_necesidad  ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
	...
	function uf_srh_delete_competencia_adiestramiento($as_codcompadi,$aa_seguridad)
	{
		...
		//         areaess: public 
		//      Argumento: $as_codcompadi       // c�digo de la competencia de adiestramiento
	    //                 $aa_seguridad   // arreglo de registro de seguridad
		//	      Returns: Retorna un Booleano
		...
		else
		{
			...
			if($li_row===false)
			{
				$this->io_msg->message("CLASE->Competencia Adiestramiento M�TODO->uf_srh_delete_competencia_adiestramiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
				$lb_valido=false;
				$this->io_sql->rollback();
			}
			else
...
function uf_srh_buscar_competencia_adiestramiento($as_codcompadi,$as_dencompadi)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Competencia Adiestramiento M�TODO->uf_srh_buscar_competencia_adiestramiento( ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{	
