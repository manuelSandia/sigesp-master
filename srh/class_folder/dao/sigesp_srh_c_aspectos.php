...
function uf_srh_getProximoCodigo($as_codeval, $as_codaspaux)
  {
		...
		//      Argumento: 
		//	      Returns: Retorna el nuevo c�digo de un registro de un accidente de personal
		//    Description: Funcion que genera un c�digo de registro de un accidente de personal
		//	   Creado Por: Maria Beatriz Unda
		// Fecha Creaci�n:17/01/2008							Fecha �ltima Modificaci�n:17/01/2008 Prueba
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_srh_select_aspectos($as_codasp, $as_codeval)
	{
		...
		//         areaess: public 
		//      Argumento: $as_codasp    // codigo de aspecto de evaluaci�n
		//	      Returns: Retorna un Booleano
		//    Description: Funcion que realiza una busqueda de un aspecto de evaluaci�n en la tabla de  srh_aspectos_evaluacion
		//	   Creado Por: Maria Beatriz Unda
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->aspecto_evaluaci�n M�TODO->uf_srh_select_aspectos ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
...
function  uf_srh_insert_aspectos($ao_aspecto,$aa_seguridad)
	{
		...
		//      Argumento: $as_codasp   // codigo de aspecto de evaluaci�n
	    //                 $as_denasp   // denominacion de aspecto de evaluaci�n
	    //                 $aa_seguridad   // arreglo de registro de seguridad
		//	      Returns: Retorna un Booleano
		//    Description: Funcion que inserta una aspecto de evaluaci�n en la tabla de srh_aspectos_evaluacion
		//	   Creado Por: Maria Beatriz Unda
		// Fecha Creaci�n: 22/11/2007							Fecha �ltima Modificaci�n: 22/11/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->aspecto_evaluaci�n M�TODO->uf_srh_insert_aspectos ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		...
		else
		{
				...
				/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� el aspecto de evalucion ".$ao_aspecto->codasp;
...
function uf_srh_update_aspectos($ao_aspecto,$aa_seguridad) 
	{
		...
		//         areaess: public 
		//      Argumento: $ao_aspectos   // arreglo con los datos de item de evaluaci�n
	    //                 $aa_seguridad   // arreglo de registro de seguridad
		//	      Returns: Retorna un Booleano
		//    Description: Funcion que modifica una item de evaluaci�n en la tabla de srh_items_evaluacion
		//	   Creado Por: Maria Beatriz Unda
		// Fecha Creaci�n: 26/11/2007							Fecha �ltima Modificaci�n: 26/11/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 $lb_valido=true;
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->aspecto  M�TODO->uf_srh_update_aspectos ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
			$this->io_sql->rollback();
		}
		else
		{
			...
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="UPDATE";
			$ls_descripcion ="Modific� el aspecto de evaluacion ".$ao_aspecto->codasp;
			$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
 ...
 function uf_select_aspectos_items ($as_codeval, $as_codasp)
	{
		...
		//		   Access: private
 		//	    Arguments: as_codeval // c�digo de la evaluaci�n
		...
		if($rs_data===false)
		{
        	$this->io_msg->message("CLASE->aspecto  M�TODO->uf_select_aspectos_items  ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
...
function uf_srh_delete_aspectos($as_codeval, $as_codasp,$aa_seguridad)
	{
		...
		//         areaess: public 
		//      Argumento: $as_codeval   // codigo de la evaluaci�n
	    //                 $aa_seguridad   // arreglo de registro de seguridad
		//	      Returns: Retorna un Booleano
		//    Description: Funcion que elimina una aspecto de evaluaci�n en la tabla de srh_aspectos_evaluacion  
		//	   Creado Por: Maria Beatriz Unda
		// Fecha Creaci�n: 22/11/2007							Fecha �ltima Modificaci�n: 22/11/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		else
		{
			...
			if($li_row===false)
			{
				$this->io_msg->message("CLASE->aspecto_evaluaci�n M�TODO->uf_srh_delete_aspectos ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
				$lb_valido=false;
				$this->io_sql->rollback();
			}
			else
			{
				...
				/////////////////////////////////         SEGURIDAD               /////////////////////////////
				$ls_evento="DELETE";
				$ls_descripcion ="Elimin� los aspectos de la evaluacion evaluaci�n ".$as_codeval;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
				/////////////////////////////////         SEGURIDAD               /////////////////////////////			
 ...
 function uf_srh_buscar_aspectos($as_codeval, $as_deneval)
	{
		...
		//         Access: private
		//      Argumento: $as_deneval // denominaci�n de la evaluacion
		//			       $as_codeva  // c�digo de la evaluacion
		//	      Returns: Retorna un Booleano
		//    Description: Funcion busca un aspecto de evaluaci�n  para luego mostrarla
		//	   Creado Por: Mar�a Beatriz Unda
		// Fecha Creaci�n: 22/11/2007							Fecha �ltima Modificaci�n: 22/11/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->aspecto_evaluaci�n M�TODO->uf_srh_buscar_aspectos( ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{	
...
function uf_srh_load_aspectos_campos($as_codeval,&$ai_totrows,&$ao_object)
	{
		...
		//	    Arguments: as_codeval  // c�digo de laevaluaci�n
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->aspectos M�TODO->uf_srh_load_aspectos_campos ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
		 ...
		 {
		    $this->io_msg->message("No hay aspectos asociados a esa evaluaci�n.");
	 		$ai_totrows=0;	
...
function uf_srh_buscar_aspectos_items ($as_codeval, $as_codasp, $as_denasp)
	{
		...
		//         Access: private
		//      Argumento: $as_codeva  // c�digo de la evaluacion
		//	      Returns: Retorna un Booleano
		//    Description: Funcion busca un aspecto de evaluaci�n  para luego mostrarla
		//	   Creado Por: Mar�a Beatriz Unda
		// Fecha Creaci�n: 08/05/200/						Fecha �ltima Modificaci�n: 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->aspecto_evaluaci�n M�TODO->uf_srh_buscar_aspectos_items ( ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{	
