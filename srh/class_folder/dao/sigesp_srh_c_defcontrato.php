 ...
 function uf_srh_getProximoCodigo()
  {
		...
		//      Argumento: 
		//	      Returns: Retorna el nuevo n�mero de un registro de una nueva configuraci�n de contrato
		//    Description: Funcion que genera un n�mero un registro de configuraci�n de contrato
    ...
    $ls_nroreg = str_pad ($ls_nroreg,3,"0",STR_PAD_LEFT);
    return $ls_nroreg;
  }
...
function uf_srh_guardar_defcontrato ($ao_contrato,$as_operacion="insertar", $aa_seguridad)
  { 
		...
		//      Argumento: $ao_contrato    // arreglo con los datos de la configuraci�n del contrato 					        //
		//                 $as_operacion    //  variable que guarda la operacion a ejecutar (insertar o modificar)              //
		//                 $aa_seguridad    //   arreglo de registro de seguridad                                               //
		//	      Returns: Retorna un Booleano																					//
		//    Description: Funcion que inserta o modifica un registro de configuraci�n de contrato en la tabla srh_defcontrato
		//	   Creado Por: Maria Beatriz Unda																				    //
		// Fecha Creaci�n: 30/06/2008							Fecha �ltima Modificaci�n: 30/06/2008							//
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  	...
  	if ($as_operacion == "modificar")
	{
	 $this->io_sql->begin_transaction();
	  ...
	  $ls_sql = "UPDATE srh_defcontrato SET ".
			...
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="UPDATE";
			$ls_descripcion ="Modific� el registro de Configuraci�n de Contrato".$as_codcont;
	...
	{ $this->io_sql->begin_transaction();
	 ...
	 $ls_sql = "INSERT INTO srh_defcontrato (codcont, descont, tamletcont, tamletpiecont,intlincont, marsupcont, marinfcont, titcont,  arcrtfcont, concont, piepagcont, codemp) ".	  
		...
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� el registro de Configuraci�n de Contrato ".$as_codcont;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	$lb_guardo = $this->io_sql->execute($ls_sql);
     ...
     if($lb_guardo===false)
		{
			$this->io_msg->message("CLASE->defcontrato M�TODO->uf_srh_guardar_defcontrato ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
...
function uf_srh_eliminar_defcontrato($as_codcont, $aa_seguridad)
  {
		...
		//        access:  public (sigesp_srh_defcontrato)															            //
		//      Argumento: $as_codcont       // numero de la configuraci�n del contraro									        //
		//                 $aa_seguridad    //  arreglo de registro de seguridad                                                //
		//	      Returns: Retorna un Booleano																					//
		//    Description: Funcion que elimina una configurci�n de contrato de la tabla srh_defcontrato		        		    //
		//	   Creado Por: Maria Beatriz Unda																				    //
		// Fecha Creaci�n: 30/06/2008							Fecha �ltima Modificaci�n: 30/06/2008							//
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if($lb_borro===false)
	 {
		$this->io_msg->message("CLASE->defcontrato M�TODO->uf_srh_eliminar_defcontrato ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		$lb_valido=false;
		$this->io_sql->rollback();
	 }
	else
...
function uf_srh_buscar_defcontrato($as_codcont,$as_descont)
	{
		...
		//         access: public (sigesp_srh_defcontrato)													                    //
		//      Argumento: $as_codcont   //  numero del registro de la Configuraci�n de  Contrato								//
		//                 $as_descont   //  descripci�n de la Configuraci�n de Contrato
		//	      Returns: Retorna un XML  																						//
		//    Description: Funcion busca una Configuraci�n de  Contrato en la tabla srh_defcontrato y crea un XML para mostrar
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->defcontrato M�TODO->uf_srh_buscar_defcontrato( ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{	
