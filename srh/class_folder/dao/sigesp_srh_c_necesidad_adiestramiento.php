...
function uf_srh_getProximoCodigo()
  {
		...
		//      Argumento: 
		//	      Returns: Retorna el nuevo n�mero de una necesidad de adiestramiento
		//    Description: Funcion que genera un n�mero de una necesidad de adiestramiento
...
function uf_srh_guardar_necesidad_adiestramiento ($ao_necesidad,$ps_operacion="insertar", $aa_seguridad)
  { 
		...
		//    Description: Funcion que inserta o modifica una evaluaci�n de desempeno en la tabla srh_necesidad_adiestramiento
		//	   Creado Por: Maria Beatriz Unda																				    
		// Fecha Creaci�n: 12/05/2008							Fecha �ltima Modificaci�n: 12/05/2008							
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  	...
  	if ($ps_operacion == "modificar")
	{
	 ...
	 $ao_necesidad->fecha=$this->io_funcion->uf_convertirdatetobd($ao_necesidad->fecha);
	  ...
	  $ls_sql = "UPDATE srh_necesidad_adiestramiento SET ".
			...
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="UPDATE";
			$ls_descripcion ="Modific� la necesidad de adiestramiento ".$as_nroreg;
	...
	{ $this->io_sql->begin_transaction();
	  ...
	  $ls_sql = "INSERT INTO srh_necesidad_adiestramiento (nroreg, fecha,codunivi, comptec, objadi, estadi, obsadi, areadi, codemp) ".	  
		...
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� la necesidad de adiestramiento ".$ao_necesidad->nroreg;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	$lb_guardo = $this->io_sql->execute($ls_sql);
     ...
     if($lb_guardo===false)
		{
			$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO->uf_srh_guardar_necesidad_adiestramiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
...
function uf_srh_eliminar_necesidad_adiestramiento($as_nroreg, $aa_seguridad)
  {
		...
		//        access:  public (sigesp_srh_p_necesidad_adiestramiento)														
		//      Argumento: $as_nroreg        // c�digo de la necesidad de adiestramiento 
		//                 $aa_seguridad     //  arreglo de registro de seguridad                                                
		//	      Returns: Retorna un Booleano																					
	...
	if($lb_borro===false)
	 {
		$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO->uf_srh_eliminar_necesidad_adiestramiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		$lb_valido=false;
		$this->io_sql->rollback();
	 }
	else
	 {
				...
				/////////////////////////////////         SEGURIDAD               /////////////////////////////
				$ls_evento="DELETE";
				$ls_descripcion ="Elimin� la necesidad de adiestramiento ".$as_nroreg;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
				/////////////////////////////////         SEGURIDAD               /////////////////////////////			
...
function uf_srh_buscar_necesidad_adiestramiento($as_nroreg,$as_fecha1,$as_fecha2)
	{
		...
		//    Description: Funcion busca una evaluaci�n en la tabla srh_necesidad_adiestramiento y crea un XML para mostrar    
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO->uf_srh_buscar_necesidad_adiestramiento( ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{	
...
function uf_srh_guardar_competencias_necesidad_adiestramiento($ao_necesidad, $aa_seguridad)
  { 
		...
		//                 $aa_seguridad    //   arreglo de registro de seguridad                                               
		//	      Returns: Retorna un Booleano																					
		//    Description: Funcion que inserta una competencia de evaluaci�n en la tabla srh_dt_competencias_adiestramiento
		//	   Creado Por: Maria Beatriz Unda																				    
		// Fecha Creaci�n: 12/05/2008							Fecha �ltima Modificaci�n: 12/05/2008							
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $this->io_sql->begin_transaction();
	  ...
	  $ls_sql = "INSERT INTO srh_dt_competencias_adiestramiento (nroreg, codcompadi, prioridad, codemp) ".	  
		...
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� la competencia ".$ao_necesidad->codcom." asociada al registro ".$ao_necesidad->nroreg;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	$lb_guardo = $this->io_sql->execute($ls_sql);
     ...
     if($lb_guardo===false)
		{
			$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO->uf_srh_guardar_competencias_necesidad_adiestramiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
			$this->io_sql->rollback();
		}
		else
...
function uf_srh_eliminar_competencias_adiestramiento($as_nroreg, $aa_seguridad)
  {
		...
		//      Argumento: $as_nroreg       // c�digo de la evaluaci�n 
		//	               $aa_seguridad    //  arreglo de registro de seguridad                                                
		//	      Returns: Retorna un Booleano																				    
		//    Description: Funcion que elimina competencias de evaluaci�n en la tabla srh_dt_competencias_adiestramiento
		//	   Creado Por: Maria Beatriz Unda																				    
		// Fecha Creaci�n: 12/05/2008							Fecha �ltima Modificaci�n: 12/05/2008							
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if($lb_borro===false)
	 {
		$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO->uf_srh_eliminar_competencias_adiestramiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		$lb_valido=false;
		$this->io_sql->rollback();
	 }
	else
	 {
				...
				/////////////////////////////////         SEGURIDAD               /////////////////////////////
				$ls_evento="DELETE";
				$ls_descripcion ="Elimin� las competencias de la necesidad de adiestramiento del registro".$as_nroreg;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
				/////////////////////////////////         SEGURIDAD               /////////////////////////////			
  ...
  { 
	 ...
	 $this->io_sql->begin_transaction();
	  ...
	  $ls_sql = "INSERT INTO srh_dt_causas_adiestramiento (nroreg, codcauadi, codemp) ".	  
		...
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� la causa de necesidad de adiestramineto ".$ao_necesidad->codcau." asociada al registro".$ao_necesidad->nroreg;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	$lb_guardo = $this->io_sql->execute($ls_sql);
     ...
     if($lb_guardo===false)
		{
			$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO->uf_srh_guardar_causas_adiestramiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
			$this->io_sql->rollback();
		}
		else
...
function uf_srh_eliminar_causas_adiestramiento($as_nroreg, $aa_seguridad)
  {
	...
	if($lb_borro===false)
	 {
		$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO->uf_srh_eliminar_causas_adiestramiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		$lb_valido=false;
		$this->io_sql->rollback();
	 }
	else
	 {
				...
				/////////////////////////////////         SEGURIDAD               /////////////////////////////
				$ls_evento="DELETE";
				$ls_descripcion ="Elimin� las causas de necesidad de adiestramiento aspciadas al registro ".$as_nroreg;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
				/////////////////////////////////         SEGURIDAD               /////////////////////////////			
...
function uf_srh_eliminar_persona($as_nroreg)
  {
	...
	if($lb_borro===false)
	 {
		$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO->uf_srh_eliminar_persona ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		$lb_valido=false;
		$this->io_sql->rollback();
	 }
	else
...
function uf_srh_guardar_trabajador ($ao_necesidad, $aa_seguridad)
  { 
	 ...
	 $this->io_sql->begin_transaction();
	  ...
	  $ls_sql = "INSERT INTO srh_persona_necesidad_adiestramiento (nroreg,codper, tipo, codemp) ".	  
		...
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� Persona de la necesidad de adiestramiento ".$ao_necesidad->nroreg;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	$lb_guardo = $this->io_sql->execute($ls_sql);
     ...
     if($lb_guardo===false)
		{
			$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO->uf_srh_guardar_trabajador ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
			$this->io_sql->rollback();
		}
		else
 ...
 function uf_srh_guardar_supervisor ($ao_necesidad, $aa_seguridad)
  { 
		...
		//         access: public 														  								  
		//      Argumento: $ao_necesidad    // arreglo con los datos de los detalle de la evaluacion de desempe�o					
		//                 $aa_seguridad    //   arreglo de registro de seguridad                                               //
		//	      Returns: Retorna un Booleano																					//
	 ...
	 $this->io_sql->begin_transaction();
	  ...
	  $ls_sql = "INSERT INTO srh_persona_necesidad_adiestramiento (nroreg,codper, tipo, codemp) ".	  
		...
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� Persona de la Revsion de ODI".$ao_necesidad->nroreg;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	$lb_guardo = $this->io_sql->execute($ls_sql);
     ...
     if($lb_guardo===false)
		{
			$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO->uf_srh_guardar_supervisor ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
			$this->io_sql->rollback();
		}
		else
...
public function uf_srh_consultar_causas_adiestramiento(&$ai_totrows,&$ao_object)
{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO->uf_srh_consultar_causas_adiestramiento( ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
...
public function uf_srh_consultar_competencias_adiestramiento(&$ai_totrows,&$ao_object)
{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO->uf_srh_consultar_competencias_adiestramiento( ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
 ...
 function uf_srh_load_causas_adiestramiento($as_nroreg, &$ai_totrows,&$ao_object)
	{
		...
		//	    Arguments: $as_nroreg   // c�digo de la necesidad de adiestramiento
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO-> uf_srh_load_causas_adiestramiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$ai_totrows=0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->necesidad_adiestramiento M�TODO->uf_srh_load_competencias_adiestramiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$ai_totrows=0;
