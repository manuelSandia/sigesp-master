...
function uf_srh_getProximoCodigo()
  {
		...
		//      Argumento: 
		//	      Returns: Retorna el nuevo c�digo de un tipo de evaluaci�n
		//    Description: Funcion que genera un c�digo un tipo de evaluaci�n
    ...
    $ls_codeval = str_pad ($ls_codeval,15,"0",STR_PAD_LEFT);
	return $ls_codeval;
  }
	...
	function uf_srh_select_tipoevaluacion($as_codeval)
	{
		...
		//      Argumento: $as_codeval    // codigo de tipo de evaluaci�n
		//	      Returns: Retorna un Booleano
		//    Description: Funcion que realiza una busqueda de un tipo de evaluaci�n en la tabla de  srh_tipoevaluacion
		//	   Creado Por: Maria Beatriz Unda
		// Fecha Creaci�n: 22/11/2007					Fecha �ltima Modificaci�n: 22/11/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->tipoevaluacion M�TODO->uf_srh_select_tipoevaluacion ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function  uf_srh_insert_tipoevaluacion($as_codeval,$as_deneval,$as_codesc,$aa_seguridad)
	{
		...
		//      Argumento: $as_codeval   // codigo de tipo de evaluaci�n
	    //                 $as_deneval// denominacion de tipo de evaluaci�n
	    //                 $aa_seguridad   // arreglo de registro de seguridad
		//	      Returns: Retorna un Booleano
		//    Description: Funcion que inserta un tipo de evaluaci�n en la tabla de srh_tipoevaluacion
		//	   Creado Por: Maria Beatriz Unda
		// Fecha Creaci�n: 22/11/2007					Fecha �ltima Modificaci�n:22/11/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->tipoevaluacion M�TODO->uf_srh_insert_tipoevaluacion ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		...
		else
		{
				...
				/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� el tipo de evaluaci�n".$as_codeval;
	...
	function uf_srh_update_tipoevaluacion($as_codeval,$as_deneval,$as_codesc,$aa_seguridad) 
	{
	    ...
	    //                 $aa_seguridad   // arreglo de registro de seguridad
		//	      Returns: Retorna un Booleano
		//    Description: Funcion que modifica un tipo de evaluaci�n en la tabla de srh_tipoevaluacion
		//	   Creado Por: Maria Beatriz Unda
		// Fecha Creaci�n: 22/11/2007					Fecha �ltima Modificaci�n: 22/11/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 $lb_valido=true;
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->tipoevaluacion M�TODO->uf_srh_update_tipoevaluacion ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
			$this->io_sql->rollback();
		}
		else
		{
			...
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="UPDATE";
			$ls_descripcion ="Modific� el tipo de evaluaci�n".$as_codeval;
			$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
 ...
 function uf_select_aspectos_evaluacion ($as_codeval)
	{
		...
		//		   Access: private
 		//	    Arguments: as_codeval // c�digo del tipo de evaluaci�n
		...
		if($rs_data===false)
		{
        	$this->io_msg->message("CLASE->tipoevaluacion  M�TODO->uf_select_aspectos_evaluacion  ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
   ...
   function uf_select_tipo_evaluacion_psicologica ($as_codeval)
	{
		...
		//		   Access: private
 		//	    Arguments: as_codeval // c�digo del tipo de evaluaci�n
		//	      Returns: lb_existe True si existe � False si no existe
		//	  Description: Funcion que verifica si el tipo de evaluacion esta asociada a una evaluaci�n psicol�gica
		//	   Creado Por: Mar�a Beatriz Unda
		// Fecha Creaci�n: 24/04/2008								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_existe=true;	    
		...
		if($rs_data===false)
		{
        	$this->io_msg->message("CLASE->tipoevaluacion  M�TODO->uf_select_tipo_evaluacion_psicologica  ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
	...
	function uf_select_tipo_evaluacion_requisitos ($as_codeval)
	{
		...
		//		   Access: private
 		//	    Arguments: as_codeval // c�digo del tipo de evaluaci�n
		//	      Returns: lb_existe True si existe � False si no existe
		//	  Description: Funcion que verifica si el tipo de evaluacion esta asociada a una evaluaci�n de requisitos m�nimos
		//	   Creado Por: Mar�a Beatriz Unda
		// Fecha Creaci�n: 24/04/2008								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_existe=true;	    
		...
		if($rs_data===false)
		{
        	$this->io_msg->message("CLASE->tipoevaluacion  M�TODO->uf_select_tipo_evaluacion_requisitos ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
	...
	function uf_select_tipo_evaluacion_entrevista ($as_codeval)
	{
		...
		//		   Access: private
 		//	    Arguments: as_codeval // c�digo del tipo de evaluaci�n
		//	      Returns: lb_existe True si existe � False si no existe
		//	  Description: Funcion que verifica si el tipo de evaluacion esta asociada a un entrevista t�cnica
		//	   Creado Por: Mar�a Beatriz Unda
		// Fecha Creaci�n: 24/04/2008								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_existe=true;	    
		...
		if($rs_data===false)
		{
        	$this->io_msg->message("CLASE->tipoevaluacion  M�TODO->uf_select_tipo_evaluacion_entrevista  ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
	...
	function uf_select_tipo_evaluacion_ascenso ($as_codeval)
	{
		...
		//		   Access: private
 		//	    Arguments: as_codeval // c�digo del tipo de evaluaci�n
		//	      Returns: lb_existe True si existe � False si no existe
		//	  Description: Funcion que verifica si el tipo de evaluacion esta asociada a una evaluaci�n de ascenso
		//	   Creado Por: Mar�a Beatriz Unda
		// Fecha Creaci�n: 24/04/2008								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_existe=true;	    
		...
		if($rs_data===false)
		{
        	$this->io_msg->message("CLASE->tipoevaluacion  M�TODO->uf_select_tipo_evaluacion_ascenso  ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
	...
	function uf_select_tipo_evaluacion_eficiencia($as_codeval)
	{
		...
		//		   Access: private
 		//	    Arguments: as_codeval // c�digo del tipo de evaluaci�n
		//	      Returns: lb_existe True si existe � False si no existe
		//	  Description: Funcion que verifica si el tipo de evaluacion esta asociada a una evaluaci�n de eficiencia
		//	   Creado Por: Mar�a Beatriz Unda
		// Fecha Creaci�n: 24/04/2008								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_existe=true;	    
		...
		if($rs_data===false)
		{
        	$this->io_msg->message("CLASE->tipoevaluacion  M�TODO->uf_select_tipo_evaluacion_eficiencia ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
	...
	function uf_select_tipo_evaluacion_desempeno ($as_codeval)
	{
		...
		//		   Access: private
 		//	    Arguments: as_codeval // c�digo del tipo de evaluaci�n
		//	      Returns: lb_existe True si existe � False si no existe
		//	  Description: Funcion que verifica si el tipo de evaluacion esta asociada a una evaluaci�n de desempe�o
		//	   Creado Por: Mar�a Beatriz Unda
		// Fecha Creaci�n: 24/04/2008								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_existe=true;	    
		...
		if($rs_data===false)
		{
        	$this->io_msg->message("CLASE->tipoevaluacion  M�TODO->uf_select_tipo_evaluacion_desempeno  ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
	...
	function uf_select_tipo_evaluacion_metas ($as_codeval)
	{
		...
		if($rs_data===false)
		{
        	$this->io_msg->message("CLASE->tipoevaluacion  M�TODO->uf_select_tipo_evaluacion_metas  ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
	...
	function uf_srh_delete_tipoevaluacion($as_codeval,$aa_seguridad)
	{
	    ...
	    //                 $aa_seguridad   // arreglo de registro de seguridad
		//	      Returns: Retorna un Booleano
		//    Description: Funcion que elimina un tipo de evaluaci�n en la tabla de srh_tipoevaluacion
		//	   Creado Por: Maria Beatriz Unda
		// Fecha Creaci�n: 22/11/2007						Fecha �ltima Modificaci�n: 22/11/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 $lb_valido=false;
		...
		if (($this->uf_select_aspectos_evaluacion ($as_codeval)===false)&&
			...
			($this->uf_select_tipo_evaluacion_metas ($as_codeval)===false))
		 {
			...
			if($li_row===false)
			{
				$this->io_msg->message("CLASE->tipoevaluacion M�TODO->uf_srh_delete_tipoevaluacion ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
				$lb_valido=false;
				$this->io_sql->rollback();
			}
			else
			{
				...
				/////////////////////////////////         SEGURIDAD               /////////////////////////////
				$ls_evento="DELETE";
				$ls_descripcion ="Elimin� el tipo de evaluaci�n".$as_codeval;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
				/////////////////////////////////         SEGURIDAD               /////////////////////////////			
...
function uf_srh_buscar_tipoevaluacion($as_codeval,$as_deneval)
	{
		...
		//         Access: private
		//      Argumento: $as_codeval  // codigo de el tipo de evaluaci�n
		//	      Returns: Retorna un Booleano
		//    Description: Funcion busca un tipo de evaluaci�n  para luego mostrarla
		//	   Creado Por: Mar�a Beatriz Unda
		// Fecha Creaci�n: 22/11/2007						Fecha �ltima Modificaci�n: 22/11/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->tipoevaluacion M�TODO->uf_srh_buscar_tipoevaluacion( ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{	
