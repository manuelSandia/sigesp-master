...
function sigesp_srh_c_registro_ascenso($path)
	 ...
	 function uf_srh_getProximoCodigo()
  {
		...
		//      Argumento: 
		//	      Returns: Retorna el nuevo n�mero de un registro de ascenso
  ...
  {  
		...
		//      Argumento: $ps_nroreg    // numero de la postulaci�n 															//
		//                 $pa_datos    //  arreglos donde  se cargaran lo datos de la consulta									//
		//	      Returns: Retorna un Booleano																					//
		//    Description: Funcion que realiza una busqueda de una postulaci�n de ascenso en la tabla srh_registro_ascenso  	
		//	   Creado Por: Maria Beatriz Unda																				    //
		//   Fecha Creaci�n: 21/12/2007							Fecha �ltima Modificaci�n: 21/12/2007							//
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function uf_srh_guardarregistro_ascenso ($po_postulacion,$ps_operacion="insertar", $aa_seguridad)
  { 
		...
		//      Argumento: $po_postulacion    // arreglo con los datos de la postulaci�n										  	
		//                 $ps_operacion    //  variable que guarda la operacion a ejecutar (insertar o modificar)              //
		//                 $aa_seguridad    //   arreglo de registro de seguridad                                               //
		//	      Returns: Retorna un Booleano																					//
		//    Description: Funcion que inserta o modifica una amonestaci�n en la tabla srh_registro_ascenso     		
		//	   Creado Por: Maria Beatriz Unda																				    //
		// Fecha Creaci�n: 21/12/2007							Fecha �ltima Modificaci�n: 21/12/2007							//
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  	...
  	if ($ps_operacion == "modificar")
	{
	 ...
	 $ls_sql = "UPDATE srh_registro_ascenso SET ".
			...
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="UPDATE";
			$ls_descripcion ="Modific� la postulaci�n para ascenso ".$as_nroreg;
	...
	{ $this->io_sql->begin_transaction();
	  ...
	  $ls_sql = "INSERT INTO srh_registro_ascenso (nroreg, fecreg, codcon, observacion, opinion, codemp) ".	  
		...
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� la postulaci�n para ascenso ".$as_nroreg;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	$lb_guardo = $this->io_sql->execute($ls_sql);
     ...
     if($lb_guardo===false)
		{
			$this->io_msg->message("CLASE->ascenso M�TODO->guardarregistro_ascenso ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
	...
	//Guardamos las Personas involucradas en la postulaci�n (Supervisor y Trabajador)
...
function uf_srh_eliminarregistro_ascenso($ps_nroreg, $aa_seguridad)
  {
		...
		//                 $aa_seguridad    //  arreglo de registro de seguridad                                                //
		//	      Returns: Retorna un Booleano																					//
		//    Description: Funcion que elimina una postulaci�n para ascenso en la tabla srh_registro_ascenso		
		//	   Creado Por: Maria Beatriz Unda																				    //
		// Fecha Creaci�n: 21/12/2007							Fecha �ltima Modificaci�n: 21/12/2007							//
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if($lb_borro===false)
	 {
		$this->io_msg->message("CLASE->ascenso M�TODO->eliminarregistro_ascenso ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		$lb_valido=false;
		$this->io_sql->rollback();
	 }
	else
	 {
				...
				/////////////////////////////////         SEGURIDAD               /////////////////////////////
				$ls_evento="DELETE";
				$ls_descripcion ="Elimin� la postulaci�n para ascenso ".$ps_nroreg;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
				/////////////////////////////////         SEGURIDAD               /////////////////////////////			
	...
	//SE BORRAN LOS DETALLES DE la postulaci�n
...
function uf_srh_buscar_registro_ascenso($as_nroreg,$as_codper,$as_codcon)
	{
		...
		//         access: public (sigesp_srh_registro_ascenso)													
		//      Argumento: $as_nroreg   //  numero de la postulaci�n									                      
		...
		//    Description: Funcion busca una postulaci�n de ascenso en la tabla srh_registro_ascenso y crea un XML para mostrar	
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->registro_ascenso M�TODO->uf_srh_buscar_registro_ascenso( ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{	
...
//FUNCIONES PARA EL MANEJO DEL LAS APERSONAS INVOLUACRADAS EN LA POSTULACI�N PARA ASCENSO
...
function uf_srh_eliminar_persona($as_nroreg)
  {
		...
		//        access:  public (sigesp_srh_registro_ascenso)															
		//      Argumento: $as_nroreg	    // n�mero de  la postulaci�n								       
		//                 $aa_seguridad    //  arreglo de registro de seguridad                                               
		//	      Returns: Retorna un Booleano																					
		//    Description: Funcion que elimina una persona involucrada en postulaci�n de ascenso en la tabla srh_registro_ascenso	
		//	   Creado Por: Maria Beatriz Unda																				    
		// Fecha Creaci�n: 21/12/2007							Fecha �ltima Modificaci�n: 21/12/2007							
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if($lb_borro===false)
	 {
		$this->io_msg->message("CLASE->ascenso M�TODO->eliminar_persona ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		$lb_valido=false;
		$this->io_sql->rollback();
	 }
	else
...
function uf_srh_guardar_trabajador ($po_postulacion, $aa_seguridad)
  { 
	 ...
	 $this->io_sql->begin_transaction();
	  ...
	  $ls_sql = "INSERT INTO srh_persona_registro_ascenso (nroreg,codper, tipo, codemp) ".	  
		...
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� Persona de la postulaci�n ".$po_postulacion->nroreg;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	$lb_guardo = $this->io_sql->execute($ls_sql);
     ...
     if($lb_guardo===false)
		{
			$this->io_msg->message("CLASE->ascenso M�TODO->uf_srh_guardar_trabajador ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
			$this->io_sql->rollback();
		}
		else
 ...
 function uf_srh_guardar_supervisor ($po_postulacion, $aa_seguridad)
  { 
		...
		//	     Function: uf_srh_guardar_dt_registro_ascenso															     	//
		//         access: public (sigesp_dt_srh_registro_ascenso)														        //
		//      Argumento: $po_postulacion    // arreglo con los datos de los detalle de la postulaci�n							//
		//                 $ps_operacion    //  variable que guarda la operacion a ejecutar (insertar o modificar)              //
		//                 $aa_seguridad    //   arreglo de registro de seguridad                                               //
		//	      Returns: Retorna un Booleano																					//
		//    Description: Funcion que inserta un supervisor una postulaci�n de ascenso en la tabla srh_dt_registro_ascenso    
		//	   Creado Por: Maria Beatriz Unda																				    //
		// Fecha Creaci�n: 21/12/2007							Fecha �ltima Modificaci�n: 21/12/2007							//
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$lb_guardo = $this->io_sql->execute($ls_sql);
     ...
     if($lb_guardo===false)
		{
			$this->io_msg->message("CLASE->ascenso M�TODO->uf_srh_guardar_dt_registro_ascenso ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
			$this->io_sql->rollback();
		}
		else
