...
<input name="hidguardar_guard" type="hidden" id="hidguardar_guard" value="insertar">
...
<td width="823">
  ...
  <div id="demo" class="yui-navset">
    <ul class="yui-nav">
		...
		<li><a href="#tab10"><em>Guarderia</em></a></li>
    </ul>            
  ...
  <input name="reset" type="reset" onclick="return showCalendar('txtfecingadmpub', '%d/%m/%Y');" value=" ... " />          </td>
          ...
          <td colspan="2"><div align="left">
            ...
            &nbsp;&nbsp;meses
            <input name="txtmesserprev" type="text" id="txtmesserprev" value="0" size="5" maxlength="2" style="text-align:right" onKeyUp="javascript: ue_validarnumero(this);">
</div></td>
          </tr>
        <tr>
  ...
  <input name="reset" type="reset" onclick="return showCalendar('txtfecfevid', '%d/%m/%Y');" value=" ... " />          </td>
	  ...
	  <tr>
        ...
        <tr>
          <td height="22"><div align="right">C&eacute;dula</div></td>
          <td colspan="3"><div align="left">
            <input name="txtcedula" type="text" id="txtcedula" onclick="document.form1.txtcedula.value=document.form1.txtcedfam.value" size="13" maxlength="10" onKeyUp="javascript: ue_validarnumero(this);"> <!--onblur="document.form1.txtcedula.value=this.value" (Funciona igual como el onclick)-->
          </div></td>
        </tr>
		<tr>
          <td height="22"><div align="right">Nombre</div></td>
      ...
      <tr>
        ...
        <a href="javascript: ue_calculardias();"> <img id="cuota" src="../../../../shared/imagebank/tools20/actualizar.jpg" alt="Calcular" width="15" height="15" border="0"></a>
		</div></td>
      </tr>
	  <tr>
    ...
    <div><p><table width="677" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
      ...
      <a href="javascript:catalogo_detalle_deduccion();"></a></td>
            <td colspan="2">&nbsp;</td>
      </tr>
      ...
      <a href="javascript:catalogo_detalle_deduccion_fam();"></a></td>
            <td colspan="2">&nbsp;</td>
      </tr>
	...
	<div><p><table width="677" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
	  ...
	  <tr>
       ...
       <tr class="titulo-ventana">
          <td height="20" colspan="4" class="titulo-ventana">Definici&oacute;n de Guarderias </td>
        </tr>
		<tr>
        <td  colspan="3"><div align="right" class="sin-borde2">C&oacute;digo Personal</div></td>
        <td align="right"><div align="left">
	  ...
	  <tr>
        ...
        <tr>
          ...
          <td colspan="3">
            <div align="left">
              <input name="txtcodguar" type="text" id="txtcodguar"  size="15" maxlength="10" onKeyUp="javascript: ue_validarnumero(this);" onBlur="javascript: ue_rellenarcampo(this,10);" readonly>
			  </div></td></tr>
		<tr>
          <td height="22"><div align="right">Beneficiario</div></td>
          <td colspan="3"><input name="txtguarbene" type="text" id="txtguarbene"  size="15" maxlength="15" readonly>
            ...
            <input name="txtnomguarben" type="text" class="sin-borde" id="txtnomguarben"  size="70" maxlength="100" readonly></td>
        </tr>          <td height="22"><div align="right">Monto</div></td>
          <td colspan="3"><input name="txtguarmonto" type="text" id="txtguarmonto" onKeyPress="return(ue_formatonumero(this,'.',',',event))" size="20" maxlength="25"></td>
        </tr>
		  <tr>
          <td height="21" colspan="4">		 </td>
          </tr>
		 <tr>
        <td height="22"><div align="left"><a href="javascript: ue_nueva_guarderia();"><img src="../../../../shared/imagebank/tools20/nuevo.gif" alt="Grabar" width="20" height="20" border="0">Nueva Guarderia </a></div></td>
        <td width="136">
			<a href="javascript: ue_guardar_guarderia();"> <img src="../../../../shared/imagebank/tools20/grabar.gif" alt="Grabar" width="20" height="20" border="0">Guardar Guarderia </a></td>
		  <td width="141">
			<a href="javascript: ue_eliminar_guarderia();"><img src="../../../../shared/imagebank/tools20/eliminar.gif" alt="Grabar" width="20" height="20" border="0">Eliminar Guarderia  </a></td>
          <td width="251"><span class="toolbar"><a href="javascript: ue_buscar_guarderia();"><img src="../../../../shared/imagebank/tools20/buscar.gif" alt="Grabar" width="20" height="20" border="0">Buscar Guarderia </a></span></td>
      </tr>
      </table>
          <p>&nbsp;</p>
          </div>
