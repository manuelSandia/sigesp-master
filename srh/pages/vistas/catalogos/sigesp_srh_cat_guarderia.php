...
<form name="form1" method="post" action="">
  ...
  <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Guarderias</td>
    </tr>
  </table>
  <br>
...
<script language="JavaScript">
        ...
        var loadDataURL = "../../php/sigesp_srh_a_personal.php?valor=createXML_guarderia";
	...
	//initialise (from xml) and populate (from xml) grid
		function doOnLoad()
		{
			...
			mygrid.setHeader("Código,Cedula Beneficiario,Beneficiario");
	...
	function aceptar (ls_codguar, ls_guarbene, ls_nomguarbene, li_monto, ls_codguardestino, ls_guarbenedestino, ls_nomguarbenedestino, li_montodestino)
	{
		
		
		  obj=eval("opener.document.form1."+ls_codguardestino+"");
		  obj.value=ls_codguar;
	      obj1=eval("opener.document.form1."+ls_guarbenedestino+"");
	      obj1.value=ls_guarbene;
	   	  obj2=eval("opener.document.form1."+ls_nomguarbenedestino+"");
		  obj2.value=ls_nomguarbene;
		  obj3=eval("opener.document.form1."+li_montodestino+"");
		  obj3.value=li_monto;
		  
		  
		  
		  opener.document.form1.hidguardar_guard.value='modificar';
