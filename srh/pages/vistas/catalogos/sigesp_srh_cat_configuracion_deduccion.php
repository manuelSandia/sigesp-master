...
<script>
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function aceptar(ls_codtipded,ls_dentipded,ls_coddestino,ls_dendestino)
		{
			...
			if (ls_tipo=='3')
			{
				...
				calcular_montofam (ls_codtipded);
				calcular_montofam2 (ls_codtipded);
			}	
			else
			{
				...
				if (ls_tipo=='2')
				{
					calcular_monto (ls_codtipded);
					calcular_monto2 (ls_codtipded);
				}
			}
			//close();
	...
	function calcular_monto (codtipded)
 	{
		function onConsultar(respuesta)
		 {
		  ...
		  sexper=opener.document.form1.cmbsexper.value;
		  url="../../php/sigesp_srh_a_configuracion_deduccion.php";
		  params = "operacion=calcular_monto_deduccionnew&codper="+codper+"&codtipded="+codtipded+"&sexper="+sexper;
		  new Ajax.Request(url,{method:'get',parameters:params,onComplete:onConsultar});
	}

	function calcular_monto2 (codtipded)
 	{
		function onConsultar(respuesta)
		 {
			opener.document.form1.txtcoddettipded.value  = trim(respuesta.responseText);
		 }	
		  codper=opener.document.form1.txtcodper.value;	  
		  sexper=opener.document.form1.cmbsexper.value;
		  url="../../php/sigesp_srh_a_configuracion_deduccion.php";
		  params = "operacion=calcular_monto_deduccionnew_cod&codper="+codper+"&codtipded="+codtipded+"&sexper="+sexper;
		  new Ajax.Request(url,{method:'get',parameters:params,onComplete:onConsultar});
	}
	
	function calcular_montofam (codtipded)
 	{
		function onConsultar(respuesta)
		 {
		  ...
		  sexper=opener.document.form1.cmbsexper.value;
		  url="../../php/sigesp_srh_a_configuracion_deduccion.php";
		  params = "operacion=calcular_monto_deduccionnewfam&codper="+codper+"&codtipded="+codtipded+"&sexper="+sexper+"&cedfam="+cedfam;
		  new Ajax.Request(url,{method:'get',parameters:params,onComplete:onConsultar});
	}

	function calcular_montofam2 (codtipded)
 	{
		function onConsultar(respuesta)
		 {
			opener.document.form1.txtcoddettipdedfam.value  = trim(respuesta.responseText);
		 }	
		  cedfam=opener.document.form1.txtcedfam1.value;
		  codper=opener.document.form1.txtcodper.value;	  
		  sexper=opener.document.form1.cmbsexper.value;
		  url="../../php/sigesp_srh_a_configuracion_deduccion.php";
		  params = "operacion=calcular_monto_deduccionnew_codfam&codper="+codper+"&codtipded="+codtipded+"&sexper="+sexper+"&cedfam="+cedfam;
		  new Ajax.Request(url,{method:'get',parameters:params,onComplete:onConsultar});
	}
