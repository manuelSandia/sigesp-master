...
<script language="JavaScript">
	...
	//initialise (from xml) and populate (from xml) grid
		function doOnLoad()
		{
			...
			mygrid.setHeader("Cédula,Nombre,Nexo");
