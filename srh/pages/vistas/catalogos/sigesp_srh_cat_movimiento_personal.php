...
function aceptar (ls_nummov,ls_codcar,ls_coduniadm,ls_denuniadm ,ls_grapro,ls_paspro,ls_suelpro,ls_compro,ls_suetotpro,ls_codgrumov,ls_dengrumov,ls_motivo,ls_obs,ls_fecreg,ls_fecinimov, ls_nummovdestino,ls_codcardestino,ls_coduniadmdestino, ls_denuniadmdestino,ls_graprodestino,ls_pasprodestino,ls_suelprodestino,ls_comprodestino,ls_suetotprodestino,ls_codgrumovdestino,ls_dengrumovdestino,
				...
				ls_pasactdestino,ls_pasact,ls_codcaractdestino,ls_codcaract,ls_descaractdestino,ls_descaract,ls_coduniadmactdestino,ls_coduniadmact,ls_desuniadmactdestino,ls_denuniadmact,ls_codnomactdestino,ls_codnomact,ls_gradodestino,ls_graact,ls_pasodestino,ls_pasact,ls_sueldodestino,ls_suebasact)
	{
	...
	/*	ue_buscar_cargo_actual2(ls_codper);
		...
		obj21=eval("opener.document.form1."+ls_horactdestino+"");
		obj21.value=ls_horact;

		obj22=eval("opener.document.form1."+ls_horprodestino+"");
		obj22.value=ls_horpro;

		obj23=eval("opener.document.form1."+ls_comactdestino+"");
		obj23.value=uf_convertir (ls_comact);

		obj24=eval("opener.document.form1."+ls_otringactdestino+"");
		obj24.value=uf_convertir (ls_otringact);

		obj25=eval("opener.document.form1."+ls_otringprodestino+"");
		obj25.value=uf_convertir (ls_otringpro);

		obj26=eval("opener.document.form1."+ls_tipnomdestino+"");
		obj26.value=ls_tipnom;

		obj27=eval("opener.document.form1."+ls_graactdestino+"");
		obj27.value=ls_graact;

		obj28=eval("opener.document.form1."+ls_descaractdestino+"");
		obj28.value=ls_descaract;

		obj29=eval("opener.document.form1."+ls_coduniadmactdestino+"");
		obj29.value=ls_coduniadmact;

		obj30=eval("opener.document.form1."+ls_desuniadmactdestino+"");
		obj30.value=ls_denuniadmact;

		obj31=eval("opener.document.form1."+ls_codnomactdestino+"");
		obj31.value=ls_codnomact;

		obj32=eval("opener.document.form1."+ls_gradodestino+"");
		obj32.value=ls_graact;

		obj33=eval("opener.document.form1."+ls_pasodestino+"");
		obj33.value=ls_pasact;

		obj34=eval("opener.document.form1."+ls_sueldodestino+"");
		obj34.value=uf_convertir (ls_suebasact);

		obj35=eval("opener.document.form1."+ls_codcaractdestino+"");
		obj35.value=ls_codcaract;
