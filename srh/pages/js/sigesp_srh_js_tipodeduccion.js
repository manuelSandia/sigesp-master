...
if(f.txtcodtipded.value=="")
  {
		alert('Falta Codigo del Tipo de Deducción de Seguro');
		lb_valido=false;
   }
   else if(f.txtdentipded.value=="")
   {
	   alert('Falta la Denominacion del Tip de Deducción de Seguro');
	   lb_valido=false;
   }
  ...
  //enviando los valores
   ajax.send("txtcodtipded="+codtipded);
		...
		else
	   {
		...
		alert('Debe elegir un Tipo de Deducción de Seguro del Catalogo');
