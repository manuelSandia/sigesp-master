...
var loadDataURL = "../../php/sigesp_srh_a_requisitos_minimos.php?valor=createXML";
var actionURL = "../../php/sigesp_srh_a_requisitos_minimos.php";
var mygrid;
...
function doOnLoad()
		{
			...
			mygrid.setInitWidths("130,250,120");
...
function Buscar()
{
	 ...
	 else
	 {
		 ...
		 mygrid.loadXML("../../php/sigesp_srh_a_requisitos_minimos.php?valor=buscar"+"&txtfechades="+fechades+"&txtfechahas="+fechahas+"&txtcodper="+codper);
...
function aceptar ( ls_codper ,  ls_fecha ,  ls_apeper ,  ls_nomper,  ls_codcon ,  ls_descon , ls_codperdestino ,  ls_fechadestino ,  ls_nomdestino ,  ls_codcondestino ,  ls_descondestino, ls_codeval, ls_deneval, ls_codevaldestino, ls_denevaldestino, li_total, ls_totaldestino, ls_ejecucion)
	{
		...
		if(ls_ejecucion=="1")
		{
		 ...
		 opener.document.form1.hidstatus.value="";
			...
			opener.document.form1.action="../pantallas/sigesp_srh_p_requisitos_minimos.php";
