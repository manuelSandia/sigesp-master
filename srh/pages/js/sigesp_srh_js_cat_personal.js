...
function Buscar()
{
 ...
 numexp=document.form1.txtnumexp.value;
 hidtipo=document.form1.hidtipo.value;
  ...
  mygrid.loadXML("../../php/sigesp_srh_a_personal.php?valor=buscar"+"&txtcodper="+codper+"&txtcedper="+cedper+"&txtnomper="+nomper+"&txtapeper="+apeper+"&txtnumexp="+numexp+"&hidtipo="+hidtipo);
...
function aceptar_persona1 (ls_codper, ls_cedper, ls_nomper, ls_apeper,	ls_dirper,	ls_fecnacper, 	ls_edocivper, 	ls_nacper, ls_codpai,	ls_codest,	ls_codmun, ls_codpar, ls_telhabper, 	ls_coreleper,ls_telmovper, ls_sexper, ls_estaper, ls_pesper, ls_codpro,ls_despro, ls_nivacaper,	ls_codcom,	ls_codran,	ls_cedbenper,	ls_numhijper,	ls_contraper,	ls_obsper, ls_fotper, 				ls_cenmedper, ls_turper, 	ls_horper,	ls_hcmper,	ls_tipsanper,	ls_numexpper, ls_tipvivper, ls_tenvivper, ls_monpagvivper, ls_cuecajahoper, ls_cajahoper, ls_cuelphper, ls_cuefidper,	ls_fecingadmpubper, ls_anoservpreper, ls_messerprev, ls_fecingper, ls_fecegrper, ls_cauegrper, ls_obsegrper, ls_codperdestino, ls_cedperdestino, ls_nomperdestino, ls_apeperdestino,	ls_dirperdestino,	ls_fecnacperdestino, ls_edocivperdestino, ls_nacperdestino, ls_codpaidestino,	ls_codestdestino, ls_codmundestino, ls_codpardestino, ls_telhabperdestino, 	ls_coreleperdestino,	ls_telmovperdestino, ls_sexperdestino, ls_estaperdestino,	ls_pesperdestino,	ls_codprodestino, ls_desprodestino, ls_nivacaperdestino, ls_codcomdestino, ls_codrandestino,	ls_cedbenperdestino,	ls_numhijperdestino,	ls_contraperdestino,	ls_obsperdestino, ls_fotperdestino,	ls_cenmedperdestino, ls_turperdestino, 	ls_horperdestino,	ls_hcmperdestino,	ls_tipsanperdestino,	ls_numexpperdestino, ls_tipvivperdestino, ls_tenvivperdestino, ls_monpagvivperdestino,ls_cuecajahoperdestino, ls_cajahoperdestino,ls_cuelphperdestino, ls_cuefidperdestino,	ls_fecingadmpubperdestino, ls_anoservpreperdestino, ls_messerprevdestino, ls_fecingperdestino, ls_fecegrperdestino, ls_cauegrperdestino, ls_obsegrperdestino, ls_codpainac, ls_codestnac,ls_codtippersss, ls_dentippersss, ls_codpainacdestino, ls_codestnacdestino,ls_codtippersssdestino,ls_dentippersssdestino, ls_codunivi,ls_codunividestino, ls_denunivi,ls_denunividestino, ls_fecjubper,ls_fecjubperdestino, ls_fecreingper,ls_fecreingperdestino, ls_fecfevid, ls_fecfeviddestino, ls_enviorec, ls_enviorecdestino, ls_descom, ls_descomdestino , ls_desran,ls_desrandestino, ls_feclossfan,ls_feclossfandestino,ls_codcausa, ls_codcausadestino, ls_dencausa, ls_dencausadestino,ls_situacion,ls_fecsitu,  ls_talcamper, ls_talpanper, ls_talzapper, ls_situaciondestino, ls_fecsitudestino,ls_talcamperdestino, ls_talpanperdestino , ls_talzapperdestino,ls_anoservprecont,ls_anoservprecontdestino,ls_anoservprefijo, ls_anoservprefijodestino, ls_codorg, ls_codorgdestino,ls_desorg, ls_desorgdestino,ls_porcajahoper,ls_porcajahoperdestino, ls_codger,ls_denger,ls_coddestino,ls_dendestino, ls_anoperobr, ls_anoperobrdestino, ls_carantper, ls_carantperdestino, dias, meses, anos)
	{
		...
		obj401=eval("opener.document.form1."+ls_messerprevdestino+"");
		obj401.value=ls_messerprev;
...
function aceptar_persona_movimiento (ls_codper,ls_nomper, ls_apeper,ls_cargo,ls_uniadm,ls_sueact,ls_comact, ls_otringact, ls_codperdestino,ls_nomperdestino, ls_caractdestino, ls_uniadmdestino, ls_sueactdestino, ls_comactdestino, ls_otringactdestino, ls_codcar, ls_codcardestino, ls_coduniadm, ls_coduniadmdestino,ls_codnom,ls_codnomdestino, ls_paso, ls_pasodestino, ls_grado, ls_gradodestino, ls_horariodestino, ls_horario, ls_pasodestino1, ls_gradodestino1)
{
	obj1=eval("opener.document.form1."+ls_codperdestino+"");
	obj1.value=ls_codper;
	 ...
	 if (ls_apeper!='0'){
       ...
       obj11=eval("opener.document.form1."+ls_horariodestino+"");
	   obj11.value=ls_horario;
	   
	   obj12=eval("opener.document.form1."+ls_pasodestino1+"");
	   obj12.value=ls_paso;
	   
	   obj13=eval("opener.document.form1."+ls_gradodestino1+"");
	   obj13.value=ls_grado;

	   obj14=eval("opener.document.form1."+ls_comactdestino+"");
	   obj14.value=uf_convertir (ls_comact);
   
       obj15=eval("opener.document.form1."+ls_otringactdestino+"");
	   obj15.value=uf_convertir (ls_otringact);
	
  	   suelact = ls_sueact;
       comact = ls_comact;
       totingact = ls_otringact;
       suma = parseFloat (suelact) + parseFloat(comact) + parseFloat(totingact);
       suma = uf_convertir (suma);
	   opener.document.form1.txtsumsueact.value= suma;
...
function aceptar_personal2 (ls_codper, ls_nomper, ls_apeper,ls_cargo, ls_fecegr, ls_estper, ls_codperdestino, ls_nomperdestino,ls_cargodestino,ls_fecegrdestino, ls_estperdestino,ls_ejecucion)
	{
	   obj1=eval("opener.document.form1."+ls_codperdestino+"");
	   obj1.value=ls_codper;
	  if (ls_apeper!='0'){
	   ...
	   obj5=eval("opener.document.form1."+ls_estperdestino+"");
	   obj5.value=ls_estper;
