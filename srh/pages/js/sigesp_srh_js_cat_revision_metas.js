...
var loadDataURL = "../../php/sigesp_srh_a_revision_metas.php?valor=createXML";
var actionURL = "../../php/sigesp_srh_a_revision_metas.php";
var mygrid;
...
function doOnLoad()
		{
			...
			mygrid.setHeader("Nro. Revisión,Codigo,Nombre y Apellido,Fecha Revisión");
...
function Buscar()
{
	 ...
	 else
	 {
		 ...
		 mygrid.loadXML("../../php/sigesp_srh_a_revision_metas.php?valor=buscar"+"&txtfechades="+fechades+"&txtfechahas="+fechahas+"&txtnroreg="+nroreg);
...
function aceptar ( ls_nroreg, ls_fecha, ls_apeper, ls_nomper, ls_codper,ls_apeeva, ls_nomeva, ls_codeva, ls_careva,ls_fecini,ls_fecfin, ls_obs, li_total, ls_codeval, ls_deneval, ls_nrodestino,ls_codperdestino, ls_fechadestino,  ls_nomperdestino, ls_fecinidestino,  ls_fecfindestino, ls_codevadestino,ls_nomevadestino,ls_carevadestino,ls_obsdestino, ls_totaldestino, ls_codevaldestino, ls_denevaldestino, ls_fecreg, ls_fecregdestino, ls_codcarper,ls_codcarperdestino)
	{
		...
		obj11=eval("opener.document.form1."+ls_codevaldestino+"");
		obj11.value=ls_codeval;
		
		
		obj12=eval("opener.document.form1."+ls_denevaldestino+"");
		obj12.value=ls_deneval;
		
		obj13=eval("opener.document.form1."+ls_fecregdestino+"");
		obj13.value=ls_fecreg;
		
		
		obj14=eval("opener.document.form1."+ls_totaldestino+"");
		obj14.value=li_total;
	     ...
	     ls_ejecucion=document.form1.hidstatus.value;
			...
			opener.document.form1.action="../pantallas/sigesp_srh_p_revision_metas.php";
...
function Limpiar_busqueda () 
{
	...
	document.form1.txtfechades.value=document.form1.txtfechas2.value;
	document.form1.txtfechahas.value=document.form1.txtfecdes2.value;
	
}


function cat_registro_metas()
{
  pagina="../catalogos/sigesp_srh_cat_registro_metas.php?valor_cat=0"+"&tipo=cat";
