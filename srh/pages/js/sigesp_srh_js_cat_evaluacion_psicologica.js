...
var loadDataURL = "../../php/sigesp_srh_a_evaluacion_psicologica.php?valor=createXML";
var actionURL = "../../php/sigesp_srh_a_evaluacion_psicologica.php";
var mygrid;
...
function Buscar()
{
	 ...
	 else
	 {
		 ...
		 mygrid.loadXML("../../php/sigesp_srh_a_evaluacion_psicologica.php?valor=buscar"+"&txtfechades="+fechades+"&txtfechahas="+fechahas+"&txtcodper="+codper);
	...
	ls_ejecucion=document.form1.hidstatus.value
		if(ls_ejecucion=="1")
		{
		 ...
		 opener.document.form1.hidstatus.value="";
			...
			opener.document.form1.action="../pantallas/sigesp_srh_p_evaluacion_psicologica.php";
