...
var url= "../../php/sigesp_srh_a_cargo.php";
var metodo="POST";
...
function ue_buscar()
{
	...
	{
		f.hidstatus.value='C';
		window.open("../catalogos/sigesp_srh_cat_cargo.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
