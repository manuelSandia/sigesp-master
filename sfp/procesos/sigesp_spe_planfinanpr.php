	...
	global $json;
			...
			while($Datos2=$Datos->FetchRow())
			{
				foreach($Datos2 as $Propiedad=>$valor)
				{
					...
					{
						if (is_numeric($valor) && $Propiedad!="ano_presupuesto" && $Propiedad!="codcaif" && $Propiedad!="sig_cuenta" && $Propiedad!="codigo" && $Propiedad!="codigohaber" && $Propiedad!="codigodebe" && $Propiedad!="codcaif" && $Propiedad!="codvardebe" && $Propiedad !="codvarhaber") 
						{							
