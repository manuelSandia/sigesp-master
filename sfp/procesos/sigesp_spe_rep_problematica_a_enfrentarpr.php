<?php
require_once('../class_folder/dao/sigesp_spe_rep_inversion_area_estrategica_dao.php');
...
if (filter_has_var ( INPUT_POST , 'ObjSon')) 
{
	...
	switch ($Evento)
	{
		...
		case 'Reporte':
			...
			//$oReporte->CrearXml('detalle_financiamiento',$Data);		//este es que se repite por tantas consultas uno haga
			$oReporte->NomRep="detalle_financiamiento";
