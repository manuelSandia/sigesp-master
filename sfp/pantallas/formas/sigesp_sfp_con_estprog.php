...
<head>
    ...
    <title id="page-title">SIGESP-Configuraci&oacute;n de Niveles</title> 
...
<script type="text/javascript" src="../js/sigesp_sfp_con_estplan.js"></script>
...
<div class="titulo-pantalla">Configuraci&oacute;n de Niveles</div>
<div id="tabPrin">
	<div id="ContenedorGrid" class="x-hide-display"  style="height:200px;"></div>
	<div id="ContenedorGrid2" class="x-hide-display" style="height:200px;"></div>
	<div id="ContenedorGrid3" class="x-hide-display" style="height:200px;"></div>
	<div id="ContenedorGrid4" class="x-hide-display" style="height:200px;"></div>
</div>
</div>
</body> 
