...
<script type="text/javascript" src="../js/sigesp_spe_comboubest.js"></script>
...
<div id="tabs2">
<img src="../../otros/imagenes/Add.PNG" id="imgSum" style="width:20px,height:20px" width="40" height="40">
<img src="../../otros/imagenes/delete_24x24.PNG" id="imgSum" style="width:20px,height:20px" width="40" height="40">
...
<img src="../../otros/imagenes/gastos.gif" alt="Nuevo"  id="ImgRestar" >
<img src="../../otros/imagenes/ingresos.gif" alt="Grabar" id="ImgSumar">

</div> 


<div id="todoscombos" class="x-hide-display">
<div id="DivEst">
	<div id='combo1'></div>
	<div id='combo2'></div>
	<div id='combo3'></div>
