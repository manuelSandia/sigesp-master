...
<head>
	<title>SIGESP - Definici&oacute;n de Meta</title>
...
<script type="text/javascript" src="../js/sigesp_spe_meta.js"></script>
...
<div id="centro">
<div class="titulo-pantalla">Definici&oacute;n de Meta</div>
...
<table width="588" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td><table width="566" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
                  ...
                  <tr class="formato-blanco">
                    ...
                    <td height="22"><input name="txtcod" type="text" id="txtcod" value="" size="8" maxlength="4" style="text-align:center " title="Código" readonly>
		      ...
		      <input name="actualizar" type="hidden" id="actualizar">
                  ...
                  <tr class="formato-blanco">
                    ...
                    <td height="22"><input name="txtden" type="text" id="txtden"  value="" size="50" maxlength="100" title="Denominación"></td>
                  </tr>
                 
                  <tr class="formato-blanco">
                    <td height="28"><div align="right">Unidad de Medida</div></td>
                    <td height="22"><select name="cmbunidad"  id="cmbunidad" title="Unidad de medida"> 
