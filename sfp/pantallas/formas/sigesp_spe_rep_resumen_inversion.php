...
<html>
<head>
  <title> Inversion Area Estratégica </title>
  ...
  <script type="text/javascript" src="../js/sigesp_spe_rep_inversion_area_estrategica.js"></script>
      ...
      <tr>
        ...
        <table class="formato-blanco" align="center" border="0" cellpadding="0" cellspacing="0" width="566">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="2" class="titulo-ventana">Inversi&oacute;n Area Estrat&eacute;gica </td>
            </tr>
            ...
            <tr class="formato-blanco">
              <td height="28">
              <div align="right">Nivel Plan </div>
              </td>
              <td height="22"><select name="nplan1" id="nplan1" /> 
			  </td>
            </tr>
            ...
            <tr class="formato-blanco">
              ...
              <td height="22"><select name="plan1" id="plan1" /> 
			  </td>
            </tr>
