...
<head>
	 <title id="page-title">SIGESP - Definici&oacute;n de Tipo de Indicador</title> 
...
<script type="text/javascript" src="../js/sigesp_sfp_tipoindi.js"></script>
<script type="text/javascript" src="../catalogos/catalogoTipoind.js"></script>
...
<div id="centro">
<div class="titulo-pantalla">Definici&oacute;n de Tipo de Indicador</div>
...
<table width="588" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td><table width="566" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
                  ...
                  <tr class="formato-blanco">
                    ...
                    <td height="22"><input name="txtcod" type="text" id="cod_tipoind" value="" size="8" maxlength="4" style="text-align:center " title="Código" readonly>
		      ...
		      <input name="actualizar" type="hidden" id="actualizar">
                  ...
                  <tr class="formato-blanco">
                    ...
                    <td height="22"><input name="txtden" type="text" id="denominacion"  value="" size="50" maxlength="100" title="Denominación"></td>
                  </tr>
