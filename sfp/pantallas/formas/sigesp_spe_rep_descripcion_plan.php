...
<html>
<head>
  <title> Descripción del Plan </title>
  ...
  <script type="text/javascript" src="../js/sigesp_spe_rep_descripcion_plan.js"></script>
      ...
      <tr>
        ...
        <table class="formato-blanco" align="center" border="0" cellpadding="0" cellspacing="0" width="566">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="2" class="titulo-ventana">Descripción del Plan </td>
            </tr>
            ...
            <tr class="formato-blanco">
              ...
              <td height="22"><select name="" id="plan1" /> <select name="" id="plan2" /> <select name="" id="plan3" /> <input name="codemp" id="codemp" value="0001" type="hidden">
              </td>
