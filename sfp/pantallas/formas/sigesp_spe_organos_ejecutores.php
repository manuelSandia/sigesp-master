...
<html>
<head>
  <title>Planificaciaci&oacute;n Estrat&eacute;gica- OrganosEjecutores</title>
        ...
        <table class="formato-blanco" align="center" border="0" cellpadding="0" cellspacing="0" width="566">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="2" class="titulo-ventana">Definici&oacute;n
de Organos Ejecutores</td>
            ...
            <tr class="formato-blanco">
              ...
              <td height="22"><input name="txtcod" id="txtcod" value="" size="8" maxlength="4" style="text-align: center;" title="C&oacute;digo" readonly="readonly" type="text"> <input name="codemp" id="codemp" value="0001" type="hidden"> <input name="actualizar" id="actualizar" type="hidden">
              </td>
            ...
            <tr class="formato-blanco">
              ...
              <td height="22"><input name="txtdenfue" id="txtden" value="" size="50" maxlength="100" title="Denominaci&oacute;n" type="text"></td>
