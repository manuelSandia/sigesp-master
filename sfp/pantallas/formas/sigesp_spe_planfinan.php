...
<head>
    ...
    <title id="page-title">SIGESP - Formulaci&oacute;n de Ingresos</title> 
    
<script type="text/javascript" language="JavaScript" src="../../librerias/js/general/funciones.js"></script>
<style type="text/css">
	
</style><script type="text/javascript" src="../../librerias/js/ext/adapter/ext/ext-base.js"></script>
...
<script type="text/javascript" src="../js/sigesp_spe_planfinan.js"></script>
...
<div class="titulo-ventana"></div>
<div class="status" id="p1text"></div>
<div class="status" id="p1"></div>
<div id="progra">
<div id="grid-example" style="overflow:scroll">
<div class="titulo-pantalla" style="position:absolute;top:10px">Formulaci&oacute;n de Ingresos</div>
</div>
</div>
<div id="grid-montos" style="overflow:scroll"></div>
<div style="margin:4px" id="aqui">
<!-- <img src="../../otros/imagenes/file-add.gif" alt="Grabar" id="ImgSumar" style="position:absolute;left:890px;top:170px;cursor:pointer">
<img src="../../otros/imagenes/file-remove.gif" alt="Nuevo"  id="ImgRestar" style="position:absolute;left:890px;top:200px;cursor:pointer">-->
</div> 
