              ...
              <tr>
                <td><table width="566" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
                  ...
                  <tr class="formato-blanco">
                    ...
                    <td height="22"><input type="text" id="txtden"   size="50" maxlength="100" title="Denominación"></td>
                  </tr>
                  <tr class="formato-blanco">
                    <td height="28"><div align="right">Sensible a Género</div></td>
                    <td height="22"><input name="chkgen" type="checkbox" id="chkgen"  value="" size="50" maxlength="100" title="Género"></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
