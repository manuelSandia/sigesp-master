...
Ejecutores</title>
  ...
  <script type="text/javascript" src="../js/sigesp_spe_rep_detalle_financiamiento.js"></script>
      ...
      <tr>
        ...
        <table class="formato-blanco" align="center" border="0" cellpadding="0" cellspacing="0" width="566">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="2" class="titulo-ventana">Detalle del Financiamiento </td>
            </tr>
            ...
            <tr class="formato-blanco">
              ...
              <td height="22"><select name="" id="plan1" />
			  </td>
            </tr>
