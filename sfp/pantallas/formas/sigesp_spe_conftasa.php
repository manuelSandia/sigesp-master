...
<head>
    ...
    <title id="page-title">SIGESP - Configuraci&oacute;n de Tasas de Inflación Estimadas</title> 
...
<script type="text/javascript" src="../js/sigesp_spe_conftasa.js"></script>
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno" id="norte">
  ...
  <tr>
	  <td class="Botonera">
	  <img src="../../../shared/imagebank/tools20/nuevo.gif" alt="Grabar" width="20" height="20" border="0" id="BtnNuevo">
	  	    <img src="../../../shared/imagebank/tools20/grabar.gif" alt="Grabar" width="20" height="20" border="0" id="BtnGrabar">
	  	    <img src="../../../shared/imagebank/tools20/buscar.gif" alt="Grabar" width="20" height="20" border="0" id="BtnBuscar">
...
<div id="tabPrin1" >
<div id="grid-example"   class="x-hide-display"></div>
<div id="form1"   class="x-hide-display"></div>
<div id="grid-example2"  class="x-hide-display"></div>
</div>


<div class="titulo-pantalla" style="position:absolute;top:100px">Tasa de Inflación Estimada</div>
