...
<head>
    ...
    <title id="page-title">SIGESP-Variación Patrimonial</title> 
...
<script type="text/javascript" src="../../librerias/js/general/Listas.js"></script>
<script type="text/javascript" src="../js/sigesp_spe_integraciongeneral.js"></script>
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno" id="norte">
  ...
  <tr>
	  <td class="Botonera">
		    <img src="../../../shared/imagebank/tools20/nuevo.gif" alt="Nuevo" width="20"  border="0" id="BtnNuevo" >
		    <img src="../../../shared/imagebank/tools20/grabar.gif" alt="Grabar" width="20"  border="0" id="BtnGrabar">
		    <img src="../../../shared/imagebank/tools20/eliminar.gif" alt="Eliminar" width="20" height="20" border="0" id="BtnElim">
		    <img src="../../../shared/imagebank/tools20/buscar.gif" alt="Buscar" width="20" height="20" border="0" id="BtnBuscar">
		    <img src="../../../shared/imagebank/tools20/imprimir.gif" alt="Imprimir" width="20"  border="0" id="BtnImp">
		    <img src="../../../shared/imagebank/tools20/salir.gif" alt="Salir" width="20"  border="0" id="BtnSalir">
		    <img src="../../../shared/imagebank/tools20/ayuda.gif" alt="Ayuda" width="20"  id="BtnAyu">
	  </td>
  </tr>
</table>
<div id="centro">
<div class="titulo-pantalla">Definicion del Plan General de Cuentas Integrado</div>
<div id="form"></div>

</div>
<div id="sur">
	<div id="ContenedorGridCoversion">
	</div>
</div>
</body> 
