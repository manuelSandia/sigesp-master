...
<script type="text/javascript" src="../../librerias/js/ext/RowExpander.js"></script>
<script type="text/javascript" src="../../librerias/js/general/json2.js"></script>
<script type="text/javascript" src="../js/sigesp_spe_progCompra.js"></script>
...
<script type="text/javascript" src="../js/sigesp_sfp_distindi.js"></script>
<script type="text/javascript" src="../js/sigesp_sfp_Catesadmin.js"></script>
<script type="text/javascript" src="../js/sigesp_sfp_Catarticulos.js"></script>
<script type="text/javascript" src="../js/sigesp_sfp_plangastos.js"></script>
<script type="text/javascript" src="../js/sigesp_sfp_distarts.js"></script>
<script type="text/javascript" src="../js/sigesp_sfp_catestructurasInt.js"></script>
...
<title>SIGESP - Programaci&oacute;n de Compras</title><table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno" id="norte">
  <tr>
...
<!--  	<img src="../../otros/imagenes/file-add.gif" id="LlamarCatalogosTabs2">
	...
	<div id="grid-Gastos" style="width:400px"></div>
	<div id="grid-ind" class="x-hide-display"></div>	
</div>


<div id="grid-fuentesIng" style="height:50px;width:850px"></div>
