...
<head>
    ...
    <title id="page-title">SIGESP-Conversi&oacute;n de Cuentas</title> 
...
<script type="text/javascript" src="../../librerias/js/menu/menuempresa.js"></script>
...
<script type="text/javascript" src="../js/sigesp_spe_variacion.js"></script>
...
<div id="centro">
<div class="titulo-pantalla">Conversión de Cuentas</div>
<div id="form"></div>
