...
<html>
<head>
  <title> Problematica a Enfrentar </title>
  ...
  <script type="text/javascript" src="../js/sigesp_spe_rep_problematica_a_enfrentar.js"></script>
...
<table class="contorno" align="center" border="0" cellpadding="0" cellspacing="0" width="762">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="Botonera"><img src="../../../shared/imagebank/tools20/buscar.gif" alt="Buscar" id="BtnCat" border="0" height="20" width="20"><img src="../../../shared/imagebank/tools20/imprimir.gif" alt="Imprimir" id="BtnImp" border="0" height="20" width="20"> <img src="../../../shared/imagebank/tools20/salir.gif" alt="Salir" id="BtnSalir" border="0" height="20" width="20">
      ...
      <tr>
        ...
        <table class="formato-blanco" align="center" border="0" cellpadding="0" cellspacing="0" width="566">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="2" class="titulo-ventana">Problematica a Enfrentar  </td>
            </tr>
            ...
            <tr class="formato-blanco">
              ...
              <td height="22"><select name="" id="plan1" /> <select name="" id="plan2" /> <select name="" id="plan3" /> <select name="" id="plan4" /><select name="" id="plan5" /><input name="codemp" id="codemp" value="0001" type="hidden">
              </td>
            ...
            <tr class="formato-blanco">
              <td height="28">
              <div align="right">Años</div>
              </td>
              <td height="22"><select name="plan1" id="plan1" /> Hasta <select name="plan2" id="plan2" />
			  </td>
            </tr>
