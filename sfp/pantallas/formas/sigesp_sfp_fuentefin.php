...
<head>
	<title id="page-title">SIGESP - Definici&oacute;n de Fuente de Financiamiento</title> >
...
<div id="centro">
<div class="titulo-pantalla">Definici&oacute;n de Fuente de Financiamiento</div>
...
<table width="588" border="0" align="center" cellpadding="0" cellspacing="0">
		      ...
		      <input name="actualizar" type="hidden" id="actualizar">
                  ...
                  <tr class="formato-blanco">
                    ...
                    <td height="22"><input name="txtdenfue" type="text" id="txtden"  value="" size="50" maxlength="100" title="Denominación"></td>
                  </tr>
                  <tr class="formato-blanco">
                    <td height="25"><div align="right">Explicación</div></td>
                    <td rowspan="2"><textarea name="txtexp" cols="50" id="txtexp" title="Explicación"></textarea></td>
                  </tr>
                  <tr class="formato-blanco">
                    <td height="14">&nbsp;</td>
                  </tr>
