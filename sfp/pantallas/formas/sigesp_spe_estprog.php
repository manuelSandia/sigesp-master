...
<head>
    ...
    <title id="page-title">SIGESP - Configuraci&oacute;n del Plan</title> 
...
<script type="text/javascript" src="../js/sigesp_spe_estprog.js"></script>
...
<div id="centro">
<div class="titulo-pantalla">Configuraci&oacute;n del Plan</div>
