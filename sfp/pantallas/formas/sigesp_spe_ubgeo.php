...
<head>
    ...
    <title id="page-title">SIGESP - Definici&oacute;n de Ubicaci&oacute;n Geogr&aacute;fica</title> 
...
<script type="text/javascript" src="../js/sigesp_spe_ubgeo.js"></script>
...
<div id="centro">
<div class="titulo-pantalla">Definici&oacute;n de Ubicaci&oacute;n Geogr&aacute;fica</div>

<div id="tabs7" style='margin-top:70px'>
</div>
<table id='formestprog'>
	<tr>
		<td id='nivel1' class="NombreNivel">
			nombre	
		</td>
		<td id='valornivel1' class="ValorNivel">
		valor
		</td>
	</tr>
	<tr>
		<td id='nivel2' class="NombreNivel">
		
		</td>
		<td id='valornivel2' class="ValorNivel">
		</td>
	</tr>
	<tr>
		<td id='nivel3' class="NombreNivel">
		
		</td>
		<td id='valornivel3' class="ValorNivel">
	
		</td>
	</tr>
	<tr>
		<td id='nivel4' class="NombreNivel">
		</td>
		<td id='valornivel4' class="ValorNivel">
	
		</td>
	</tr>

</table>
<input type="hidden" name='numniveles' id="numniveles" value="3">
...
<div id="grid5" class="x-hide-display"></div>
<div id="grid6" class="x-hide-display"></div>
<div id="grid7" class="x-hide-display"></div>

<div class="adsense" style="margin:4px" id="aqui"/> 
<div id="ImgRestar" ></div>
<div id="ImgSumar" ><div>
