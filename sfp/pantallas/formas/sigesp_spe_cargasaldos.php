...
<head>
    ...
    <title id="page-title">SIGESP - Carga de Saldos Contables</title> 
...
<script type="text/javascript" src="../js/sigesp_spe_cargasaldos.js"></script>
...
<div id="centro">
<!--  <div class="titulo-pantalla">Carga de Saldos Contables</div>-->

	<div id="ContenedorGridCarga">
 
	</div>
</div>
<!--  <div id="sur">
	<div id="ContenedorGridPlanCuentas">	
	</div>
</div>-->
</body> 
