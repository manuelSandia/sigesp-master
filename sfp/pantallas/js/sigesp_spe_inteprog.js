...
//	hasta = gridIntAd.store.getCount()-2;
	...
	{	
		...
		for(i=0;i<arrMetas.length;i++)
		{
			if(i==0)
			{
				reg= reg +"{'cod_var':'"+ arrMetas[i].get('cod_var')+"','enero_masc':'"+arrMetas[i].get('enero_masc')+"','febrero_masc':'"+arrMetas[i].get('febrero_masc')+"','marzo_masc':'"+arrMetas[i].get('marzo_masc')+"','abril_masc':'"+arrMetas[i].get('abril_masc')+"','mayo_masc':'"+arrMetas[i].get('mayo_masc')+"','junio_masc':'"+arrMetas[i].get('junio_masc')+"','julio_masc':'"+arrMetas[i].get('julio_masc')+"','agosto_masc':'"+arrMetas[i].get('agosto_masc')+"','septiembre_masc':'"+arrMetas[i].get('septiembre_masc')+"','octubre_masc':'"+arrMetas[i].get('octubre_masc')+"','noviembre_masc':'"+arrMetas[i].get('noviembre_masc')+"','diciembre_masc':'"+arrMetas[i].get('diciembre_masc')+"','enero_fem':'"+arrMetas[i].get('enero_fem')+"','febrero_fem':'"+arrMetas[i].get('febrero_fem')+"','marzo_fem':'"+arrMetas[i].get('marzo_fem')+"','abril_fem':'"+arrMetas[i].get('abril_fem')+"','mayo_fem':'"+arrMetas[i].get('mayo_fem')+"','junio_fem':'"+arrMetas[i].get('julio_fem')+"','agosto_fem':'"+arrMetas[i].get('agosto_fem')+"','septiembre_fem':'"+arrMetas[i].get('septiembre_fem')+"','octubre_fem':'"+arrMetas[i].get('octubre_fem')+"','noviembre_fem':'"+arrMetas[i].get('noviembre_fem')+"','diciembre_fem':'"+arrMetas[i].get('diciembre_fem')+"'}";
			}
			else
			{
				reg= reg +",{'cod_var':'"+ arrMetas[i].get('cod_var')+"','enero_masc':'"+arrMetas[i].get('enero_masc')+"','febrero_masc':'"+arrMetas[i].get('febrero_masc')+"','marzo_masc':'"+arrMetas[i].get('marzo_masc')+"','abril_masc':'"+arrMetas[i].get('abril_masc')+"','mayo_masc':'"+arrMetas[i].get('mayo_masc')+"','junio_masc':'"+arrMetas[i].get('julio_masc')+"','agosto_masc':'"+arrMetas[i].get('agosto_masc')+"','septiembre_masc':'"+arrMetas[i].get('septiembre_masc')+"','octubre_masc':'"+arrMetas[i].get('octubre_masc')+"','noviembre_masc':'"+arrMetas[i].get('noviembre_masc')+"','diciembre_masc':'"+arrMetas[i].get('diciembre_masc')+"','enero_fem':'"+arrMetas[i].get('enero_fem')+"','febrero_fem':'"+arrMetas[i].get('febrero_fem')+"','marzo_fem':'"+arrMetas[i].get('marzo_fem')+"','abril_fem':'"+arrMetas[i].get('abril_fem')+"','mayo_fem':'"+arrMetas[i].get('mayo_fem')+"','junio_fem':'"+arrMetas[i].get('julio_fem')+"','agosto_fem':'"+arrMetas[i].get('agosto_fem')+"','septiembre_fem':'"+arrMetas[i].get('septiembre_fem')+"','octubre_fem':'"+arrMetas[i].get('octubre_fem')+"','noviembre_fem':'"+arrMetas[i].get('noviembre_fem')+"','diciembre_fem':'"+arrMetas[i].get('diciembre_fem')+"'}";
			}
		}
		reg = reg + "]";
	}
