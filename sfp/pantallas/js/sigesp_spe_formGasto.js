...
function getGridVar()
{
			...
			var DatosNuevo={"raiz":[{"cod_var":'',"meta":'',"unidad":'',"genero":'',"totalmeta":""}]};	
            ...
            ds:DataStoreVar,
            cm: new Ext.grid.ColumnModel([
			{header: "C&#243;digo", width: 35, sortable: true, dataIndex: 'cod_var'},
            {header: "Denominaci&#243;n", width: 350, sortable: true, dataIndex: 'meta'},
			{header: "Total", width: 150, sortable: true, dataIndex: 'totalmeta', align:"right"}
]),
			...
			reader: new Ext.data.JsonReader({
			 ...
			 autoScroll:true,
                        ...
                        cm: new Ext.grid.ColumnModel([
                            ...
                            {header: "Denominación", width: 750, sortable: true, dataIndex: 'denominacion',editor: new Ext.form.TextField({allowBlank: false})},
                            {header: "Monto", width: 150, align: "right", sortable: true, dataIndex: 'montototal',editor: new Ext.form.TextField({allowBlank: false})}
						]),
						selModel: new Ext.grid.RowSelectionModel({singleSelect:false}),
                        viewConfig:{
                        forceFit:true
...
getGridGastos();
		...
		var quitarEstPre = new Ext.Action(
		{
		   ...
		   var expander = new Ext.grid.RowExpander({
			...
			//grid que muestra la estructura presupuestaria
...
function borrarCuentas(btn)
{
	if (btn=='yes') 
	{
		...
		{	
			...
			{
				Ext.MessageBox.alert('Error', 'Ha ocurrido un error en el proceso de eliminacion');				
			}
		  },
				failure: function ( result, request)
				{ 
