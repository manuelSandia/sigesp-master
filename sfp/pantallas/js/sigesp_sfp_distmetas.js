...
//{
	...
	gridUnaVez=true;
		...
		//	var DatosNuevo={"raiz":[{"programatica":'',"spg_cuenta":'',"year":'',"monto":''}]};	
            ...
            cm: new Ext.grid.ColumnModel([
            {header: "Mes", width: 50, sortable: true,   dataIndex: 'mes'},
			{header: "Cantidad", width: 100, sortable: true, dataIndex: 'cantmasculino',editor:new Ext.form.NumberField({allowBlank:false,allowDecimals:false,id:'montomas'})},							
]),
...
selModel: new Ext.grid.RowSelectionModel({singleSelect:false}),
            ...
            AcuMontoTotAux=0;
		  	...
		  	{
		  		Rec = auxGridMetas.getSelectionModel().getSelected();
		  		...
		  		auxGridMetas.store.getAt(12).set('cantmasculino',AcuMontoMasAux);
		  		auxGridMetas.store.getAt(12).set('totalcant',AcuMontoTotAux);
		  		auxGridMetas.getSelectionModel().selectNext();
		  	});
