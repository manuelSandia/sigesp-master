...
function getgrid(numero,ultima)
{
	Tipo=
	[
		['Proyecto','P'],
...
selModel: new Ext.grid.RowSelectionModel({singleSelect:true}),
			...
			stripeRows: true
				...
				if(Ultimo==true)
				{
					grid1.addButton('Integrar Estructura',llamarintegracion);
				}
...
selModel: new Ext.grid.RowSelectionModel({singleSelect:false}),
			...
			stripeRows: true
				...
				if(Ultimo==true)
				{
					grid2.addButton('Integrar Estructura',llamarintegracion);
				}
				grid2.render('grid1');
				break
			case 3:
...
selModel: new Ext.grid.RowSelectionModel({singleSelect:false}),
        ...
        if(Ultimo==true)
		{
			grid3.addButton('Integrar Estructura',llamarintegracion);
		}
		grid3.render('grid2');
		break
		case 4:
...
selModel: new Ext.grid.RowSelectionModel({singleSelect:false}),
     ...
     grid4.on('change', function(Obj)
    {
		...
		if(Ultimo==true)
		{
			grid4.addButton('Integrar Estructura',llamarintegracion);
		}
		grid4.render('grid3');
		break
		case 5:
...
selModel: new Ext.grid.RowSelectionModel({singleSelect:false}),
		...
		if(Ultimo==true)
		{
			grid5.addButton('Integrar Estructura',llamarintegracion);
		}
		grid5.render('grid4');
		break
		}
...
function llamarintegracion()
{
	tabActual = tabs.getActiveTab().id;
	nivel = tabActual+1;
	GridActual = ObtenerGrid(tabActual);
	registro =  GridActual.getSelectionModel().getSelected();
	if(registro)
	{
		if(registro.get('codestpro1')!='')
		{
			valor1 = registro.get('codestpro1'); 
		}	
		if(registro.get('codestpro2')!='')
		{
			valor2 = registro.get('codestpro2'); 
		}
		else
		{
			valor2 = "0000000000000000000000000";
		}
		if(registro.get('codestpro3')!='')
		{
			valor3 = registro.get('codestpro3'); 
		}
		else
		{
			valor3 = "0000000000000000000000000";
		}
		if(registro.get('codestpro4')!='')
		{
			valor4 = registro.get('codestpro4'); 
		}
		else
		{
			valor4 = "0000000000000000000000000";
		}
		if(registro.get('codestpro5')!='')
		{
			valor5 = registro.get('codestpro5'); 
		}
		else
		{
			valor5 = "0000000000000000000000000";
		}
		Abrir_ventana('sigesp_spe_integracion2.php?nivel='+nivel+'&valor1='+valor1+'&valor2='+valor2+'&valor3='+valor3+'&valor4='+valor4+'&valor5='+valor5);
	}		
	else
	{
