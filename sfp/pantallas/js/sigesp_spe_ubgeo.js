...
function getgrid(numero)
{
			...
			reader: new Ext.data.JsonReader({
			 ...
			 autoScroll:true,
                        ...
                        cm: new Ext.grid.ColumnModel([
                            {header: "C&#243;digo", width: 40, sortable: true,dataIndex: 'codubgeo'+numero,editor: new Ext.form.TextField({allowBlank: false,enableKeyEvents:true,listeners: {
	...
	'blur' : function(campo){
			        		var valor = ""; 
			        		valor = ue_rellenarcampo(String.trim(campo.getValue()),4)
		...
		case 6:
			...
			reader: new Ext.data.JsonReader({
			 ...
			 autoScroll:true,
                        ...
                        ds:DataStore5,
                        cm: new Ext.grid.ColumnModel([
                            {header: "C&#243;digo", width: 40, sortable: true,dataIndex: 'codubgeo'+numero,editor: new Ext.form.TextField({allowBlank: false,listeners: {
    'change': function(){
    	if(this.getValue()!='')
    	{
...
Ext.get('BtnGrabar').on('click', function()
{
	...
	{	
		if(i==0)
		{
				...
				reg = reg + "{'codubgeo1':'" + numDatos[i].get('codubgeo1') +"','denominacion':'" + numDatos[i].get('denominacion') +"'}";
	...
	{	
		...
		reg = reg + "{'codubgeo1':'" + valor1 +"','codubgeo2':'" + numDatos[i].get('codubgeo2') +"','coduac':'UU','denominacion':'" + numDatos[i].get('denominacion') +"'}";
		...
		reg = reg + ",{'codubgeo1':'" + valor1 +"','codubgeo2':'" + numDatos[i].get('codubgeo2') +"','estcla_p':'T','coduac':'UU','denominacion':'" + numDatos[i].get('denominacion') +"'}";
	...
	{	
		...
		reg = reg + "{'codubgeo1':'" + valor1 +"','codubgeo2':'" + valor2 +"','codubgeo3':'" + numDatos[i].get('codubgeo3') +"','estcla_p':'T','coduac':'UU','denominacion':'" + numDatos[i].get('denominacion') +"'}";
	...
	{	
		...
		reg = reg + "{'codubgeo1':'" + valor1 +"','codubgeo2':'" + valor2 +"','codubgeo3':'" + valor3 +"','codubgeo4':'" + numDatos[i].get('codubgeo4') +"','estcla_p':'T','coduac':'UU','denominacion':'" + numDatos[i].get('denominacion') +"'}";
	...
	{	
		...
		reg = reg + "{'codubgeo1':'" + valor1 +"','codubgeo2':'" + valor2 +"','codubgeo3':'" + valor3 +"','codubgeo4':'" +valor4 +"','codubgeo5':'" + numDatos[i].get('codubgeo5') +"','estcla_p':'T','coduac':'UU','denominacion':'" + numDatos[i].get('denominacion') +"'}";
	...
	{	
		...
		reg = reg + "{'codubgeo1':'" + valor1 +"','codubgeo2':'" + valor2 +"','codubgeo3':'" + valor3 +"','codubgeo4':'" +valor4 +"','codubgeo5':'" + numDatos[i].get('codubgeo5') +"','CODUBGEO6':'" + numDatos[i].get('CODUBGEO6') +"','denominacion':'" + numDatos[i].get('denominacion') +"'}";
...
Ext.get('BtnElim').on('click',function()
{
	...
	reg = reg + "{'codubgeo1':'" + valor1 +"','denominacion':'888'}";
	...
	reg = reg + "{'codubgeo1':'" + valor1 +"','codubgeo2':'" + valor2 +"','estcla_p':'T','coduac':'UU','denominacion':'888'}";
	reg = reg + "]}";	
	break;
	case 3:
	valor3 = grid3.getSelectionModel().getSelected().get('codubgeo3');
	...
	reg = reg + "{'codubgeo1':'" + valor1 +"','codubgeo2':'" + valor2 +"',,'codubgeo3':'" + valor3 +"','estcla_p':'T','coduac':'UU','denominacion':'888'}";
	reg = reg + "]}";	
	break;
	case 4:
	valor4 = grid4.getSelectionModel().getSelected().get('codubgeo4');
	...
	reg = reg + "{'codubgeo1':'" + valor1 +"','codubgeo2':'" + valor2 +"',,'codubgeo3':'" + valor3 +"','codubgeo4':'" + valor4 +"','estcla_p':'T','coduac':'UU','denominacion':'888'}";
	reg = reg + "]}";	
	break;
	case 5:
	valor5 = grid5.getSelectionModel().getSelected().get('codubgeo5');
	...
	reg = reg + "{'codubgeo1':'" + valor1 +"','codubgeo2':'" + valor2 +"',,'codubgeo3':'" + valor3 +"','codubgeo4':'" + valor4 +"','codubgeo5':'" + valor5 +"','estcla_p':'T','coduac':'UU','denominacion':'888'}";
	reg = reg + "]}";	
	break;
}	
