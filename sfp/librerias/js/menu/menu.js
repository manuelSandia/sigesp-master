...
stm_ai("p1i1",[6,1,"#e6e6e6","",0,0,0]);
//stm_aix("p1i8","p0i0",[0,"Catálogos de Grupos, Subgrupos y Secciones    ","","",-1,-1,0,"sigesp_saf_d_grupo.php","","","","","",0,0,0,"","",0,0,0,0,1,"#ffffff"]);
...
stm_aix("p6i0","p1i2",[0,"Incorporación                ","","",-1,-1,0,"sigesp_saf_r_incorporacion.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p6i0","p1i2",[0,"Desincorporación             ","","",-1,-1,0,"sigesp_saf_r_desincorporacion.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p6i0","p1i2",[0,"Reasignación                 ","","",-1,-1,0,"sigesp_saf_r_reasignacion.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p6i0","p1i2",[0,"Modificación                 ","","",-1,-1,0,"sigesp_saf_r_modificacion.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ai("p1i1",[6,1,"#e6e6e6","",0,0,0]);
stm_aix("p6i0","p1i2",[0,"Depreciación                 ","","",-1,-1,0,"sigesp_saf_r_depreciacion.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p6i0","p1i2",[0,"Depreciacion Mensual         ","","",-1,-1,0,"sigesp_saf_r_depmensual.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ai("p1i1",[6,1,"#e6e6e6","",0,0,0]);
stm_aix("p6i0","p1i2",[0,"Listado Catálogo SIGECOF     ","","",-1,-1,0,"sigesp_saf_r_sigecof.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p6i0","p1i2",[0,"Listado de Activos           ","","",-1,-1,0,"sigesp_saf_r_defactivo.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ai("p1i1",[6,1,"#e6e6e6","",0,0,0]);
stm_aix("p6i0","p1i2",[0,"Comprobante de Incorporación ","","",-1,-1,0,"sigesp_saf_r_compincorporacion.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p6i0","p1i2",[0,"Comprobante de Desincorporación ","","",-1,-1,0,"sigesp_saf_r_compdesincorporacion.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p6i0","p1i2",[0,"Comprobante de Reasignación  ","","",-1,-1,0,"sigesp_saf_r_compreasignacion.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);

/*stm_aix("p1i0","p1i0",[0,"Categoria   CGR ","","",-1,-1,0,"","","","","","",6,0,0,"../shared/imagebank/arrow.gif","../shared/imagebank/arrow.gif",0,0,0,0,1,"#ffffff"]);
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
stm_aix("p6i0","p1i2",[0,"Acta de Donación","","",-1,-1,0,"sigesp_saf_r_incorporacion.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();*/
stm_ep();
