...
(
	function()
	{
		...
		var itentasinf = new  Ext.menu.Item(
		{
		...
		menuconfiguracion.addItem(itentasinf); 
	...
	/*	var itemOrganoE = new  Ext.menu.Item
		...
		var itenprogcompra = new  Ext.menu.Item(
		{
				text: 'Programación de Compras',
           		iconCls: 'blist',  
           		id:'progcomp',
				handler: llamarPantalla
		});
		menuprocesos.addItem(itenprogcompra);
		...
		function llamarPantalla(item)
		{
			switch(item.getId())
			{
				...
				case 'tasinf':
					...
					break;
				case 'progcomp':
					location.href='sigesp_spe_progCompra.php';
					break;		
			}
		}
