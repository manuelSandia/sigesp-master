...
class sigesp_scv_c_transporte
{
	...
	//Se agrego el parametro $as_tartra para actualizar la tarifa del transporte
	function uf_scv_update_transporte($as_codemp,$as_codtra,$as_codtiptra,$as_dentra,$as_tartra,$aa_seguridad) 
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 	$lb_valido=true;
	 	//Se agrego en el update la actualizacion la tarifa del transporte
		$ls_sql = " UPDATE scv_transportes".
				  "    SET   codtiptra='". $as_codtiptra ."', dentra='". $as_dentra ."', tartra='". $as_tartra ."'".
				  "  WHERE codemp='" . $as_codemp ."'".
				  "    AND codtra='" . $as_codtra ."'";
        $this->io_sql->begin_transaction();
		$li_row = $this->io_sql->execute($ls_sql);
