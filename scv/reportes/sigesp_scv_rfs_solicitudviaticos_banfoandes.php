...
/*		unset($la_data);
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		// Fecha Creación: 21/04/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $la_data=array(array('titulo'=>'<b>NOTA:</b> Deben presentar factura originales en un lapso NO MAYOR a 10 DIAS HABILES, los cuales regiran a partir del retorno del viaje. SIN PRORROGA.'));
        $la_columna=array('titulo'=>'');
        $la_config=array('showHeadings'=>0, // Mostrar encabezados
                         'fontSize' => 9, // Tamaño de Letras
                         'showLines'=>1, // Mostrar Líneas
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('elaborado'=>'<b>24. Solicitud Aprobada por:</b>','revisado'=>'<b>25. Procesado por:</b>','autorizado'=>'<b>26. Aprobado por:</b>'),
					   array('elaborado'=>'VICE. P. JEFE DE AREA','revisado'=>'ANALISTA DE RRHH','autorizado'=>'GTE. PROC. NOM. Y BEN.'),
					   array('elaborado'=>'','revisado'=>'','autorizado'=>''),
					   array('elaborado'=>'','revisado'=>'','autorizado'=>''),
					   array('elaborado'=>'','revisado'=>'','autorizado'=>''),
					   array('elaborado'=>'','revisado'=>'','autorizado'=>''),
					   array('elaborado'=>'Sello y Firma','revisado'=>'Sello y Firma','autorizado'=>'Sello y Firma'));
