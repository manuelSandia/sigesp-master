<?php
							  ...
							  $as_codclavia,$ad_fecsalvia,$ad_fecregvia,$ai_numdiavia,$as_denmis,$ai_acompanante,$as_cargo,&$io_pdf)
	{
		...
		$la_data=array(array('dependencia'=>'<b>Dependencia Solicitante:</b> '.$as_desuniadm,'acompanante'=>'<b>Acompañantes:</b> '.$ls_acompanante,'categoria'=>'<b>Categoria:</b> '.$as_codclavia));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('dependencia'=>array('justification'=>'left','width'=>380),
									   ...
									   'categoria'=>array('justification'=>'left','width'=>70))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		unset($la_data);
		unset($la_columna);
		unset($la_config);
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$la_data=array(array('elaborado'=>'<b>Elaborado Por:</b>','revisado'=>'<b>Revisado Por:</b>','autorizado'=>'<b>Autorizado Por:</b>'),
					   ...
					   array('elaborado'=>'','revisado'=>'','autorizado'=>''),
					   array('elaborado'=>'','revisado'=>'                      ','autorizado'=>'                     '),
					   array('elaborado'=>'                              ANALISTA','revisado'=>'     SUB-GCIA DE SERVICIOS GENERALES','autorizado'=>'          GERENTE DE ADMINISTRACIÓN'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>540, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('elaborado'=>array('justification'=>'left','width'=>180), // Justificación y ancho de la columna
						 			   'revisado'=>array('justification'=>'left','width'=>180), // Justificación y ancho de la columna
						 			   'autorizado'=>array('justification'=>'left','width'=>180))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
