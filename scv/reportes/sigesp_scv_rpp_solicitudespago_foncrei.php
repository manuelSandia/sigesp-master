...
//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_codsolvia,$ad_fecsolvia,&$io_encabezado,&$io_pdf)
	{
		...
		$io_pdf->addText(468,727,11,"2. N° DE CONTROL"); // Agregar NRO DE CONTROL
							  ...
							  $as_codclavia,$ad_fecsalvia,$ad_fecregvia,$ai_numdiavia,$as_denmis,$ai_acompanante,$as_cargo,&$io_pdf)
	{
		...
		$la_columna=array('nombre'=>'<b>3. Nombre del Funcionario</b>','cedula'=>'<b>4. Cédula de Identidad N°</b>',
						  'cargo'=>'<b>5. Denominación del Cargo</b>','unidad'=>'<b>6. Ubicación Administrativa</b>','categoria'=>'<b>7. Categoria</b>');
		...
		$la_data=array(array('titulo'=>'<b>8. N° de Cuenta Nómina</b>','corriente'=>$ls_corriente,'titulocorriente'=>'Corriente',
		...
		$la_data=array(array('dependencia'=>'<b>9. Dependencia Solicitante:</b> '.$as_desuniadm));
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('desde'=>'<b>10. Periodo Desde:</b> '.$ad_fecsalvia,'hasta'=>'<b>Periodo Hasta:</b> '.$ad_fecregvia,'dias'=>'<b>11. Total Días:</b> '.$ai_numdiavia));
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('mision'=>'<b>12. Conceptos de la Misión:</b> '.$as_denmis));
	...
	function uf_print_detalle_asignaciones($la_data,$ai_total,$as_totalletras,&$io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('titulo'=>'<b>15.'.$ls_titulo.'</b>              ','total'=>$ai_total));
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('letra'=>'<b>16. Son:</b> '.$as_totalletras));
	...
	function uf_print_detalle_presupuestario($la_data,&$io_pdf)
	{
		...
		unset($la_config);
		$io_pdf->ezSetDy(-2);
		$la_columna=array('ano'=>'<b>17. Año</b>',
   						  'proyecto'=>'<b>18. '.$_SESSION["la_empresa"]["nomestpro1"].'</b>',
						  'especifica'=>'<b>19. '.$_SESSION["la_empresa"]["nomestpro2"].'</b>',
						  'cuenta'=>'<b>20. Partida Presupuestaria</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'rowGap' => 1,
						 'titleFontSize' => 9,  // Tamaño de Letras de los títulos
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		// Fecha Creación: 21/04/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data=array(array('elaborado'=>'<b>21. Elaborado Por:</b>','revisado'=>'<b>22. Revisado Por:</b>','autorizado'=>'<b>23. Autorizado Por:</b>'),
					   ...
					   array('elaborado'=>'ANALISTA','revisado'=>'COORDINADOR DE SERVICIOS GENERALES','autorizado'=>'GERENTE DE  LA OFICINA DE ADMINISTRACIÓN Y SERVICIOS'));
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('nombre'=>'<b>24. Nombre y Apellido:</b>','cedula'=>'<b>25. C.I. No:</b>','firma'=>'<b>26. Firma:</b>','fecha'=>'<b>27. Fecha:</b>'),
