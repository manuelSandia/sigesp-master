<?php
	...
	function uf_print_encabezado_pagina($as_codsolvia,&$io_encabezado,&$io_pdf)
	{
		...
		$io_pdf->addText(62,110,7,"UNIDAD SOLICITANTE"); // Agregar el título
		$io_pdf->addText(215,110,7,"DIRECCIÓN DE GESTIÓN ADMINISTRATIVA"); // Agregar el título
		$io_pdf->addText(440,110,7,"RECIBE CONFORME"); // Agregar el título
		$io_pdf->addText(410,52,7,"NOMBRES, APELLIDOS, FIRMA Y FECHA"); // Agregar el título
		...
		$io_pdf->addText(265,725,12,"<b>VIÁTICOS</b>"); // Agregar NRO DE CONTROL
							  ...
							  $as_telefono,$ai_sueper,$as_denestpro1,$as_denestpro2,$as_desrut,$ai_solviaext,$as_obssolvia,$ls_unidadsol,&$io_pdf)
	{
		...
		$la_columna=array('unidad'=>'<b>Unidad Solicitante</b>','telunidad'=>'<b>Teléfono Oficina / Celular</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('unidad'=>array('justification'=>'center','width'=>270),
						       		   'telunidad'=>array('justification'=>'center','width'=>270))); // Ancho Máximo de la tabla
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'center','width'=>180),
									   ...
									   'cargo'=>array('justification'=>'center','width'=>180))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		...
		$la_data=array(array('titulo'=>'<b>Cuenta Nómina</b>','corriente'=>$ls_corriente,'titulocorriente'=>'<b>Corriente</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'center','width'=>160),
									   ...
									   'cuenta'=>array('justification'=>'left','width'=>180))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('titulo'=>'<b>DATOS DE LA COMISIÓN</b>'));
		...
		$la_columna=array('estpro1'=>'<b>Proyecto / Acción Centralizada</b>','estpro2'=>'<b>Acción Específica N°</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0	, // Sombra entre líneas
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('desde'=>'<b>Tiempo Estimado:        Desde</b> '.$ad_fecsalvia,'hasta'=>'<b>Hasta</b> '.$ad_fecregvia,'dias'=>'<b>Total Días:</b> '.$ai_numdiavia));
		...
		$la_data=array(array('titulo'=>'<b>CÁLCULO</b>'));
		$la_columna=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
		...
		$io_pdf->ezSetDy(-1.08);
		$la_data=array(array('tipvia'=>'Nacional           '.$ls_extno.'                   Exterior           '.$ls_extsi,'pasaje'=>'Aéreo                        Terrestre                    Maritimo'));
		$la_columna=array('tipvia'=>'<b>Tipo de Viático</b>','pasaje'=>'<b>Pasaje</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0	, // Sombra entre líneas
						 ...
						 'cols'=>array('tipvia'=>array('justification'=>'center','width'=>270),
						       		   'pasaje'=>array('justification'=>'center','width'=>270))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		...
		$la_columna=array('pernoc'=>'<b>Pernocta</b>','movil'=>'<b>Movilización</b>','alimentos'=>'<b>Alimentos y Bebidas</b>','otras'=>'<b>Otras Asignaciones</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0	, // Sombra entre líneas
						 ...
						 'cols'=>array('pernoc'=>array('justification'=>'center','width'=>135),
									   ...
									   'alimentos'=>array('justification'=>'center','width'=>135),
						       		   'otras'=>array('justification'=>'center','width'=>135))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
