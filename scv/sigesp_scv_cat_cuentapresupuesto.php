		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					...
					case "DISTANCIA":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptar_distancia('$ls_spg_cuenta','$ls_denominacion');\">".$ls_spg_cuenta."</a></td>";
						print "<td>".$ls_denominacion."</td>";
						print "<td align=center>".$ls_programatica."</td>";
						print "</tr>";			
					break;
...
function aceptar_distancia(spg_cuenta,denominacion)
{
	opener.document.form1.txtspgdis.value=spg_cuenta;
    opener.document.form1.txtdenspgdis.value=denominacion;
	close();
}
