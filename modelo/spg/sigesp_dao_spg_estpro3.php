<?php
/****************************************************************************
* @Modelo para las funciones de estructura presupuestaria 3.
...
class EstPro3 extends ADOdb_Active_Record
{
	var $_table = 'spg_ep3';
	public $valido = true;
	public $mensaje;
...
***********************************************************************************/			
	function incluir()
	{
		...
		$this->mensaje = 'Incluyo la Estructura Presupuestaria '.$this->codestpro1.$this->codestpro2.$this->codestpro3.$this->estcla;
		try 
		{
			$this->save();
		}		
	   	...
	   	{
			$this->valido  = false;				
			$this->mensaje = 'Error al Incluir la Estructura Presupuestaria '.$this->codestpro1.$this->codestpro2.$this->codestpro3.$this->estcla.' '.$conexionbd->ErrorMsg();
		} 
...
/***********************************************************************************
* @Función que Busca uno o todas las estructuras presupuestarias de nivel 3
* @parametros: 
* @retorno:
...
************************************************************************************/		
	public function leer() 
 	{	
 		...
 		try
		{	
			$consulta = " SELECT DISTINCT codestpro1,codestpro2,codestpro3,denestpro3,1 as valido 		".
						" FROM {$this->_table} 															".
