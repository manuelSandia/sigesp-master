			...
			{				
				...
				{ 
					...
					{	
						...
						$this->monto     = round($this->resulttransito->fields['monto'],2);
						...
						$this->monobjret = round($this->resulttransito->fields['monobjret'],2);
						...
						if ($this->fechaconta=='')
						{
							$this->fechaconta = '1900-01-01';
						}
						if ($this->fechaanula=='')
						{
							$this->fechaanula = '1900-01-01';
						}
...
**********************************************************************************/				
	public function calcularSaldoDocumento($conexionbdorigen) 
	{
		...
		if ($this->valido)
		{
			$debitos  = $debitosaux  - $debitos_negativosaux;
	 		$creditos = $creditosaux - $creditosnegativosaux;
