<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_mh.jpg',25,740,500,40); // Agregar Logo
	...
	if($lb_valido)
	{
	 ...
	 else // Imprimimos el reporte
	 {
		...
		while(!$io_report->rs_analitico->EOF)
		{
			...
			if ($li_recortar==1)
			{
				$ls_concepto=substr($io_report->rs_analitico->fields["descripcion"],0,$li_lenconcepto);
			}
			else
			{
