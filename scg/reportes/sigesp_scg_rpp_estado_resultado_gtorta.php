...
else// Imprimimos el reporte
{
	...
	if($lb_valido_egr)
	{
		...
		$ld_total=trim($ld_total_ingresos)-($ld_total_egresos);
		 // Dataset definition 
		 $DataSet = new pData;
		 $DataSet->AddPoint(array($ld_total_ingresos,$ld_total_egresos),"Serie1");
		 $DataSet->AddPoint(array("Ingresos","Egresos"),"titulos");
		 ...
		 $Test->Render("estadoresultadotorta.png");
	}//if
	unset($la_data);
	unset($la_data_egr);
}//else
...
<table width="498" border="0" align="center">
  ...
  <tr>
    <td><div align="center" class="titulo_report"><?php print($ls_titulo." ".$ls_titulo2);?></div></td>
  </tr>
  <tr>
    <td width="320"><img src="estadoresultadotorta.png" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><div align="right">
<a href="javascript:ue_print();"><img src="../../shared/imagebank/tools20/print.gif" width="35" height="30" border="0"/></a></div>	</td>
  </tr>
  <tr>
    <td width="320"></td>
  </tr>
