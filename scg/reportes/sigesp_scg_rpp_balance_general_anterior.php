	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'left','width'=>100), // Justificación y ancho de la columna
						 			   ...
						 			   'saldo4'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'saldo3'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'saldo2'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
	...
	if($lb_valido)
	{
		...
		else// Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_tot;$li_i++)
			{
				...
				$la_data[$li_i]=array('cuenta'=>$as_cuenta,'denominacion'=>$ls_denominacion,'saldo4'=>$ld_saldo4,'saldo3'=>$ld_saldo3,'saldo2'=>$ld_saldo2,'saldo'=>$ld_saldo);
			}//for
