...
//			unset($la_data);
		...
		*/
		...
		if((($lb_valido_ing==false)&&($lb_valido_egr==false))) // Existe algún error ó no hay registros
	    {
	    	/*var_dump($lb_valido_ing);
	    	var_dump($lb_valido_egr);
	    	var_dump($lb_valido);*/
