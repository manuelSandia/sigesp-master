...
function uf_print_encabezado_pagina($as_titulo,$as_fecha,&$io_pdf)
{
	...
	$io_pdf->addText(90,170,7,"<b>ELABORADO POR</b>"); // Agregar el título
    $io_pdf->addText(40,105,7,"<b>Usuario: ".$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]."</b>"); // Agregar el título 
	$io_pdf->addText(390,170,7,"<b>APROBADO POR</b>"); // Agregar el título
    $io_pdf->addText(370,105,7,"<b>Coordinador de Contabilidad</b>"); // Agregar el título
...
if(!$io_report->rs_data->RowCount()) // Existe algún error ó no hay registros
{
	print("<script language=JavaScript>");
