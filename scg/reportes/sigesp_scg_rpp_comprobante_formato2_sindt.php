<?php
	...
	function uf_print_cabecera($as_procede,$as_comprobante,$as_nomprobene,$as_descripcion,$adt_fecha,&$io_pdf)
	{
		...
		$la_data=array(array('name'=>'<b>Comprobante</b>  '.$as_procede.'---'.$as_comprobante.'                '.$adt_fecha.''),
					   ...
					   array('name'=>'<b>Descripción</b>  '.$as_descripcion.''));
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
									   'denominacion'=>array('justification'=>'left','width'=>160), // Justificación y ancho de la columna
						 			   'documento'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la columna
	...
	function uf_print_pie_cabecera($ad_totaldebe,$ad_totalhaber,$as_tipo,&$io_pdf)
	{
		...
		{
			$la_data=array(array('total'=>'<b>Total Comprobante</b>','debe'=>$ad_totaldebe,'haber'=>$ad_totalhaber));
		}
		elseif($as_tipo=="2")//total general
		{
			$la_data=array(array('total'=>'<b>Total</b>','debe'=>$ad_totaldebe,'haber'=>$ad_totalhaber));
		}
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'xPos'=>300, // Orientación de la tabla
				 		 'cols'=>array('total'=>array('justification'=>'right','width'=>360), // Justificación y ancho de la columna
						 			   'debe'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
						 			   'haber'=>array('justification'=>'right','width'=>90))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		/*$la_data=array(array('name'=>''));
	...
	//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
		...
		$ls_titulo=" <b>COMPROBANTES  CONTABLE  FORMATO 2 </b> ";
	//--------------------------------------------------------------------------------------------------------------------------------
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )
	$lb_valido=uf_insert_seguridad("<b>Comprobante Formato 2 en PDF</b>"); // Seguridad de Reporte
	if($lb_valido)
	{
	 ...
	 else // Imprimimos el reporte
	 {
		...
		for($li_i=1;$li_i<=$li_tot;$li_i++)
		{
			...
			uf_print_cabecera($ls_procede,$ls_comprobante,$ls_nomprobene,$ls_descripcion,$ldt_fecha,$io_pdf); // Imprimimos la cabecera del registro
