<?php
	...
	// para crear el libro excel
		...
		$lo_archivo = tempnam("/tmp", "movimientos_mes.xls");
	...
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_scg_reporte_movimientos_mes($ls_cuentadesde,$ls_cuentahasta,$ls_fecha,$ls_fechasta,1,$ls_costodesde,$ls_costohasta);
	}
	//---------------------------------------------------------------------------------------------------------------------------
