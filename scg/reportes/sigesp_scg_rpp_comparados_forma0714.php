<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$tm=505-($li_tm/2);
		$io_pdf->addText($tm,518,12,$ls_titulo1); // Agregar el título
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
		...
		$io_pdf->addText(400,450,10,"<b> VENTA Y/O DESINCORPORACIÓN DE ACTIVOS </b>");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
		...
		$ld_total_reprog_proxima=0;
		$io_pdf->ezSetDy(-50);
		//$io_pdf->addText(400,300,10,"<b> RECUPERACIÓN DE PRÉSTAMOS </b>");
		$io_pdf->addText(400,250,10,"<b> RECUPERACIÓN DE PRÉSTAMOS </b>");
