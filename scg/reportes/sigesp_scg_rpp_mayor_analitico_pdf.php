<?php
	...
	function uf_print_detalle($la_data,&$io_pdf,$li_ocultar)
	{
		...
		else
		{
			$la_config=array('showHeadings'=>1, // Mostrar encabezados
							 ...
							 'cols'=>array('procede'=>array('justification'=>'center','width'=>30), // Justificaci�n y ancho de la columna
										   'comprobante'=>array('justification'=>'center','width'=>55), // Justificaci�n y ancho de la columna
										   'concepto'=>array('justification'=>'left','width'=>70), 
										'numcarord'=>array('justification'=>'left','width'=>70), // Justificaci�n y ancho de la columna
										   'nombre'=>array('justification'=>'left','width'=>70), // Justificaci�n y ancho de la columna
										   'documento'=>array('justification'=>'center','width'=>55), // Justificaci�n y ancho de la columna
										   'fecha'=>array('justification'=>'center','width'=>35), // Justificaci�n y ancho de la columna
										   'debe'=>array('justification'=>'right','width'=>60), // Justificaci�n y ancho de la columna
										   'haber'=>array('justification'=>'right','width'=>60), // Justificaci�n y ancho de la columna
										   'saldo'=>array('justification'=>'right','width'=>60))); // Justificaci�n y ancho de la columna

			$la_columnas=array('procede'=>'<b>Procede</b>',
							   'comprobante'=>'<b>Comprobante</b>',
							   'concepto'=>'<b>Concepto</b>',
			                   'numcarord'=>'<b>Carta Orden</b>'   , 
							   'nombre'=>'<b>Beneficiario</b>',
							   'documento'=>'<b>Documento</b>',
							   'fecha'=>'<b>Fecha</b>',
							   'debe'=>'<b>Debe</b>',
  ...
  //  die();
	 ...
	 else // Imprimimos el reporte
	 {
		...
		/*print_r($io_report->rs_analitico);
		die();*/
		$ld_totaldebe=0;
		$ld_totalhaber=0;
		$ld_totalsaldo=0;
		...
		while(!$io_report->rs_analitico->EOF)
		{
			...
			if(!empty($ls_comprobante))
			{
			 $la_data[$i]=array('procede'=>$ls_procede,'comprobante'=>$ls_comprobante,'concepto'=>$ls_concepto,
							    ...
							    'haber'=>$ldec_monhab,'saldo'=>$ld_saldo_final,'numcarord'=>$ls_numcarord);
			 $i++;
			}
