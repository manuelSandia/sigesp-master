...
function uf_insert_seguridad($as_titulo)
{
	...
	$lb_valido=$io_fun_scg->uf_load_seguridad_reporte("SCG","sigesp_scg_r_balance_general_formatoresumen.php",$ls_descripcion);
	return $lb_valido;
}
//-----------------------------------------------------------------------------------------------------------------------------------
...
function uf_print_detalle_cueproacu($la_data,&$io_pdf)
{
	...
	//'width'=>520, // Ancho de la tabla
						 ...
						 'xOrientation'=>'center', // Orientaciï¿½n de la tabla
						 'cols'=>array('cuenta'=>array('justification'=>'left','width'=>10), // Justificaciï¿½n y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>195), // Justificaciï¿½n y ancho de la columna
										'saldo_n8'=>array('justification'=>'right','width'=>1), // Justificaciï¿½n y ancho de la columna
										'saldo_n7'=>array('justification'=>'right','width'=>1), // Justificaciï¿½n y ancho de la columna
										'saldo_n6'=>array('justification'=>'right','width'=>50), // Justificaciï¿½n y ancho de la columna
										'saldo_n5'=>array('justification'=>'right','width'=>1), // Justificaciï¿½n y ancho de la columna
										'saldo_n4'=>array('justification'=>'right','width'=>1), // Justificaciï¿½n y ancho de la columna
									   'saldo_n3'=>array('justification'=>'right','width'=>50), // Justificaciï¿½n y ancho de la columna
						 				'saldo_cueproacu'=>array('justification'=>'right','width'=>50), // Justificaciï¿½n y ancho de la columna
									   'saldo'=>array('justification'=>'right','width'=>50))); // Justificaciï¿½n y ancho de la columna
	$la_columnas=array('cuenta'=>'<b>Cuenta</b>',
						   'denominacion'=>'<b>Denominación</b>',
						   'saldo_n8'=>'',
						   'saldo_n7'=>'',
...
$lb_valido=uf_insert_seguridad("<b>Balance General Resumen en PDF</b>"); // Seguridad de Reporte
if($lb_valido)
{
	$lb_valido=$io_report->uf_balance_general_formatoresumen($ldt_fechas,$li_nivel);
}
	...
	for($li_i=1;$li_i<=$li_tot;$li_i++)
	{
		...
		switch($ls_nivel)
		{
			case 7:
				// if($ls_estatus == 'C')
				//	{
				$la_data[$cont]=array('cuenta'=>'','denominacion'=>'            <i>'.$ls_denominacion.'</i>','saldo_n8'=>'','saldo_n7'=>'','saldo_n6'=>'<i>'.$ld_saldo.'</i>','saldo_n5'=>'','saldo_n4'=>'','saldo_n3'=>'','saldo_cueproacu'=>'','saldo'=>'');
				/*	}
				 else
				 {
			...
			case 6:
				// if($ls_estatus == 'C')
				//	{
				$la_data[$cont]=array('cuenta'=>'','denominacion'=>'            '.$ls_denominacion.'','saldo_n8'=>'','saldo_n7'=>'','saldo_n6'=>'<b>'.$ld_saldo6.'</b>','saldo_n5'=>'','saldo_n4'=>'','saldo_n3'=>'','saldo_cueproacu'=>'','saldo'=>'');
				$cont6=$cont6+1;
				/*	}
				 else
				 {
			...
			case 3:
				//  if($ls_estatus == 'C')
				//{
				$la_data[$cont]=array('cuenta'=>'<b>'.''.'</b>','denominacion'=>'<b>   '.$ls_denominacion.'</b>','saldo_n8'=>'','saldo_n7'=>'','saldo_n6'=>'','saldo_n5'=>'','saldo_n4'=>'','saldo_n3'=>'<b>'.$ld_saldo3.'</b>','saldo_cueproacu'=>'','saldo'=>'');
				$cont3=$cont3+1;
				/*}
				 else
				 {
			...
			case 2:
				...
				//if($ls_estatus == 'C')
				//{
				$la_data[$cont]=array('cuenta'=>'<b><i></b></i>','denominacion'=>'<b><u><i>'.$ls_denominacion.'</i></u></b>','saldo_n8'=>'','saldo_n7'=>'','saldo_n6'=>'','saldo_n5'=>'','saldo_n4'=>'','saldo_n3'=>'','saldo_cueproacu'=>'<b><i>'.$ld_saldo2.'</b></i>','saldo'=>'<b><i></b></i>');
				$cont2=$cont2+1;
				/*}
				 else
				 {
			...
			case 1:
				if ($cont>1)
				{
					...
					//	if($ls_estatus == 'C')
					//{
					$la_data[$cont]=array('cuenta'=>'<b><i></b></i>','denominacion'=>'<b><i>'.$ls_denominacion.'</b></i>','saldo_n8'=>'','saldo_n7'=>'','saldo_n6'=>'','saldo_n5'=>'','saldo_n4'=>'','saldo_n3'=>'','saldo_cueproacu'=>'<b><i></b></i>','saldo'=>'<b><i>'.$ld_saldo1.'</b></i>');
					$cont1=$cont1+1;
					/*	}
					 else
					 {
