<?php
	...
	$ls_reporte=$io_fun_scg->uf_select_config("SCG","REPORTE","MAYOR_ANALITICO","sigesp_scg_rpp_mayor_analitico_pdf.php","C");
	$ls_reporteexcel=$io_fun_scg->uf_select_config("SCG","REPORTE","MAYOR_ANALITICO_EXCEL","sigesp_scg_rpp_mayor_analitico_excel.php","C");
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
$li_diasem = date('w');
switch ($li_diasem){
...
?>
  <table width="535" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr style="display:none">
      ...
      <td width="416" height="13" align="center"><div align="left">
        <select name="cmbbsf" id="cmbbsf">
          <option value="0" selected>Bs.</option>
          <option value="1">Bs.F.</option>
        </select>
      </div></td>
      <td width="13" height="13" align="center">&nbsp;</td>
      <td width="14" height="13" align="center">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="22" align="left"><div align="right">Ordenar </div>
        <div align="left"></div></td>
      <td align="left"><div align="left">
        <select name="orden">
          <option value="scg_dt_cmp.comprobante">Comprobante</option>
          <option value="scg_dt_cmp.fecha">Fecha</option>
          <option value="scg_dt_cmp.sc_cuenta">Cuenta</option>
          <option value="scg_dt_cmp.procede">Procede</option>
          <option value="scg_dt_cmp.monto">Monto</option>
          <option value="scg_dt_cmp.debhab">Debe - Haber</option>
          <option value="nompro">Proveedor</option>
          <option value="nombene">Beneficiario</option>         
        </select>
      </div></td>
      <td align="center">&nbsp;</td>
      <td align="center">&nbsp;</td>
    ...
    <tr>
      <td height="22" align="right">Reporte</td>
      <td align="left"><label>
        <select name="cmb_reporte" id="cmb_reporte">
          <option value="mayor">Mayor Anal&iacute;tico</option>
    ...
    <tr>
      ...
      Ocultar campo Detalle de los  Comprobantes</td><br>

    </tr>
<tr>
      <td height="22" colspan="4" align="left"><div align="center">
          <input name="chkcolor" type="checkbox" class="sin-borde"  id="chkcolor" value="1" checked>
      Color Reporte</div></td><br>

    </tr>

    <tr>
      <td height="22" colspan="4" align="center">
      	<input name="chkrecortar" type="checkbox" id="chkrecortar" > Mostrar <input name="txtlencad" type="text" size=4 value=50 id="txtlencad">  caracteres en el concepto
...
function ue_search()
{
	...
	if(li_imprimir==1)
	{
		if(f.cmb_reporte.value == 'resumen')
		{
			...
			pagina="reportes/sigesp_scg_rpp_resumen_mensual.php?sc_cuenta="+sc_cuenta;
...
function ue_openexcel()
{
	...
	if(li_imprimir==1)
	{
		...
		else
		{
			...
			pagina="reportes/"+formato+"?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&orden="+ls_orden;
