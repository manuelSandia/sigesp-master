<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","sigesp_scg_r_comparados_balance_general_ins08.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<title>Reporte Balance General - Instructivo 08</title>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.gif" width="20" height="20" border="0" alt="Imprimir" title="Imprimir"></a><a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.jpg" alt="Excel" width="20" height="20" border="0" title="Excel"></a><a href="sigespwindow_blank.php"><img src="../shared/imagebank/tools20/salir.gif" alt="Salir" title="Salir" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/ayuda.gif" alt="Ayuda" title="Ayuda" width="20" height="20"></td>
  </tr>
</table>
  <?php
...
?>		  
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Comparado Balance General </td>
    </tr>
  </table>
        ...
        <table width="550" height="84" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="73"><div align="right">
                <input name="botbimensual" type="button" class="boton" id="botbimensual" value="Bimestral" onClick="uf_cargar_combo('BIMESTRAL')">
            </div></td>
            <td width="63">
              <div align="left">
	...
	{	
		...
		if(txtetiqueta=="Mensual")
		{
			...
			else
			{
				...
				{
				   pagina="reportes/sigesp_scg_rpp_comparado_bal_general_ins08.php?combo="+combo
		...
		else
		{
			...
			{
			   pagina="reportes/sigesp_scg_rpp_comparado_bal_general_ins08.php?combo="+combo+"&txtetiqueta="+txtetiqueta+"&tiporeporte="+tiporeporte;
			   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
   	}
	...
	{	
		...
		if(txtetiqueta=="Mensual")
		{
			...
			else
			{
				...
				{
				   pagina="reportes/sigesp_scg_rpp_comparado_bal_general_ins08_excel.php?combo="+combo
						   +"&combomes="+combomes+"&txtetiqueta="+txtetiqueta+"&tiporeporte="+tiporeporte;
				   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
				}
			}	
		...
		else
		{
			...
			if(combo=="s1")
			{
			  alert("Por favor seleccione todos los parametros de busqueda");
			}
			else
			{
			   pagina="reportes/sigesp_scg_rpp_comparado_bal_general_ins08_excel.php?combo="+combo+"&txtetiqueta="+txtetiqueta+"&tiporeporte="+tiporeporte;
			   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
   	}
