...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td height="20" width="25" class="toolbar"><div align="center"><a href="javascript:ue_search('<?php echo $ls_reporte ?>','<?php echo $_SESSION["la_empresa"]["ciesem1"]?>','<?php echo $_SESSION["la_empresa"]["estcencos"] ?>');"><img src="../shared/imagebank/tools20/imprimir.gif" alt="Imprimir" title="Imprimir" width="20" height="20" border="0"></a></div></td>
    <td class="toolbar" width="25"><div align="center"><a href="javascript:ue_openexcel('<?php echo $_SESSION["la_empresa"]["estcencos"] ?>');"><img src="../shared/imagebank/tools20/excel.jpg" alt="Excel" title="Excel" width="20" height="20" border="0"></a></div></td>
...
?>
  <table width="535" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="4" align="center"><table width="520" border="0" cellspacing="0" class="formato-blanco">
        <tr class="pie-pagina">
          <td colspan="4"><div align="center" class="titulo-celdanew"><strong>Centros de Costos</strong></div></td>
          </tr>
        <tr>
          <td width="84" height="22"><div align="right">Desde</div></td>
          <td width="170"><div align="left">
    ...
    <tr>
      ...
      <td width="150" align="center"><div align="right"><input type="checkbox" name="chksaldocero" id="chksaldocero" value="0"   /> Ocultar Saldos Cero </div></td>
	<td height="40" align="center"><div align="right"><input type="checkbox" name="chksaldomes" id="chksaldomes" value="0"   /> Mostrar Saldo del Mes </div></td>
...
<script language="JavaScript">
function ue_search(as_reporte,as_ciesem,as_estcencos)
{
	f=document.form1;
			...
			if(valido){
				if ((ls_cuentadesde=="")&&(ls_cuentahasta==""))
				{
					...
					pagina=pagina+"&cuentadesde="+ls_cuentadesde+"&cuentahasta="+ls_cuentahasta+"&nivel="+li_nivel+
					      "&tiporeporte="+tiporeporte+"&saldomes="+li_saldomes+"&saldocero="+li_saldocero+
...
function ue_openexcel(as_estcencos)
{
	f=document.form1;
	li_imprimir=f.imprimir.value;
	if(li_imprimir==1)
	{
		...
		else
		{
			if(ue_comparar_fechas(ld_fecdesde,ld_fechasta))
			{
				...
				pagina=pagina+"&cuentadesde="+ls_cuentadesde+"&cuentahasta="+ls_cuentahasta+"&nivel="+li_nivel+
				       "&tiporeporte="+tiporeporte+"&saldomes="+li_saldomes+"&saldocero="+li_saldocero+"&costodesde="+ls_costodesde+"&costohasta="+ls_costohasta;
				window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
			else
			{
