<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","sigesp_scg_r_balance_general_formatoresumen.php",$ls_permisos,$la_seguridad,$la_permisos);
	$ls_reporte = $io_fun_scg->uf_select_config("SCG","REPORTE","BALANCE_GENERAL RESUMEN","sigesp_scg_rpp_balance_general_formatoresumen.php","C");
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
            ...
            <td height="22" colspan="2"><div align="left">
			  ...
			  <?php 
				...
				for($i=1;$i<=$li_totniv;$i++){
			   			echo '<option value="7">Resumen</option>';
			  	}
			  	unset($io_fun_scg);
			  ?>
			  </select>
