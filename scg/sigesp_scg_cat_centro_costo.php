			   ...
			   while(!$rs_data->EOF)
				    {
				      ...
				      echo "<td style=text-align:center width=120><a href=\"javascript: aceptar('$ls_codcencos');\">".$ls_codcencos."</a></td>";
...
<script language="JavaScript">
  ...
  function aceptar(ls_codcosto)
  {
    opener.document.form1.<? print $ls_obj ?>.value=ls_codcosto;
  ...
  function ue_search()
  {
	  ...
	  f.action="sigesp_scg_cat_centro_costo.php";
	  f.submit();
  }
</script>
</html>