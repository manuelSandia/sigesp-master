...
class class_funciones_scg
{
   ...
   //----------------------------------------------------------------------------------------------------------------------------
	...
	function uf_obtener_niveles()
	{
	 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	     Function: uf_obtener_niveles
	 //		   Access: private
	 //     Arguments: ai_niveles // Número de Niveles del Formato Contable
	 //	      Returns: lb_valido True si se ejecuto el insert ó False si hubo error en el insert
	 //	  Description: Funcion que retorna el número de niveles que posee el formato de la cuenta
	 //	   Creado Por: Ing. Arnaldo Suárez
	 // Fecha Creación: 09/07/2010							Fecha Última Modificación : 
	 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 $li_niveles = 0;
	 $la_formato = explode("-",$_SESSION["la_empresa"]["formcont"]);
	 $li_niveles = count($la_formato);
	 if($li_niveles == 0)
	 {
	   $li_niveles = 10;
	 }
