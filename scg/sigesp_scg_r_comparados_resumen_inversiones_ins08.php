<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","sigesp_scg_r_comparados_resumen_inversiones_ins08.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<title>Reporte Resumen de Inversiones - Instructivo 08</title>
...
?>		  
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">RESUMEN DE INVERSIONES</td>
    </tr>
  </table>
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr style="display:none">
      ...
      <td width="400" height="17" align="center"><div align="left">
        <select name="cmbbsf" id="cmbbsf">
          <option value="0" selected>Bs.</option>
          <option value="1">Bs.F.</option>
        </select>
      </div></td>
      <td width="72" height="17" align="center">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" align="center"><div align="right"><a href="javascript: ue_showouput();"><span class="Estilo1">
	<?php  if($ls_operacion=="")
	{
		?>
	...
	{	
		...
		if(txtetiqueta=="Mensual")
		{
			...
			else
			{
				...
				{
				   pagina="reportes/sigesp_scg_rpp_comparados_resumen_inversiones_ins08.php?combo="+combo
		...
		else
		{
			...
			{
			   pagina="reportes/sigesp_scg_rpp_comparados_resumen_inversiones_ins08.php?combo="+combo+"&txtetiqueta="+txtetiqueta+"&tiporeporte="+tiporeporte;
			   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
   	}
	...
	{	
		...
		if(txtetiqueta=="Mensual")
		{
			...
			else
			{
				...
				{
				   pagina="reportes/sigesp_scg_rpp_comparados_resumen_inversiones_ins08_excel.php?combo="+combo
						   +"&combomes="+combomes+"&txtetiqueta="+txtetiqueta+"&tiporeporte="+tiporeporte;
				   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
				}
			}	
		...
		else
		{
			...
			{
			   pagina="reportes/sigesp_scg_rpp_comparados_resumen_inversiones_ins08_excel.php?combo="+combo+"&txtetiqueta="+txtetiqueta+"&tiporeporte="+tiporeporte;
			   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
   	}
