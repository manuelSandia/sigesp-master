<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","sigesp_scg_r_situacionfinanciera.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<table width="450" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td height="24" colspan="3" align="center" class="titulo-ventana">Situacion Financira </td>
    </tr>
    <tr>
...
function ue_search()
{
	...
	if(li_imprimir==1){	
		...
		pagina="reportes/sigesp_scg_rpp_situacionfinanciera.php?cmbmes="+cmbmes+"&cmbagno="+cmbagno;
