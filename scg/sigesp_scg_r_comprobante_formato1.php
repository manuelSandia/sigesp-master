      ...
      <td colspan="3" align="center">
        <table width="480" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
		  ...
		  <tr>
           ...
           <tr>
            <td height="22">&nbsp;</td>
            <td colspan="6"><input name="chkorderdocumento" type="checkbox" class="sin-borde" id="chkorderdocumento"> 
            Ordenar movimientos por documento.</td>
          </tr>
          <tr>
            <td height="22">&nbsp;</td>
            <td colspan="3">&nbsp;</td>
...
function ue_search()
{
	...
	{	
		...
		if(f.chkorderdocumento.checked){
		...
		if (f.chkmostrar_res.checked)
		{
			pagina="reportes/sigesp_scg_rpp_resumen_comprobantes.php?txtcompdes="+txtcompdes
					...
					+"&txtfecdes="+txtfecdes+"&rborden="+orden+"&txtfechas="+txtfechas+"&tiporeporte="+tiporeporte+"&orderdocumento="+li_chkorderdocumento;
		}
