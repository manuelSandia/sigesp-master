...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td height="20" width="20" class="toolbar"><div align="center"><a href="javascript:ue_imprimir('<? print $ls_codemp; ?>','<?php echo $ls_reporte ?>','<?php echo $_SESSION["la_empresa"]["estcencos"] ?>');"><img src="../shared/imagebank/tools20/imprimir.gif" alt="Imprimir" title="Imprimir" width="20" height="20" border="0"></a></div></td>
    <td class="toolbar" width="20"><div align="center"><a href="javascript:ue_openexcel('<? print $ls_codemp; ?>','<?php echo $_SESSION["la_empresa"]["estcencos"] ?>');"><img src="../shared/imagebank/tools20/excel.jpg" alt="Excel" title="Excel" width="20" height="20" border="0"></a></div></td>
...
?>		  
  ...
  <table width="530" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td height="122" colspan="3" align="center"><div align="left"></div>        <div align="left"></div>        <div align="left" class="style14"></div>        <div align="left">
        <table width="480" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <?php 
    	if($_SESSION["la_empresa"]["estcencos"]=='1'){
    ?>
    <tr class="titulo-celdanew">
            <td height="13" colspan="7">Centro de Costos </td>
            </tr>
    <tr>
    	<td height="22">&nbsp;</td>
            <td height="22"><div align="right">Desde</div></td>
            <td height="22" colspan="2"><div align="left">
            <input name="txtcostodesde" type="text" id="txtcostodesde"  size="10" style="text-align:center" readonly>
            <a href="javascript:cat_cos_desde()"><img src="../shared/imagebank/tools15/buscar.gif" alt="Catalogo Cuentas" width="15" height="15" border="0"></a>
          </div></td>
            <td height="22">Hasta</td>
            <td height="22"><div align="left">
            <input name="txtcostohasta" type="text" id="txtcostohasta" size="10" style="text-align:center" readonly>
            <a href="javascript:cat_cos_hasta()"><img src="../shared/imagebank/tools15/buscar.gif" alt="Catalogo Cuentas" width="15" height="15" border="0"></a></div></td>
            <td height="22">&nbsp;</td>
    ...
    <tr>
      <td height="22" colspan="3" align="center"><table width="480" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="21" class="titulo-celdanew">Graficos</td>
        </tr>
        <tr>
          <td><div align="center">
            <input name="rdgrafico" type="radio" class="sin-borde" value="radiobutton" checked>
Torta
<input name="rdgrafico" type="radio" class="sin-borde" value="radiobutton">
Barras</div></td>
        </tr>
      </table></td>
    </tr>
...
function ue_imprimir(codemp,as_reporte,as_estcencos)
{
	f=document.form1;
	...
	{	
		...
		valido       = true;
		if(as_estcencos=='1'){
			ls_costodesde  = f.txtcostodesde.value;
			ls_costohasta  = f.txtcostohasta.value;
		}
		else{
			ls_costodesde  = '';
			ls_costohasta  = '';
		...
		if(valido){
			if(hidbot==1)
			{
				...
				else
				{
					pagina="reportes/"+as_reporte+"?hidcodemp="+codemp+"&cmbmesdes="+cmbmesdes
							...
							+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte+"&precierre="+li_precierre+"&costodesde="+ls_costodesde+"&costohasta="+ls_costohasta;
	        ...
	        if(hidbot==3)
			{
	        	...
	        	if(f.rbtrimestre[0].checked){
	        		pagina="reportes/"+as_reporte+"?hidcodemp="+codemp+"&cmbmesdes=01&cmbmeshas=03&cmbagnodes="+cmbagno
					+"&cmbagnohas="+cmbagno+"&cmbnivel="+cmbnivel
					+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte+"&precierre="+li_precierre
					+"&costodesde="+ls_costodesde+"&costohasta="+ls_costohasta;
					window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	        	}

	        	if(f.rbtrimestre[1].checked){
	        		pagina="reportes/"+as_reporte+"?hidcodemp="+codemp+"&cmbmesdes=04&cmbmeshas=06&cmbagnodes="+cmbagno
					+"&cmbagnohas="+cmbagno+"&cmbnivel="+cmbnivel
					+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte+"&precierre="+li_precierre
					+"&costodesde="+ls_costodesde+"&costohasta="+ls_costohasta;
					window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	        	...
	        	if(f.rbtrimestre[2].checked){
	        		pagina="reportes/"+as_reporte+"?hidcodemp="+codemp+"&cmbmesdes=07&cmbmeshas=09&cmbagnodes="+cmbagno
					+"&cmbagnohas="+cmbagno+"&cmbnivel="+cmbnivel
					+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte+"&precierre="+li_precierre
					+"&costodesde="+ls_costodesde+"&costohasta="+ls_costohasta;
					window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	        	...
	        	if(f.rbtrimestre[3].checked){
	        		pagina="reportes/"+as_reporte+"?hidcodemp="+codemp+"&cmbmesdes=10&cmbmeshas=12&cmbagnodes="+cmbagno
					+"&cmbagnohas="+cmbagno+"&cmbnivel="+cmbnivel
					+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte+"&precierre="+li_precierre
					+"&costodesde="+ls_costodesde+"&costohasta="+ls_costohasta;
					window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
...
function ue_graficos(codemp)
{
	f=document.form1;
	li_imprimir=f.imprimir.value;
	if(f.rdgrafico[0].checked){
	as_reporte="sigesp_scg_rpp_estado_resultado_gtorta.php";}
	else{
	as_reporte="sigesp_scg_rpp_estado_resultado_gbarra.php";}
	if(li_imprimir==1)
	{	
		hidbot       = f.hidbot.value;
		cmbnivel     = f.cmbnivel.value;
		...
		if (f.chkprecierre.checked)
		{
			li_precierre = 1;
			if(as_ciesem==0){
				alert("Usted debe ejecutar el proceso de cierre semestral");
				valido = false;
			}
		}
			...
			if(hidbot==1)
			{
				...
				else
				{
					pagina="reportes/"+as_reporte+"?hidcodemp="+codemp+"&cmbmesdes="+cmbmesdes
							+"&cmbmeshas="+cmbmeshas+"&cmbagnodes="+cmbagnodes+"&cmbagnohas="+cmbagnohas+"&cmbnivel="+cmbnivel
							+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte+"&precierre="+li_precierre;
					window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=no,width=800,height=600,resizable=no,location=no");
				}
			}
			if(hidbot==2)
			{
				...
				{
					pagina="reportes/"+as_reporte+"?hidcodemp="+codemp+"&txtfecdes="+txtfecdes
							+"&txtfechas="+txtfechas+"&cmbnivel="+cmbnivel+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte+"&precierre="+li_precierre;
					window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=no,width=800,height=600,resizable=no,location=no");
				}
			}
	        if(hidbot==3)
...
function ue_openexcel(codemp,as_estcencos)
{
	f=document.form1;
	li_imprimir=f.imprimir.value;
	if(li_imprimir==1)
	{	
		...
		if(valido)
		{
	        ...
	        if(hidbot==3)
			{
	        	cmbagno = f.cmbagno.value;
	        	if(f.rbtrimestre[0].checked){
	        		pagina="reportes/sigesp_scg_rpp_estado_resultado_excel.php?hidcodemp="+codemp+"&cmbmesdes=01&cmbmeshas=03&cmbagnodes="+cmbagno
					+"&cmbagnohas="+cmbagno+"&cmbnivel="+cmbnivel
					+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte+"&precierre="+li_precierre
					+"&costodesde="+ls_costodesde+"&costohasta="+ls_costohasta;
					window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	        	...
	        	if(f.rbtrimestre[1].checked){
	        		pagina="reportes/sigesp_scg_rpp_estado_resultado_excel.php?hidcodemp="+codemp+"&cmbmesdes=04&cmbmeshas=06&cmbagnodes="+cmbagno
					+"&cmbagnohas="+cmbagno+"&cmbnivel="+cmbnivel
					+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte+"&precierre="+li_precierre
					+"&costodesde="+ls_costodesde+"&costohasta="+ls_costohasta;
					window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	        	...
	        	if(f.rbtrimestre[2].checked){
	        		pagina="reportes/sigesp_scg_rpp_estado_resultado_excel.php?hidcodemp="+codemp+"&cmbmesdes=07&cmbmeshas=09&cmbagnodes="+cmbagno
					+"&cmbagnohas="+cmbagno+"&cmbnivel="+cmbnivel
					+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte+"&precierre="+li_precierre
					+"&costodesde="+ls_costodesde+"&costohasta="+ls_costohasta;
					window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	        	...
	        	if(f.rbtrimestre[3].checked){
	        		pagina="reportes/sigesp_scg_rpp_estado_resultado_excel.php?hidcodemp="+codemp+"&cmbmesdes=10&cmbmeshas=12&cmbagnodes="+cmbagno
					+"&cmbagnohas="+cmbagno+"&cmbnivel="+cmbnivel
					+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte+"&precierre="+li_precierre
					+"&costodesde="+ls_costodesde+"&costohasta="+ls_costohasta;
					window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
...
function cat_cos_desde()
{
	f=document.form1;
	window.open("sigesp_scg_cat_centro_costo.php?obj=txtcostodesde","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}

function cat_cos_hasta()
{
	f=document.form1;
	window.open("sigesp_scg_cat_centro_costo.php?obj=txtcostohasta","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}
</script>
