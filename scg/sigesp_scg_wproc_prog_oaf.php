...
if(!array_key_exists("la_logusr",$_SESSION))
{
	...
	$ls_sistema="SCG";
	$ls_ventanas="sigesp_scg_wproc_prog_oaf.php";
...
?>
        <table width="644" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-ventana">
            <td colspan="5" ><div align="center" >Programaci&oacute;n de Origen y Aplicacion de Fondos </div></td>
          </tr>
          <tr class="contorno">
            <td colspan="5"></td>
          </tr>
        ...
        Ninguno</td>
            ...
            <td width="209" class="Estilo3"><span class="Estilo1"> </span> <span class="Estilo1">
              <input name="botDistribuir" type="button" class="boton" id="botDistribuir" onClick="ue_distribuir()" value="Totalizar">
          ...
          <tr>
            ...
            <td class="fd-blanco">
              <div align="left"> <span class="cd-titulo">
            ...
            <td colspan="2" class="fd-blanco">
              <div align="left">
                <input name="txtCuenta" type="text" id="txtCuenta2" value="<?php print $ls_cuenta ?>" readonly>
            </div></td>
          </tr>
          <tr class="formato-blanco">
            <td class="fd-blanco Estilo1"><input name="operacion" type="hidden" id="operacion2" value="<?php $_POST["operacion"]?>"></td>
            <td class="fd-blanco Estilo1">&nbsp;</td>
            <td class="fd-blanco Estilo1">&nbsp;</td>
            <td colspan="2" class="fd-blanco Estilo1">&nbsp;</td>
          </tr>
  ...
  <tr class="fd-blanco">    
  <tr class="fd-blanco">
        <input name="fila" type="hidden" id="fila3">
        <input name="numrow" type="hidden" id="numrow3">
        <input name="status" type="hidden" id="status3">
  <tr class="fd-blanco">
  <table width="1200"  border="0" align="left" cellpadding="1" cellspacing="1" class="fondo-tabla">
        <tr class="titulo-ventana">
          <td width="96"><div align="center">Cuenta</div></td>
          <td width="147">Denominacion</td>
          <td width="64"><div align="center">Asignado</div></td>
          <td width="72"><div align="center">Enero</div></td>
          <td width="64"><div align="center">Febrero</div></td>
          <td width="55"><div align="center">Marzo</div></td>
          <td width="54"><div align="center">Abril</div></td>
          <td width="64"><div align="center">Mayo</div></td>
          <td width="54"><div align="center">Junio</div></td>
          <td width="46"><div align="center">Julio</div></td>
          <td width="65"><div align="center">Agosto</div></td>
          <td width="96"><div align="center">Septiembre</div></td>
          <td width="88"><div align="center">Octubre</div></td>
          <td width="89"><div align="center">Noviembre</div></td>
          <td width="109"><div align="center">Diciembre</div></td>
        </tr>
        <?php		
if($ls_operacion=="")
{
    ...
    $li_rtn=0 ;
    $lb_valido=true;
    $ls_cod_report="0719"; // OAF Instr 4
    ...
    $ls_cod_report=$_SESSION["cod_report"];
      ...
      <tr class="celdas-amarillas">
          ...
          <?php
								 ...
								 print"<td>".number_format($ds_proaf->getValue("enero",$i),2,",",".")."</td>";
								 print"<td>".number_format($ds_proaf->getValue("febrero",$i),2,",",".")."</td>";
								 print"<td>".number_format($ds_proaf->getValue("marzo",$i),2,",",".")."</td>";
								 print"<td>".number_format($ds_proaf->getValue("abril",$i),2,",",".")."</td>";
								 print"<td>".number_format($ds_proaf->getValue("mayo",$i),2,",",".")."</td>";
								 print"<td>".number_format($ds_proaf->getValue("junio",$i),2,",",".")."</td>";
								 print"<td>".number_format($ds_proaf->getValue("julio",$i),2,",",".")."</td>";
								 print"<td>".number_format($ds_proaf->getValue("agosto",$i),2,",",".")."</td>";
								 print"<td>".number_format($ds_proaf->getValue("septiembre",$i),2,",",".")."</td>";
								 print"<td>".number_format($ds_proaf->getValue("octubre",$i),2,",",".")."</td>";
								 print"<td>".number_format($ds_proaf->getValue("noviembre",$i),2,",",".")."</td>";
  ...
  if ($ls_operacion=="DISTRIBUIR")
  {
	...
	if($ls_opcion=="A")
	{
		...
		$ds_proaf->updateRow("asignado",$ld_asignado,$i);
		$ds_proaf->updateRow("enero",$ld_div_asig,$i);
		$ds_proaf->updateRow("febrero",$ld_div_asig,$i);
		$ds_proaf->updateRow("marzo",$ld_div_asig,$i);
		$ds_proaf->updateRow("abril",$ld_div_asig,$i);
		$ds_proaf->updateRow("mayo",$ld_div_asig,$i);
		$ds_proaf->updateRow("junio",$ld_div_asig,$i);
		$ds_proaf->updateRow("julio",$ld_div_asig,$i);
		$ds_proaf->updateRow("agosto",$ld_div_asig,$i);
		$ds_proaf->updateRow("septiembre",$ld_div_asig,$i);
		$ds_proaf->updateRow("octubre",$ld_div_asig,$i);
		$ds_proaf->updateRow("noviembre",$ld_div_asig,$i);
...
{	
	...
	for ($i=1; $i<=$li_num; $i++)
	{
		...
		//meses
		$la_datos[6]  = $ds_proaf->getValue("enero",$i);
		$la_datos[7]  = $ds_proaf->getValue("febrero",$i);
		$la_datos[8]  = $ds_proaf->getValue("marzo",$i);
		$la_datos[9]  = $ds_proaf->getValue("abril",$i);
		$la_datos[10] = $ds_proaf->getValue("mayo",$i);
		$la_datos[11] = $ds_proaf->getValue("junio",$i);
		$la_datos[12] = $ds_proaf->getValue("julio",$i);
		$la_datos[13] = $ds_proaf->getValue("agosto",$i);
		$la_datos[14] = $ds_proaf->getValue("septiembre",$i);
		$la_datos[15] = $ds_proaf->getValue("octubre",$i);
		$la_datos[16] = $ds_proaf->getValue("noviembre",$i);
	...
	{   
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
		$ls_evento="UPDATE";
		$ls_descripcion =" Actualizo la Programacion de Reportes Origen y Aplicacion de Fondos ";
...
function ue_distribuir()
{
   ...
   if (document.opcion=="A")
   {
		 ...
		 {
		   f.operacion.value="DISTRIBUIR";
		   f.action="sigesp_scg_wproc_prog_oaf.php";
		   f.submit();
		 }  
     }
