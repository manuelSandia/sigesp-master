...
$io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_articulosxvencer.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<html>
<head>
<title>Reporte de Articulos por Vencer </title>
...
?>	
  ...
  <table width="442" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="438" colspan="2" class="titulo-ventana">Reporte de Articulos por Vencer </td>
    </tr>
  </table>
  <table width="437" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td height="53" colspan="5" align="center">      <div align="left">
        <table width="415" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td width="55" height="19"><div align="right">Tipo de Articulo </div></td>
            <td height="22"><input name="txtcodtipart" type="text" id="txtcodtipart" size="6" maxlength="4" readonly>
              <a href="javascript: ue_catatipart();"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar" width="15" height="15" border="0"></a>
              <input name="txtdentipart" type="text" class="sin-borde" id="txtdentipart" size="30" readonly>
    ...
    <tr>
      <td colspan="5" align="center"><table width="415" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td colspan="2"><strong> Fechas de Vencimiento</strong></td>
          <td width="65">&nbsp;</td>
          <td width="172">&nbsp;</td>
          <td width="30">&nbsp;</td>
        </tr>
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir)
			{
				...
				if (ls_codtipart!="")
				{
					ls_nomtipart= f.txtdentipart.value;
					...
					if ((ld_desde!="")||(ld_hasta!=""))
					{
						...
						window.open("reportes/sigesp_siv_rpp_articulosxvencer.php?codtipart="+ls_codtipart+"&nomtipart="+ls_nomtipart+"&ordenfec="+li_ordenfec+"&ordenart="+li_ordenart+"&desde="+ld_desde+"&hasta="+ld_hasta+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
						f.action="sigesp_siv_r_articulosxvencer.php";
					}
					else
					{
						alert("Debe seleccionar fechas de vencimiento");
					}
				}
				else
				{
