...
Categor&iacute;a CGR </div></td>
    ...
    <tr class="formato-blanco">
      <td height="22" align="center" style="text-align:right">C&oacute;digo</td>
      <td height="22" align="center" style="text-align:left"><input name="txtcodact" type="text" id="txtcodact" value="<?php print $ls_codact; ?>" 
    ...
    <tr class="formato-blanco">
      <td height="22" style="text-align:right">SIGECOF</td>
      <td height="22" style="text-align:left">
        <input name="txtcodcatsig" type="text" id="txtcodcatsig" size="18" maxlength="15" readonly value="<?php print $ls_sigecof ?>" style="text-align:center">
        <?php
		  if ($ls_rbtipocat==1 && $ls_tipocat=='')
		     {
		?>
