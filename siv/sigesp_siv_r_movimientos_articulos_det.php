...
$io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_movimientos_articulos_det.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<html>
<head>
<title>Reporte Detallado de Movimientos de Inventario </title>
...
?>	
  ...
  <table width="442" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="438" colspan="2" class="titulo-ventana">Reporte Detallado de Movimientos de Inventario </td>
    </tr>
  </table>
  <table width="437" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="5" align="center"><div align="left">
        <table width="415" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="134"><div align="right"><span class="style1">Ascendente
                  <input name="radioordenfec" type="radio" class="sin-borde" value="0" checked  código>
            </span></div></td>
            <td width="11">&nbsp;</td>
		...
		<table width="415" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td colspan="5"><span class="style14"><strong>Tipo de Reporte</strong></span></td>
            </tr>
          <tr>
            <td width="49"><div align="right"></div></td>
            <td width="97"><div align="right"><span class="style1">Resumido
                  <input name="radioresumido" type="radio" class="sin-borde" value="0" checked  código>
            </span></div></td>
            <td width="48">&nbsp;</td>
            <td width="128">&nbsp;</td>
            <td width="91">&nbsp;</td>
          ...
          <tr>
            <td><div align="right"></div></td>
            <td><div align="right">Especifico
                <input name="radioresumido" type="radio" class="sin-borde" value="1"  Nombre>
            </div></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
		...
		if(valido)
		{
			...
			if(li_imprimir)
			{
				...
				{	
					...
					window.open("reportes/sigesp_siv_rpp_movimientos_detallados.php?codart="+ls_codart+"&codalm="+ls_codalm+"&ordenfec="+li_ordenfec+"&ordenart="+li_ordenart+"&desde="+ld_desde+"&hasta="+ld_hasta+"&tipoformato="+tipoformato+"&resumido="+li_res,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
					f.action="sigesp_siv_r_movimientos.php";
				}
				else
				{
					alert("Debe llenar un rango de fechas!");
				}
			}
		}
		else
