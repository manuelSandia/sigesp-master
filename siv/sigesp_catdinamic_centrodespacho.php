...
<script language="JavaScript">
	...
	{ 
		...
		opener.document.form1.action="sigesp_siv_p_centrodespacho.php";
		opener.document.form1.hidvienecat.value="1";
	...
	function ue_search()
  	{
		...
		f.action="sigesp_catdinamic_centrodespacho.php";
		f.submit();
	}
</script>
