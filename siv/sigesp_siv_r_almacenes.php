...
$io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_almacenes.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
      ...
      <td colspan="5" align="center"><table width="430" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td width="375" height="22"><div align="left">
              ...
              <a href="javascript:uf_almacendesde();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a> 
              <input name="txtdendesde" type="text" class="sin-borde" id="txtdendesde" size="45" readonly>
</div>
        ...
        <tr>
          ...
          <td height="22"><div align="left">
              <input name="txtcodhasta" type="text" id="txtcodhasta" size="11" maxlength="10"  style="text-align:center">
              <a href="javascript:uf_almacenhasta();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a> 
              <input name="txtdenhasta" type="text" class="sin-borde" id="txtdenhasta" size="45" readonly>
</div>
            <div align="left"> </div></td>
        </tr>
      </table></td>
...
<script language="JavaScript">
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			window.open("reportes/sigesp_siv_rpp_almacenes.php?ordenalm="+li_ordenalm+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			f.action="sigesp_siv_r_almacenes.php";
		}
		else
		{
