...
$io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_valinventario.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<html>
<head>
<title>Valoraci&oacute;n de Inventario </title>
...
?>	
  ...
  <table width="500" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="438" colspan="2" class="titulo-ventana">Valoraci&oacute;n de Inventario </td>
    </tr>
  </table>
  <table width="494" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="5" align="center"><table width="452" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          <td colspan="2"><div align="left"><strong> Art&iacute;culos </strong></div></td>
        </tr>
        <tr>
          <td width="40"><div align="right">Desde</div></td>
          <td width="410" height="22"><div align="left">
    ...
    <tr>
      <td height="33" colspan="5" align="center">      <div align="left">
        <table width="452" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="75"><input name="txtdesde" type="text" id="txtdesde"  onKeyPress="ue_separadores(this,'/',patron,true);" value="<?php print $ld_fecdes ?>" size="15" maxlength="10"  datepicker="true"></td>
            <td><div align="right">Hasta</div></td>
            <td><div align="left">
                <input name="txthasta" type="text" id="txthasta"  onKeyPress="ue_separadores(this,'/',patron,true);" value="<?php print $ld_fechas ?>" size="15" maxlength="10"  datepicker="true">
            </div></td>
            <td>&nbsp;</td>
          </tr>
        </table>
    ...
    <tr>
      <td width="111" height="22" align="center"><div align="right" class="style1 style14"></div></td>
      <td colspan="2" align="left">&nbsp;        </td>
      <td width="70" align="center"><div align="right" class="style1 style14"></div></td>
      <td width="308" align="center"><div align="left">
...
{
	ls_tipo="tipo";
	window.open("sigesp_catdinamic_articulom.php?coddestino="+ ls_coddestino +"&dendestino="+ ls_dendestino +"&tipo="+ls_tipo+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
}
	...
	if(valido)
	{
		...
		if(li_imprimir==1)
		{
			...
			if ((ld_desde!="")&&(ld_hasta!=""))
			{
				...
				window.open("reportes/sigesp_siv_rpp_valinventario.php?ordenart="+li_ordenart+"&desde="+ld_desde+"&hasta="+ld_hasta+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			}
			else
			{
