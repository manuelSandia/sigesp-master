...
$io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_articulosespecificos.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<html>
<head>
<title>Listado de Art&iacute;culos Detallados</title>
...
?>	
  ...
  <table width="446" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="442" colspan="2" class="titulo-ventana">Listado de Art&iacute;culos Detallados </td>
    </tr>
  </table>
  <table width="437" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="165" align="center"><div align="left"></div></td>
    </tr>
    <tr>
      ...
      <td colspan="5" align="center"><div align="left">
        <table width="430" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="21">&nbsp;</td>
            <td width="100"><div align="right">C&oacute;digo
    ...
    <tr>
      <td height="24" colspan="5" align="center">
        <div align="center">
          <input name="chkexistencia" type="checkbox" class="sin-borde" id="chkexistencia" value="checkbox">
          Mostrar solo art&iacute;culos con existencia
...
<script language="JavaScript">
	...
	function uf_mostrar_reporte()
	{
		...
		window.open("reportes/sigesp_siv_rpp_articulosespecificos.php?codart="+ls_codart+"&ordenart="+li_ordenart+"&existencia="+existencia,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
	}
