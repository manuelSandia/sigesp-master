<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_fecha,$as_numorddes,&$io_pdf)
	{
		...
		// cuadro inferior
        $io_pdf->Rectangle(50,40,660,70);
		$io_pdf->line(50,56,710,56);//horizontal
		$io_pdf->line(50,48,710,48);//horizontal			
		$io_pdf->line(50,100,710,100);//horizontal		
		$io_pdf->line(280,40,280,110);//vertical		
		$io_pdf->line(530,40,530,110);//vertical		
		$io_pdf->addText(140,102,7,"Elaborado por:"); // Agregar el título
		$io_pdf->addText(140,50,7,"Victor Torres"); // Agregar el título
		$io_pdf->addText(110,41,7,"Coordinador de Servicios Generales"); // Agregar el título
		$io_pdf->addText(380,102,7,"Autorizado por"); // Agregar el título
		$io_pdf->addText(380,50,7,"Maryoris Lurua"); // Agregar el título
		$io_pdf->addText(340,41,7,"Gerente de Administración y Finanzas"); // Agregar el título
		$io_pdf->addText(590,102,7,"Recibido por:"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
