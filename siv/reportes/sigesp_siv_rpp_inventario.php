<?php
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_columna=array('codigo'=>'<b>Código</b>',
						  ...
						  'ultcosart'=>'<b>Ultimo Costo '.$ls_titulo.'</b>',
						  'cosproart'=>'<b>Costo Promedio '.$ls_titulo.'</b>',
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('codigo'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la columna
						 			   ...
						 			   'ultcosart'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'cosproart'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
	...
	$ls_titulo="<b> Resumen de Inventario en ".$ls_titulo_report."</b>";
	if($ld_desde!="")
	...
	{
		/////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////////////////////////////////////////////////////
		$ls_desc_event="Generó el reporte de Resumen de Inventario Desde el Articulo ".$ls_coddesde." hasta ".$ls_codhasta." Periodo de fechas ".$ld_desde." - ".$ld_hasta;
		$io_fun_inventario->uf_load_seguridad_reporte("SIV","sigesp_siv_r_inventario.php",$ls_desc_event);
		////////////////////////////////         SEGURIDAD               ///////////////////////////////////////////////////////////////////////////////////////////////
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$lb_valido=$io_report->uf_select_inventario($ls_codemp,$ls_coddesde,$ls_codhasta,$ld_desde,$ld_hasta,$li_ordenart); // Obtenemos el detalle del reporte
			if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					$li_exiart=     $io_report->ds->data["exiart"][$li_s];
					...
					if($li_existencia!=1)
					{
						if($li_exiartaux>0)
						{
							$la_data[$li_s]=array('codigo'=>$ls_codart,'articulo'=>$ls_denart,'unidad'=>$ls_denunimed,
							                      'precio'=>$li_preuniart,'existencia'=>$li_exiart,'entradas'=>$li_entradas,
												  'salidas'=>$li_salidas,'ultcosart'=>$li_ultcosart,'cosproart'=>$li_cosproart);
						}
						else
						{
							print("<script language=JavaScript>");
							print(" alert('No hay existencias para los Articulos');"); 
							print(" close();");
							print("</script>");
						}
					}
