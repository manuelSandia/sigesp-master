<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numconrec,$ad_fecha,&$io_pdf)
	{
		...
		$io_pdf->addText(90,102,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(100,43,7,"ALMACÉN"); // Agregar el título
		//$io_pdf->addText(157,102,7,"VERIFICADO POR"); // Agregar el título
		//$io_pdf->addText(160,43,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(260,102,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(257,43,7,"JEFE DE COMPRAS"); // Agregar el título
		$io_pdf->addText(425,102,7,"MATERIALES RECIBIDOS"); // Agregar el título
		$io_pdf->addText(427,43,7,"FIRMA, SELLO, FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
