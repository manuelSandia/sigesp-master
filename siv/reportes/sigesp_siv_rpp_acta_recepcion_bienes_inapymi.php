<?php
	...
	function uf_cabezera_detalle(&$io_pdf)
	{
		...
		$la_data=array(array('codart'=>'<b>Codigo</b>','denart'=>'<b>Denominación</b>','canart'=>'<b>Cantidad</b>',
		                     'unidad'=>'<b>Unidad</b>','preuniart'=>'<b>Precio Unitario '.$ls_titulo.'</b>'));
		$la_columnas=array('codart'=>'','denart'=>'','canart'=>'','unidad'=>'','preuniart'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codart'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la 
						 			   'denart'=>array('justification'=>'center','width'=>210), // Justificación y  
						 			   'canart'=>array('justification'=>'center','width'=>60), // Justificación y  
						 			   'unidad'=>array('justification'=>'center','width'=>60), // Justificación y  
									   'preuniart'=>array('justification'=>'center','width'=>110))); // Justificación y ancho de la 
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>306, // Orientación de la tabla
						 'cols'=>array('codart'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la 
						 			   'denart'=>array('justification'=>'left','width'=>210), // Justificación y  
						 			   'canart'=>array('justification'=>'right','width'=>60), // Justificación y  
						 			   'unidad'=>array('justification'=>'center','width'=>60), // Justificación y  
									   'preuniart'=>array('justification'=>'right','width'=>110))); // Justificación y ancho de la 
    ...
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
	 ...
	 else // Imprimimos el reporte
	 {
		...
		for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
		{
			  ...
			  $ls_unidad=$io_report->dts_reporte->data["unidad"][$li_s];
			 
			 $la_data[$li_s]=array('codart'=>$ls_codart,'denart'=>$ls_denart,'canart'=>$ls_canart,'unidad'=>$ls_unidad,'preuniart'=>$ls_preuniart);
		}//for
