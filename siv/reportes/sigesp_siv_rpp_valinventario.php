<?php
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('codigo'=>array('justification'=>'left','width'=>110), // Justificación y ancho de la columna
						 			   'articulo'=>array('justification'=>'left','width'=>178), // Justificación y ancho de la columna
						 			   'unidad'=>array('justification'=>'left','width'=>70), // Justificación y ancho de la columna
						 			   'existencia'=>array('justification'=>'right','width'=>75), // Justificación y ancho de la columna
						 			   'cospro'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'totcospro'=>array('justification'=>'right','width'=>85), // Justificación y ancho de la columna
						 			   'ultcosart'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'totultcos'=>array('justification'=>'right','width'=>85))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_totales($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('total'=>array('justification'=>'right','width'=>358), // Justificación y ancho de la columna
						 			   'existencia'=>array('justification'=>'right','width'=>75), // Justificación y ancho de la columna
						 			   'cospro'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'totcospro'=>array('justification'=>'right','width'=>85), // Justificación y ancho de la columna
						 			   'ultcosart'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
	...
	$ls_titulo="<b> Valoración de Inventario ".$ls_titulo_report."</b>";
	if($ld_desde!="")
	...
	{
		/////////////////////////////////         SEGURIDAD               ////////////////////////////////////////////////////////////////////////////////////////////////////
		$ls_desc_event="Generó el reporte Valoración de Inventario Desde el articulo ".$ls_coddesde." hasta ".$ls_codhasta." Periodo  de fechas ".$ld_desde." - ".$ld_hasta;
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
		   // $io_pdf->transaction('start'); // Iniciamos la transacción
			...
			$li_cospro=0;
			$li_ultcos=0;
			$lb_valido=$io_report->uf_select_promedio($ls_codemp,$ls_codart,$ld_desde,$ld_hasta,$li_cospro); // Obtenemos el detalle del reporte
			if($lb_valido)
			{
