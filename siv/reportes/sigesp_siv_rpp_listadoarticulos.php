<?php
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		// Fecha Creación: 21/04/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_columna=array('codartpri'=>'<b>Codigo Alterno</b>',
				 		  'codart'=>'<b>Codigo </b>',
						  'denart'=>'<b>Artículo</b>',
						  'dentipart'=>'<b>Tipo</b>',
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('codartpri'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
						 			   'codart'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
						 			   'denart'=>array('justification'=>'left','width'=>230), // Justificación y ancho de la columna
						 			   'dentipart'=>array('justification'=>'left','width'=>110), // Justificación y ancho de la columna
						 			   'nomfisalm'=>array('justification'=>'left','width'=>110), // Justificación y ancho de la columna
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$ls_codartpri= $io_report->ds->data["primario"][$li_i];
			...
			$la_data[$li_i]=array('codartpri'=>$ls_codartpri,'codart'=>$ls_codart,'denart'=>$ls_denart,'dentipart'=>$ls_dentipart,'nomfisalm'=>$ls_nomfisalm,
