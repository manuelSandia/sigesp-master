<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$ad_fecha,&$io_pdf)
	{
		...
		$io_pdf->addText(70,43,7,""); // Agregar el título
		$io_pdf->addText(157,102,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(160,43,7,""); // Agregar el título
		$io_pdf->addText(280,102,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(257,43,7,""); // Agregar el título
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$lb_valido=$io_report->uf_select_articuloxalmacen($ls_codemp,$ls_codalm,$ls_codart,$ls_codtipart,$li_ordenalm,$li_ordenart); // Obtenemos el detalle del reporte
			if($lb_valido)
			{
