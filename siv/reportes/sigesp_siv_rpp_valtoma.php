<?php
	...
	function uf_print_totales($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('total'=>array('justification'=>'right','width'=>430), // Justificación y ancho de la columna
						 			   ...
						 			   'totdif'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'totcos'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codart'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la columna
						 			   'denart'=>array('justification'=>'left','width'=>210), // Justificación y ancho de la columna
						 			   'denunimed'=>array('justification'=>'left','width'=>100), // Justificación y ancho de la columna
						 			   'cospro'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'diferencia'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'totcospro'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	$ls_titulo="<b> Valoración de Toma de Inventario </b>";
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=$io_report->uf_select_toma($ls_codemp,"",$ld_desde,$ld_hasta); // Cargar el DS con los datos de la cabecera del reporte
	...
	{
		/////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////////////////
		$ls_desc_event="Generó el reporte Valoración de Toma de Inventario Periodo  de fechas ".$ld_desde." - ".$ld_hasta;
		$io_fun_inventario->uf_load_seguridad_reporte("SIV","sigesp_siv_r_valtoma.php",$ls_desc_event);
		////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////////////////
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$lb_valido=$io_report->uf_select_dt_valtoma($ls_codemp,$ls_numtom); // Obtenemos el detalle del reporte
			if($lb_valido)
			{
