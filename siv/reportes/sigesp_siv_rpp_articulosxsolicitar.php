<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$ad_fecha,&$io_pdf)
	{
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,733,11,$as_titulo); // Agregar el título
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codart'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la columna
						 			   ...
						 			   'exiart'=>array('justification'=>'right','width'=>68), // Justificación y ancho de la columna
						 			   'minart'=>array('justification'=>'right','width'=>66), // Justificación y ancho de la columna
						 			   'reoart'=>array('justification'=>'right','width'=>66))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_totales($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('total'=>array('justification'=>'right','width'=>434), // Justificación y ancho de la columna
						 			   'canart'=>array('justification'=>'right','width'=>66))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	$ls_titulo="Listado de Artículos a Solicitar";
	if($ls_coddesde!="")
	...
	{
		/////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////////
		$ls_desc_event="Generó el reporte Listado de Artículos a Solicitar  Desde ".$ls_coddesde." hasta ".$ls_codhasta;
