<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_fecha,$as_numorddes,&$io_pdf)
	{
		...
		$io_pdf->line(70,97,250,97);
		$io_pdf->line(530,97,670,97);		
		...
		$io_pdf->addText(110,80,9,"UNIDAD SOLICITANTE"); // Agregar el título
		...
		$io_pdf->addText(580,80,9,"ALMACÉN"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
