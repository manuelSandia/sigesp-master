<?php
	...
	function uf_print_cabecera(&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data=array(array('name'=>'<b>Tipo de Artículo</b>  '));
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codart'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la columna
						 			   ...
						 			   'nomfisalm'=>array('justification'=>'left','width'=>200))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	$ls_titulo="Listado Imputación Presupuestaria del Inventario";
/*	if($ls_coddesde!="")
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$la_data[$li_i]=array('codart'=>$ls_codart,'denart'=>$ls_denart,'dentipart'=>$ls_cuenta,'nomfisalm'=>$ls_descrip);
		}
		if($li_totrow>0)
		{
