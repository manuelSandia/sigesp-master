<?php
	...
	function uf_print_cabecera($as_numordcom,$ad_fecrec,$as_nomfisalm,$as_denpro,&$io_pdf)
	{
		...
		$la_data=array(array('name'=>'<b>Ordén de Compra</b>  '.$as_numordcom.'                                                   <b>Proveedor</b>  '.$as_denpro.''),
	...
	{
		/////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////////
		$ls_desc_event="Generó el reporte de Entradas de Suministros Desde ".$ld_desde." hasta ".$ld_hasta;
