<?php
	...
	//$li_ordenart=1;
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=$io_report->uf_select_almacen($ls_codemp,$ls_codalm,$ls_codarti,$ls_codtipart,$li_ordenalm); // Cargar el DS con los datos de la cabecera del reporte
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$lb_valido=$io_report->uf_select_articuloxalmacen($ls_codemp,$ls_codalm,$ls_codarti,$ls_codtipart,$li_ordenalm,$li_ordenart); // Obtenemos el detalle del reporte
			if($lb_valido)
			{
				$li_total=0;
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					//$li_existenciahijos=$io_report->uf_select_articulosrelacionados($ls_codart);
					//$li_detal= $li_detal+ $li_existenciahijos;
