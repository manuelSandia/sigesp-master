<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_fecha,$as_numorddes,&$io_pdf)
	{
		...
		$io_pdf->addText(190,102,8,"Entregado por:"); // Agregar el título
		$io_pdf->addText(180,43,8,"Firma / Sello / Fecha"); // Agregar el título
		$io_pdf->addText(540,102,8,"Recibido por:"); // Agregar el título
		$io_pdf->addText(530,43,8,"Firma / Sello / Fecha"); // Agregar el título
