<?php
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('articulo'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
						 			   'fecven'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
									   'lote'=>array('justification'=>'left','width'=>60), // Justificación y ancho de la columna
									   'unidad'=>array('justification'=>'left','width'=>40), // Justificación y ancho de la columna
						 			   ...
						 			   'pendiente'=>array('justification'=>'right','width'=>45), // Justificación y ancho de la columna
						 			   'precio'=>array('justification'=>'right','width'=>55), // Justificación y ancho de la columna
						 			   'total'=>array('justification'=>'right','width'=>50))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_totales($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('total'=>array('justification'=>'right','width'=>300), // Justificación y ancho de la columna
						 			   'totcan'=>array('justification'=>'right','width'=>50), // Justificación y ancho de la columna
						 			   'totpen'=>array('justification'=>'right','width'=>45), // Justificación y ancho de la columna
						 			   'vacio'=>array('justification'=>'right','width'=>55), // Justificación y ancho de la columna
						 			   'totmon'=>array('justification'=>'right','width'=>50))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					$ls_lote=       $io_report->ds_detalle->data["lote"][$li_s];
					$ls_fecven=     $io_report->ds_detalle->data["fecven"][$li_s];
					$ls_fecven=     $io_funciones->uf_convertirfecmostrar($ls_fecven);
					if($ls_estartgen=="1")
					{
						$ls_denart="    ".$ls_denart;
						$ls_estatus="H";
					...
					$la_data[$li_s]=array('articulo'=>$ls_denart,'unidad'=>$ls_unidad,'cantidad'=>$li_canart,'pendiente'=>$li_penart,'precio'=>$li_preuniart,'total'=>$li_montotart,'lote'=>$ls_lote,'fecven'=>$ls_fecven);
				}
