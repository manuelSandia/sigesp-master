<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numconrec,$ad_fecha,&$io_pdf)
	{
		...
		//$io_pdf->line(50,97,550,97); Linea superior horizontal de los firmante		
		$io_pdf->line(155,40,155,110);	// 1ra Linea Vertical de izquierda a derecha de los firmante	
		$io_pdf->line(270,40,270,110);	// 2da Linea Vertical de izquierda a derecha de los firmante		
		$io_pdf->line(400,40,400,110);	// 3ra Linea Vertical de izquierda a derecha de los firmante
		//$io_pdf->addText(60,102,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(80,43,8,"ALMACÉN"); // Agregar el título
		//$io_pdf->addText(157,102,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(190,43,8,"COMPRAS"); // Agregar el título
		//$io_pdf->addText(280,102,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(300,43,8,"ADMINISTRACIÓN"); // Agregar el título
		//$io_pdf->addText(440,102,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(430,43,8,"SUB-DIRECC. ADMINIST"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	$ls_titulo="<b>INFORME DE RECEPCIÓN DE COMPRAS</b>";
	$ls_fecha=$ls_fecrec;
