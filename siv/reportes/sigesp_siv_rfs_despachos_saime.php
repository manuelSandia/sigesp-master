<?php
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>670, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('articulo'=>array('justification'=>'left','width'=>247), // Justificación y ancho de la columna
						 			   'almacen'=>array('justification'=>'left','width'=>190), // Justificación y ancho de la columna
						 			   'unidad'=>array('justification'=>'left','width'=>60), // Justificación y ancho de la columna
						 			   'solicitada'=>array('justification'=>'right','width'=>82), // Justificación y ancho de la columna
						 			   'despachada'=>array('justification'=>'right','width'=>90))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_totales($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>670, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('total'=>array('justification'=>'right','width'=>497), // Justificación y ancho de la columna
						 			   'totsol'=>array('justification'=>'right','width'=>82), // Justificación y ancho de la columna
						 			   'totart'=>array('justification'=>'right','width'=>90))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detallepresupuesto($la_data,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_detallepresupuesto
		//		   Access: private 
		//	    Arguments: la_data // arreglo de información
		//	   			   io_pdf // Objeto PDF
		//    Description: función que imprime el detalle
		...
		// Fecha Creación: 21/04/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_columna=array('codestpro'=>'<b>Estructura Presupuestaria</b>',
		                  'estcla'=>'<b>Estatus</b>',
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('codestpro'=>array('justification'=>'left','width'=>319), // Justificación y ancho de la columna
						               'estcla'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
						 			   'spg_cuenta'=>array('justification'=>'center','width'=>75), // Justificación y ancho de la columna
						 			   'monto'=>array('justification'=>'right','width'=>125))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'<b>Detalle Presupuestario</b>',$la_config);
	}// end function uf_print_detallepresupuesto
	//--------------------------------------------------------------------------------------------------------------------------------

	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_totalespresupuesto($li_totalp,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_totalespresupuesto
		//		   Access: private 
		//	    Arguments: la_data // arreglo de información
		//	   			   io_pdf // Instancia de objeto pdf
		//    Description: función que imprime el detalle por personal
		...
		// Fecha Creación: 06/07/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data[1]=array('total'=>'<b>TOTAL</b>','haber'=>$li_totalp);
		$la_columna=array('total'=>'','haber'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 11,  // Tamaño de Letras de los títulos
						 'showLines'=>1, // Mostrar Líneas
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('total'=>array('justification'=>'right','width'=>544),
						 			   'haber'=>array('justification'=>'right','width'=>125))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$la_data=array(array('name'=>''));
		$la_columna=array('name'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center'); // Orientación de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	}// end function uf_print_totalespresupuesto
	//--------------------------------------------------------------------------------------------------------------------------------
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					$la_data[$li_s]=array('articulo'=>$ls_denart,'almacen'=>$ls_nomfisalm,'unidad'=>$ls_unidad,'solicitada'=>$li_cansol,'despachada'=>$li_canart);
				}
				...
				$rs_datap=$io_report->uf_siv_load_dt_presupuestario($ls_codemp,$ls_numorddes,$ld_fechaaux); // Obtenemos el detalle del reporte
				$li_rowdet=$io_report->io_sql->num_rows($rs_datap);
				if($li_rowdet>0)
				{
					$li_z=0;
					$li_totalp=0;
					...
					{
						$li_z++;
						$ls_codestpro1=$rs_datap->fields["codestpro1"];
						$ls_codestpro2=$rs_datap->fields["codestpro2"];
						$ls_codestpro3=$rs_datap->fields["codestpro3"];
						$ls_codestpro4=$rs_datap->fields["codestpro4"];
						$ls_codestpro5=$rs_datap->fields["codestpro5"];
						$ls_estcla=$rs_datap->fields["estcla"];
						$ls_spgcuenta=$rs_datap->fields["spg_cuenta"];
						$li_monto=$rs_datap->fields["monto"];
						
						$li_totalp=$li_totalp+$li_monto;
						$ls_codpro=$ls_codestpro1.$ls_codestpro2.$ls_codestpro3.$ls_codestpro4.$ls_codestpro5;
						$io_fun_inventario->uf_formatoprogramatica($ls_codpro,$ls_codestpro);
						if($ls_estcla=="P")
						{$ls_estcla="Proyecto";}
						else
						{$ls_estcla="Accion";}
						$li_monto=$io_fun_inventario->uf_formatonumerico($li_monto);
						$la_datap[$li_z]=array('codestpro'=>$ls_codestpro,'estcla'=>$ls_estcla,'spg_cuenta'=>trim($ls_spgcuenta),'monto'=>$li_monto);
						$rs_datap->MoveNext();
					}
					uf_print_detallepresupuesto($la_datap,$io_pdf); // Imprimimos el detalle 
					$li_totalp=$io_fun_inventario->uf_formatonumerico($li_totalp);
					uf_print_totalespresupuesto($li_totalp,&$io_pdf);
				}
