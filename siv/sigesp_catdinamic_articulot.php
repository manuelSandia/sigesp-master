	...
	if($ls_operacion=="BUSCAR")
	{
		...
		if($row=$io_sql->fetch_row($rs_cta))
		{
			...
			for($z=1;$z<=$totrow;$z++)
			{
				...
				print "<td><a href=\"javascript: aceptar('$ls_codart','$ls_denart','$li_cosart','$li_linea','$li_unidad','$ls_denunimed','$li_existencia');\">".$ls_codart."</a></td>";
...
<script language="JavaScript">
	function aceptar(ls_codart,ls_denart,li_cosart,li_linea,li_unidad,ls_denunimed,li_existencia)
	{
		...
		obj1=eval("opener.document.form1.hidexistencia"+li_linea+"");
