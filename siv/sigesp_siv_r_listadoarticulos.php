...
$io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_listadoarticulos.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<html>
<head>
<title>Listado de Art&iacute;culos Por Almacen</title>
...
?>	
  ...
  <table width="517" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="518" colspan="2" class="titulo-ventana">Listado  de Art&iacute;culos Por Almacen </td>
    </tr>
  </table>
  <table width="517" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          <td height="10"><div align="right">Almac&eacute;n</div></td>
          <td height="22"><input name="txtcodalm" type="text" id="txtcodalm" size="24" style="text-align:center">
        ...
        <tr>
          <td height="10"><div align="right">Tipo de Art&iacute;culo</div></td>
      ...
      <td colspan="5" align="center"><div align="left">
        <table width="478" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <div align="right">Art&iacute;culo
            ...
            <td width="88"><div align="right">Almac&eacute;n
                <input name="rdorden" type="radio" class="sin-borde" value="radiobutton">
            </div></td>
            <td width="108"><div align="right">Tipo de Art&iacute;culo
              <input name="rdorden" type="radio" class="sin-borde" value="radiobutton">
            </div></td>
			...
			{
			?>
		    <td width="101"><div align="right">SIGECOF<label>
              <input name="rdorden" type="radio" class="sin-borde" value="radiobutton">
              </label>
            </div></td>
			<?php
...
<script language="JavaScript">
	...
	{
		window.open("sigesp_siv_cat_sigecof.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
	}
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			if(li_sigecof==1)
			{
				...
				if(f.rdorden[4].checked){li_orden=4;}
			}
			else
			{ls_codsigecof="";}
			...
			window.open("reportes/sigesp_siv_rpp_listadoarticulos.php?orden="+li_orden+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&codsigecof="+ls_codsigecof+"&codalm="+ls_codalm+"&codtipart="+ls_codtipart+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
