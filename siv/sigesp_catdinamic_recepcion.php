	...
	if($ls_operacion=="BUSCAR")
	{
		...
		if($li_row>0)
		{
			while($row=$io_sql->fetch_row($rs_cta))
			{
				...
				if($ls_estrevrec=="1")
				{
					print "<td><a href=\"javascript: aceptar('$ls_numconrec','$ls_numordcom','$ls_obsrec','$ls_codpro','$ls_nompro','$ls_codalm','$ls_nomfisalm','$ls_estpro','$ls_estrec','$ls_estrevrec','$ld_fecrec','$ls_estapr');\">".$ls_numconrec."</a></td>";
				}
				else
				{
...
<script language="JavaScript">
	function aceptar(ls_numconrec,ls_numordcom,ls_obsrec,ls_codpro,ls_nompro,ls_codalm,ls_nomfisalm,ls_estpro,ls_estrec,
					 ls_estrevrec,ld_fecrec,ls_estapr)
	{
