  ...
  <table width="465" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="5" align="center">      <div align="left">
        <table width="453" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td colspan="2"><strong>Tipo de Busqueda </strong></td>
            </tr>
          <tr>
            <td width="87"><div align="right">Art&iacute;culo</div></td>
            <td width="364" height="22"><div align="left">
          ...
          <tr>
            <td height="19"><div align="right">Tipo de Articulo </div></td>
...
<script language="JavaScript">
	...
	function uf_mostrar_reporte()
	{
		...
		window.open("reportes/sigesp_siv_rpp_existencias.php?codart="+ls_codart+"&codalm="+ls_codalm+"&ordenalm="+li_ordenalm+"&ordenart="+li_ordenart+"&codtipart="+ls_codtipart,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
	}
