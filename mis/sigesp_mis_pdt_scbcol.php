<?php
   ...
   //----------------------------------------------------------------------------------------------------------------------------
   function uf_imprimirresultados($as_numdoc,$as_codban,$as_ctaban,$as_codope,$as_numcol,$as_disponibilidad)
   {
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		else
		{
			while(!$rs_data->EOF)
			{
				...
				$ld_fecmovcol=$io_funciones->uf_convertirfecmostrar($rs_data->fields["fecmovcol"]);
				$_SESSION["fechacomprobante"]=$ld_fecmovcol;
				switch($ls_codope)
				{
					case "ND":
				...
				print "		<td width='350'><div align='left'>".$ld_fecmovcol."</div></td>";
				print "  </tr>";
				print "  <tr>";
...
<?php
	...
	uf_imprimirresultados($ls_numdoc,$ls_codban,$ls_ctaban,$ls_codope,$ls_numcol,$ls_disponibilidad);
?>
</div>
</form>
</body>
