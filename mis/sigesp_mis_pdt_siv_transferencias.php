<?php
   ...
   //----------------------------------------------------------------------------------------------------------------------------
   function uf_imprimirresultados($as_numtra,$ad_fecemi)
   {
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql="SELECT siv_transferencia.codemp, siv_transferencia.numtra, MAX(obstra) as obstra, siv_transferencia.fecemi ". 
				"  FROM siv_transferencia, siv_dt_transferencia ".
				" WHERE siv_transferencia.codemp = '".$ls_codemp."' ".
				"   AND siv_transferencia.numtra='".$as_numtra."'".
				"   AND siv_transferencia.fecemi='".$ad_fecemi."'".
				"   AND siv_transferencia.codemp=siv_dt_transferencia.codemp ".
				"   AND siv_transferencia.numtra=siv_dt_transferencia.numtra ".
				"   AND siv_transferencia.fecemi=siv_dt_transferencia.fecemi ".
				" GROUP BY siv_transferencia.codemp, siv_transferencia.numtra, siv_transferencia.fecemi".
			    " ORDER BY siv_transferencia.numtra  ";	
		...
		else
		{
			if(!$rs_data->EOF)
			{
				$ls_comprobante=$rs_data->fields["numtra"];
				$ls_descripcion=$rs_data->fields["obstra"];
				$_SESSION["fechacomprobante"]=$rs_data->fields["fecemi"];
				...
				$ls_sql="SELECT sc_cuenta, debhab, monto ".
						...
						" WHERE siv_dt_transferencia.codemp = '".$ls_codemp."' ".
...
<?php
	...
	$ls_numtra=$in_class_mis->uf_obtenervalor_get("numtra","");
	$ld_fecemi=$in_class_mis->uf_obtenervalor_get("fecemi","");
	uf_imprimirresultados($ls_numtra,$ld_fecemi);
?>
</div>
</form>
</body>
