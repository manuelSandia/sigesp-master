<?php
   ...
   //----------------------------------------------------------------------------------------------------------------------------
   function uf_imprimirresultados($as_mes,$as_ano,$as_disponibilidad)
   {
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		uf_buscarconfiguracion($ls_depreciacion);
		...
		$ls_sql="SELECT SUM(mondepmen) AS monto  ".
				...
				" GROUP BY SUBSTR(CAST(fecdep AS CHAR(10)),1,4), SUBSTR(CAST(fecdep AS CHAR(10)),6,2) ";
			...
			while(!$rs_data->EOF)
			{
				...
				if($ls_depreciacion!="C")
				{
					...
					else
					{
						...
						while(!$rs_data2->EOF)
						{
							$ls_cuenta=$rs_data2->fields["spg_cuenta_dep"];
					...
					else
					{
						...
						while(!$rs_data2->EOF)
						{
							...
							$ls_debhab=$rs_data2->fields["operacion"];
							switch($ls_debhab)
							{
								case "D":
									$li_debe=$li_monto;
...
<?php
	...
	uf_imprimirresultados($ls_mes,$ls_ano,$ls_disponibilidad);
?>
</div>
</form>
</body>
