<?php
	...
	$oi_fun_integrador->uf_load_seguridad("MIS","sigesp_mis_p_reverso_anula_soc.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
   ...
   function uf_limpiarvariables()
   {
		...
		$lo_title[6]="Detalle";
		$li_widthtable=700;
		$ls_titletable="Ordenes de Compras Anuladas";
		$ls_nametable="grid";
   ...
   function uf_load_variables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
   		global$ls_operacion_soc,$ls_numordcom,$ls_codprov,$ls_fecapr;
...
<html>
<head>
<title>Reverso de la Anulaci&oacute;n de compras</title>
...
?>
  ...
  <table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr class="titulo-ventana">
      <td colspan="2">Reverso de Anulaci&oacute;n de Ordenes de Compra </td>
    </tr>
    <tr>
      <td width="120"  height="23"><div align="right">N&uacute;mero de Orden de compra </div></td>
...
function ue_procesar()
{
	...
	{	
		...
		if(lb_valido)
		{
			...
			f.action="sigesp_mis_p_reverso_anula_soc.php";
			f.submit();
		}
		else
		{
