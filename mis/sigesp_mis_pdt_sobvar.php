<?php
   ...
   //----------------------------------------------------------------------------------------------------------------------------
   function uf_imprimirresultados($as_codvar,$as_codcom,$as_disponibilidad)
   {
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql="SELECT sob_variacioncontrato.motvar, sob_asignacion.cod_pro, sob_variacioncontrato.codvar, sob_contrato.obscon, sob_variacioncontrato.fecvar,  ".
				...
				"   AND sob_variacioncontrato.codcon='".$as_codcom."' ".
		...
		else
		{
			while(!$rs_data->EOF)
			{
				$ls_descripcion=$rs_data->fields["motvar"];
				$ls_descontrato=$as_codcom." - ".$rs_data->fields["obscon"];
				$ls_nombre_destino=$rs_data->fields["cod_pro"]." - ".$rs_data->fields["nompro"];
				$ld_fecvar=$io_funciones->uf_convertirfecmostrar($rs_data->fields["fecvar"]);
				$_SESSION["fechacomprobante"]=$ld_fecvar;
				...
				print "  </tr>";
				print "  <tr>";
				print "		<td width='100'><div align='right' class='texto-azul'>Variación</div></td>";
				print "		<td width='350'><div align='left'>".$as_codvar."</div></td>";
				print "  </tr>";
				print "  <tr>";
				print "		<td width='100'><div align='right' class='texto-azul'>Fecha</div></td>";
				print "		<td width='350'><div align='left'>".$ld_fecvar."</div></td>";
				print "  </tr>";
				print "  <tr>";
