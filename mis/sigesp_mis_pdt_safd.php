<?php
   ...
   //----------------------------------------------------------------------------------------------------------------------------
   function uf_imprimirresultados($as_numdoc,$as_fecdoc)
   {
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$as_fecdoc = $io_funciones->uf_convertirdatetobd($as_fecdoc);
		
		$ls_sql="SELECT cmpmov, numcmp, feccmp, descmp ".
                "  FROM saf_movimiento ".
				" WHERE codemp='".$ls_codemp."' ".
				"   AND cmpmov='".$as_numdoc."' ".
				"   AND feccmp='".$as_fecdoc."' ".
				"   AND tipcmp = 'DE' ";
		...
		{
			if(!$rs_data->EOF){
				$ls_numcmp=$rs_data->fields["cmpmov"];
				$ls_numdoc=$rs_data->fields["numcmp"];
				$ld_fecha=$io_funciones->uf_convertirfecmostrar($rs_data->fields["feccmp"]);
				...
				print "		<td width='350'><div align='left'>".$ls_numcmp."</div></td>";
				print "  </tr>";
				print "  <tr>";
				print "		<td width='100'><div align='right' class='texto-azul'>Documento</div></td>";
				print "		<td width='350'><div align='left'>".$ls_numdoc."</div></td>";
				print "  </tr>";
				print "  <tr>";
...
<?php
	...
	$ls_fecdoc=$in_class_mis->uf_obtenervalor_get("fecdoc","");
	uf_imprimirresultados($ls_numdoc,$ls_fecdoc);
?>
</div>
</form>
</body>
