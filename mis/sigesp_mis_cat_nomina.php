<?php
   ...
   function uf_print($as_codigo, $as_denominacion, $as_tipo)
   {
		...
		$ls_sql="SELECT DISTINCT sno_nomina.codemp, sno_nomina.codnom, sno_nomina.desnom ".
				"  FROM sno_nomina, sno_dt_scg ".
				" WHERE sno_dt_scg.codemp = '".$ls_codemp."' ".
				"   AND sno_dt_scg.estatus = ".$ls_status.
				...
				" WHERE sno_dt_spi.codemp='".$ls_codemp."' ".
				"   AND sno_dt_spi.estatus=".$ls_status.
				"   AND sno_nomina.codnom like '".$as_codigo."' ".
				"   AND sno_nomina.desnom like '".$as_denominacion."' ".
