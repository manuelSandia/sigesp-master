...
$conexionbd->Connect($_SESSION['sigesp_servidor_apr'].':'.$_SESSION['sigesp_puerto_apr'],$_SESSION['sigesp_usuario_apr'],$_SESSION['sigesp_clave_apr'],$_SESSION['sigesp_basedatos_apr']);
if ($conexionbd != false)
{
...
* @autor:
***********************************************************************************/
	function conectarBD($servidor, $usuario, $clave, $basedatos, $gestor, $puerto) 
	{ 
		$conexion=false;
		try
		{
			$conexion=&ADONewConnection($gestor);
			$conexion->Connect($servidor.':'.$puerto, $usuario, $clave, $basedatos);
