<?php
   ...
   function uf_print($as_ruta)
   {
		...
		while (false!==$file = readdir($handle))
		{
			 if(($file != '.') && ($file != '..'))
			 {
			 	if(($file!="accord_ticket.xls")&&($file!="accord_tarjeta.xls")&&($file!="valeven_ticket.xls")&&($file!="sodexho_tarjeta.xls")&&($file!="sodexho_ticket.xls")&&($file!="valeven_tarjeta.xls")&&($file!="todoticket_tarjeta.xls")&&($file!=".svn")&&($file!="casapropia.xls")&&($file!="fps_bancoagricolavenezuela.xls")&&($file!="bicentenario.xls")&&($file!="tesoro.xls"))
				{
					print "<tr>";
					print "<td width='360' height='22'><div align='left'>".$file."</div></td>";
					print "<td width='70' height='22'><div align='center'><a href='sigesp_sno_cat_descarga.php?enlace=".$as_ruta."&file=".$file."'><img src='../shared/imagebank/tools20/download.gif' width='20' height='20' border='0'></a></div></td>";
...
<?php
	...
	$ls_ruta=$_GET["ruta"];
	$ls_file=$io_fun_nomina->uf_obtenervalor_get("file","");
	if($ls_file!="")
	{
...
function ue_delete(ruta,file)
{
	...
	{
		f=document.form1;
		f.action="sigesp_sno_cat_directorio.php?ruta="+ruta+"&file="+file+"";
		f.submit();
	}
}
</script>
