<?php
   ...
   //--------------------------------------------------------------
   function uf_print($as_codper, $as_cedper, $as_nomper, $as_apeper, $as_numexp, $as_tipo, $ai_subnomina, $as_codnom)
   {
		//////////////////////////////////////////////////////////////////////////////
		//	Function:  uf_print
		...
		else
		{
			while(!$rs_data->EOF)
			{
				...
				$ls_obsegrper=str_replace('"',"", $ls_obsegrper);
				$ls_obsegrper=str_replace("/","-", $ls_obsegrper);
				$ls_obsrecper=trim($rs_data->fields["obsrecper"]);
				$ls_obsrecper=str_replace('"',"", $ls_obsrecper);
				$ls_obsrecper=str_replace("/","-", $ls_obsrecper);
				...
				switch ($as_tipo)
				{
					case "": // el llamado se hace desde sigesp_sno_d_personalnomina.php
						...
						print "'$ld_fecegrper','$ld_fecsusper','$ls_codger');\">".$ls_codper."</a>";
						print "<input name='txtobsrecper".$ls_codper."' type='hidden' id='txtobsrecper".$ls_codper."' value='$ls_obsrecper'>";
						print "<input name='txtobsegrper".$ls_codper."' type='hidden' id='txtobsegrper".$ls_codper."' value='$ls_obsegrper'></td>";
					...
					case "hojatiempo": // el llamado se hace desde sigesp_sno_d_hojatiempo.php
						$ld_sueper=$rs_data->fields["sueper"];
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarhojatiempo('$ls_codper','$ls_cedper','$ls_nomper','$ls_desuniadm','$ld_sueper');\">".$ls_codper."</a></td>";
						print "<td>".$ls_cedper."</td>";
						print "<td>".$ls_nomper."</td>";
						print "<td>".$ls_estper."</td>";
						print "<td ".$ls_clase.">".$ls_contrato."</td>";
					...
					case "aprobarhojatiempodes": // el llamado se hace desde sigesp_sno_p_aprobacionhojatiempo.php
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aprobarhojatiempodes('$ls_codper');\">".$ls_codper."</a></td>";
						print "<td>".$ls_cedper."</td>";
						print "<td>".$ls_nomper."</td>";
						print "<td>".$ls_estper."</td>";
						print "<td ".$ls_clase.">".$ls_contrato."</td>";
					...
					case "aprobarhojatiempohas": // el llamado se hace desde sigesp_sno_p_aprobacionhojatiempo.php
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aprobarhojatiempohas('$ls_codper');\">".$ls_codper."</a></td>";
						print "<td>".$ls_cedper."</td>";
						print "<td>".$ls_nomper."</td>";
						print "<td>".$ls_estper."</td>";
						print "<td ".$ls_clase.">".$ls_contrato."</td>";
...
<br>
    <table width="500" border="0" cellpadding="1" cellspacing="0" class="formato-blanco" align="center">
      <tr>
        <td width="87" height="22"><div align="right">C&oacute;digo</div></td>
        <td width="407"><div align="left">
...
<?php
	...
	if($ls_operacion=="BUSCAR")
	{
		...
		uf_print($ls_codper, $ls_cedper, $ls_nomper, $ls_apeper, $ls_numexp, $ls_tipo, $li_subnomina, $ls_codnom);
	}
	unset($io_fun_nomina);
?>
</div>
...
function aceptar(codper,nomper,estper,codasicar,denasicar,codcar,descar,codtab,destab,codgra,codpas,
				 ...
				 coddep, dendep, tippen, fecvid, prirem, segrem,salnorper, estencper,fecegrper,fecsusper,codger)
{
	f=document.form1;
	...
	{
		if((opener.document.form1.rac.value=="1")&&(opener.document.form1.racobrnom.value=="0"))
		{
		...
		if((opener.document.form1.rac.value=="1")&&(opener.document.form1.racobrnom.value=="1"))
		{	
			opener.document.form1.txtgrado.value=grado;
			opener.document.form1.txtcodasicar.value=codasicar;
		    opener.document.form1.txtdenasicar.value=denasicar;
    ...
    opener.document.form1.txtobsegrper.value=eval("f.txtobsegrper"+codper+".value");
    ...
    opener.document.form1.txtobsrecper.value=eval("f.txtobsrecper"+codper+".value");
...
function aceptarhojatiempo(codper,cedper,nomper,desuniadm,sueper)
{
	opener.document.form1.txtcodper.value=codper;
	opener.document.form1.txtcodper.readOnly=true;
	...
	opener.document.form1.operacion.value="BUSCARDETALLE";
	opener.document.form1.action="sigesp_sno_d_hojatiempo.php";
	opener.document.form1.submit();
	close();
}

function aprobarhojatiempodes(codper)
{
	opener.document.form1.txtcodperdes.value=codper;
	opener.document.form1.txtcodperdes.readOnly=true;
	opener.document.form1.txtcodperhas.value="";
...
function aprobarhojatiempohas(codper)
{
	if(opener.document.form1.txtcodperdes.value<=codper)
	{
		opener.document.form1.txtcodperhas.value=codper;
