<?php
   ...
   function uf_print($as_codproy, $as_nomproy, $as_tipo)
   {
		...
		print "<td>Tipo</td>";
		print "</tr>";
		$ls_sql="SELECT codemp, codproy, nomproy, codestpro1, codestpro2, codestpro3, codestpro4, codestpro5, estcla, ".
				"		(SELECT denestpro1 ".
				"		   FROM spg_ep1 ".
				"		  WHERE spg_ep1.codemp=sno_hproyecto.codemp".
				"		    AND spg_ep1.codestpro1=sno_hproyecto.codestpro1 ".
				"           AND spg_ep1.estcla=sno_hproyecto.estcla) as denestpro1, ".
				"		(SELECT denestpro2 ".
				"		   FROM spg_ep2 ".
				"		  WHERE spg_ep2.codemp=sno_hproyecto.codemp".
				"		    AND spg_ep2.codestpro1=sno_hproyecto.codestpro1 ".
				"		    AND spg_ep2.codestpro2=sno_hproyecto.codestpro2 ".
				"           AND spg_ep2.estcla=sno_hproyecto.estcla) as denestpro2, ".
				"		(SELECT denestpro3 ".
				"		   FROM spg_ep3 ".
				"		  WHERE spg_ep3.codemp=sno_hproyecto.codemp".
				"		    AND spg_ep3.codestpro1=sno_hproyecto.codestpro1 ".
				"		    AND spg_ep3.codestpro2=sno_hproyecto.codestpro2 ".
				"		    AND spg_ep3.codestpro3=sno_hproyecto.codestpro3 ".
				"           AND spg_ep3.estcla=sno_hproyecto.estcla) as denestpro3, ".
				"		(SELECT denestpro4 ".
				"		   FROM spg_ep4 ".
				"		  WHERE spg_ep4.codemp=sno_hproyecto.codemp".
				"		    AND spg_ep4.codestpro1=sno_hproyecto.codestpro1 ".
				"		    AND spg_ep4.codestpro2=sno_hproyecto.codestpro2 ".
				"		    AND spg_ep4.codestpro3=sno_hproyecto.codestpro3 ".
				"		    AND spg_ep4.codestpro4=sno_hproyecto.codestpro4 ".
				"           AND spg_ep4.estcla=sno_hproyecto.estcla) as denestpro4, ".
				"		(SELECT denestpro5 ".
				"		   FROM spg_ep5 ".
				"		  WHERE spg_ep5.codemp=sno_hproyecto.codemp".
				"		    AND spg_ep5.codestpro1=sno_hproyecto.codestpro1 ".
				"		    AND spg_ep5.codestpro2=sno_hproyecto.codestpro2 ".
				"		    AND spg_ep5.codestpro3=sno_hproyecto.codestpro3 ".
				"		    AND spg_ep5.codestpro4=sno_hproyecto.codestpro4 ".
				"		    AND spg_ep5.codestpro5=sno_hproyecto.codestpro5 ".
				"           AND spg_ep5.estcla=sno_hproyecto.estcla) as denestpro5 ".
				"  FROM sno_hproyecto ".
...
function ue_mostrar(myfield,e)
{
  ...
  function ue_search()
  {
	  ...
	  f.action="sigesp_sno_cat_hproyecto.php?tipo=<?php print $ls_tipo;?>";
	  f.submit();
  }
</script>
</html>
