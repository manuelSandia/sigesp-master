	...
	function uf_print($as_codper, $ai_codestrea, $as_insestrea)
   	{
		...
		if($ai_codestrea!="")
		{
			$ls_criterio="   AND codestrea = ".$ai_codestrea." ";
		}
		...
		else
		{
			while(!$rs_data->EOF)
			{
				$li_codestrea=$rs_data->fields["codestrea"];
				$ls_tipestrea=$rs_data->fields["tipestrea"];
				$ls_insestrea=$rs_data->fields["insestrea"];
				$ls_desestrea=$rs_data->fields["desestrea"];
				$ls_titestrea=$rs_data->fields["titestrea"];
				$li_calestrea=$rs_data->fields["calestrea"];
				$ls_escval=$rs_data->fields["escval"];
				$li_calestrea=$io_fun_nomina->uf_formatonumerico($li_calestrea);
				$ld_fecgraestrea=$io_funciones->uf_convertirfecmostrar($rs_data->fields["fecgraestrea"]);			
				$ld_feciniact=$io_funciones->uf_convertirfecmostrar($rs_data->fields["feciniact"]);			
				$ld_fecfinact=$io_funciones->uf_convertirfecmostrar($rs_data->fields["fecfinact"]);			
				$ls_aprestrea=$rs_data->fields["aprestrea"];
				$ls_anoaprestrea=$rs_data->fields["anoaprestrea"];
				$ls_horestrea=$rs_data->fields["horestrea"];
