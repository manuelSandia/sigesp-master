<?php
   ...
   function uf_print($as_codigo, $as_denominacion, $as_tipo)
   {
		...
		$ls_sql="SELECT codemp,minorguniadm,ofiuniadm,uniuniadm,depuniadm,prouniadm,desuniadm,codestpro1, codestpro2, codestpro3, codestpro4, codestpro5,estcla, ".
				"		(SELECT denestpro1 ".
				"		   FROM spg_ep1 ".
				...
				"		   FROM spg_ep2 ".
				"		  WHERE codemp=sno_unidadadmin.codemp".
				"		    AND spg_ep2.codestpro1=sno_unidadadmin.codestpro1 ".
				"		    AND spg_ep2.codestpro2=sno_unidadadmin.codestpro2 ".
				"           AND spg_ep2.estcla=sno_unidadadmin.estcla) as denestpro2, ".
				"		(SELECT denestpro3 ".
				"		   FROM spg_ep3 ".
				"		  WHERE codemp=sno_unidadadmin.codemp".
				"		    AND spg_ep3.codestpro1=sno_unidadadmin.codestpro1 ".
				"		    AND spg_ep3.codestpro2=sno_unidadadmin.codestpro2 ".
				"		    AND spg_ep3.codestpro3=sno_unidadadmin.codestpro3".
				"           AND spg_ep3.estcla=sno_unidadadmin.estcla) as denestpro3, ".
				"		(SELECT denestpro4 ".
				"		   FROM spg_ep4 ".
				"		  WHERE codemp=sno_unidadadmin.codemp".
				"		    AND spg_ep4.codestpro1=sno_unidadadmin.codestpro1  ".
				"		    AND spg_ep4.codestpro2=sno_unidadadmin.codestpro2 ".
				"		    AND spg_ep4.codestpro3=sno_unidadadmin.codestpro3 ".
				"		    AND spg_ep4.codestpro4=sno_unidadadmin.codestpro4 ".
				"           AND spg_ep4.estcla=sno_unidadadmin.estcla) as denestpro4, ".
				"		(SELECT denestpro5 ".
				"		   FROM spg_ep5 ".
				"		  WHERE codemp=sno_unidadadmin.codemp".
				"		    AND spg_ep5.codestpro1=sno_unidadadmin.codestpro1 ".
				"		    AND spg_ep5.codestpro2=sno_unidadadmin.codestpro2 ".
				"		    AND spg_ep5.codestpro3=sno_unidadadmin.codestpro3 ".
				"		    AND spg_ep5.codestpro4=sno_unidadadmin.codestpro4 ".
				"		    AND spg_ep5.codestpro5=sno_unidadadmin.codestpro5 ".
		...
		else
		{
			while(!$rs_data->EOF)
			{
				...
				$ls_codprouniadm=$ls_codest1.$ls_codest2.$ls_codest3.$ls_codest4.$ls_codest5;
