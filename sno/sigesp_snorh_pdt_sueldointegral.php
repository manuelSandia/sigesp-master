<?php
   ...
   function uf_print($ls_codper, $ls_anocurper, $ls_mescurper,$ls_sueint,$ls_nomina)
   {
		...
		$ls_sql="SELECT sno_hsalida.codnom, sno_hsalida.codconc,MAX(sno_hconcepto.nomcon) AS nomcon, SUM(sno_hsalida.valsal) AS valsal". 
		        ...
		        "     AND sno_hsalida.codnom ='".$ls_nomina."'".
  				"	 AND substr(cast(sno_hperiodo.fecdesper as char(10)),6,2) = '".str_pad($ls_mescurper,2,"0",0)."' ". 
  				"	 AND substr(cast(sno_hperiodo.fecdesper as char(10)),1,4) = '".$ls_anocurper."' ". 
  				"	  ".
