<?php
   ...
   function uf_print($as_codubifis, $as_desubifis, $as_tipo)
   {
		...
		print "</tr>";
		$ls_sql="SELECT codubifis, desubifis, codpai, codest, codmun, codpar, dirubifis, tietras, ".
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				$li_tietras=$row["tietras"];
				switch ($as_tipo)
				{
					case "":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptar('$ls_codubifis','$ls_desubifis','$ls_codpai','$ls_despai',";
						print "'$ls_codest','$ls_desest','$ls_codmun','$ls_desmun','$ls_codpar','$ls_despar','$ls_dirubifis','$li_tietras');\">".$ls_codubifis."</a></td>";
...
function aceptar(codubifis,desubifis,codpai,despai,codest,desest,codmun,desmun,codpar,despar,dirubifis,tietras)
{
	...
	opener.document.form1.txttietras.value=tietras;
