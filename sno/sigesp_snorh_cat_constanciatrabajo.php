...
<html>
<head>
<title>Cat&aacute;logo de Constancia Trabajo</title>
...
<form name="form1" method="post" action="">
  ...
  <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" height="20" colspan="2" class="titulo-ventana">Cat&aacute;logo de Constancia de Trabajo </td>
    </tr>
  </table>
<br>
...
function ue_search(existe)
{
	f=document.form1;
  	...
  	f.action="sigesp_snorh_cat_constanciatrabajo.php?tipo=<?php print $ls_tipo;?>";
  	f.submit();
}
</script>
</html>