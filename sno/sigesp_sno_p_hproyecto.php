<?php
	...
	$io_fun_nomina->uf_load_seguridad("SNO","sigesp_sno_p_hproyecto.php",$ls_permisos,$la_seguridad,$la_permisos);
   ...
   function uf_limpiarvariables()
   {
		...
		global $ls_desnom,$ls_desper,$li_contabilizado,$ls_estcla;
   ...
   function uf_load_variables()
   {
		...
		// Fecha Creación: 20/07/2007 								Fecha Última Modificación : 
		//////////////////////////////////////////////////////////////////////////////
   		global $ls_codproy,$ls_nomproy,$ls_codestpro1,$ls_modalidad,$ls_denestpro1,$ls_codestpro2,$ls_denestpro2,$ls_codestpro3;
...
<?php 
	...
	switch ($ls_operacion) 
	{
		case "GUARDAR":
			...
			$lb_valido=$io_proyecto->uf_update_proyecto_historico($ls_codproy,$ls_nomproy,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,
		  ...
		  <table width="650" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
            ...
            <tr>
              ...
              <td ><div align="left" >
                  ...
                  <a href="javascript: ue_buscarproyecto();"><img id="concepto" src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Cat&aacute;logo de Concepto"></a></div></td>
            </tr>
            <tr >
	...
	{	
		if(((lb_existe=="TRUE")&&(li_cambiar==1))||(lb_existe=="FALSE")&&(li_incluir==1))
		{
			...
			if ((codproy!="")&&(nomproy!="")&&(codestpro1!="")&&(codestpro2!="")&&(codestpro3!="")&&(codestpro4!="")&&(codestpro5!=""))
			{
				...
				f.action="sigesp_sno_p_hproyecto.php";
				f.submit();
			}
			else
			{
...
{
	window.open("sigesp_sno_cat_hproyecto.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=yes");
}
