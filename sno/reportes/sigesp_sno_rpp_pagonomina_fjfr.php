<?php
	...
	function uf_print_cabecera($as_cedper,$as_apenomper,$as_descar,$as_desuniadm,$ad_fecingper,$as_codcueban,$la_sueper,$la_ubicacion,&$io_pdf)
	{
		...
		$la_configt=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>157, // Orientación de la tabla
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cedula'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
									   ...
									   'unidad'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
										...
										'suelbas'=>array('justification'=>'left','width'=>60))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cedula'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
									   ...
									   'unidad'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
									    ...
									    'suelbas'=>array('justification'=>'center','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);	
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'nombre'=>array('justification'=>'left','width'=>240), // Justificación y ancho de la columna
	...
	function uf_print_piecabecera($ai_totalasignacion,$ai_totaldeduccion,$ai_totalaporte,$ai_total_neto,$as_obsrecper,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('totales'=>array('justification'=>'right','width'=>310), // Justificación y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('neto0'=>array('justification'=>'right','width'=>80),
								...
								'neto3'=>array('justification'=>'right','width'=>160))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_piepagina($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,$li_contador,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>180), // Justificación y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>95), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>95), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>95))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		
		$la_data=array(array('titulo'=>'','asignacion'=>'<b>Asignación</b>',
							 'deduccion'=>'<b>Deducción</b>','neto'=>'<b>Neto</b>'));
		$la_columna=array('titulo'=>'','asignacion'=>'','deduccion'=>'','neto'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data=array(array('titulo'=>'<b>Total Bolívares '.$ls_bolivares.': </b>','asignacion'=>$ai_totasi,
		...
		$io_pdf->addText(55,121,8,"Elabora"); // Agregar el título
		$io_pdf->addText(55,65,8,"Análista"); // Agregar el título
		
		$io_pdf->line(150,60,150,130);	//VERTICAL	
		$io_pdf->addText(215,121,8,"Revisa"); // Agregar el título
		$io_pdf->addText(185,65,8,"Director(a) Recursos Humanos"); // Agregar el título
		
		$io_pdf->line(460,60,460,130);	//VERTICAL
		
		$io_pdf->line(310,60,310,130);	//VERTICAL
		$io_pdf->addText(365,121,8,"Valida"); // Agregar el título
		$io_pdf->addText(345,65,8,"Director(a) Administración"); // Agregar el título
		
        $io_pdf->addText(505,121,8,"Aprueba"); // Agregar el título
		$io_pdf->addText(505,65,8,"Presidente"); // Agregar el título
