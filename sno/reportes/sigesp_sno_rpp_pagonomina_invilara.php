<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		// $io_pdf->line(50,678,555,678);
		$io_pdf->line(50,670,555,670);
		...
		$io_pdf->addText($tm,708,10,$as_desnom); // Agregar el título
		// Cambio...
		// $io_pdf->addText($tm,720,10,$as_desnom); // Agregar el título
		//////////////////////////////////////////////////////////////////////////
		/*
		...
		*/
		$io_pdf->ezSetY(710);
		$la_data[1]=array('programa'=>'<b>Unidad Administrativa</b>',
						   'cedula'=>'<b>Cédula</b>',
						   'nombre'=>'<b>Apellidos y Nombres</b>',
						   'cargo'=>'<b>Cargo</b>',
						   'fecha'=>'<b>Fecha de Ing.</b>');
		$la_columnas=array('programa'=>'',
						   'cedula'=>'',
						   'nombre'=>'',
						   'cargo'=>'',
						   'fecha'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('programa'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'cedula'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'nombre'=>array('justification'=>'center','width'=>130), // Justificación y ancho de la columna
						 			   'cargo'=>array('justification'=>'center','width'=>130), // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   ...
						 			   'neto'=>array('justification'=>'center','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);	
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($as_cedper,$as_apenomper,$as_descar,$as_desuniadm,$ad_fecingper,$as_codcueban,&$io_pdf)
	{
		...
		// $io_pdf->ezSetDy(-5);
		$io_pdf->ezSetDy(-12);
		$la_data[1]=array('programa'=>$as_desuniadm,
						   'cedula'=>$as_cedper,
						   'nombre'=>$as_apenomper,
						   'cargo'=>$as_descar,
						   'fecha'=>$ad_fecingper);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('programa'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'cedula'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'nombre'=>array('justification'=>'left','width'=>130), // Justificación y ancho de la columna
	...
	function uf_print_piecabecera($ai_totalasignacion,$ai_totaldeduccion,$ai_totalaporte,$ai_total_neto,$as_obsrecper,&$io_pdf)
	{
		...
		$la_data=array(array('totales'=>'<b>**Totales '.$ls_bolivares.'**</b>','asignacion'=>'<b>'.$ai_totalasignacion.'</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>480, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('totales'=>array('justification'=>'right','width'=>240), // Justificación y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($lb_valido)
			{
				...
				$li_neto_pagar=$li_neto_pagar+$li_total_neto;
				$li_tot_asig_acum=$li_tot_asig_acum+$li_totalasignacion;
				$li_tot_dedu_acum=$li_tot_dedu_acum+$li_totaldeduccion;
		...
		$li_neto_pagar=$io_fun_nomina->uf_formatonumerico($li_neto_pagar);
