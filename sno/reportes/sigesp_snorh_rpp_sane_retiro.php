<?php
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte("SNR","sigesp_snorh_r_sane_retiro.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_cabecera(&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nro'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   ...
						 			   'causa'=>array('justification'=>'center','width'=>75))); // Justificación y ancho de la columna
	...
	$ls_titulo="<b>Listado de Registro de Retiro</b>";
	$ls_titulo2="<b>(Forma 14-03)</b>";
	...
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_sane_retiro($ls_codperdes,$ls_codperhas,$ls_orden); // Cargar el DS con los datos del reporte
	}
	...
	else  // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$ls_cauegrper=$io_report->DS->data["cauegrper"][$li_i];
			switch($ls_cauegrper)
			{
				case "D": // Despido
					$ls_cauegrper="Despido";
					break;
				case "R": // Renuncia
					$ls_cauegrper="Renuncia";
					break;
				case "J": // Jubilado
					$ls_cauegrper="Jubilado";
					break;
				case "P": // Pensionado
					$ls_cauegrper="Pensionado";
					break;
				case "T": // Traslado
					$ls_cauegrper="Traslado";
					break;
				case "F": // Fallecido
					$ls_cauegrper="Fallecido";
					break;
			}
			$la_data[$li_i]=array('nro'=>$li_i,'cedula'=>$ls_cedper,'nombre'=>$ls_nomper,'fecha'=>$ld_fecegrper,'causa'=>$ls_cauegrper);
		}
