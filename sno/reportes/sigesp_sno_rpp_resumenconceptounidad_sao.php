<?php
	...
	function uf_print_piedetalle($ai_totalasignacion,$ai_totaldeduccion,$ai_totalaporte,$ai_total_neto,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('totales'=>array('justification'=>'right','width'=>290), // Justificación y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'aporte'=>array('justification'=>'right','width'=>70))); // Justificación y ancho de la columna
	...
	function uf_print_piecabecera($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('asignacion'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
						 			   'aporte'=>array('justification'=>'center','width'=>150))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('name'=>array('justification'=>'right','width'=>250), // Justificación y ancho de la columna
						 			   'total'=>array('justification'=>'left','width'=>250))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_firmas(&$io_pdf)
	{
		...
		$io_pdf->addText(500,132,7,"Fecha    ".date("d/m/Y")); // Agregar el título
		$io_pdf->addText(40,122,7,"Elaborado Por:"); // Agregar el título
		$io_pdf->addText(38,77,7,"Gustavo A. Oviedo"); // Agregar el título
		...
		$io_pdf->addText(190,122,7,"Revisado:"); // Agregar el título
		$io_pdf->addText(170,71,7,"Lcda. Juana Puertas"); // Agregar el título
		$io_pdf->addText(140,64,7,"Jefe(E) de Recursos Humanos del SAO"); // Agregar el título
		
		$io_pdf->addText(340,122,7,"Autorizado Por:"); // Agregar el título
		$io_pdf->addText(327,77,7,"Dra. Gloria B. Soler A."); // Agregar el título
		$io_pdf->addText(305,70,7,"Presidenta del Servicio Desconcentrado"); // Agregar el título
                $io_pdf->addText(320,63,7,"Oncologico del Estado Lara"); // Agregar el título 
