<?php
	...
	function uf_print_cabecera(&$io_pdf)
	{
		...
		$la_data[1]=array('cedper'=>'<b>Cédula del Personal</b>',						
						  ...
						  'cedaut'=>'<b>Cédula del Autorizado</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cedper'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   ...
						 			   'cedaut'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'nomaut'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'innerLineThickness' =>0.5,
						 'xPos' => 312,
						 'cols'=>array('cedper'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'cedben'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'cedaut'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'nomaut'=>array('justification'=>'right','width'=>100), // Justificación y ancho de la columna
						 			   'monto'=>array('justification'=>'right','width'=>60),
									   'banco'=>array('justification'=>'center','width'=>80),
									   'forma'=>array('justification'=>'center','width'=>60),
									   'cuenta'=>array('justification'=>'right','width'=>85))); // Justificación y ancho de la columna
