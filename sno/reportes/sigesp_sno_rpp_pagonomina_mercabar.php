		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($lb_valido)
			{
				...
				while(!$io_report->rs_data_detalle->EOF)
				{
					...
					$li_cantidad=number_format($io_report->rs_data_detalle->fields["unidad"],2);
					if ($li_cantidad == 0)
					{
						$li_cantidad="";
					}
					...
					$la_data[$li_s]=array('codigo'=>$ls_codconc,'nombre'=>$ls_nomcon."  ".$li_cantidad,'asignacion'=>$li_asignacion,
