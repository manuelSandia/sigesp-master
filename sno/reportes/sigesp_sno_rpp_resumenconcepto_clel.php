<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],65,720,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		...
		$io_pdf->addText(35,780,7,'República Bolivariana de Venezuela'); // Agregar el título
              $io_pdf->addText(35,770,7,'Consejo Legislativo del Estado Lara '); // Agregar el título
