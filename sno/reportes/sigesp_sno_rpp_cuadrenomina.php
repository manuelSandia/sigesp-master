<?php
	...
	function uf_print_cabecera(&$io_pdf)
	{
		...
		$la_data[1]=array('codigo'=>'<b>Código</b>',
						   ...
						   'anterior'=>'<b>Nomina Anterior</b>',
						   'actual'=>'<b>Nomina Actual</b>',
						   'movimiento'=>'<b>Diferencia</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>70), // Justificaciï¿½n y ancho de la columna
						 			   ...
						 			   'anterior'=>array('justification'=>'center','width'=>90), // Justificaciï¿½n y ancho de la columna
						 			   'actual'=>array('justification'=>'center','width'=>90), // Justificaciï¿½n y ancho de la columna
						 			   'movimiento'=>array('justification'=>'center','width'=>90))); // Justificaciï¿½n y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		//	    		   io_pdf // Instancia de objeto pdf
		//    Description: funciï¿½n que imprime el detalle de la nï¿½mina
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaciï¿½n: 29/04/2006 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_piecabecera($ai_totprevio,$ai_totactual,$ai_totmovimiento,$ai_totconc,&$io_pdf)
	{
		...
		//	    		   io_pdf // Instancia de objeto pdf
		//    Description: funciï¿½n que imprime el fin de la cabecera por cuadre
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaciï¿½n: 02/05/2006 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $ls_bolivares;

		$la_data[0]=array('descripcion'=>'<b>Total Conceptos '.$ls_bolivares.'</b> ('.$ai_totconc.')','anterior'=>$ai_totprevio,'actual'=>$ai_totactual,'movimiento'=>$ai_totmovimiento);
		$la_columna=array('descripcion'=>'','anterior'=>'','actual'=>'','movimiento'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaï¿½o de Letras
						 'titleFontSize' => 12,  // Tamaï¿½o de Letras de los tï¿½tulos
						 'showLines'=>1, // Mostrar Lï¿½neas
						 ...
						 'maxWidth'=>500, // Ancho Mï¿½ximo de la tabla
						 'xOrientation'=>'center', // Orientaciï¿½n de la tabla
						 'cols'=>array('descripcion'=>array('justification'=>'right','width'=>230), // Justificaciï¿½n y ancho de la columna
						 			   'anterior'=>array('justification'=>'center','width'=>90), // Justificaciï¿½n y ancho de la columna
						 			   'actual'=>array('justification'=>'center','width'=>90), // Justificaciï¿½n y ancho de la columna
						 			   'movimiento'=>array('justification'=>'center','width'=>90))); // Justificaciï¿½n y ancho de la columna
		...
		$io_pdf->addText(420,102,7,'<b>APROBADO POR: xxx</b>  '); // Agregar el tï¿½tulo
	...
	else  // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3.5,2.5,3,3); // Configuraciï¿½n de los margenes en centï¿½metros
