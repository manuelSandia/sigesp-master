<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_insert_seguridad($as_titulo,$as_desnom,$as_periodo,$ai_tipo,$as_codnom)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_codnom1=$_SESSION["la_nomina"]["codnom"];
		if(!empty($ls_codnom1))
		{
			$nomina = $ls_codnom1;
		}else
		...
		if($ai_tipo==1)
		{
			$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte_nomina("SNO","sigesp_sno_r_recibopago.php",$ls_descripcion,$nomina);
		}
		if($ai_tipo==2)
		{
			$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte_nomina("SNO","sigesp_sno_r_hrecibopago.php",$ls_descripcion,$nomina);
		}
		if($ai_tipo==3)
		{
			$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte("SNR","sigesp_snorh_r_recibopago.php",$ls_descripcion,$nomina);
		}
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,$as_desuniadm,&$io_pdf,$as_anocur,$ad_fecdesper)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText($tm,750,7,$as_titulo1); // Agregar el t�tulo
		$tm=390-($li_tm/2);
		$as_titulo2='INSTITUTO DE PREVISION SOCIAL DE LA';
		$io_pdf->addText($tm,740,7,$as_titulo2); // Agregar el t�tulo
		$tm=425-($li_tm/2);
		$as_titulo3='FUERZA ARMADA';
		$io_pdf->addText($tm,730,7,$as_titulo3); // Agregar el t�tulo
		$tm=425-($li_tm/2);
		$io_pdf->addText(300,705,7,'UBICACION'); // Agregar el t�tulo	
		$io_pdf->Rectangle(230,700,200,14);
		$io_pdf->addText(445,705,7,'FECHA'); // Agregar el t�tulo	
		$io_pdf->Rectangle(430,700,50,14);
		$io_pdf->addText(490,705,7,'NUMERO'); // Agregar el t�tulo	
		$io_pdf->Rectangle(480,700,50,14);
		$io_pdf->addText(235,690,7,$as_desuniadm); // Agregar el t�tulo
		$io_pdf->Rectangle(230,686,200,14);
		if(!empty($as_anocur))
		{
		$io_pdf->addText(440,690,7,$as_anocur); // Agregar el t�tulo
		}else
		{
		//$io_pdf->addText(440,690,7,date('d/m/Y')); // Agregar el t�tulo
		$io_pdf->addText(440,690,7,$ad_fecdesper); // Agregar el t�tulo
		}
		$io_pdf->Rectangle(430,686,50,14);
		$io_pdf->Rectangle(480,686,50,14);	
		$tm=420-($li_tm/2);	
		$io_pdf->addText($tm,665,8,'DATOS DEL PERSONALES'); // Agregar el t�tulo
								...
								$total,$as_agencia,&$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-30);
		//-------------------------------------------------------------------------------------------------------------------
		$la_data_1[1]=array('cedula'=>'CEDULA',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'rowGap' => 0.5 ,		 
						 'cols'=>array('cedula'=>array('justification'=>'center','width'=>100), // Justificaci�n y ancho de la columna
						 			   'nombre'=>array('justification'=>'center','width'=>225),
									   'cargo'=>array('justification'=>'center','width'=>225))); // Justificaci�n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientaci�n de la tabla
						 'rowGap' => 0.5 ,
						 'cols'=>array('dato'=>array('justification'=>'center','width'=>550))); // Justificaci�n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientaci�n de la tabla
						 'rowGap' => 0.5 ,
						 'cols'=>array('banco'=>array('justification'=>'center','width'=>150), // Justificaci�n y ancho de la columna
						 			   'sucursal'=>array('justification'=>'center','width'=>190),
									   'cuenta'=>array('justification'=>'center','width'=>110),
									   'tipo'=>array('justification'=>'center','width'=>100))); // Justificaci�n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientaci�n de la tabla
						 'rowGap' => 0.5 ,
						 'cols'=>array('sueldo'=>array('justification'=>'center','width'=>90), // Justificaci�n y ancho de la columna
									   ...
									   'total'=>array('justification'=>'center','width'=>90))); // Justificaci�n y ancho de la columna
		...
		unset($la_config);
		$io_pdf->ezSetDy(-5);				
		$la_data[1]=array('codigo'=>'<b>CODIGO</b>', 
						  'denominacion'=>'<b>DESCRIPCION DEL CONCEPTO</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>65), // Justificaci�n y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>205), // Justificaci�n y ancho de la columna
									   'cuotas'=>array('justification'=>'center','width'=>100),
						 			   'asignacion'=>array('justification'=>'center','width'=>90), // Justificaci�n y ancho de la columna
						 			   'deduccion'=>array('justification'=>'center','width'=>90))); // Justificaci�n y ancho de la columna
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>540, // Ancho M�ximo de la tabla
						 'xPos'=>315,
						 'cols'=>array('total'=>array('justification'=>'center','width'=>370), // Justificaci�n y ancho de la columna						 			   
						 			   'asignacion'=>array('justification'=>'right','width'=>90), // Justificaci�n y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>90))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
...
//-----------------------------------------------------  Instancia de las clases  ------------------------------------------------
	...
	$ls_tiporeporte="0";
	$ls_bolivares ="Bs.";
	$validoconsolidado = $io_fun_nomina->uf_obtenervalor_get("tiporeporte2","");

	if($validoconsolidado == '3')
	{
	...
	{
		if($_SESSION["la_nomina"]["tiponomina"])
		{
	...
	if($li_tipo==3)
	{
		...
		$ls_anocur=$io_fun_nomina->uf_obtenervalor_get("fecdesper","");
		$ls_codperiodo=$io_fun_nomina->uf_obtenervalor_get("codperides","");
	}
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=uf_insert_seguridad($ls_titulo,$ls_desnom,$ls_periodo,$li_tipo,$ls_codnom); // Seguridad de Reporte
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_recibopago_personal($ls_codperdes,$ls_codperhas,$ls_coduniadm,$ls_conceptocero,$ls_conceptop2,$ls_conceptoreporte,$ls_codubifis,$ls_codpai,$ls_codest,$ls_codmun,$ls_codpar,$ls_subnomdes,$ls_subnomhas,$ls_orden,$ls_codnom,$ls_anocur,$ls_codperiodo,$li_tipo); // Cargar el DS con los datos de la cabecera del reporte
	}
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(4,1,1,2); // Configuraci�n de los margenes en cent�metros		
		...
		{  
			...
			if ($ls_descasicar!="Sin Asignacion de Cargo" and $ls_descasicar!="" and $ls_descasicar!="Sin Cargo")
			{
				$ls_descar=$ls_descasicar;
			
			}
			//echo 'descar = '.$ls_descar.'      descasicar =    '.$ls_descasicar;
			...
			{
				$li_sueper=number_format($io_report->rs_data->fields["sueobr"],2,",",".");
			}
			else
			{
			...
			//---------------------------CONCEPTOS--------------------------------------------------------------------------------
			$io_report->uf_obtener_valor_concepto($ls_codper,'0000000003',&$ls_valor,$li_tipo,$ls_codperiodo,$ls_codnom);//////compensaci�n
			$ls_compensacion=$ls_valor;
			$io_report->uf_obtener_valor_concepto($ls_codper,'0000000013',&$ls_valor,$li_tipo,$ls_codperiodo,$ls_codnom);//////decreto 5318
			$ls_prima_prof=$ls_valor;
			$io_report->uf_obtener_valor_concepto($ls_codper,'0000000005',&$ls_valor,$li_tipo,$ls_codperiodo,$ls_codnom);//////prima antiguedad empleado
			$ls_prima_ant=$ls_valor;
			$io_report->uf_obtener_valor_concepto($ls_codper,'0000000012',&$ls_valor,$li_tipo,$ls_codperiodo,$ls_codnom);//////decreto 6660
			$ls_decreto_6660= $ls_valor;
			$sueldo=$io_report->rs_data->fields["sueper"];
			
			if ($ls_tiponom =='3' || $ls_tiponom =='4')
			{
				$sueldo=$io_report->rs_data->fields["sueobr"];
			}
			else
			{
				$sueldo=$io_report->rs_data->fields["sueper"];
			...
			$total=$sueldo+$ls_compensacion+$ls_prima_ant+$ls_prima_prof+$ls_decreto_6660;
			
			//--------------------------------------------------------------------------------------------------------------------
			uf_print_encabezado_pagina1($ls_titulo,$ls_desnom,$ls_periodo,$ls_desuniadm,$io_pdf,$ls_anocur,$ld_fecdesper); // Imprimimos el encabezado de la p�gina
			if($li_reg==1)
			{   
				uf_print_cabecera1($ls_codper,$ls_cedper,$ls_nomper,$ls_descar,$ls_codcueban,$ls_desuniadm,$ld_fecingper,
								   $li_sueper,$ls_desnom,$ls_tipo,$ls_banco,
								   $io_fun_nomina->uf_formatonumerico(abs($ls_compensacion)),
								   $io_fun_nomina->uf_formatonumerico(abs(0)),
								   $io_fun_nomina->uf_formatonumerico(abs($ls_decreto_6660)),
								   $io_fun_nomina->uf_formatonumerico(abs($ls_prima_ant+$ls_prima_prof)),
								   $io_fun_nomina->uf_formatonumerico(abs($total)),
								   $ls_agencia,$io_pdf); // Imprimimos la cabecera del registro
			}			
			
			$lb_valido=$io_report->uf_recibopago_conceptopersonal($ls_codper,$ls_conceptocero,$ls_conceptop2,$ls_conceptoreporte,$ls_tituloconcepto,$ls_quincena,$ls_codnom,$ls_anocur,$ls_codperiodo,$li_tipo); // Obtenemos el detalle del reporte
			...
			if($lb_valido)
			{
				...
				if($li_reg==1)
				{
					...
					$io_report->uf_seleccionar_quincenas($ls_codper,&$ls_priqui,&$ls_segqui,$ls_codnom,$ls_codperiodo,$li_tipo);
