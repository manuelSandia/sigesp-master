<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],60,720,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		...
		$io_pdf->addText(35,785,7,'República Bolivariana de Venezuela'); // Agregar el título
              $io_pdf->addText(35,775,7,'Consejo Legislativo del Estado Lara '); // Agregar el título
              $io_pdf->addText(45,715,7,'Oficina de Recursos Humanos '); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
