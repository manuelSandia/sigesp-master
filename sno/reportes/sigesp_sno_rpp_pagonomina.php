<?php
	...
	function uf_print_cabecera($as_cedper,$as_apenomper,$as_descar,$as_desuniadm,$ad_fecingper,$as_codcueban,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cedula'=>array('justification'=>'center','width'=>70), // Justificaciï¿½n y ancho de la columna
						 			   'nombre'=>array('justification'=>'center','width'=>110), // Justificaciï¿½n y ancho de la columna
						 			   'cargo'=>array('justification'=>'center','width'=>120),// Justificaciï¿½n y ancho de la columna
									   'unidad'=>array('justification'=>'center','width'=>120), // Justificaciï¿½n y ancho de la columna
	...
	function uf_print_piecabecera($ai_totalasignacion,$ai_totaldeduccion,$ai_totalaporte,$ai_total_neto,$as_obsrecper,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientaciï¿½n de la tabla
						 'cols'=>array('name'=>array('justification'=>'left','width'=>500))); // Justificaciï¿½n y ancho de la columna
	...
	if(($lb_valido==false) || ($li_totrow == 0) )// Existe algï¿½n error ï¿½ no hay registros
	{
		print("<script language=JavaScript>");
