<?php
	...
	function uf_print_cabecera(&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array(//'nro'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   'codigo'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   ...
						 			   'deduccion'=>array('justification'=>'center','width'=>80)
	...
	function uf_print_piecabecera($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,&$io_pdf)
	{
		...
		$la_columna=array('titulo'=>'','asignacion'=>'','deduccion'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>700, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('name'=>array('justification'=>'right','width'=>600), // Justificación y ancho de la columna
						 			   'total'=>array('justification'=>'left','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	}

function uf_print_piecabecera2($ai_total,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$la_data=array(array('elaborado'=>'<b>Elaborado</b>','conformado'=>'<b>Conformado</b>','jefeunidad'=>'<b>Jefe de Unidad</b>','directorpersonal'=>'<b>Director de Personal</b>'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('elaborado'=>array('justification'=>'right','width'=>100), // Justificación y ancho de la columna
'conformado'=>array('justification'=>'right','width'=>100),
'jefeunidad'=>array('justification'=>'right','width'=>150),
						 			   'directorpersonal'=>array('justification'=>'right','width'=>150))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
	}
	...
	else  // Imprimimos el reporte
	{
		...
		uf_print_piecabecera2($li_totgeneral,$io_pdf); // Imprimimos el pie de la cabecera
