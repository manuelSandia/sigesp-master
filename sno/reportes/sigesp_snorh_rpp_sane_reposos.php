<?php
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		// Fecha Creación: 31/07/2006 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_fun_nomina;
		$ls_descripcion="Generó el Reporte ".$as_titulo;
		$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte("SNR","sigesp_snorh_r_sane_reposos.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo2,&$io_pdf)
	{
		...
		//		   Access: private 
		//	    Arguments: as_titulo // Título del Reporte
		//	    		   as_titulo2 // Título 2 del Reporte
	...
	function uf_print_cabecera(&$io_pdf)
	{
		...
		$la_data[1]=array('nro'=>'<b>Nro</b>',
						   ...
						   'desde'=>'<b>Periodo Reposo Desde</b>',
						   'hasta'=>'<b>Periodo Reposo Hasta</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nro'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   ...
						 			   'desde'=>array('justification'=>'center','width'=>115), // Justificación y ancho de la columna
						 			   'hasta'=>array('justification'=>'center','width'=>115))); // Justificación y ancho de la columna
	...
	$ls_titulo="<b>Listado de Registro de Reposos</b>";
	$ls_titulo2="<b>Médicos (Forma 14-10)</b>";
	...
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_sane_reposos($ls_codperdes,$ls_codperhas,$ls_fecdes,$ls_fechas,$ls_orden); // Cargar el DS con los datos del reporte
	}
