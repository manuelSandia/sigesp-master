<?php
	...
	function uf_print_cabecera($as_cedper,$as_nomper,$as_apeper,$as_estper,$as_dirper,$as_telhabper,$as_telmovper,$as_coreleper,
							   &$io_cabecera,&$io_pdf,$unidad_admin='')
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(45,510,9,'<b>Datos del Personal   Unidad Admin.:</b><c:covensol_color:000099>'.$unidad_admin.'</c:covensol_color>'); // Agregar el título
		$io_pdf->ezSetY(500);
	...
	function uf_print_datos($la_data,&$io_pdf)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetDy(-1);
		$la_columna=array('numper'=>'<b>Nro</b>','feciniper'=>'<b>Inicio</b>','fecfinper'=>'<b>Fin</b>','numdiaper'=>'<b>Nro de Días</b>',
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
		{
			...
			$ls_uniadmin=$io_report->DS->data["desuniadm"][$li_i];
			switch ($ls_estper)
			{
				case "0":
			...
			uf_print_cabecera($ls_cedper,$ls_nomper,$ls_apeper,$ls_estper,$ls_dirper,$ls_telhabper,$ls_telmovper,$ls_coreleper,
							  &$io_cabecera,&$io_pdf,$ls_uniadmin);
			$lb_valido=$io_report->uf_permisospersonal_permiso($ls_codper,$ls_fec_des,$ls_fec_has,$ls_tipo_permiso); // Obtenemos el detalle del reporte
			if($lb_valido)
			{
