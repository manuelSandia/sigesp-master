<?php
	...
	function uf_print_cabecera($as_codproy,$as_nomproy,&$io_cabecera,&$io_pdf)
	{
		...
		//		   Access: private 
		//	    Arguments: as_codproy // Código de Proyecto
		//	   			   as_nomproy // Nombre de Proyecto
		//	    		   io_cabecera // objeto cabecera
		//	    		   io_pdf // Instancia de objeto pdf
		//    Description: función que imprime la cabecera por proyecto
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creación: 01/08/2007 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->saveState();
		...
		$io_pdf->addText(55,695,11,'<b>Proyecto</b>  '.$as_codproy.' - '.$as_nomproy.''); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
