<?php
	...
	function uf_print_cabecera(&$io_pdf)
	{
		...
		$la_data[1]=array('codigo'=>'<b>Código</b>',
						  ...
						  'edad'=>'<b>Edad</b>',
						  'unidad'=>'<b>Unidad de Adscripción</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
						 			   ...
						 			   'fecha'=>array('justification'=>'center','width'=>54), // Justificación y ancho de la columna
						 			   'edad'=>array('justification'=>'center','width'=>35), // Justificación y ancho de la columna
									   'unidad'=>array('justification'=>'center','width'=>90))); // Justificación y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
						 			   ...
						 			   'fecha'=>array('justification'=>'center','width'=>54), // Justificación y ancho de la columna
						 			   'edad'=>array('justification'=>'center','width'=>35), // Justificación y ancho de la columna
									   'unidad'=>array('justification'=>'left','width'=>90))); // Justificación y ancho de la columna)); // Justificación y ancho de la columna
