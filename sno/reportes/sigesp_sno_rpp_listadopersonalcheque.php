<?php
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_piecabecera($ai_total,$ai_totpersonas,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$la_data[0]=array('name'=>'<b>Total Personas: </b>','neto'=>$ai_totpersonas);
		$la_data[1]=array('name'=>'<b>Total a girar en cheques '.$ls_bolivares.': </b>','neto'=>$ai_total);
		$la_columna=array('name'=>'','neto'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 10, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$io_pdf->addText(220,102,7,'<b>APROBADO POR: XXXX:</b>'); // Agregar el tï¿½tulo
