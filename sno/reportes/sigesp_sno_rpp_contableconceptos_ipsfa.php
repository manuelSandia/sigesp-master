<?php
	...
	function uf_print_frimas (&$io_pdf)
	{
		...
		$la_data=array(array('name1'=>'','name2'=>'', 'name3'=>''));
		...
		$la_data1=array(array('name1'=>'<b>Elaborado Por</b>','name2'=>'<b>Conformado Por</b>', 'name3'=>'<b>Aprobado Por</b>'));	
		...
		$la_config1=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
				 		 'cols'=>array('name1'=>array('justification'=>'center','width'=>167), // Justificación y ancho de la columna
						               'name2'=>array('justification'=>'center','width'=>166), // Justificación y ancho de la columna
						 			   'name3'=>array('justification'=>'center','width'=>167))); // Justificación y ancho de la columna
		...
		$la_data1=array(array('name1'=>'<b>Contabilidad</b>','name2'=>'<b>Ejecución Presupuestaria</b>'));	
		$la_columna1=array('name1'=>'','name2'=>'');
		$la_config1=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 ...
						 'width'=>550, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
				 		 'cols'=>array('name1'=>array('justification'=>'center','width'=>250), // Justificación y ancho de la columna
						               'name2'=>array('justification'=>'center','width'=>250))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data1,$la_columna1,'',$la_config1);
		
		$la_data2[1]=array('name1'=>'','name2'=>'');
		$la_data2[2]=array('name1'=>'','name2'=>'');
		$la_data2[3]=array('name1'=>'','name2'=>'');	
		$la_data2[4]=array('name1'=>'','name2'=>'');	
		$la_columna2=array('name1'=>'','name2'=>'');
		$la_config2=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' =>9, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
	...
	else // Imprimimos el reporte
	{
		...
		if($li_totrow>0)
		{
			...
			uf_print_frimas ($io_pdf); //imprimimos las firmas
			unset($la_data);
		}		
		//-------------------------------------------------------------------------------------------------------------------------------	
