<?php
	...
	function uf_insert_seguridad($as_titulo,$as_desnom,$as_periodo,$ai_tipo)
	{
		...
		// Fecha Creaci�n: 07/08/2007 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_fun_nomina;
		
		$ls_codnom=$_SESSION["la_nomina"]["codnom"];
		$ls_descripcion="Genera el Reporte ".$as_titulo.". Para ".$as_desnom.". ".$as_periodo;
		if($ai_tipo==1)
		{
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->setColor(0.9,0.9,0.9);
        	$io_pdf->filledRectangle(50,685,500,$io_pdf->getFontHeight(14));
       		$io_pdf->setColor(0,0,0);

		$io_pdf->addText(65,695,9,'Cedula'); // Agregar la Cedula
		$io_pdf->addText(235,695,9,'Nombre'); // Agregar Apellidos y Nombres
		$io_pdf->addText(435,695,9,'Cargo'); // Agregar el cargo

		$io_pdf->setColor(0.9,0.9,0.9);
        	$io_pdf->filledRectangle(50,673,500,$io_pdf->getFontHeight(14));
       		$io_pdf->setColor(0,0,0);

		$io_pdf->addText(67,683,9,'Codigo'); // Agregar la Cedula
		$io_pdf->addText(210,683,9,'Concepto'); // Agregar Apellidos y Nombres
		$io_pdf->addText(320,683,9,'Asignacion'); // Agregar el cargo
		$io_pdf->addText(400,683,9,'Deduccion'); // Agregar Apellidos y Nombres
		$io_pdf->addText(490,683,9,'Neto'); // Agregar el cargo
							   ...
							   &$io_cabecera,&$io_pdf)
	{
		...
		//		   Access: private 
		//	    Arguments: as_minorguniadm // C�digo de la unidad
		...
		$io_pdf->saveState();
       	 	$io_pdf->setColor(0.9,0.9,0.9);
        	$io_pdf->filledRectangle(50,665,500,$io_pdf->getFontHeight(14));
       		 $io_pdf->setColor(0,0,0);
		$io_pdf->addText(55,670,9,'<b>Unidad Administrativa</b> '.$as_minorguniadm.'-'.$as_ofiuniadm.'-'.$as_uniuniadm.'-'.$as_depuniadm.'-'.$as_prouniadm.'  '.$as_desuniadm.''); // Agregar el t�tulo
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera_personal($as_cedper,$as_apenomper,$as_descar,$as_desuniadm,$ad_fecingper,$as_codcueban,&$io_pdf)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
		$la_data=array(array('cedula'=>'<b>C�dula</b>','nombre'=>'<b>Nombre</b>','cargo'=>'<b>Cargo</b>','fecha'=>'<b>Fecha Ingreso</b>'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cedula'=>array('justification'=>'center','width'=>60), // Justificaci�n y ancho de la columna
						 			   ...
						 			   'cargo'=>array('justification'=>'center','width'=>180),// Justificaci�n y ancho de la columna
						 			   'fecha'=>array('justification'=>'center','width'=>80))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);	
*/
		$io_pdf->ezSetDy(-40);
		$la_data=array(array('cedula'=>$as_cedper,'nombre'=>$as_apenomper,'cargo'=>$as_descar));
		$la_columnas=array('cedula'=>'',
						   'nombre'=>'',
						   'cargo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cedula'=>array('justification'=>'center','width'=>100), // Justificaci�n y ancho de la columna
						 			   ...
						 			   'cargo'=>array('justification'=>'left','width'=>200))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);	
	}// end function uf_print_cabecera
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_piecabecera($ai_totalasignacion,$ai_totaldeduccion,$ai_totalaporte,$ai_total_neto,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho M�ximo de la tabla
						 'xOrientation'=>'center', // Orientaci�n de la tabla
						 'cols'=>array('totales'=>array('justification'=>'right','width'=>260), // Justificaci�n y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>80), // Justificaci�n y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>80), // Justificaci�n y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>80))); // Justificaci�n y ancho de la columna
	...
	function uf_print_piepagina($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,$as_desuniadm,&$io_pdf)
	{
		...
		//	   			   as_desuniadm // Descripci�n Unidad Administrativa
		//	    		   io_pdf // Instancia de objeto pdf
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho M�ximo de la tabla
						 'xOrientation'=>'center', // Orientaci�n de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>260), // Justificaci�n y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>80), // Justificaci�n y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>80), // Justificaci�n y ancho de la columna
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_piepagina_total($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,$li_count_per,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_piepagina
		//		   Access: private 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500); // Ancho M�ximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$la_data=array(array('titulo'=>'<b>TOTAL PERSONAS : '.$li_count_per,
				'titulo2'=>'TOTAL NOMINA : '.$ls_bolivares.': </b>',
				'asignacion'=>$ai_totasi,
				'deduccion'=>$ai_totded,'neto'=>$ai_totgeneral));
		$la_columna=array('titulo'=>'','titulo2'=>'','asignacion'=>'','deduccion'=>'','neto'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tama�o de Letras
						 'titleFontSize' => 12,  // Tama�o de Letras de los t�tulos
						 'showLines'=>0, // Mostrar L�neas
						 ...
						 'maxWidth'=>500, // Ancho M�ximo de la tabla
						 'xOrientation'=>'center', // Orientaci�n de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>130), // Justificaci�n y ancho de la columna
									'titulo1'=>array('justification'=>'right','width'=>130),
						 			   'asignacion'=>array('justification'=>'right','width'=>80), // Justificaci�n y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>80), // Justificaci�n y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>80))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		...
		$la_data=array(array('elaborado' =>'<b>Elaborado</b>','conformado'=>'<b>Conformado</b>',
				     'jefeunidad'=>'<b>Jefe de Unidad</b>','directorpersonal'=>'<b>Director de Personal</b>'));
		$la_columna=array('elaborado'=>'','conformado'=>'','jefeunidad'=>'','directorpersonal'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
					 'fontSize' => 10, // Tama�o de Letras
					 'titleFontSize' => 10,  // Tama�o de Letras de los t�tulos
					 'showLines'=>0, // Mostrar L�neas
					 ...
					 'maxWidth'=>500, // Ancho M�ximo de la tabla
					 'xOrientation'=>'center', // Orientaci�n de la tabla
					 'cols'=>array('elaborado'=>array('justification'=>'right','width'=>100), // Justificaci�n y ancho de la co
					 'conformado'=>array('justification'=>'right','width'=>100),
					 'jefeunidad'=>array('justification'=>'right','width'=>150),
					 'directorpersonal'=>array('justification'=>'right','width'=>150))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	}
	...
	$ls_periodo="<b>Periodo Nro ".$ls_peractnom.", ".$ld_fecdesper." - ".$ld_fechasper."</b>";
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			while((!$io_report->rs_data_detalle->EOF)&&($lb_valido))
			{
				...
				if($lb_valido)
				{
					...
					{		
						//$li_count_per=$io_report->rs_data_detalle->RecordCount();
						//$li_count_per++;
					...
					$li_totasi_g=$li_totasi_g+$li_totalasignacion;
					$li_totded_g=$li_totded_g+$li_totaldeduccion;
					$li_totapo_g=$li_totapo_g+$li_totalaporte;
					$li_totgeneral_g=$li_totgeneral_g+$li_total_neto;
...
*/
		...
		//uf_print_piepagina_total($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,&$io_pdf);
		$li_totasi_g=number_format($li_totasi_g,2,",",".");
		$li_totded_g=number_format($li_totded_g,2,",",".");
		$li_totapo_g=number_format($li_totapo_g,2,",",".");
		$li_totgeneral_g=number_format($li_totgeneral_g,2,",",".");
		
		uf_print_piepagina_total($li_totasi_g,$li_totded_g,$li_totapo_g,$li_totgeneral_g,($li_count_per-1),&$io_pdf);
