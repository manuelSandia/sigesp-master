<?php
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,$as_quinmes,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,720,11,$as_periodo." - ".$as_quinmes); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(10,$as_desnom);
		$tm=306-($li_tm/2);
		$ls_codnom=$_SESSION["la_nomina"]["codnom"];
		$io_pdf->addText($tm,710,10,$as_desnom."   ".$ls_codnom); // Agregar el título
	...
	else // Imprimimos el reporte
	{
		...
		if ($ls_quincena==1)
		{
			$ls_quinmes="Adelanto de Quincena";
		}
		elseif($ls_quincena==2)
		{
			$ls_quinmes="Segunda Quincena";
		}
		else
		{
			$ls_quinmes="Mes Completo";
		}
		uf_print_encabezado_pagina($ls_titulo,$ls_desnom,$ls_periodo,$ls_quinmes,$io_pdf); // Imprimimos el encabezado de la página
