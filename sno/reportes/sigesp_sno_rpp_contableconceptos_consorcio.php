<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo2,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->addText(60,121,7,"ELABORADO POR:"); // Agregar el título
		
		$io_pdf->line(170,60,170,130);	//VERTICAL	
		$io_pdf->addText(265,121,7,"REVISADO POR:"); // Agregar el título
		$io_pdf->line(400,60,400,130);	//VERTICAL
		
        $io_pdf->addText(470,121,7,"APROBADO POR:"); // Agregar el título
