<?php
	...
	function uf_print_cabecera(&$io_pdf)
	{
        ...
        $io_pdf->filledRectangle(25,679,550,$io_pdf->getFontHeight(17));
		...
		$la_data[1]=array('numero'=>'<b>Num</b>',
						  ...
						  'bonofin'=>'<b>Alicuota Bono Fin Año</b>',
						  'diafid'=>'<b>Días Fid.</b>',
						  'diaadi'=>'<b>Días Adi.</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numero'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   'periodo'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
						 			   ...
						 			   'sueldointegral'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'bonovacacional'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'bonofin'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'diafid'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   'diaadi'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
		{
			...
			$li_diafid=$io_report->DS->data["diafid"][$li_i];
			$li_diaadi=$io_report->DS->data["diaadi"][$li_i];
			$li_totaldiafid=$li_totaldiafid+$li_diafid;
			$li_totaldiaadi=$li_totaldiaadi+$li_diaadi;
			...
			$la_data[$li_i]=array('numero'=>$li_numper,'periodo'=>$ls_periodo,'cedula'=>$ls_cedper,'nombre'=>$ls_nomper,'sueldointegral'=>$li_sueintper,
							'bonovacacional'=>$li_bonvacper,'bonofin'=>$li_bonfinper,'diafid'=>$li_diafid,'diaadi'=>$li_diaadi,
							'aporte'=>$li_apoper);
		}
		...
		$la_data[1]=array('total'=>'<b>Total '.$ls_titulobs.'</b>','sueldointegral'=>$li_totalsueintper,'bonovacacional'=>$li_totalbonvacper,
						  'bonofin'=>$li_totalbonfinper,'diafid'=>$li_totaldiafid,'diaadi'=>$li_totaldiaadi,'aporte'=>$li_totalapoper);
