<?php
	...
	function uf_print_cabecera($as_codconc,$as_nomcon,&$io_pdf)
	{
       ...
       // $io_pdf->filledRectangle(50,690,500,$io_pdf->getFontHeight(14));
		...
		$io_pdf->addText(55,695,11,'<b>Nombre</b>  '.$as_codconc.' - '.$as_nomcon.''); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_piecabecera($ai_personal,$ai_patron,$ai_total,$io_pdf)
	{
		...
		$la_data[0]=array('name'=>'_________________________________');
		...
		$la_data[0]=array('name'=>'','personal'=>'<b>'.$ai_personal.'</b>','aporte'=>'<b>'.$ai_patron.'</b>');
		$la_data[1]=array('name'=>'','personal'=>'<b>Total Aporte '.$ls_bolivares.'</b>','aporte'=>'<b>'.$ai_total.'</b>');
		$la_columna=array('name'=>'','personal'=>'','aporte'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 'showLines'=>0, // Mostrar Líneas
						 ...
						 'cols'=>array('name'=>array('justification'=>'right','width'=>320), // Justificación y ancho de la columna
						 			   'personal'=>array('justification'=>'right','width'=>100), // Justificación y ancho de la columna
	...
	else  // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$la_data[$li_i]=array('nro'=>$li_i,'cedula'=>$ls_cedper,'nombre'=>$ls_nomper,'personal'=>$li_personal,'patron'=>$li_patron);
		}
