<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->addText(512,750,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(518,743,6,date("h:i a")); // Agregar la Hora
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($as_cedper,$as_apenomper,$as_descar,$as_desuniadm,$ad_fecingper,$as_codcueban,&$io_pdf)
	{
		...
		// Fecha Creación: 26/04/2006 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data[1]=array('cedula'=>'<b>Cédula</b>',
		                  'nombre'=>'<b>Nombre</b>',
						  'cargo'=>'<b>Cargo</b>',
		...
		$la_data[1]=array('cedula'=>$as_cedper,
		                  'nombre'=>$as_apenomper,
						  'cargo'=>$as_descar,
						  'unidad'=>$as_desuniadm,
						  'fecha'=>$ad_fecingper);		
	...
	function uf_print_piecabecera($ai_totalasignacion,$ai_totaldeduccion,$ai_totalaporte,$ai_total_neto,$as_obsrecper,&$io_pdf)
	{
		...
		$la_data[1]=array('totales'=>'<b>Totales '.$ls_bolivares.'</b>',
		                  'asignacion'=>$ai_totalasignacion,
						  'deduccion'=>$ai_totaldeduccion,
	...
	function uf_print_piepagina($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,&$io_pdf)
	{
		...
		$la_data[1]=array('titulo'=>'<b>Total Nómina '.$ls_bolivares.': </b>',
	...
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_pagonomina_personal($ls_codperdes,$ls_codperhas,$ls_conceptocero,$ls_conceptoreporte,
		                                              $ls_conceptop2, $ls_codubifis,$ls_codpai,$ls_codest,$ls_codmun,
													  $ls_codpar,$ls_subnomdes,$ls_subnomhas,$ls_orden,$ls_pagobanco,$ls_pagocheque); // Cargar el DS con los datos de la cabecera del reporte
	}
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			$lb_valido=$io_report->uf_pagonomina_conceptopersonal($ls_codper,$ls_conceptocero,$ls_tituloconcepto,
			                                                      $ls_conceptoreporte,$ls_conceptop2); // Obtenemos el detalle del reporte
			if($lb_valido)
			{
