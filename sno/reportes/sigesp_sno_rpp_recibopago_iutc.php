<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->addText(50,360,8,"Republica Bolivariana de Venezuela");
		$io_pdf->addText(50,350,8,"Ministerio de Educación Superior");
		$io_pdf->addText(50,340,8,"Instituto Universitario de Tecnología de Cabimas");
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,330,11,$as_titulo); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(9,$as_desnom);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,320,9,$as_desnom); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(9,$as_periodo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,305,9,$as_periodo); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($as_cedper,$as_nomper,$as_descar,&$io_cabecera,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->saveState();
		$io_pdf->addText(50,300,'10','____________________________________________________________________________________________');
		$io_pdf->ezSetDy(-11);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>210), // Justificación y ancho de la columna
						 			   ...
						 			   'cargo'=>array('justification'=>'left','width'=>210))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(50,286,'10','____________________________________________________________________________________________');
		$la_data=array(array('nombre'=>$as_nomper, 'cedula'=>$as_cedper, 'cargo'=>$as_descar));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>210), // Justificación y ancho de la columna
						 			   ...
						 			   'cargo'=>array('justification'=>'left','width'=>210))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(50,270,'10','____________________________________________________________________________________________');
		$io_pdf->ezSetDy(-2);
		...
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(50,258,'10','____________________________________________________________________________________________');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	switch(substr($_SESSION["la_nomina"]["fechasper"],5,2))
	{
		case "01":
			$ls_mes="ENERO";
			break;
	...
	$ls_periodo="Mes: <b>".$ls_mes."</b>   Año: <b>".substr($_SESSION["la_nomina"]["fechasper"],0,4)."</b>";
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf=new Cezpdf(array(21.59,13.97),'portrait'); // Instancia de la clase PDF
		...
		{
			print("<script language=JavaScript>");
			print(" alert('Ocurrio un error al generar el reporte. Intente de Nuevo ".$ls_codper."');"); 
			print(" close();");
			print("</script>");		
		}
		unset($io_pdf);
