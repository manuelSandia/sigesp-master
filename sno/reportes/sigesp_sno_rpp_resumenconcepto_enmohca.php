<?php
	...
	function uf_print_piecabecera($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,&$io_pdf)
	{
		...
		$la_data[0]=array('name'=>'_______________________________________________');
		...
		$la_data=array(array('name'=>'<b>Neto '.$ls_bolivares.'</b>','total'=>$ai_totgeneral));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('name'=>array('justification'=>'right','width'=>350), // Justificación y ancho de la columna
						 			   'total'=>array('justification'=>'left','width'=>150))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
