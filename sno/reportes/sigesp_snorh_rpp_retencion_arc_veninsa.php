<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo2,&$io_pdf)
	{
		...
		$as_titulo1="<b>COMPROBANTE DE RETENCIÓN DE IMPUESTO SOBRE LA RENTA</b>";
		$as_titulo3="<b>O CESE DE ACTIVIDADES PARA PERSONAS</b>";
		$as_titulo4="<b>RESIDENTES PERCEPTORAS DE SUELDOS</b>";
		$as_titulo5="<b>SALARIOS Y DEMÁS REMUNERACIONES SIMILARES</b>";
		...
		$io_pdf->ezSetY(669);
		$io_pdf->addText(55,683,10,'<b>Datos Agentes de Retención</b>'); // Agregar el título
		$la_data[0]=array('titulo'=>'<b>Nombre</b>','descripcion'=>$_SESSION["la_empresa"]["nombre"]);
		$la_data[1]=array('titulo'=>'<b>Dirección</b>','descripcion'=>str_pad($_SESSION["la_empresa"]["direccion"],154," "));
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('mes'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   ...
						 			   'porcentaje'=>array('justification'=>'right','width'=>55), // Justificación y ancho de la columna
						 			   'retencion'=>array('justification'=>'right','width'=>55), // Justificación y ancho de la columna
						 			   'arcacum'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
						 			   'retencionacum'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$la_data[8]=array('firma1'=>'Lic. Yulisbeth Castillo');
		$la_data[9]=array('firma1'=>'Directora de Gestión Interna');
