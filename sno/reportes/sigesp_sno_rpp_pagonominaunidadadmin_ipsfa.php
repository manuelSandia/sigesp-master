<?php
	...
	function uf_print_piepagina($ai_totper,$ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,$as_desuniadm,&$io_pdf)
	{
		...
		$la_data=array(array('titulo'=>'<b>Total Personas  '.$as_desuniadm.': </b>','totper'=>$ai_totper));
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 10,  // Tamaño de Letras de los títulos
						 'showLines'=>0, // Mostrar Líneas
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>180), // Justificación y ancho de la columna
						 			   'totper'=>array('justification'=>'left','width'=>320))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,'','',$la_config);
		unset ($la_data);
		unset ($la_config);	
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			uf_print_piepagina($li_totrow,$li_totasi,$li_totded,$li_totapo,$li_totgeneral,$ls_desuniadm,$io_pdf);
			...
			uf_print_piepagina($li_totgenper,$li_totgenasi,$li_totgended,$li_totgenapo,$li_totgen,'',$io_pdf);				
		}	
