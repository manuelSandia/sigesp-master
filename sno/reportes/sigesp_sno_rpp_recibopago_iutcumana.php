		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_total;$li_s++) 
				{
					...
					$la_valores_ext["denomasig"]="";
					$la_valores_ext["valorasig"]="";
					$la_valores_ext["denomdedu"]="";
					$la_valores_ext["valordedu"]="";
					if(($li_s<=$li_asig)&&($li_s<=8))
					{
						$la_valores["denomasig"]=$la_data_a[$li_s]["denominacion"];
						$la_valores["valorasig"]=$la_data_a[$li_s]["valor"];
					}
					if(($li_s<=$li_dedu)&&($li_s<=8))
					{
						$la_valores["denomdedu"]=$la_data_d[$li_s]["denominacion"];
						$la_valores["valordedu"]=$la_data_d[$li_s]["valor"];
					}
					elseif(($li_s<=$li_asig)&&($li_s>8))
					{
						$la_valores_ext["denomasig"]=$la_data_a[$li_x]["denominacion"];
						$la_valores_ext["valorasig"]=$la_data_a[$li_x]["valor"];
					}
					elseif(($li_s<=$li_dedu)&&($li_s>8))
					{
						$la_valores_ext["denomdedu"]=$la_data_d[$li_x]["denominacion"];
						$la_valores_ext["valordedu"]=$la_data_d[$li_x]["valor"];
						$li_x++;
					}
					$la_data[$li_s]=$la_valores;
					$la_data2[$li_x]=$la_valores_ext;
				}
