<?PHP
							    ...
							    &$io_cabecera,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->ezSetDy(-5);
		$la_data[1]=array('nombre'=>'                                                             Apellidos y Nombres', 
						  'cedula'=>'Cédula','fechaingreso'=>'Fecha Ingreso','sueldo'=>'Sueldo             ');
		$la_data[2]=array('nombre'=>$as_nomper,'cedula'=>$as_cedper,'fechaingreso'=>$ad_fecingper,'sueldo'=>$ai_sueper);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'rowGap' => 0.5 ,
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>310), // Justificación y ancho de la columna
						 			   ...
						 			   'sueldo'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('cantidadasig'=>'<b>CANT</b>','denomasig'=>'<b>CONCEPTOS</b>', 'valorasig'=>'<b>ASIGNACIÓN</b>', 
		                     'cantidaddedu'=>'<b>CANT</b>','denomdedu'=>'<b>CONCEPTOS</b>','valordedu'=>'<b>DEDUCCIÓN</b>',
							 'valoracumulado'=>'<b>ACUMULADO</b>'));
		$la_columna=array('cantidadasig'=>'<b>CANT</b>','denomasig'=>'<b>DENOMINACIÓN</b>',
						  'valorasig'=>'<b>ASIGNACIÓN</b>',
						  'cantidaddedu'=>'<b>CANT</b>','denomdedu'=>'<b>DENOMINACIÓN</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('cantidadasig'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   'denomasig'=>array('justification'=>'center','width'=>155), // Justificación y ancho de la columna
						 			   'valorasig'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'cantidaddedu'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'center','width'=>155), // Justificación y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('cantidadasig'=>array('justification'=>'left','width'=>30), // Justificación y ancho de la columna
						 			   'denomasig'=>array('justification'=>'left','width'=>155), // Justificación y ancho de la columna
						 			   'valorasig'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
									   'cantidaddedu'=>array('justification'=>'left','width'=>30), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'left','width'=>155), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'valoracumulado'=>array('justification'=>'right','width'=>60))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_pago,$as_obsrecper,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data=array(array('forma'=>'<b>Forma de Pago:</b>  '.$as_pago, 'cuenta'=>'<b>Cuenta Bancaria:</b>  '.$as_codcueban, 'neto'=>'<b>Neto a Cobrar '.$ls_bolivares.':</b>  '.$ai_totnet));
		$la_columna=array('forma'=>'','cuenta'=>'','neto'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 7,  // Tamaño de Letras de los títulos
						 'showLines'=>0, // Mostrar Líneas
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('forma'=>array('justification'=>'left','width'=>155),
						 			   'cuenta'=>array('justification'=>'left','width'=>195), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>150))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		$io_pdf->addText(40,435,'10','<b>Observación:</b>');
		$io_pdf->ezSety(444);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('obsrecper'=>array('justification'=>'left','width'=>300))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_cabecera2($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_pago,$as_obsrecper,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('forma'=>array('justification'=>'left','width'=>155),
						 			   ...
						 			   'neto'=>array('justification'=>'right','width'=>150))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,58,'10','------------------------------------------------------------------------------------------------------------------------------------------------------------');
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		$io_pdf->addText(40,45,'10','<b>Observación:</b>');
		$io_pdf->ezSety(54);
		$la_data=array(array('obsrecper'=>$as_obsrecper));
		$la_columna=array('obsrecper'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($lb_valido)
			{
				...
				if($li_reg==1)
				{
					uf_print_pie_cabecera1($li_toting,$li_totded,$li_totnet,$ls_codcueban,$ls_pago,$ls_obsrecper,$io_pdf); // Imprimimos pie de la cabecera
				}
				else
				{
					uf_print_pie_cabecera2($li_toting,$li_totded,$li_totnet,$ls_codcueban,$ls_pago,$ls_obsrecper,$io_pdf); // Imprimimos pie de la cabecera
				}
				unset($la_data_a);
				unset($la_data_d);
				unset($la_data);
