<?php
	...
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,&$io_cabecera,&$io_pdf)
	{
		...
		$io_pdf->ezSetY(668);
		$la_data=array(array('cantidadasig'=>'<b>CANT</b>','denomasig'=>'<b>DENOMINACIÓN</b>', 'valorasig'=>'<b>ASIGNACIÓN</b>','cantidaddedu'=>'<b>CANT</b>', 'denomdedu'=>'<b>DENOMINACIÓN</b>','valordedu'=>'<b>DEDUCCIÓN</b>'));
		$la_columna=array('cantidadasig'=>'<b>CANT</b>',
						  'denomasig'=>'<b>DENOMINACIÓN</b>',
						  'valorasig'=>'<b>ASIGNACIÓN</b>',
						  'cantidaddedu'=>'<b>CANT</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('cantidadasig'=>array('justification'=>'center','width'=>34), // Justificación y ancho de la columna
						 			   'denomasig'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
						 			   'valorasig'=>array('justification'=>'right','width'=>100), // Justificación y ancho de la columna
						 			   'cantidaddedu'=>array('justification'=>'center','width'=>34), // Justificación y ancho de la columna
									   'denomdedu'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cantidadasig'=>array('justification'=>'left','width'=>30), // Justificación y ancho de la columna
						 			   'denomasig'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la columna
						 			   'valorasig'=>array('justification'=>'right','width'=>100), // Justificación y ancho de la columna
						 			   'cantidaddedu'=>array('justification'=>'left','width'=>30), // Justificación y ancho de la columna
									   'denomdedu'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_totales($as_totalpersonas,$as_desnom,$ai_neto_pagar,$ai_tot_asig_acum,$ai_tot_dedu_acum,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_pie_cabecera
		//		   Access: private 
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetDy(-50);
		$la_data=array(array('nomina'=>'Total de trabajadores en Nomina: <b>'.$as_totalpersonas.'</b>', 'asignaciones'=>$ai_tot_asig_acum, 'deducciones'=>$ai_tot_dedu_acum,'netopagar'=>$ai_neto_pagar));
		$la_columna=array('nomina'=>'<b>Totales Nómina   </b>'.'<b>'.$as_desnom.'</b>',
						  'asignaciones'=>'<b>Total Asignaciones</b>',
						  'deducciones'=>'<b>Total Deducciones</b>',
						  'netopagar'=>'<b>Neto a Pagar</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('nomina'=>array('justification'=>'center','width'=>200), // Justificación y ancho de la columna
						 			   'asignaciones'=>array('justification'=>'right','width'=>100), // Justificación y ancho de la columna
						 			   'deducciones'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'netopagar'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	}// end function uf_print_pie_cabecera
	...
	else // Imprimimos el reporte
	{
		...
		$li_tot_asig_acum=0;
		$li_tot_dedu_acum=0;
		$ls_totalpersonas=$li_totrow;
		if ($ls_totalpersonas > 1)
		{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($lb_valido)
			{
						...
						case "2": // segunda quincena;
							for($li_s=1;$li_s<=$li_totrow_det;$li_s++) 
							{
								...
								else // Buscamos las deducciones y aportes
								{
									...
									$li_cantidad=number_format($io_report->DS_detalle->data["unidad"][$li_s],0);
									$li_valsal=$io_fun_nomina->uf_formatonumerico(abs($io_report->DS_detalle->data["valsal"][$li_s]));
									$la_data_d[$li_dedu]=array('denominacion'=>$ls_nomcon,'valor'=>$li_valsal,'cantidad'=>$li_cantidad);
								}
							}
							$li_dedu=$li_dedu+1;
							$ls_codconc="----------";
				...
				$li_neto_pagar=$li_neto_pagar+$li_totnet;
				$li_tot_asig_acum=$li_tot_asig_acum+$li_toting;
				$li_tot_dedu_acum=$li_tot_dedu_acum+$li_totded;
		...
		$li_tot_asig_acum=$io_fun_nomina->uf_formatonumerico($li_tot_asig_acum);
		$li_tot_dedu_acum=$io_fun_nomina->uf_formatonumerico($li_tot_dedu_acum);
		//uf_print_totales($ls_totalpersonas,$ls_desnom,$li_neto_pagar,$li_tot_asig_acum,$li_tot_dedu_acum,$io_pdf);
