<?php
	...
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,$as_descripcion,&$io_cabecera,&$io_pdf)
	{
		...
		$io_pdf->line(30,715,30,462); //VERTICAL
		$io_pdf->line(310,715,310,462); //VERTICAL
		$io_pdf->line(580,715,580,462); //VERTICAL
		$io_pdf->line(30,690,580,690); //HORIZONTAL
		$io_pdf->line(30,670,580,670); //HORIZONTAL
		$io_pdf->line(450,690,450,462); //VERTICAL
		//$io_pdf->line(30,412,580,412); //HORIZONTAL
	...
	function uf_print_cabecera2($as_cedper,$as_nomper,$as_descar,$as_descripcion,&$io_cabecera,&$io_pdf)
	{
		...
		// Fecha Creación: 05/05/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],50,297,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0,1);
		$io_pdf->line(30,295,580,295); //HORIZONTAL
		$io_pdf->line(30,295,30,42);//VERTICAL
		$io_pdf->line(310,295,310,42);//VERTICAL
		$io_pdf->line(580,295,580,42);//VERTICAL
		$io_pdf->line(30,270,580,270);//HORIZONTAL
		$io_pdf->line(30,250,580,250);//HORIZONTAL
		$io_pdf->line(450,270,450,42);//VERTICAL
		//$io_pdf->line(30,42,580,42); //HORIZONTAL
		$io_pdf->addText(40,285,8,$_SESSION["la_empresa"]["nombre"]);
		$io_pdf->addText(40,275,8,$as_descripcion);
		$io_pdf->addText(315,285,8,$as_nomper);
		$io_pdf->addText(315,275,8,$as_descar);
		$io_pdf->addText(40,255,9,"DESCRIPCIÓN");
		$io_pdf->addText(345,255,9,"ASIGNACIONES");
		$io_pdf->addText(480,255,9,"DEDUCCIONES");
        $io_pdf->addText(141,45,9,"CI:");
