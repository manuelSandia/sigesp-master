	...
	function uf_print_cabecera($as_nomban,&$io_cabecera,&$io_pdf)
	{
		...
		//    Description: funciï¿½n que imprime la cabecera por banco
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaciï¿½n: 03/05/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->saveState();
		...
		$io_pdf->addText(55,695,11,'<b>'.$as_nomban.'</b>'); // Agregar el tï¿½tulo
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		//	   			   io_pdf // Objeto PDF
		//    Description: funciï¿½n que imprime el detalle por banco
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaciï¿½n: 03/05/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nro'=>array('justification'=>'center','width'=>30), // Justificaciï¿½n y ancho de la columna
						 			   ...
						 			   'nombre'=>array('justification'=>'center','width'=>150), // Justificaciï¿½n y ancho de la columna
						 			   'cuenta'=>array('justification'=>'center','width'=>150), // Justificaciï¿½n y ancho de la columna
						 			   'monto'=>array('justification'=>'center','width'=>100))); // Justificaciï¿½n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nro'=>array('justification'=>'center','width'=>30), // Justificaciï¿½n y ancho de la columna
						 			   'cedula'=>array('justification'=>'center','width'=>70), // Justificaciï¿½n y ancho de la columna
						 			   'nombre'=>array('justification'=>'left','width'=>150), // Justificaciï¿½n y ancho de la columna
						 			   'cuenta'=>array('justification'=>'center','width'=>150), // Justificaciï¿½n y ancho de la columna
	...
	function uf_print_pie_detalle($as_descripcion,$ai_total,&$io_pdf)
	{
		...
		//		   Access: private 
		//	    Arguments: as_descripcion // Descripciï¿½n del total
		//	   			   ai_total // Total 
		//	    		   io_pdf // Instancia de objeto pdf
		//    Description: funciï¿½n que imprime el fin de la cabecera por banco
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaciï¿½n: 03/05/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $ls_bolivares;
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientaciï¿½n de la tabla
				 		 'cols'=>array('titulo'=>array('justification'=>'right','width'=>400), // Justificaciï¿½n y ancho de la columna
						 			   'total'=>array('justification'=>'right','width'=>100))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_piecabecera($ai_total,&$io_pdf)
	{
		...
		//	    		   io_pdf // Instancia de objeto pdf
		//    Description: funciï¿½n que imprime el fin de la cabecera por todos los registros
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaciï¿½n: 03/05/2006 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $ls_bolivares;
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientaciï¿½n de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>400), // Justificaciï¿½n y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>100))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->setStrokeColor(0,0,0);
		$io_pdf->Rectangle(15,60,570,50); 
		$io_pdf->line(15,100,585,100);	//HORIZONTAL	
		$io_pdf->addText(30,102,7,'<b>APROBADO POR: XXXX</b>'); // Agregar el tï¿½tulo
		$io_pdf->addText(30,63,7,"GERENTE DE RECURSOS HUMANOS"); // Agregar el tï¿½tulo
		$io_pdf->line(190,60,190,110);	//VERTICAL	
		$io_pdf->line(15,70,585,70);	//HORIZONTAL
		$io_pdf->addText(220,102,7,'<b>APROBADO POR: XXX:</b>'); // Agregar el tï¿½tulo
		$io_pdf->addText(215,63,7,"GERENTE DE ADMINISTRACION Y FINANZAS"); // Agregar el tï¿½tulo
		$io_pdf->line(380,60,380,110);	//VERTICAL	
		$io_pdf->addText(450,102,7,'<b>APROBADO POR: </b>  '); // Agregar el tï¿½tulo
		$io_pdf->addText(430,63,7,"DIRECTOR EJECUTIVO/PRESIDENCIA"); // Agregar el tï¿½tulo
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	{
		$ls_periodo="<b>Perï¿½odo Nro ".$ls_peractnom.", ".$ld_fecdesper." - ".$ld_fechasper." -  Adelanto de Quincena</b>";	
	}
	//--------------------------------------------------------------------------------------------------------------------------------
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3.55,2.5,3,3); // Configuraciï¿½n de los margenes en centï¿½metros
		...
		{			
			...
			//-------------------------------------------Buscamos las cuentas Activos Lï¿½quidos------------------------------------------
			$ls_tipcueban="L"; // Buscamos las cuentas Activos Lï¿½quidos
			if (($ls_tipocuenta == '') ||  ($ls_tipocuenta == $ls_tipcueban))
			{
				$lb_valido=$io_report->uf_listadobanco_personal($ls_codban,$ls_suspendido,$ls_tipcueban,$ls_quincena,$ls_subnomdes,$ls_subnomhas,
																$ls_codperdes,$ls_codperhas,$ls_orden); // Obtenemos el detalle del reporte
