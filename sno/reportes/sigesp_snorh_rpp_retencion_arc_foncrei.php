<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo2,&$io_pdf)
	{
		...
		//	   Creado Por: Ing. Yesenia Moreno                     Modificado Por: Ing. Gloriely Fréitez
		// Fecha Creación: 04/08/2006                              Fecha Modificación: 13/03/2008
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,740,9,$as_titulo); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(9,$as_titulo2);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,730,9,$as_titulo2); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(9,$ls_titulobs);
		$tm=306-($li_tm/2);
		$ls_titulo1="<b>FONDO DE CRÉDITO INDUSTRIAL</b>";
		$io_pdf->addText(235,750,9,$ls_titulo1); // Agregar el título
		$io_pdf->addText(512,750,8,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(518,743,7,date("h:i a")); // Agregar la Hora
		$io_pdf->line(200,80,400,80);  // Linea horizontal firma
		$io_pdf->addText(220,60,9,"<b>FIRMA DEL AGENTE DE RETENCIÓN</b>"); // Agregar el título
        $io_pdf->setColor(0.9,0.9,0.9);
        $io_pdf->filledRectangle(50,695,500,$io_pdf->getFontHeight(12));
        $io_pdf->setColor(0,0,0);
		$io_pdf->addText(55,702,10,'<b>Datos Agentes de Retención</b>'); // Agregar el título
		$la_data[0]=array('titulo'=>'<b>Nombre</b>','descripcion'=>$_SESSION["la_empresa"]["nombre"]);
		$la_data[1]=array('titulo'=>'<b>Dirección</b>','descripcion'=>str_pad($_SESSION["la_empresa"]["direccion"],254," "));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>45), // Justificación y ancho de la columna
						 			   'descripcion'=>array('justification'=>'left','width'=>455))); // Justificación y ancho de la columna
		$io_pdf->ezSetDy(10);
	...
	function uf_print_cabecera($as_nacper,$as_cedper,$as_nomper,&$io_cabecera,&$io_pdf)
	{
        ...
        $io_pdf->setColor(0,0,0);
		$io_pdf->addText(55,622,10,'<b>Beneficiario de las Remuneraciones</b>'); // Agregar el título
		$io_pdf->addText(55,610,8,'<b>Apellidos y Nombre</b>  '.$as_nacper.'-'.$as_cedper.'   '.$as_nomper.''); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_columnas=array('mes'=>'<b>Mes</b>',
						   ...
						   'porcentaje'=>'<b>Porcentaje de         Retención         </b>',
						   ...
						   'datos'=>'<b>Datos Obtenidos de la Información         Suministrada por el   Contribuyente      </b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('mes'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   'arc'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
						 			   'porcentaje'=>array('justification'=>'right','width'=>50), // Justificación y ancho de la columna
						 			   'retencion'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'arcacum'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
						 			   'retencionacum'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'datos'=>array('justification'=>'right','width'=>90))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
	...
	function uf_print_detalle_aporte($la_data,&$io_pdf)
	{
		...
		$io_pdf->ezTable($la_data,$la_columnas,'Retenciones al Personal',$la_config);
	...
	$ls_titulo="<b>RETENCIÓN ANUAL ISRL A EMPLEADOS</b>";
	...
	else  // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(4,4,3,3); // Configuración de los margenes en centímetros
		...
		{			
			...
			if($lb_valido)
			{
				...
				while(!$io_report->rs_detalle->EOF)
				{
					...
					$li_porisr=$io_fun_nomina->uf_formatonumerico($io_report->rs_detalle->fields["porisr"]);
