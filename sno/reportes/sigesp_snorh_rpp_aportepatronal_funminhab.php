<?php
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$io_pdf->addText(55,121,7,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(90,79,7,"Firma:"); // Agregar el título
		
		$io_pdf->line(200,60,200,130);	//VERTICAL	
		$io_pdf->addText(205,121,7,"REVISADO POR:"); // Agregar el título
		$io_pdf->addText(255,79,7,"Firma:"); // Agregar el título
		$io_pdf->line(380,60,380,130);	//VERTICAL
		
        $io_pdf->addText(385,121,7,"CONFOMADO: "); // Agregar el título
		$io_pdf->addText(440,79,7,"Firma:"); // Agregar el título
