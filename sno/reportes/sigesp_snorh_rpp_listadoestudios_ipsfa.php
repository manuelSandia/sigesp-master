<?php
							   ...
							   &$io_cabecera,&$io_pdf,$unidad_admin='')
	{
		...
		$io_pdf->addText(45,510,12,'<b> Unidad Admin.:</b><c:covensol_color:000099>'.$unidad_admin.'</c:covensol_color>'); // Agregar el título
		$io_pdf->ezSetY(500);
	...
	function uf_print_datos($la_data,&$io_pdf)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetDy(-1);
		$la_columna=array('codestrea'=>'<b>Nro</b>','tipestrea'=>'<b>Tipo</b>','insestrea'=>'<b>Instituto</b>',
	...
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_estudiospersonal_personal($ls_codnomdes,$ls_codnomhas,$ls_codperdes,$ls_codperhas,$ls_activo,
															...
															$ls_suspendidono,$ls_egresadono,$ls_masculino,$ls_femenino,$ls_orden,$ls_uniadmin); // Obtenemos el detalle del reporte
	}
