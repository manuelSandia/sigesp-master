<?php
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$li_tm=$io_pdf->getTextWidth(9,$as_desnom);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,305,9,$as_desnom); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,$as_codper,$ad_fechaingreso,$as_gerencia,&$io_cabecera,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->ezSetDy(-11);
		$la_data=array(array('nombre'=>'Apellidos y Nombres:', 'cedula'=>'Cédula:', 'cargo'=>'Cargo:', 'codigo'=>'Codigo:' ,'fecha'=>'Fecha Ingreso:','unidad'=>'Unidad Admin.:'  ));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'', 'codigo'=>'' ,'fecha'=>'','unidad'=>'' );
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>180), // Justificación y ancho de la columna
						 			   'cedula'=>array('justification'=>'center','width'=>45), // Justificación y ancho de la columna
		...
		$la_data=array(array('nombre'=>$as_nomper, 'cedula'=>$as_cedper, 'cargo'=>substr($as_descar,0,100), 'codigo'=>$as_codper ,'fecha'=>$ad_fechaingreso,'unidad'=>substr($as_gerencia,0,30)));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'', 'codigo'=>'' ,'fecha'=>'','unidad'=>'' );
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera2($as_cedper,$as_nomper,$as_descar,$as_codper,$ad_fechaingreso,$as_gerencia,&$io_cabecera,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->saveState();
		$io_pdf->addText(40,295,'10','______________________________________________________________________________________________');
		$io_pdf->ezSetDy(-175);
		$la_data=array(array('nombre'=>'Apellidos y Nombres:', 'cedula'=>'Cédula:', 'cargo'=>'Cargo:', 'codigo'=>'Codigo:' ,'fecha'=>'Fecha Ingreso:','unidad'=>'Unidad Admin.:'  ));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'', 'codigo'=>'' ,'fecha'=>'','unidad'=>'' );
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,&$io_pdf)
	{
		...
		$io_pdf->addText(380,422,'9','______________________________');
		$io_pdf->addText(420,408,'9','Recibí Conforme');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_pie_cabecera2($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,&$io_pdf)
	{
		...
		$io_pdf->addText(380,27,'9','______________________________');
		$io_pdf->addText(420,13,'9','Recibí Conforme');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_piepagina,'all');
		$io_pdf->stopObject($io_piepagina); // Detener el objeto pie de página
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($li_reg==1)
			{
				uf_print_cabecera1($ls_cedper,$ls_nomper,$ls_descar,$ls_codper,$ld_fechaingreso,$ls_gerencia,$io_cabecera,$io_pdf); // Imprimimos la cabecera del registro
			}
			else
			{
				uf_print_cabecera2($ls_cedper,$ls_nomper,$ls_descar,$ls_codper,$ld_fechaingreso,$ls_gerencia,$io_cabecera,$io_pdf); // Imprimimos la cabecera del registro
			}
