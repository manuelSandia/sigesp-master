<?php
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		// MODIFICADO POR RAMON VELASQUEZ 310510//
		// cuadro inferior
		...
		$io_pdf->addText(30,75,8,"ISABEL MARIA GUTIERREZ"); // Agregar el título
		$io_pdf->addText(241,75,8,"LIC. INGRID CAMACHO"); // Agregar el título
		$io_pdf->addText(475,75,8,"ANALISTA"); // Agregar el título
		$io_pdf->addText(45,69,5,"DIRECTOR GENERAL DE RECURSOS HUMANOS"); // Agregar el título
		$io_pdf->addText(263,69,5,"JEFE DE NÓMINA"); // Agregar el título
		$io_pdf->addText(453,69,5,""); // Agregar el título
		$io_pdf->addText(85,63,5,"(FIRMA Y SELLO)"); // Agregar el título
		$io_pdf->addText(260,63,5,"(FIRMA Y SELLO)"); // Agregar el título
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3.3,5,3,3); // Configuración de los margenes en centímetros
