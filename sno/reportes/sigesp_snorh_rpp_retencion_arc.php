<?php
	...
	function uf_print_cabecera($as_nacper,$as_cedper,$as_nomper,&$io_cabecera,&$io_pdf)
	{
        ...
        $io_pdf->setColor(0,0,0);
		$io_pdf->addText(55,632,10,'<b>Beneficiario de las Remuneraciones</b>'); // Agregar el título
		$io_pdf->addText(55,620,8,'<b>Apellidos y Nombre</b>  '.$as_nacper.'-'.$as_cedper.'   '.$as_nomper.''); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	$ls_titulo="<b>Comprobante de Retención AR-C</b>";
