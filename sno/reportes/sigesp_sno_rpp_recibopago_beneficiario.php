	                            ...
	                            $as_cedben, $as_nomben, $as_apeben,$ls_parentesco,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>290),
									   ...
									   'parentesco'=>array('justification'=>'left','width'=>200))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('banco1'=>array('justification'=>'left','width'=>79),
						 			   'banco2'=>array('justification'=>'left','width'=>150))); // Justificación y ancho de la columna
		...
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		 ...
		 $la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('servicio'=>array('justification'=>'left','width'=>160),
									   ...
									   'rango'=>array('justification'=>'left','width'=>200))); // Justificación y ancho de la columna
...
//-------------------------------------------------------------------------------------------------------------------------
	...
	if(($lb_valido==false) || ($io_report->rs_data_detalle2->RecordCount()==0)) // Existe algún error ó no hay registros
	{
		print("<script language=JavaScript>");
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data_detalle2->EOF)&&($lb_valido))
		{
			...
			$lb_valido=$io_report->uf_recibopago_personal($ls_codperdes2,$ls_codperhas2,$ls_coduniadm,$ls_conceptocero,
		...
		if(($li_totrow2>0)&&($li_totrow_det2>0)) // Si no ocurrio ningún error
		{
