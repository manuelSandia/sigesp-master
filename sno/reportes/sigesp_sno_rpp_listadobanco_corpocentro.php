<?php
	...
	function uf_print_pie_de_pagina(&$io_pdf)
	{
		...
		$io_pdf->saveState();
		// cuadro inferior
        $io_pdf->Rectangle(50,60,502,70); 
		$io_pdf->line(50,117,552,117);	//HORIZONTAL	
		$io_pdf->addText(81,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(132,76,7,"AREA DE RECURSOS HUMANOS"); // Agregar el título
		$io_pdf->addText(150,63,7,"FIRMAS Y SELLOS"); // Agregar el título
		$io_pdf->line(190,86,190,130);	//VERTICAL	
		$io_pdf->addText(230,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->line(330,60,330,130);	//VERTICAL		
		$io_pdf->addText(395,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(342,76,7,"GERENCIA DE ADMINISTRACIÓN DE RECURSOS HUMANOS"); // Agregar el título
		$io_pdf->addText(400,63,7,"FIRMA Y SELLO"); // Agregar el título
		$io_pdf->line(50,86,552,86); //HORIZONTAL
		$io_pdf->line(50,73,552,73); //HORIZONTAL
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	}// end function uf_print_encabezadopagina
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3.55,5,3,3); // Configuración de los margenes en centímetros
