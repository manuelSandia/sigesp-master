<?php
	...
	function uf_print_cabecera($as_cedper,$as_apenomper,$as_descar,$as_desuniadm,$ad_fecingper,$as_codcueban,$ai_sueper,&$io_pdf)
	{
		...
		// Fecha Creación: 26/04/2006 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data=array(array('cedula'=>'<b>Cédula</b>','nombre'=>'<b>Nombre</b>','cargo'=>'<b>Cargo</b>','sueldo'=>'<b>Sueldo</b>',
		...
		$la_data=array(array('cedula'=>$as_cedper,'nombre'=>$as_apenomper,'cargo'=>$as_descar,'sueldo'=>$ai_sueper,'unidad'=>$as_desuniadm,'fecha'=>$ad_fecingper));
		$la_columnas=array('cedula'=>'',
						   'nombre'=>'',
						   'cargo'=>'',
						   'sueldo'=>'',
				...
				while (!$io_report->rs_data_detalle->EOF)
				{
					...
					switch($ls_tipsal)
					{
						...
						case "D":
							...
							$li_aporte=""; 
							$lb_valido=$io_report->uf_pagonomina_prestamoamortizado($ls_codper,$ls_codconc,&$li_aporte);
							break;
