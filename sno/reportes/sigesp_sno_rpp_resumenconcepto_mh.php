<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->addText(30,63,7,"Coordinador Nómina y Bienestar"); // Agregar el título

		$io_pdf->line(170,60,170,130);	//VERTICAL
		$io_pdf->addText(220,122,7,"Revisado por"); // Agregar el título
		$io_pdf->addText(195,63,7,"Gerente de Recursos Humanos"); // Agregar el título
		//$io_pdf->addText(150,61,7,"y Servicios Generales"); // Agregar el título

		$io_pdf->line(325,60,325,130);	//VERTICAL
		$io_pdf->addText(365,122,7,"Conformado por"); // Agregar el título
		$io_pdf->addText(355,63,7,"Vicepresidente Ejecutivo"); // Agregar el título

		$io_pdf->line(460,60,460,130);	//VERTICAL
		$io_pdf->addText(500,122,7,"Aprobado por"); // Agregar el título
		$io_pdf->addText(490,63,7,"Presidencia Ejecutiva"); // Agregar el título
