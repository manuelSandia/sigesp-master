<?php
	...
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->line(40,665,40,694);
		$io_pdf->line(210,665,210,679);
		$io_pdf->line(350,679,350,694);
		$io_pdf->line(563,665,563,694);
		$io_pdf->addText(40,750,9,'<b>INSTITUTO UNIVERSITARIO DE TECNOLOGIA DE YARACUY</b>'); // Agregar el título
		$io_pdf->addText(40,740,8,'<b>UNIDAD DE RECURSOS HUMANOS SECCION NOMINA</b>'); // Agregar el título
	...
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,&$io_cabecera,$as_obsrecper,&$io_pdf)
	{
		...
		$la_data=array(array('nombre'=>'Apellidos y Nombres:', 'cedula'=>'', 'cargo'=>'' ));
		...
		$io_pdf->addText(40,680,'10','______________________________________________________________________________________________');
		$io_pdf->addText(130,685,'7',$as_nomper);
		$io_pdf->addText(50,670,'8','Cédula:');
		$io_pdf->addText(100,670,'7',$as_cedper);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'left','width'=>260), // Justificación y ancho de la columna
									   'valorasig'=>array('justification'=>'right','width'=>130), // Justificación y ancho de la columna
									   'valordedu'=>array('justification'=>'right','width'=>110))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config1=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'left','width'=>240), // Justificación y ancho de la columna
		...
		$la_config2=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomdedu'=>array('justification'=>'left','width'=>260), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>230))); // Justificación y ancho de la columna
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_obsrecper,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->addText(250,460,'10','__________________________________________________________________________________________________________');
		$io_pdf->ezSety(460);
		$la_data=array(array('denomasig'=>'', 'valorasig'=>'', 'denomdedu'=>$ai_toting,'valordedu'=>$ai_totded));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
						 			   ...
						 			   'denomdedu'=>array('justification'=>'right','width'=>150), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(250,444,'10','___________________________________________________________________________________________________________________');
		$la_data=array(array('cuenta'=>'', 'neto'=>'<b>Total a Cobrar '.$ls_bolivares.':</b>                        '.$ai_totnet));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'left','width'=>250), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>280))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(250,447,'10','______________________________________________________________________________________________________________________');
						...
						case "2": // segunda quincena;
							while(!$io_report->rs_data_detalle->EOF)
							{
								...
								else // Buscamos las deducciones y aportes
								{
									...
									$la_data_d[$li_dedu]=array('denominacion'=>$ls_nomcon,'valor'=>$li_valsal,'cuota'=>$ls_cuota);
								}
