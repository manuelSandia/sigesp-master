<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('name1'=>array('justification'=>'center','width'=>150), // Justificaci�n y ancho de la columna
						 			   'name2'=>array('justification'=>'center','width'=>150), // Justificaci�n y ancho de la columna
									   'name3'=>array('justification'=>'center','width'=>150),
									   'name4'=>array('justification'=>'center','width'=>150),						 			  
									   'name5'=>array('justification'=>'center','width'=>150))); // Justificaci�n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>750, // Ancho M�ximo de la tabla
						 'xOrientation'=>'center', // Orientaci�n de la tabla						 
						 'cols'=>array('codban'=>array('justification'=>'left','width'=>30), // Justificaci�n y ancho de la columna
						 			   'nomban'=>array('justification'=>'left','width'=>120), // Justificaci�n y ancho de la columna
									   'numche'=>array('justification'=>'center','width'=>50),
									   'montotche'=>array('justification'=>'right','width'=>100),
						 			  
									   'nunctaaho'=>array('justification'=>'center','width'=>50), // Justificaci�n y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>750, // Ancho M�ximo de la tabla
						 'xOrientation'=>'center', // Orientaci�n de la tabla						 
						 'cols'=>array('codban'=>array('justification'=>'cleft','width'=>30), // Justificaci�n y ancho de la columna
						 			   'nomban'=>array('justification'=>'left','width'=>120), // Justificaci�n y ancho de la columna
									   'numche'=>array('justification'=>'center','width'=>50),
									   'montotche'=>array('justification'=>'right','width'=>100),
		...
		$io_pdf->addText(30,150,7,'<b>APROBADO POR: XXXX</b>'); // Agregar el t�tulo
		$io_pdf->addText(30,63,7,"GERENTE DE RECURSOS HUMANOS"); // Agregar el t�tulo
		$io_pdf->line(190,60,190,110);	//VERTICAL	
		$io_pdf->line(15,70,585,70);	//HORIZONTAL
		$io_pdf->addText(220,150,7,'<b>APROBADO POR: XXXX:</b>'); // Agregar el t�tulo
		$io_pdf->addText(215,63,7,"GERENTE DE ADMINISTRACION Y FINANZAS"); // Agregar el t�tulo
		$io_pdf->line(380,60,380,110);	//VERTICAL	
		$io_pdf->addText(400,150,7,'<b>APROBADO POR: XXXX</b>  '); // Agregar el t�tulo
		$io_pdf->addText(450,63,7,"DIRECTOR EJECUTIVO"); // Agregar el t�tulo
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	$ls_titulo="<b>Relaci�n de Pagos y Dep�sitos por Entidad Bancaria ".$ls_nomban."</b>";
	...
	else  // Imprimimos el reporte
	{
 		...
 		while ((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if ($ls_pagbanper=='1')
			{
				...
				{
					$li_totctaaho=$li_totctaaho+1;
					$ld_montotctaaho=$ld_montotctaaho+$li_neto;
				}
				elseif($ls_tipcuebanper=='C')
				{
					$li_totctacte=$li_totctacte+1;
					$ld_montotctacte=$ld_montotctacte+$li_neto;
				}
			}
			elseif ($ls_pagtaqper=='1')
			{
				$li_totche=$li_totche+1;
				$ld_montotche=$ld_montotche+$li_neto;
			}
			 ...
			 if($ls_codban!=$io_report->rs_data->fields["codban"])
			 {
				...
				$la_data[$li_s]=array('codban'=>$ls_codban,'nomban'=>$ls_nomban,
									  'numche'=>$li_totche,'montotche'=>$ld_montotche,
									  'nunctaaho'=>$li_totctaaho,'montotctaaho'=>$ld_montotctaaho,
									  'numctacte'=>$li_totctacte,'montotctacte'=>$ld_montotctacte,
		...
		if(($lb_valido)&&($li_s>0)) // Si no ocurrio ning�n error
		{
			...
			$la_data[1]=array('codban'=>'','nomban'=>'<b>T O T A L    G E N E R A L</b>',
				  'numche'=>'<b>'.$li_totgenche.'</b>','montotche'=>'<b>'.number_format($ld_montotgenche,2,",",".").'</b>',
				  'nunctaaho'=>'<b>'.$li_totgenctaaho,'montotctaaho'=>'<b>'.number_format($ld_montotgenctaaho,2,",",".").'</b>',
				  'numctacte'=>'<b>'.$li_totgenctacte,'montotctacte'=>'<b>'.number_format($ld_montotgenctacte,2,",",".").'</b>',
				  'numtot'=>'<b>'.$li_totgen,'montot'=>'<b>'.number_format($ld_montotgen,2,",",".").'</b>');
			uf_print_detalle($la_data,$io_pdf);
			unset($la_data);	
