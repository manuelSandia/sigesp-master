<?php
 ...
 //--------------------------------tabla que contiene la cedula del firmante-----------------------------------------------
	   ...
	   //----------------------------rectangulo-pie de pag.------------------------------------------------------------------
		 ...
		 $io_pdf->addText(75,55,8,$pie_1); // Agregar el título
		 $pie_2="<b>EL FORMULARIO Y SU TRAMITACIÒN SON COMPLETAMENTE GRATUITOS</b>";
		 $io_pdf->addText(150,45,8,$pie_2); // Agregar el título
		 $pie_3="www.ivss.gov.ve";
		 $io_pdf->addText(265,35,8,$pie_3); // Agregar el título
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3.8,1.5,3,3); // Configuración de los margenes en centímetros
		...
		{ 
			...
			if($ls_mesaux!=$ls_mes)
			{
				while($i<number_format($ls_mesaux,0,"",""))
				{
					$nombre_mes=$io_fecha->uf_load_nombre_mes($i);
					$ls_data[$i]=array('periodo'=>$nombre_mes,'sueldo1'=>number_format(0,2,",","."),'sueldo2'=>number_format(0,2,",","."),
									   'sueldo3'=>number_format(0,2,",","."),'sueldo4'=>number_format(0,2,",","."),
									   'sueldo5'=>number_format(0,2,",","."),'sueldo6'=>number_format(0,2,",","."));						 
					$i++;
				}
				$nombre_mes=$io_fecha->uf_load_nombre_mes($ls_mesaux);
				$ls_data[$i]=array('periodo'=>$nombre_mes,'sueldo1'=>number_format($sueldo1,2,",","."),'sueldo2'=>number_format($sueldo2,2,",","."),
								   'sueldo3'=>number_format($sueldo3,2,",","."),'sueldo4'=>number_format($sueldo4,2,",","."),
								   'sueldo5'=>number_format($sueldo5,2,",","."),'sueldo6'=>number_format($sueldo6,2,",","."));						 
				$i++;
		...
		while ($i<=12)
		{
			$nombre_mes=$io_fecha->uf_load_nombre_mes($i);
			$ls_data[$i]=array('periodo'=>$nombre_mes,'sueldo1'=>number_format(0,2,",","."),'sueldo2'=>number_format(0,2,",","."),
							   'sueldo3'=>number_format(0,2,",","."),'sueldo4'=>number_format(0,2,",","."),'sueldo5'=>number_format(0,2,",","."),
