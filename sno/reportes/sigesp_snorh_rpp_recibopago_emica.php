<?php
	...
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->addText(40,760,10,'<b><i>'.$ls_nomepm.'</b></i>'); // Agregar el título
		$io_pdf->addText(40,750,9,'<b><i>'.$ls_nombre.'</b></i>'); // Agregar el título
		$io_pdf->addText(120,750,9,'<i>'.$ls_rifemp.'</i>'); // Agregar el título
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,705,9,$as_periodo); // Agregar el título
		
		$li_tm=$io_pdf->getTextWidth(9,$as_desnom);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,718,9,$as_desnom); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$ls_nombre=$_SESSION["la_empresa"]["nombre"];
		$ls_rifemp=$_SESSION["la_empresa"]["rifemp"];
		$io_pdf->addText(40,350,10,'<b><i>'.$ls_nomepm.'</b></i>'); // Agregar el título
		$io_pdf->addText(40,340,9,'<b><i>'.$ls_nombre.'</b></i>'); // Agregar el título
		$io_pdf->addText(120,340,9,'<i>'.$ls_rifemp.'</i>'); // Agregar el título
		
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,320,9,$as_titulo); // Agregar el título
		
		$li_tm=$io_pdf->getTextWidth(9,$as_periodo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,295,9,$as_periodo); // Agregar el título
		
		$li_tm=$io_pdf->getTextWidth(9,$as_desnom);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,308,9,$as_desnom); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera1($as_codper,$as_cedper,$as_nomper,$ad_fecingper,$as_codcueban,$as_descar,$as_desunidad,$ai_sueper,$ai_sueintper,&$io_cabecera,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ai_sueper=(($ai_sueper/30)/7);
		$ai_sueper=number_format($ai_sueper,2,",",".");
		$ai_sueper_ext=number_format($ai_sueper_ext,2,",",".");
		$io_pdf->addText(50,700,8,"Sueldo Bs.   ".$ai_sueper_ext); // Agregar el título
		$io_pdf->addText(470,700,8,"Sueldo Diario Bs.   ".$ai_sueper); // Agregar el título
		$io_pdf->ezSety(700);
		$la_data[1]=array('codigo'=>'Código:', 'cedula'=>'Cédula:', 'nombre'=>'Apellidos y Nombres:', 'fecha'=>'Fecha Ingreso', 'cta'=>'Cta. Bancaria');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
									   ...
									   'cta'=>array('justification'=>'left','width'=>100))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('cargo'=>array('justification'=>'left','width'=>270), // Justificación y ancho de la columna
						 			   'dpto'=>array('justification'=>'left','width'=>260))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		unset($la_data);
		unset($la_columna);
		unset($la_config);
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera2($as_codper,$as_cedper,$as_nomper,$ad_fecingper,$as_codcueban,$as_descar,$as_desunidad,$ai_sueper,$ai_sueintper,&$io_cabecera,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ai_sueper=number_format($ai_sueper,2,",",".");
		$ai_sueper_ext=number_format($ai_sueper_ext,2,",",".");
		$io_pdf->addText(50,283,8,"Sueldo Bs.   ".$ai_sueper_ext); // Agregar el título
		$io_pdf->addText(470,283,8,"Sueldo Diario Bs.   ".$ai_sueper); // Agregar el título
		$la_data[1]=array('codigo'=>'Código:', 'cedula'=>'Cédula:', 'nombre'=>'Apellidos y Nombres:', 'fecha'=>'Fecha Ingreso', 'cta'=>'Cta. Bancaria');
		$la_data[2]=array('codigo'=>$as_codper, 'cedula'=>$as_cedper, 'nombre'=>$as_nomper, 'fecha'=>$ad_fecingper, 'cta'=>$as_codcueban);
		$la_columna=array('codigo'=>'', 'cedula'=>'', 'nombre'=>'', 'fecha'=>'', 'cta'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
	...
	function uf_print_detalle($la_data,$la_data2,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'rowGap' =>0.5,
						 'cols'=>array('codigoasig'=>array('justification'=>'left','width'=>100), // Justificación y ancho de la columna
						 			   'denomasig'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
						 			   'valorasig'=>array('justification'=>'right','width'=>160), // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>315, // Orientación de la tabla
						 'rowGap' =>0.5,
						 'cols'=>array('codigoasig'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
						 			   'denomasig'=>array('justification'=>'left','width'=>300), // Justificación y ancho de la columna
						 			   'valorasig'=>array('justification'=>'left','width'=>150))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>315, // Orientación de la tabla
						 'rowGap' =>0.5,
						 'cols'=>array('codigodedu'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'left','width'=>300), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>150))); // Justificación y ancho de la columna
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xPos'=>315, // Orientación de la tabla
						 'cols'=>array('linea'=>array('justification'=>'right','width'=>530))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'right','width'=>180), // Justificación y ancho de la columna
						 			   'valorasig'=>array('justification'=>'right','width'=>150), // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xPos'=>315, // Orientación de la tabla
						 'cols'=>array('linea'=>array('justification'=>'left','width'=>530)));// Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($li_reg==1)
			{
				uf_print_cabecera1($ls_codper,$ls_cedper,$ls_nomper,$ld_fecingper,$ls_codcueban,$ls_descar,$ls_desunidad,$li_sueper,$li_sueintper,&$io_cabecera,&$io_pdf); // Imprimimos la cabecera del registro
			}
			else
			{
				uf_print_cabecera2($ls_codper,$ls_cedper,$ls_nomper,$ld_fecingper,$ls_codcueban,$ls_descar,$ls_desunidad,$li_sueper,$li_sueintper,&$io_cabecera,&$io_pdf); // Imprimimos la cabecera del registro
			}
			$ls_codperi="";
			if($ls_consolidar=="0")
			{
