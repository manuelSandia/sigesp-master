<?php
	...
	function uf_print_cabecera($as_coduniadm,$as_desuniadm,&$io_pdf)
	{
		...
		//		   Access: private 
		//	    Arguments: as_coduniadm // Cï¿½digo de la unidad administrativa
		//	    		   as_desuniadm // Descripciï¿½n de la unidad administrativa
		//	    		   io_pdf // Instancia de objeto pdf
		//    Description: funciï¿½n que imprime la cabecera por unidad administrativa
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaciï¿½n: 28/04/2006 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		//	    		   io_pdf // Instancia de objeto pdf
		//    Description: funciï¿½n que imprime el detalle por unidad administrativa
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaciï¿½n: 28/04/2006 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetDy(-2);
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>70), // Justificaciï¿½n y ancho de la columna
						 			   'nombre'=>array('justification'=>'left','width'=>220), // Justificaciï¿½n y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>70), // Justificaciï¿½n y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>70), // Justificaciï¿½n y ancho de la columna
						 			   'aporte'=>array('justification'=>'right','width'=>70))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
	...
	function uf_print_piedetalle($ai_totalasignacion,$ai_totaldeduccion,$ai_totalaporte,$ai_total_neto,&$io_pdf)
	{
		...
		//	    		   io_pdf // Instancia de objeto pdf
		//    Description: funciï¿½n que imprime el fin de la cabecera por unidad administrativa
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaciï¿½n: 28/04/2006 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $ls_bolivares;
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Mï¿½ximo de la tabla
						 'xOrientation'=>'center', // Orientaciï¿½n de la tabla
						 'cols'=>array('totales'=>array('justification'=>'right','width'=>290), // Justificaciï¿½n y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>70), // Justificaciï¿½n y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>70), // Justificaciï¿½n y ancho de la columna
						 			   'aporte'=>array('justification'=>'right','width'=>70))); // Justificaciï¿½n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientaciï¿½n de la tabla
						 'cols'=>array('name'=>array('justification'=>'center'))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_piecabecera($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientaciï¿½n de la tabla
						 'cols'=>array('asignacion'=>array('justification'=>'center','width'=>150), // Justificaciï¿½n y ancho de la columna
						 			   'deduccion'=>array('justification'=>'center','width'=>150), // Justificaciï¿½n y ancho de la columna
						 			   'aporte'=>array('justification'=>'center','width'=>150))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Mï¿½ximo de la tabla
						 'xOrientation'=>'center', // Orientaciï¿½n de la tabla
						 'cols'=>array('name'=>array('justification'=>'right','width'=>250), // Justificaciï¿½n y ancho de la columna
						 			   'total'=>array('justification'=>'left','width'=>250))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->setStrokeColor(0,0,0);
		$io_pdf->Rectangle(15,60,570,100); 
		$io_pdf->line(15,140,585,140);	//HORIZONTAL	
		$io_pdf->addText(60,150,7,'<b>ELABORADO POR:</b>'); // Agregar el tï¿½tulo
		$io_pdf->addText(30,63,7,"ANALISTA DE RECURSOS HUMANOS"); // Agregar el tï¿½tulo
		$io_pdf->line(190,60,190,160);	//VERTICAL	
		$io_pdf->line(15,70,585,70);	//HORIZONTAL
		$io_pdf->addText(260,150,7,'<b>REVISADO POR:</b>'); // Agregar el tï¿½tulo
		$io_pdf->addText(260,63,7,"JEFE OFICINA"); // Agregar el tï¿½tulo
		$io_pdf->line(380,60,380,160);	//VERTICAL	
		$io_pdf->addText(420,150,7,'<b>APROBADO POR: xxxx</b>  '); // Agregar el tï¿½tulo
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3,2.5,3,3); // Configuraciï¿½n de los margenes en centï¿½metros
