	...
	function uf_print_cabecera(&$io_pdf,$as_sueint)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('periodo'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
						 			   ...
						 			   'fechaing'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
									   'sueldointegral'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
						 			   'bonovacacional'=>array('justification'=>'center','width'=>45), // Justificación y ancho de la columna
						 			   'bonofin'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
									   'diaadi'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
						 			   'prisoc'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
									   'aporte'=>array('justification'=>'center','width'=>50))); // Justificación y ancho de la columna
	...
	function uf_print_totales($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('total'=>array('justification'=>'right','width'=>290), // Justificación y ancho de la columna
						 			   'sueldointegral'=>array('justification'=>'right','width'=>50), // Justificación y ancho de la columna
						 			   'bonovacacional'=>array('justification'=>'right','width'=>45), // Justificación y ancho de la columna
						 			   'bonofin'=>array('justification'=>'right','width'=>40), // Justificación y ancho de la columna
						 			   'diaadi'=>array('justification'=>'right','width'=>40), // Justificación y ancho de la columna
									   'prisoc'=>array('justification'=>'right','width'=>40), // Justificación y ancho de la columna
									   'aporte'=>array('justification'=>'right','width'=>50))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
