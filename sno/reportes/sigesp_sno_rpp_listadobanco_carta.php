<?php
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
function uf_print_carta_banco($as_nomban,$as_desnom,$ad_fecdesper,$ad_fechasper,$as_codcue,$as_peractnom,&$io_pdf)
{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(140,618,10,$ls_ciudad); // Agregar el ciudad
		$io_pdf->ezSetDy(-10);
		$io_pdf->ezText("Señores:",12,array('justification' => 'left','spacing' =>1.5));
		$io_pdf->ezText(strtoupper($as_nomban),12,array('justification' => 'left','spacing' =>1.5));
		$io_pdf->ezText("Ciudad.- ",12,array('justification' => 'left','spacing' =>1.5));	
		$io_pdf->ezSetDy(-15);
		$ls_texto="           Estimamosle efectuar los abonos en cuentas que se indican a continuación por pago de sueldos al".
		          " personal correspondiente  ".$ls_quincena. " con cargo total  a nuestra C/C ".$as_codcue.", con ustedes";			 
	...
	else // Imprimimos el reporte
	{
		...
		{			
			...
			unset($io_encabezado);
			$io_pdf->ezNewPage();
			uf_print_carta_banco($ls_nomban,$ls_desnom,$ld_fecdesper,$ld_fechasper,$ls_codcue,$ls_periodo,$io_pdf); 
