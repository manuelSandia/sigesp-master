<?php
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_cedper,$as_apenomper,$as_descar,$as_desuniadm,$ad_fecingper,$as_codcueban,$as_desubifis,$as_denmun,$as_denpar,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data=array(array('ubicacion'=>'<b>Ubicacion Fisica</b>','municipio'=>'<b>Municipio</b>','parroquia'=>'<b>Parroquia</b>'));
		$la_columnas=array('ubicacion'=>'',
						   'municipio'=>'',
						   'parroquia'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('ubicacion'=>array('justification'=>'center','width'=>200), // Justificación y ancho de la columna
						 			   'municipio'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
						 			   'parroquia'=>array('justification'=>'center','width'=>150))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);	

		$la_data=array(array('ubicacion'=>$as_desubifis,'municipio'=>$as_denmun,'parroquia'=>$as_denpar));
		$la_columnas=array('ubicacion'=>'',
						   'municipio'=>'',
						   'parroquia'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('ubicacion'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   'municipio'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
						 			   'parroquia'=>array('justification'=>'left','width'=>150))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);	
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_piepagina($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,$ai_totalpersonas,$ai_asignacionglobal,$ai_deduccionglobal,
	                            $ai_aporteglobal,$ai_netoglobal,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('titulo'=>'<b>Total de Personas </b>','total'=>$ai_totalpersonas));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>180), // Justificación y ancho de la columna
						 			   'total'=>array('justification'=>'left','width'=>320))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		unset($la_data);
		unset($la_columna);
		unset($la_config);

		$la_data=array(array('titulo'=>'<b>Sub Total Nómina '.$ls_bolivares.': </b>','asignacion'=>$ai_totasi,
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('titulo'=>'<b>Total Nómina '.$ls_bolivares.': </b>','asignacion'=>$ai_asignacionglobal,
							 'deduccion'=>$ai_deduccionglobal,'aporte'=>$ai_aporteglobal,'neto'=>$ai_netoglobal));
		$la_columna=array('titulo'=>'','asignacion'=>'','deduccion'=>'','aporte'=>'','neto'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			$ld_fecingper=$io_funciones->uf_convertirfecmostrar($io_report->rs_data->fields["fecingnom"]);
			...
			uf_print_cabecera($ls_cedper,$ls_apenomper,$ls_descar,$ls_desuniadm,$ld_fecingper,$ls_codcueban,$ls_desubifis,$ls_denmun,$ls_denpar,$io_pdf); // Imprimimos la cabecera del registro
		...
		$li_asignacionglobal=number_format($io_report->rs_data->fields["totalasignacion"],2,",",".");
		$li_deduccionglobal=number_format($io_report->rs_data->fields["totaldeduccion"],2,",",".");
		$li_aporteglobal=number_format(0,2,",",".");	
		$li_netoglobal=$io_report->rs_data->fields["totalasignacion"]-$io_report->rs_data->fields["totaldeduccion"];
		$li_netoglobal=number_format($li_netoglobal,2,",",".");			
		if(!(empty($ls_conceptop2)))
		{
			$li_aporteglobal=number_format($io_report->rs_data->fields["totalaporte"],2,",",".");	
		}
		...
		uf_print_piepagina($li_totasi,$li_totded,$li_totapo,$li_totgeneral,$li_totrow,$li_asignacionglobal,
					       $li_deduccionglobal,$li_aporteglobal,$li_netoglobal,$io_pdf);
