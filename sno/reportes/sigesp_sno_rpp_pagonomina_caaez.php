<?PHP
	...
	//----------------------------------------------------------------------------------------------------------------------------------
	function firmas (&$io_pdf)
	{
	  //----------------firmas--------------------------------------------------------------------------------------------
		$io_pdf->ezSetDy(-45);
		$la_data_f[1]=array('firma1'=>'Elaborado Por:', 'firma2'=>'Revisado por:','firma3'=>'Aprobador por:');		
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'width'=>500, // Ancho Máximo de la tabla
						 'cols'=>array('firma1'=>array('justification'=>'left','width'=>167),
						               'firma2'=>array('justification'=>'left','width'=>167),
						               'firma3'=>array('justification'=>'left','width'=>167)));
		$io_pdf->ezTable($la_data_f,$la_columna,'',$la_config);
		
		$la_data_f2[1]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data_f2[2]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data_f2[3]=array('firma1'=>''.$_SESSION['la_apeusu'].','.$_SESSION['la_nomusu'].'','firma2'=>'T.S.U. Pamela Silva/ Carina Zara','firma3'=>'Inti  Ernesto  MC Cormick');
		$la_data_f2[4]=array('firma1'=>'Asistente de Personal','firma2'=>'Jefe de Administración de Personal','firma3'=>'Presidente J. Directiva CAAEZ, S.A.');
		$la_data_f2[5]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data_f2[6]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data_f2[7]=array('firma1'=>'','firma2'=>'Lic. Yaimara Gimenez','firma3'=>'');
		$la_data_f2[8]=array('firma1'=>'','firma2'=>'Gerente de Recursos Humanos (E )','firma3'=>'');
		$la_data_f2[9]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data_f2[10]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data_f2[11]=array('firma1'=>'','firma2'=>'Lic. Rene Rodrìguez','firma3'=>'');
		$la_data_f2[12]=array('firma1'=>'','firma2'=>'Gerente de Admin. y Finanzas (E) ','firma3'=>'');
		$la_columna=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 ...
						 'cols'=>array('firma1'=>array('justification'=>'left','width'=>167),
						               'firma2'=>array('justification'=>'left','width'=>167),
						               'firma3'=>array('justification'=>'left','width'=>167)));
		$io_pdf->ezTable($la_data_f2,$la_columna,'',$la_config);
		
		$la_data_f3[1]=array('firma1'=>'Presupuestado por:', 'firma2'=>'','firma3'=>'Contabilizado por:');		
		$la_columna=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 ...
						 'cols'=>array('firma1'=>array('justification'=>'left','width'=>167),
						               'firma2'=>array('justification'=>'left','width'=>167),
						               'firma3'=>array('justification'=>'left','width'=>167)));
		$io_pdf->ezTable($la_data_f3,$la_columna,'',$la_config);
		
		$la_data_f4[1]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data_f4[2]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data_f4[3]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data_f4[4]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_columna=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 ...
						 'cols'=>array('firma1'=>array('justification'=>'left','width'=>167),
						               'firma2'=>array('justification'=>'left','width'=>167),
						               'firma3'=>array('justification'=>'left','width'=>167)));
		$io_pdf->ezTable($la_data_f4,$la_columna,'',$la_config);	
		//-----------------------------------------------------------------------------------------------------------------	
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3,4,3,3); // Configuración de los margenes en centímetros
