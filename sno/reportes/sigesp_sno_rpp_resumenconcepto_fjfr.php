<?php
	...
	function uf_print_cabecera(&$io_pdf)
	{
        ...
        $io_pdf->filledRectangle(31,688,540,$io_pdf->getFontHeight(11.5));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nro'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   ...
						 			   'partida'=>array('justification'=>'center','width'=>75), // Justificación y ancho de la columna
									   'asignacion'=>array('justification'=>'center','width'=>65), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'center','width'=>65), // Justificación y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nro'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   ...
						 			   'partida'=>array('justification'=>'center','width'=>75), // Justificación y ancho de la columna
									   'asignacion'=>array('justification'=>'right','width'=>65), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>65), // Justificación y ancho de la columna
	...
	function uf_print_piecabecera($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>335),
						 			   'asignacion'=>array('justification'=>'right','width'=>65), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>65), // Justificación y ancho de la columna
						 			   'aporte'=>array('justification'=>'right','width'=>75))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		...
		while ((!$rs_data->EOF)&&($lb_valido))
		{
			...
			switch($ls_tipsal)
			{
				case "A": // Asignación
					...
					$la_data[$li_i]=array('nro'=>$li_i,'codigo'=>$ls_codconc,'nombre'=>$ls_nomcon,'asignacion'=>$li_monto,'deduccion'=>'','aporte'=>'','partida'=>$ls_cueprecon);
					break;
				...
				case "D": // Deducción
					...
					$la_data[$li_i]=array('nro'=>$li_i,'codigo'=>$ls_codconc,'nombre'=>$ls_nomcon,'asignacion'=>'','deduccion'=>$li_monto,'aporte'=>'','partida'=>$ls_cueprecon);
					break;
				...
				case "P2": // Aporte Patrón
					...
					$la_data[$li_i]=array('nro'=>$li_i,'codigo'=>$ls_codconc,'nombre'=>$ls_nomcon,'asignacion'=>'','deduccion'=>'','aporte'=>$li_monto,'partida'=>$ls_cueprecon);
					break;
