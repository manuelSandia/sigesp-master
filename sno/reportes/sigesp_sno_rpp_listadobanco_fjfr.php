<?php
	...
	function uf_print_cabecera($as_nomban,&$io_cabecera,&$io_pdf)
	{
        ...
        $io_pdf->filledRectangle(36,690,530,$io_pdf->getFontHeight(14));
        $io_pdf->setColor(0,0,0);
		$io_pdf->addText(45,695,11,'<b>'.$as_nomban.'</b>'); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nro'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   ...
						 			   'fechaing'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
									   'cuenta'=>array('justification'=>'center','width'=>130), // Justificación y ancho de la columna
			...
			if (($ls_tipocuenta == '') ||  ($ls_tipocuenta == $ls_tipcueban))
			{
				...
				if($lb_valido)
				{
					...
					while(!$io_report->rs_data_detalle->EOF)
					{
						...
						$la_data[$li_s]=array('nro'=>$li_nro,'cedula'=>$ls_cedper,'nombre'=>$ls_nomper,'monto'=>$li_monnetres, 'cuenta'=>$ls_codcueban,'fechaing'=>$ld_fecingper);
						$li_s++;
