<?php
	...
	function uf_print_cabecera($as_cedper,$as_apenomper,$as_descar,$as_desuniadm,$ad_fecingper,$as_codcueban,$ai_sueper,&$io_pdf)
	{
		...
		$la_data=array(array('cedula'=>'<b>Cédula</b>','nombre'=>'<b>Nombre</b>','cargo'=>'<b>Cargo</b>',
							 'unidad'=>'<b>Unidad Adscripción</b>','fecha'=>'<b>Fecha Ingreso</b>','sueldo'=>'<b>Sueldo Base</b>'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cedula'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
									   ...
									   'unidad'=>array('justification'=>'center','width'=>110), // Justificación y ancho de la columna
						 			   'fecha'=>array('justification'=>'center','width'=>70),// Justificación y ancho de la columna
									   'sueldo'=>array('justification'=>'center','width'=>60))); // Justificación y ancho de la columna)); 
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);	

		$la_data=array(array('cedula'=>$as_cedper,'nombre'=>$as_apenomper,'cargo'=>$as_descar,'unidad'=>$as_desuniadm,'fecha'=>$ad_fecingper,'sueldo'=>$ai_sueper));
		$la_columnas=array('cedula'=>'',
						   'nombre'=>'',
						   'cargo'=>'',
						   'unidad'=>'',
	...
	function uf_print_piecabecera($ai_totalasignacion,$ai_totaldeduccion,$ai_totalaporte,$ai_total_neto,$as_obsrecper,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('totales'=>array('justification'=>'right','width'=>200), // Justificación y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'aporte'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_piepagina($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,$ai_totalregistros,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>180), // Justificación y ancho de la columna
						 			   ...
						 			   'neto'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$la_data=array(array('titulo'=>'<b>Total Cantidad de Personas:    '.$ai_totalregistros.'</b>'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>466, // Orientación de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>180))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	else // Imprimimos el reporte
	{
		...
		uf_print_piepagina($li_totasi,$li_totded,$li_totapo,$li_totgeneral,$li_totalregistros,$io_pdf);
