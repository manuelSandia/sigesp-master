	...
	function uf_contableconceptos_contable($as_codper="")
	{
		...
		if($ls_modo=="OC") // Si el modo de contabilizar la n�mina es Compromete y Causa tomamos la cuenta pasivo de la n�mina.
		{
			...
			if(($ls_espnom==1)&&($ls_ctnom==1))
			{
					...
					{
						/*$ls_sql=$ls_sql." UNION ".
								" SELECT rpc_proveedor.sc_cuenta as cuenta, MAX(scg_cuentas.denominacion) as denominacion, CAST('H' AS char(1)) as operacion, -sum(sno_salida.valsal) as total ".
					...
					{
						$ls_sql=$ls_sql." UNION ".
								" SELECT rpc_beneficiario.sc_cuenta as cuenta, MAX(scg_cuentas.denominacion) as denominacion, CAST('H' AS char(1)) as operacion, -sum(sno_salida.valsal) as total ".
		...
		else
		{
			...
			$ls_sql=$ls_sql." UNION ".
					...
					"   AND (sno_personalnomina.pagbanper = 1 OR sno_personalnomina.pagtaqper = 1)".
					"   AND sno_personalnomina.pagefeper = 0 ".
					"   AND scg_cuentas.status = 'C' AND sno_nomina.descomnom = 'B' 
AND sno_nomina.codemp = sno_salida.codemp AND sno_nomina.codnom = sno_salida.codnom 
AND sno_nomina.peractnom = sno_salida.codperi AND sno_personalnomina.codemp = sno_salida.codemp 
AND sno_personalnomina.codnom = sno_salida.codnom AND sno_personalnomina.codper = sno_salida.codper 
AND sno_nomina.codemp = rpc_beneficiario.codemp AND sno_nomina.codbennom = rpc_beneficiario.ced_bene 
AND rpc_beneficiario.codemp = scg_cuentas.codemp AND rpc_beneficiario.sc_cuenta = scg_cuentas.sc_cuenta 
GROUP BY scg_cuentas.sc_cuenta   ";
		/*	$ls_sql=$ls_sql." UNION ".
					"SELECT scg_cuentas.sc_cuenta as cuenta, MAX(scg_cuentas.denominacion) as denominacion, CAST('H' AS char(1)) as operacion, -sum(sno_salida.valsal) as total ".
					"  FROM sno_personalnomina, sno_salida, sno_banco, scg_cuentas ".
	...
	//echo "<br>".$ls_sql;
		...
		{
			//$this->io_mensajes->message("CLASE->Report M�TODO->uf_contableconceptos_contable ERROR->".$ls_sql);
		//	$lb_valido=false;
	...
	function uf_cuadreconceptoaporte_aportes()
	{
		...
		// Buscamos todas aquellas cuentas presupuestarias de los conceptos que se integran directamente con presupuesto
		$ls_sql="SELECT sno_concepto.codestpro1, sno_concepto.codestpro2, sno_concepto.codestpro3, sno_concepto.codestpro4, sno_concepto.codestpro5, ".
				"		sno_concepto.estcla, sno_concepto.cueprepatcon, sum(sno_salida.valsal) as total ".
		...
		$ls_sql=$ls_sql." UNION ".
				"SELECT sno_unidadadmin.codestpro1, sno_unidadadmin.codestpro2, sno_unidadadmin.codestpro3, sno_unidadadmin.codestpro4, sno_unidadadmin.codestpro5, ".
				"		sno_unidadadmin.estcla, sno_concepto.cueprepatcon, sum(sno_salida.valsal) as total".
	...
	function uf_cuadreconceptoaporte_conceptos()
	{
		...
		$ls_sql="SELECT sno_concepto.codestpro1, sno_concepto.codestpro2, sno_concepto.codestpro3, sno_concepto.codestpro4, sno_concepto.codestpro5, ".
				"		sno_concepto.estcla, sno_concepto.cueprecon, sum(sno_salida.valsal) as total ".
				"  FROM sno_personalnomina, sno_salida, sno_concepto ".
				" WHERE sno_salida.codemp='".$this->ls_codemp."' ".
				"   AND sno_salida.codnom='".$this->ls_codnom."' ".
				"   AND sno_salida.codperi='".$this->ls_peractnom."' ".
		...
		$ls_sql=$ls_sql." UNION ".
				"SELECT sno_unidadadmin.codestpro1, sno_unidadadmin.codestpro2, sno_unidadadmin.codestpro3, sno_unidadadmin.codestpro4, sno_unidadadmin.codestpro5, ".
				"		sno_unidadadmin.estcla, sno_concepto.cueprecon, sum(sno_salida.valsal) as total ".
				"  FROM sno_personalnomina, sno_unidadadmin, sno_salida, sno_concepto ".
				" WHERE sno_salida.codemp='".$this->ls_codemp."' ".
				"   AND sno_salida.codnom='".$this->ls_codnom."' ".
				"   AND sno_salida.codperi='".$this->ls_peractnom."' ".
	...
	function uf_contableconceptos_presupuesto_enmohca()
	{
		...
		// Buscamos todas aquellas cuentas presupuestarias de los conceptos A , que se integran directamente con presupuesto
		$ls_sql="SELECT sno_concepto.codestpro1, sno_concepto.codestpro2, sno_concepto.codestpro3, sno_concepto.codestpro4, sno_concepto.codestpro5, ".
				"		sno_concepto.estcla, sno_concepto.cueprecon, spg_cuentas.denominacion, sum(sno_salida.valsal) as total ".
				"  FROM sno_personalnomina, sno_salida, sno_concepto, spg_cuentas ".
				" WHERE sno_salida.codemp='".$this->ls_codemp."' ".
				"   AND sno_salida.codnom='".$this->ls_codnom."' ".
				"   AND sno_salida.codperi='".$this->ls_peractnom."' ".
		...
		$ls_sql=$ls_sql." UNION ".
				"SELECT sno_unidadadmin.codestpro1, sno_unidadadmin.codestpro2, sno_unidadadmin.codestpro3, sno_unidadadmin.codestpro4, sno_unidadadmin.codestpro5, ".
				"		sno_unidadadmin.estcla, sno_concepto.cueprecon, spg_cuentas.denominacion, sum(sno_salida.valsal) as total ".
				"  FROM sno_personalnomina, sno_unidadadmin, sno_salida, sno_concepto, spg_cuentas ".
				" WHERE sno_salida.codemp='".$this->ls_codemp."' ".
				"   AND sno_salida.codnom='".$this->ls_codnom."' ".
				"   AND sno_salida.codperi='".$this->ls_peractnom."' ".
