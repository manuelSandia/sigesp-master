<?php
	...
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,&$io_cabecera,$as_obsrecper,&$io_pdf)
	{
		...
		$io_pdf->ezSetY(668);
		$la_data=array(array('denomasig'=>'<b>DENOMINACIÓN</b>', '1'=>'<b>CUOTA</b>','valorasig'=>'<b>ASIGNACIÓN</b>', 'denomdedu'=>'<b>DENOMINACIÓN</b>', '2'=>'<b>CUOTA</b>','valordedu'=>'<b>DEDUCCIÓN</b>'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>130), // Justificación y ancho de la columna
						 			   '1'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
									   'valorasig'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   ...
						 			   '2'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'left','width'=>130), // Justificación y ancho de la columna
						 			   'cuotaasi'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
									   'valorasig'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'left','width'=>130), // Justificación y ancho de la columna
									   'cuotadedu'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>60))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_obsrecper,&$io_pdf)
	{
		...
		$io_pdf->addText(40,400,'10','<b>Observación:</b>');
		$io_pdf->ezSety(414);
