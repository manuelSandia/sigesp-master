<?php
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],50,310,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=306-($li_tm/2);
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,$as_desubifis,$as_denmun,$as_denpar,&$io_cabecera,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->ezSetY(667);
		$la_data=array(array('ubicacion'=>'Ubicación Física: '.$as_desubifis,'municipio'=>'Municipio: '.$as_denmun,'parroquia'=>'Parroquia: '.$as_denpar));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'rowGap'=>0.5,
						 'cols'=>array('ubicacion'=>array('justification'=>'left','width'=>200),
						 			   'municipio'=>array('justification'=>'left','width'=>175),
									   'parroquia'=>array('justification'=>'left','width'=>175))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera2($as_cedper,$as_nomper,$as_descar,$as_desubifis,$as_denmun,$as_denpar,&$io_cabecera,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>220), // Justificación y ancho de la columna
						 			   ...
						 			   'cargo'=>array('justification'=>'left','width'=>260))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(40,277,'10','______________________________________________________________________________________________');
		$io_pdf->ezSetY(277);
		$la_data=array(array('ubicacion'=>'Ubicación Física: '.$as_desubifis,'municipio'=>'Municipio: '.$as_denmun,'parroquia'=>'Parroquia: '.$as_denpar));
		$la_columna=array('ubicacion'=>'','municipio'=>'','parroquia'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('ubicacion'=>array('justification'=>'left','width'=>200),
									   ...
									   'parroquia'=>array('justification'=>'left','width'=>175))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(40,267,'10','______________________________________________________________________________________________');
		$io_pdf->ezSetY(268);
		$la_data=array(array('denomasig'=>'<b>DENOMINACIÓN</b>', 'valorasig'=>'<b>ASIGNACIÓN</b>', 'denomdedu'=>'<b>DENOMINACIÓN</b>','valordedu'=>'<b>DEDUCCIÓN</b>'));
		$la_columna=array('denomasig'=>'<b>DENOMINACIÓN</b>',
						  'valorasig'=>'<b>ASIGNACIÓN</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
						 			   ...
						 			   'valordedu'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,256,'10','______________________________________________________________________________________________');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_cabecera,'all');
	}// end function uf_print_cabecera
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($li_reg==1)
			{
				uf_print_cabecera1($ls_cedper,$ls_nomper,$ls_descar,$ls_desubifis,$ls_denmun,$ls_denpar,$io_cabecera,$io_pdf); // Imprimimos la cabecera del registro
			}
			else
			{
				uf_print_cabecera2($ls_cedper,$ls_nomper,$ls_descar,$ls_desubifis,$ls_denmun,$ls_denpar,$io_cabecera,$io_pdf); // Imprimimos la cabecera del registro
			}
			$ls_codperi="";
			if($ls_consolidar=="0")
			{
