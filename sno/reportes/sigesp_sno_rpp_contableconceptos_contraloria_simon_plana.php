<?php
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$la_data[1]=array('firma1'=>'ELABORADO POR','firma2'=>'CONTABILIDAD','firma3'=>'PRESUPUESTO','firma4'=>'ADMINISTRACION Y FINANZAS','firma5'=>'CONTRALORA MUNICIPIAL','firma6'=>'');
		$la_data[2]=array('firma1'=>'','firma2'=>'','firma3'=>'','firma4'=>'','firma5'=>'','firma6'=>'');
		$la_data[3]=array('firma1'=>'','firma2'=>'','firma3'=>'',
						  'firma4'=>'','firma5'=>'','firma6'=>'');
            $la_data[4]=array('firma1'=>'','firma2'=>'','firma3'=>'','firma4'=>'','firma5'=>'','firma6'=>'');

		$la_columna=array('firma1'=>'_____________________','firma2'=>'_____________________','firma3'=>'_____________________',
						  'firma4'=>'_____________________','firma5'=>'_____________________','firma6'=>'');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>0, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 ...
						 'width'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
				 		 'cols'=>array('firma1'=>array('justification'=>'center','width'=>105), // Justificación y ancho de la columna
						 			   'firma2'=>array('justification'=>'center','width'=>105), // Justificación y ancho de la columna
						 			   'firma3'=>array('justification'=>'center','width'=>105), // Justificación y ancho de la columna
						 			   'firma4'=>array('justification'=>'center','width'=>105), // Justificación y ancho de la columna
						 			   'firma5'=>array('justification'=>'center','width'=>105), // Justificación y ancho de la columna
						 			   'firma6'=>array('justification'=>'center','width'=>0))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
		{
			...
			$ls_cueprecon=rtrim($io_report->DS->data["cueprecon"][$li_i]);
