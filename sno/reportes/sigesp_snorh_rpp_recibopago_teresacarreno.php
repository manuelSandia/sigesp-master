<?php
	...
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->addText(500,780,11,date("d/m/Y")); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->addText(500,362,11,date("d/m/Y")); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	function uf_print_cabecera1($as_codper,$as_cedper,$as_nomper,$as_codcueban,$as_unidadadmin,&$io_cabecera,&$io_pdf)
	{
		...
		//	    		   as_unidadadmin // código de la unidad administrativa
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>585, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'rowGap'=>0.5,
						 'cols'=>array('unidad'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
						 			   'codigo'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'cedula'=>array('justification'=>'center','width'=>85), // Justificación y ancho de la columna
	...
	function uf_print_cabecera2($as_codper,$as_cedper,$as_nomper,$as_codcueban,$as_unidadadmin,&$io_cabecera,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>595, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'rowGap'=>0.5,
						 'cols'=>array('unidad'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
						 			   'codigo'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'rowGap'=>0.5,
						 'cols'=>array('denominacion'=>array('justification'=>'left','width'=>245), // Justificación y ancho de la columna
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(0,1,1,0.5); // Configuración de los margenes en centímetros
