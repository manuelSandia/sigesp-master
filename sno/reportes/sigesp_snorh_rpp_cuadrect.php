<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_periodo,$as_programatica,$as_programatica2,&$io_pdf)
	{
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,725,11,$as_periodo); // Agregar el t�tulo
		$li_tm=$io_pdf->getTextWidth(11,$as_programatica);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,710,11,$as_programatica); // Agregar el t�tulo
		$io_pdf->addText($tm,697,11,$as_programatica2); // Agregar el t�tulo
	...
	function uf_print_detalle($la_data,$ls_programatica,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('programatica'=>array('programatica'=>'left','width'=>520))); // Justificaci�n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('nom'=>array('justification'=>'center','width'=>240), // Justificaci�n y ancho de la columna
						 			   'monct'=>array('justification'=>'right','width'=>70), // Justificaci�n y ancho de la columna
						 			   'mondes'=>array('justification'=>'right','width'=>70), // Justificaci�n y ancho de la columna
						 			   'montot'=>array('justification'=>'right','width'=>70),
									   'porc'=>array('justification'=>'right','width'=>70))); // Justificaci�n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('nom'=>array('justification'=>'left','width'=>240), // Justificaci�n y ancho de la columna
						 			   'monct'=>array('justification'=>'right','width'=>70), // Justificaci�n y ancho de la columna
						 			   'mondes'=>array('justification'=>'right','width'=>70), // Justificaci�n y ancho de la columna
						 			   'montot'=>array('justification'=>'right','width'=>70),
									   'porc'=>array('justification'=>'right','width'=>70))); // Justificaci�n y ancho de la columna
	...
	function uf_print_total($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('nom'=>array('justification'=>'right','width'=>240), // Justificaci�n y ancho de la columna
						 			   'monct'=>array('justification'=>'right','width'=>70), // Justificaci�n y ancho de la columna
						 			   'mondes'=>array('justification'=>'right','width'=>70), // Justificaci�n y ancho de la columna
						 			   'montot'=>array('justification'=>'right','width'=>70),
									   'porc'=>array('justification'=>'right','width'=>70))); // Justificaci�n y ancho de la columna
	...
	$ls_titulo2="";
	$ls_periodo="<b>Periodo Nro ".$ls_periodo;
	//--------------------------------------------------------------------------------------------------------------------------------
	...
	if(($lb_valido==false)||($rs_data2->RecordCount()==0)) // Existe alg�n error � no hay registros
	{
		print("<script language=JavaScript>");
	...
	else // Imprimimos el reporte
	{
		...
		uf_print_encabezado_pagina($ls_titulo,$ls_periodo,$ls_programatica,$ls_programatica2,$io_pdf); // Imprimimos el encabezado de la p�gina
		...
		{	
			$ls_estruc=$rs_data2->fields["codestpro1"].$rs_data2->fields["codestpro2"].$rs_data2->fields["codestpro3"].$rs_data2->fields["codestpro4"].$rs_data2->fields["codestpro5"];
			$rs_data2->MoveNext();
			$lb_valido=$io_report->uf_cuadrect($ls_codperi,$ls_ano,$ls_estruc,$ls_estruc,$ls_estcla,$ls_estcla2,$rs_data);			
			while ((!$rs_data->EOF)&&($lb_valido))
		   	{
					
					$ls_estruc2=$rs_data->fields["codestpro1"].$rs_data->fields["codestpro2"].$rs_data->fields["codestpro3"].$rs_data->fields["codestpro4"].$rs_data->fields["codestpro5"];
					...
					if (trim($rs_data->fields["desnom"]) != trim($ls_desnom))
					{
						...
						$ld_porc=round($ld_totgennom*0.025,2);
						$ld_porc2=round($ld_totgennom2*0.025,2);
