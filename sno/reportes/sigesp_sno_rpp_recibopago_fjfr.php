<?PHP
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$li_tm=$io_pdf->getTextWidth(9,$as_periodo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,330,9,$as_periodo); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(9,$as_desnom);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,315,9,$as_desnom); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
...
$ls_desubifis,&$io_cabecera,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->saveState();
		$io_pdf->ezSetDy(-5);
		$as_desuniadm_cort=substr($as_desuniadm,0,40)."...";
		$io_pdf->addText(405,703,7,$as_desuniadm_cort); // Agregar el título
		$la_data[1]=array('nombre'=>'Apellidos y Nombres','cedula'=>'Cédula','fechaingreso'=>'Fecha Ingreso','sueldo'=>'Ubicacion');
		$la_data[2]=array('nombre'=>$as_nomper,'cedula'=>$as_cedper,'fechaingreso'=>$ad_fecingper,'sueldo'=>$ls_desubifis);
		$la_columna=array('nombre'=>'Apellidos y Nombres', 'cedula'=>'Cédula','fechaingreso'=>'Fecha Ingreso','sueldo'=>'Sueldo');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'rowGap' => 0.5 ,
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>210), // Justificación y ancho de la columna
						 			   'cedula'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'fechaingreso'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'sueldo'=>array('justification'=>'right','width'=>180))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		$la_data[1]=array('cargo'=>'                                                             Cargo', 'departamento'=>'                                                  Unidad Administrativa');
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('denomasig'=>'<b>CONCEPTOS</b>', 'valorasig'=>'<b>ASIGNACIÓN</b>', 
		                     'cantidaddedu'=>'<b>CANT</b>','denomdedu'=>'<b>CONCEPTOS</b>','valordedu'=>'<b>DEDUCCIÓN</b>',
							 'valoracumulado'=>'<b>ACUMULADO</b>'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>185), // Justificación y ancho de la columna
						 			   'valorasig'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'center','width'=>185), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'valoracumulado'=>array('justification'=>'right','width'=>60))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(35,656,'10','___________________________________________________________________________________________________');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera2($as_codper,$as_cedper,$as_nomper,$as_descar,$as_codcueban,$as_desuniadm,$ad_fecingper,$ai_sueper,$ls_desubifis,&$io_cabecera,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->ezSetDy(-110);
		$as_desuniadm_cort=substr($as_desuniadm,0,40)."...";
		$io_pdf->addText(405,313,7,$as_desuniadm_cort); // Agregar el título
		$la_data[1]=array('nombre'=>'Apellidos y Nombres','cedula'=>'Cédula','fechaingreso'=>'Fecha Ingreso','sueldo'=>'Ubicacion');
		$la_data[2]=array('nombre'=>$as_nomper,'cedula'=>$as_cedper,'fechaingreso'=>$ad_fecingper,'sueldo'=>$ls_desubifis);
		$la_columna=array('nombre'=>'Apellidos y Nombres', 'cedula'=>'Cédula','fechaingreso'=>'Fecha Ingreso','sueldo'=>'Sueldo');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
		...
		unset($la_config);
		$la_data=array(array('denomasig'=>'<b>CONCEPTOS</b>', 'valorasig'=>'<b>ASIGNACIÓN</b>',
							 'denomdedu'=>'<b>CONCEPTOS</b>','valordedu'=>'<b>DEDUCCIÓN</b>',
							 'valoracumulado'=>'<b>ACUMULADO</b>'));
		$la_columna=array('denomasig'=>'<b>DENOMINACIÓN</b>',
						  'valorasig'=>'<b>ASIGNACIÓN</b>',
						  'denomdedu'=>'<b>DENOMINACIÓN</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>185), // Justificación y ancho de la columna
						 			   ...
						 			   'valoracumulado'=>array('justification'=>'right','width'=>60))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(35,266,'10','___________________________________________________________________________________________________');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_cabecera,'all');
	}// end function uf_print_cabecera
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('denomasig'=>array('justification'=>'left','width'=>185), // Justificación y ancho de la columna
						 			   'valorasig'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'left','width'=>185), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'valoracumulado'=>array('justification'=>'right','width'=>60))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$la_banco,$as_pago,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->saveState();
		$io_pdf->ezSety(480);
		$io_pdf->addText(35,480,'10','___________________________________________________________________________________________________');
		$io_pdf->ezSety(480);
		$la_data=array(array('denomasig'=>'<b>Total Ingresos '.$ls_bolivares.'</b>', 'valorasig'=>$ai_toting, 
		                     'denomdedu'=>'<b>Total Deducciones '.$ls_bolivares.'</b>','valordedu'=>$ai_totded,'valoracumulado'=>''));
		$la_columna=array('denomasig'=>'<b>DENOMINACIÓN</b>',
						  'valorasig'=>'<b>ASIGNACIÓN</b>',
						  'denomdedu'=>'<b>DENOMINACIÓN</b>',
						  'valordedu'=>'<b>DEDUCCIÓN</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('denomasig'=>array('justification'=>'right','width'=>180), // Justificación y ancho de la columna
						 			   'valorasig'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'right','width'=>170), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'valoracumulado'=>array('justification'=>'right','width'=>40))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(35,464,'10','___________________________________________________________________________________________________');
		$la_data=array(array('forma'=>'<b>Banco:</b>  '.$la_banco,'neto'=>'<b>Neto a Cobrar '.$ls_bolivares.':</b>  '.$ai_totnet));
		$la_columna=array('forma'=>'','neto'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 7,  // Tamaño de Letras de los títulos
						 'showLines'=>0, // Mostrar Líneas
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('forma'=>array('justification'=>'left','width'=>255), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>230))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(35,448,'10','___________________________________________________________________________________________________');
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('conforme'=>'','espacio'=>''),array('conforme'=>'','espacio'=>'<b>Recibi Conforme:</b>_________________________________'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('conforme'=>array('justification'=>'left','width'=>200),
						 		 	   'espacio'=>array('justification'=>'right','width'=>300))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_cabecera2($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$la_banco,$as_pago,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_piepagina=$io_pdf->openObject(); // Creamos el objeto pie de página
		$io_pdf->saveState();
		$io_pdf->addText(35,90,'10','___________________________________________________________________________________________________');
		$io_pdf->ezSety(90);
		$la_data=array(array('denomasig'=>'<b>Total Ingresos '.$ls_bolivares.'</b>', 'valorasig'=>$ai_toting, 
		                     'denomdedu'=>'<b>Total Deducciones '.$ls_bolivares.'</b>','valordedu'=>$ai_totded,
							 'valoracumulado'=>''));
		$la_columna=array('denomasig'=>'<b>DENOMINACIÓN</b>',
						  'valorasig'=>'<b>ASIGNACIÓN</b>',
						  'denomdedu'=>'<b>DENOMINACIÓN</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>130), // Justificación y ancho de la columna
						 			   'valorasig'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'center','width'=>130), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'valoracumulado'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(35,74,'10','___________________________________________________________________________________________________');
		$la_data=array(array('forma'=>'<b>Banco:</b>  '.$la_banco, 'neto'=>'<b>Neto a Cobrar '.$ls_bolivares.':</b>  '.$ai_totnet));
		$la_columna=array('forma'=>'','neto'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 ...
						 'cols'=>array('forma'=>array('justification'=>'left','width'=>255), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>230))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(35,58,'10','___________________________________________________________________________________________________');
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('conforme'=>'','espacio'=>''),array('conforme'=>'','espacio'=>'<b>Recibi Conforme:</b>_________________________________'));
	...
	$ls_periodo="</b> del <b>".$ld_fecdesper."</b> al <b>".$ld_fechasper."</b>";
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($li_reg==1)
			{
				uf_print_cabecera1($ls_codper,$ls_cedper,$ls_nomper,$ls_descar,$ls_codcueban,$ls_desuniadm,$ld_fecingper, $li_sueper,$ls_desubifis,$io_cabecera,$io_pdf); // Imprimimos la cabecera del registro
			}
			else 
			{
				uf_print_cabecera2($ls_codper,$ls_cedper,$ls_nomper,$ls_descar,$ls_codcueban,$ls_desuniadm,$ld_fecingper,$li_sueper,$ls_desubifis,$io_cabecera,$io_pdf); // Imprimimos la cabecera del registro
			}
			...
			if($lb_valido)
			{
				...
				if($li_adelanto==1)// Utiliza el adelanto de quincena
				{
					switch($ls_quincena)
					{
						case "1": // primera quincena;
							...
							$la_data_a[$li_asig]=array('denominacion'=>$ls_nomcon,'valor'=>$li_valsal,'cantidad'=>'');
							break;
						...
						case "2": // segunda quincena;
							while(!$io_report->rs_data_detalle->EOF)
							{
								...
								if(($ls_tipsal=="A") || ($ls_tipsal=="V1") || ($ls_tipsal=="V2") || ($ls_tipsal=="R")) // Buscamos las asignaciones
								{
									...
									$li_cantidad=number_format($io_report->DS_detalle->data["unidad"][$li_s],0);
									if ($ls_tipsal!="R")
									{
									...
									$la_data_a[$li_asig]=array('denominacion'=>$ls_nomcon,'valor'=>$li_valsal,'cantidad'=>$li_cantidad);
								}
								else // Buscamos las deducciones y aportes
								{
									...
									$li_valsal=$io_fun_nomina->uf_formatonumerico(abs($io_report->rs_data_detalle->fields["valsal"]));
									$li_cantidad=number_format($io_report->rs_data_detalle->fields["unidad"],0);
									$li_acuemp="";
									$li_repacucon=$io_report->rs_data_detalle->fields["repacucon"];
									if($li_repacucon=="1")
									{
										$li_acuemp=$io_fun_nomina->uf_formatonumerico(abs($io_report->rs_data_detalle->fields["acuemp"]));
									}
									$la_data_d[$li_dedu]=array('denominacion'=>$ls_nomcon,'valor'=>$li_valsal,'acumulado'=>$li_acuemp,'cantidad'=>$li_cantidad);
								}
							...
							$li_valsal=$io_fun_nomina->uf_formatonumerico($li_valsal);
							$li_cantidad="";
							$la_data_d[$li_dedu]=array('denominacion'=>$ls_nomcon,'valor'=>$li_valsal,'acumulado'=>0,'cantidad'=>$li_cantidad);
							break;
				...
				if($li_reg==1)
				{
					uf_print_pie_cabecera1($li_toting,$li_totded,$li_totnet,$ls_codcueban,$ls_banco,$ls_pago,$io_pdf); // Imprimimos pie de la cabecera
				}
				else
				{
					uf_print_pie_cabecera2($li_toting,$li_totded,$li_totnet,$ls_codcueban,$ls_banco,$ls_pago,$io_pdf); // Imprimimos pie de la cabecera
				}
				unset($la_data_a);
				unset($la_data_d);
				unset($la_data);
