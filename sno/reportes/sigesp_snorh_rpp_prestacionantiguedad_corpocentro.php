<?php
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$io_pdf->addText(66,60,9,'Elaborado por'); // Agregar el título

		$io_pdf->line(208,70,320,70);
		$io_pdf->addText(212,60,9,'Responsable del Area de'); // Agregar el título
		$io_pdf->addText(221,50,9,'Recursos Humanos'); // Agregar el título

		$io_pdf->line(355,70,470,70);
		$io_pdf->addText(358,60,9,'Gerente de Administracion'); // Agregar el título
		$io_pdf->addText(382,50,9,'de Recursos'); // Agregar el título
	...
	function uf_print_totales($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('total'=>array('justification'=>'right','width'=>260), // Justificación y ancho de la columna
						 			   'sueldointegral'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'bonovacacional'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'bonofin'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3.9,4,3,3); // Configuración de los margenes en centímetros
		...
		uf_print_firmas($io_pdf); // Imprimimos el encabezado de la página 
