<?php
	...
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->addText(220,760,8,"REPUBLICA BOLIVARIANA DE VENEZUELA"); // Agregar el título
		$io_pdf->addText(223,750,8,"MINISTERIO DEL PODER POPULAR PARA"); // Agregar el título
		$io_pdf->addText(220,740,8,"LAS RELACIONES INTERIORES Y JUSTICIA"); // Agregar el título
		$io_pdf->addText(235,730,8,"OFICINA NACIONAL ANTIDROGAS"); // Agregar el título
		$io_pdf->addText(235,720,8,"FONDO NACIONAL ANTIDROGAS"); // Agregar el título
		$io_pdf->addText(230,710,8,"OFICINA DE RECURSOS HUMANOS"); // Agregar el título
		$io_pdf->addText(246,700,8,$as_titulo); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->addJpegFromFile('../../shared/imagebank/fona1.jpg',40,310,65,65); // Agregar Logo
		$io_pdf->addJpegFromFile('../../shared/imagebank/fona2.jpg',500,310,65,65); // Agregar Logo
		$io_pdf->addText(220,370,8,"REPUBLICA BOLIVARIANA DE VENEZUELA"); // Agregar el título
		$io_pdf->addText(223,360,8,"MINISTERIO DEL PODER POPULAR PARA"); // Agregar el título
		$io_pdf->addText(220,350,8,"LAS RELACIONES INTERIORES Y JUSTICIA"); // Agregar el título
		$io_pdf->addText(235,340,8,"OFICINA NACIONAL ANTIDROGAS"); // Agregar el título
		$io_pdf->addText(235,330,8,"FONDO NACIONAL ANTIDROGAS"); // Agregar el título
		$io_pdf->addText(230,320,8,"OFICINA DE RECURSOS HUMANOS"); // Agregar el título
		$io_pdf->addText(246,310,8,$as_titulo); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_nomper,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('conforme'=>'Yo, '.$as_nomper.' , declaro que he recibido los conceptos aquí mencionados'),
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('conforme'=>array('justification'=>'center','width'=>600))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_cabecera2($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_nomper,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($lb_valido)
			{
				...
				if($li_reg==1)
				{
					uf_print_pie_cabecera1($li_toting,$li_totded,$li_totnet,$ls_codcueban,$ls_nomper,$io_pdf); // Imprimimos pie de la cabecera
				}
				else
				{
					uf_print_pie_cabecera2($li_toting,$li_totded,$li_totnet,$ls_codcueban,$ls_nomper,$io_pdf); // Imprimimos pie de la cabecera
				}
