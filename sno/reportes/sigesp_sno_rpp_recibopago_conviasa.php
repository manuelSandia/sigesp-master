<?php
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>239, // Orientación de la tabla
						 'cols'=>array('codcon'=>array('justification'=>'left','width'=>100),    // Justificación y ancho de la columna
						 			   'denomasig'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
	...
	function uf_print_detalle2($la_data2,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>289, // Orientación de la tabla
						 'cols'=>array('codcon'=>array('justification'=>'left','width'=>100),
						 			   'denomdedu'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
...
//--------------------------------------------------------------------------------------------------------------------------------
	...
	else // Imprimimos el reporte
	{
		...
		uf_print_encabezado_pagina1($ls_titulo,$ls_desnom,$ls_periodo,$ld_fecdesper,$ld_fechasper,$io_pdf); // Imprimimos el encabezado de la página
		uf_print_encabezado_pagina2($ls_titulo,$ls_desnom,$ls_periodo,$ld_fecdesper,$ld_fechasper,$io_pdf); // Imprimimos el encabezado de la página
