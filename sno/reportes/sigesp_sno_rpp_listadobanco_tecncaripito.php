<?php
	...
	{
		$ls_desquincena="Primera Quincena del mes de ".$io_fecha->uf_load_nombre_mes(substr($ld_fecdesper,3,2))." del ".substr($ld_fecdesper,6,4);
	}
	else
	{
		$ls_desquincena="Segunda Quincena del mes de ".$io_fecha->uf_load_nombre_mes(substr($ld_fecdesper,3,2))." del ".substr($ld_fecdesper,6,4);
	}
