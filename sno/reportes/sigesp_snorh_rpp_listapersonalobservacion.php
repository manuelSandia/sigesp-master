<?php
	...
	function uf_print_cabecera(&$io_pdf)
	{
        ...
        $io_pdf->filledRectangle(65,506,670,$io_pdf->getFontHeight(11));
        $io_pdf->setColor(0,0,0);
		$la_data[1]=array('codigo'=>'<b>Código</b>',
		                  'cedula'=>'<b>Cédula</b>',
						  'nombre'=>'<b>Nombre y Apellidos</b>',
						  'obs'=>'<b>Obervación</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   ...
						 			   'obs'=>array('justification'=>'center','width'=>320))); // Justificación y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   ...
						 			   'obs'=>array('justification'=>'left','width'=>320))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_listadopersonal_personal_observacion($ls_codnomdes,$ls_codnomhas,$ls_codperdes,$ls_codperhas,$ls_activo,$ls_egresado,
														   ...
														   $ls_codpar,$ls_orden,$ls_uniadmin); // Obtenemos el detalle del reporte
	}
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
		{
			...
			$ls_obs=$io_report->DS->data["obsper"][$li_i];
			
			$la_data[$li_i]=array('codigo'=>$ls_codper,'cedula'=>$ls_cedper,'nombre'=>$ls_nomper,
								  'obs'=>$ls_obs);
		}
