<?php
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,$as_titrepnom,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//	    		   as_desnom // Descripción de la nómina
		//	    		   as_periodo // Descripción del período
		//	    		   as_titrepnom // Título del Reporte
		...
		$li_tm=$io_pdf->getTextWidth(11,$as_titrepnom);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,740,11,$as_titrepnom); // Agregar el título
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_minorguniadm,$as_ofiuniadm,$as_uniuniadm,$as_depuniadm,$as_prouniadm,$as_desuniadm,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[2]=array('titulo'=>'<b>Unidad Administrativa</b> '.$as_minorguniadm.'-'.$as_ofiuniadm.'-'.$as_uniuniadm.'-'.$as_depuniadm.'-'.$as_prouniadm.'  '.$as_desuniadm.'');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cedula'=>array('justification'=>'left','width'=>500))); // Justificación y ancho de la columna
	...
	$ls_titrepnom=$_SESSION["la_nomina"]["titrepnom"];
	$ld_fecdesper=$io_funciones->uf_convertirfecmostrar($_SESSION["la_nomina"]["fecdesper"]);
	$ld_fechasper=$io_funciones->uf_convertirfecmostrar($_SESSION["la_nomina"]["fechasper"]);
	$ls_titulo="<b>NÓMINA DE PAGO</b>";
	...
	else // Imprimimos el reporte
	{
		...
		uf_print_encabezado_pagina($ls_titulo,$ls_desnom,$ls_periodo,$ls_titrepnom,$io_pdf); // Imprimimos el encabezado de la página
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			while((!$io_report->rs_data_detalle->EOF)&&($lb_valido))
			{
				...
				if($lb_valido)
				{
					...
					$io_report->DS_detalle2->resetds("codconc");
