			...
			if($lb_valido)
			{
				...
				while(!$io_report->rs_data_detalle->EOF)
				{
					...
					if(($ls_tipsal=="A") || ($ls_tipsal=="V1") || ($ls_tipsal=="W1") ) // Buscamos las asignaciones
					{
						...
						$la_data[$li_s]=array('codigo'=>$ls_codconc,'denominacion'=>$ls_nomcon."  ".$li_cantidad,'asignacion'=>$li_valsal,'deduccion'=>'');
					}
					else // Buscamos las deducciones y aportes
					{
						...
						$la_data[$li_s]=array('codigo'=>$ls_codconc,'denominacion'=>$ls_nomcon."  ".$li_cantidad,'asignacion'=>'','deduccion'=>$li_valsal);
					}
					$li_s++;
