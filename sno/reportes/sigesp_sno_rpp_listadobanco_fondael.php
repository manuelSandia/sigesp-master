<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,720,10,$as_periodo); // Agregar el título
	...
	function uf_print_cabecera($as_nomban,&$io_cabecera,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->saveState();
		$la_data=array(array('name'=>'Señores:'),
		               array('name'=>'<b>Banco: '.$as_nomban.'</b>'),	   		               
					   array('name'=>'Ciudad.-'),
					   array('name'=>'           Por medio de la presente autorizamos a cargar en nuestra cuenta Corriente No: <b>'.$_GET["codcue"].'</b> las siguientes cantidades de acuerdo al siguiente detalle, para hacerse efectiva el dia '.$_GET["fecpro"].'.'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500,
						 'justification' => 'full'); // Ancho Mínimo de la tabla
	...
	function uf_print_piecabecera($ai_total,&$io_pdf)
	{
		...
		$io_numero_letra->setNumero($ai_total);
		$as_monto=$io_numero_letra->letra();
		$la_data=array(array('monto'=>"Son Bs. ".$as_monto));
		$la_columna=array('monto'=>'');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500,
						 'cols'=>array('monto'=>array('justification'=>'full','width'=>570))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		$la_data=array(array('name'=>''),
		               ...
		               array('name'=>''),
		               array('name'=>''),					   					   
					   array('name'=>'<b>                               XXXXXXXXXXXXXX                                                            YYYYYYYYYYYYYY'),	   		               
		               array('name'=>'                                      Presidente                                                                         Administrador'),
					   array('name'=>'                                  C.I.: 12.345.678                                                                     C.I.: 12.345.678</b>'));
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 10, // Tamaño de Letras
						 'showLines'=>0, // Mostrar Lineas
						 ...
						 'xOrientation'=>'center', // Ancho de la tabla						 
						 'maxWidth'=>500,
						 'justification' => 'center'); // Ancho Mínimo de la tabla
