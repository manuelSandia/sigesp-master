<?php
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$la_data[2]=array('firma1'=>'Realizado Por','firma2'=>'Revisado Por');
		$la_data[3]=array('firma1'=>'','firma2'=>'');
		$la_data[4]=array('firma1'=>'____________________________','firma2'=>'____________________________');
		$la_data[5]=array('firma1'=>'Lic. Victor E. Gonzalez Ch.','firma2'=>'Lic. María Ignacia García');
		$la_data[6]=array('firma1'=>'','firma2'=>'');
		$la_data[7]=array('firma1'=>'','firma2'=>'');
		$la_data[8]=array('firma1'=>'','firma2'=>'');
		$la_data[9]=array('firma1'=>'Revisado Por','firma2'=>'Revisado Por');
		$la_data[10]=array('firma1'=>'','firma2'=>'');
		$la_data[11]=array('firma1'=>'____________________________','firma2'=>'____________________________');
		$la_data[12]=array('firma1'=>'Lic. Yusbely González','firma2'=>'Lic. Sandra Sarmiento');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
				 		 'cols'=>array('firma1'=>array('justification'=>'center','width'=>300), // Justificación y ancho de la columna
						 			   'firma2'=>array('justification'=>'center','width'=>300))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
