<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo2,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->Rectangle(52,60,500,70); 
		$io_pdf->line(52,116,552,116);	//HORIZONTAL	
		$io_pdf->addText(80,121,7,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(90,79,7,"Firma:"); // Agregar el título
		$io_pdf->addText(54,69,7,"COORDINADORA (E) DE NOMINA"); // Agregar el título
		$io_pdf->addText(72,62,7," Y BIENESTAR"); // Agregar el título
		
		$io_pdf->line(170,60,170,130);	//VERTICAL	
		$io_pdf->addText(205,121,7,"REVISADO POR:"); // Agregar el título
		$io_pdf->addText(215,79,7,"Firma:"); // Agregar el título
		$io_pdf->addText(172,67,7,"GERENTE DE RECURSOS HUMANOS"); // Agregar el título
		$io_pdf->line(300,60,300,130);	//VERTICAL
		
        $io_pdf->addText(330,121,7,"CONFOMADO POR:"); // Agregar el título
		$io_pdf->addText(340,79,7,"Firma:"); // Agregar el título
		$io_pdf->addText(310,67,7,"VICEPRESIDENTE EJECUTIVO"); // Agregar el título
		$io_pdf->line(420,60,420,130);	//VERTICAL
		
		$io_pdf->addText(450,121,7,"APROBADO POR:"); // Agregar el título
		$io_pdf->addText(460,79,7,"Firma:"); // Agregar el título 
		$io_pdf->addText(440,67,7,"PRESIDENTE EJECUTIVO"); // Agregar el título 
		
		$io_pdf->line(52,85,552,85); //HORIZONTAL
		$io_pdf->line(52,75,552,75); //HORIZONTAL
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3.3,5.5,3,3); // Configuración de los margenes en centímetros
