<?php
	...
	else // Imprimimos el reporte
	{
		...
		$lo_hoja->set_column(15,15,40);
		$lo_hoja->set_column(16,16,40);
		...
		$lo_hoja->write(4, 15, "Escala Docente",$lo_titulo);
		$lo_hoja->write(4, 16, "Clasificación Docente",$lo_titulo);
		$li_col=16;
		...
		while(!$io_report->rs_data->EOF)
		{
			...
			$ls_denescdoc=$io_report->rs_data->fields["desescdoc"];
			$ls_dencladoc=$io_report->rs_data->fields["descladoc"];
			$ls_programatica="";
			...
			$lo_hoja->write($li_row, 15, $ls_denescdoc, $lo_dataleft);
			$lo_hoja->write($li_row, 16, $ls_dencladoc, $lo_dataleft);
			$li_col=16;
