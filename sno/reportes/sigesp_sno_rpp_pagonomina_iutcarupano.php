<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$la_data=array(array('codigop'=>'<b>CÓDIGO</b>','cedula'=>'<b>CÉDULA</b>','nombre'=>'<b>APELLIDOS Y NOMBRE</b>','cargo'=>'<b>CARGO</b>',
							 'unidad'=>'<b>UNIDAD DE ADSCRIPCIÓN</b>','firma'=>'<b>FIRMA</b>'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigop'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
									   ...
									   'unidad'=>array('justification'=>'center','width'=>160), // Justificación y ancho de la columna
						 			   'firma'=>array('justification'=>'center','width'=>120))); // Justificación y ancho de la columna
	...
	function uf_print_cabecera($num,$as_codper,$as_cedper,$as_apenomper,$as_descar,$as_desuniadm,$ad_fecingper,$as_codcueban,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>403, // Orientación de la tabla
						 'cols'=>array('codigop'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'cedula'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'nombre'=>array('justification'=>'center','width'=>200), // Justificación y ancho de la columna
						 			   'cargo'=>array('justification'=>'center','width'=>120),// Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>212, // Orientación de la tabla
						 'cols'=>array('fecingper'=>array('justification'=>'left','width'=>160), // Justificación y ancho de la columna
						 			   'cuebanper'=>array('justification'=>'left','width'=>170))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>422, // Orientación de la tabla
						 'rowGap' =>-2 ,
						 'cols'=>array('line'=>array('justification'=>'left','width'=>660))); // Justificación y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'nombre'=>array('justification'=>'left','width'=>199), // Justificación y ancho de la columna
									   ...
									   'deduccion'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>90))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
	...
	function uf_print_piecabecera($as_apenomper,$ai_totalasignacion,$ai_totaldeduccion,$ai_totalaporte,$ai_total_neto,$as_obsrecper,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>430, // Orientación de la tabla
						 'cols'=>array('totales'=>array('justification'=>'center','width'=>259), // Justificación y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
									   'firma'=>array('justification'=>'right','width'=>160))); // Justificación y ancho de la columna
	...
	function uf_print_piepagina($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>220), // Justificación y ancho de la columna
