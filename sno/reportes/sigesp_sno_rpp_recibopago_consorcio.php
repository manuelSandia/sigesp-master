<?php
	...
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->addText(460,730,6,"<b>AVENIDA FRANCISCO DE MIRANDA</b>"); // Agregar el título
		$io_pdf->addText(462,725,6,"<b>TORRE PEQUIVEN, PLANTA BAJA</b>"); // Agregar el título
		$io_pdf->addText(443,720,6,"<b>URB. CHACAO, MUN. CHACAO, ESTADO MIRANDA</b>"); // Agregar el título
		$io_pdf->addText(480,715,6,"<b>RIF. G-20008338-7</b>"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->addText(460,310,6,"<b>AVENIDA FRANCISCO DE MIRANDA</b>"); // Agregar el título
		$io_pdf->addText(462,305,6,"<b>TORRE PEQUIVEN, PLANTA BAJA</b>"); // Agregar el título
		$io_pdf->addText(443,300,6,"<b>URB. CHACAO, MUN. CHACAO, ESTADO MIRANDA</b>"); // Agregar el título
		$io_pdf->addText(480,295,6,"<b>RIF. G-20008338-7</b>"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,&$io_cabecera,&$io_pdf)
	{
		...
		$io_pdf->ezSetY(668);
		$la_data=array(array('denomasig'=>'', 'valorasig'=>'<b>ASIGNACIÓN</b>', 'denomdedu'=>'','valordedu'=>'<b>DEDUCCIÓN</b>'));
	...
	function uf_print_cabecera2($as_cedper,$as_nomper,$as_descar,&$io_cabecera,&$io_pdf)
	{
		...
		$io_pdf->addText(350,38,'9',"N° C.I:  ".$as_cedper);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_cabecera,'all');
	}// end function uf_print_cabecera
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,&$io_pdf)
	{
		...
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,478,'10','------------------------------------------------------------------------------------------------------------------------------------------------------------');
		$io_pdf->addText(350,468,'9','<b>Recibí Conforme</b>');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_pie_cabecera2($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,&$io_pdf)
	{
		...
		$io_pdf->addText(350,48,'9','<b>Recibí Conforme</b>');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_piepagina,'all');
		$io_pdf->stopObject($io_piepagina); // Detener el objeto pie de página
