<?php
	...
	if ($ls_quincena==1)
	{
		$ls_prosegquin="PRIMERA QUINCENA";
	}
	elseif ($ls_quincena==2)
	{
		$ls_prosegquin="SEGUNDA QUINCENA";
	}
	else
	{
		$ls_prosegquin="";
	...
	$ls_periodo="<b>Período Desde ".$ls_codperdes." Hasta ".$ls_codperhas." ".$ls_prosegquin."</b>";
