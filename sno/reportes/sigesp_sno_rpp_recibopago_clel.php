<?php
	...
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],50,705,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		...
		$io_pdf->addText(20,765,9,'República Bolivariana de Venezuela'); // Agregar el título
              $io_pdf->addText(20,755,9,'Consejo Legislativo del Estado Lara '); // Agregar el título
              $io_pdf->addText(30,695,9,'Oficina de Recursos Humanos '); // Agregar el título
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],50,295,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=306-($li_tm/2);
		...
		$io_pdf->addText(20,355,9,'República Bolivariana de Venezuela'); // Agregar el título
              $io_pdf->addText(20,345,9,'Consejo Legislativo del Estado Lara '); // Agregar el título
              $io_pdf->addText(30,285,9,'Oficina de Recursos Humanos '); // Agregar el título
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,&$io_cabecera,$as_gerencia,$ad_fechaingreso,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->ezSetDy(-11);
		$la_data=array(array('nombre'=>'Apellidos y Nombres:', 'cedula'=>'Cédula:', 'cargo'=>'Cargo:', 'departamento'=>'Departamento:' ,'fecha'=>'Fecha Ingreso' ));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'','departamento'=>'', 'fecha'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   ...
						 			   'cargo'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la columna
									   'departamento'=>array('justification'=>'left','width'=>90), // Justificación y ancho de la columna
									   'fecha'=>array('justification'=>'left','width'=>90))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(40,284,'10','______________________________________________________________________________________________');
		$la_data=array(array('nombre'=>$as_nomper, 'cedula'=>$as_cedper, 'cargo'=>substr($as_descar,0,30), 'departamento'=>substr($as_gerencia,0,20),'fecha'=>$ad_fechaingreso));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'','departamento'=>'', 'fecha'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
		...
		$io_pdf->addText(40,510,'8','_______________________');
		$io_pdf->addText(50,500,'8','RECIBI CONFORME');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera2($as_cedper,$as_nomper,$as_descar,&$io_cabecera,$as_gerencia,$ad_fechaingreso,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(40,90,'8','_______________________');
		$io_pdf->addText(50,80,'8','RECIBI CONFORME');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_cabecera,'all');
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($li_reg==1)
			{
				uf_print_cabecera1($ls_cedper,$ls_nomper,$ls_descar,$io_cabecera,$ls_gerencia,$ld_fechaingreso,$io_pdf); // Imprimimos la cabecera del registro
			}
			else
			{
				uf_print_cabecera2($ls_cedper,$ls_nomper,$ls_descar,$io_cabecera,$ls_gerencia,$ld_fechaingreso,$io_pdf); // Imprimimos la cabecera del registro
			}
