<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		//	   Creado Por: Ing. Yesenia Moreno
		// Modificado Por: TSU Juan Castellanos		
		// Fecha Creación: 09/10/2007 
		// Fecha Modificación: 13/01/2010 		
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->rectangle(50,20,505,60); // Rectangulo
		$io_pdf->line(50,67,555,67); // linea horizontal superior
		$io_pdf->line(50,30,555,30); // linea horizontal inferior
		$io_pdf->addText(85,70,8,'ELABORADO POR'); 
		$io_pdf->addText(50,40,8,'Lcda.'.$_SESSION['la_apeusu'].','.$_SESSION['la_nomusu']); // nombre del usuario en el reporte
		$io_pdf->addText(90,23,7,'ANALISTA RRHH');
		$io_pdf->line(210,80,210,20); // primera linea vertical
		$io_pdf->addText(235,70,8,'GERENTE DE ADMIN Y RRHH');
		$io_pdf->line(380,80,380,20);  // segunda linea vertical
		$io_pdf->addText(240,23,7,'LCDA. MARIA STELLA GARZON');
		$io_pdf->addText(443,70,8,'PRESIDENCIA');
		$io_pdf->addText(420,23,7,'LCDA. ROSANGELA PEREIRA M.');
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3.55,4,3,3); // Configuración de los margenes en centímetros
