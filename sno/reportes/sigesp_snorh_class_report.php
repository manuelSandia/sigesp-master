...
function uf_generar_reporte($ls_sql)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_aportepatronal_personal
		//		   Access: public (desde la clase sigesp_snorh_rpp_aportepatronal)  
...
//				$this->DS->group_by(array('0'=>'codper'),array('0'=>'personal','1'=>'patron'),'codper');
	...
	function uf_aportepatronal_personal3($aa_codconcapo,$aa_codconcded,$aa_codconcpcp,$aa_codconcpmp,$aa_codconcbic,$aa_codconcuti,$aa_codconcma,$as_codnomdes,$as_codnomhas,$as_ano,$as_mesdes,$as_meshas,$as_perdes,$as_perhas,$todosconcepto,$aa_codconcsfu,$aa_codconcpco,$aa_codconclma,$aa_codconcopt,$aa_codconcsir){
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_criterioma="";
	    $li_total=count($aa_codconcma);
		for($li_i=0;$li_i<$li_total;$li_i++)
		{
			$ls_codconcma=str_pad($aa_codconcma[$li_i],10,"0",0);
			if($li_i==0)
			{
				$ls_criterioma=$ls_criterioma." AND (  sno_hsalida.codconc in (".$aa_codconcma.") ";
			}
			else
			{
				$ls_criterioma=$ls_criterioma."    OR sno_hsalida.codconc in (".$aa_codconcma.") ";
			}
		}
		if($li_total>0)
		{
			$ls_criterioma=$ls_criterioma.")";
		}	
		...
		$ls_criteriosfu="";
	    $li_total=count($aa_codconcsfu);
		for($li_i=0;$li_i<$li_total;$li_i++)
		{
			$ls_codconcsfu=str_pad($aa_codconcsfu[$li_i],10,"0",0);
			if($li_i==0)
			{
				$ls_criteriosfu=$ls_criteriosfu." AND (  sno_hsalida.codconc in (".$aa_codconcsfu.") ";
			}
			else
			{
				$ls_criteriosfu=$ls_criteriosfu."    OR sno_hsalida.codconc in (".$aa_codconcsfu.") ";
			}
		}
		if($li_total>0)
		{
			$ls_criteriosfu=$ls_criteriosfu.")";
		}	
		
		$ls_criteriopco="";
	    $li_total=count($aa_codconcpco);
		for($li_i=0;$li_i<$li_total;$li_i++)
		{
			$ls_codconcpco=str_pad($aa_codconcpco[$li_i],10,"0",0);
			if($li_i==0)
			{
				$ls_criteriopco=$ls_criteriopco." AND (  sno_hsalida.codconc in (".$aa_codconcpco.") ";
			}
			else
			{
				$ls_criteriopco=$ls_criteriopco."    OR sno_hsalida.codconc in (".$aa_codconcpco.") ";
			}
		}
		if($li_total>0)
		{
			$ls_criteriopco=$ls_criteriopco.")";
		}	
		
		
		$ls_criteriolma="";
	    $li_total=count($aa_codconclma);
		for($li_i=0;$li_i<$li_total;$li_i++)
		{
			$ls_codconclma=str_pad($aa_codconclma[$li_i],10,"0",0);
			if($li_i==0)
			{
				$ls_criteriolma=$ls_criteriolma." AND (  sno_hsalida.codconc in (".$aa_codconclma.") ";
			}
			else
			{
				$ls_criteriolma=$ls_criteriolma."    OR sno_hsalida.codconc in (".$aa_codconclma.") ";
			}
		}
		if($li_total>0)
		{
			$ls_criteriolma=$ls_criteriolma.")";
		}	
		
		
		$ls_criterioopt="";
	    $li_total=count($aa_codconcopt);
		for($li_i=0;$li_i<$li_total;$li_i++)
		{
			$ls_codconcopt=str_pad($aa_codconcopt[$li_i],10,"0",0);
			if($li_i==0)
			{
				$ls_criterioopt=$ls_criterioopt." AND (  sno_hsalida.codconc in (".$aa_codconcopt.") ";
			}
			else
			{
				$ls_criterioopt=$ls_criterioopt."    OR sno_hsalida.codconc in (".$aa_codconcopt.") ";
			}
		}
		if($li_total>0)
		{
			$ls_criterioopt=$ls_criterioopt.")";
		}	
		
		
		
		$ls_criteriosir="";
	    $li_total=count($aa_codconcsir);
		for($li_i=0;$li_i<$li_total;$li_i++)
		{
			$ls_codconcsir=str_pad($aa_codconcsir[$li_i],10,"0",0);
			if($li_i==0)
			{
				$ls_criteriosir=$ls_criteriosir." AND (  sno_hsalida.codconc in (".$aa_codconcsir.") ";
			}
			else
			{
				$ls_criteriosir=$ls_criteriosir."    OR sno_hsalida.codconc in (".$aa_codconcsir.") ";
			}
		}
		if($li_total>0)
		{
			$ls_criteriosir=$ls_criteriosir.")";
		}	
		
		

        $ls_criteriotodos="";
	    $li_total=count($todosconcepto);
		for($li_i=0;$li_i<$li_total;$li_i++)
		{
			$ls_criteriotodos=str_pad($todosconcepto[$li_i],10,"0",0);
			if($li_i==0)
			{
				$ls_criteriotodos=" AND (  sno_hsalida.codconc in (".$todosconcepto.") ";
			}
			else
			{
				$ls_criteriotodos=$ls_criteriotodos."    OR sno_hsalida.codconc in (".$todosconcepto.") ";
			}
		}
		if($li_total>0)
		{
			$ls_criteriotodos=$ls_criteriotodos.")";
		}	


		
		// $ls_criterio = $ls_criterio." AND sno_hsalida.valsal<>0 "; Colocado en comentario por Ofimatica de Venezuela el 11-05-2011
		$ls_sql= "SELECT distinct sno_personalnomina.codper, ".
"      lpad(sno_personal.cedper,8,'0') as cedper , ".
"      sno_personal.apeper, ".
"      sno_personal.nomper, ".
"      (select max(sno_personalnomina.sueper) from sno_personalnomina where sno_personalnomina.codper=sno_personalnomina.codper )as sueper, ".
"      ".
"      sno_personal.nacper, ".
...
"       sno_personalnomina.fecegrper AS fecegrnom, ".
"       sno_personal.estper, ".
...
"       lpad(sno_personalnomina.codcueban,30,' ') as codcueban,".
"       '105' as codban,".
 ...
 "   OR sno_hsalida.tipsal='V3' OR sno_hsalida.tipsal='W3' OR sno_hsalida.tipsal='Q1') ".
  "  and sno_hsalida.codemp='".$this->ls_codemp."' ".
   ...
   "  AND sno_personalnomina.codemp = sno_hsalida.codemp ".
   "   AND sno_personalnomina.codnom = sno_hsalida.codnom ".
   "  ".
  "    AND sno_personalnomina.codper = sno_hsalida.codper) as personal, ".     
  "    (SELECT SUM(valsal) FROM sno_hsalida WHERE (sno_hsalida.tipsal='P2' OR sno_hsalida.tipsal='V4'
   ...
   "  AND sno_personalnomina.codnom = sno_hsalida.codnom ".
   "   ".
    " AND sno_personalnomina.codper = sno_hsalida.codper) as patron, ".
  "   (SELECT SUM(valsal) FROM sno_hsalida WHERE sno_hsalida.codemp='".$this->ls_codemp."' ".
     $ls_criterio."  ". $ls_criteriopcp.
   "  AND sno_personalnomina.codemp = sno_hsalida.codemp ".
    " AND sno_personalnomina.codnom = sno_hsalida.codnom ".
    " ".
    " AND sno_personalnomina.codper = sno_hsalida.codper) as pcp, ".
    " (SELECT SUM(valsal) FROM sno_hsalida WHERE sno_hsalida.codemp='".$this->ls_codemp."' ".
     $ls_criterio."  ". $ls_criteriopmp.
     " AND sno_personalnomina.codemp = sno_hsalida.codemp ".
    " AND sno_personalnomina.codnom = sno_hsalida.codnom ".
    "   ".
    " AND sno_personalnomina.codper = sno_hsalida.codper) as pmp, ".
     " (SELECT SUM(valsal) FROM sno_hsalida WHERE sno_hsalida.codemp='".$this->ls_codemp."' ".
     $ls_criterio."  ". $ls_criteriobic.
  "   AND sno_personalnomina.codemp = sno_hsalida.codemp ". 
   "  AND sno_personalnomina.codnom = sno_hsalida.codnom  ".
   "    ".
    " AND sno_personalnomina.codper = sno_hsalida.codper) as bicentenario, ".
"    ( SELECT SUM(valsal) FROM sno_hsalida WHERE sno_hsalida.codemp='".$this->ls_codemp."' ".
     $ls_criterio."  ". $ls_criteriouti.
      " AND sno_personalnomina.codemp = sno_hsalida.codemp ". 
     " AND sno_personalnomina.codnom = sno_hsalida.codnom ". 
    "  ". 
    " AND sno_personalnomina.codper = sno_hsalida.codper) as utiles, ". 
"    ( SELECT SUM(valsal) FROM sno_hsalida WHERE sno_hsalida.codemp='".$this->ls_codemp."' ".
     $ls_criterio."  ". $ls_criterioma.
      " AND sno_personalnomina.codemp = sno_hsalida.codemp ". 
     " AND sno_personalnomina.codnom = sno_hsalida.codnom ". 
    "  ". 
    " AND sno_personalnomina.codper = sno_hsalida.codper) as ma, ". 
     
     "    ( SELECT SUM(valsal) FROM sno_hsalida WHERE sno_hsalida.codemp='".$this->ls_codemp."' ".
     $ls_criterio."  ". $ls_criteriosfu.
      " AND sno_personalnomina.codemp = sno_hsalida.codemp ". 
     " AND sno_personalnomina.codnom = sno_hsalida.codnom ". 
    "  ". 
    " AND sno_personalnomina.codper = sno_hsalida.codper) as sfu, ".

     "    ( SELECT SUM(valsal) FROM sno_hsalida WHERE sno_hsalida.codemp='".$this->ls_codemp."' ".
     $ls_criterio."  ". $ls_criteriopco.
      " AND sno_personalnomina.codemp = sno_hsalida.codemp ". 
     " AND sno_personalnomina.codnom = sno_hsalida.codnom ". 
    "  ". 
    " AND sno_personalnomina.codper = sno_hsalida.codper) as pco, ". 
     
     "    ( SELECT SUM(valsal) FROM sno_hsalida WHERE sno_hsalida.codemp='".$this->ls_codemp."' ".
     $ls_criterio."  ". $ls_criterioopt.
      " AND sno_personalnomina.codemp = sno_hsalida.codemp ". 
     " AND sno_personalnomina.codnom = sno_hsalida.codnom ". 
    "  ". 
    " AND sno_personalnomina.codper = sno_hsalida.codper) as opt, ". 
     
     
     "    ( SELECT SUM(valsal) FROM sno_hsalida WHERE sno_hsalida.codemp='".$this->ls_codemp."' ".
     $ls_criterio."  ". $ls_criteriosir.
      " AND sno_personalnomina.codemp = sno_hsalida.codemp ". 
     " AND sno_personalnomina.codnom = sno_hsalida.codnom ". 
    "  ". 
    " AND sno_personalnomina.codper = sno_hsalida.codper) as sir, ". 
     
     "    ( SELECT SUM(valsal) FROM sno_hsalida WHERE sno_hsalida.codemp='".$this->ls_codemp."' ".
     $ls_criterio."  ". $ls_criteriolma.
      " AND sno_personalnomina.codemp = sno_hsalida.codemp ". 
     " AND sno_personalnomina.codnom = sno_hsalida.codnom ". 
    "  ". 
    " AND sno_personalnomina.codper = sno_hsalida.codper) as lma, ". 
...
"            AND sno_personalnomina.codper = sno_hsalida.codper and sno_hsalida.codperi = sno_hconceptopersonal.codperi ".
"      	and sno_hsalida.codemp='".$this->ls_codemp."' ".
      $ls_criterio."  ".$ls_criteriotodos.
"            GROUP BY sno_personalnomina.codper) as acumulado,  trim(sno_personal.cedper) as cedper2 ".
 
"            FROM sno_personal, sno_personalnomina".
"             WHERE sno_personalnomina.codemp='".$this->ls_codemp."'  ".
"             AND sno_personalnomina.codnom in ('".$as_codnomdes."' )".

"             ".
"              ".
"                AND (sno_personalnomina.staper='1' ".
"                OR sno_personalnomina.staper='2')           ".
"                 AND sno_personal.codemp = sno_personalnomina.codemp".
"                  AND sno_personal.codper = sno_personalnomina.codper ".
"                  GROUP BY sno_personalnomina.codemp, ".
"                   ".
...
return $ls_sql;
	...
	function uf_aportepatronal_personal2($aa_codconc,$as_codnomdes,$as_codnomhas,$as_ano,$as_mesdes,$as_meshas,$as_perdes,$as_perhas)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_aportepatronal_personal
		//		   Access: public (desde la clase sigesp_snorh_rpp_aportepatronal)  
...
return $ls_sql;
											...
											$as_conceptoreporte,$as_tituloconcepto,$as_codperi)
	{
		...
		$ls_sql="SELECT sno_hconcepto.codconc, sno_hconcepto.codperi, MAX(".$ls_campo.") as nomcon, SUM(sno_hsalida.valsal) AS valsal, MAX(sno_hsalida.tipsal) AS tipsal, ".
				...
				"		MAX(sno_hconcepto.consunicon) AS consunicon, 0 AS unidad, 0 AS monacusal ".
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_prestacionantiguedad_afectacionpresupuestaria($as_codnom,$as_anocurper,$as_mescurper)
	{
		...
		$ls_sql="SELECT sno_dt_spg.codestpro1, sno_dt_spg.codestpro2, sno_dt_spg.codestpro3, sno_dt_spg.codestpro4, sno_dt_spg.codestpro5, ".
		        ...
		        " (select distinct spg_cuentas.denominacion from spg_cuentas where sno_dt_spg.spg_cuenta = spg_cuentas.spg_cuenta) as denominacion, ". 
				"  sno_dt_spg.monto ".
				"  FROM sno_dt_spg  ".  
