<?php
	...
	function uf_insert_seguridad($as_titulo,$as_desnom,$as_rango2,$as_periodo)
	{
		...
		$ls_descripcion="Generó el Reporte ".$as_titulo.". Para ".$as_desnom." ".$as_rango2.". ".$as_periodo;
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_rango2,$as_periodo,&$io_pdf)
	{
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,730,11,$as_desnom); // Agregar el título

		$li_tm=$io_pdf->getTextWidth(11,$as_rango2);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,720,11,$as_rango2); // Agregar el título
	...
	$ls_rango= "Nómina Desde: ".$ls_desnomdes;
	$ls_rango2=" Nómina Hasta: ".$ls_desnomhas;
