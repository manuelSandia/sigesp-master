...
class sigesp_sno_c_cierre_periodo4
{
	...
	function sigesp_sno_c_cierre_periodo4()
	{
		...
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		//////////////////////////////////////////////////////////////////////////////
	...
	function uf_reversar_acumular_conceptos($as_codperi_abrir)
	{
		...
		//	  Description: Funci�n que se encarga reversar el acumulado de los conceptos al momento de abrir un periodo
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo M�TODO->uf_reversar_acumular_conceptos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			while(!$rs_data->EOF)
			{
				$ls_tipsal=$rs_data->fields["tipsal"];
				$ld_valsal=$rs_data->fields["valsal"];
	...
	function uf_reversar_actualizar_periodo($as_codperi_abrir)
	{
		...
		//	    Arguments: as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que se enacarga de reversar el perido, ya cerrado para proceder abrir otro
		//     Creado por: Ing. Yozelin Barrag�n
		// Fecha Creaci�n: 11/02/2006          Fecha �ltima Modificacion : 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		//////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo4 M�TODO->uf_reversar_actualizar_periodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function uf_procesar_contabilizacion()
	{
		...
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que se encarga de procesar la data para la contabilizaci�n del per�odo
		...
		$ls_descripcion=$ls_desnom."- Per�odo ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper; // Descripci�n de Conceptos
		$ls_descripcioning=$ls_desnom." INGRESOS - Per�odo ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper; // Descripci�n de Conceptos
		$ls_descripcionapo=$ls_desnom." APORTES - Per�odo ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper; // Descripci�n de Aportes
		$ls_descripcion_int=$ls_desnom."- Per�odo ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper." Asiento Intercompa�ia"; // Descripci�n de Conceptos Asiento intercomap�ias
		$ls_descripcionapo_int=$ls_desnom." APORTES - Per�odo ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper." Asiento Intercompa�ia"; // Descripci�n de Aportes Asientos intercompa�ias
		$ls_cuentapasivo="";
		$ls_operacionnomina="";
		$ls_operacionaporte="";
		$ls_tipodestino="";
		...
		$li_tipdocnom="";
		$li_tipdocapo="";
		// Obtenemos la configuraci�n de la contabilizaci�n de la n�mina
		...
		{// insertamos la contabilizaci�n de contabilidad de conceptos
			if($ls_operacionnomina!="O")// Si es compromete no genero detalles contables
			{
				...
				{
					//para contabilizar cuentas contables de intercompa�ias
		...
		if($lb_valido)
		{ // insertamos la contabilizaci�n de presupuesto de aportes
		...
		if($lb_valido)
		{// insertamos la contabilizaci�n de contabilidad de aportes
		...
		if($lb_valido)
		{ // insertamos la contabilizaci�n de ingresos
		...
		if($lb_valido)
		{
			$lb_valido=$this->uf_verificar_contabilizacion($ls_codcom); // N�mina
		}
		if($lb_valido)
		{
	...
	function uf_validar_cuentas($as_codnom,$as_codperi)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre_Periodo_4 M�TODO->uf_validar_cuentas ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$lb_valido=true;
		}
		else
		{
			...
			while(!$rs_data->EOF)
			{
				...
				$estprog[0]=$rs_data->fields["codestpro1"];
				$estprog[1]=$rs_data->fields["codestpro2"];
				$estprog[2]=$rs_data->fields["codestpro3"];
				$estprog[3]=$rs_data->fields["codestpro4"];
				$estprog[4]=$rs_data->fields["codestpro5"];
				...
				if($li_existe>0)
				{
					...
					if($li_monto>$li_disponibilidad)
					{
						...
						{
							$ls_codestpro  = $ls_codestpro1.'-'.$ls_codestpro2.'-'.$ls_codestpro3.'-'.$ls_codestpro5.'-'.$ls_codestpro5;
						}
						$li_monto=number_format($li_monto,2,",",".");
						$li_disponibilidad=number_format($li_disponibilidad,2,",",".");
	...
	&$ai_gennotdeb,&$ai_genvou,&$ai_genrecdoc,&$ai_genrecapo,&$ai_tipdocnom,&$ai_tipdocapo)
	{
		...
		//	    		   as_modoaporte  //  modo de contabilizaci�n de los aportes
		...
		//	    		   ai_genrecapo  // generar recepci�n de documento de aporte
		//	    		   ai_tipdocnom  // Tipo de documento de n�mina
		//	    		   ai_tipdocapo  // Tipo de documento de aporte
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que busca los datos de la configuraci�n de la contabilizaci�n de la n�min
		//     Creado por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 31/05/2006
		///////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("ERROR-> La n�mina debe tener una Destino de Contabilizaci�n (Proveedor � Beneficiario).");
		}
		else
		{
		...
		if($ai_genrecdoc=="1") // Genera recepci�n de Documento de la N�mina.
		{
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("ERROR-> Debe Seleccionar un Tipo de Documento,Para la Recepci�n de Documento de la N�mina. ");
			}
		}
		if($ai_genrecapo=="1") // Genera recepci�n de Documento de los aportes
		{
			if(trim($ai_tipdocapo)=="")
			{
				$lb_valido=false;
				$this->io_mensajes->message("ERROR-> Debe Seleccionar un Tipo de Documento,Para la Recepci�n de Documento de los Aportes. ");
			}
		}
		return  $lb_valido;
	...
	function uf_delete_contabilizacion($as_peractnom)
	{
		...
		//	  Description: Funcion que elimina la contabilizaci�n de los conceptos en spg
		//     Creado por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 31/05/2006
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_delete_conceptos_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		if($lb_valido)
		{
			$ls_sql="DELETE ".
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_delete_conceptos_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			}
		}
		if($lb_valido)
		{
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_delete_conceptos_spi ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			}
		}
		if($lb_valido)
		{
	...
	$ai_gennotdeb,$ai_genvou,$as_codcomapo)
	{
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_insert_contabilizacion_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
	...
	$ai_monto,$as_tipnom,$as_codconc,$ai_genrecdoc,$ai_tipdoc,$ai_gennotdeb,$ai_genvou,$as_codcomapo)
	{
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_insert_contabilizacion_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
	...
	$as_codestpro4,$as_codestpro5,$as_estcla)
	{
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_insert_contabilizacion_spi ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
	...
	$ai_genrecdoc,$ai_tipdocnom,$ai_gennotdeb,$ai_genvou)
	{
		...
		$lb_valido=true;
		$this->io_sql=new class_sql($this->io_conexion);
		$ls_tipnom="N"; // tipo de contabilizaci�n
		$ls_group="";
		$ls_order="";
		if($_SESSION["la_nomina"]["nomliq"]=='1')
		{
			$ls_tipnom="L"; // tipo de contabilizaci�n
			$ls_group=", sno_salida.codper ";
			$ls_order=", codper";
		}
		...
		$ls_sql="SELECT sno_concepto.codestpro1, sno_concepto.codestpro2, sno_concepto.codestpro3, sno_concepto.codestpro4, sno_concepto.codestpro5, ".
				"		spg_cuentas.spg_cuenta as cueprecon, sum(sno_salida.valsal) AS total, sno_concepto.estcla ".$ls_group.
				...
				"		   sno_concepto.estcla, spg_cuentas.spg_cuenta  ".$ls_group;
		...
		$ls_sql=$ls_sql." UNION ".
				...
				"		spg_cuentas.spg_cuenta as cueprecon, sum(sno_salida.valsal) as total, sno_unidadadmin.estcla".$ls_group.
				...
				"		 sno_unidadadmin.estcla, spg_cuentas.spg_cuenta ".$ls_group;
		...
		$ls_sql=$ls_sql." UNION ".
				...
				" GROUP BY sno_unidadadmin.codestpro1, sno_unidadadmin.codestpro2, sno_unidadadmin.codestpro3, sno_unidadadmin.codestpro4, sno_unidadadmin.codestpro5, ".
				"		sno_unidadadmin.estcla, spg_cuentas.spg_cuenta ".$ls_group.
				" ORDER BY codestpro1, codestpro2, codestpro3, codestpro4, codestpro5, estcla, cueprecon".$ls_order;


		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_contabilizar_conceptos_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
			...
			while((!$rs_data->EOF)&&($lb_valido))
			{
				...
				$lb_valido=$this->uf_disponibilidad_nomina($this->ls_codemp,$ls_cueprecon,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5,$ls_estcla,$li_total);
			...
			//	if($lb_valido){
				...
				if (!$lb_existe)
				{
					...
					$as_tipodestino,$as_descripcion,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,
	...
	function uf_disponibilidad_nomina($codemp,$spg_cuenta,$codestpro1,$codestpro2,$codestpro3,$codestpro4,$codestpro5,$estcla,$monto)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Disponibilidad MeTODO->uf_disponibilidad_nomina ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			while(!$rs_data->EOF)
	...
	$as_cuentapasivo,$ai_genrecdoc,$ai_tipdocnom,$ai_gennotdeb,$ai_genvou)
	{
		...
		if($as_operacionnomina=="OC") // Si el modo de contabilizar la n�mina es Compromete y Causa tomamos la cuenta pasivo de la n�mina.
		{
			if($ai_genrecdoc=="0") // No se genera Recepci�n de Documentos
			{
			...
			else // Se genera Recepci�n de documentos
			{
				...
				{
					$ls_sql=$ls_sql." UNION ".
							"SELECT scg_cuentas.sc_cuenta as cuenta, CAST('H' AS char(1)) as operacion, -sum(sno_salida.valsal) as total, sno_salida.codper ".
							...
							" GROUP BY scg_cuentas.sc_cuenta, sno_salida.codper ";
				}
			}
			if(($ls_espnom==1)&&($ls_ctnom==1))
			{
				...
				{
					/*$ls_sql=$ls_sql." UNION ".
					 " SELECT rpc_proveedor.sc_cuenta as cuenta, CAST('H' AS char(1)) as operacion, -sum(sno_salida.valsal) as total ".
				...
				{
					$ls_sql=$ls_sql." UNION ".
								" SELECT rpc_beneficiario.sc_cuenta as cuenta, CAST('H' AS char(1)) as operacion, -sum(sno_salida.valsal) as total ".
		...
		else
		{
			...
			$ls_sql=$ls_sql." UNION ".
					...
					"   AND sno_personalnomina.codban = sno_banco.codban ".
					"   AND scg_cuentas.codemp = sno_banco.codemp ".
					"   AND scg_cuentas.sc_cuenta = sno_banco.codcuecon and sno_banco.codperi in(select max(codperi) from sno_banco where sno_banco.codnom = '".$this->ls_codnom."'  ) ".
					" GROUP BY scg_cuentas.sc_cuenta ";
...
//echo "<br>".$ls_sql;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_contabilizar_conceptos_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	$as_cuentapasivo,$ai_genrecapo,$ai_tipdocapo,$ai_gennotdeb,$ai_genvou)
	{
		...
		//	    Arguments: as_codcom  //  C�digo de Comprobante
		//	    		   as_operacionaporte  //  Operaci�n de la contabilizaci�n
		//	    		   as_codpro  //  codigo del proveedor
		//	    		   as_codben  //  codigo del beneficiario
		//	    		   as_tipodestino  //  Tipo de destino de contabiliaci�n
		//	    		   as_descripcion  //  descripci�n del comprobante
		//	    		   ai_genrecapo  //  Generar recepci�n de documento
		...
		$lb_valido=true;
		$this->io_sql=new class_sql($this->io_conexion);
		$ls_tipnom="A"; // tipo de contabilizaci�n
		// Buscamos todas aquellas cuentas presupuestarias de los conceptos que se integran directamente con presupuesto
		$ls_sql="SELECT sno_concepto.codestpro1, sno_concepto.codestpro2, sno_concepto.codestpro3, sno_concepto.codestpro4, sno_concepto.codestpro5, ".
				"		spg_cuentas.spg_cuenta as cueprepatcon, sum(sno_salida.valsal) as total, sno_concepto.estcla, ".
				...
				"		   sno_concepto.estcla, spg_cuentas.spg_cuenta, sno_concepto.codprov, sno_concepto.cedben ";
		// Buscamos todas aquellas cuentas presupuestarias de los conceptos que no se integran directamente con presupuesto
		// entonces las buscamos seg�n la estructura de la unidad administrativa a la que pertenece el personal
		$ls_sql=$ls_sql." UNION ".
				"SELECT sno_unidadadmin.codestpro1, sno_unidadadmin.codestpro2, sno_unidadadmin.codestpro3, sno_unidadadmin.codestpro4, sno_unidadadmin.codestpro5, ".
				"		spg_cuentas.spg_cuenta as cueprepatcon, sum(sno_salida.valsal) as total, sno_unidadadmin.estcla, ".
				"		sno_concepto.codprov, sno_concepto.cedben, sno_concepto.codconc ".
				"  FROM sno_personalnomina, sno_unidadadmin, sno_salida, sno_concepto, spg_cuentas ".
				" WHERE sno_salida.codemp='".$this->ls_codemp."' ".
				"   AND sno_salida.codnom='".$this->ls_codnom."' ".
				...
				"		 sno_unidadadmin.estcla,spg_cuentas.spg_cuenta, sno_concepto.codprov, sno_concepto.cedben ".
				" ORDER BY codconc, codestpro1, codestpro2, codestpro3, codestpro4, codestpro5, estcla, cueprepatcon, codprov, cedben ";
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_contabilizar_aportes_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
			while((!$rs_data->EOF)&&($lb_valido))
			{
				...
				if (!$lb_existe)
				{
					...
					$ls_codestpro4,$ls_codestpro5,$ls_estcla,$ls_cueprepatcon,$li_total,
					$ls_tipnom,$ls_codconc,$ai_genrecapo,
	...
	$ai_gennotdeb,$ai_genvou,$as_operacionaporte)
	{
		...
		//	    		   ai_gennotdeb  //  generar nota de d�bito
		//	    		   ai_genvou  //  generar n�mero de voucher
		//	    		   as_operacionaporte  //  Operaci�n con que se va a contabilizar los aportes
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que se encarga de procesar la data para la contabilizaci�n de los conceptos
		//     Creado por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 31/05/2006
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_contabilizar_aportes_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_contabilizar_ingresos_spi($as_codcom,$as_descripcion)
	{
		...
		$this->io_sql=new class_sql($this->io_conexion);
		$ls_tipnom="I"; // tipo de contabilizaci�n
		if ($ls_estpreing==0)
		{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_contabilizar_ingresos_spi ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_contabilizar_ingresos_scg($as_codcom,$as_descripcion)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_contabilizar_ingresos_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_verificar_contabilizacion($as_codcom)
	{
		...
		else
		{
			...
			if($li_debe!=$li_haber)
			{
				...
				$this->io_mensajes->message("Los Monto en la Contabilizaci�n de ".$ls_texto." no cuadran. Debe=".$this->io_fun_nomina->uf_formatonumerico($li_debe)." Haber ".$this->io_fun_nomina->uf_formatonumerico($li_haber).". Verifique la informaci�n ");
			}
		}
		return  $lb_valido;
	...
	function uf_procesar_contabilizacion_proyectos()
	{
		...
		//	    Arguments:
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que se encarga de procesar la data para la contabilizaci�n del per�odo por proyectos
		//     Creado por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 11/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_anocurnom=$_SESSION["la_nomina"]["anocurnom"];
		$ls_codnom=$this->ls_codnom;
		...
		$ls_codcomapo=$ls_anocurnom."-".$ls_codnom."-".$ls_codperi."-A"; // Comprobante de Aportes
		$ls_descripcion=$ls_desnom."- Per�odo ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper; // Descripci�n de Conceptos
		$ls_descripcion_int=$ls_desnom."- Per�odo ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper." Asiento intercompa�ia"; // Descripci�n de Conceptos
		$ls_descripcionapo=$ls_desnom." APORTES - Per�odo ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper; // Descripci�n de Aportes
		$ls_descripcionapo_int=$ls_desnom." APORTES - Per�odo ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper." Asiento intercompa�ia"; // Descripci�n de Aportes
		$ls_cuentapasivo="";
		$ls_operacionnomina="";
		$ls_operacionaporte="";
		$ls_tipodestino="";
		...
		{ // insertamos la contabilizaci�n de contabilidad de conceptos
			if($ls_operacionnomina!="O")// Si es compromete no genero detalles contables
			{
				...
				if(($lb_valido)&&($ls_estempcon==0)&&($ls_basdatcon!=""))
				{
					//------------cuentas contables intercompa�ias------------------------------------------------------------
		...
		if($lb_valido)
		{ // insertamos la contabilizaci�n de presupuesto de los aportes
		...
		if($lb_valido)
		{ // insertamos la contabilizaci�n de contabilidad de los aportes
			if($ls_operacionaporte!="O")// Si es compromete no genero detalles contables
			{
				...
				if(($lb_valido)&&($ls_estempcon==0)&&($ls_basdatcon!=""))
				{
					//------------------------------cuentas contables de intercompa�ias---------------------------------------
	...
	function uf_load_conceptos_spg_normales()
	{
		...
		//	    Arguments:
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que se encarga de procesar la data para la contabilizaci�n de los conceptos que son normales
		//     Creado por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 11/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		// Buscamos todas aquellas cuentas presupuestarias de los conceptos A y D, que se integran directamente con presupuesto
		$ls_sql="SELECT sno_concepto.codestpro1, sno_concepto.codestpro2, sno_concepto.codestpro3, sno_concepto.codestpro4, sno_concepto.codestpro5, ".
				"		spg_cuentas.spg_cuenta as cueprecon, sum(sno_salida.valsal) AS total,sno_concepto.estcla  ".
				"  FROM sno_personalnomina, sno_salida, sno_concepto, spg_cuentas ".
				" WHERE sno_salida.codemp='".$this->ls_codemp."' ".
				"   AND sno_salida.codnom='".$this->ls_codnom."' ".
				"   AND sno_salida.codperi='".$this->ls_peractnom."' ".
		...
		$ls_sql=$ls_sql." UNION ".
				"SELECT sno_unidadadmin.codestpro1, sno_unidadadmin.codestpro2, sno_unidadadmin.codestpro3, sno_unidadadmin.codestpro4, sno_unidadadmin.codestpro5,".
				"		spg_cuentas.spg_cuenta as cueprecon, sum(sno_salida.valsal) as total,sno_unidadadmin.estcla ".
				"  FROM sno_personalnomina, sno_unidadadmin, sno_salida, sno_concepto, spg_cuentas ".
				" WHERE sno_salida.codemp='".$this->ls_codemp."' ".
				"   AND sno_salida.codnom='".$this->ls_codnom."' ".
				"   AND sno_salida.codperi='".$this->ls_peractnom."' ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_load_conceptos_spg_normales ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_conceptos_spg_proyecto()
	{
		...
		$ls_sql="SELECT sno_proyectopersonal.codper, sno_proyectopersonal.codproy, MAX(sno_proyecto.codestpro1) AS codestpro1, MAX(sno_proyecto.codestpro2) AS codestpro2, ".
				"		MAX(sno_proyecto.codestpro3) AS codestpro3, MAX(sno_proyecto.codestpro4) AS codestpro4, MAX(sno_proyecto.codestpro5) AS codestpro5, ".
				"		MAX(sno_proyecto.estcla) AS estcla, spg_cuentas.spg_cuenta,".
		...
		// Buscamos todas aquellas cuentas presupuestarias de los conceptos D , que se integran directamente con presupuesto
		$ls_sql=$ls_sql." UNION ".
				"SELECT sno_proyectopersonal.codper, sno_proyectopersonal.codproy, MAX(sno_proyecto.codestpro1) AS codestpro1, MAX(sno_proyecto.codestpro2) AS codestpro2, ".
				"		MAX(sno_proyecto.codestpro3) AS codestpro3, MAX(sno_proyecto.codestpro4) AS codestpro4, MAX(sno_proyecto.codestpro5) AS codestpro5, ".
				"		MAX(sno_proyecto.estcla) AS estcla, spg_cuentas.spg_cuenta, ".
				"		".$ls_cadena." as montoparcial, sum(sno_salida.valsal) AS total, MAX(spg_cuentas.denominacion) AS denominacion, MAX(sno_proyectopersonal.pordiames) AS pordiames ".
				"  FROM sno_proyectopersonal, sno_proyecto, sno_salida, sno_concepto, spg_cuentas ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_load_conceptos_spg_proyecto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	$ai_genrecdoc,$ai_tipdocnom,$ai_gennotdeb,$ai_genvou)
	{
		...
		//	    		   ai_genvou  //  generar n�mero de voucher
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que se lee el datastored y lo manda a insertar
		//     Creado por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 11/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
		{
			...
			$li_total=round($this->DS->data["total"][$li_i],3);
			$ls_codconc="0000000001";
			$ls_codcomapo=substr($ls_codconc,2,8).$this->ls_peractnom.$this->ls_codnom;
			if($li_total>0)
			{
	...
	function uf_load_conceptos_scg_normales($as_operacionnomina,$as_cuentapasivo,$ai_genrecdoc)
	{
		...
		//	    Arguments: as_operacionnomina // Operaci�n de contabilizaci�n 
		//				   as_cuentapasivo // Cuenta de Pasivo hacia donde se contabiliza la n�mina
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que se encarga de procesar la data para la contabilizaci�n de los conceptos normales
		//     Creado por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 11/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_load_conceptos_scg_normales ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_conceptos_scg_proyecto()
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_load_conceptos_scg_proyecto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_aportes_spg_normales()
	{
		...
		//	    Arguments:
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que se encarga de procesar la data para la contabilizaci�n de los conceptos de aportes normales
		//     Creado por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 13/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		$ls_sql="SELECT sno_concepto.codestpro1, sno_concepto.codestpro2, sno_concepto.codestpro3, sno_concepto.codestpro4, sno_concepto.codestpro5, ".
				...
				"		SUM(sno_salida.valsal) as total, sno_concepto.codprov, sno_concepto.cedben, sno_concepto.codconc  ".
				"  FROM sno_personalnomina, sno_salida, sno_concepto, spg_cuentas ".
				" WHERE sno_salida.codemp='".$this->ls_codemp."' ".
				"   AND sno_salida.codnom='".$this->ls_codnom."' ".
				"   AND sno_salida.codperi='".$this->ls_peractnom."' ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_load_aportes_spg_normales ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_aportes_spg_proyecto()
	{
		...
		// Buscamos todas aquellas cuentas presupuestarias de los conceptos que se integran directamente con presupuesto
		$ls_sql="SELECT MAX(sno_proyecto.codestpro1) AS codestpro1, MAX(sno_proyecto.codestpro2) AS codestpro2, ".
				"		MAX(sno_proyecto.codestpro3) AS codestpro3, MAX(sno_proyecto.codestpro4) AS codestpro4, MAX(sno_proyecto.codestpro5) AS codestpro5, ".
				"		sno_proyecto.estcla, spg_cuentas.spg_cuenta, ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_load_aportes_spg_proyecto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	$as_cuentapasivo,$ai_genrecapo,$ai_tipdocapo,$ai_gennotdeb,$ai_genvou)
	{
		...
		for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
		{
			...
			$li_total=abs(round($this->DS->data["total"][$li_i],3));
			...
			if (!$lb_existe)
			{
				...
				$ls_tipodestino,$as_descripcion,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,
				$ls_codestpro4,$ls_codestpro5,$ls_estcla,$ls_cueprepatcon,$li_total,
				$ls_tipnom,$ls_codconc,$ai_genrecapo,$ai_tipdocapo,$ai_gennotdeb,$ai_genvou,
				$ls_codcomapo);
			}
			else
			{
	...
	function uf_load_aportes_scg_normales($as_operacionaporte)
	{
		...
		//	    Arguments: as_operacionaporte  //  Operaci�n con que se va a contabilizar los aportes
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_load_aportes_scg_normales ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_aportes_scg_proyecto()
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_load_aportes_scg_proyecto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_procesar_rec_doc_pago_personal_cheque()
	{
		...
		//	    Arguments:
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que se encarga de procesar la informacion para la recepcion de documento del 
		//                 personal que cobra con cheque
		//     Creado por: Ing. Mar�a Beatriz Unda
		// Fecha Creaci�n: 22/12/2009
		///////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$lb_valido=$this->uf_delete_sno_rd();
		$lb_valido=$this->uf_delete_sno_td();
		if ($lb_valido)
		{
			...
			if ($lb_valido)
			{
				...
				$nomina=$ls_anocurnom."-".$this->ls_codnom."-%-N";
				...
				$ls_sql=" SELECT distinct  sno_resumen.codper, ".
"   sno_resumen.monnetres,  ". 
"   sno_personalnomina.cueaboper , ". 
"   sno_asignacioncargo.codestpro1||sno_asignacioncargo.codestpro2||sno_asignacioncargo.codestpro3||sno_asignacioncargo.codestpro4||sno_asignacioncargo.codestpro5 as codestpro, ". 
"   sno_asignacioncargo.codestpro1, ". 
"   sno_asignacioncargo.codestpro2, ". 
"   sno_asignacioncargo.codestpro3, ". 
"   sno_asignacioncargo.codestpro4, ". 
"   sno_asignacioncargo.codestpro5 , ". 
"   '--' AS codfuefin, ". 
"   CASE SNO_CONCEPTO.CUEPRECON WHEN '' THEN sno_CONCEPTO.CUEPREPATCON ELSE SNO_CONCEPTO.CUEPRECON END  as  spg_cuenta ,".
" (select sc_cuenta from scg_casa_presu where (SNO_CONCEPTO.CUEPRECON=scg_casa_presu.sig_cuenta) or ".
" (SNO_CONCEPTO.CUEPREPATCON=scg_casa_presu.sig_cuenta)) as cuentacontra ". 
"   FROM ". 
"   sno_resumen, ".  
"   sno_personalnomina , ". 
"   sno_SALIDA, SNO_CONCEPTO,SNO_ASIGNACIONCARGO ". 
"   WHERE  ". 
"   sno_personalnomina.codemp=sno_resumen.codemp ".  
"   AND sno_personalnomina.codnom=sno_resumen.codnom ".  
"   AND sno_personalnomina.codper=sno_resumen.codper ". 
"   and sno_personalnomina.codemp=sno_SALIDA.codemp ". 
"   and sno_personalnomina.codnom=sno_SALIDA.codnom ". 
...
"   AND SNO_CONCEPTO.codemp=sno_personalnomina.codemp ". 
"   AND SNO_CONCEPTO.codnom=sno_personalnomina.codnom ". 
"   AND SNO_CONCEPTO.codCONC=sno_SALIDA.codCONC ". 
"   AND SNO_CONCEPTO.codemp=sno_resumen.codemp ". 
"   AND SNO_CONCEPTO.codnom=sno_resumen.codnom ". 

"   AND SNO_CONCEPTO.CODCONC IN( ". 
"   SELECT DISTINCT CODCONC FROM SNO_DT_SPG WHERE codcom like '".$nomina."' ". 
"   ) ". 
...
"   and sno_personalnomina.pagbanper=0 ". 
"   and sno_resumen.codemp='".$this->ls_codemp."'  ". 
"   AND sno_resumen.codnom='".$this->ls_codnom."'  ". 
"   AND sno_resumen.codperi='".$this->ls_peractnom."'  ". 
"   AND sno_personalnomina.pagefeper=1 ".  
"   AND sno_personalnomina.pagbanper=0 ". 
"   AND sno_resumen.monnetres > 0 ";
				...
				if($rs_data===false)
				{
					$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_procesar_rec_doc_pago_personal_cheque ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
					$lb_valido=false;
				}
				else
				{
					while ((!$rs_data->EOF)&&($lb_valido))
					{
						...
						$codestrpro=$rs_data->fields["codestpro"];
						$codestpro1=$rs_data->fields["codestpro1"];
						$codestpro2=$rs_data->fields["codestpro2"];
						$codestpro3=$rs_data->fields["codestpro3"];
						$codestpro4=$rs_data->fields["codestpro4"];
						$codestpro5=$rs_data->fields["codestpro5"];
						$codfuefin=$rs_data->fields["codfuefin"];
						$spg_cuenta=$rs_data->fields["spg_cuenta"];
							
						$lb_exist_cta_spg=$this->uf_chequear_ctaspg($spg_cuenta);
						$ls_ctahaber2=$rs_data->fields["cuentacontra"];
						$lb_valido=$this->uf_chequear_beneficiario($ls_codper,$ls_ctahaber);
						if (($lb_valido)&&($ls_ctahaber==""))
						{
							$this->io_mensajes->message("El personal ".$ls_codper." no tiene asocida cuenta contable como beneficiario. No se puede realizar la recepci�n de Documento al personal");
							$lb_valido=false;
						}
						elseif ($lb_valido)
						{
							...
							if ($lb_exist_cta)
							{
								$lb_valido=$this->uf_insert_sno_rd($ls_codper,$ld_monpagper,$ls_ctadebe,'H',$codestpro1,$codestpro2,$codestpro3,$codestpro4,$codestpro5,$codestpro,$spg_cuenta);
							}
							else
							{
							...
							if ($lb_valido)
							{
								...
								if($lb_exist_cta)
								{
									$lb_valido=$this->uf_insert_sno_rd($ls_codper,$ld_monpagper,$ls_ctahaber2,'D',$codestpro1,$codestpro2,$codestpro3,$codestpro4,$codestpro5,$codestpro,$spg_cuenta);
								}
								else
								{
									$this->io_mensajes->message("Por favor chequee que el personal ".$ls_codper." tenga una cuenta correcta de beneficiario asociada al plan de cuentas");
								...
								if($lb_exist_cta_spg)
								{
									$lb_valido=$this->uf_insert_sno_td($ls_codper,$ld_monpagper,$codestrpro,$codfuefin,$spg_cuenta);
								}
								else
								{
									$this->io_mensajes->message("Por favor chequee que el personal ".$ls_codper." tenga una cuenta correcta de beneficiario asociada al plan de cuentas");
	...
	function uf_delete_sno_rd()
	{
		...
		//	    Arguments: $
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que elimina la data de recpeciones de documento de un periodo
		//     Creado por: Ing. Mar�a Beatriz Unda
		// Fecha Creaci�n: 22/12/2009
		///////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_delete_sno_rd ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
	...
	function uf_chequear_beneficiario($as_codper,&$as_ctahaber)
	{
		...
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que se encarga de verificar si el personal existe como benficiario y buscar
		//                 su cuenta contable
		//     Creado por: Ing. Mar�a Beatriz Unda
		// Fecha Creaci�n: 22/12/2009
		///////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_chequear_beneficiario ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
			...
			{
				$this->io_mensajes->message("El personal ".$as_codper." no se encuentra registrado como beneficiario. No se puede realizar la recepci�n de Documento al personal");
				$lb_valido=false;
			}
		}
		return $lb_valido;
	...
	function uf_chequear_ctascg($as_ctascg)
	{
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_chequear_ctascg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($row=$this->io_sql->fetch_row($rs_data))
	...
	function uf_chequear_ctaspg($as_ctascg)
	{
		//////////////////////////////////////////////////////////////////////
		// Function :  uf_chequear_ctascg
		//
	...
	//------------------------------------------------------------------------------------------------------------------------------------
	function uf_insert_sno_rd($as_codper,$ad_monpagper,$as_sc_cuenta,$as_debhab,$codestpro1,$codestpro2,$codestpro3,$codestpro4,$codestpro5,$codestpro,$spg_cuenta)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_insert_sno_rd
		//	    Arguments: $as_codper // c�digo del personal
		//                 $ad_monpagper // monto de la recepci�n de documento
		//                 $as_sc_cuenta // cuenta contable para la recepci�n de documentos
		...
		$nomina=$ldt_anocurnom."-".$this->ls_codnom."-".$this->ls_peractnom."-N";
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_insert_sno_rd ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}else{
			if($as_debhab=='D'||$as_debhab=='H'){
				$ls_sql=" update sno_dt_scg set monto=monto-".$ad_monpagper." where codemp='".$this->ls_codemp."' and codnom='".$this->ls_codnom."' and  codperi='".$this->ls_peractnom."' and codcom='".$nomina."' and sc_Cuenta='".$as_sc_cuenta."'";
				//echo "<br>".$ls_sql;
				$li_row=$this->io_sql->execute($ls_sql);
				if($li_row===false)
				{
			...
			if($as_debhab=='D'){
				$ls_sql=" update sno_dt_spg set monto=monto-".$ad_monpagper." where codemp='".$this->ls_codemp."' and codnom='".$this->ls_codnom."' and  codperi='".$this->ls_peractnom."' and codcom='".$nomina."' and codestpro1='".$codestpro1."'  and codestpro2='".$codestpro2."'  and codestpro3='".$codestpro3."'  and codestpro4='".$codestpro4."'  and codestpro5='".$codestpro5."' and spg_cuenta='".$spg_cuenta."'";
				//echo "<br>".$ls_sql;
				$li_row=$this->io_sql->execute($ls_sql);
				if($li_row===false)
				{
	...
	function uf_insert_sno_td($as_codper,$ad_monpagper,$codestrpro,$codfuefin,$as_sc_cuenta)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_insert_sno_rd
		//	    Arguments: $as_codper // c�digo del personal
		...
		$ldt_anocurnom=$_SESSION["la_nomina"]["anocurnom"];
		$nomina=$ldt_anocurnom."-".$this->ls_codnom."-".$this->ls_peractnom."-N";
		$ls_sql=" INSERT INTO sno_td (codemp ,  codnom,  codperi ,  codper ,  spg_cuenta,  codestpro ,  codtipdoc ,  codfuefin ,  monpagper ,  estcon ) ".
		        " VALUES ('".$this->ls_codemp."', '".$this->ls_codnom."', '".$this->ls_peractnom."', '".$as_codper."' , ".
				"         '".$as_sc_cuenta."', '".$codestrpro."', '".$ls_codtipdoc."','".$codfuefin."','".$ad_monpagper."','0') ";
		$li_row=$this->io_sql->execute($ls_sql);
		if($li_row===false)
		{
			$lb_valido=false;
		...
		/*if($as_debhab=='D'){
		$ls_sql=" update sno_dt_scg set monto=monto-".$ad_monpagper." where codemp='".$this->ls_codemp."' and codnom='".$this->ls_codnom."' and  codperi='".$this->ls_peractnom."' and codcom='".$nomina."'";
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_select_contabilizacion_spg($as_codcom,$as_tipnom,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,
	$as_codestpro5,$as_estcla,$as_cueprecon,$as_operacionnomina,$as_codconc)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//	   Creado Por: Ing. Mar�a Beatriz Unda
		// Fecha Creaci�n: 07/02/2009 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$li_estatus=0; // No contabilizado
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_select_contabilizacion_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		else
		{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_update_contabilizacion_spg($as_codcom,$as_tipnom,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,
	$as_codestpro5,$as_estcla,$as_cueprecon,$as_operacionnomina,$as_codconc,$ai_monto)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_update_contabilizacion_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
	...
	function uf_select_contabilizacion_scg($as_tipnom,$as_cuenta,$as_operacion,$as_codcom,$as_codconc)
	{
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_select_contabilizacion_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		else
		{
			if ($rs_data->RecordCount()==0)
	...
	function uf_update_contabilizacion_scg($as_tipnom,$as_cuenta,$as_operacion,$as_codcom,$as_codconc,$ai_monto)
	{
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_update_contabilizacion_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
	...
	function uf_select_contabilizacion_spi($as_codcom,$as_tipnom,$as_cuenta,$as_operacionnomina,$as_codconc,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,$as_estcla)
	{
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_select_contabilizacion_spi ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		else
		{
			if ($rs_data->RecordCount()==0)
	...
	function uf_update_contabilizacion_spi($as_codcom,$as_tipnom,$as_cuenta,$as_operacionnomina,$as_codconc,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,$as_estcla,$ai_monto)
	{
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_update_contabilizacion_spi ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_procesar_contabilizacion_liquidacion()
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_procesar_contabilizacion_liquidacion
		//	    Arguments: as_codperi_actual  //  codigo del periodo a cerrar
		...
		return  $lb_valido;
	}// end function uf_procesar_contabilizacion_liquidacion
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	$ai_gennotdeb,$ai_genvou,$as_codcomapo, $as_codest1_G, $as_estcla_G)
	{
		...
		// Fecha Creaci�n: 14/08/2008								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$li_estatus=0; // No contabilizado
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_insert_contabilizacion_scg_int ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
	...
	function uf_concepto_reintegro_int()
	{
		...
		$ls_sql=" SELECT scg_cuentas.sc_cuenta AS cuenta,'H' AS operacion, sum(sno_salida.valsal) AS total,
				   ...
				   WHERE sno_salida.codemp='".$this->ls_codemp."'                           
					...
					AND sno_concepto.codestpro1 = spg_ep1.codestpro1
		...
		$ls_sql=$ls_sql."	UNION ".
				    " SELECT scg_cuentas.sc_cuenta AS cuenta, 'H' AS operacion, sum(sno_salida.valsal) AS total,
					  ...
					  WHERE sno_salida.codemp='".$this->ls_codemp."'                           
					    ...
					    AND spg_cuentas.status = 'C'            
					    AND spg_ep1.estint = 1                  
					    AND sno_unidadadmin.codestpro1  = spg_ep1.codestpro1 
					    AND sno_unidadadmin.estcla = spg_ep1.estcla				          
					    AND sno_personalnomina.codemp = sno_salida.codemp                    
					    AND sno_personalnomina.codnom = sno_salida.codnom                    
					    AND sno_personalnomina.codper = sno_salida.codper                    
					    AND sno_salida.codemp = sno_concepto.codemp                          
		...
		if($rs_datos===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_concepto_reintegro_int ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			return $rs_datos="";
		}
		else
		{
	...
	$ai_genvou)
	{
		...
		$this->io_sql=new class_sql($this->io_conexion);
		$ls_tipnom="N";
		// se buscan todas las cuentas contables de intercampa�ias realcioandas con el presupuesto
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_contabilizar_conceptos_scg_int ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	$ai_tipdocapo, $ai_gennotdeb,$ai_genvou,$as_operacionaporte)
	{
		...
		//	               as_codcom  //  C�digo de Comprobante
		//	    		   as_codpro  //  codigo del proveedor
		//	    		   as_codben  //  codigo del beneficiario
		//	    		   as_tipodestino  //  Tipo de destino de contabiliaci�n
		//	    		   as_descripcion  //  descripci�n del comprobante
		...
		$ls_sql="SELECT scg_cuentas.sc_cuenta AS cuenta, 'D' AS operacion, sum(abs(sno_salida.valsal)) AS total,
		        ...
		        SELECT scg_cuentas.sc_cuenta AS cuenta, 'D' AS operacion, sum(abs(sno_salida.valsal)) AS total, 
				  ...
				  WHERE sno_salida.codemp='".$this->ls_codemp."'                           
					...
					AND spg_cuentas.status = 'C'     
					AND spg_ep1.estint = 1           
					AND spg_ep1.codestpro1 = sno_unidadadmin.codestpro1
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_contabilizar_aportes_scg_int ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_conceptos_scg_normales_int($as_operacionnomina,$as_cuentapasivo,$ai_genrecdoc)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_load_conceptos_scg_normales_int ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_conceptos_scg_proyecto_int()
	{
		...
		$ls_cadena." AS montoparcial,  sno_proyectopersonal.codper, sno_proyectopersonal.codproy,   ".
					...
					"	AND spg_cuentas.status= 'C'          ".
					"	AND spg_ep1.estint = 1               ".
					"	AND sno_proyecto.codestpro1 = spg_ep1.codestpro1 ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_load_conceptos_scg_proyecto_int ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_aportes_scg_normales_int($as_operacionaporte)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_load_aportes_scg_normales_int ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_aportes_scg_proyecto_int()
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 M�TODO->uf_load_aportes_scg_proyecto_int ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
