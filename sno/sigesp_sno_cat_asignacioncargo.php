	...
	function uf_print($as_codasicar, $as_denasicar, $as_tipo)
   	{
		...
		$ls_sql="SELECT sno_asignacioncargo.codasicar, sno_asignacioncargo.denasicar, sno_asignacioncargo.claasicar, ".
				...
				"		sno_asignacioncargo.codestpro1, sno_asignacioncargo.codestpro2, sno_asignacioncargo.codestpro3, ".
				"		sno_asignacioncargo.codestpro4, sno_asignacioncargo.codestpro5, sno_tabulador.destab, sno_grado.monsalgra, sno_grado.moncomgra, ".
