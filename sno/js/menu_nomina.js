...
stm_aix("p1i4","p1i0",[0," Observaciones Personal   ","","",-1,-1,0,"sigesp_sno_d_observacionespersonal.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ai("p1i1",[6,1,"#e6e6e6","",0,0,0]);
...
stm_ai("p1i1",[6,1,"#e6e6e6","",0,0,0]);
stm_aix("p1i4","p1i0",[0," Hoja de Tiempo ","","",-1,-1,0,"","","","","","",6,0,0,"../shared/imagebank/arrow.gif","../shared/imagebank/arrow.gif",0,0,0,0,1,"#ffffff"]);
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
//stm_aix("p1i4","p1i0",[0," Cargar Hoja de Tiempo ","","",-1,-1,0,"sigesp_sno_d_hojatiempo.php","_self"]);
stm_aix("p1i4","p1i0",[0," Aprobación Hoja de Tiempo ","","",-1,-1,0,"sigesp_sno_p_aprobacionhojatiempo.php","_self"]);
stm_ep();
...
stm_aix("p3i0","p1i0",[0," Listado de Conceptos Detallados ","","",-1,-1,0,"sigesp_sno_r_listadoconcepto_detallado.php","_self"]);
...
stm_aix("p3i0","p1i0",[0," Listado de Hoja de Tiempo ","","",-1,-1,0,"sigesp_sno_r_listadohojatiempo.php","_self"]);
stm_ep();
stm_ai("p1i1",[6,1,"#e6e6e6","",0,0,0]);
