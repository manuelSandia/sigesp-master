...
class sigesp_snorh_c_rango
{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_insert_rango($as_codcom,$as_codran,$as_desran,$as_codcat,$as_nomabr,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql="INSERT INTO sno_rango(codemp,codcom,codran,desran,codcat,nomabr) VALUES ".
				"('".$this->ls_codemp."','".$as_codcom."','".$as_codran."','".$as_desran."','".$as_codcat."','".$as_nomabr."')";
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_update_rango($as_codcom,$as_codran,$as_desran,$as_codcat,$as_nomabr,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_guardar($as_existe,$as_codcom,$as_codran,$as_desran,$as_codcat,$as_nomabr,$aa_seguridad)
	{		
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_guardar
		//		   Access: public (sigesp_snorh_d_rango)
		...
		switch ($as_existe)
		{
			case "FALSE":
				...
				{
					$lb_valido=$this->uf_insert_rango($as_codcom,$as_codran,$as_desran,$as_codcat,$as_nomabr,$aa_seguridad);
				}
				else
				{
			...
			case "TRUE":
				if(($this->uf_select_rango($as_codcom,$as_codran)))
				{
					$lb_valido=$this->uf_update_rango($as_codcom,$as_codran,$as_desran,$as_codcat,$as_nomabr,$aa_seguridad);
				}
				else
				{
