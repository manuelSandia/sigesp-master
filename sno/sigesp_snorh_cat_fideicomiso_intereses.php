<?php
   ...
   function uf_print($as_anocurper, $as_mescurper, $as_tipo)
   {
		...
		print "</tr>";
		$ls_sql="SELECT sno_fideiperiodointereses.anocurper, sno_fideiperiodointereses.mescurper, sno_nomina.codnom, sno_nomina.desnom, MAX(sno_periodo.fidintconper) as fidconper ".
				"  FROM sno_fideiperiodointereses, sno_nomina, sno_periodo ".
				" WHERE sno_fideiperiodointereses.codemp='".$ls_codemp."' ".
				"   AND sno_fideiperiodointereses.anocurper like '".$as_anocurper."' ".
				...
				"   AND sno_fideiperiodointereses.codemp=sno_nomina.codemp ".
				"   AND sno_fideiperiodointereses.codnom=sno_nomina.codnom ".
				"   AND sno_nomina.codemp=sno_periodo.codemp ".
				"   AND sno_nomina.codnom=sno_periodo.codnom ".
				" GROUP BY sno_fideiperiodointereses.anocurper, sno_fideiperiodointereses.mescurper, sno_nomina.codnom, sno_nomina.desnom ".
				" ORDER BY sno_fideiperiodointereses.anocurper, sno_fideiperiodointereses.mescurper, sno_nomina.codnom ";
...
<html>
<head>
<title>Cat&aacute;logo de Prestaci&oacute;n Antiguedad</title>
...
<form name="form1" method="post" action="">
  ...
  <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" height="20" colspan="2" class="titulo-ventana">Cat&aacute;logo de Prestaci&oacute;n Antiguedad </td>
    </tr>
  </table>
<br>
...
function aceptar(anocurper,mescurper,desmes,codnom,fidconper)
{
	...
	opener.document.form1.action="sigesp_snorh_p_fideicomiso_intereses.php";
...
function ue_search(existe)
{
	f=document.form1;
  	...
  	f.action="sigesp_snorh_cat_fideicomiso_intereses.php?tipo=<?php print $ls_tipo;?>";
  	f.submit();
}
</script>
</html>
