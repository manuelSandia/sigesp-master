<?php
   ...
   function uf_print($as_codcom, $as_descom,$as_tipo)
   {
		...
		print "</tr>";
		$ls_sql="SELECT codcom, descom, nomabr ".
				"  FROM sno_componente ".
			...
			while(!$rs_data->EOF)
			{
				...
				switch ($as_tipo)
				{
					case "":
						...
						print "<td><a href=\"javascript: ue_aceptar('$ls_codcom','$ls_descom','$ls_nomabr');\">".$ls_codcom."</a></td>";
...
function ue_aceptar(codcom,descom,nomabr)
{
