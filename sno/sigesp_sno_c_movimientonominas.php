...
class sigesp_sno_c_movimientonominas
{
							   ...
							   $ai_sueper,$as_codded,$as_codtipper,$as_coduniadm, $aa_seguridad)
	{
		...
		if($as_egenom=="1")
		{
			$lb_valido=$this->io_personalnomina->uf_update_estatus($as_codper,"3",$ad_fecegrper,$as_cauegrper,"2",$aa_seguridad);
		}
	...
	function uf_verificarintegridad($as_codsubnom,$as_codcar,$as_codasicar,$as_codtab,$as_codpas,$as_codgra,$as_codnom)
	{
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("No Existe El Grado ".$as_codgra." y Paso ".$as_codpas." de la Tabla ".$as_codtab." en la Nómina ".$as_codnom.".");
		}				
