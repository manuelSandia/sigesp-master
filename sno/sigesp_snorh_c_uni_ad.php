...
class sigesp_snorh_c_uni_ad
{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_insert_unidadadministrativa($as_coduniadm,$as_desuniadm,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,
											$as_estcla,$aa_seguridad)
	{
		...
		//				   as_codestpro1  // Estructura programática 5 Niveles
		//				   as_codestpro2  // Estructura programática 5 Niveles
		//				   as_codestpro3  // Estructura programática 5 Niveles
		//				   as_codestpro4  // Estructura programática 5 Niveles
		//				   as_codestpro5  // Estructura programática 5 Niveles
		//				   as_estcla	  // Estatus
		...
		$ls_sql= "INSERT INTO sno_unidadadmin (codemp,minorguniadm,ofiuniadm,uniuniadm,depuniadm,prouniadm,desuniadm,codestpro1,codestpro2,".
				 "							   codestpro3,codestpro4,codestpro5,estcla)VALUES".
				 "('".$this->ls_codemp."','".$ls_minorguniadm."','".$ls_ofiuniadm."','".$ls_uniuniadm."',".
				 "'".$ls_depuniadm."','".$ls_prouniadm."','".$as_desuniadm."','".$as_codestpro1."','".$as_codestpro2."','".$as_codestpro3."',".
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_update_unidadadministrativa($as_coduniadm,$as_desuniadm,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,
											$as_estcla,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_guardar($as_existe,$as_coduniadm,$as_desuniadm,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,
						$as_estcla,$aa_seguridad)
	{		
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_guardar
		...
		switch ($as_existe)
		{
			case "FALSE":
				...
				{
					$lb_valido=$this->uf_insert_unidadadministrativa($as_coduniadm,$as_desuniadm,$as_codestpro1,$as_codestpro2,$as_codestpro3,
																	 $as_codestpro4,$as_codestpro5,$as_estcla,$aa_seguridad);
				}
				else
				{
			...
			case "TRUE":
				...
				{
					$lb_valido=$this->uf_update_unidadadministrativa($as_coduniadm,$as_desuniadm,$as_codestpro1,$as_codestpro2,$as_codestpro3,
																	 $as_codestpro4,$as_codestpro5,$as_estcla,$aa_seguridad);
				}
				else
				{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_update_unidadadministrativa_historico($as_coduniadm,$as_desuniadm,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,
