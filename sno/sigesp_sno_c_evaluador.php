...
class sigesp_sno_c_evaluador
{
	...
	{	
		...
		//	      Returns: lb_valido True si se crearon las variable sesion � False si no se crearon
		//	  Description: funci�n que dado el c�digo de personal y el c�digo del concetpo crea las variables session necesarias
	...
	{	
		...
		//		   Access: private
		//	    Arguments: as_codper // c�digo de personal
		//	      Returns: lb_valido True si se creo la variable sesion � False si no se creo
		//	  Description: funci�n que dado el c�digo de personal crea una variable session con todos los datos
		//				   de personal nomina
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_crear_personalnomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	{	
		...
		//	    Arguments: as_codper // c�digo de personal
		//	      Returns: lb_valido True si se creo la variable sesion � False si no se creo
		//	  Description: funci�n que dado el c�digo de personal obtiene la suma de todos los 
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_sueldointegral ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
			while ((!$rs_data->EOF)&&($lb_valido))
			{
				...
				{
					if(!(trim($ls_concon)==""))// si tiene condici�n
					{
						$lb_filtro=false;
						$lb_valido=$this->uf_evaluar($as_codper,$ls_concon,$lb_filtro);
						if(($lb_filtro)&&($lb_valido)) // si la condici�n es v�lida
						{
	...
	{	
		...
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 18/09/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ai_totalarc=0;
		$ls_sql="SELECT codemp, codnom, codper, codconc, nomcon, titcon, sigcon, forcon, glocon, acumaxcon, valmincon, valmaxcon, concon, cueprecon, cueconcon, ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_montoarc ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	{	
		...
		// Fecha Creaci�n: 18/11/2008					Fecha �ltima Modificaci�n : 		
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ai_salarionormal=0;
		$ls_sql="SELECT codemp, codnom, codper, codconc, nomcon, titcon, sigcon, forcon, glocon, acumaxcon, valmincon, valmaxcon, concon, cueprecon, cueconcon, ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_salarionormal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	{	
		...
		if($ls_metodovacaciones!="0")
		{
			...
			if($rs_data==false)
			{
				$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_crear_vacacionpersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
				$lb_valido=false;
			}
			else
			{
	...
	{	
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_crear_tablasueldo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_crear_tablasueldo ERROR->Verifique el Tabulador � grados asociados al personal ".$as_codper);
			}
			$this->io_sql->free_result($rs_data);	
		}		
		return $lb_valido;
	...
	{	
	  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//		   Access: public
		//	    Arguments: as_codper // c�digo de personal
		//				   as_formula // f�rmula del concepto
		//				   as_valor // valor que se obtiene de la f�rmula
		//	      Returns: lb_valido True si se evalua correctamente la f�rmula � False si hubo error 
		//	  Description: funci�n que dado una formula de devuelve el valor que arroja
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
	...
	{	
		...
		//		   Access: private
		//	    Arguments: as_codper // c�digo de personal
		//				   as_exp // Expresi�n que me identifica que tipo de valor se va a buscar
		//				   as_formula // f�rmula del concepto
		//	      Returns: lb_valido True si se sustituye correctamente la f�rmula � False si hubo error 
		//	  Description: funci�n que dado una formula sustituye los valores que son de la n�mina
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
	...
	{	
		...
		//	  Description: funci�n que dado un token se sutituye por su valor respectivo de la n�mina
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$as_valor="";
		...
		switch ($as_token) 
		{
			...
			case "NRO_LUNES": // N�mero de lunes que tiene el per�odo
			...
			case "NRO_LUNESMES": // N�mero de lunes que tiene el mes
				$ld_fecdes=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechas=$_SESSION["la_nomina"]["fechasper"];
			...
			case "NRO_DIAS_BV_S": // N�mero de d�as de bono vacacional 
				$as_valor=intval($_SESSION["la_nomina"]["diabonvacnom"]);
				break;

			case "NRO_DIAS_BV_R": // N�mero de d�as de reintegro
			...
			case "DIF_DIA_FIN_PERIODO": // D�a del Fin del per�odo
			...
			case "DHABILES": // D�as H�biles que tuvo el periodo
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "VALOR_CT": // Monto del cesta ticket seg�n la n�mina
			...
			default: // si el token no existe
				$this->io_mensajes->message("ERROR->NOMINA FN[".$as_token."] N� V�lido.");			
				$lb_valido=false;
				break;
		}
		return $lb_valido;
	...
	{			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//				   as_valor // valor del token
		//	      Returns: lb_valido True si se sustituye correctamente el valor � False si hubo error 
		//	  Description: funci�n que dado un token se sutituye por su valor respectivo del personal
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$as_valor="";
		...
		switch ($as_token)
		{
			case "DIAS_LABORADO": // N�mero de d�as laborados por la persona desde que lleg� a la instituci�n
			...
			case "MESES_LABORADO": // N�mero de meses laborados por la persona desde que lleg�
				$ld_fechatope=$this->io_funciones->uf_convertirdatetobd($this->io_sno->uf_select_config("SNO","ANTIGUEDAD","FECHA_TOPE","1900-01-01","C"));
				$ld_fecingper=$this->personal->fecingper;
				$ld_diades=substr($ld_fecingper,8,2);
				$ld_mesdes=substr($ld_fecingper,5,2);
			...
			case "PERMISO_AUSENCIA": // Monto de la Guarderia
				$li_dias_ausencia=0;
				$lb_valido=$this->uf_obtener_dias_permisos($as_codper,&$li_dias_ausencia,7);
				if($lb_valido)
				{
					$as_valor=$li_dias_ausencia;
				}
				break;
							
			case "PERMISO_SINDICAL": // Monto de la Guarderia
				$li_dias_sindical=0;
				$lb_valido=$this->uf_obtener_dias_permisos($as_codper,&$li_dias_sindical,8);
				if($lb_valido)
				{
					$as_valor=$li_dias_sindical;
				}
				break;
			
			case "PERMISO_COMPENSATORIO": // Monto de la Guarderia
				$li_dias_compensatorio=0;
				$lb_valido=$this->uf_obtener_dias_permisos($as_codper,&$li_dias_compensatorio,9);
				if($lb_valido)
				{
					$as_valor=$li_dias_compensatorio;
				}
				break;		
			...
			case "TRASLADOS": //Horas de los Traslados
				$li_horastraslados=0;
				$ls_codnom=$_SESSION["la_nomina"]["codnom"];
				$lb_valido=$this->uf_obtener_horatraslado($as_codper,$ls_codnom,&$li_horastraslados);
				if($lb_valido)
				{
			...
			case "SUELDO_MIN_GRADO": // Sueldo M�nimo seg�n el grado que tenga el obrero
				$as_valor=$this->personal->suemingra;
				break;

			case "DIF_SUELDOMIN": //  Diferencia del sueldo M�nimo con respecto al sueldo base
				$as_valor=0;
				$li_sueldominimo=0;
			...
			case "COMPENSACION_OBRERO": // Monto de la Compensaci�n para las n�minas de obreros con clasificaci�n
			...
			case "NRO_HIJOS": // N�mero de Hijos de la persona
				$as_valor=$this->personal->numhijper;
				break;
				
			case "A_SERVICIO": // A�os de Servicios previos de la persona
			...
			case "V_DIASBONO": // D�as de bono vacacional de la persona
				$as_valor=intval($_SESSION["la_vacacionpersonal"]["diabonvac"]);
				break;

			case "V_DIASBONO_ADIC": // D�as adicionales de bono vacacional de la persona
				$as_valor=intval($_SESSION["la_vacacionpersonal"]["diaadibon"]);
				break;

			case "V_NRO_DIAS": // n�mero de d�as h�biles de vacaciones de la persona
			...
			case "NRO_LUNES_S": // n�mero de d�as lunes de salida de vacaciones de la persona
				$as_valor=$_SESSION["la_vacacionpersonal"]["nrolunes_s"];
				break;

			case "NRO_LUNES_R": // n�mero de d�as lunes de reingreso de vacaciones de la persona
			...
			case "NRO_DIAS_CALEN_S": // n�mero de d�as calendario de salida de vacaciones de la persona
				$ld_fecreivac=$_SESSION["la_vacacionpersonal"]["fecreivac"];
				$ld_fecdisvac=$_SESSION["la_vacacionpersonal"]["fecdisvac"];
			...
			case "NRO_DIAS_CALEN_R": // n�mero de d�as calendario de reingreso de vacaciones de la persona
				$ld_fecreivac=$_SESSION["la_vacacionpersonal"]["fecreivac"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "NRO_DIAS_HABILES": // n�mero de d�as h�biles de vacaciones de la persona
				$as_valor=$_SESSION["la_vacacionpersonal"]["diavac"];
				break;

			case "NRO_DIAS_FERIADOS": // n�mero de d�as feriados de vacaciones de la persona
				$as_valor=$_SESSION["la_vacacionpersonal"]["diafer"];
				break;

			case "NRO_DIAS_SABYDOM": // n�mero de d�as sabados y domingos de vacaciones de la persona
			...
			case "COMPENSACION": // Monto Compensaci�n del grado de la persona
			...
			case substr($as_token,0,12)=="ANTIGUEDAD_A": // Antiguedad en a�os de la persona
			...
			case "ANTIGUEDAD_MESPERIODO_A": // Antiguedad en a�os de la persona pero del mes del perido
				$ld_fecingper=$this->personal->fecingper;
				$ld_fechasper=substr($_SESSION["la_nomina"]["fechasper"],0,4);
				$ld_fecing=substr($ld_fecingper,0,4);
				$as_valor=$ld_fechasper-$ld_fecing;
			...
			case "ANTIG_DC": // Antiguedad en d�as de la persona
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
				$ld_fecingper=$this->personal->fecingper;
				$ld_diades=substr($ld_fecingper,8,2);
				$ld_mesdes=substr($ld_fecingper,5,2);
			...
			case substr($as_token,0,7)=="MENORES": // N�mero de Hijos Menores de la persona
			...
			case substr($as_token,0,16)=="ESTUDIANTE_MENOR": // N�mero de Hijos Menores de la persona
				$ls_codper=$this->personal->codper;
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case substr($as_token,0,3)=="VCA": // Total del Concepto en un per�odo anterior
			...
			case "DHABILES": // D�as H�biles que tuvo el mes sin los feriados, sin los d�as de permiso que tuvo el personal
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
				$li_sabdom=$this->io_sno->uf_nro_sabydom($ld_fecdesper,$ld_fechasper);
			...
			case "DHABILES_CONTRATADOS": // D�as H�biles que laboro el personal contratado en el per�odo actual
			...
			case "DCALENDARIO_CONTRATADOS": // D�as H�biles que laboro el personal contratado en el per�odo actual
				$ld_fecculcontr=$this->personal->fecculcontr;
				$as_valor=0;
				if(substr($ld_fecculcontr,0,10)!="1900-01-01")
				{
			...
			case "CUMP_ORGV": // Si en este per�odo cumple a�o en el organismo
				...
				{
					if($ls_tipo==0) // es una n�mina Semanal
					{
			...
			case "CUMP_ORGV_MES": // Si en el mes cumple a�o en el organismo
				$ls_tipo = $_SESSION["la_nomina"]["tippernom"];
				$li_anoact = intval(substr($_SESSION["la_nomina"]["fechasper"],0,4));
				$li_mesact = intval(substr($_SESSION["la_nomina"]["fechasper"],5,2));
				$li_diaact = intval(substr($_SESSION["la_nomina"]["fechasper"],8,2));
			...
			case "ANT_INST": // antiguedad en la instituci�n
			...
			case "ANT_ADMP": // Antiguedad en la Intitucion desde Personal + A�os de Servicio 
			...
			case "ANT_ADMP_DIAS": // Antiguedad en la Intitucion en d�as 
				$ld_fecingper=$this->personal->fecingadmpubper;
				$ld_diades=substr($ld_fecingper,8,2);
				$ld_mesdes=substr($ld_fecingper,5,2);
				$ld_anodes=substr($ld_fecingper,0,4);
			...
			case "SUELDO_INTEGRAL_VACACION":
				$ls_codper=$this->personal->codper;
				$as_valor=0;
				$li_siv=0;
				$li_anoant=intval(substr($_SESSION["la_nomina"]["fechasper"],0,4));
				$li_mesant=intval(substr($_SESSION["la_nomina"]["fechasper"],6,2));
				$li_mesant=$li_mesant-1;
				if($li_mesant==0)
				{
					$li_mesant=12;
				...
				$lb_valido=$this->uf_obtener_sueldo_integral_vacacion($ls_codper,$li_mesant,$li_anoant,$li_siv);
				...
				break;	
			case "SUELDO_INTEGRAL_SIN_VACACIONES":
				$ls_codper=$this->personal->codper;
				$as_valor=0;
				$li_siv=0;
				$li_anoant=intval(substr($_SESSION["la_nomina"]["fechasper"],0,4));
				...
				$lb_valido=$this->uf_obtener_sueldo_integral_sin_vacacion($ls_codper,$li_mesant,$li_anoant,$li_siv);
			...
			case "SUELDO_INTEGRAL2":
				$ls_codper=$this->personal->codper;
// ES PARA EL SUELDO INTEGRAL QUINCENA ANTERIOR IMPUESTO
				$as_valor=0;
				$li_siv=0;
				$li_anoant=intval(substr($_SESSION["la_nomina"]["fechasper"],0,4));
				$li_mesant=intval(substr($_SESSION["la_nomina"]["fechasper"],6,2));
$ls_perant=(intval($_SESSION["la_nomina"]["peractnom"])-1);
$ls_perant=str_pad($ls_perant,3,"0",0);
				if($ls_perant=='000')
				{
					$ls_ano=$ls_ano-1;
				...
				$lb_valido=$this->uf_obtener_sueldo_integral_vacacion2($ls_codper,$ls_perant,$li_mesant,$li_anoant,$li_siv,$_SESSION["la_nomina"]["peractnom"]);
			...
			case "ANTIG_REINGRESO": // antiguedad em fecha de Reingreso en d�as
				$as_valor=0;
				$ld_fecculcontr=$this->personal->fecculcontr;
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
				if(substr($ld_fecculcontr,0,10)!="1900-01-01")
			...
			case substr($as_token,0,13)=="EDAD_CONYUGUE": // N�mero de Conyugues comprendidos en un rango de edades
				$ls_codper=$this->personal->codper;
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case substr($as_token,0,9)=="EDAD_HIJO": // N�mero de Hijos comprendidos en un rango de edades
				$ls_codper=$this->personal->codper;
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case substr($as_token,0,15)=="EDAD_PROGENITOR": // N�mero de Progenitores comprendidos en un rango de edades
				$ls_codper=$this->personal->codper;
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case substr($as_token,0,12)=="EDAD_HERMANO": // N�mero de Hermanos comprendidos en un rango de edades
				$ls_codper=$this->personal->codper;
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case substr($as_token,0,6)=="CN_ANT": // Verifica si el concepto fue cobrado por el personal los 3 per�odos Anteriores
				$ls_codper=$this->personal->codper;
				$as_valor=false;
			...
			case "DIAS_BONO_TABVAC": // D�as Tabla de vacaciones seg�n el personal
				$as_valor=0;
			...
			case "DIAS_BONO_TABVAC_MES": // D�as Tabla de vacaciones seg�n el personal
				$as_valor=0;
				$ls_codtabvac=$this->personal->codtabvac;
				$li_anoservpreper=$this->personal->anoservpreper;
				$ld_fecingper=$this->personal->fecingper;
			...
			case "SUELDO_BAS_PENSION": // Sueldo B�sico para los pensionados
			...
			case "PRIMA_SERVICIO_PENSION": // Prima a�os de servicio para los pensionados
		   ...
		   case substr(trim ($as_token),0,9)=="DEDUCCION": // Deducciones personales	
			   	$ls_codper=$this->personal->codper; // c�digo del personal
				$ls_codtipded=substr($as_token,10,10);  // c�digo del tipo de deducci�n	
				...
				case substr(trim ($as_token),0,14)=="DEDUC_FAMILIAR": // Deducciones de los familiares
					$ls_codper=$this->personal->codper; // c�digo del personal
					$ls_codtipded=substr($as_token,15,10); // c�digo del tipo de deducci�n						
					$ls_codtipded=str_pad($ls_codtipded,10,"0","LEFT");												
					$ls_sueldo=$this->personal->sueper; // Sueldo del personal
			   ...
			   case substr(trim ($as_token),0,16)=="PATRON_DEDUCCION": // Aporte del Patrono para las deducciones personales
			        $ls_codper=$this->personal->codper; // c�digo del personal
					$ls_codtipded=substr($as_token,17,10); // c�digo del tipo de deducci�n	
					$ls_codtipded=str_pad($ls_codtipded,10,"0","LEFT");															
					$ls_sueldo=$this->personal->sueper; // Sueldo del personal
					// ---------------------------- Para calcular la edad de la persona-----------------------------------
					$ld_fechas=substr($_SESSION["la_nomina"]["fechasper"],0,4);
			...
			case substr(trim($as_token),0,21)=="DEDUC_PATRON_FAMILIAR": //Aporte del Patrono para las deducciones de los familiares
				...
				$ls_codper=$this->personal->codper; // c�digo del personal
				$ls_codtipded=substr($as_token,22,10); // c�digo del tipo de deducci�n
				$ls_codtipded=str_pad($ls_codtipded,10,"0","LEFT");											
				$ls_sueldo=$this->personal->sueper; // Sueldo del personal
				$ld_fecha_hasta=$_SESSION["la_nomina"]["fechasper"]; /// fecha hasta del lapso de la nomina
			...
			case "DEDICACION": // C�digo de la dedicaci�n del personal
				$as_valor=$this->personal->codded;
				break;
            
			case "TIP_PERSONAL": // C�digo del tipo de personal
				$as_valor=$this->personal->codtipper;
				break;
            
			case "CLASIFICACION_DOC": // C�digo de la dedicaci�n del personal
				$as_valor=$this->personal->codcladoc;
				break;
            
			case "ESCALA_DOC": // C�digo del tipo de personal
			...
			case "SALARIO_NORMAL": // Salario Normal de la persona
				...
				break;
			//--------------------------------------------------------------------------------------------------
			case substr(trim($as_token),0,23)=="DIAS_TOTAL_ENCARGADURIA": // N�mero de d�as totales de la Encargadur�a
			     $ls_codenc=substr($as_token,24,10); // c�digo de la encargadur�a	
				 $ls_codenc=str_pad($ls_codenc,10,"0","LEFT");
				 $ls_codnomenc=substr($as_token,35,4); // c�digo de n�mina de la encargadur�a	
				 ...
				 if (!$lb_valido)
				 {
				 	$this->io_mensajes->message("ERROR->ENCARGADURIA ".$ls_codenc."  NO TIENE FECHA DE FINALIZACI�N.");
				 }
				 $as_valor=$ls_dias;
				break;
			//--------------------------------------------------------------------------------------------------
			case substr(trim($as_token),0,21)=="DIF_DIAS_ENCARGADURIA": // Diferencia de D�as entre la fecha final
			                                                             // de la Encargadur�a y la fecha final del periodo 
				 $ls_codenc=substr($as_token,22,10); // c�digo de la encargadur�a	
				 $ls_codenc=str_pad($ls_codenc,10,"0","LEFT");
				 $ls_codnomenc=substr($as_token,34,4); // c�digo de n�mina de la encargadur�a	
				 $ls_codnomenc=str_pad($ls_codnomenc,4,"0","LEFT");					
				 $ld_fechas=$_SESSION["la_nomina"]["fechasper"];											 
			...
			case "FIN_ENCARGADO": // Indica si la persona finaliza el rol de encargado en el periodo actual de la nomina
				...
				break;	
			//--------------------------------------------------------------------------------------------------
			case "FIN_ENCARGADURIA": // Indica si la persona finaliza una encargadur�a en el periodo actual de la nomina
				$ld_fecdes=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechas=$_SESSION["la_nomina"]["fechasper"];
				$ls_codper=$this->personal->codper; // c�digo del personal
				...
				break;	
			//--------------------------------------------------------------------------------------------------
			case "VAC_PROX_PER": // Indica si la persona sale de vacaciones en el proximo periodo de la n�mina
				$ls_codper=$this->personal->codper;				
				$li_numpernom=intval($_SESSION["la_nomina"]["numpernom"]);
				$li_peractnom=intval($_SESSION["la_nomina"]["peractnom"]);
				$ls_peractnom=$_SESSION["la_nomina"]["peractnom"];				
				...
				break;			
			//------------------------------------------------------------------------------------------------------------
				case "DIAS_LABORADO_NOM": // N�mero de d�as laborados por la persona desde que seincluyo en la nomina
				$ld_fechatope=$this->io_funciones->uf_convertirdatetobd($this->io_sno->uf_select_config("SNO","ANTIGUEDAD","FECHA_TOPE","1900-01-01","C"));
				...
				break;
			//--------------------------------------------------------------------------------------------------
			case "MESES_LABORADO_NOM": // N�mero de meses laborados por la persona desde que se incluyo en la nomina
				$ld_fecingnom=$this->personal->fecingnom;
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
				$ld_diahas = substr($ld_fechasper, 8, 2);  
				$ld_meshas = substr($ld_fechasper, 5, 2);  
			...
			case "ANT_NOMINA": // antiguedad en la NOMINA
			    $ld_fecingnom=$this->personal->fecingnom;// fecha de ingreso en la instituci�m
			...
			case substr(trim($as_token),0,10)=="MONTO_CONC": // Monto del Concepto en un periodo			
			     $ls_codconc=substr($as_token,11,10); // c�digo del concepto
				 $ls_codconc=str_pad($ls_codconc,10,"0","LEFT");
				 $ls_codperi=substr($as_token,23,3); // c�digo del periodo
			...
			case substr($as_token,0,14)=="ACU_MONTO_CONC": // Monto Acumulado del Concepto en un numero de periodos
				$ls_codconc=substr($as_token,15,10); // c�digo del concepto
				$ls_codconc=str_pad($ls_codconc,10,"0","LEFT");
			...
			case substr($as_token,0,12)=="CONCEPTO_NOM": // Monto Acumulado del Concepto en un numero de periodos
				$ls_codconc=substr($as_token,13,10); // c�digo del concepto
				//$ls_codconc=str_pad($ls_codconc,10,"0","LEFT");
				$ls_perdes=substr($as_token,24,3);
				//$ls_perdes=str_pad($ls_perdes,3,"0","LEFT");
				$ls_perhas=substr($as_token,28,3);
				//$ls_perhas=str_pad($ls_perhas,3,"0","LEFT");
				$ls_codnom=substr($as_token,32,4);
				//$ls_codnom=str_pad($ls_codnom,4,"0","LEFT");
				...
				$lb_valido=$this->io_concepto->uf_buscar_valor_acumulado_periodo($ls_codper,$ls_codconc,$ls_criterio,$ld_monto,$ls_codnom);
				if($ld_monto===0)//Modificado por Carlos Zambrano
				{
					$lb_valido=true;
				}//Modificado por Carlos Zambrano
			...
			case "SUELDO_DOCENTE": // Monto del sueldo de la Clasificaci�n docente que tiene
				$ls_codper=$this->personal->codper;
				$ai_sueldo=0;
				$as_valor=0;
			...
			// Esta funcion es solo para ser usada por el IPSFA, fue creada por el Lcdo. Edgar Quintero e forma cerrada, es decir, no se puede utilizar
			// para otras instituciones, no es configurable por el sistema, sino solo a traves de codigo fuente.
			...
			case "NETO_PRESTACION_ANTIGUEDAD": // Monto Neto de la prestaci�n antiguedad Acumulada 
				$as_valor=0;
				$li_monto=0;
			...
			case "NETO_INTERESES_PRESTACION": // Monto Neto de los intereses de prestaci�n antiguedad Acumulada 
				$as_valor=0;
				$li_monto=0;
			...
			case "PRESTACION_ANTIGUEDAD": // Monto Acumulado de la prestaci�n antiguedad
				$as_valor=0;
				$li_monto=0;
			...
			case "INTERESES_PRESTACION": // Monto Acumulado de los intereses de prestaci�n antiguedad
				$as_valor=0;
				$li_monto=0;
			...
			case "ANTICIPOS_PRESTACION": // Monto de los Anticipos de la prestaci�n antiguedad
				$as_valor=0;
				$li_monto=0;
			...
			case "FERIADO_NACIONAL": // Numero de D�as Feriados nacionales
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "FERIADO_REGIONAL": // Numero de D�as Feriados regionales
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "PERMISO_RESTUDIO": // Numero de D�as de permiso remunerado por estudio.
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "PERMISO_ESTUDIO": // Numero de D�as de permiso no remunerado por estudio.
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "PERMISO_RMEDICO": // Numero de D�as de permiso remunerado por medico.
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "PERMISO_MEDICO": // Numero de D�as de permiso no remunerado por medico.
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "PERMISO_RTRAMITES": // Numero de D�as de permiso remunerado por tramites.
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "PERMISO_TRAMITES": // Numero de D�as de permiso no remunerado por tramites.
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "PERMISO_ROTROS": // Numero de D�as de permiso remunerado por otros.
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "PERMISO_OTROS": // Numero de D�as de permiso no remunerado por otros.
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "PERMISO_RREPOSO": // Numero de D�as de permiso remunerado por reposo.
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "PERMISO_REPOSO": // Numero de D�as de permiso no remunerado por reposo.
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "PERMISO_RREPOSOLABORAL": // Numero de D�as de permiso remunerado por reposo laboral.
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "PERMISO_REPOSOLABORAL": // Numero de D�as de permiso no remunerado por reposo laboral.
				$ld_fecdesper=$_SESSION["la_nomina"]["fecdesper"];
				$ld_fechasper=$_SESSION["la_nomina"]["fechasper"];
			...
			case "HT_DIASLABORADOS": // Numero de D�as laborados registrados en la hoja de tiempo
				$as_valor=0;
				$li_monto=0;
			...
			case "HT_SUBTERRANEO": // Numero de D�as en subterraneo
				$as_valor=0;
				$li_monto=0;
				$ls_cadena="";
			...
			case "HT_REPOSOCOMIDA": // Numero de D�as de reposo comida
				$as_valor=0;
				$li_monto=0;
				$ls_cadena="";
				switch($_SESSION["ls_gestor"])
			...
			case "HT_ESCALERA": // Numero de D�as de escalera
				$as_valor=0;
				$li_monto=0;
				$ls_cadena="";
				switch($_SESSION["ls_gestor"])
			...
			case substr(trim($as_token),0,8)=="HC_TURNO": // Turno de hoja de tiempo
				$ls_codhor=substr($as_token,10,3); // c�digo del horario
				$ls_codhor=str_pad($ls_codhor,3,"0","LEFT");
            ...
            case "ANTIG_COMP": // Dias Antiguedad Complementaria
				...
				if($li_anoper==$li_anoact)
				{
					...
					{
						$li_meses=(($li_mesact-$li_mesper)+1); 
					}
				}
				else
				{
					if($li_mesper<$li_mesact)
					{
						$li_meses=((12*($li_anoact-$li_anoper))+(($li_mesact-$li_mesper)+1));
					}
					elseif($li_mesper==$li_mesact)
					{
						$li_meses=(12*($li_anoact-$li_anoper));
					}
					elseif($li_mesper>$li_mesact)
					{			 
						$li_meses=((12*($li_anoact-$li_anoper))+($li_mesact-$li_mesper)+1);
				...
				if($li_meses>=12)
				{
				  $lb_valido=$io_fideicomiso->uf_load_dias_adicionales($li_meses,$li_antigcomp);
				}
				if($lb_valido)
				{
					$as_valor=$li_antigcomp;
				}
   			    unset ($io_fideicomiso);
				break;
				
			default:
				$this->io_mensajes->message("ERROR->PERSONAL PS[".$as_token."] N� V�lido.");
				$lb_valido=false;
				break;
	...
	{	
		...
		//	      Returns: lb_valido True si se sustituye correctamente el valor � False si hubo error 
		//	  Description: funci�n que dado un token se sutituye por su valor respectivo de la tabla de sueldo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$ai_valor=0;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("ERROR->TABLA SUELDO TB[".$as_token."] N� V�lido.");
		}
		else
		{
	...
	{	
		...
		//				   ai_valor // valor del token
		//	      Returns: lb_valido True si se sustituye correctamente el valor � False si hubo error 
		//	  Description: funci�n que dado un token se sutituye por su valor respectivo del concepto
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_aplicar=true;
		...
		if(intval($ls_codconc)>intval($as_token))
		{
			...
			if($lb_valido)
			{
				...
				{
					$lb_filtro=false;
					$lb_valido=$this->uf_evaluar($as_codper,$la_concepto["concon"],$lb_filtro);
				}				  
			...
			{
				$this->io_mensajes->message("ERROR->CONCEPTO CN[".$as_token."] N� V�lido. Utilizado en el Concepto ".$ls_codconc);
			}
		}
		else
		{
	...
	{	
		...
		//				   ai_valor // valor del token
		//	      Returns: lb_valido True si se sustituye correctamente el valor � False si hubo error 
		//	  Description: funci�n que dado un token se sutituye por su valor respectivo de la constante
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$ai_valor=0;
		...
		if($lb_valido===false)
		{
			$this->io_mensajes->message("ERROR->CONSTANTE CT[".$as_token."] N� V�lido. Utilizado en el Concepto ".$ls_codconc);
		}
		return $lb_valido;
	...
	{	
		...
		//	  Description: funci�n que dado el c�digo de personal y concepto calcula todas las asignaciones menos las deducciones
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_vtc ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
	...
	{	
		...
		//	      Returns: lb_valido True si se obtuvo el concepto � False si no se obtuvo
		//	  Description: funci�n que dado el c�digo de personal y concepto calcula el valor del concepto en un per�odo previo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_vca ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
	...
	{	
		...
		//				   ai_vca // Toatl del concepto
		//	      Returns: lb_valido True si se obtuvo el concepto � False si no se obtuvo
		//	  Description: funci�n que dado el c�digo de personal y busca el sueldo integral de vacaciones dado un mes y a�o
		//	   Creado Por: Ing. Yesenia Moreno
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_primas_ante ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
	...
	function uf_obtener_sueldo_integral_vacacion($as_codper,$as_mes,$as_anopre,&$ai_siv)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_obtener_primas_ante
		//		   Access: private
		...
		$ai_siv=0;
		$as_mes_ant=$as_mes;
		if($as_mes_ant=='1'||$as_mes_ant=='2'||$as_mes_ant=='3'||$as_mes_ant=='4'||$as_mes_ant=='5'||$as_mes_ant=='6'||$as_mes_ant=='7'||$as_mes_ant=='8'||$as_mes_ant=='9'){
			$as_mes_ant='0'.$as_mes_ant;
		}else{
			
			if($as_mes_ant=='0'){
				$as_mes_ant=12;
				$as_anopre=$as_anopre-1;
			}
		}
		...
		$rs_data=$this->io_sql->select($ls_sql);
			$ls_sql="SELECT sum(valsal) as valsal ".
				"  FROM sno_hsalida, sno_hperiodo , sno_hconcepto".
				" WHERE sno_hsalida.codemp='".$this->ls_codemp."'".
				"   AND sno_hsalida.codnom='".$this->ls_codnom."'".
				"   AND sno_hsalida.anocur='".$as_anopre."'".
				"   AND sno_hsalida.codper='".$as_codper."'".
				...
				"  AND sno_hconcepto.sueintvaccon='1' ".
				"   AND substr(cast(sno_hperiodo.fecdesper as char(10)),6,2)='".$as_mes_ant."'".
				"   AND (sno_hsalida.tipsal='A' OR sno_hsalida.tipsal='D' OR sno_hsalida.tipsal='P1') ".
				"   AND sno_hsalida.codemp = sno_hperiodo.codemp ".
				"   AND sno_hsalida.codnom = sno_hperiodo.codnom ".
				"   AND sno_hsalida.anocur = sno_hperiodo.anocur ".
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_sueldo_integral_vacacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function uf_obtener_sueldo_integral_sin_vacacion($as_codper,$as_mes,$as_anopre,&$ai_siv)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_obtener_primas_ante
		//		   Access: private
		...
		$rs_data=$this->io_sql->select($ls_sql);
			$ls_sql="SELECT sum(valsal) as valsal ".
				...
				"   AND sno_hsalida.codnom = sno_hperiodo.codnom ".
				"   AND sno_hsalida.anocur = sno_hperiodo.anocur ".
				"   AND sno_hsalida.codperi = sno_hperiodo.codperi and sno_hconcepto.codconc !='0000000302'";
...
function uf_obtener_sueldo_integral_vacacion2($as_codper,$ls_perant,$as_mes,$as_anopre,&$ai_siv,$li_numpernom)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_obtener_primas_ante
		//		   Access: private
...
if($as_mes=='1'||$as_mes=='2'||$as_mes=='3'||$as_mes=='4'||$as_mes=='5'||$as_mes=='6'||$as_mes=='7'||$as_mes=='8'||$as_mes=='9'){
			$as_mes='0'.$as_mes;
		}else{
	...
	$as_mes_ant=$as_mes-1;
		...
		$rs_data=$this->io_sql->select($ls_sql);
			$ls_sql="SELECT sum(valsal) as valsal ".
				...
				"  AND sno_hconcepto.sueintvaccon='1' ".
				"   AND ((substr(cast(sno_hperiodo.fecdesper as char(10)),6,2)='".$as_mes."'".
			    " AND sno_hsalida.codperi!='".$li_numpernom."')  or (substr(cast(sno_hperiodo.fecdesper as char(10)),6,2)='".$as_mes_ant."'".
			    " AND sno_hsalida.codperi='".$ls_perant."') )".
				"   AND (sno_hsalida.tipsal='A' OR sno_hsalida.tipsal='D' OR sno_hsalida.tipsal='P1') ".
				"   AND sno_hsalida.codemp = sno_hperiodo.codemp ".
				"   AND sno_hsalida.codnom = sno_hperiodo.codnom ".
				"   AND sno_hsalida.anocur = sno_hperiodo.anocur ".
	...
	{	
		...
		//	      Returns: lb_valido True si se obtuvo el concepto � False si no se obtuvo
		//	  Description: funci�n que dado el c�digo de personal y busca el sueldo Anterior de acuerdo al mes
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 23/11/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ai_sueldo=0;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_sueldo_ante ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
	...
	{	
		...
		//	      Returns: lb_valido True si se obtuvo el concepto � False si no se obtuvo
		//	  Description: funci�n que dado el c�digo de personal y el concepto verifica si dicho concepto fue pagado
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 03/08/2007 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ab_cobrado=false;
		$ls_sql="SELECT sum(valsal) as valsal ".
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_concepto_ante ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
	...
	{	
		...
		//	    Arguments: as_codtabvac  // c�digo de la tabla de vacacion
		//	    		   ai_anoant  // A�o de antiguedad
		//	    		   ai_anopre  // A�os de servicio previos
		//	    		   ai_diabonvac  // D�as de Bono vacacional
		//	      Returns: lb_valido True si existe � False si no existe
		//	  Description: Funcion que verifica si la tabla de vacacion est� registrada
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_dias_tabla_vacacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$lb_valido=false;
		}
		else
		{
	...
	{	
		...
		//		   Access: private
		//	    Arguments: ai_sueldominimo // Sueldo M�nimo
		//	      Returns: lb_valido True si se obtuvo el Sueldo m�nimo � False si no se obtuvo
		//	  Description: funci�n que busca el sueldo m�nimo vigente
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 14/04/2008 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ai_sueldominimo=0;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_sueldominimo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
	...
	{	
		...
		//		   Access: private
		//	    Arguments: as_anio // A�o
		//	   			   ai_unidadtributaria // Valor de la unidad tributaria
		//	      Returns: lb_valido True si se obtuvo la Unidad Tributaria � False si no se obtuvo
		//	  Description: funci�n que busca la unidad tributaria del a�o
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 14/04/2008 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_unidadtributaria ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
	...
	function uf_obtener_montoanterior($as_codper,$as_tipsal,$ai_meses,&$ai_monto)
	{
		...
		//				   ai_monto // Monto
		//	      Returns: lb_valido True si se obtuvo el concepto � False si no se obtuvo
		//	  Description: funci�n que dado el c�digo de personal y obtiene la suma de los concepto del tipo de salida
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 19/06/2008 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ai_monto=0;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_montoanterior ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
	...
	{	
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_montoarc_mesactual ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	{	
		...
		//	      Returns: lb_valido True si se creo la variable sesion � False si no se creo
		//	  Description: funci�n que dado el c�digo de personal obtiene el sueldo de la clasificaci�n docente
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 20/03/2009 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ai_sueldo=0;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_sueldo_docente ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	{	
		...
		//	    		   ai_prima // Prima
		//	      Returns: lb_valido True si se creo la variable sesion � False si no se creo
		//	  Description: funci�n que dado el c�digo de personal obtiene las primas docentes se�n el tipo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 20/03/2009 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_prima_docente ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	{	
		...
		//				   de vacaci�n personal
		//	   Creado Por: Ing. Mar�a Beatriz Unda
		// Fecha Creaci�n: 17/01/2009 								Fecha �ltima Modificaci�n :		
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_metodovacaciones=trim($this->personal->mettabvac);
		switch ($ls_metodovacaciones)
		...
		if($ls_metodovacaciones!="0")
		{
			...
			if($rs_data==false)
			{
				$this->io_mensajes->message("CLASE->Evaluador M�TODO-> uf_crear_proxima_vacacionpersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
				$lb_valido=false;
			}
			else
			{
	...
	{	
		...
		//				   ai_sueldo // Sueldo Anterior
		//	      Returns: lb_valido True si se obtuvo el concepto � False si no se obtuvo
		//	  Description: funci�n que dado el c�digo de personal y busca el sueldo Anterior de acuerdo al periodo
		//	   Creado Por: Ing. Yesenia Moreno
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_sueldo_quincena_ante ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ((!$rs_data->EOF))
	...
	{	
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_montoguarderia ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ((!$rs_data->EOF))
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_obtener_dias_permisos($as_codper,&$ai_cantdias,$as_tipopermiso)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_obtener_sueldo_quincena_ante
		//		   Access: private
		...
		$lb_valido=true;
		$ai_cantdias=0;
		$ls_sql=" SELECT sum(numdiaper) as cantdias ".
				" FROM sno_permiso ".
				" WHERE sno_permiso.codemp='".$this->ls_codemp."' ".
				" AND sno_permiso.codper='".$as_codper."' ".
				" AND sno_permiso.tipper=$as_tipopermiso ";
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data==false)
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_dias_permisos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ((!$rs_data->EOF))
			{
				$ai_cantdias=$rs_data->fields["cantdias"];
			}
			$this->io_sql->free_result($rs_data);	
		}
		return $lb_valido;
	...
	{	
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_horatraslado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ((!$rs_data->EOF))
	...
	{	
		...
		//	      Returns: lb_valido True si se creo la variable sesion � False si no se creo
		//	  Description: funci�n que devuelve la categoria militar que tiene el personal
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/06/2009 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_categoria_militar ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	{	
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_verificar_personal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	{	
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_verificar_beneficiario ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	{	
		...
		//				   ai_monto // Monto
		//	      Returns: lb_valido True si se obtuvo el concepto � False si no se obtuvo
		//	  Description: funci�n que dado el c�digo de personal busca la prestaci�n antiguedad Acumulada
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 02/04/2007 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_prestacionantiguedad ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			while(!$rs_data->EOF)
	...
	{	
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Evaluador M�TODO->uf_obtener_interesesprestacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			while(!$rs_data->EOF)
	...
	{	
		...
		//		   Access: private
		//	    Arguments: codper		  
		//	      Returns: El valor del pago total de d�as adicionales o false si hay un error
		//	  Description: funci�n que devuelve el calculo de los d�as de antiguedad complementaria
		...
		if($rs_data===false)
		{
			echo "CLASE->Evaluador M�TODO->uf_antiguedad_complementaria ERROR->".$this->io_sql->message;
