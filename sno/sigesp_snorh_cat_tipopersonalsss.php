<?php
   ...
   //--------------------------------------------------------------
   function uf_print($as_codtippersss, $as_dentippersss, $as_tipo)
   {
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_print
		//		   Access: public
			...
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					case "":
						...
						print "<td><a href=\"javascript: aceptar('$ls_codtippersss','$ls_dentippersss');\">".$ls_codtippersss."</a></td>";
						print "<td>".$ls_dentippersss."</td>";
						print "</tr>";			
						break;
					
					case "personal": // llamado desde sigesp_snorh_d_personal.php
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarpersonal('$ls_codtippersss','$ls_dentippersss');\">".$ls_codtippersss."</a></td>";
						print "<td>".$ls_dentippersss."</td>";
						print "</tr>";			
						break;
					...
					case "tarjeta": // 
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptartarjeta('$ls_codtippersss','$ls_dentippersss');\">".$ls_codtippersss."</a></td>";
						print "<td>".$ls_dentippersss."</td>";
						print "</tr>";			
						break;
				}
...
<?php
	...
	{
		$ls_codtippersss="%".$_POST["txtcodpro"]."%";
		$ls_dentippersss="%".$_POST["txtdespro"]."%";
		uf_print($ls_codtippersss, $ls_dentippersss, $ls_tipo);
	}
	else
	{
		$ls_codtippersss="%%";
...
{
	opener.document.form1.txtcodtippersss.value=codigo;
	opener.document.form1.txtcodtippersss.readOnly=true;
    opener.document.form1.txtdestippersss.value=descripcion;
...
function aceptarpersonal(codigo,descripcion)
{
	...
	opener.document.form1.txtcodtippersss.readOnly=true;
    opener.document.form1.txtdestippersss.value=descripcion;
	opener.document.form1.txtdestippersss.readOnly=true;
	close();
}

function aceptartarjeta(codigo,descripcion)
{
	opener.document.form1.txtcodtipper.value=codigo;
...
function ue_search(existe)
{
	f=document.form1;
  	...
  	f.action="sigesp_snorh_cat_tipopersonalsss.php?tipo=<?php print $ls_tipo;?>";
  	f.submit();
}
</script>
</html>
