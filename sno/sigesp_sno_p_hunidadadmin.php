...
<?php 
	...
	switch ($ls_operacion) 
	{
		case "GUARDAR":
			uf_load_variables();
			$lb_valido=$io_unidadadm->uf_update_unidadadministrativa_historico($ls_codigo,$ls_denominacion,$ls_codestpro1,$ls_codestpro2,
																			   $ls_codestpro3,$ls_codestpro4,$ls_codestpro5,$ls_estcla,$la_seguridad);
			if($lb_valido)
			{
				uf_limpiarvariables();
				$ls_existe="FALSE";
