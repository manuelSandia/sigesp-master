...
//--------------------------------------------------------------
function uf_print($as_tipo,$ams_codnom,$as_codnomhas)
{
	//////////////////////////////////////////////////////////////////////////////
	//	     Function : uf_print
	//		   Access : public
	...
	for($li_i=0;$li_i<$totoalnomina;$li_i++)
	{
		...
		if($as_codnom==''){
			$as_codnom="'".$als_codnom[$li_i]."'";
		}else{
			$as_codnom=$as_codnom.",'".$als_codnom[$li_i]."'";
		}
	...
	print "</tr>";
	$ls_sql="SELECT DISTINCT sno_hperiodo.anocur, substr(cast(sno_hperiodo.fechasper as char(10)),6,2) as mes, sno_hperiodo.fechasper".
	...
	{
		$ls_sql="SELECT DISTINCT sno_hperiodo.anocur, substr(cast(sno_hperiodo.fechasper as char(10)),6,2) as mes, sno_hperiodo.fechasper, sno_hperiodo.codperi ".
				"  FROM sno_hperiodo, sno_hnomina, sno_periodo ".
				" WHERE  ".
				"   sno_periodo.cerper= 1 ".
				"	AND sno_hperiodo.codemp=sno_hnomina.codemp ".
	...
	if(($as_tipo=="replispreantdesde")||($as_tipo=="replispreanthasta")||($as_tipo=="replispreant"))
	{
		$ls_sql=$ls_sql."	AND (substr(cast(sno_hperiodo.fecdesper as char(10)),6,2) IN (SELECT LPAD(cast(mescurper as char(2)),2,'0') ".
							...
							"   AND sno_hperiodo.codnom in (".$as_codnom.") ";
	}
	 ...
	 
	{
		$ls_sql="SELECT DISTINCT sno_hperiodo.anocur, substr(cast(sno_hperiodo.fechasper as char(10)),6,2) as mes, sno_hperiodo.fechasper  ".
					"  FROM sno_hperiodo, sno_hnomina, sno_periodo  ".
					" WHERE sno_hnomina.codnom in(".$as_codnom.") ".
	...
	{
		$ls_sql="SELECT DISTINCT sno_hperiodo.anocur, substr(cast(sno_hperiodo.fechasper as char(10)),6,2) as mes, sno_hperiodo.codperi, sno_hperiodo.fechasper ".
					"  FROM sno_hperiodo, sno_hnomina, sno_periodo ".
					" WHERE sno_hnomina.espnom='1' ".
					"   AND sno_hnomina.ctnom='1' ".
					"   AND sno_hnomina.codnom in (".$as_codnom.") ".
		...
		while($row=$io_sql->fetch_row($rs_data))
		{
			...
			switch ($as_tipo)
			{
				...
				case "replispreantdesde":
					print "<tr class=celdas-blancas>";
					print "<td><a href=\"javascript: aceptarreplispreantdesde('$ls_anocur','$ls_mes','$ls_desmes','$ls_codperi');\">".$ls_anocur."</a></td>";
					print "<td>".$ls_mes."</td>";
					print "<td>".$ls_desmes."</td>";
					print "</tr>";
					break;
				...
				case "replispreanthasta":
					print "<tr class=celdas-blancas>";
					print "<td><a href=\"javascript: aceptarreplispreanthasta('$ls_anocur','$ls_mes','$ls_desmes','$ls_codperi');\">".$ls_anocur."</a></td>";
					print "<td>".$ls_mes."</td>";
					print "<td>".$ls_desmes."</td>";
					print "</tr>";
					break;
				...
				case "replispreantint":
					print "<tr class=celdas-blancas>";
					print "<td><a href=\"javascript: aceptarreplispreantint('$ls_anocur','$ls_mes','$ls_desmes');\">".$ls_anocur."</a></td>";
					print "<td>".$ls_mes."</td>";
					print "<td>".$ls_desmes."</td>";
					print "</tr>";
					break;
