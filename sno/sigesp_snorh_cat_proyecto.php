<?php
   ...
   function uf_print($as_codproy, $as_nomproy, $as_tipo)
   {
		...
		$ls_sql="SELECT codemp, codproy, nomproy, codestpro1, codestpro2, codestpro3, codestpro4, codestpro5, estcla, ".
				"		(SELECT denestpro1 ".
				"		   FROM spg_ep1 ".
				"		  WHERE spg_ep1.codemp=sno_proyecto.codemp".
				"		    AND spg_ep1.codestpro1=sno_proyecto.codestpro1 ".
				"			AND spg_ep1.estcla=sno_proyecto.estcla) as denestpro1, ".
				"		(SELECT denestpro2 ".
				"		   FROM spg_ep2 ".
				"		  WHERE spg_ep2.codemp=sno_proyecto.codemp".
				"		    AND spg_ep2.codestpro1=sno_proyecto.codestpro1 ".
				"		    AND spg_ep2.codestpro2=sno_proyecto.codestpro2 ".
				"           AND spg_ep2.estcla=sno_proyecto.estcla) as denestpro2, ".
				"		(SELECT denestpro3 ".
				"		   FROM spg_ep3 ".
				"		  WHERE spg_ep3.codemp=sno_proyecto.codemp".
				"		    AND spg_ep3.codestpro1=sno_proyecto.codestpro1 ".
				"		    AND spg_ep3.codestpro2=sno_proyecto.codestpro2 ".
				"		    AND spg_ep3.codestpro3=sno_proyecto.codestpro3 ".
				"           AND spg_ep3.estcla=sno_proyecto.estcla) as denestpro3, ".
				"		(SELECT denestpro4 ".
				"		   FROM spg_ep4 ".
				"		  WHERE spg_ep4.codemp=sno_proyecto.codemp".
				"		    AND spg_ep4.codestpro1=sno_proyecto.codestpro1 ".
				"		    AND spg_ep4.codestpro2=sno_proyecto.codestpro2 ".
				"		    AND spg_ep4.codestpro3=sno_proyecto.codestpro3 ".
				"		    AND spg_ep4.codestpro4=sno_proyecto.codestpro4 ".
				"           AND spg_ep4.estcla=sno_proyecto.estcla) as denestpro4, ".
				"		(SELECT denestpro5 ".
				"		   FROM spg_ep5 ".
				"		  WHERE spg_ep5.codemp=sno_proyecto.codemp".
				"		    AND spg_ep5.codestpro1=sno_proyecto.codestpro1 ".
				"		    AND spg_ep5.codestpro2=sno_proyecto.codestpro2 ".
				"		    AND spg_ep5.codestpro3=sno_proyecto.codestpro3 ".
				"		    AND spg_ep5.codestpro4=sno_proyecto.codestpro4 ".
				"		    AND spg_ep5.codestpro5=sno_proyecto.codestpro5 ".
