	...
	function uf_importar_asignacioncargo($as_codnombus,$as_codper)
	{
		...
		else
		{
			while((!$rs_data->EOF)&&($lb_valido))
			{
				...
				$ls_sql="update sno_asignacioncargo set codemp='".$this->ls_codemp."', codnom='".$this->ls_codnom."', codasicar='".$ls_codasicar."',
				denasicar='".$ls_denasicar."',minorguniadm='".$ls_minorguniadm."',ofiuniadm='".$ls_ofiuniadm."',uniuniadm='".$ls_uniuniadm."',
				depuniadm='".$ls_depuniadm."',prouniadm='".$ls_prouniadm."',claasicar='".$ls_claasicar."',codtab='".$ls_codtab."', 
				codpas= '".$ls_codpas."',codgra='".$ls_codgra."',codded='".$ls_codded."',codtipper='".$ls_codtipper."',numvacasicar=".$li_numvacasicar.",
				numocuasicar=".$li_numocuasicar.", codestpro1='".$ls_codestpro1."',codestpro2='".$ls_codestpro2."',codestpro3='".$ls_codestpro3."',
				codestpro4='".$ls_codestpro4."',codestpro5='".$ls_codestpro5."',estcla='".$ls_estcla."'  WHERE codemp='".$this->ls_codemp."'  AND codnom='".$this->ls_codnom."'  AND codasicar='".$ls_codasicar."'";
