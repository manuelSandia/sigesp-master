<?php
	...
	switch($ls_modalidad)
	{
		...
		case "2": // Modalidad por Presupuesto
			$ls_titulo="Catalogo de Estructura Programática ".$ls_nomestpro3;
			break;
	}
	...
	function uf_print($as_codestprog1, $as_codestprog2, $as_codestprog3, $as_denominacion, $as_tipo,$as_estcla2)
   	{
		...
		else
		{
			while(!$rs_data->EOF)
			{
				...
				$denominacion=$rs_data->fields["denestpro3"];
...
<?php
	...
	{
		$ls_codigo="%".$_POST["txtcodestpro3"]."%";
		$ls_denominacion="%".$_POST["denominacion"]."%";
		$ls_estcla2=$_POST["txtestcla2"];
		uf_print($ls_codestprog1, $ls_codestprog2, $ls_codigo, $ls_denominacion, $ls_tipo,$ls_estcla2);
	}
	else
	{
		$ls_codigo="%%";
...
function aceptar(codestprog3,deno,estcla)
{
...
function aceptardes(codestprog3,deno,estcla)
{
	opener.document.form1.txtdenestpro3.value=deno;
	opener.document.form1.txtcodestpro3.value=codestprog3;
...
function aceptarhas(codestprog3,deno,estcla)
{
	opener.document.form1.txtdenestpro8.value=deno;
	opener.document.form1.txtcodestpro8.value=codestprog3;
	opener.document.form1.txtestcla8.value=estcla;
...
function aceptarasignacion(codestprog3,deno,estcla)
{
	opener.document.form1.txtdenestpro3.value=deno;
	opener.document.form1.txtcodestpro3.value=codestprog3;
	opener.document.form1.txtcodestpro4.value="";
...
function ue_search()
{
	...
	f.action="sigesp_snorh_cat_estpre3.php?tipo=<?php print $ls_tipo;?>";
	f.submit();
}
</script>
</html>