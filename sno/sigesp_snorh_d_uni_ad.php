<?php
	...
	$io_fun_nomina->uf_load_seguridad("SNR","sigesp_snorh_d_uni_ad.php",$ls_permisos,$la_seguridad,$la_permisos);
   ...
   function uf_load_variables()
   {
		...
		$ls_codestpro1=trim($_POST["txtcodestpro1"]);
		$ls_denestpro1=$_POST["txtdenestpro1"];
		$ls_codestpro2=trim($_POST["txtcodestpro2"]);
		$ls_denestpro2=$_POST["txtdenestpro2"];
		$ls_codestpro3=trim($_POST["txtcodestpro3"]);
		$ls_denestpro3=$_POST["txtdenestpro3"];
		$ls_codestpro4=trim($_POST["txtcodestpro4"]);
		$ls_denestpro4=$_POST["txtdenestpro4"];
		$ls_codestpro5=trim($_POST["txtcodestpro5"]);
...
<title>Definici&oacute;n de Unidad Administrativa</title>
...
<?php
	...
	switch ($ls_operacion) 
	{
		case "NUEVO":		
			$ls_statusg=0;
		    $ls_statusi=0;
		    $lb_valido=$io_unidadadm->uf_validarcierre_gastos_ingreso($ls_statusg,$ls_statusi);
		    if(($lb_valido)&&($ls_statusg=="1")&&($ls_statusi=="1"))
		    {
				$msg->message("El cierre Presuepuestario de Gasto e Ingreso fue ejecutado con Anterioridad, No se puede crear Unidades Administrativas");			
		    }
		break;
		...
		case "GUARDAR":
		    ...
		    {
				uf_load_variables();			
				$lb_valido=$io_unidadadm->uf_guardar($lb_existe,$ls_codigo,$ls_denominacion,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,
			...
			{
				$msg->message("El cierre Presuepuestario de Gasto e Ingreso fue ejecutado con Anterioridad, No Se pueden crear Unidades Administrativas");		
			}
			break;
		...
		case "ELIMINAR":
		    ...
		    {
				uf_load_variables();
				$lb_valido=$io_unidadadm->uf_delete_unidadadministrativa($ls_codigo,$la_seguridad);
				if($lb_valido)
				{
					uf_limpiarvariables();
					$lb_existe="FALSE";
			...
			{
				$msg->message("El cierre Presuepuestario de Gasto e Ingreso fue ejecutado con Anterioridad, No se puede Eliminar Unidades Adminstrativas");		
			}
			break;
	}
        ...
        <td>
		  ...
		  <table width="650" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
              <tr class="titulo-ventana">
                <td height="20" colspan="2">Definici&oacute;n de Unidad Administrativa</td>
              </tr>
              <tr >
              ...
              <tr>
                ...
                <td>	
				  <div align="left">
                  <input name="txtcodestpro1" type="text" id="txtcodestpro1" value="<?php print $ls_codestpro1;?>" size="<?php print $ls_loncodestpro1+10; ?>" maxlength="<?php print $ls_loncodestpro1; ?>" readonly>
            ...
            <tr>
                ...
                <td>
				 <div align="left" >
                 <input name="txtcodestpro2" type="text" id="txtcodestpro2" value="<?php print $ls_codestpro2 ; ?>" size="<?php print $ls_loncodestpro2+10; ?>" maxlength="<?php print $ls_loncodestpro2; ?>" readonly>
            ...
            <tr>
              ...
              <td>
			    <div align="left">
                <input name="txtcodestpro3" type="text" id="txtcodestpro3" value="<?php print $ls_codestpro3;?>" size="<?php print $ls_loncodestpro3+10; ?>" maxlength="<?php print $ls_loncodestpro3; ?>" readonly>
...
<?php }
	  ...
	  {?>
            <tr>
              ...
              <td>
			    <div align="left">
                <input name="txtcodestpro4" type="text" id="txtcodestpro4" value="<?php print $ls_codestpro4;?>" size="<?php print $ls_loncodestpro4+10; ?>" maxlength="<?php print $ls_loncodestpro4;?>" readonly>
            ...
            <tr>
              ...
              <td>
			    <div align="left">
                <input name="txtcodestpro5" type="text" id="txtcodestpro5" value="<?php print $ls_codestpro5;?>" size="<?php print $ls_loncodestpro5+10; ?>" maxlength="<?php print $ls_loncodestpro5;?>" readonly>
...
function ue_nuevo()
{
	...
	{	
		...
		f.action="sigesp_snorh_d_uni_ad.php";
		f.submit();
   	}
	else
   	{
...
function ue_buscar()
{
	...
	if (li_leer==1)
   	{
		window.open("sigesp_snorh_cat_uni_ad.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=yes");
   	}
	else
   	{
 		alert("No tiene permiso para realizar esta operacion");
