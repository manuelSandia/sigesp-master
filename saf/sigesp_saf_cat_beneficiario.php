...
<script language="JavaScript">
	function aceptar(as_ced_bene,as_nombene)
	{
		...
		if (ls_opener=="sigesp_saf_p_autorizacionsalida.php")
		{
			opener.document.form1.txtcodpro.value=as_ced_bene;
			opener.document.form1.txtdenpro.value=as_nombene;
			opener.document.form1.proben.value='B';
		}
		else
		{
