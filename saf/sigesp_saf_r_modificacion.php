...
$io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_modificacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<html>
<head>
<title>Reporte de Modificaci&oacute;n</title>
...
?>	
  ...
  <table width="547" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Reporte de Modificaci&oacute;n</td>
    </tr>
  </table>
  <table width="542" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td height="22" colspan="3" align="center"><table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
        ...
        <tr>
          ...
          <td width="82"><input name="txtdesde" type="text" id="txtdesde"  onKeyPress="ue_separadores(this,'/',patron,true);" value="<?php print $ld_fecdes ?>" size="15" maxlength="10"  datepicker="true"></td>
    ...
    <tr>
      <td colspan="3" align="center"><div align="left">
        <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td height="22"><div align="right"></div>  <div align="right"></div>              
            <div align="right">Comprobante
...
<script language="JavaScript">
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			{
				window.open("reportes/sigesp_saf_rpp_modificacion.php?orden="+li_orden+"&desde="+ld_desde+"&hasta="+ld_hasta+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			}
			else
			{
