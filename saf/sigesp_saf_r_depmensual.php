...
function uf_mostrar_reporte()
{
	...
	if(li_imprimir==1)
	{
		...
		window.open("reportes/sigesp_saf_rpp_depmensual.php?ordenact="+li_ordenact+"&mes="+ls_mes+"&anio="+ls_anio+"&tipoformato="+tipoformato+"&codcatsudeban="+codcatsudeban+"&soloincorporados="+soloincorporados,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
	}
	else
...
function uf_open_excel()
{
	...
	if(li_imprimir==1)
	{
		...
		window.open("reportes/sigesp_saf_rpp_depmensual_excel.php?ordenact="+li_ordenact+"&mes="+ls_mes+"&anio="+ls_anio+"&tipoformato="+tipoformato+"&codcatsudeban="+codcatsudeban+"&soloincorporados="+soloincorporados,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
	}
	else
	{alert("No tiene permiso para realizar esta operación");}
}
