...
<br>
    <table width="600" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        <td height="22"><div align="right">Chapa</div></td>
        <td height="22" colspan="4"><input name="txtidchapa" type="text" id="txtidchapa"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
...
{
	$ls_sql="SELECT saf_activo.*, saf_dta.ideact, saf_dta.idchapa, saf_dta.seract".
