<?php
	...
	function uf_cabecera(&$io_pdf)
	{
	    ...
	    $la_data=array(array('name'=>'   Los sucritos ___________________________________________________, mayores de edad, hacemos'),
					   ...
					   array('name'=>'   se ha reasignado del invetario de la Unidad ____________________________que funciona en:'),
					   array('name'=>'   _______________________, del Estado _______________________, los bienes que a continuación se '),
		               array('name'=>'   especifican:'));
	...
	function uf_print_pie_detalle(&$io_pdf)
	{
		...
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
	    $la_data=array(array('name'=>'   Esta  acta es realizada por quintuplicado a un solo tenor y efecto para los fines de la reasignación'),
	...
	function uf_print_pie_cabecera(&$io_pdf)
	{
	    ...
	    $io_pdf->addText(350,205,10,"QUIEN ENTREGA");  
	...
	$ls_titulo="<b>ACTA DE REASIGNACIÓN</b>";   
