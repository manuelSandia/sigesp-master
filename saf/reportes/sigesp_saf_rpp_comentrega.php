<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_cmpent,$ad_fecha,&$io_pdf)
	{
		...
		$io_pdf->addText(45,542,8,"<b>Coordinación de Bienes Nacionales</b>"); // Agregar la Fecha
	...
	function uf_print_cabecera($as_codemp,$as_nomemp,$as_coduniadm,$as_denuniadm,$as_codunisol,$as_denunisol,$as_cedres,$as_nomres,&$io_pdf)
	{
		...
		$io_pdf->ezSetY(402);
		$la_data[1]=array('cantidad'=>'<b>Código</b>',
						  'catalogo'=>'<b>Denominación</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>760, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('cantidad'=>array('justification'=>'center','width'=>118), // Justificación y ancho de la columna
						 			   'catalogo'=>array('justification'=>'center','width'=>220), // Justificación y ancho de la columna
						 			   'codact'=>array('justification'=>'center','width'=>409))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>760, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('canti'=>array('justification'=>'center','width'=>118), // Justificación y ancho de la columna
						 			   'cata'=>array('justification'=>'left','width'=>220), // Justificación y ancho de la columna
						 			   'coda'=>array('justification'=>'left','width'=>409))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cantidad'=>array('justification'=>'center','width'=>45), // Justificación y ancho de la columna
						 			   ...
						 			   'codact'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'denact'=>array('justification'=>'center','width'=>253), // Justificación y ancho de la columna
						 			   'costo'=>array('justification'=>'center','width'=>145), // Justificación y ancho de la columna
						 			   'total'=>array('justification'=>'center','width'=>145))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cantidad'=>array('justification'=>'center','width'=>45), // Justificación y ancho de la columna
						 			   'catalogo'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'codact'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'denact'=>array('justification'=>'left','width'=>253), // Justificación y ancho de la columna
						 			   'costo'=>array('justification'=>'right','width'=>145), // Justificación y ancho de la columna
						 			   'total'=>array('justification'=>'right','width'=>145))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_totales($as_nomrec,$as_cedrec,$as_carrec,$as_nomdes,$as_ceddes,$as_cardes,&$io_pdf)
	{
		...
		$io_pdf->addText(18,100,9,"<b>Cédula de Identidad</b>"); // Agregar texto
		...
		$io_pdf->addText(375,100,9,"<b>Cédula de Identidad</b>"); // Agregar texto
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(8.35,5.5,3,3); // Configuración de los margenes en centímetros
		$ld_fecha=$io_report->ds->data["feccmp"][1];
		$ld_fecha=$io_funciones->uf_convertirfecmostrar($ld_fecha);
		uf_print_encabezado_pagina($ls_titulo,$ls_cmpent,$ld_fecha,$io_pdf); // Imprimimos el encabezado de la página
