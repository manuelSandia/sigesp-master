<?php
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codact'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'denact'=>array('justification'=>'left','width'=>205), // Justificación y ancho de la columna
									   'estact'=>array('justification'=>'center','width'=>125), // Justificación y ancho de la columna
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=$io_report->uf_saf_load_invgenbie($ls_codemp,$li_ordenact,$ld_desde,$ld_hasta,$ls_coddesde,$ls_codhasta,$ls_grupo,$ls_subgrupo,$ls_seccion); // Cargar el DS con los datos de la cabecera del reporte
