<?php
	...
	function uf_cabecera(&$io_pdf)
	{
	    ...
	    $la_data=array(array('name'=>'   Los sucritos ___________________________________________________, mayores de edad, hacemos'),
					   ...
					   array('name'=>'   instrucciones recibidas de la Direccion de Administración del Ministerio del Poder Popular para la'),
					   array('name'=>'   Educación se han incorporado al inventario de la Unidad _________________________________ '),
					   array('name'=>'   que funciona en____________________________, Municipio _______________________ ,'),
					   array('name'=>'   del Estado _____________________________________, los bienes que a continuación se especifican,'),
					    array('name'=>'   por presentar:__________________________.'));
	...
	$ls_titulo="<b>ACTA DE DESINCORPORACIÓN</b>";   
