<?php
	...
	function uf_print_detalle_activo($aa_data,&$io_pdf)
	{
		
		$io_pdf->ezSetDy(-10);
		
		$la_columna = array('codact'=>'<b>Código</b>','seract'=>'<b>Serial</b>','idchapa'=>'<b>Id Chapa</b>','denact'=>'<b>Denominación</b>');
		$la_config  = array('showHeadings'=>1, // Mostrar encabezados
						    ...
						    'width'=>500, // Ancho de la tabla
						    'maxWidth'=>500,
						    'cols'=>array('codact'=>array('justification'=>'center','width'=>90),
							              'seract'=>array('justification'=>'center','width'=>110),
										  'idchapa'=>array('justification'=>'center','width'=>90),
										  'denact'=>array('justification'=>'center','width'=>250))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($aa_data,$la_columna,'<b>Datos Activos</b>',$la_config);
	    unset($la_data,$la_columna,$la_config);
	}
	          ...
	          if ($row=$io_sql->fetch_row($rs_data))
		         {
				   ...
				   $data=$io_report->uf_activos_responsable($ls_codnewres);
				   uf_print_detalle_activo($data->GetArray(),$io_pdf);
				   $io_pdf->setStrokeColor(0,0,0);
