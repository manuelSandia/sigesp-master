	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('cantidad'=>array('justification'=>'center','width'=>45), // Justificación y ancho de la columna
									   ...
									   'serial'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna	
						 			   'denact'=>array('justification'=>'left','width'=>170), // Justificación y ancho de la columna
						 			   'codcau'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
	...
	else // Imprimimos el reporte
	{
		...
		if($lb_valido)
		{
			...
			for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
			{
				...
				{
					$li_aux=$li_aux + 1;
					$la_data[$li_aux]=array('cantidad'=>$li_cantidad,'catalogo'=>$ls_catalogo,'codact'=>$ls_codart,'serial'=>$ls_serial,'denact'=>$ls_denart,
