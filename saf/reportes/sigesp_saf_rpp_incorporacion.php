<?php
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codart'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
									   'serial'=>array('justification'=>'left','width'=>70), // Justificación y ancho de la columna
						 			   ...
						 			   'desmov'=>array('justification'=>'left','width'=>125), // Justificación y ancho de la columna
	...
	function uf_print_totales($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>530, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('total'=>array('justification'=>'right','width'=>455), // Justificación y ancho de la columna
						 			   'monact'=>array('justification'=>'right','width'=>75))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					$la_data[$li_s]=array('codart'=>$ls_codart,'serial'=>$ls_serial,'denart'=>$ls_denart,'ideact'=>$li_ideact,'desmov'=>$ls_desmov,
										  'monact'=>$li_monact);
				}
