<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_cmpmov,$ad_fecha,&$io_pdf)
	{
		...
		$tm=514-($li_tm/2);
		$io_pdf->addText($tm,540,10,$ad_fecha); // Agregar el título
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>900, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('fectraact'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
	...
	function uf_print_detallecontable($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>900, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('cuenta'=>array('justification'=>'left','width'=>350), // Justificación y ancho de la columna
						 			   'documento'=>array('justification'=>'left','width'=>350), // Justificación y ancho de la columna
	...
	$ls_titulo="<b>Reporte de Reasignaciones</b>";
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=$io_report->uf_saf_load_movimiento($ls_codemp,$ls_cmpmov,$ld_fecdes,$ld_fechas,"R",$ls_coddes,$ls_codhas,$li_orden); // Cargar el DS con los datos de la cabecera del reporte
	...
	{
		/////////////////////////////////         SEGURIDAD               ////////////////////////////////////////////////////
		$ls_desc_event="Generó el reporte de Reasignacion. Desde el Activo   ".$ls_coddes." hasta   ".$ls_codhas;
		$io_fun_activos->uf_load_seguridad_reporte("SAF","sigesp_saf_r_reasignacion.php",$ls_desc_event);
		////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////////////
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$lb_valido=$io_report->uf_siv_load_dt_movreasignacion($ls_codemp,$ls_cmpmov); // Obtenemos el detalle del reporte
			if($lb_valido)
			{
				$li_montot=0;
