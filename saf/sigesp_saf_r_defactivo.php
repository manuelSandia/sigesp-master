...
$io_saf_tipcat->uf_load_config("SAF","DEPRECIACION","MODIFICACION_INCORPORACION",$ls_estsudeban);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<table width="542" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center" class="titulo-ventana">Listado de Activos </td>
    </tr>
    <tr>
      <td colspan="3" align="center"><table width="511" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          <td height="10">&nbsp;</td>
          <td height="22"><input name="chkestdes" type="checkbox" class="sin-borde" id="chkestdes" value="1" checked>
            No mostrar activos desincorporados </td>
        </tr>
      </table></td>
    </tr>
    <tr>
      ...
      <td height="22" colspan="3" align="center"><table width="511" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td height="22"><input name="txtcodresuso" type="text" id="txtcodresuso" size="15" style="text-align:center" readonly>
              <a href="javascript: uf_resprimario('repasignadosuso');"><img src="../shared/imagebank/tools15/buscar.gif" alt="buscar" width="15" height="15" border="0"></a>
              <input name="txtdenresuso" type="text" class="sin-borde" id="txtdenresuso" size="40" readonly>          </td>
        </tr>
      </table></td>
    </tr>
    <tr>
	...
	?>
    <tr>
      <td height="22" colspan="3" align="center"><table width="511" height="22" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
    ...
    <tr>
      <td height="22" colspan="3" align="center"><table width="511" height="22" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td width="126" height="22"><div align="left"><strong>Tipos de Activos </strong></div></td>
          <td width="368" height="22">&nbsp;</td>
        </tr>
        <tr>
          <td height="22" colspan="2"><div align="center">
            <input name="rdtipact" type="radio" class="sin-borde" value="T" checked> 
            Todos
            <input name="rdtipact" type="radio" class="sin-borde" value="TD">
            Totalmente Depreciados
            <input name="rdtipact" type="radio" class="sin-borde" value="PD">
            Por Depreciar 
            <input name="rdtipact" type="radio" class="sin-borde" value="D">
          Desincorporados</div></td>
          </tr>
      </table></td>
    </tr>
    <tr>
