	...
	if($ls_operacion=="BUSCAR")
	{
		...
		if($row=$io_sql->fetch_row($rs_data))
		{
			...
			for($z=1;$z<=$li_totrow;$z++)
			{
				...
				$codestprog4=substr($data["codestpro4"][$z],(strlen($data["codestpro4"][$z])-$li_len4),$li_len4);
				$codigo=substr($data["codestpro5"][$z],(strlen($data["codestpro5"][$z])-$li_len5),$li_len5);
...
<script language="JavaScript">
  ...
  function aceptar(codestprog,deno)
  {
	...
	opener.document.form1.txtcodestpro5.value=codestprog;
	close();
  }
