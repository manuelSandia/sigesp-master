<?php
	...
	$io_fun_sep->uf_load_seguridad("SEP","sigesp_sep_r_ubicacionsolicitudes.php",$ls_permisos,$la_seguridad,$la_permisos);
...
var patron2 = new Array(1,3,3,3,3)
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			pantalla="reportes/"+formato+"?numsoldes="+numsoldes+"&numsolhas="+numsolhas+"&tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"";
