  ...
  <tr>
    <td width="432" height="20" colspan="11" bgcolor="#E7E7E7">
		<table width="762" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
          		<td width="432" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Solicitud de Ejecuci&oacute;n Presupuestaria</td>
          		<td width="346" bgcolor="#E7E7E7">
          			<div align="right">
          				<span class="letras-pequenas"><b><?PHP print date("j/n/Y")." - ".date("h:i a");?></b>
          				</span>
          			</div>
          		</td>
          	</tr>
  ...
  <table width="575" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <td height="33" colspan="3" align="center">      <div align="left">
        <table width="511" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="101">
            	<input name="txtfecregdes" type="text" id="txtfecregdes"  onKeyPress="ue_formatofecha(this,'/',patron,true);" size="15" maxlength="10"  datepicker="true">
            </td>
    ...
    <tr>
      <td height="22" colspan="3" align="center"><table width="511" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <!-- Se agrego el nuevo estatus al filtro -->
        <tr>
          <td colspan="2"><input name="chkestsol" type="checkbox" class="sin-borde" id="chkestsol" value="1">
            Sin Disponibilidad Presupuestaria</td>
	  	  <td colspan="2"><input name="chkestsol" type="checkbox" class="sin-borde" id="chkestsol" value="1">
            Finalizada-anulada parcial</td>
        </tr>
      </table></td>
    </tr>
    <tr>
...
var patron2 = new Array(1,3,3,3,3)
	function ue_buscar()
	{
		...
		if (li_leer==1)
		{
			...
			{pagada=0;}
			//se agrego el if del estatus "Sin disponibilidad presupuestaria"
			if(f.chkestsol[8].checked)
			{sindisp=1;}
			else
			{sindisp=0;}
//se agrego el if del estatus "finalizada-anulada parcial"
			if(f.chkestsol[9].checked)
			{finalizada=1;}
			else
			{finalizada=0;}
			if((fegregdes!="")&&(fegreghas!=""))
			{
				...
				// Enviar todos los campos a la pagina para que haga el procesamiento y se agrego el nuevo estatus de SEP
				ajax.send("numsoldes="+numsoldes+"&numsolhas="+numsolhas+"&tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fegregdes="+fegregdes+"&fegreghas="+fegreghas+"&codunides="+codunides+"&codunihas="+codunihas+"&tipsol="+tipsol+"&registrada="+registrada+"&emitida="+emitida+"&contabilizada="+contabilizada+"&procesada="+procesada+"&anulada="+anulada+"&despachada="+despachada+"&aprobada="+aprobada+"&pagada="+pagada+"&sindisp="+sindisp+"&finalizada="+finalizada+"&codusudes="+codusudes+"&codusuhas="+codusuhas+"&proceso=SOLICITUDES");
		...
		if(li_imprimir==1)
		{
			...
			if(selectivo==1)
			{
				...
				else
				{
					...
					ls_formato  = "sigesp_sep_rpp_solicitudes_excel.php";
			...
			else
			{
				...
				{sindisp=0;}
//se agrego el if del estatus "Finalizada"
				if(f.chkestsol[9].checked)
				{finalizada=1;}
				else
				{finalizada=0;}
				...
				tipoformato="NORMAL";
				//Se agregó a los parametros enviados el nuevo estatus "Sin disponibilidad presupuestaria"
				pantalla="reportes/"+formato+"?numsoldes="+numsoldes+"&numsolhas="+numsolhas+"&tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fegregdes="+fegregdes+"&fegreghas="+fegreghas+"&codunides="+codunides+"&codunihas="+codunihas+"&tipsol="+tipsol+"&registrada="+registrada+"&emitida="+emitida+"&contabilizada="+contabilizada+"&procesada="+procesada+"&anulada="+anulada+"&despachada="+despachada+"&aprobada="+aprobada+"&pagada="+pagada+"&sindisp="+sindisp+"&finalizada="+finalizada+"&orden="+orden+"&tipoformato="+tipoformato+"&codusudes="+codusudes+"&codusuhas="+codusuhas+"";
				window.open(pantalla,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			}
		}
		else
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			else
			{
				...
				tipoformato="NORMAL";
				//Se agregó a los parametros enviados el nuevo estatus "Sin disponibilidad presupuestaria"
				pantalla="reportes/"+formato+"?numsoldes="+numsoldes+"&numsolhas="+numsolhas+"&tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fegregdes="+fegregdes+"&fegreghas="+fegreghas+"&codunides="+codunides+"&codunihas="+codunihas+"&tipsol="+tipsol+"&registrada="+registrada+"&emitida="+emitida+"&contabilizada="+contabilizada+"&procesada="+procesada+"&anulada="+anulada+"&despachada="+despachada+"&aprobada="+aprobada+"&pagada="+pagada+"&sindisp="+sindisp+"&orden="+orden+"&tipoformato="+tipoformato+"&codusudes="+codusudes+"&codusuhas="+codusuhas+"";
				window.open(pantalla,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			}
		}
		else
