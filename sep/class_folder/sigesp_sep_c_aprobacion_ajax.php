<?php
	...
	{	
		...
		$lo_title[6]="Monto";
		$lo_title[7] = "Justificaci&oacute;n ";
		if($as_tipo=="-")
		{
			$as_tipo="";
		}	
		...
		while($row=$io_aprobacion->io_sql->fetch_row($rs_datasol))
		{
			...
			$lo_object[$li_fila][2]="<input type=text name=txtnumsol".$li_fila."    id=txtnumsol".$li_fila."    class=sin-borde style=text-align:center size=20 value='".$ls_numsol."'    readonly>".
									...
									"<input type=hidden name=txtcodtipsol".$li_fila." id=txtcodtipsol".$li_fila." class=sin-borde style=text-align:center size=20 value='".$ls_codtipsol."' readonly>";
			...
			//$lo_object[$li_fila][7]="<input type=text name=txtjusaprosol".$li_fila."     id=txtjusaprosol".$li_fila."     class=sin-borde style=text-align:right  size=15 value='".$ls_justificacion."'>";
			$lo_object[$li_fila][7]="<textarea input name=txtjusaprosol".$li_fila." id=txtjusaprosol".$li_fila."  type=text class=sin-borde  size=80   style=text-align:left       >$ls_jusaprosol</textarea>";
		...
		if($li_fila==0)
		{
			...
			$lo_object[$li_fila][7]="<input type=text name=txtjusaprosol".$li_fila."     class=sin-borde style=text-align:right  size=15 readonly>";
