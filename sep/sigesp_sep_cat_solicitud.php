    ...
    <table width="630" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td height="29"><div align="left">
            <?php  if($ls_tipo!="AUTCAN"){
            			$io_sep->uf_load_tiposolicitud(""); 
      			   }
      			   else{
      			   	    echo "<b>Precompromiso(Bienes/Servicios)</b><input name='cmbcodtipsol' type='hidden' id='cmbcodtipsol'>";
      			   }
      	    ?>
        </div></td>
      </tr>
...
function ue_aceptar(ls_numsol,ls_codtipsol,ls_coduniadm,ls_codfuefin,ls_estsol,ls_tipo_destino,ls_codigo,ls_denuniadm,
					...
					ls_nombenalt,ls_estayueco,as_tipsepbie,as_rif,contador,ls_consolanu,ls_numdocori)
{
	f=document.formulario;
	opener.document.formulario.catalogo.value=1;
	...
	if (as_tipsepbie=='M')
	   {
		 ...
		 opener.document.formulario.hidtipbie.value='M';			  
		 ...
		 if (as_tipsepbie=='A')
		    {
			  ...
			  opener.document.formulario.radiotipbie[0].disabled = true;
		      opener.document.formulario.radiotipbie[1].disabled = true;
		      opener.document.formulario.hidtipbie.value='A';
		    }
		 else
		    {
			  opener.document.formulario.radiotipbie[0].checked  = false;
			  ...
			  opener.document.formulario.radiotipbie[0].disabled = true;
			  opener.document.formulario.radiotipbie[1].disabled = true;
			  opener.document.formulario.hidtipbie.value='-';			  
		    }	     
	   }
	...
	opener.document.formulario.txtconsolanu.value=ls_consolanu;
	...
	opener.document.formulario.txtnumdocori.value=ls_numdocori;
...
function ue_aceptar_autcan(ls_numsol,ls_codtipsol,ls_coduniadm,ls_codfuefin,ls_estsol,ls_tipo_destino,ls_codigo,ls_denuniadm,
		ls_denfuefin,ls_nombre,ls_estapro,ld_fecregsol,li_monto,li_monbasinm,li_montotcar,ls_estatus,ls_estope,
		ls_modsep,ls_codestpro1,ls_codestpro2,ls_codestpro3,ls_codestpro4,ls_codestpro5,ls_estcla,as_consol,
		ls_nombenalt,ls_estayueco,as_tipsepbie,as_rif,contador,ls_numdocori)
{
f=document.formulario;
opener.document.formulario.catalogo.value=1;
opener.document.formulario.txtnumsol.value=ls_numsol;
...
if(ls_modsep=="B") // Bienes
{
proceso="LOADBIENES_AUTCAN";
}
if(ls_modsep=="S") // Servicios
{
proceso="LOADSERVICIOS_AUTCAN";
}
if(ls_modsep=="O") // Conceptos
{
proceso="LOADCONCEPTOS";
