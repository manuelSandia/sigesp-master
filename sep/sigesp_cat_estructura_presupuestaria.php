...
if ($ls_operacion=="BUSCAR")
   {
	 if (!empty($ls_codunieje))
		...
		{
		 $ls_sql_seguridad = " AND CONCAT('".$la_empresa["codemp"]."','SPG','".$_SESSION["la_logusr"]."',spg_dt_unidadadministrativa.codestpro1,spg_dt_unidadadministrativa.codestpro2,spg_dt_unidadadministrativa.codestpro3,spg_dt_unidadadministrativa.codestpro4,spg_dt_unidadadministrativa.codestpro5,spg_dt_unidadadministrativa.estcla) IN (SELECT CONCAT(codemp,codsis,codusu,codintper) 
		                       FROM sss_permisos_internos WHERE codusu = '".$_SESSION["la_logusr"]."' AND codsis = 'SPG' AND enabled=1)";
		}
		else
		{
		 $ls_sql_seguridad = " AND '".$la_empresa["codemp"]."'||'SPG'||'".$_SESSION["la_logusr"]."'||spg_dt_unidadadministrativa.codestpro1||spg_dt_unidadadministrativa.codestpro2||spg_dt_unidadadministrativa.codestpro3||spg_dt_unidadadministrativa.codestpro4||spg_dt_unidadadministrativa.codestpro5||spg_dt_unidadadministrativa.estcla IN (SELECT codemp||codsis||codusu||codintper
		                       FROM sss_permisos_internos WHERE codusu = '".$_SESSION["la_logusr"]."' AND codsis = 'SPG' AND enabled=1)";
		}
	 $ls_sql="SELECT spg_unidadadministrativa.coduniadm,spg_unidadadministrativa.denuniadm,spg_dt_unidadadministrativa.codestpro1, 
	                 spg_dt_unidadadministrativa.codestpro2,spg_dt_unidadadministrativa.codestpro3,spg_ep1.denestpro1,
					 spg_ep2.denestpro2,spg_ep3.denestpro3,spg_ep4.denestpro4,spg_ep5.denestpro5,spg_dt_unidadadministrativa.codestpro4, 
			   ...
			   WHERE spg_unidadadministrativa.codemp='".$la_empresa["codemp"]."'
				 ...
				 AND spg_dt_unidadadministrativa.central='0'
				 AND spg_dt_unidadadministrativa.codestpro1 like '%".$ls_codestpro1."%'".$ls_sql_seguridad.
			   ...
			   while ($row=$io_sql->fetch_row($rs_data))
			         {
					   ...
					   echo "<td width=160 style=text-align:center title='".$ls_denestpro1."'><a href=\"javascript: aceptar('$ls_codunieje','$ls_denunieje','$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_estcla');\">".trim(substr($ls_codestpro1,-$li_loncodestpro1))."</a></td>";
					   echo "<td width=160 style=text-align:center title='".$ls_denestpro2."'><a href=\"javascript: aceptar('$ls_codunieje','$ls_denunieje','$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_estcla');\">".trim(substr($ls_codestpro2,-$li_loncodestpro2))."</a></td>";
					   echo "<td width=160 style=text-align:center title='".$ls_denestpro3."'><a href=\"javascript: aceptar('$ls_codunieje','$ls_denunieje','$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_estcla');\">".trim(substr($ls_codestpro3,-$li_loncodestpro3))."</a></td>";
					   if ($li_estmodest==2)
					      {
					        echo "<td width=160 style=text-align:center title='".$ls_denestpro4."'><a href=\"javascript: aceptar('$ls_codunieje','$ls_denunieje','$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_estcla');\">".trim(substr($ls_codestpro4,-$li_loncodestpro4))."</a></td>";
					        echo "<td width=160 style=text-align:center title='".$ls_denestpro5."'><a href=\"javascript: aceptar('$ls_codunieje','$ls_denunieje','$ls_codestpro1','$ls_codestpro2','$ls_codestpro3','$ls_codestpro4','$ls_codestpro5','$ls_estcla');\">".trim(substr($ls_codestpro5,-$li_loncodestpro5))."</a></td>";
						  }
...
<script language="JavaScript">
  ...
  {
	close();
    opener.aceptar(ls_codunieje,ls_denunieje,ls_codestpro1,ls_codestpro2,ls_codestpro3,ls_codestpro4,ls_codestpro5,ls_estcla);
  }
  ...
  function ue_search()
  {
	  ...
	  f.action="sigesp_cat_estructura_presupuestaria.php";
	  f.submit();
  }
</script>
</html>