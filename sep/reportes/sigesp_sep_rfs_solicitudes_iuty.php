<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
		...
		$io_pdf->addText(157,122,7,"SOLICITADO POR"); // Agregar el título
		$io_pdf->addText(145,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(275,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(257,63,7,"UNIDAD DE ADMINISTRACIÓN"); // Agregar el título
		$io_pdf->addText(440,122,7,"UNIDAD DE COMPRAS"); // Agregar el título
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
						 			   ...
						 			   'cantidad'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   'unidad'=>array('justification'=>'center','width'=>45), // Justificación y ancho de la columna
						 			   'cosuni'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
						 			   'baseimp'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
						 			   'cargo'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
	...
	function uf_print_detalle_cargos($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
						 			   'dencar'=>array('justification'=>'center','width'=>225), // Justificación y ancho de la columna
						 			   'monbasimp'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'monimp'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
	...
	function uf_print_piecabecera($li_subtot,$li_totcar,$li_montot,$ls_monlet,&$io_pdf)
	{
		...
		unset($la_columnas);
		unset($la_config);
		$la_data[1]=array('titulo'=>'<b>IVA  '.$ls_titcar.'</b>','contenido'=>$li_totcar,);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
