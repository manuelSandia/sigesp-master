<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_nomusu,$as_estsol,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_inn.jpg',25,735,560,30); // Agregar Logo
		if ($as_estsol=="A")
		{
		...
		$io_pdf->addText(485,720,9,"No. ".$as_numsol); // Agregar el título
		...
		$io_pdf->addText(78,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(80,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(80,75,7,$as_nomusu); // Agregar el título
		$io_pdf->addText(202,122,7,"DIRECTOR RESPONSABLE DE EJECUTAR PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(265,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(465,122,7,"RECIBIDO POR"); // Agregar el título
		$io_pdf->addText(430,63,7,"FIRMA  AUTÓGRAFA, SELLO, FECHA"); // Agregar el título
...
*/		$io_pdf->restoreState();
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_report->uf_sep_select_usuario($_SESSION["la_logusr"],&$ls_nomusu);
