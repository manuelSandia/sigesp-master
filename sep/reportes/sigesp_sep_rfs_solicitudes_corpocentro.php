<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
		...
		$io_pdf->addText(280,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(270,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(470,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(445,63,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>110), // Justificación y ancho de la columna
						 			   ...
						 			   'cantidad'=>array('justification'=>'left','width'=>37), // Justificación y ancho de la columna
						 			   'unidad'=>array('justification'=>'center','width'=>63), // Justificación y ancho de la columna
