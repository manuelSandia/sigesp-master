<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
		...
		$io_pdf->line(190,60,190,130);		
		$io_pdf->line(380,60,380,130);		
		$io_pdf->addText(60,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(257,122,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(465,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
	 $ls_titulo='<b>REQUISICION DE MATERIALES </b>';
	//--------------------------------------------------------------------------------------------------------------------------------
