<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
		...
		$io_pdf->line(15,150,585,150);		
		$io_pdf->line(15,110,585,110);		
		$io_pdf->line(150,90,150,170);		
		$io_pdf->line(290,90,290,170);		
		$io_pdf->line(430,90,430,170);		
		$io_pdf->addText(45,157,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(42,98,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(185,157,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(180,98,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(325,157,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(315,98,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(480,157,7,"RECIBIDO POR"); // Agregar el título
		$io_pdf->addText(470,98,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
