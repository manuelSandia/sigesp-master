<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
		...
		$io_pdf->addText(175,122,7,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->addText(176,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(325,122,7,"VERIFICADO POR:"); // Agregar el título
		$io_pdf->addText(325,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(475,122,7,"RECIBIDO POR:"); // Agregar el título
		$io_pdf->addText(473,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
