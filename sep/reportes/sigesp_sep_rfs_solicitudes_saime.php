<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_nomusu,$as_estsol,&$io_pdf)
	{
		...
		$io_pdf->line(147,90,147,170);		
		$io_pdf->line(284,90,284,170);		
		$io_pdf->line(441,90,441,170);		
		$io_pdf->addText(65,158,6,"ELABORADO"); // Agregar el título
		$io_pdf->addText(200,158,6,"REVISADO"); // Agregar el título
		$io_pdf->addText(310,162,6,"COORDINACIÓN DE PLANIFICACIÓN");
		$io_pdf->addText(295,155,6,"PRESUPUESTO, ORGANIZACIÓN Y SISTEMAS"); // Agregar el título
		$io_pdf->addText(452,158,6,"DIRECCIÓN DE GESTIÓN ADMINISTRATIVA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
