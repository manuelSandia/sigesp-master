<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
		...
		$io_pdf->addText(80,122,8,"Elaborado por:"); // Agregar el título
		$io_pdf->addText(70,63,8,"Firma / Sello / Fecha"); // Agregar el título
		$io_pdf->addText(270,122,8,"Revisado por:"); // Agregar el título
		$io_pdf->addText(260,63,8,"Firma / Sello / Fecha"); // Agregar el título
		$io_pdf->addText(460,122,8,"Aprobado por:"); // Agregar el título
		$io_pdf->addText(450,63,8,"Firma / Sello / Fecha"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
