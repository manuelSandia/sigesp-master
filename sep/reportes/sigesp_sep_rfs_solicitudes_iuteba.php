<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
    	...
    	$io_pdf->addText(16,122,7,"SOLICITADO"); // Agregar el título
		$io_pdf->addText(16,115,7,"FECHA:"); // Agregar el título		
		$io_pdf->addText(102,122,7,"CONFOR. Y SUPERV."); // Agregar el título
		$io_pdf->addText(102,115,7,"FECHA:"); // Agregar el título		
		$io_pdf->addText(201,122,7,"SUB-DIRECCION"); // Agregar el título
		$io_pdf->addText(201,115,7,"ADMINISTRATIVA:"); // Agregar el título		
		$io_pdf->addText(312,122,7,"Vo.Bo. DIRECTOR"); // Agregar el título
		$io_pdf->addText(401,122,7,"DESPACHADO"); // Agregar el título
		$io_pdf->addText(401,115,7,"FECHA:"); // Agregar el título		
		$io_pdf->addText(500,122,7,"RECIBIDO"); // Agregar el título
		$io_pdf->addText(500,115,7,"FECHA:"); // Agregar el título		
		$io_pdf->restoreState();
		$io_pdf->closeObject();
