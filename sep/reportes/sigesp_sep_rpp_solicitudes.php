	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('numsol'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
						 			   ...
						 			   'estsol'=>array('justification'=>'center','width'=>75), // Justificación y ancho de la columna
	...
	function uf_print_piecabecera($ai_total,$ai_totrows,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('name'=>array('justification'=>'right','width'=>390), // Justificación y ancho de la columna
						 			   'totrows'=>array('justification'=>'right','width'=>75), // Justificación y ancho de la columna
...
//Se agrega el nuevo parametro del nuevo estatus de SEP
	$li_finalizada=$io_fun_sep->uf_obtenervalor_get("finalizada",0);
	...
	if($lb_valido)
	{
		...
		if($ls_tipoformato=="NORMAL")
		{
			...
			$lb_valido=$io_report->uf_select_solicitudes($ls_numsoldes,$ls_numsolhas,$ls_tipproben,$ls_codprobendes,$ls_codprobenhas,
														 ...
														 $li_despachada,$ls_orden,$ls_codusudes,$ls_codusuhas,$li_aprobada, $li_pagada,$li_sindisp,$li_finalizada); // Cargar el DS con los datos del reporte
		}
					...
					for($li_j=1;$li_j<=$li_totrowdet;$li_j++)
					{
						...
						switch ($ls_estsol)
						{
							...
							case "L": 
								...
								break;
							//Se agrego el case del nuevo estatus de SEP	
							case "S": 
...
break;
				...
				$la_data[$li_i]=array('numsol'=>$ls_numsol,'denuniadm'=>utf8_decode($ls_denuniadm),'nombre'=>utf8_decode($ls_nombre),'fecregsol'=>$ld_fecregsol,'estsol'=>$ls_estsol,'monto'=>$li_monto);
			}
