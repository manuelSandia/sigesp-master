<?php
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$ad_fechaconta,$as_estsol,$ls_logusr,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->line(480,730,595,730);
        $io_pdf->Rectangle(15,700,580,60);
		...
		$io_pdf->addText(480,720,9,"Fecha Registro: ".$ad_fecregsol); // Agregar el título
		$io_pdf->addText(480,705,9,"Fecha de Envío: ".$ad_fechaconta); // Agregar fecha de contabilizacion
		$io_pdf->addText(540,770,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(546,764,6,date("h:i a")); // Agregar la Hora 
		// cuadro inferior
        $io_pdf->Rectangle(250,60,330,70);
		$io_pdf->line(250,73,580,73);		
		$io_pdf->line(250,117,580,117);		
		...
		//$io_pdf->addText(40,100,7,"usuario"); // Agregar el título
		//$io_pdf->addText(42,63,7,"FIRMA / SELLO"); // Agregar el título
		//$io_pdf->addText(157,122,7,""); // Agregar el título
		//$io_pdf->addText(145,63,7,""); // Agregar el título
		$io_pdf->addText(275,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(290,77,7,'<b></b>'.$ls_logusr.'');
		$io_pdf->addText(285,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(440,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(420,63,7,"GERENTE DE LA UNIDAD SOLICITANTE"); // Agregar el título*/
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($as_numsol,$as_dentipsol,$as_denuniadm,$as_denfuefin,$as_codigo,$as_nombre,$as_consol,&$io_pdf)
	{
		...
		$la_data[1]=array('titulo'=>'<b>Justificacion</b>','contenido'=>$as_consol,);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ld_fechaconta=$io_report->DS->data["fechaconta"][$li_i];
				...
				$ls_logusr=$io_report->DS->data["codusu"][$li_i];
				...
				$ld_fechaconta=$io_funciones->uf_convertirfecmostrar($ld_fechaconta);
				if($ls_codpro!="----------")
				{
					$ls_codigo=$ls_codpro;
				}
				...
				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecregsol,$ld_fechaconta,$ls_estsol,$ls_logusr,&$io_pdf);
