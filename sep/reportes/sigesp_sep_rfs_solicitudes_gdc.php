<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,&$io_pdf)
	{
		...
		$io_pdf->addText(42,73,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(47,63,7,"ANALISTA"); // Agregar el título
		$io_pdf->addText(157,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(145,73,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(150,63,7,"COORDINACION"); // Agregar el título
		$io_pdf->addText(275,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(257,73,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(263,63,7,"JEFE DE OFICINA"); // Agregar el título
		$io_pdf->addText(430,122,7,"OFICINA DE PLANIFICACION"); // Agregar el título
		$io_pdf->addText(420,112,7,"ORGANIZACION Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(445,73,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
