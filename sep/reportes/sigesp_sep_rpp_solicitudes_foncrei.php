<?php
	...
	function uf_print_piecabecera($ai_total,$ai_totrows,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('name'=>array('justification'=>'right','width'=>800), // Justificación y ancho de la columna
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				if($ls_tipoformato=="SELECTIVO")
				{
					...
					for($li_j=1;$li_j<=$li_totrowdet;$li_j++)
					{
						...
						$io_fun_sep->uf_formato_estructura($ls_programatica,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5);
						if($li_estmodest==1)
						{
