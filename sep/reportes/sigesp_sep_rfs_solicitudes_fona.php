<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/encabezado.jpg',16,700,464,59); // Agregar Logo  //465,60
		//$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],695,720,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar 2 Logo
		if ($as_estsol=="A")
		{
		...
		$io_pdf->addText(450,122,7,"CERTIFICADO POR"); // Agregar el título
		$io_pdf->addText(425,63,7,"PLANIFICACION Y PRESUPUESTO"); // Agregar el título
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_numsol,$as_dentipsol,$as_denuniadm,$as_denfuefin,$as_codigo,$as_nombre,$as_consol,$as_numdocori,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[1]=array('titulo'=>'<b>Documento Origen</b>','contenido'=>$as_numdocori);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ls_numdocori=$io_report->DS->data["numdocori"][$li_i];
				...
				uf_print_cabecera($ls_numsol,$ls_dentipsol,$ls_denuniadm,$ls_denfuefin,$ls_codigo,$ls_nombre,$ls_consol,$ls_numdocori,&$io_pdf);
