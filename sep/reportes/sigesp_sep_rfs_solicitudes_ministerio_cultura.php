<?php
	...
	//  ORGANISMO: MINISTERIO DE LA CULTURA
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
		...
		$io_pdf->line(125,60,125,125);	//vertical
		$io_pdf->line(15,105,125,105);	//Horizontal
		$io_pdf->line(250,60,250,125);	//vertical
		$io_pdf->line(125,115,585,115);	//Horizontal
		$io_pdf->line(185,60,185,115);	//vertical
		$io_pdf->line(420,60,420,125);	//vertical
		$io_pdf->line(15,75,585,75);	//Horizontal
		$io_pdf->addText(30,110,7,"ELABORADO POR: ");      // Agregar texto
		$io_pdf->addText(30,65,7,"JEFE DE COMPRAS ");      // Agregar texto
		$io_pdf->addText(150,117,7,"CONTRALORÍA INTERNA ");      // Agregar texto
		$io_pdf->addText(128,65,7,"PRESUPUESTO    CONTRALORÍA ");      // Agregar texto
		$io_pdf->addText(290,117,7,"COMPRA AUTORIZADA ");      // Agregar texto
		$io_pdf->addText(460,117,7,"MATERIALES RECIBIDOS ");      // Agregar texto
		$io_pdf->addText(270,65,7,"GERENTE DE ADMINIST Y FINANZAS ");      // Agregar texto
		$io_pdf->addText(440,65,7,"FIRMA AUTOGRAFA, SELLO, FECHA");      // Agregar texto
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>115), // Justificación y ancho de la columna
						 			   ...
						 			   'montot'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
