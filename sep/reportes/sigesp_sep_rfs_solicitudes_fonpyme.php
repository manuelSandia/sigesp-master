<?php
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_nomusu,$as_estsol,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// cuadro inferior
        $io_pdf->Rectangle(15,90,570,80);
		$io_pdf->line(15,103,585,103);		
		$io_pdf->line(15,157,585,157);		
		$io_pdf->line(200,90,200,170);		
		$io_pdf->line(380,90,380,170);		
		$io_pdf->addText(60,162,7,"Elaborado Por:"); // Agregar el título
		$io_pdf->addText(55,113,7,$as_nomusu); // Agregar el título
		$io_pdf->addText(60,93,7,"Unidad Solicitante"); // Agregar el título
		$io_pdf->addText(257,162,7,"Verificado Por:"); // Agregar el título
		$io_pdf->addText(250,113,7,"Jose Manuel Balza"); // Agregar el título
		$io_pdf->addText(245,93,7,"Especialista En Compras"); // Agregar el título
		$io_pdf->addText(457,162,7,"Autorizado Por:"); // Agregar el título
		$io_pdf->addText(450,113,7,"Maryoris Lurua"); // Agregar el título
		$io_pdf->addText(425,93,7,"Gerente de Administracion y Finanzas"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezSetCmMargins(3.5,8,3,3); // Configuración de los margenes en centímetros
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecregsol,$ls_nomusu,$ls_estsol,&$io_pdf);
