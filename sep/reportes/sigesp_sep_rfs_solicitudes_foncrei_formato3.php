<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_dentipsol,$as_estsol,&$io_pdf)
	{
		...
		$io_pdf->addText($tm,710,12,"<b> TIPO:  ".$as_dentipsol."</b>"); // Agregar el título
		...
		$io_pdf->addText(120,60,7,"ANALISTA");      // Agregar texto
		...
		$io_pdf->addText(380,60,7,"OFICINA DE ADMINISTRACION Y SERVICIO");      // Agregar texto
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numero'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
						               'codigo'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   ...
						 			   'montot'=>array('justification'=>'right','width'=>105), // Justificación y ancho de la columna
						 			   'baseimp'=>array('justification'=>'right','width'=>105))); // Justificación y ancho de la columna
	...
	function uf_print_piecabecera($li_subtot,$li_totcar,$li_montot,$ls_monlet,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>450), // Justificación y ancho de la columna
						 			   'contenido'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecregsol,$ls_dentipsol,$ls_estsol,&$io_pdf);
