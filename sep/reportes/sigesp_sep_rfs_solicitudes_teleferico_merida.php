<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
		...
		// cuadro inferior
		$io_pdf->setStrokeColor(0,0,0);		
		$io_pdf->rectangle(15,60,570,80); // Agregar rectangulo grande		
		$io_pdf->line(205,60,205,140);	//vertical		
		$io_pdf->line(395,60,395,140);	//vertical
		$io_pdf->line(15,127,585,127);	//Horizontal		
		$io_pdf->line(15,112,585,112);	//Horizontal		
		$io_pdf->line(15,95,204,95);	//Horizontal
				
		$io_pdf->addText(75,130,7,"PRESUPUESTO ");   
		$io_pdf->addText(20,115,7,"FECHA:              /               /     ");     
		$io_pdf->addText(20,100,7,"REVISADO: ");     
		$io_pdf->addText(20,85,7,"FIRMA:   ");     
		
		$io_pdf->addText(280,130,7,"ALMACEN "); 
		$io_pdf->addText(210,115,7,"FECHA:              /               /     ");     
		$io_pdf->addText(210,100,7,"FIRMA: ");     		
		     
		$io_pdf->addText(455,130,7,"ADMINISTRACION ");
		$io_pdf->addText(400,115,7,"FECHA:              /               /     ");     
		$io_pdf->addText(400,100,7,"FIRMA: ");     
