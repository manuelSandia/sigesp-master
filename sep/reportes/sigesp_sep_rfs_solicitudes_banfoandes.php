<?php
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_codusu,$as_codaprusu,$as_estsol,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->line(130,60,130,140);		
		$io_pdf->line(240,60,240,140);		
		$io_pdf->line(380,60,380,140);		                   //$as_codusu,$as_codaprusu
		$io_pdf->addText(40,132,7,"ELABORADO POR"); // Agregar el título
        $io_pdf->addText(52,73,7,$as_codusu); // Agregar el título
		$io_pdf->addText(42,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(157,132,7,"VERIFICADO POR"); // Agregar el título
        $io_pdf->addText(160,73,7,$as_codaprusu ); // Agregar el título  
		$io_pdf->addText(145,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(275,132,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(257,63,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->addText(440,132,7,"CONTRALORIA INTERNA"); // Agregar el título
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
                ...
                $ls_codaprusu=$io_report->DS->data["codaprusu"][$li_i];
				...
				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecregsol,$ls_codusu,$ls_codaprusu,$ls_estsol,&$io_pdf);
