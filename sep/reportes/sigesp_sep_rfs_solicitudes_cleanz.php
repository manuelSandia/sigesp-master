...
//  ORGANISMO: CONSEJO LEGISLATIVO DEL ESTADO ANZOATEGUI
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
		...
		// cuadro inferior
		$io_pdf->addText(245,162,7,"_____________________________"); // Agregar el título
		$io_pdf->addText(255,152,7,"FIRMA DEL SOLICITANTE"); // Agregar el título
        $io_pdf->Rectangle(15,60,570,70);
		$io_pdf->line(15,117,585,117); //HORINZONTAL
		...
		$io_pdf->addText(155,122,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(265,122,7,"CONTRALORIA"); // Agregar el título
		$io_pdf->addText(370,122,7,"ADMINISTRACIÓN"); // Agregar el título
		$io_pdf->addText(500,122,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($as_numsol,$as_dentipsol,$as_denuniadm,$as_denfuefin,$as_codigo,$as_nombre,$as_consol,&$io_pdf)
	{
		...
		$ls_nombre=$as_nombre."         <b>CODIGO / C.I</b>:  ".$as_codigo;
		$la_data[1]=array('titulo'=>'<b>Proveedor / Beneficiario</b>','contenido'=>$ls_nombre,);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezSetCmMargins(3.6,9,3,3); // Configuración de los margenes en centímetros
