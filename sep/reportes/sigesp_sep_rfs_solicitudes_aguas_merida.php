...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
	    ...
	    $io_pdf->rectangle(40,60,550,65);           // Agregar rectangulo grande		
		$io_pdf->line(125,60,125,125);	//vertical
		$io_pdf->line(40,105,125,105);	//Horizontal
		$io_pdf->line(250,60,250,125);	//vertical
		$io_pdf->line(125,115,590,115);	//Horizontal
		$io_pdf->line(185,60,185,115);	//vertical
		$io_pdf->line(420,60,420,125);	//vertical
		$io_pdf->line(40,75,590,75);	//Horizontal
		$io_pdf->addText(50,110,7,"ELABORADO POR: ");      // Agregar texto
		$io_pdf->addText(50,65,7,"JEFE DE COMPRAS ");      // Agregar texto
