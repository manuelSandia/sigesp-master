<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
        ...
        $io_pdf->Rectangle(120,700,465,60);
		//$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],25,703,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_idena.jpg',25,705,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo		
		if ($as_estsol=="A")
		{
		...
		$io_pdf->addText(65,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(80,63,7,"Nombre"); // Agregar el título
//		$io_pdf->addText(157,122,7,"VERIFICADO POR"); // Agregar el título
//		$io_pdf->addText(145,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(260,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(257,63,7,"Gerente o Coordinador"); // Agregar el título
		$io_pdf->addText(440,122,7,"PRECOMPROMETIDO"); // Agregar el título
		$io_pdf->addText(445,63,7,"Gerente o Coordinador"); // Agregar el título
		$io_pdf->addJpegFromFile('../../shared/imagebank/comunas_idena.jpg',45,19,500,40); // Agregar Logo
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezStartPageNumbers(580,47,8,'','',1); // Insertar el número de página
