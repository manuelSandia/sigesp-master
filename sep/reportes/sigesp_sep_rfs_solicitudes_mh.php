<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.'logo_mh.jpg',20,725,450,50); // Agregar Logo
		if ($as_estsol=="A")
		{
			$io_pdf->addText(480,765,10,"<b>ANULADO</b>"); // Agregar la Fecha
		}
		$io_pdf->line(15,40,585,40);
		$io_pdf->line(480,660,480,720);
		$io_pdf->line(480,690,585,690);
		$io_pdf->Rectangle(15,660,570,60);
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,690,11,$as_titulo); // Agregar el título
		$io_pdf->addText(485,702,9,"No. ".$as_numsol); // Agregar el título
		$io_pdf->addText(485,670,9,"Fecha ".$ad_fecregsol); // Agregar el título
		$io_pdf->addText(540,770,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(546,764,6,date("h:i a")); // Agregar la Hora
		// cuadro inferior
		$io_pdf->Rectangle(15,60,570,70);
		$io_pdf->line(130,73,585,73);//horizontal 1
		$io_pdf->line(15,117,585,117);
		$io_pdf->line(130,60,130,130);
		$io_pdf->line(230,60,230,130);
		$io_pdf->line(340,60,340,130);
		$io_pdf->line(460,60,460,130);
		$io_pdf->addText(40,122,7,"Elaborado por"); // Agregar el título
		$io_pdf->addText(30,70,7,$_SESSION["la_nomusu"].' '.$_SESSION["la_apeusu"]); // Nombre del Usuario
		$io_pdf->addText(42,62,7,$ad_fecregsol); // Nombre del Usuario
		$io_pdf->addText(160,122,7,"Revisado por"); // Agregar el título
		$io_pdf->addText(150,63,7,"Jefe de la Unidad"); // Agregar el título
		$io_pdf->addText(265,122,7,"Aprobado por"); // Agregar el título
		$io_pdf->addText(247,63,7,"Oficina de Administración"); // Agregar el título
		$io_pdf->addText(380,122,7,"Aprobado por"); // Agregar el título
		$io_pdf->addText(365,63,7,"Oficina de Presupuesto"); // Agregar el título
		$io_pdf->addText(495,122,7,"Auditoria Interna"); // Agregar el título
		$io_pdf->addText(480,63,7,"FIRMA  / SELLO  /  FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
