<?php
	...
	$io_fun_scf=new class_funciones_scg();
	$io_fun_scf->uf_load_seguridad("SCF","sigesp_scf_r_movimientos_mes.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
function ue_search()
{
	...
	{	
		...
		{
			pagina="reportes/sigesp_scf_rpp_movimientos_mes.php?fecha="+ls_periodo+"&cuentadesde="+ls_cuentadesde+
...
function ue_openexcel()
{
	...
	{	
		...
		{
			pagina="reportes/sigesp_scf_rpp_movimientos_mes_excel.php?fecha="+ls_periodo+"&cuentadesde="+ls_cuentadesde+
