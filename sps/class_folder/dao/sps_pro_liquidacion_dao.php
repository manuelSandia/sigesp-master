...
class sps_pro_liquidacion_dao extends class_dao
{
 ...
 //-----------------------------------------Registros Contables y Presupuestarios----------------------------------//
	...
	function uf_contabilizar_liquidacion_spg($as_codnom,$as_codper,$as_numliq,$adt_fecliq)
	{
		...
		$ls_tipdoc  = "";
		$ls_descripcion=" Liquidacion de Prestaciones Sociales Nro ".$as_numliq.", para la persona ".$as_codper;      // Descripción
 ...
 //-----------------------------------------------------------------------------------------------------------------------------------
  ...
  public function uf_insert_contabilizacion_scg( $ps_codnom,$ps_comprobante,$pi_tipo,$ps_sc_cuenta,$ps_debhab,$ps_codper,
     ...
     {	
	  ...
	  //      Alcance : Publico
	  //         Tipo : Object Data Record
	  //  Descripción : Función que extrae la información de la extructura presupuestaria de la Liquidación
	  //    Arguments : $as_codnom: codigo de nomina
	  //  				$as_codper: codigo de personal
	  ...
	  //      Alcance : Publico
	  //         Tipo : Object Data Record
	  //  Descripción : Función que extrae la información del tipo de nomina
	  //    Arguments : 
	  //      Retorna : 
	  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  public function getTipoNomina($as_codnom)
	  {
		...
		if ($rs_data===false)
       	{
        	$this->io_mensajes->message("CLASE->Liquidacion MÉTODO->getDetalleContableLiq ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
       	}
       	else
       	{
			if($row=$this->io_sql->fetch_row($rs_data))
	  ...
	  //      Alcance : Publico
	  //         Tipo : Object Data Record
	  //  Descripción : Función que extrae la información de la configuracion del modulo
	  //    Arguments : 
	  //      Retorna : 
	  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      public function getConfiguracion(&$pa_array)
	  {
		...
		if ($rs_data===false)
       	{
        	$this->io_mensajes->message("CLASE->Liquidacion MÉTODO->getConfiguracion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
       	}
       	else
       	{
			if($row=$this->io_sql->fetch_row($rs_data))
