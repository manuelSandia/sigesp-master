...
if ($ls_visible == "1")
{
  ...
  elseif ($_GET["pagina"] == "sps_rep_movimientopersonal.html.php")
  {
    $lb_valido = $io_seguridad->uf_sss_load_permisos($ls_codemp,$ls_logusr,"SPS","sps_rep_movimientopersonal.html.php",$la_permisos);
	if ($lb_valido)   
    {   
		$ls_permisos = "bimepra"; //Buscar, Incluir, Modificar, Eliminar, Imprimir, Ejecutar,
		$ls_botones = "i";    //Imprimir
