...
<form name="form1" id="form1" method="post" action="">
            ...
            <div>
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formato-blanco" style="border-color:#FFFFFF">
                ...
                <tr>
                  ...
                  <td colspan="4"><label>
                    <input name="txtfecingper" type="text" id="txtfecingper" style="text-align:center"  onBlur="javascript: ue_validar_formatofecha(this);">
                  </label></td>
                  <td><div align="right">Fecha Egreso </div></td>
                  <td><label>
                    <input name="txtfecegrper" type="text" id="txtfecegrper" style="text-align:center" onBlur="ue_tiempo_servicio();ue_validar_formatofecha(this);" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" datepicker="true">
                  </label></td>
                </tr>
                <tr>
                  <td height="16">&nbsp;</td>
          ...
          <div>
              <table width="99%" border="0" cellspacing="0" cellpadding="0" class="formato-blanco" style="border-color:#FFFFFF">
                ...
                <tr>
                  ...
                  <td width="16%" height="16"><input name="txtfecdes" type="text" id="txtfecdes" size="18" style="text-align:center" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);" datepicker="true"></td>
                  <td width="13%" height="16"><div align="right">Hasta:</div></td>
                  <td height="16"><input name="txtfechas" type="text" id="txtfechas" size="20" style="text-align:center" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);" datepicker="true"></td>
                </tr>
                <tr>
                  <td height="16" colspan="4">&nbsp;</td>
                </tr>
                <tr>
                  ...
                  <td height="16" colspan="3"><label>
                    <input name="txtdescripcion" type="text" id="txtdescripcion" value=" " size="65">
                  </label></td>
                ...
                <tr>
                  ...
                  <td height="16" colspan="3"><label>
                  <input name="txtmonto" type="text" id="txtmonto" onBlur="ue_deduccion_liq(this);" onKeyPress="return(ue_formatonumero_negativo(this,'.',',',event))" >
                  </label></td>
                  <td height="16">&nbsp;</td>
                  <td height="16">&nbsp;</td>
                </tr>
  ...
  <input name="hidpermisos" type="hidden" id="hidpermisos" value="<?Php print $ls_permisos?>">
			...
			<input name="hidfvigente"  type="hidden" id="hidfvigente" value="19/06/1997">
