					  ...
					  <div>
						...
						<div>
						  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formato-blanco" style="border-color:#FFFFFF">
							...
							<tr>
							  <td height="16"><div align="right">Prorateo</div></td>
							  <td><label>
							    <input name="chkestpro" type="checkbox" id="chkestpro" value="1">
							  </label>
						      <input name="txtvalmaxpro" type="hidden" id="txtvalmaxpro" size="8" maxlength="4" style="text-align:center" onKeyPress="return validaCajas( this,'i', event );"></td>
							</tr>
						 </table>	
						</div>
					  </div>
					  <div>
						<!-- DIV QUE CONTIENE LOS DATOS DE LAS CUENTAS-->
						<div id="datos_cuentas" class="celdas-azules" align="center"><strong>Detalles de cuentas</strong></div>
						<div>
						  <table width="642" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td><table width="656" border="1" align="center">
                                <tr>
                                  <td width="108" class="Estilo6"><span class="Estilo5">Dedicaci&oacute;n</span></td>
                                  <td width="532">
								   <select name="cmbdedicacion" id="cmbdedicacion" onChange="ue_buscartipopersonal();">
				                   </select>
								  </td>
                                </tr>
                                <tr>
                                  <td class="Estilo6"><span class="Estilo5">Tipo de Personal</span> </td>
                                  <td>
								   <select name="cmbtipopersonal" id="cmbtipopersonal">
				                   </select>
								  </td>
                                </tr>
                                <tr>
                                  <td class="Estilo6"><span class="Estilo5">Cuenta</span></td>
                                  <td><input name="txtcuepre" type="text" id="txtcuepre" value="" size="26" maxlength="25" readonly>
                                    <a href="javascript: ue_buscar_spg_cuenta();"><img id="cuentapresupuesto" src="../../../shared/imagebank/tools15/buscar.gif" alt="Buscar" width="15" height="15" border="0"></a>
									<input name="txtdencuepre" type="text" id="txtdencuepre" value="" size="50" readonly>
								  </td>
                                </tr>
                              </table></td>
                            </tr>
                            <tr>
                              <td><div align="center">
                                <input name="btninccuenta" type="button" class="celdas-grises" id="btninccuenta" onClick="ue_agregar_detallecuenta();" value="     Incluir     ">
                              </div></td>
                            </tr>
                            <tr>
                              <td><table width="680" align="center" id="dt_cuenta" cellspacing="1" cellpadding="0" border="1" class="fondo-tabla">
                                <tr class="titulo-ventana">
                                  <td width="209" height="19"><font color=#FFFFFF class="titulo-ventana">Dedicación</font></td>
                                  <td width="209"><font color=#FFFFFF class="titulo-ventana" >Tipo de Personal</font></td>
                                  <td width="209"><font color=#FFFFFF  class="titulo-ventana">Cuenta</font></td>
                                ...
                                <table width="680"   align="center" cellspacing="1" cellpadding="0" border="0">
                                  <tr  id="filacuenta0" class="celdas-blancas">
                                    <td width="209" height="19"  align="right">&nbsp;</td>
