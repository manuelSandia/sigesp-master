...
<html>
<head>
<title>Catálogo de Articulos</title>
...
<script type="text/javascript" language="javascript1.2" src="../js/sps_cat_articulos.js"></script>
...
<form name="form1" method="post" action="">
 <table width="600" border="0"  class="formato-blanco" >
	<tr class="titulo-celda">
	  ...
	  Cat&aacute;logo de Articulos </td>
	</tr>
 ...
 <table id="data_grid_header" width="600" class="fondo-tabla" cellpadding="1" cellspacing="1">
  <tr class="estilo-celda">
   <td width="100" class="titulo-celda"  > Código </font></td>
   <td width="150" class="titulo-celda"  > Artículo </font></td>
   <td width="150" class="titulo-celda" > Fecha Vig. </td>
   <td width="200" class="titulo-celda" > Concepto </td>
  </tr>
 </table>
  <!-- Script que coloca un DIV donde se mostraran los registros 
