...
<html>
<head>
<title>Reporte de Movimientos de Personal</title>
...
<script type="text/javascript" language="javascript1.2" src="../js/sps_rep_movimientopersonal.js"></script>
</head>
        ...
        <td width="483" height="160">
		 <div align="center"> 
          <table width="450" height="154"  border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
            <tr >
              <td colspan="3" class="titulo-ventana">Reporte de Movimientos de Personal </td>
            </tr>
            <tr>
              <td >&nbsp;</td>
              <td colspan="2" >&nbsp;</td>
