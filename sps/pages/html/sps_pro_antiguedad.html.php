...
<html>
<head>
<title>C&aacute;lculo de Antig&uuml;edad</title>
...
<script type="text/javascript" language="javascript1.2" src="../js/sps_pro_antiguedad.js"></script>
...
<form name="form1" id="form1" method="post" action="">
			<table width="705" height="451" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco" id="tabla_fondo">	
				<tr>
				  <td width="703" height="27" colspan="4" class="titulo-ventana">C&aacute;lculo de Antig&uuml;edad </td>
				</tr>	
				<tr>
						...
						<div>
						  <table width="99%" border="0" cellspacing="0" cellpadding="0" class="formato-blanco" style="border-color:#FFFFFF">			
						    ...
						    <tr>
					          ...
					          <td height="16"><div align="right">Capitaliza				              </div></td>
						      <td height="16"><select name="cmbcapint" id="cmbcapint">
						    ...
						    <tr>
							  <td height="13" colspan="7" align="center"><input name="btngendeu" type="button" class="celdas-grises" id="btngendeu" onClick="ue_generar_deuda();" value="     Generar Deuda     ">
							    <label></label></td>
						    </tr>
						    ...
						    <tr><td height="61" colspan="7"><table width="1210" align="center" id="dt_antig" cellspacing="1" cellpadding="0" border="1" class="fondo-tabla">
                              <tr class="titulo-ventana">
								...
								<td width="70" height="35" align="center"><font class="titulo-ventana-grid">Salario Integral Diario</font></td>
								<td width="45" height="35" align="center"><font class="titulo-ventana-grid">Días Antig</font></td>
	...
	<input name="hidestbolactual" type="hidden" id="hidestbolactual" value="">
	<input name="hidsueldo"   type="hidden" id="hidsueldo"  value="">
	<input name="hidincvac"   type="hidden" id="hidincvac"  value="">
	<input name="hidincfin"   type="hidden" id="hidincfin"  value="">
	<input name="hidaux"  type="hidden" id="hidaux" value="0">
	<!-- Articulo -->
	...
	<input name="hiddiasal"   type="hidden" id="hiddiasal"  value="0">
	<input name="hidtiempo"   type="hidden" id="hidtiempo"  value="A">
	<input name="hiddiaacu"   type="hidden" id="hiddiaacu"  value="0">
	<input name="hiddiasal2"  type="hidden" id="hiddiasal2" value="0">
	<input name="hidtiempo2"  type="hidden" id="hidtiempo2" value="A">
	<input name="hiddiaacu2"  type="hidden" id="hiddiaacu2" value="0">
	<!-- Anticipo -->
