...
var url    ='../php/sps_cat_aprob_liquidacion.php';
var params ='operacion';
var metodo ='get';

function ue_ver_liquidacion()
{ 
  ...
  var params = 
  {
	operacion : "ue_ver_liquidacion",
	numliq : $F('txtnumliq'),
	nomper : $F('txtnomper'),
	apeper : $F('txtapeper')
  };
 
  new Ajax.Request(url,{method:metodo,parameters:$H(params).toQueryString(),onComplete:onVerLiquidacion});
  
  function onVerLiquidacion(respuesta)
  { 
...
{  
	opener.ue_cargar_registro_aprob_liq(arreglo);
	close();
}