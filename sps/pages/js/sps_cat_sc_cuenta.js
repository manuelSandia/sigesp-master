...
var url    ='../php/sps_cat_sc_cuenta.php';
var params ='operacion';
var metodo ='get';

function ue_ver_sc_cuentas()
{ 
  validarOpener();                    //valida que el catalogo sea llamado de una pagina
  var params = 
  {
	operacion    : "ue_ver_sc_cuentas",
	sc_cuenta    : $F('txtcodigo'),
...
{
	opener.ue_cargar_registro_sc_cuenta(arreglo);
	close();
}