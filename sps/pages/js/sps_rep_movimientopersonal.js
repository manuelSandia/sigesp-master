...
var url = '../php/sps_rep_movimientopersonal.php';
...
{	
	...
	{  
		...
		{   
			...
			{   
			    $('cmbcodnom').options[$('cmbcodnom').options.length] = new Option("Todas las Nóminas","all");
...
{
	pagina="sps_cat_rep_antiguedad.html.php";
...
function ue_imprimir()
{
	...
	if(lb_valido)
	{
	  ...
	  var pagina = "../../reports/documents/sps_reporte_movimientopersonal.php?"+params;
	  //ue_cancelar();
