...
var url    ='../php/sps_cat_rep_anticipo.php';
var params ='operacion';
var metodo ='get';

function ue_ver_personal_anticipo()
{ 
  ...
  var params = 
  {
	operacion : "ue_ver_personal_anticipo",
	codper : $F('txtcodper'),
	nomper : $F('txtnomper'),
	apeper : $F('txtapeper')
  };
 
  new Ajax.Request(url,{method:metodo,parameters:$H(params).toQueryString(),onComplete:onVerPersonalAnticipo});
  
  function onVerPersonalAnticipo(respuesta)
  { 
...
{
	opener.ue_cargar_registro_catalogo(arreglo);
	close();
}