...
var url    ='../php/sps_cat_rep_liquidacion.php';
var params ='operacion';
var metodo ='get';

function ue_ver_personal_liq()
{ 
  ...
  var params = 
  {
	operacion : "ue_ver_personal_liq",
	codper : $F('txtcodper'),
	nomper : $F('txtnomper'),
	apeper : $F('txtapeper')
  };
 
  new Ajax.Request(url,{method:metodo,parameters:$H(params).toQueryString(),onComplete:onVerPersonalLiq});
  
  function onVerPersonalLiq(respuesta)
  { 
