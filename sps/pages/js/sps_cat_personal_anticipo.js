...
var url    ='../php/sps_cat_personal_anticipo.php';
...
{ 
  ...
  var params = 
  {
	operacion : "ue_ver_anticipo",
	cedper : $F('txtcedper'),
	nomper : $F('txtnomper'),
	apeper : $F('txtapeper')
  };
  
  new Ajax.Request(url,{method:metodo,parameters:$H(params).toQueryString(),onComplete:onVerAnticipo});
  
  function onVerAnticipo(respuesta)
  { 
	var respuestas = respuesta.responseText.split('&');
...
{
	opener.ue_cargar_registro_anticipo(arreglo);
	close();
}