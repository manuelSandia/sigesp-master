...
var url    ='../php/sps_cat_rep_antiguedad.php';
var params ='operacion';
var metodo ='get';

function ue_ver_personal_antig()
{ 
  ...
  var params = 
  {
	operacion : "ue_ver_personal_antig",
	codper : $F('txtcodper'),
	nomper : $F('txtnomper'),
	apeper : $F('txtapeper')
  };
 
  new Ajax.Request(url,{method:metodo,parameters:$H(params).toQueryString(),onComplete:onVerPersonalAntig});
  
  function onVerPersonalAntig(respuesta)
  { 
