  ...
  <table width="743" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
      ...
      <tr class="formato-blanco">
        ...
        <td width="33"><div align="right">C&oacute;digo</div></td>
			<td colspan="2">		          <input name="txtcodasi" type="text" id="txtcodasi" style="text-align:center " value="<?php print $ls_codasi ?>" size="20" maxlength="15"  readonly="true">
...
<div align="right"></div></td>
      ...
      <tr class="formato-blanco">
        ...
        <td height="39" align="left" valign="middle" id="tbcombo" ><input name="txtcodcon" id="txtcodcon" style="text-align:center " value="<?php print $ls_codcon?>" type="text" size="20" maxlength="15" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz-')" onBlur="javascript: ue_rellenarcampo(this,15);" <?php if($ls_operacion!="ue_nuevo"){print "readonly";} ?>>        
        <td height="39" align="left" valign="middle" id="tbcombo" >        
        <td height="39" align="left" valign="middle" id="tbcombo" >        
        <td height="39" align="left" valign="middle" id="tbcombo" >        
        <td height="39" align="left" valign="middle" id="tbcombo" >        
      ...
      <tr class="formato-blanco">
        <td height="26">&nbsp;</td>
        <td height="26">&nbsp;</td>
        <td height="26" align="right" valign="middle">                  Tipo de Contrato
          <?Php
				//if($ls_codobr=="")
					//$lb_valido=false;
				//else
				...
				?></td>
        <td height="26" colspan="7" align="right" valign="middle"><div align="left">
          <select name="cmbtipocontrato" size="1" id="select"  >
            ...
            <?Php 
					for($li_i=1;$li_i<=$li_totalfilas;$li_i++)
					{
					 ...
					 {
						  print "<option value='$ls_codigo' selected >$ls_codigo - $ls_descripcion</option>";
					 }
					 else
					 {
						  print "<option value='$ls_codigo'>$ls_codigo - $ls_descripcion</option>";
					 }
					} 
	           ?>
            </select>
          <input name="hidtipocontrato" type="hidden" id="hidtipocontrato3" value="<?php print $ls_codtco ?>">
  &nbsp;&nbsp;&nbsp;
  <input name="txtdestipcon" type="text" class="sin-borde" value="<?php print $ls_destipcon ?>" readonly="true">
        </div></td>
        <td height="26">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
...
function ue_imprimir()
{
	...
	if(li_imprimir==1)
	{
		if(lb_status=="C")
		{
			...
			window.open("reportes/"+formato+"?codasi="+codasi+"&codcon="+codcon+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
		}
		else
		{
