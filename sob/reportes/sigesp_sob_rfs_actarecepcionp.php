<?php
...

	{
		...
		'los fines previstos en el Artículo 123 de la Ley de Contrataciones Públicas publicado en Gaceta Oficial Nº 39.165 de fecha 24 de abril de 2009, se ha procedido '.
		...
		'que su ejecución se adapta a las condiciones estipuladas en el Contrato No. '.$as_codcon.' de fecha '.$as_feccon.' suscrito entre ambas partes,  por lo cual  se ha acordado proceder a la  Recepción Provicional.');
		$la_data[2]=array('1'=>' ');
		$la_data[3]=array('1'=>'     La presente acta no exime al contratista de cualquier obligación que pudiera derivarse del Contrato o Ley, para que conste se firma la presente Recepción Provicional. ');
		$la_data[4]=array('1'=>' ');
	...
	//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
	 $ls_titulo='<b>ACTA DE ACEPTACIÓN PROVISIONAL</b>';
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=uf_insert_seguridad($ls_titulo); // Seguridad de Reporte
	if($lb_valido)
	{

		$lb_valido=$io_report->uf_select_actacontrato($ls_codact,$ls_codcon,"3"); // Cargar el DS con los datos del reporte
