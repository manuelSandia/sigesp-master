<?php
...

	{
		...
		$io_pdf->EzSetDy(-15);
		$la_data[1]=array('1'=>'     En el día de hoy, a los '.$as_diaact.' días del mes de '.$as_mesact.' de '.$as_anioact.'; en el sitio donde se ejecutó la obra; '. 
		...
		'los fines previstos en el Artículo 121 de la Ley de Contrataciones Públicas publicado en Gaceta Oficial Nº 39.165 de fecha 24 de abril de 2009, se ha procedido '.
		...
		'que su ejecución se adapta a las condiciones estipuladas en el Contrato No. '.$as_codcon.' de fecha '.$as_feccon.' suscrito entre ambas partes,  por lo cual  se ha acordado proceder a su terminación.');
		$la_data[2]=array('1'=>' ');
		$la_data[3]=array('1'=>'     La presente acta no exime al contratista de cualquier obligación que pudiera derivarse del Contrato o Ley,  para que conste se firma la presente Acta de Terminación. ');
		$la_data[4]=array('1'=>' ');
		$la_data[5]=array('1'=>'     En prueba de conformidad se firman (3) ejemplares de  la presente Acta de Terminación.');
		$la_columnas=array('1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
	...
	//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
	 $ls_titulo='<b>ACTA DE TERMINACION</b>';
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=uf_insert_seguridad($ls_titulo); // Seguridad de Reporte
	if($lb_valido)
	{

		$lb_valido=$io_report->uf_select_actacontrato($ls_codact,$ls_codcon,"2"); // Cargar el DS con los datos del reporte
