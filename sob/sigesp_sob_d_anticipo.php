...
?>	
  ...
  <table width="828" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
      ...
      <tr class="formato-blanco">
        ...
        <td width="160" height="39"><input name="txtfecant" type="hidden" id="txtfecant"  style="text-align:center" value="<?php print $ls_fecant ?>" size="10" maxlength="10"  readonly="true"></td>
        <td height="39">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td height="26">&nbsp;</td>
      ...
      <tr class="formato-blanco">
        ...
        <td height="26" colspan="2"><input name="txtporant"  style="text-align:right "type="text" id="txtporant" onKeyPress="return(validaCajas(this,'d',event,21)) "   onBlur="javascript:ue_validaporcentaje(this)" value="<?php print number_format($ls_porant,2,',','.') ?>" size="21" maxlength="6" onFocus="javascript:ue_guardarvalor()">
        %.</td>
        <td height="26">&nbsp;</td>
      </tr>
...
<!-- Fin de la declaracion de Hidden-->
  ...
  <input name="estapr" type="hidden" id="estapr" value="<?php print $ls_estapr; ?>">
  </form>
</body>
<script language="javascript">
...
function ue_cargaranticipo (ls_codcon,ls_desobr,ls_estado,ls_codest,ls_codobr,ld_monto,ls_codant,
							ls_fecintant,ld_porant,ls_conant,ld_montotant,ls_cuenta,ls_fecant,ld_montocontrato,ls_estgenrd,ls_estapr)
{
	f=document.form1;
						...
						else
						{
							...
							else
							{
								...
								else
								{
									...
									if(estapr==1)
									{
										alert("El Anticipo esta aprobado y no puede ser modificado");
									}
									else
									{
										f.action="sigesp_sob_d_anticipo.php";
