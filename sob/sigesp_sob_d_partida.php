        ...
        <td width="516" height="237"><div align="center">
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            ...
            <tr>
              ...
              <td><input name="txtcodcovpar" type="text" id="txtcodcovpar" value="<?php print $ls_codcovpar;?>" size="15" maxlength="15" onKeyPress="return(validaCajas(this,'x',event,15))" readonly="true">
              <a href="javascript:ue_catcovenin();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a>
              <input name="txtdescov" type="text" class="sin-borde" id="txtdescov" size="35"></td>
            </tr>
            <tr>
              <td height="8">&nbsp;</td>
              <td>&nbsp;</td>
...
function ue_catcovenin()
{
	f=document.form1;
	f.operacion.value="";			
	pagina="sigesp_cat_covenin.php";
	popupWin(pagina,"catalogo",600,300);
//	window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=650,height=300,resizable=yes,location=no");
}
...
function ue_cargarpartida(codigo,nombre,descripcion,codunidad,nomunidad,prepar,codcovpar,codcatpar,descatpar,descov)
{
	f=document.form1;
