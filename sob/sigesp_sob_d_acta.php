...
&nbsp;&nbsp;&nbsp;
      ...
      <tr class="formato-blanco">
        ...
        <td height="25" colspan="5" width="800"><input name="txtnominsact" type="text"  style="text-align: left" id="txtnominsact" size="50" value="<?php print $ls_nominsact?>" maxlength="50"  onKeyPress="return(validaCajas(this,'x',event,254))" readonly>          &nbsp;&nbsp;&nbsp;&nbsp;C.I.
        <input name="txtcedinsact" type="text" id="txtcedinsact" value="<?php print $ls_cedinsact?>" size="10" maxlength="10" style="text-align:center "  onKeyPress="return(validaCajas(this,'x',event,254))" readonly>
        &nbsp;
        C.I.V.        
      ...
      <tr class="formato-blanco">
        ...
        <td height="24" colspan="5"><input name="txtnomresact" type="text" id="txtnomresact" value="<?php print $ls_nomresact?>" size="50"  maxlength="50" style="text-align:left "  onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz-()=%#¿?!¡áéíóú ')">
        &nbsp;&nbsp;&nbsp;&nbsp;C.I.
        <input name="txtcedresact" type="text" id="txtcedresact"  value="<?php print $ls_cedresact?>" size="10" maxlength="10" style="text-align:center "   onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz-()=%#¿?!¡áéíóú')">
        &nbsp;&nbsp;C.I.V.
        <input name="txtcivresact" type="text" style="text-align:center " value="<?php print $ls_civresact;?>" size="10" maxlength="10"    onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz-()=%#¿?!¡áéíóú')">
	  ...
	  ?>
        ...
        <td colspan="5"><textarea name="txtmotact" cols="80" rows="2" id="txtmotact" onKeyDown="textCounter(this,254)" onKeyUp="textCounter(this,254)"   onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz-()=%#¿?!¡áéíóú')"><?php print $ls_motact;?></textarea></td>
        <td>&nbsp;</td>
      </tr>
	  <?
	  }
      ...
      <tr class="formato-blanco">
        ...
        <td colspan="5"><textarea name="txtobsact" cols="80" rows="2" id="txtobsact" onKeyDown="textCounter(this,254)" onKeyUp="textCounter(this,254)"   onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz-()=%#¿?!¡áéíóú ')"><?php print $ls_obsact;?></textarea></td>
        <td>&nbsp;</td>
      </tr>
	...
	else
	{
		if( f.hidtipoacta.value=="5" || f.hidtipoacta.value=="6")
		{
			if(f.txtfeciniact.value=="" || f.txtfecfinact.value=="")
			{
				...
				pagina="sigesp_sob_cat_personal.php?codpro="+codpro+"&tipocatalogo="+tipocatalogo;
...
{
	f=document.form1;
	if((f.cmbtipoacta.value!="s1")&&(f.txtcodact.value!=""))
	{
		tipoacta=f.cmbtipoacta.value;
		codact=f.txtcodact.value;
		codcon=f.txtcodcon.value;
		switch(tipoacta)
		{
			case "1":
				window.open("reportes/sigesp_sob_rfs_actainicio.php?codact="+codact+"&codcon="+codcon+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			break;
			case "2":
				window.open("reportes/sigesp_sob_rfs_actafinalizacion.php?codact="+codact+"&codcon="+codcon+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			break;
			case "3":
				window.open("reportes/sigesp_sob_rfs_actarecepcionp.php?codact="+codact+"&codcon="+codcon+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			break;
			case "4":
				window.open("reportes/sigesp_sob_rfs_actarecepciond.php?codact="+codact+"&codcon="+codcon+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			break;
			case "5":
				//window.open("reportes/sigesp_sob_rfs_actainicio.php?codact="+codact+"&codcon="+codcon+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			break;
			case "6":
				window.open("reportes/sigesp_sob_rfs_actareinicio.php?codact="+codact+"&codcon="+codcon+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			break;
			case "1":
				//window.open("reportes/sigesp_sob_rfs_actainicio.php?codact="+codact+"&codcon="+codcon+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			break;
