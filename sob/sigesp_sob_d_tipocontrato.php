        ...
        <td width="516" height="170"><div align="center">
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            ...
            <tr>
              ...
              <td><input name="txtdestco" type="hidden" value="" id="txtdestco"><!--<textarea name="txtdestco" cols="53" onKeyDown="textCounter(this,254)"  onKeyUp="textCounter(this,254)" rows="2" id="txtdestco" value="<?php print $ls_destco; ?>" onKeyPress="return(validaCajas(this,'x',event,254))"><?php print $ls_destco?></textarea>--></td>
            </tr>
            <tr>
              <td height="8">&nbsp;</td>
              <td>&nbsp;</td>
