<?Php
	...
	$io_fun_sob->uf_load_seguridad("SOB","sigesp_sob_r_reporteobra.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>	
<table width="675" height="630" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
	  
	
        <td width="675" height="628"><div align="center">
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            <tr>
              <td colspan="3" class="titulo-ventana">Reporte de Obras </td>
            </tr>
            <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hasta
    <input name="txtfeccreobrhasta" type="text" id="txtfeccreobrhasta"  style="text-align:left" value="<? print $ls_feccreobrhasta ?>" size="11" maxlength="10" datepicker="true" readonly="true"></td>
               ...
               <tr>
                 <td width="156" height="21"><div align="right">Descripci&oacute;n</div></td>
              ...
              <td height="8" colspan="3" align="left"><table width="572" height="71" border="0" align="center" cellpadding="0" cellspacing="2" class="formato-blanco">
                <tr>
                  ...
                  <td colspan="3"><span class="style6">
				    ...
				    ?>
                    <select name="cmbpais" size="1" id="cmbpais" onChange="javascript:ue_recargar();">
                      <option value="">Seleccione...</option>
                      <?Php
					for($li_i=1;$li_i<=$li_totalfilas;$li_i++)
					{
					 ...
					 {
					 	if ($ls_codpai==""){
					 		if ($ls_codigo=='058' || trim($ls_desest)=='VENEZUELA') {
					 			print "<option value='$ls_codigo' selected>$ls_desest</option>";
					 			$ls_codpai=$ls_codigo;
					 		}
					 		else{
            ...
            <tr>
              <td height="8" colspan="3" align="left"><table width="572" height="45" border="0" align="center" cellpadding="0" cellspacing="2" class="formato-blanco">
                ...
                <tr>
                  ...
                  <td width="164"><input name="txtmonto" type="text" id="txtmonto"  style="text-align:right" value="<? print $ls_monto ?>" size="22" maxlength="21" onKeyPress="return(validaCajas(this,'d',event,21)) "  onBlur="javascript:ue_getformat(this)" ></td>
                  <td width="129">&nbsp;</td>
                </tr>
              </table></td>
            </tr>
            ...
            <tr>
              <td height="164" colspan="3"><table width="572" height="167" border="0" align="center" cellpadding="0" cellspacing="2" class="formato-blanco">
                ...
                <tr>
                  ...
                  <td width="210" rowspan="4" align="left" valign="top">
				   <select name="lst2" id="lst2" size="10" multiple style="width: 200px " onChange="javascript:ue_habilitar_deshabilitar_botones(this,document.form1.btn3,document.form1.btn4)">
				  <?Php
				  		if($ls_hidlista2!="")
						{
	...
	<input name="hidlista1" type="hidden" id="hidlista1" value="<?php print $ls_hidlista1 ?>">
	<input name="hidlista2" type="hidden"  id="hidlista2" value="<?php print $ls_hidlista2 ?>" >
</form>
</body>
