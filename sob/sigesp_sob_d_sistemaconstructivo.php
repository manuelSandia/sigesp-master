        ...
        <td width="516" height="168"><div align="center">
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            ...
            <tr>
              ...
              <td><input name="txtdessiscon" type="hidden" value="" id="txtdessiscon"><!--<textarea name="txtdessiscon" cols="53" rows="2" wrap="VIRTUAL" id="txtdessiscon" onKeyPress="return(validaCajas(this,'x',event))" onKeyDown="textCounter(this,254)"  onKeyUp="textCounter(this,254)" value="<?php print $ls_dessiscon; ?>"><?php print $ls_dessiscon; ?></textarea>--></td>
            </tr>
            <tr>
              <td height="8">&nbsp;</td>
              <td>&nbsp;</td>
