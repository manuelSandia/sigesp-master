<?php
	...
	$io_fun_cxp->uf_load_seguridad("SOB","sigesp_sob_r_listadoobras.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<table width="575" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
  ...
  <tr>
    <td height="22" colspan="3" align="center" class="titulo-ventana">Listado de Obras </td>
  </tr>
...
var patron2 = new Array(1,3,3,3,3)
	...
	function uf_imprimir()
	{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/sigesp_sob_rpp_listadoobras.php?coddes="+coddes+"&codhas="+codhas+"&fecregdes="+fecregdes+"&fecreghas="+fecreghas+"&codorgeje="+codorgeje;
