...
<form name="form1" method="post" action="">
  ...
  <p align="center">
    ...
    <input name="fotoeliminar" type="hidden" id="fotoeliminar">
    <input name="archivoeliminar" type="hidden" id="archivoeliminar">
</p>
		  ...
		  <table  border="1">
            <tr>             
			  ...
			  for($li_i=0;$li_i<$li_count;$li_i++)
			  {
					...
					$ls_foto=$la_fotos["foto"][$li_i];
					//$_SESSION["nombre".$ls_codigo]=$ls_nombre;
			  	    print"<td width='130' height='130' align=center>";
					print "<a href=javascript:ue_mostrar_foto('$ls_codigo')><img src='fotosobras/$ls_codigo'  border='0' width='120' height='120' style=' border-color:#3399FF; border:groove ' title='$ls_nombre'/></a>";					
					print "\n $ls_nombre";
					print "\n <a href=javascript:ue_eliminar_foto('".$ls_foto."','".$ls_codigo."')><img src='../shared/imagebank/tools15/eliminar.gif'  border='0' width='15' height='15' title='Eliminar Imagen'/></a>";
					print"</td>";
			  }
			 	?>	
...
<script language="javascript">
	...
	function ue_eliminar_foto(foto,codigo)
	{
		f=document.form1;
		f.operacion.value="ue_eliminar";
		f.fotoeliminar.value=codigo;
		f.archivoeliminar.value=foto;
		f.action="";
		f.submit();
	}
