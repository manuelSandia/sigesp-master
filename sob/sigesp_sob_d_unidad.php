        ...
        <td width="516" height="195"><div align="center">
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            ...
            <tr align="left">
              ...
              <td><input name="txtnomuni" id="txtnomuni" value="<?php print $ls_nomuni?>" type="text" size="50" maxlength="30" onKeyPress="return(validaCajas(this,'x',event))"></td>
            </tr>
			<tr style="visibility:hidden">
              <td width="134" height="22" align="right"><span class="style2">Tipo de Unidad</span></td>
              <td width="334" ><input name="txtcodtun" type="text" style="text-align:center " id="txtcodtun" value="---" size="3" maxlength="3"  readonly="true">
            ...
            <tr>
              ...
              <td><input name="txtdesuni" type="hidden" value="" id="txtdesuni"><!--<textarea name="txtdesuni" cols="56" rows="2" id="txtdesuni" value="<?php print $ls_desuni?>" onKeyDown="textCounter(this,254);" onKeyUp="textCounter(this,254);" onKeyPress="return(validaCajas(this,'x',event))"><?php print $ls_desuni?></textarea>--></td>
            </tr>
            <tr>
              <td height="8">&nbsp;</td>
              <td>&nbsp;</td>
