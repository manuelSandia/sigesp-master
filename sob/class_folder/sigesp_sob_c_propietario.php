...
function sigesp_sob_c_propietario()
{
	...
	function uf_guardar_propietario(&$ls_codpro,$ls_nompro,$ls_telpro,$ls_dirpro,$ls_nomresppro,$ls_faxpro,$ls_emapro,$ls_status,$ls_rifpro,$ls_nitpro,$aa_seguridad)
	{
		//////////////////////////////////////////////////////////////////////////////////////////
		...
		if($ls_status=="C")
		{
			...
			if($lb_existe)
			{
				$lb_valido=$this->uf_update_propietario($ls_codpro,$ls_nompro,$ls_telpro,$ls_dirpro,$ls_nomresppro,$ls_faxpro,$ls_emapro,$ls_rifpro,$ls_nitpro,$aa_seguridad);
			}
			else
			{
		...
		{
			$lb_valido=$this->uf_insert_propietario(&$ls_codpro,$ls_nompro,$ls_telpro,$ls_dirpro,$ls_nomresppro,$ls_faxpro,$ls_emapro,$ls_rifpro,$ls_nitpro,$aa_seguridad);
		}
		if(!$lb_valido)
		{
...
/*		$ls_codemp=$this->datoemp["codemp"];
	...
	function uf_insert_propietario(&$ls_codpro,$ls_nompro,$ls_telpro,$ls_dirpro,$ls_nomresppro,$ls_faxpro,$ls_emapro,$ls_rifpro,$ls_nitpro,$aa_seguridad)
	{
		//////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql=" INSERT INTO sob_propietario(codemp,codpro,nompro,telpro,dirpro,nomresppro,faxpro,emapro,rifpro,nitpro)".
				"    VALUES ('".$ls_codemp."','".$ls_codpro."','".$ls_nompro."','".$ls_telpro."','".$ls_dirpro."','".$ls_nomresppro."',".
				"            '".$ls_faxpro."','".$ls_emapro."','".$ls_rifpro."','".$ls_nitpro."') ";
		$this->io_sql->begin_transaction();	
	...
	function uf_update_propietario($ls_codpro,$ls_nompro,$ls_telpro,$ls_dirpro,$ls_nomresppro,$ls_faxpro,$ls_emapro,$ls_rifpro,$ls_nitpro,$aa_seguridad)
	{
		//////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql="UPDATE sob_propietario".
				...
				"       nomresppro='".$ls_nomresppro."', faxpro='".$ls_faxpro."', emapro='".$ls_emapro."', rifpro='".$ls_rifpro."', nitpro='".$ls_nitpro."'  ".
