...
if($ls_operacion=="BUSCAR")
{
	$ls_sql="SELECT a.codcon,a.codant,a.fecant,a.fecintant,a.porant,a.monto,a.fecant,
			a.conant,a.montotant,a.sc_cuenta as cuenta,a.estant,o.desobr,o.codobr,a.estspgscg,c.monto as montocontrato,a.estgenrd,a.estapr
	...
	}else
	{
		...
		while($row=$io_sql->fetch_row($rs_data))
		{
			...
			//{
				...
				'$ls_codant','$ls_fecintant','$ld_porant','$ls_conant','$ld_montotant','$ls_cuenta','$ls_fecant','$ld_montocontrato','$ls_estgenrd','$ls_estapr');\">".$ls_codant."</a></td>";
...
function aceptar(ls_codcon,ls_desobr,ls_estado,ls_codest,ls_codobr,$ld_monto,ls_codant,ls_fecintant,ld_porant,ls_conant,
				 ld_montotant,ls_cuenta,ls_fecant,ld_montocontrato,ls_estgenrd,ls_estapr)
  {
    opener.ue_cargaranticipo(ls_codcon,ls_desobr,ls_estado,ls_codest,ls_codobr,$ld_monto,ls_codant,ls_fecintant,ld_porant,
							 ls_conant,ld_montotant,ls_cuenta,ls_fecant,ld_montocontrato,ls_estgenrd,ls_estapr);
	close();
  }
