        ...
        <td width="516" height="178"><div align="center">
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            ...
            <tr>
              ...
              <td><input name="txtdestob" type="hidden" value="" id="txtdestob"><!--<textarea name="txtdestob" cols="56" rows="2" id="txtdestob" value="<?php print $ls_destob; ?>" onKeyDown="textCounter(this,254);" onKeyUp="textCounter(this,254);" onKeyPress="return(validaCajas(this,'x',event))"><?php print $ls_destob; ?></textarea>--></td>
            </tr>
            <tr>
              <td height="8">&nbsp;</td>
              <td>&nbsp;</td>
