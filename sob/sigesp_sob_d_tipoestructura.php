        ...
        <td width="516" height="158"><div align="center">
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            ...
            <tr>
              ...
              <td><input name="txtdestipest" type="hidden" value="" id="txtdestipest"><!--<textarea name="txtdestipest" cols="53" rows="2" id="txtdestipest" value="<?php print $ls_destipest; ?>" onKeyDown="textCounter(this,254)"  onKeyUp="textCounter(this,254)" onKeyPress="return(validaCajas(this,'x',event,254))"><?php print $ls_destipest?></textarea>--></td>
            </tr>
            <tr>
              <td height="8">&nbsp;</td>
              <td>&nbsp;</td>
...
function ue_guardar()
{
	...
	if(((lb_status=="C")&&(li_cambiar==1))||(lb_status!="C")&&(li_incluir==1))
	{
		...
		with (form1)
		{
			if (ue_valida_null(txtcodtipest,"Código")==false)
			{
				txtcodtipest.focus();
			}
			else
