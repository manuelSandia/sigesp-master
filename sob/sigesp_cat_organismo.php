...
$ls_cadena=" SELECT codpro,nompro,telpro,dirpro,nomresppro,faxpro,emapro,rifpro,nitpro ".
			...
			else
			{
				if($row=$io_sql->fetch_row($rs_datauni))
				{
					...
					for($z=1;$z<=$totrow;$z++)
					{
						...
						$rifpro=$io_data->getValue("rifpro",$z);
						$nitpro=$io_data->getValue("nitpro",$z);
						$rif1=substr($rifpro,0,1);
						$rif2=substr($rifpro,1,8);
						$rif3=substr($rifpro,8,1);
						print "<td  align=center><a href=\"javascript: aceptar('$codpro','$nompro','$telpro','$dirpro','$nomresppro','$faxpro','$emapro','$nitpro','$rif1','$rif2','$rif3');\">".$codpro."</a></td>";
...
<script language="JavaScript">
  function aceptar(cod,nom,tel,dir,res,fax,ema,nitpro,rif1,rif2,rif3)
  {
    opener.ue_cargarpropietario(cod,nom,tel,dir,res,fax,ema,nitpro,rif1,rif2,rif3);
	close();
  }
